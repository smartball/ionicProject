...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture-socket/docs/can-fixture-socket.listener.md
	@typedef can-fixture-socket.socket-event-listener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - SocketEventListener</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.socket-event-listener.html">SocketEventListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>SocketEventListener</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/docs/can-fixture-socket.listener.md">Edit on GitHub</a>
				</li>
    ...
    <p>A listener handler that will be executed to handle the socket event.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(...data, [ackFn])</code>
  </h2>
  <p>Socket event listener handler expects one or more data arguments and an optional ACK callback.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>data</b> <code>{*}</code>: <p>Event data. Socket.io allows to pass as many arguments as needed.</p>
</li>
        
          <li><b>ackCb</b> <code>{function}</code>: <p>Optional acknowledgement callback to let emitter know about success receiving data.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture-socket/docs/can-fixture-socket.listener.md"},"description":"A listener handler that will be executed to handle the socket event. \n","type":"typedef","title":"SocketEventListener","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-fixture-socket.socket-event-listener","parent":"can-fixture-socket.types","signatures":[{"code":"handler(...data, [ackFn])","description":"\n\nSocket event listener handler expects one or more data arguments and an optional ACK callback.\n\n```js\n// Client:\nsocket.on(\"news\": function handler(data, ackCb){\n  console.log(\"received some news\", data);\n  ackCb(\"Acknowledged\", \"thank you\");\n});\n\n// Server:\nserver.emit(\"news\", {some: \"news here\"}, function ackFn(...data){\n  console.log(\"Client acknowledged data receiving\")\n});\n```\n","params":[{"types":[{"type":"*"}],"name":"data","description":"Event data. Socket.io allows to pass as many arguments as needed."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"ackCb","description":"Optional acknowledgement callback to let emitter know about success receiving data.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"ackCb","description":"Optional acknowledgement callback to let emitter know about success receiving data.\n"},"pathToRoot":".."};
</script>
</article>
