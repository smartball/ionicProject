...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/types.DefineMap.prototype.md
	@typedef can-define-stream.types.DefineMap
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DefineMap.prototype</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.types.DefineMap.html">DefineMap.prototype</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>DefineMap.prototype</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/types.DefineMap.prototype.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> constructor to add stream methods to.</p>
...
<div class="signature">
  ...
  <p>Creates a DefineMap type instance</p>
...
var john = new Person({
    ...
    <section class="body">
    <h2>Use</h2>
<p>See: <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> and <a href="can-define/map/map.extend.html" title="Define a custom map type.">extend</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/types.DefineMap.prototype.md"},"description":"A [can-define/map/map] constructor to add stream methods to. \n","type":"typedef","title":"DefineMap.prototype","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-stream.types.DefineMap","parent":"can-define-stream.types","signatures":[{"code":"new DefineMap({props})","description":"\n\nCreates a DefineMap type instance\n\n```js\nimport DefineMap from 'can-define/map/map';\n\nvar Person = DefineMap.extend({\n\tfirst: 'string',\n\tlast: 'string',\n\tfullName: {\n\t\tget() {\n\t\t\treturn this.first + \" \" + this.last;\n\t\t}\n\t}\n});\n\nvar john = new Person({\n\tfirst: 'John',\n\tlast: 'Gardner'\n});\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
