...
<!--####################################################################
	...
	@function can-observation.trap
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - trap</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-observation.trap.html">trap</a></li>
	...
	<div class="page-type">
		<h1>trap</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L594">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Trap all observations until the <code>untrap</code> function is called. The state of
traps prior to <code>Observation.trap()</code> will be restored when <code>untrap()</code> is called.</p>
...
console.log(traps[0].obj === obj); // -&gt; true
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-observation.getTrapped.html" title="">getTrapped</a>()}</code>: <p>A function to get the trapped observations.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-observation.trap","parent":"can-observation.static","src":{"line":593,"codeLine":612,"path":"node_modules/can-observation/can-observation.js"},"description":"","title":"trap","signatures":[{"code":"Observation.trap()","description":"\n\nTrap all observations until the `untrap` function is called. The state of\ntraps prior to `Observation.trap()` will be restored when `untrap()` is called.\n\n```js\nvar untrap = Observation.trap();\n\nObservation.add(obj, \"prop1\");\n\nvar traps = untrap();\nconsole.log(traps[0].obj === obj); // -> true\n```\n","params":[],"returns":{"types":[{"type":"can-observation.getTrapped"}],"description":"A function to get the trapped observations.\n"}}],"_curReturn":{"types":[{"type":"can-observation.getTrapped"}],"description":"A function to get the trapped observations.\n"},"pathToRoot":".."};
</script>
</article>
