...
<!--####################################################################
	...
	@function can-reflect.isConstructorLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isConstructorLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isConstructorLike.html">isConstructorLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isConstructorLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L6">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value looks like a constructor function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isConstructorLike(func)</code>
  </h2>
  <p>Return <code>true</code> if <code>func</code> is a function and has a non-empty prototype, or implements
<a href="can-symbol/symbols/new.html" title="Create a new instance of a constructor function or prototype object."><code>@@can.new</code></a>; <code>false</code> otherwise.</p>
<pre><code>canReflect.isConstructorLike(function() {}); // -&gt; false
...
!!canReflect.isConstructorLike({ [canSymbol.for(&quot;can.new&quot;)]: function() {} }); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>func</b> <code>{*}</code>: <p>maybe a function</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if a constructor; <code>false</code> if otherwise.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isConstructorLike","parent":"can-reflect/type","src":{"line":5,"codeLine":30,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value looks like a constructor function. \n","title":"isConstructorLike","signatures":[{"code":"isConstructorLike(func)","description":"\n\nReturn `true` if `func` is a function and has a non-empty prototype, or implements\n [can-symbol/symbols/new `@@can.new`]; `false` otherwise.\n\n```\ncanReflect.isConstructorLike(function() {}); // -> false\n\nfunction Construct() {}\nConstruct.prototype = { foo: \"bar\" };\ncanReflect.isConstructorLike(Construct); // -> true\n\ncanReflect.isConstructorLike({}); // -> false\n!!canReflect.isConstructorLike({ [canSymbol.for(\"can.new\")]: function() {} }); // -> true\n```\n","params":[{"types":[{"type":"*"}],"name":"func","description":"maybe a function"}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if a constructor; `false` if otherwise.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"func","description":"maybe a function"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if a constructor; `false` if otherwise.\n"},"pathToRoot":".."};
</script>
</article>
