...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-attribute-encoder/can-attribute-encoder.js
	@module can-attribute-encoder
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-attribute-encoder</title>
...
location.pathname; // -&gt; &quot;/user&quot;">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-attribute-encoder.decode.html"
							title="Decode an attribute name encoded by can-attribute-encoder.encode">
							decode
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-attribute-encoder.encode.html"
							title="Encode an attribute name">
							encode
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-attribute-encoder.html">can-attribute-encoder</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-attribute-encoder</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-attribute-encoder">
						<img src="https://img.shields.io/badge/npm%20package-0.3.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-attribute-encoder" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-attribute-encoder/edit/master/can-attribute-encoder.js#L4">Edit on GitHub</a>
				</li>
    ...
    <p>Encode and decode attribute names.</p>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        ...
        <p>object with the methods:
<a href="can-attribute-encoder.encode.html" title="Encode an attribute name">encode</a> and <a href="can-attribute-encoder.decode.html" title="Decode an attribute name encoded by can-attribute-encoder.encode">decode</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-attribute-encoder","params":[{"name":"items","types":[{"type":"*"}]},{"name":"callback","types":[{"type":"*"}]}],"parent":"can-infrastructure","src":{"line":3,"codeLine":16,"path":"node_modules/can-attribute-encoder/can-attribute-encoder.js"},"description":"\nEncode and decode attribute names.\n","title":"can-attribute-encoder","types":[{"type":"Object","options":[{"name":"An","description":"object with the methods:\n[can-attribute-encoder.encode] and [can-attribute-encoder.decode].\n\n","types":[{"type":"Object","options":[]}]}]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-attribute-encoder/issues"},"bundleDependencies":false,"dependencies":{"can-log":"^0.1.0","can-namespace":"^1.0.0"},"deprecated":false,"description":"Encode / decode attributes for DOM elements","devDependencies":{"detect-cyclic-packages":"^1.1.0","jshint":"^2.9.5","steal":"^1.5.6","steal-qunit":"^1.0.1","steal-tools":"^1.7.0","testee":"^0.7.0"},"homepage":"https://canjs.com/","keywords":["canjs"],"license":"MIT","main":"can-attribute-encoder","name":"can-attribute-encoder","repository":{"type":"git","url":"git://github.com/canjs/can-attribute-encoder.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update version number\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-attribute-encoder","npmIgnore":["testee","steal-tools"]},"version":"0.3.1"},"pathToRoot":".."};
</script>
</article>
