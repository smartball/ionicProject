...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/with.md
	@function can-stache.helpers.with
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#with(expression)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.with.html">{{#with(expression)}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{#with(expression)}}</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/with.md">Edit on GitHub</a>
				</li>
    ...
    <p>Changes the context within a block.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#with(EXPRESSION)}}BLOCK{{/with}}</code>
  </h2>
  <p>Renders <code>BLOCK</code> with the result of <code>EXPRESSION</code> added to the top of the <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>.</p>
<pre><code>{{#with(person.address)}}
    Street: {{street}}
    City: {{city}}
{{/with}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>A lookup expression that will provide a value.</p>
</li>
        
          <li><b>BLOCK</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>A template that is rendered
with the context of the <code>EXPRESSION</code>'s value.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#with(HASHES)}}BLOCK{{/with}}</code>
  </h2>
  <p>Renders <code>BLOCK</code> with the key-value pairs from a <a href="can-stache/expressions/hash.html" title="">Hash Expression</a> added to the top of the <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>.</p>
<pre><code>{{#with(innerStreet=person.address.street innerCity=person.address.city)}}
    Street: {{innerStreet}}
    City: {{innerCity}}
{{/with}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>HASHES</b> <code>{<a href="can-stache/expressions/hash.html" title="">Hash Expression</a>}</code>: <p>Any number of hash keys and values</p>
</li>
        
          <li><b>BLOCK</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>A template that is rendered
with the hashes added to the context.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>{{#with()}}</code> renders a subsection with a new context added to the <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>.
For example:</p>
<pre><code>TEMPLATE:
    {{#with(person.address)}}
        Street: {{street}}
...
<p>The new context can be a lookup expression, or a set of hashes which are taken together to be a new context.</p>
<pre><code>TEMPLATE:
...
<p>The difference between <code>{{#with()}}</code> and the default <a href="can-stache.tags.section.html" title="Renders a subsection one or more times depending on the type of expression
or the expression's return value.">{{#expression}}</a>
is that the subsection <code>BLOCK</code> is rendered no matter what:</p>
<pre><code>TEMPLATE:
    {{#with(person.address)}}
        Street: {{street}}
        City: {{city}}
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/with.md"},"description":"\nChanges the context within a block.\n","title":"{{#with(expression)}}","name":"can-stache.helpers.with","type":"function","parent":"can-stache.htags","order":6,"signatures":[{"code":"{{#with(EXPRESSION)}}BLOCK{{/with}}","description":"\n\nRenders `BLOCK` with the result of `EXPRESSION` added to the top of the [can-view-scope].\n\n```\n{{#with(person.address)}}\n\tStreet: {{street}}\n\tCity: {{city}}\n{{/with}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"A lookup expression that will provide a value.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"A template that is rendered\nwith the context of the `EXPRESSION`'s value.\n"}]},{"code":"{{#with(HASHES)}}BLOCK{{/with}}","description":"\n\nRenders `BLOCK` with the key-value pairs from a [can-stache/expressions/hash] added to the top of the [can-view-scope].\n\n```\n{{#with(innerStreet=person.address.street innerCity=person.address.city)}}\n    Street: {{innerStreet}}\n    City: {{innerCity}}\n{{/with}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/hash"}],"name":"HASHES","description":"Any number of hash keys and values\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"A template that is rendered\nwith the hashes added to the context.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"A template that is rendered\nwith the hashes added to the context.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
