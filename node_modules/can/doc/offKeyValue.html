...
<div class="breadcrumb">
	...
	<li><a href="offKeyValue.html">offKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>offKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/can-globals-proto.js#L149">Edit on GitHub</a>
				</li>
    ...
    <p>Remove handler from event queue.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>globals.offKeyValue(key, handler)</code>
  </h2>
  <p>Removes <code>handler</code> from future change events for <code>key</code>.</p>
<pre><code class="language-javascript">var handler = (value) =&gt; {
  value === 'baz' //-&gt; true
};
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key value to observe.</p>
</li>
        
          <li><b>handler</b> <code>{function(value)}</code>: <p>The observer callback.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"offKeyValue","parent":"can-globals/methods","src":{"line":148,"codeLine":178,"path":"node_modules/can-globals/can-globals-proto.js"},"description":"\nRemove handler from event queue.\n","title":"","signatures":[{"code":"globals.offKeyValue(key, handler)","description":"\n\nRemoves `handler` from future change events for `key`.\n\n\n```javascript\nvar handler = (value) => {\n  value === 'baz' //-> true\n};\nglobals.define('foo', 'bar');\nglobals.onKeyValue('foo', handler);\nglobals.setKeyValue('foo', 'baz');\nglobals.offKeyValue('foo', handler);\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"\nThe key value to observe.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"optional":true,"name":"value"}]}],"name":"handler","description":"\nThe observer callback.\n"}],"returns":{"types":[{"type":"can-globals"}],"description":"\nReturns the instance of `can-globals` for chaining.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"optional":true,"name":"value"}]}],"name":"handler","description":"\nThe observer callback.\n"},"_curReturn":{"types":[{"type":"can-globals"}],"description":"\nReturns the instance of `can-globals` for chaining.\n"},"pathToRoot":".."};
</script>
</article>
