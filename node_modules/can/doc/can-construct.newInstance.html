...
<!--####################################################################
	...
	@function can-construct.newInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - newInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.newInstance.html">newInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>newInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L208">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an instance of <code>Construct</code>. This method can be overridden to return a cached instance.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>args</b> <code>{*}</code>: <p>arguments that get passed to <a href="can-construct.prototype.setup.html" title="">setup</a> and <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>. Note
that if <a href="can-construct.prototype.setup.html" title="">setup</a> returns an array, those arguments will be passed to <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>
instead.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{class}</code>: <p>instance of the class</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Creates a new instance of the constructor function. This method is useful for creating new instances
with arbitrary parameters. Typically, however, you will simply want to call the constructor with the
<strong>new</strong> operator.</p>
<h2>Example</h2>
<p>The following creates a <code>Person</code> Construct and overrides <code>newInstance</code> to cache all
instances of Person to prevent duplication. If the properties of a new Person match an existing one it
will return a reference to the previously created object, otherwise it returns a new object entirely.</p>
<pre><code class="language-js">// define and create the Person constructor
