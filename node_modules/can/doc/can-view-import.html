...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-import/docs/can-view-import.md
	@module can-view-import
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-import</title>
...
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="page"
							href="can-view-import.pages.dynamic.html"
							title="Dynamic imports are used in conditional situations such as within an can-stache.helpers.if to prevent unnecessarily fetching resources that might not be needed in all cases.">
							Dynamic Imports
						</a>
					...
					<li class="
           						...
           						">
						<a class="page"
							href="can-view-import.pages.static.html"
							title="Static imports reflect direct dependencies of the template. Most uses of can-view-import will be for static imports.">
							Static Imports
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-import.can-tag.html"
							title="Use another can-view-callbacks.tag (such as a can-component) to control the &lt;content&gt; of a can-view-import.">
							can-tag
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-import.from.html"
							title="Set the module name that will be imported into the template.">
							from
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-import.value.html"
							title="Set the value that is returned from the can-import Promise to a reference scope variable.">
							value:to
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-import.html">can-view-import</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-import</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-import">
						<img src="https://img.shields.io/badge/npm%20package-3.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-import" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-import/edit/master/docs/can-view-import.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Statically import a module from within a <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> template. <em>MODULE_NAME</em> will be imported before the template renders.</p>
<pre><code>&lt;can-import from=&quot;components/tabs&quot; /&gt;
&lt;tabs-widget /&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>MODULE_NAME</b> <code>{moduleName}</code>: <p>A module that this template depends on.</p>
</li>
...
<div class="signature">
  ...
  <p>Dynamically import <em>MODULE_NAME</em> if <em>content</em> is anything other than whitespace; the scope within the template is a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a>.</p>
<pre><code>&lt;can-import from=&quot;components/tabs&quot;&gt;
  {{#if isResolved}}
    &lt;tabs-widget /&gt;
  {{/if}}
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;can-dynamic-import from=&quot;MODULE_NAME&quot;&gt;content&lt;/can-import&gt;</code>
  </h2>
  <p>Dynamically import <em>MODULE_NAME</em>; the scope within the template is a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a>.</p>
<pre><code>&lt;can-dynamic-import from=&quot;components/tabs&quot;&gt;
  {{#if isResolved}}
    &lt;tabs-widget /&gt;
  {{/if}}
&lt;/can-dynamic-import&gt;
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;can-dynamic-import from=&quot;MODULE_NAME&quot; value:to=&quot;*MODULE_REF&quot;/&gt;</code>
  </h2>
  <p>Dynamically import a module from within a <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> template. Since there is no subtemplate to attach the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a> to as the current scope, you must export the Promise's resolved value to the template's refs scope using <a href="can-view-import.value.html" title="Set the value that is returned from the can-import Promise to a reference scope variable.">value:to</a>.</p>
<pre><code>&lt;can-dynamic-import from=&quot;components/tabs&quot; value:to=&quot;*tabsWidget&quot; /&gt;
{{#if *tabsWidget}}
    &lt;tabs-widget /&gt;
{{/if}}
...
{{&gt; *myPartial}}
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p>A template might depend on component or helper modules. <code>&lt;can-import&gt;</code> allows
you to specify these dependencies.</p>
<p>Example:</p>
...
<p>Currently this <strong>only</strong> works with <a href="can-view-autorender.html" title="A module that automatically renders script and other elements with
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">can-view-autorender</a> or the <a href="steal-stache.html" title="A StealJS extension that allows stache templates as dependencies.">steal-stache</a> plugin.</p>
<h2>Progressive Loading</h2>
<p>A template may (conditionally) load a module after the initial page load. <code>&lt;can-import&gt;</code> allows progressive loading by using an end tag.</p>
<p>This example shows a component being loaded ad hoc:</p>
<pre><code>&lt;can-import from=&quot;components/home&quot;&gt;&lt;/can-import&gt;
</code></pre>
<p>This example illustrates conditionally loading modules based on some application state:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-import/docs/can-view-import.md"},"description":"\n","type":"module","title":"can-view-import","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-view-import","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-view-import/issues"},"bundleDependencies":false,"dependencies":{"can-assign":"^1.0.0","can-dom-data-state":"^0.1.1","can-event":"^3.6.0","can-globals":"^0.2.3","can-log":"^0.1.0","can-stache":"^3.7.3","can-util":"^3.9.5","can-view-callbacks":"^3.2.0","can-view-nodelist":"^3.1.0"},"deprecated":false,"description":"Import dependencies in CanJS views","devDependencies":{"bit-docs":"0.0.7","can-component":"^3.2.2","can-compute":"^3.3.1","can-map":"^3.3.1","can-stache":"^3.3.0","can-test-helpers":"^1.0.1","detect-cyclic-packages":"^1.1.0","jshint":"^2.9.1","steal":"^1.2.0","steal-qunit":"^1.0.0","steal-stache":"^3.1.0","steal-tools":"^1.0.0","testee":"^0.7.0"},"homepage":"https://canjs.com","keywords":[],"main":"can-view-import","name":"can-view-import","repository":{"type":"git","url":"git://github.com/canjs/can-view-import.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve,steal-stache","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.2.2"},"signatures":[{"code":"<can-import from=\"MODULE_NAME\" />","description":"\n\nStatically import a module from within a [can-stache] template. *MODULE_NAME* will be imported before the template renders.\n\n```\n<can-import from=\"components/tabs\" />\n<tabs-widget />\n```\n","params":[{"types":[{"type":"moduleName"}],"optional":true,"name":"MODULE_NAME","description":"A module that this template depends on.\n"}]},{"code":"<can-import from=\"MODULE_NAME\">content</can-import>","description":"\n\nDynamically import *MODULE_NAME* if *content* is anything other than whitespace; the scope within the template is a [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise).\n\n```\n<can-import from=\"components/tabs\">\n  {{#if isResolved}}\n    <tabs-widget />\n  {{/if}}\n</can-import>\n```\n","params":[{"types":[{"type":"moduleName"}],"optional":true,"name":"MODULE_NAME","description":"A module that this template depends on.\n"}]},{"code":"<can-dynamic-import from=\"MODULE_NAME\">content</can-import>","description":"\n\nDynamically import *MODULE_NAME*; the scope within the template is a [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise).\n\n```\n<can-dynamic-import from=\"components/tabs\">\n  {{#if isResolved}}\n    <tabs-widget />\n  {{/if}}\n</can-dynamic-import>\n```\n","params":[{"types":[{"type":"moduleName"}],"optional":true,"name":"MODULE_NAME","description":"A module that this template depends on.\n"}]},{"code":"<can-dynamic-import from=\"MODULE_NAME\" value:to=\"*MODULE_REF\"/>","description":"\n\nDynamically import a module from within a [can-stache] template. Since there is no subtemplate to attach the [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) to as the current scope, you must export the Promise's resolved value to the template's refs scope using [can-view-import.value].\n\n```\n<can-dynamic-import from=\"components/tabs\" value:to=\"*tabsWidget\" />\n{{#if *tabsWidget}}\n\t<tabs-widget />\n{{/if}}\n\n{{! other can-reflect-promise keys also work, as does the *REFERENCE shorthand from can-stache-bindings }}\n\n<can-dynamic-import from=\"components/tabs\" \n\tisPending:to=\"*tabsWidgetPending\"\n\tisRejected:to=\"*tabsWidgetError\"\n\tthis:to\"*tabsWidgetPromise\" />\n{{#if *tabsWidgetPending}}\n\tLoading...\n{{else}}\n\t<tabs-widget />\n\t{{#if *tabsWidgetError}}\n\t\t{{*tabsWidgetPromise.reason}}\n\t{{/if}}\n{{/if}}\n\n{{! load a stache partial \n\t -- staches are functions, so prefix it with `@` to put the function in the ref scope without running it }}\n\n<can-dynamic-import from \"my-partial.stache!\" @value:to=\"*myPartial\" />\n\n{{> *myPartial}}\n\n\n```\n","params":[{"types":[{"type":"moduleName"}],"optional":true,"name":"MODULE_NAME","description":"A module that this template depends on.\n"}]}],"_curParam":{"types":[{"type":"moduleName"}],"optional":true,"name":"MODULE_NAME","description":"A module that this template depends on.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
