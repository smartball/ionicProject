...
<div class="breadcrumb">
	...
	<li><a href="can-event.delegate.html">delegate</a></li>
	...
	<div class="page-type">
		<h1>delegate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L437">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Provides a compatibility layer for adding delegate event listeners.
This doesn't actually implement delegates, but rather allows
logic that assumes a delegate to still function.</p>
<p>Therefore, this is essentially an alias of <a href="can-event.addEventListener.html" title="can-event.addEventListener">addEventListener</a> with the selector ignored.</p>
...
<div class="signature">
  ...
  <p>This syntax can be used for objects that don't include the [can.event] mixin.</p>
