...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/registerPartial.md
	@function can-stache.registerPartial
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - registerPartial</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.registerPartial.html">registerPartial</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>registerPartial</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/registerPartial.md">Edit on GitHub</a>
				</li>
    ...
    <p>Register a partial template that can be rendered with <a href="can-stache.tags.partial.html" title="Render another template within the current template.">{{>key}}</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>stache.registerPartial(name, template)</code>
  </h2>
  <p>Registers a template so it can be rendered with <code>{{&gt;name}}</code>.</p>
<pre><code class="language-js">stache.registerPartial(&quot;item.stache&quot;, &quot;&lt;li&gt;{{name}}&lt;/li&gt;&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>The name of the partial.</p>
</li>
        
          <li><b>template</b> <code>{String|<a href="can-stache.renderer.html" title="A function returned by can-stache that renders a template into an html documentFragment.">renderer</a>(data, helpers, <a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">nodeList</a>)}</code>: <p>The string of a stache template or the
returned result of a stache template.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/registerPartial.md"},"description":"Register a partial template that can be rendered with [can-stache.tags.partial]. \n","title":"registerPartial","name":"can-stache.registerPartial","type":"function","parent":"can-stache.static","signatures":[{"code":"stache.registerPartial(name, template)","description":"\n\nRegisters a template so it can be rendered with `{{>name}}`.\n\n```js\nstache.registerPartial(\"item.stache\", \"<li>{{name}}</li>\");\n\nvar itemsTemplate = stache(\"{{#each(items)}}{{>item.stache}}{{/each}}\");\n```\n","params":[{"types":[{"type":"String"}],"name":"name","description":"The name of the partial."},{"types":[{"type":"String"},{"type":"can-stache.renderer"}],"name":"template","description":"The string of a stache template or the\nreturned result of a stache template.\n"}]}],"_curParam":{"types":[{"type":"String"},{"type":"can-stache.renderer"}],"name":"template","description":"The string of a stache template or the\nreturned result of a stache template.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
