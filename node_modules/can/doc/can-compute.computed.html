...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/computed.md
	@function can-compute.computed
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - compute</title>
  ...
  <li>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-compute.computed.addEventListener.html"
							title="Listen to when a compute changes value.">
							addEventListener
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-compute.computed.off.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-compute.computed.on.html"
							title="Listen to when a compute changes value.">
							on
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-compute.computed.removeEventListener.html"
							title="Listen to when a compute changes value.">
							removeEventListener
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-compute.computed.ChangeEvent.html"
							title="Event fired when the value of the can-compute.computed changes.">
							change
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.computed.html">compute</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>compute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/computed.md">Edit on GitHub</a>
				</li>
    ...
    <p>A derived value from other computes and observable maps.</p>
...
<div class="signature">
  ...
  <p>Gets the compute's value if no arguments are provided, otherwise calls the compute's setter with the value passed as the first argument.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newVal</b> <code>{*}</code>: <p>If the compute is called with an argument, the first argument is used
...
the current value.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The current value of the compute.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A compute instance is created with <a href="can-compute.html" title="Create an observable value.">can-compute</a> and used as an observable value. Computes are useful to provide a value representative of multiple other observables:</p>
...
<p>Calling the compute with a value will cause it to run as a setter function:</p>
<pre><code class="language-js">var count = compute(0);
...
<p>This depends on how the <a href="can-compute.html" title="Create an observable value.">getterSetter</a> is defined, and can adjust how it handles setters:</p>
<pre><code class="language-js">var plusOne = compute(function(val){
    if(val) {
        return val + 1;
    } else {
        return 1;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-compute/docs/computed.md"},"description":"A derived value from other computes and observable maps. \n","title":"compute","name":"can-compute.computed","type":"function","parent":"can-compute","signatures":[{"code":"compute([newVal])","description":"\n\nGets the compute's value if no arguments are provided, otherwise calls the compute's setter with the value passed as the first argument.\n","params":[{"types":[{"type":"*"}],"optional":true,"name":"newVal","description":"If the compute is called with an argument, the first argument is used\nto set the compute to a new value. This may trigger a\n`\"change\"` event that can be listened for with [can-computed.bind].\n\nIf the compute is called without any arguments (`compute()`), it simply returns\nthe current value.\n"}],"returns":{"types":[{"type":"*"}],"description":"The current value of the compute.\n"}}],"_curParam":{"types":[{"type":"*"}],"optional":true,"name":"newVal","description":"If the compute is called with an argument, the first argument is used\nto set the compute to a new value. This may trigger a\n`\"change\"` event that can be listened for with [can-computed.bind].\n\nIf the compute is called without any arguments (`compute()`), it simply returns\nthe current value.\n"},"_curReturn":{"types":[{"type":"*"}],"description":"The current value of the compute.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
