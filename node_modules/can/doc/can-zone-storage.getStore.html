...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.methods.getStore.md
	@function can-zone-storage.getStore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-zone-storage.getStore</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.getStore.html">can-zone-storage.getStore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-zone-storage.getStore</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.methods.getStore.md">Edit on GitHub</a>
				</li>
...
<p>If the <a href="can-zone.html" title="A library that tracks asynchronous activity and lets you know when it has completed. Useful when you need to call a function and wait for all async behavior to complete, such as when performing server-side rendering.">can-zone</a> library has NOT been imported, <code>getStore</code> returns the internal <a href="can-zone-storage.data.html" title="Implement Zone-safe memory-based storage">data</a> object.</p>
<pre><code class="language-js">var zoneStorage = require(&quot;can-zone-storage&quot;);
var store = zoneStorage.getStore();
