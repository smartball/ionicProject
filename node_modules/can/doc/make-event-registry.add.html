...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-dom-events/helpers/make-event-registry.js
	@function make-event-registry.add
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - eventRegistry.add</title>
...
can.route. It can serve as both a traditional view and a traditional controller.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-dom-events.addEvent.html"
							title="Add a custom event to the global event registry.">
							addEvent
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-dom-events.addEventListener.html"
							title="Add an event listener for eventType to the target.">
							addEventListener
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-dom-events.dispatch.html"
							title="Create and dispatch a configured event on the target.">
							dispatch
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-dom-events.removeEventListener.html"
							title="Remove an event listener for eventType to the target.">
							removeEventListener
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						expanded">
						<a class="module"
							href="can-dom-events/helpers/make-event-registry.html"
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="make-event-registry.add.html"
							title="Add an event to the registry.">
							eventRegistry.add
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="make-event-registry.get.html"
							title="Retrieve an event type which has already been registered.">
							eventRegistry.get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="make-event-registry.has.html"
							title="Check whether an event type has already been registered.">
							eventRegistry.has
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-dom-events.DomEventTarget.html"
							title="An object which can have DOM Events registered on it.
This is a Window, Document, or HTMLElement.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-dom-events.EventDefinition.html"
							title="Definition of a custom event that may be added to an event registry.">
							EventDefinition
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-dom-events.html">can-dom-events</a></li>
		<li> / </li>
	
		<li><a href="can-dom-events/helpers/make-event-registry.html">./helpers/make-event-registry</a></li>
		<li> / </li>
	
	
	<li><a href="make-event-registry.add.html">eventRegistry.add</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>eventRegistry.add</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-dom-events/edit/master/helpers/make-event-registry.js#L61">Edit on GitHub</a>
				</li>
    ...
    <p>Add an event to the registry.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>eventRegistry.add( event [, eventType ] )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{EventDefinition}</code>: <p>The event definition to register.</p>
</li>
        
          <li><b>eventType</b> <code>{String}</code>: <p>The event type with which to register the event.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>The callback to remove the event from the registry.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"make-event-registry.add","parent":"make-event-registry.registry","src":{"line":60,"codeLine":71,"path":"node_modules/can-dom-events/helpers/make-event-registry.js"},"description":"\nAdd an event to the registry.\n","title":"eventRegistry.add","signatures":[{"code":"eventRegistry.add( event [, eventType ] )","description":"","params":[{"types":[{"type":"EventDefinition"}],"name":"event","description":"The event definition to register."},{"types":[{"type":"String"}],"name":"eventType","description":"The event type with which to register the event."}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The callback to remove the event from the registry.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"eventType","description":"The event type with which to register the event."},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The callback to remove the event from the registry.\n"},"pathToRoot":".."};
</script>
</article>
