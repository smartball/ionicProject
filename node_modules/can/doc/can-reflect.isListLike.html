...
<!--####################################################################
	...
	@function can-reflect.isListLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isListLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isListLike.html">isListLike</a></li>
	...
	<div class="page-type">
		<h1>isListLike</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L300">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isListLike(list)</code>
  </h2>
  <p>Return <code>true</code> if <code>list</code> is a <code>String</code>, <br>OR <code>list</code> is <em>not</em> a primitive and implements <code>@@iterator</code>,
<br>OR <code>list</code> is <em>not</em> a primitive and returns <code>true</code> for <code>Array.isArray()</code>, <br>OR <code>list</code> is <em>not</em> a primitive and has a
numerical length and is either empty (<code>length === 0</code>) or has a last element at index <code>length - 1</code>; <br><code>false</code> otherwise</p>
<pre><code>canReflect.isListLike(null); // -&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{*}</code>: <p>maybe a List-like</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isListLike","parent":"can-reflect/type","src":{"line":299,"codeLine":329,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value looks like a constructor function. \n","title":"isListLike","signatures":[{"code":"isListLike(list)","description":"\n\nReturn `true` if `list` is a `String`, <br>OR `list` is _not_ a primitive and implements `@@iterator`,\n<br>OR `list` is _not_ a primitive and returns `true` for `Array.isArray()`, <br>OR `list` is _not_ a primitive and has a\nnumerical length and is either empty (`length === 0`) or has a last element at index `length - 1`; <br>`false` otherwise\n\n```\ncanReflect.isListLike(null); // -> false\ncanReflect.isListLike({}); // -> false\ncanReflect.isListLike([]); // -> true\ncanReflect.isListLike(\"foo\"); // -> true\ncanReflect.isListLike(1); // -> false\ncanReflect.isListLike({ [canSymbol.for(\"can.isListLike\")]: true }); // -> true\ncanReflect.isListLike({ [canSymbol.iterator]: function() {} }); // -> true\ncanReflect.isListLike({ length: 0 }); // -> true\ncanReflect.isListLike({ length: 3 }); // -> false\ncanReflect.isListLike({ length: 3, \"2\": true }); // -> true\ncanReflect.isListLike(new DefineMap()); // -> false\ncanReflect.isListLike(new DefineList()); // -> true\n```\n","params":[{"types":[{"type":"*"}],"name":"list","description":"maybe a List-like"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"list","description":"maybe a List-like"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
