...
<!--####################################################################
	...
	@function can-set.Algebra.prototype.id
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.id.html">id</a></li>
	...
	<div class="page-type">
		<h1>id</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L692">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>algebra.id(props)</code>
  </h2>
  <p>Returns the configured <code>id</code> property value from <code>props</code>.  If there are
multiple ids, a <code>JSON.stringify</code>-ed JSON object is returned with each
<a href="can-set.props.id.html" title="Defines the identify property.">id</a> value is returned.</p>
<pre><code class="language-js">var algebra1 = new set.Algebra(set.props.id(&quot;_id&quot;));
algebra1.id({_id: 5}) //-&gt; 5
...
algebra2.id({studentId: 6, classId: &quot;7&quot;, foo: &quot;bar&quot;})
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>An instance's raw data.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*|String}</code>: <p>If a single <a href="can-set.props.id.html" title="Defines the identify property.">id</a> is configured, it's value will be returned.
If multiple <a href="can-set.props.id.html" title="Defines the identify property.">id</a> properties are configured a <code>JSON.stringify</code>-ed object is returned.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.id","parent":"can-set.Algebra.prototype","src":{"line":691,"codeLine":718,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"id","signatures":[{"code":"algebra.id(props)","description":"\n\nReturns the configured `id` property value from `props`.  If there are\nmultiple ids, a `JSON.stringify`-ed JSON object is returned with each\n[can-set.props.id] value is returned.\n\n```js\nvar algebra1 = new set.Algebra(set.props.id(\"_id\"));\nalgebra1.id({_id: 5}) //-> 5\n\nvar algebra2 = new set.Algebra(\n  set.props.id(\"studentId\"),\n  set.props.id(\"classId\")\n);\n\nalgebra2.id({studentId: 6, classId: \"7\", foo: \"bar\"})\n    //-> '{\"studentId\": 6, \"classId\": \"7\"}'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An instance's raw data."}],"returns":{"types":[{"type":"*"},{"type":"String"}],"description":"If a single [can-set.props.id] is configured, it's value will be returned.\nIf multiple [can-set.props.id] properties are configured a `JSON.stringify`-ed object is returned.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An instance's raw data."},"_curReturn":{"types":[{"type":"*"},{"type":"String"}],"description":"If a single [can-set.props.id] is configured, it's value will be returned.\nIf multiple [can-set.props.id] properties are configured a `JSON.stringify`-ed object is returned.\n "},"pathToRoot":".."};
</script>
</article>
