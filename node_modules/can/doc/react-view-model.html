...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/react-view-model/docs/react-view-model.md
	@function react-view-model
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - react-view-model</title>
...
<div class="breadcrumb">
	...
	<li><a href="react-view-model.html">react-view-model</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>react-view-model</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/react-view-model">
						<img src="https://img.shields.io/badge/npm%20package-0.5.9-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/react-view-model" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/react-view-model/edit/master/docs/react-view-model.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create an auto-rendering container component with an observable view-model by providing a ViewModel and a React render function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>reactViewModel( [displayName], [ViewModel], renderFunction )</code>
  </h2>
  <p>Create an auto-rendering <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8">container component</a> by connecting an observable view-model to a React <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8">presentational render function</a>.</p>
<p>Every instance of the component will generate an instance of the ViewModel, initialized with the props, and provide it to the render function. Whenever the container component receives new props or a value on the viewModel changes, it will trigger an update.</p>
<p>If <code>displayName</code> is omitted, it will default based on the <code>renderFunction</code>'s name, or &quot;ReactVMComponentWrapper.&quot; This is really only significant when debugging.</p>
<p>If <code>ViewModel</code> is omitted, it will default to <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>. This will still provide the benefits of auto-rendering, though you cannot add smart properties like you can with a custom <code>ViewModel</code>.</p>
<pre><code class="language-jsx">export default reactViewModel( 'AppComponent', ViewModel, (viewModel) =&gt; (&lt;div&gt;{viewModel.name}&lt;/div&gt;) );
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>displayName</b> <code>{String}</code>: <p>The name of the created <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8">container component</a> (optional)</p>
</li>
        
          <li><b>ViewModel</b> <code>{<a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>}</code>: <p>A <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> constructor function (optional)</p>
</li>
        
          <li><b>renderFunction</b> <code>{function}</code>: <p>A React render function</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{ReactComponent}</code>: <p>An auto-rendering React Component</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>An example application using the ViewModel to create an extra prop, whose value is derived from other props.</p>
<div class='demo_wrapper' data-demo-src='demos/react-view-model/function.name.html'></div>
<p>An example application which includes viewModel mutation and demonstrates auto-rendering.</p>
<div class='demo_wrapper' data-demo-src='demos/react-view-model/function.counter.html'></div>
<p>You can also play with the above example on JS Bin:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/cudobut/2/embed?js,output">react-view-model demo on jsbin.com</a></p>
<p>You can also use this module with <a href="https://preactjs.com">Preact</a>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/muqeqec/5/embed?js,output">react-view-model demo with Preact on jsbin.com</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/react-view-model/docs/react-view-model.md"},"description":"Create an auto-rendering container component with an observable view-model by providing a ViewModel and a React render function. \n","title":"react-view-model","name":"react-view-model","parent":"can-ecosystem","type":"function","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"pattern":"docs/**/*.{js,md}","ignore":"node_modules/**/*"},"readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/react-view-model/issues"},"bundleDependencies":false,"dependencies":{"can-define":"^1.5.0","can-namespace":"^1.0.0","can-observation":"^3.0.1","can-stache-key":"^0.1.0","can-util":"^3.7.0"},"deprecated":false,"description":"Add Observable View-Models to React Components","devDependencies":{"babel-eslint":"^7.2.3","bit-docs":"0.0.7","detect-cyclic-packages":"^1.1.0","done-serve":"^1.3.0","eslint":"^4.1.0","eslint-plugin-react":"^7.1.0","react":"^16.0.0","react-dom":"^16.0.0","steal":"^1.5.3","steal-builtins":"^1.0.0","steal-qunit":"^1.0.0","steal-tools":"^1.3.5","testee":"0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs","react","viewmodel"],"main":"react-view-model","name":"react-view-model","peerDependencies":{"react":"15.x - 16.x"},"repository":{"type":"git","url":"git://github.com/canjs/react-view-model.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","document":"bit-docs","eslint":"eslint \"**/*.js\" --ignore-pattern \"dist\" --ignore-pattern \"node_modules\"","postversion":"git push --tags && git checkout master && git branch -D release && git push","prepublish":"npm run build","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run detect-cycle && npm run eslint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"0.5.9"},"signatures":[{"code":"reactViewModel( [displayName], [ViewModel], renderFunction )","description":"\n\nCreate an auto-rendering [container component](https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8) by connecting an observable view-model to a React [presentational render function](https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8).\n\nEvery instance of the component will generate an instance of the ViewModel, initialized with the props, and provide it to the render function. Whenever the container component receives new props or a value on the viewModel changes, it will trigger an update.\n\nIf `displayName` is omitted, it will default based on the `renderFunction`'s name, or \"ReactVMComponentWrapper.\" This is really only significant when debugging.\n\nIf `ViewModel` is omitted, it will default to [can-define/map/map]. This will still provide the benefits of auto-rendering, though you cannot add smart properties like you can with a custom `ViewModel`.\n\n```jsx\nexport default reactViewModel( 'AppComponent', ViewModel, (viewModel) => (<div>{viewModel.name}</div>) );\n```\n","params":[{"types":[{"type":"String"}],"name":"displayName","description":"The name of the created [container component](https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8) (optional)"},{"types":[{"type":"can-define/map/map"}],"name":"ViewModel","description":"A [can-define/map/map] constructor function (optional)"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"renderFunction","description":"A React render function\n"}],"returns":{"types":[{"type":"ReactComponent"}],"description":"An auto-rendering React Component\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"renderFunction","description":"A React render function\n"},"_curReturn":{"types":[{"type":"ReactComponent"}],"description":"An auto-rendering React Component\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
