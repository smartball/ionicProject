...
<!--####################################################################
	...
	@property connection.parseInstanceProp
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - parseInstanceProp</title>
...
up to date.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect/data/parse/parse.parseInstanceData.html"
...
and connection.destroyData.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect/data/parse/parse.parseListData.html"
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect/data/parse/parse.parseListProp.html"
...
<div class="breadcrumb">
		...
		<li><a href="can-connect/data/parse/parse.html">./data/parse/</a></li>
		<li> / </li>
	
	
	<li><a href="connection.parseInstanceProp.html">parseInstanceProp</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>parseInstanceProp</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/parse/parse.js#L276">Edit on GitHub</a>
				</li>
    ...
    <p>The property to find the data that represents an instance item.</p>
...
<div class="signature">
  ...
  <p><a href="can-connect/data/parse/parse.parseInstanceData.html" title="Returns the properties that should be used to make an instance given the results of connection.getData, connection.createData, connection.updateData,
and connection.destroyData.">parseInstanceData</a> uses this property's value to
<a href="can-connect/constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">make an instance</a>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Set <code>parseInstanceData</code> if your response data does not directly contain the data you would like to pass to
[connection.hydrateInstance].</p>
<p>For example, if <a href="can-connect/connection.getData.html" title="Retrieves a record.">getData</a> returns data like:</p>
<pre><code>{
  todo: {
       id: 1,
    name: &quot;dishes&quot;
...
<p>Set <code>parseInstanceProp</code> to <code>&quot;todo&quot;</code> like:</p>
<pre><code>connect([
...
<script type="text/javascript">
  window.docObject = {"src":{"line":275,"codeLine":317,"path":"node_modules/can-connect/data/parse/parse.js"},"type":"property","description":"\nThe property to find the data that represents an instance item.\n","types":[{"type":"String","description":"[can-connect/data/parse/parse.parseInstanceData] uses this property's value to\n[can-connect/constructor/constructor.hydrateInstance make an instance].\n"}],"title":"parseInstanceProp","name":"connection.parseInstanceProp","parent":"can-connect/data/parse/parse","comment":" ","pathToRoot":".."};
</script>
</article>
