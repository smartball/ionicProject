...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.union.html">union</a></li>
	...
	<div class="page-type">
		<h1>union</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L393">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns a set that represents the union of <em>A</em> and <em>B</em> (<em>A</em> ∪ <em>B</em>).</p>
<pre><code class="language-js">algebra.union(
  {start: 0, end: 99},
  {start: 100, end: 199},
) //-&gt; {start: 0, end: 199}
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>|undefined}</code>: <p>If an object is returned, it is the union of <em>A</em> and <em>B</em> (<em>A</em> ∪ <em>B</em>).</p>
<p>If <code>undefined</code> is returned, it means a union can't be created.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.union","parent":"can-set.Algebra.prototype","src":{"line":392,"codeLine":413,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"union","signatures":[{"code":"algebra.union(a, b)","description":"\n\nReturns a set that represents the union of _A_ and _B_ (_A_ ∪ _B_).\n\n```js\nalgebra.union(\n  {start: 0, end: 99},\n  {start: 100, end: 199},\n) //-> {start: 0, end: 199}\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"a","description":"A set."},{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."}],"returns":{"types":[{"type":"can-set/Set"},{"type":"undefined"}],"description":"If an object is returned, it is the union of _A_ and _B_ (_A_ ∪ _B_).\n\nIf `undefined` is returned, it means a union can't be created.\n "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."},"_curReturn":{"types":[{"type":"can-set/Set"},{"type":"undefined"}],"description":"If an object is returned, it is the union of _A_ and _B_ (_A_ ∪ _B_).\n\nIf `undefined` is returned, it means a union can't be created.\n "},"pathToRoot":".."};
</script>
</article>
