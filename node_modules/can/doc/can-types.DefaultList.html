...
<!--####################################################################
	...
	@property can-types.DefaultList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DefaultList</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-types.DefaultList.html">DefaultList</a></li>
	...
	<div class="page-type">
		<h1>DefaultList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-types/edit/master/can-types.js#L84">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code><a href="can-connect.List.html" title="A list type.">List</a></code>
  </h2>
  <p>The default list type to create if a list is needed. If both <a href="can-list.html" title="">can-list</a> and <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>
are imported, the default type will be <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-types.DefaultList","type":"property","parent":"can-types","src":{"line":83,"codeLine":91,"path":"node_modules/can-types/can-types.js"},"description":"\n","types":[{"type":"can-connect.List","description":"\n\n  The default list type to create if a list is needed. If both [can-list] and [can-define/list/list]\n  are imported, the default type will be [can-define/list/list].\n "}],"title":"DefaultList","pathToRoot":".."};
</script>
</article>
