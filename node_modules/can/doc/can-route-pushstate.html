...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-route-pushstate/can-route-pushstate.md
	...
	<div class="page-type">
		<h1>can-route-pushstate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-route-pushstate" data-show-count="true">Star</a>
				</li>
