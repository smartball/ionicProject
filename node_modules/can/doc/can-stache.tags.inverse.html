...
<div class="breadcrumb">
	...
	<li><a href="can-stache.tags.inverse.html">{{^expression}}</a></li>
...
<p>For example:</p>
<pre><code>{{^ isOver18(person) }} Can't Vote {{/isOver18}}
</code></pre>
