...
<!--####################################################################
	...
	@function can-reflect.getValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.getValue.html">getValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/get-set/get-set.js#L115">Edit on GitHub</a>
				</li>
    ...
    <p>Get the value of an object with a gettable value</p>
...
<div class="signature">
  ...
  <p>Return the value of the Value-like object <code>obj</code>.  Unless <code>obj</code> implements
<a href="can-symbol/symbols/getValue.html" title="Defines a function that returns the object's current value when called.">@@can.getValue</a>, the result of <code>getValue</code> on
<code>obj</code> will always be <code>obj</code>.  Observable Map-like objects may want to implement
<code>@@can.getValue</code> to return non-observable or plain representations of themselves.</p>
...
canReflect.getValue(primitive); // -&gt; &quot;bar&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to get from</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>the value of the object via <code>@@can.getValue</code>, or the value itself.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.getValue","parent":"can-reflect/get-set","src":{"line":114,"codeLine":137,"path":"node_modules/can-reflect/reflections/get-set/get-set.js"},"description":"Get the value of an object with a gettable value \n","title":"getValue","signatures":[{"code":"getValue(obj)","description":"\n\nReturn the value of the Value-like object `obj`.  Unless `obj` implements\n[can-symbol/symbols/getValue @@can.getValue], the result of `getValue` on\n`obj` will always be `obj`.  Observable Map-like objects may want to implement\n`@@can.getValue` to return non-observable or plain representations of themselves.\n\n```\nvar compute = canCompute(\"foo\");\nvar primitive = \"bar\";\n\ncanReflect.getValue(compute); // -> \"foo\"\ncanReflect.getValue(primitive); // -> \"bar\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to get from"}],"returns":{"types":[{"type":"*"}],"description":"the value of the object via `@@can.getValue`, or the value itself.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to get from"},"_curReturn":{"types":[{"type":"*"}],"description":"the value of the object via `@@can.getValue`, or the value itself.\n "},"pathToRoot":".."};
</script>
</article>
