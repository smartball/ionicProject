...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-types/can-types.js
	@module can-types
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-types</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-types.DefaultList.html"
							title="">
							DefaultList
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-types.DefaultMap.html"
							title="">
							DefaultMap
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-types.queueTask.html"
							title="can-types.queueTask">
							queueTask
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-types.unwrapElement.html"
							title="can-types.unwrapElement">
							unwrapElement
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-types.wrapElement.html"
							title="can-types.wrapElement">
							wrapElement
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-types.html">can-types</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-types</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-types">
						<img src="https://img.shields.io/badge/npm%20package-1.1.3-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-types" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-types/edit/master/can-types.js#L6">Edit on GitHub</a>
				</li>
    ...
    <p>A stateful container for CanJS type information.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-types</code> exports an object with placeholder functions that
can be used to provide default types or test if something is of a certain type.</p>
<p>For example, <code>can-define/map/map</code> might overwrite <code>DefeaultMap</code> to return DefineMap</p>
<pre><code class="language-js">types.DefaultMap = DefineMap;
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"name":"can-types","type":"module","parent":"can-infrastructure","src":{"line":5,"codeLine":25,"path":"node_modules/can-types/can-types.js"},"description":"A stateful container for CanJS type information. \n","title":"","types":[{"type":"Object","options":[]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-types/issues"},"bundleDependencies":false,"dependencies":{"can-globals":"^0.2.2","can-log":"^0.1.0","can-namespace":"1.0.0","can-reflect":"^1.0.0","can-symbol":"^1.0.0"},"deprecated":false,"description":"A stateful container for CanJS type information","devDependencies":{"jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-types","name":"can-types","repository":{"type":"git","url":"git://github.com/canjs/can-types.git"},"scripts":{"build":"node build.js","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"1.1.3"},"comment":" ","pathToRoot":".."};
</script>
</article>
