...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/default.md
	@function can-stache.helpers.default
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#default()}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.default.html">{{#default()}}</a></li>
	...
	<div class="page-type">
		<h1>{{#default()}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/default.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Renders <code>BLOCK</code> if no <a href="can-stache.helpers.case.html" title="">{{#case(expression)}}</a> blocks within the <a href="can-stache.helpers.switch.html" title="">{{#switch(expression)}}</a> resolved.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>BLOCK</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>a template to be rendered.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>default</code> helper is contextual inside of a <a href="can-stache.helpers.switch.html" title="">{{#switch(expression)}}</a> block. It acts as a fall-through in case none of the <a href="can-stache.helpers.case.html" title="">{{#case(expression)}}</a> helpers resolved.</p>
<p>For more information on how <code>{{#default()}}</code> is used check:</p>
<ul>
<li><a href="can-stache.helpers.switch.html" title="">{{#switch(expr)}}</a></li>
<li><a href="can-stache.helpers.case.html" title="">{{#case(expr)}}</a></li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/default.md"},"description":"\n","title":"{{#default()}}","name":"can-stache.helpers.default","type":"function","parent":"can-stache.htags","order":15,"signatures":[{"code":"{{#default()}}BLOCK{{/default}}","description":"\n\nRenders `BLOCK` if no [can-stache.helpers.case] blocks within the [can-stache.helpers.switch] resolved.\n\n```\n{{#switch(user.type)}}\n\t{{#case(\"admin\")}}\n\t\t<button value=\"edit\"/>\n\t{{/case}}\n\t{{#case(\"manager\")}}\n\t\t<button value=\"view\">\n\t{{/case}}\n\t{{#default()}}\n\t\tYou do not have permission!\n\t{{/default}}\n{{/switch}}\n```\n\n","params":[{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"a template to be rendered.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"a template to be rendered.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
