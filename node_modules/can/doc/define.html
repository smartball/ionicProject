...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/can-globals-proto.js
	@function define
######################################################################## -->
<html lang="en">
<head>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>define</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/can-globals-proto.js#L21">Edit on GitHub</a>
				</li>
    ...
    <p>Create a new global environment variable.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>globals.define(key, value[, cache])</code>
  </h2>
  <p>Defines a new global called <code>key</code>, who's value defaults to <code>value</code>.</p>
<p>The following example defines the <code>global</code> key's default value to the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window"><code>window</code></a> object:</p>
<pre><code class="language-javascript">globals.define('global', window);
globals.getKeyValue('window') //-&gt; window
</code></pre>
<p>If a function is provided and <code>cache</code> is falsy, that function is run every time the key value is read:</p>
<pre><code class="language-javascript">globals.define('isBrowserWindow', function() {
...
<p>If a function is provided and <code>cache</code> is truthy, that function is run only the first time the value is read:</p>
<pre><code class="language-javascript">globals.define('isWebkit', function() {
  console.log('EVALUATING')
...
globals.getKeyValue('isWebkit') // Does NOT log again!
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key value to create.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>The default value. If this is a function, its return value will be used.</p>
</li>
        
          <li><b>cache</b> <code>{Boolean}</code>: <p>Enable cache. If false the <code>value</code> function is run every time the key value is read.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-globals.html" title="An environment agnostic container for global variables. Useful for testing and server-side rendering (SSR), typically used internally by CanJS.">can-globals</a>}</code>: <p>Returns the instance of <code>can-globals</code> for chaining.</p>
</p>
  </div>
