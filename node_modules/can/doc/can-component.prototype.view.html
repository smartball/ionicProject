...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/view.md
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>view</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/view.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a view to render directly within the component’s element. The view is rendered with the
...
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a> instance.  <code>&lt;content/&gt;</code> elements within the view are replaced by the source elements within the component’s tag.</p>
...
<pre><code>Component({
  ...
  view: stache(&quot;&lt;ul&gt;{{#panels}}&lt;li&gt;{{title}}&lt;/li&gt; ...&quot;)
    ...
    <section class="body">
    <h2>Use</h2>
<p>The view specified by the <code>view</code> property works similar to
...
with the <a href="can-component/content.html" title="Positions the LIGHT_DOM within a component’s can-component.prototype.view."><content></a> tag.</p>
<p>There are three things to understand about a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>’s view:</p>
<ul>
<li>It is inserted into the component’s tag.</li>
<li>It is rendered with access to the component instance’s viewModel.</li>
<li>Any <a href="can-component/content.html" title="Positions the LIGHT_DOM within a component’s can-component.prototype.view."><code>&lt;content&gt;</code></a> tags within the view act as insertion points for the source elements.</li>
</ul>
...
<p>This registers a component for elements like <code>&lt;my-greeting&gt;</code>. Its view
...
<p>The source view is the view that
...
<p>This is how we render the source view that uses <code>&lt;my-greeting&gt;</code>. The view is rendered with <code>site</code> in its <a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
to the component’s view. The constructor function
...
<p>This is the result of the view transformations. The
...
<h2>View insertion</h2>
<p>The view specified by <code>view</code> is rendered directly within the custom tag.</p>
...
<p>that content is removed, and replaced by the component’s view:</p>
<pre><code>&lt;header&gt;
  &lt;my-greeting&gt;&lt;h1&gt;Hello There&lt;/h1&gt;&lt;/my-greeting&gt;
&lt;/header&gt;
</code></pre>
...
view. For example, if we change the component to look like:</p>
<pre><code>Component({
  tag: &quot;my-greeting&quot;,
