...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/prototype.set.md
	@function can-view-scope.prototype.set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.prototype.set.html">set</a></li>
	...
	<div class="page-type">
		<h1>set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/prototype.set.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.set(key, value [, options])</code>
  </h2>
  <p>Tries to set <code>key</code> in the scope to <code>value</code>.  This looks for the first context in the value where
<code>key</code> can be set.  For example, if <code>key</code> is <code>&quot;person.first.name&quot;</code>, it will find the first
context where <code>person.first</code> is some type of Object whose <code>name</code> property can be set.</p>
<pre><code class="language-js">scope.set(&quot;person.first.name&quot;, &quot;Justin&quot;);
</code></pre>
...
property name that includes a dot.</p>
          ...
          <li><b>value</b> <code>{*}</code>: <p>The value to be set.</p>
</li>
