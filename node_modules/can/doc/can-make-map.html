...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-make-map/can-make-map.js
	@module can-make-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-make-map</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-make-map.html">can-make-map</a></li>
	...
	<div class="page-type">
		<h1>can-make-map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-make-map/edit/master/can-make-map.js">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-make-map","parent":"can-infrastructure","src":{"line":0,"codeLine":9,"path":"node_modules/can-make-map/can-make-map.js"},"description":"","title":"can-make-map","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeMap( string )","description":"","params":[{"types":[{"type":"String"}],"name":"string","description":"A comma separated list of values"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A JavaScript object with the same keys as the passed-in comma-separated values\n\nmakeMap takes a comma-separated string (can-list, NodeList, etc.) and converts it to a JavaScript object\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"string","description":"A comma separated list of values"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A JavaScript object with the same keys as the passed-in comma-separated values\n\nmakeMap takes a comma-separated string (can-list, NodeList, etc.) and converts it to a JavaScript object\n"},"pathToRoot":".."};
</script>
</article>
