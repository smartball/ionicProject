...
<div class="breadcrumb">
	...
	<li><a href="can-route.current.html">current</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>current</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L728">Edit on GitHub</a>
				</li>
    ...
    <p>Check if data represents the current route.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>route.current(data [,subsetMatch] )</code>
  </h2>
  <p>Compares <code>data</code> to the current route. Used to verify if an object is
representative of the current route.</p>
<pre><code>route.data.set({page: &quot;recipes&quot;, id: '5'});
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>data</b> <code>{Object}</code>: <p>Data to check agains the current route.</p>
</li>
        
          <li><b>subsetMatch</b> <code>{Boolean}</code>: <p>If true, <code>route.current</code> will return true
if every value in <code>data</code> matches the current route data, even if
the route data has additional properties that are not matched.  Defaults to <code>false</code>
where every property needs to be present.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>Whether the data matches the current URL.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Checks the page's current URL to see if the route represents the options
passed into the function.</p>
<p>Returns true if the options represent the current URL.</p>
<pre><code class="language-js">route.data.id = 5; // location.hash -&gt; &quot;#!id=5&quot;
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.current","parent":"can-route.static","src":{"line":727,"codeLine":771,"path":"node_modules/can-route/can-route.js"},"description":"\nCheck if data represents the current route.\n","title":"current","signatures":[{"code":"route.current(data [,subsetMatch] )","description":"\n\nCompares `data` to the current route. Used to verify if an object is\nrepresentative of the current route.\n\n```\nroute.data.set({page: \"recipes\", id: '5'});\n\nroute.current({page: \"recipes\"});       //-> false\nroute.current({page: \"recipes\"}, true); //-> true\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"data","description":"Data to check agains the current route."},{"types":[{"type":"Boolean"}],"optional":true,"name":"subsetMatch","description":"If true, `route.current` will return true\nif every value in `data` matches the current route data, even if\nthe route data has additional properties that are not matched.  Defaults to `false`\nwhere every property needs to be present."}],"returns":{"types":[{"type":"Boolean"}],"description":"Whether the data matches the current URL.\n"}}],"_curParam":{"types":[{"type":"Boolean"}],"optional":true,"name":"subsetMatch","description":"If true, `route.current` will return true\nif every value in `data` matches the current route data, even if\nthe route data has additional properties that are not matched.  Defaults to `false`\nwhere every property needs to be present."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"Whether the data matches the current URL.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
