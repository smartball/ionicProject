...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/async_computer.md
	@typedef can-compute.asyncComputer
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - asyncComputer</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.asyncComputer.html">asyncComputer</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>asyncComputer</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/async_computer.md">Edit on GitHub</a>
				</li>
    ...
    <p>A function that determines a value for an <a href="can-compute.async.html" title="Create a compute that can set its value after the computed function has been called.">async compute</a>.</p>
...
<div class="signature">
  ...
  <p>The function callback to <a href="can-compute.async.html" title="Create a compute that can set its value after the computed function has been called.">async</a> that determines
the value of the compute.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>lastSetValue</b> <code>{*}</code>: <p>The last set value of the compute.  This should be returned
if you are doing an in-place compute.</p>
</li>
        
          <li><b>setVal</b> <code>{function(newVal)}</code>: <p>Called to update the value
of the compute at a later time.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>If a <code>setVal</code> argument is not provided, the return value
is set as the current value of the compute.  If <code>setVal</code> is provided and
undefined is returned, the current value remains until <code>setVal</code> is called.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-compute/docs/async_computer.md"},"description":"\nA function that determines a value for an [can-compute.async async compute].\n","type":"typedef","title":"asyncComputer","types":[{"type":"function","returns":{"types":[{"type":"*"}],"description":"If a `setVal` argument is not provided, the return value\nis set as the current value of the compute.  If `setVal` is provided and\nundefined is returned, the current value remains until `setVal` is called.\n"},"params":[{"types":[{"type":"*"}],"optional":true,"name":"lastSetValue","description":"The last set value of the compute.  This should be returned\nif you are doing an in-place compute. \n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newVal"}]}],"optional":true,"name":"setVal","description":"Called to update the value \nof the compute at a later time. \n"}],"description":"The function callback to [can-compute.async] that determines\nthe value of the compute.\n"}],"name":"can-compute.asyncComputer","parent":"can-compute","release":"2.1","hide":true,"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newVal"}]}],"optional":true,"name":"setVal","description":"Called to update the value \nof the compute at a later time. \n"},"_curReturn":{"types":[{"type":"*"}],"description":"If a `setVal` argument is not provided, the return value\nis set as the current value of the compute.  If `setVal` is provided and\nundefined is returned, the current value remains until `setVal` is called.\n"},"pathToRoot":".."};
</script>
</article>
