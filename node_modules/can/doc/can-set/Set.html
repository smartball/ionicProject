...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/docs/can-set.Set.md
	@typedef can-set/Set
######################################################################## -->
<html lang="en">
<head>
	...
	<div class="page-type">
		<h1>Set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/docs/can-set.Set.md">Edit on GitHub</a>
				</li>
...
<p>A <a href="../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a> is used to detail the behavior of these sets like:</p>
