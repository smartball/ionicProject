...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/can-stream.md
	@module can-stream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-stream</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-stream</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-stream">
						<img src="https://img.shields.io/badge/npm%20package-0.3.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-stream" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/can-stream.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create useful stream methods from a minimal stream wrapper implementation.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream(streamImplementation)</code>
  </h2>
  <p>Exports a function that takes a <a href="can-stream.types.streamImplementation.html" title="Export an object with a minimal implementation of toStream and toCompute methods specific to a streaming library like Kefir">StreamImplementation</a> (like <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a>) and uses it internally to provide several useful string methods.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>streamImplementation</b> <code>{<a href="can-stream.types.streamImplementation.html" title="Export an object with a minimal implementation of toStream and toCompute methods specific to a streaming library like Kefir">StreamImplementation</a>}</code>: <p>A <a href="can-stream.types.streamImplementation.html" title="Export an object with a minimal implementation of toStream and toCompute methods specific to a streaming library like Kefir">StreamImplementation</a> object that implements the <code>toStream</code> and <code>toCompute</code> methods for a stream library.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-stream.types.streamInterface.html" title="Stream interface function returned from can-stream">streamInterface</a>()}</code>: <p>An object that has the following methods:</p>
<ul>
<li>.toStream(observable, propAndOrEvent[,event])</li>
<li>.toStreamFromProperty(property)</li>
<li>.toStreamFromEvent(property)</li>
<li>.toCompute(<a href="can-stream.types.makeStream.html" title="This function takes a stream whose values are bound to the returned can-compute.computed.">makeStream(setStream)</a>, context):compute</li>
</ul>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>See <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> for an example.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/can-stream.md"},"description":"Create useful stream methods from a minimal stream wrapper implementation. \n","type":"module","title":"can-stream","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-stream","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"readme":{"apis":["can-stream"]},"parent":"can-stream"},"bugs":{"url":"https://github.com/canjs/can-stream/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.2.0","can-define":"^1.2.0","can-event":"^3.5.0","can-observation":"^3.2.0","can-types":"^1.1.0","can-util":"^3.9.0","kefir":"^3.5.1"},"deprecated":false,"description":"Stream values into and out of computes","devDependencies":{"bit-docs":"0.0.7","done-serve":"^1.2.4","donejs-cli":"^1.0.2","generator-donejs":"^0.9.0","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.6.1"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-stream","name":"can-stream","repository":{"type":"git","url":"git://github.com/canjs/can-stream.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"0.3.1"},"signatures":[{"code":"canStream(streamImplementation)","description":"\n\nExports a function that takes a [can-stream.types.streamImplementation] (like [can-stream-kefir]) and uses it internally to provide several useful string methods.\n","params":[{"types":[{"type":"can-stream.types.streamImplementation"}],"name":"streamImplementation","description":"A [can-stream.types.streamImplementation] object that implements the `toStream` and `toCompute` methods for a stream library.\n"}],"returns":{"types":[{"type":"can-stream.types.streamInterface"}],"description":"An object that has the following methods:\n\n- .toStream(observable, propAndOrEvent[,event])\n- .toStreamFromProperty(property)\n- .toStreamFromEvent(property)\n- .toCompute([can-stream.types.makeStream makeStream(setStream)], context):compute\n"}}],"_curParam":{"types":[{"type":"can-stream.types.streamImplementation"}],"name":"streamImplementation","description":"A [can-stream.types.streamImplementation] object that implements the `toStream` and `toCompute` methods for a stream library.\n"},"_curReturn":{"types":[{"type":"can-stream.types.streamInterface"}],"description":"An object that has the following methods:\n\n- .toStream(observable, propAndOrEvent[,event])\n- .toStreamFromProperty(property)\n- .toStreamFromEvent(property)\n- .toCompute([can-stream.types.makeStream makeStream(setStream)], context):compute\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
