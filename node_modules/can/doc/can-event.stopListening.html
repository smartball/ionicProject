...
<head>
	<meta charset="utf-8">
	<title>CanJS - stopListening</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-event.stopListening.html">stopListening</a></li>
	...
	<div class="page-type">
		<h1>stopListening</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L332">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Stops listening for an event on another object.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>other</b> <code>{Object}</code>: <p>The object to listen for events on.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event.stopListening","parent":"can-event.static","src":{"line":331,"codeLine":347,"path":"node_modules/can-event/can-event.js"},"description":"","title":"stopListening","signatures":[{"code":"obj.stopListening(other, event, handler)","description":"\n\nStops listening for an event on another object.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"other","description":"The object to listen for events on."},{"types":[{"type":"String"}],"name":"event","description":"The name of the event to listen for."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"The handler that will be executed to handle the event."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"this\n"}},{"code":"canEvent.stopListening.call(obj, other, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n ","params":[]}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"this\n"},"pathToRoot":".."};
</script>
</article>
