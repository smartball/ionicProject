...
<!--####################################################################
	...
	@function can-fixture-socket.storeToListeners
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - storeToListeners</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.storeToListeners.html">storeToListeners</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>storeToListeners</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/src/store.js#L66">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a set of listeners transformed from fixture store request handlers. Useful for working with REST-ful resources.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>storeToListeners( fixtureStore )</code>
  </h2>
  <p>Wraps methods of fixture.store to make them socket event listener.</p>
<pre><code class="language-js">var listeners = storeToListeners( fixtureStore );
...
server.on({
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p>Fixture <a href="can-fixture.store.html" title="">store</a> provides REST-ful resource storage. Its designed to work with XHR requests thus its methods expect two arguments <code>request</code> and <code>response</code>. To work with socket events we need to transform request handlers into socket event listeners.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-fixture-socket.storeToListeners","parent":"can-fixture-socket.properties","src":{"line":65,"codeLine":122,"path":"node_modules/can-fixture-socket/src/store.js"},"description":"\nReturns a set of listeners transformed from fixture store request handlers. Useful for working with REST-ful resources.\n","title":"storeToListeners","signatures":[{"code":"storeToListeners( fixtureStore )","description":"\n\nWraps methods of fixture.store to make them socket event listener.\n\n```js\nvar listeners = storeToListeners( fixtureStore );\n\nserver.on({\n  \"news find\": listeners.getListData,\n  \"news get\": listeners.getData,\n})\n```\n","params":[{"name":"fixtureStore","description":""}]}],"_curParam":{"name":"fixtureStore","description":""},"returns":"{*}","comment":" ","pathToRoot":".."};
</script>
</article>
