...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-live/lib/core.js
	@module can-view-live
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-live</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-live.html.html"
							title="Live binds a compute&#x27;s value to a collection of elements.">
							html
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-live.html">can-view-live</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-live</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-live">
						<img src="https://img.shields.io/badge/npm%20package-3.2.4-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-live" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-live/edit/master/lib/core.js#L13">Edit on GitHub</a>
				</li>
    ...
    <p>Setup live-binding between the DOM and a compute manually.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>An</b> <code>{Object}</code>:
        <p>object with the live-binding methods:
<a href="can-view-live.html.html" title="Live binds a compute's value to a collection of elements.">html</a>, <a href="can-view-live.list.html" title="">list</a>, <a href="can-view-live.text.html" title="">text</a>, and
<a href="can-view-live.attr.html" title="">attr</a>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p><a href="can-view-live.html" title="Setup live-binding between the DOM and a compute manually.">can-view-live</a> is an object with utility methods for setting up
live-binding in relation to different parts of the DOM and DOM elements.  For
example, to make an <code>&lt;h2&gt;</code>'s text stay live with
a compute:</p>
<p>var live = require(&quot;can-view-live&quot;);
var text = canCompute(&quot;Hello World&quot;);
var textNode = $(&quot;h2&quot;).text(&quot; &quot;)[0].childNodes[0];
live.text(textNode, text);</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-view-live","type":"module","parent":"can-infrastructure","src":{"line":12,"codeLine":41,"path":"node_modules/can-view-live/lib/core.js"},"description":"\nSetup live-binding between the DOM and a compute manually.\n","title":"can-view-live","types":[{"type":"Object","options":[{"name":"An","description":"object with the live-binding methods:\n[can-view-live.html], [can-view-live.list], [can-view-live.text], and\n[can-view-live.attr].\n","types":[{"type":"Object","options":[]}]}]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-view-live/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.3.1","can-event":"^3.6.0","can-observation":"^3.3.1","can-reflect":"^1.2.1","can-types":"^1.1.0","can-util":"^3.9.6","can-view-callbacks":"^3.2.0","can-view-nodelist":"^3.1.0","can-view-parser":"^3.4.0","can-view-target":"^3.1.0"},"deprecated":false,"description":"[![Join the chat at https://gitter.im/canjs/canjs](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/canjs/canjs?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/canjs/can-view-live/blob/master/LICENSE.md) [![npm version](https://badge.fury.io/js/can-view-live.svg)](https://www.npmjs.com/package/can-view-live) [![Travis build status](https://travis-ci.org/canjs/can-view-live.svg?branch=master)](https://travis-ci.org/canjs/can-view-live) [![Greenkeeper badge](https://badges.greenkeeper.io/canjs/can-view-live.svg)](https://greenkeeper.io/)","devDependencies":{"can-list":"^3.2.0","can-map":"^3.3.1","detect-cyclic-packages":"^1.1.0","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["CanJS","DoneJS"],"main":"can-view-live","name":"can-view-live","repository":{"type":"git","url":"git://github.com/canjs/can-view-live.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint lib/**/*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-view-live","configDependencies":["live-reload"],"npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.2.4"},"release":"2.0.4","comment":" ","pathToRoot":".."};
</script>
</article>
