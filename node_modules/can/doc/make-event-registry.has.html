...
<!--####################################################################
	...
	@function make-event-registry.has
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - eventRegistry.has</title>
...
<div class="breadcrumb">
	...
	<li><a href="make-event-registry.has.html">eventRegistry.has</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>eventRegistry.has</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-dom-events/edit/master/helpers/make-event-registry.js#L33">Edit on GitHub</a>
				</li>
    ...
    <p>Check whether an event type has already been registered.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>eventRegistry.has( eventType )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>The event type for which to check.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>Whether the event type is registered.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"make-event-registry.has","parent":"make-event-registry.registry","src":{"line":32,"codeLine":42,"path":"node_modules/can-dom-events/helpers/make-event-registry.js"},"description":"\nCheck whether an event type has already been registered.\n","title":"eventRegistry.has","signatures":[{"code":"eventRegistry.has( eventType )","description":"","params":[{"types":[{"type":"String"}],"name":"eventType","description":"The event type for which to check."}],"returns":{"types":[{"type":"Boolean"}],"description":"Whether the event type is registered.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"eventType","description":"The event type for which to check."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"Whether the event type is registered.\n"},"pathToRoot":".."};
</script>
</article>
