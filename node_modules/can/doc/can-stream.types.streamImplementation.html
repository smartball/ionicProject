...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/types.streamImplementation.md
	@typedef can-stream.types.streamImplementation
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - StreamImplementation</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/implementation.toCompute.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/implementation.toStream.html"
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>StreamImplementation</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/types.streamImplementation.md">Edit on GitHub</a>
				</li>
    ...
    <p>Export an object with a minimal implementation of <code>toStream</code> and <code>toCompute</code> methods specific to a streaming library like <a href="https://rpominov.github.io/kefir/">Kefir</a></p>
...
<div class="signature">
  ...
  <p>An object with <code>toStream</code> and <code>toCompute</code> methods.</p>
<pre><code class="language-js">var streamImplementation = {
...
module.exports = streamInterface;
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>toStream</b> <code>{<a href="can-stream/type/implementation.toStream.html" title="Create a stream from an observable.">toStream</a>(compute)}</code>:
        
      </li>
    
      <li>
        <b>toCompute</b> <code>{<a href="can-stream/type/implementation.toCompute.html" title="Creates a can-compute.computed from a stream generator function.">toCompute</a>(makeStream, context)}</code>:
    ...
    <section class="body">
    <h2>Use</h2>
<p>See <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> for example implementation.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/types.streamImplementation.md"},"description":"Export an object with a minimal implementation of `toStream` and `toCompute` methods specific to a streaming library like [Kefir](https://rpominov.github.io/kefir/) \n","type":"typedef","title":"StreamImplementation","types":[{"type":"Object","options":[{"name":"toStream","description":"\n","types":[{"type":"can-stream/type/implementation.toStream"}]},{"name":"toCompute","description":"\n","types":[{"type":"can-stream/type/implementation.toCompute"}]}],"description":"\n  An object with `toStream` and `toCompute` methods.\n\n```js\nvar streamImplementation = {\n\ttoStream: function(compute){\n\t\treturn MAKE_THE_STREAM_FROM_A_COMPUTE(compute);\n\t},\n\ttoCompute: function(makeStream, context){\n\t\tvar setStream = MAKE_A_SETTABLE_STREAM_THAT_IS_SET_WHEN_COMPUTE_IS_SET();\n\t\tvar stream = makeStream.call(context, setStream);\n\n\t\tvar compute = MAKE_COMPUTE_TO_HAVE_VALUE_FROM_stream_AND_SET_TO_setStream;\n\n\t\treturn compute;\n\t}\n};\n\nvar canStream = require(\"can-stream\");\n\nvar streamInterface = canStream(streamImplementation);\n\nvar map = new DefineMap({name: \"John\"});\nstreamInterface(map, \".name\") //-> an instance of the stream library.\n\nmodule.exports = streamInterface;\n```\n"}],"name":"can-stream.types.streamImplementation","parent":"can-stream.types","comment":" ","pathToRoot":".."};
</script>
</article>
