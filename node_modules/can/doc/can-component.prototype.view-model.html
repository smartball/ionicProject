...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/view-model.md
	@function can-component.prototype.view-model
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-component.prototype.view-model.html">viewModel</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>viewModel</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/view-model.md">Edit on GitHub</a>
				</li>
    ...
    <p>Return the view model instance or type with which the component’s <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
...
<div class="signature">
  <h2 class="signature-title">
    <code>function(properties, parentScope, element)</code>
  </h2>
  <p>The <code>viewModel</code> function takes the <code>properties</code> and values that are used to
typically initialize a <a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a>, the
<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> the component is rendered within, and the component’s element
and returns either the view-model instance or ViewModel type that the component’s <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
component’s can-component::ViewModel instance.  &lt;content/&gt; elements within the view are replaced by the source elements within the component’s tag.">view</a>
is rendered with.</p>
<p>This is typically used only for special situations where a custom scope or custom bindings
need to be setup.</p>
<pre><code>var Component = require(&quot;can-component&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>properties</b> <code>{Object}</code>: <p>An object of values specified by the custom element’s attributes. For example, a view rendered like:</p>
...
<p>And calls the viewModel function with <code>properties</code> like <code>{title: &quot;Justin&quot;}</code>.</p>
</li>
        
          <li><b>parentScope</b> <code>{<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>}</code>: <p>The viewModel the custom tag was found within.  By default, any attribute’s values will
...
<p>Notice how the <code>middleName</code> value is looked up in <code>my-element</code>’s parent scope.</p>
</li>
        
          <li><b>element</b> <code>{HTMLElement}</code>: <p>The element the <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a> is going to be placed on. If you want
...
<p>This example should be done with the <a href="can-component.prototype.events.html" title="Listen to events on elements and observables.">events</a> object instead.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Map|Object}</code>: <p>Returns one of the following.</p>
<ul>
<li>An observable map or list type.</li>
<li>The prototype of an observable map or list type that will be used to render the component’s view.</li>
</ul>
</p>
  </div>
