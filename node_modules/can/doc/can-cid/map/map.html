...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-cid/map/map.md
	@module can-cid/map/map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-cid/map/map</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-cid/map/map</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-cid/edit/master/map/map.md">Edit on GitHub</a>
				</li>
    ...
    <p>Exports the native <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map">Map</a>
or a polyfill.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p>This module exports the native <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map">Map</a>
object if <code>Map</code> is present.  If not, a <code>Map</code>-like constructor function is exported that supports <code>O(1)</code> insertion and
deletion by adding a <a href="../../can-cid.html" title="can-cid">can-cid</a> property to objects passed to <code>.set</code>.</p>
<pre><code class="language-js">var Map = require(&quot;can-util/js/cid-map/cid-map&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-cid/map/map.md"},"description":"\nExports the native [Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map)\nor a polyfill.\n","type":"module","title":"","types":[{"type":"Map"}],"name":"can-cid/map/map","parent":"can-cid","comment":" ","pathToRoot":"../../.."};
</script>
</article>
