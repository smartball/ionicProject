...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/types.streamInterface.md
	@typedef can-stream.types.streamInterface
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - streamInterface</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/interface.toCompute.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/interface.toStream.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/interface.toStreamFromEvent.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stream/type/interface.toStreamFromProperty.html"
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>streamInterface</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/types.streamInterface.md">Edit on GitHub</a>
				</li>
    ...
    <p>Stream interface function returned from <a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a></p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>streamInterface( observable, propAndOrEvent[,event] )</code>
  </h2>
  <p>The stream interface function returned from <a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a> that has the following property methods:</p>
<ul>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>observable</b> <code>{Object}</code>: <p>An observable object</p>
</li>
        
          <li><b>property</b> <code>{String}</code>: <p>A property of the observable object prepended with <code>.</code></p>
</li>
        
          <li><b>event</b> <code>{String}</code>: <p>An optional event name of the observable object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/types.streamInterface.md"},"description":"Stream interface function returned from [can-stream] \n","type":"typedef","title":"streamInterface","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-stream.types.streamInterface","parent":"can-stream.types","signatures":[{"code":"streamInterface( observable, propAndOrEvent[,event] )","description":"\n\nThe stream interface function returned from [can-stream] that has the following property methods:\n\n- .toStream(observable, propAndOrEvent[,event])\n- .toStreamFromProperty(property)\n- .toStreamFromEvent(property)\n- .toCompute([can-stream.types.makeStream makeStream(setStream)], context):compute\n","params":[{"types":[{"type":"Object","options":[]}],"name":"observable","description":"An observable object\n"},{"types":[{"type":"String"}],"name":"property","description":"A property of the observable object prepended with `.`\n"},{"types":[{"type":"String"}],"optional":true,"name":"event","description":"An optional event name of the observable object\n\n"}]}],"_curParam":{"types":[{"type":"String"}],"optional":true,"name":"event","description":"An optional event name of the observable object\n\n"},"pathToRoot":".."};
</script>
</article>
