...
<div class="breadcrumb">
	...
	<li><a href="can-event.unbind.html">unbind</a></li>
	...
	<div class="page-type">
		<h1>unbind</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L421">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Removes a basic event listener from an object.</p>
<p>This is an alias of <a href="can-event.removeEventListener.html" title="can-event.removeEventListener">removeEventListener</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event.unbind","parent":"can-event.static","src":{"line":420,"codeLine":433,"path":"node_modules/can-event/can-event.js"},"description":"","title":"unbind","signatures":[{"code":"obj.unbind(event, handler)","description":"\n\nRemoves a basic event listener from an object.\n\nThis is an alias of [can-event.removeEventListener removeEventListener].\n","params":[]},{"code":"canEvent.unbind.call(obj, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n","params":[]}],"pathToRoot":".."};
</script>
</article>
