...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/case.md
	@function can-stache.helpers.case
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#case(expression)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.case.html">{{#case(expression)}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{#case(expression)}}</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/case.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#case(EXPRESSION)}}BLOCK{{/case}}</code>
  </h2>
  <p>Renders the <code>BLOCK</code> when <code>EXPRESSION</code> matches the <code>EXPRESSION</code> provided in the parent <a href="can-stache.helpers.switch.html" title="">{{#switch(expression)}}</a>.</p>
<pre><code>{{#switch(user.type)}}
    {{#case(&quot;admin&quot;)}}
        &lt;button value=&quot;edit&quot;/&gt;
    {{/case}}
    {{#case(&quot;manager&quot;)}}
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="can-stache/expressions/literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>An expression or key that references a value.</p>
</li>
        
          <li><b>BLOCK</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>A subsection that will be rendered if
the case <code>EXPRESSION</code> matches the switch's <code>EXPRESSION</code>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>case</code> helper is contextual inside of a <a href="can-stache.helpers.switch.html" title="">{{#switch(expression)}}</a> block. The parent switch contains an <code>expr</code> that will be matched against the case <code>expr</code> and if they are equal the block will be returned.</p>
<p>For more information on how <code>{{#case()}}</code> is used check:</p>
<ul>
<li><a href="can-stache.helpers.switch.html" title="">{{#switch(expression)}}</a></li>
<li><a href="can-stache.helpers.default.html" title="">{{#default()}}</a></li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/case.md"},"description":"\n","title":"{{#case(expression)}}","name":"can-stache.helpers.case","type":"function","parent":"can-stache.htags","order":14,"signatures":[{"code":"{{#case(EXPRESSION)}}BLOCK{{/case}}","description":"\n\nRenders the `BLOCK` when `EXPRESSION` matches the `EXPRESSION` provided in the parent [can-stache.helpers.switch].\n\n```\n{{#switch(user.type)}}\n\t{{#case(\"admin\")}}\n\t\t<button value=\"edit\"/>\n\t{{/case}}\n\t{{#case(\"manager\")}}\n\t\t<button value=\"view\">\n\t{{/case}}\n\t{{#default()}}\n\t\tYou do not have permission!\n\t{{/default}}\n{{/switch}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression or key that references a value.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"A subsection that will be rendered if\nthe case `EXPRESSION` matches the switch's `EXPRESSION`.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"A subsection that will be rendered if\nthe case `EXPRESSION` matches the switch's `EXPRESSION`.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
