...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/select.md
	@function can-stache-converters.examples.select
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - select </title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.examples.select.html">select </a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>select </h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/select.md">Edit on GitHub</a>
				</li>
    ...
    <p>Cross bind a value to a <code>&lt;select&gt;</code> element.</p>
...
<div class="signature">
  ...
  <p>Cross binds the selected option value with an observable value.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>KEY</b> <code>{<a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a>}</code>: <p>A named value in the current
scope. <code>KEY</code>’s value is cross bound with the selected <code>&lt;option&gt;</code> in
the <code>&lt;select&gt;</code>. <code>KEY</code> should specify either a <a href="can-map.html" title="Create observable objects.">can-map</a>/<a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> property or a <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The following cross bind's a <code>&lt;select&gt;</code> to a <code>person</code> map's <code>attending</code> property:</p>
