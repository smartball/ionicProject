...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.index.html">index</a></li>
	...
	<div class="page-type">
		<h1>index</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L525">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns where <code>item</code> should be inserted into <code>items</code> which is represented by <code>set</code>.</p>
...
<p>The default sort property is what is specified by
<a href="can-set.props.id.html" title="Defines the identify property.">id</a>. This means if that if the sort property
...
id property.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The <code>set</code> that describes <code>items</code>.</p>
</li>
        
          <li><b>items</b> <code>{Array&lt;Object&gt;}</code>: <p>An array of data objects.</p>
</li>
        
          <li><b>item</b> <code>{Object}</code>: <p>The data object to be inserted.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Number}</code>: <p>The position to insert <code>item</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.index","parent":"can-set.Algebra.prototype","src":{"line":524,"codeLine":553,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"index","signatures":[{"code":"algebra.index(set, items, item)","description":"\n\nReturns where `item` should be inserted into `items` which is represented by `set`.\n\n```js\nalgebra = new set.Algebra(\n  set.props.sort(\"orderBy\")\n);\nalgebra.index(\n  {orderBy: \"age\"},\n  [{id: 1, age: 3},{id: 2, age: 5},{id: 3, age: 8},{id: 4, age: 10}],\n  {id: 6, age: 3}\n)  //-> 2\n```\n\nThe default sort property is what is specified by\n[can-set.props.id]. This means if that if the sort property\nis not specified, it will assume the set is sorted by the specified\nid property.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The `set` that describes `items`."},{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}]}],"name":"items","description":"An array of data objects."},{"types":[{"type":"Object","options":[]}],"name":"item","description":"The data object to be inserted."}],"returns":{"types":[{"type":"Number"}],"description":"The position to insert `item`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"item","description":"The data object to be inserted."},"_curReturn":{"types":[{"type":"Number"}],"description":"The position to insert `item`.\n "},"pathToRoot":".."};
</script>
</article>
