...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/tags/partial.md
	@function can-stache.tags.partial
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.tags.partial.html">{{&gt;key}}</a></li>
	...
	<div class="page-type">
		<h1>{{&gt;key}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/tags/partial.md">Edit on GitHub</a>
				</li>
...
<li>In partials registered with <a href="can-stache.registerPartial.html" title="Register a partial template that can be rendered with can-stache.tags.partial.">registerPartial</a>.</li>
...
<p>Partials are typically registered <a href="can-stache.registerPartial.html" title="Register a partial template that can be rendered with can-stache.tags.partial.">registerPartial</a> like:</p>
