...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-element/docs/can-element.CanElement.md
	@typedef can-element.CanElement
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - CanElement</title>
...
Element is a can-element.CanElement that is derived from the HTMLElement. This is the element you will want to use to derive your own custom elements.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-element.CanElement.view.html"
							title="A static getter that returns the renderer function used to render the element&#x27;s shadow DOM.">
							CanElement.view
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-element.CanElement.html">CanElement</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>CanElement</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-element/edit/master/docs/can-element.CanElement.md">Edit on GitHub</a>
				</li>
    ...
    <p>An interface for derived elements using either <a href="can-element.html" title="Allows you to create customelement classes with CanJS.
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-element/docs/can-element.CanElement.md"},"description":"\nAn interface for derived elements using either [can-element] or [can-element.element].\n","type":"typedef","title":"CanElement","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-element.CanElement","parent":"can-element.types","pathToRoot":".."};
</script>
</article>
