...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/start.md
	@function can-view-parser.ParseHandler.start
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - start</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.start.html">start</a></li>
	...
	<div class="page-type">
		<h1>start</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/start.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>start(tagName, unary, lineNo)</code>
  </h2>
  <p>Called when parsing a tag begins.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>tagName</b> <code>{String}</code>: <p>The name of the tag.</p>
</li>
        
          <li><b>unary</b> <code>{Boolean}</code>: <p>If this tag is unary (has no closing tag).</p>
</li>
        
          <li><b>lineNo</b> <code>{Number}</code>: <p>The starting line number of the tag (undefined in production).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/start.md"},"description":"","title":"start","name":"can-view-parser.ParseHandler.start","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"start(tagName, unary, lineNo)","description":"\n\nCalled when parsing a tag begins.\n","params":[{"types":[{"type":"String"}],"name":"tagName","description":"The name of the tag."},{"types":[{"type":"Boolean"}],"name":"unary","description":"If this tag is unary (has no closing tag)."},{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the tag (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the tag (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
