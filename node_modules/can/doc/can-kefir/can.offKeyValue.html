...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-kefir/doc/can.offKeyValue.md
	@property can-kefir/can.offKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can.offKeyValue.html">can.offKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.offKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-kefir/edit/master/doc/can.offKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used by <a href="../can-reflect/observe.offKeyValue.html" title="Unregister an event handler on a MapLike object, based on a key change">can-reflect.offKeyValue</a> to stop listening to when the underlying stream emits either a <code>value</code> or <code>error</code> with a new value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>stream[@@can.offKeyValue](key, handler)</code>
  </h2>
  <p><a href="../can-reflect/observe.offKeyValue.html" title="Unregister an event handler on a MapLike object, based on a key change">can-reflect.offKeyValue</a> will use this function
to stop listening to when emitted <code>value</code>s or <code>error</code>s change.</p>
...
error values emitted by the stream.</p>
          ...
          <li><b>handler</b> <code>{function(value)}</code>: <p>The same handler passed to <code>onKeyValue</code>.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-kefir/doc/can.offKeyValue.md"},"description":"Used by [can-reflect/observe.offKeyValue can-reflect.offKeyValue] to stop listening to when the underlying stream emits either a `value` or `error` with a new value.\n\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"title":"can.offKeyValue","name":"can-kefir/can.offKeyValue","type":"property","parent":"can-kefir/symbols","signatures":[{"code":"stream[@@can.offKeyValue](key, handler)","description":"\n\n[can-reflect/observe.offKeyValue can-reflect.offKeyValue] will use this function\nto stop listening to when emitted `value`s or `error`s change.\n\n```js\nvar Kefir = require(\"can-kefir\");\n\nvar count = Kefir.sequentially(1000, [1, 2, 2, 3]);\n\nfunction handler(newVal) {\n\tconsole.log(\"new value\", newVal); // logs 1, 2\n\tif(newVal > 2) {\n\t\tcanReflect.offKeyValue(stream, \"value\", handler);\n\t}\n}\n\ncanReflect.onKeyValue(stream, \"value\", handler);\n```\n\n","params":[{"types":[{"type":"String"}],"name":"key","description":"Either `value` for values emitted by the stream or `error` or\nerror values emitted by the stream.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"}]}],"name":"handler","description":"The same handler passed to `onKeyValue`.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"}]}],"name":"handler","description":"The same handler passed to `onKeyValue`.\n"},"pathToRoot":"../.."};
</script>
</article>
