...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-kefir/doc/can.onKeyValue.md
	@property can-kefir/can.onKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can.onKeyValue.html">can.onKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-kefir/edit/master/doc/can.onKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used by <a href="../can-reflect/observe.onKeyValue.html" title="Register an event handler on a MapLike object, based on a key change">can-reflect.onKeyValue</a> to listen to when the underlying stream emits either a <code>value</code> or <code>error</code> with a new value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>stream[@@can.onKeyValue](key, handler)</code>
  </h2>
  <p><a href="../can-reflect/observe.onKeyValue.html" title="Register an event handler on a MapLike object, based on a key change">can-reflect.onKeyValue</a> will use this function
to listen to when emitted <code>value</code>s or <code>error</code>s change.</p>
<p>Notice how the following only logs 3 numbers even though 4 numbers are emitted:</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>Either <code>value</code> for values emitted by the stream or <code>error</code> or
error values emitted by the stream.</p>
</li>
        
          <li><b>handler</b> <code>{function(value)}</code>: <p>A function handler that will be called when the emitted value changes with the emitted value.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-kefir/doc/can.onKeyValue.md"},"description":"Used by [can-reflect/observe.onKeyValue can-reflect.onKeyValue] to listen to when the underlying stream emits either a `value` or `error` with a new value.\n\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"title":"can.onKeyValue","name":"can-kefir/can.onKeyValue","type":"property","parent":"can-kefir/symbols","signatures":[{"code":"stream[@@can.onKeyValue](key, handler)","description":"\n\n[can-reflect/observe.onKeyValue can-reflect.onKeyValue] will use this function\nto listen to when emitted `value`s or `error`s change.\n\nNotice how the following only logs 3 numbers even though 4 numbers are emitted:\n\n```js\nvar Kefir = require(\"can-kefir\");\n\nvar count = Kefir.sequentially(1000, [1, 2, 2, 3]);\n\ncanReflect.onKeyValue(stream, \"value\", function(newVal){\n\tconsole.log(\"new value\", newVal);\n}); // logs 1, 2, 3\n```\n\n","params":[{"types":[{"type":"String"}],"name":"key","description":"Either `value` for values emitted by the stream or `error` or\nerror values emitted by the stream.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"}]}],"name":"handler","description":"A function handler that will be called when the emitted value changes with the emitted value.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"}]}],"name":"handler","description":"A function handler that will be called when the emitted value changes with the emitted value.\n"},"pathToRoot":"../.."};
</script>
</article>
