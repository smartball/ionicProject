...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-kefir/doc/can.setKeyValue.md
	@property can-kefir/can.setKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can.setKeyValue.html">can.setKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.setKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-kefir/edit/master/doc/can.setKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used by [can-reflect.settKeyValue can-reflect.setKeyValue] to set the stream's last emitted <code>value</code> or <code>error</code>.  This symbol is only added to
<a href="emitterProperty.html" title=".emitterProperty()">emitterProperty</a> objects.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>emitterProperty[@@can.setKeyValue](key, value)</code>
  </h2>
  <p><a href="../can-reflect.setKeyValue.html" title="Set the value of a named property on a MapLike object.">can-reflect.setKeyValue</a> will use this function
to emit a <code>value</code> or <code>error</code> on the emitterProperty.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>Either <code>value</code> to emit value or <code>error</code> to
emit errors.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>Any value to emit.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-kefir/doc/can.setKeyValue.md"},"description":"Used by [can-reflect.settKeyValue can-reflect.setKeyValue] to set the stream's last emitted `value` or `error`.  This symbol is only added to\n[can-kefir/emitterProperty] objects.\n\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"title":"can.setKeyValue","name":"can-kefir/can.setKeyValue","type":"property","parent":"can-kefir/symbols","signatures":[{"code":"emitterProperty[@@can.setKeyValue](key, value)","description":"\n\n[can-reflect.setKeyValue can-reflect.setKeyValue] will use this function\nto emit a `value` or `error` on the emitterProperty.\n\n\n```js\nvar Kefir = require(\"can-kefir\");\n\nvar age = Kefir.emitterProperty();\n\nage.onValue(function(value){\n\tconsole.log(value)\n});\n\ncanReflect.setKeyValue(age,\"value\",30) // logs 30\n```\n","params":[{"types":[{"type":"String"}],"name":"name","description":"Either `value` to emit value or `error` to\nemit errors.\n"},{"types":[{"type":"*"}],"name":"value","description":"Any value to emit.\n"}]}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"Any value to emit.\n"},"pathToRoot":"../.."};
</script>
</article>
