...
<!--####################################################################
	...
	@typedef can-observation.observed
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Observed</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-observation.observed.html">Observed</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Observed</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L322">Edit on GitHub</a>
				</li>
    ...
    <p>An object representing an observation.</p>
<pre><code class="language-js">{ &quot;obj&quot;: map, &quot;event&quot;: &quot;prop1&quot; }
</code></pre>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>obj</b> <code>{Object}</code>:
        <p>The observable object</p>

      </li>
    
      <li>
        <b>event</b> <code>{String}</code>:
        <p>The event, or more likely property, that is being observed.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-observation.observed","type":"typedef","parent":"can-observation.types","src":{"line":321,"codeLine":337,"path":"node_modules/can-observation/can-observation.js"},"description":" \nAn object representing an observation.\n\n```js\n{ \"obj\": map, \"event\": \"prop1\" }\n```\n\n","title":"Observed","types":[{"type":"Object","options":[{"name":"obj","description":"The observable object","types":[{"type":"Object","options":[]}]},{"name":"event","description":"The event, or more likely property, that is being observed.\n","types":[{"type":"String"}]}]}],"pathToRoot":".."};
</script>
</article>
