...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/prototype.default-attr.md
	@property can-map.prototype.DEFAULT-ATTR
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DEFAULT-ATTR</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.DEFAULT-ATTR.html">DEFAULT-ATTR</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>DEFAULT-ATTR</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/prototype.default-attr.md">Edit on GitHub</a>
				</li>
    ...
    <p>Specify a default property and value.</p>
...
<div class="signature">
  ...
  <p>A value of any type other than a function that will
be set as the <code>DEFAULT-ATTR</code> attribute's value.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>When extending <a href="can-map.html" title="Create observable objects.">can-map</a>, if a prototype property is not a function,
it is used as a default value on instances of the extended Map.  For example:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/prototype.default-attr.md"},"description":"Specify a default property and value. \n","types":[{"type":"*","description":"A value of any type other than a function that will\nbe set as the `DEFAULT-ATTR` attribute's value.\n"}],"title":"DEFAULT-ATTR","name":"can-map.prototype.DEFAULT-ATTR","type":"property","parent":"can-map.prototype","order":1,"comment":" ","pathToRoot":".."};
</script>
</article>
