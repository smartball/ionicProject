...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-legacy/docs/can-validate-legacy.md
	@module can-validate-legacy
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-validate-legacy</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-validate-legacy</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-validate-legacy">
						<img src="https://img.shields.io/badge/npm%20package-1.1.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-validate-legacy" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-legacy/edit/master/docs/can-validate-legacy.md">Edit on GitHub</a>
				</li>
    ...
    <p>A plugin for CanJS that wraps any validation library to <code>can.validate</code>. <strong>Can-Validate doesn't do any validation of its own</strong> but instead provides some abstraction to your library of choice. The chosen library is registered with can-validate using a shim.</p>
...
<div class="signature">
  ...
  <p>Can-Validate provides methods that can be used to validate values regardless of the validation library used.</p>
<pre><code class="language-js">var validate = require(&quot;can-validate-legacy&quot;);
...
var errors = validate.validate(user, constraints);
    ...
    <section class="body">
    <p>Can-Validate can be used in two ways, in a can-map instance or standalone.</p>
<h2>Usage</h2>
<p>The module should require the following files</p>
<pre><code class="language-javascript">import 'can-validate-legacy';
import 'validate.js';
import 'can-validate-legacy/shims/validatejs.shim';
</code></pre>
<p>Now, can-validate can be used in two ways, either in a can-map or standalone.</p>
<h3>Can-Map Plugin Usage</h3>
<p>Using the plugin for can-map requires the can-map-define plugins as well.</p>
<pre><code class="language-javascript">import 'can-validate-legacy/map/validate';
import 'can/map/define/define';
</code></pre>
<p>All can-maps created in the module will now have an augmented setter that checks properties as they are set.</p>
<pre><code class="language-javascript">var ViewModel = Map.extend({
  define: {
    name: {
      value: '',
      validate: {
...
<p>First, make sure the correct files are required.</p>
<pre><code class="language-javascript">// can.validate is now available
...
<p>Now, we can validate many or a single property. Let's start with the
following values and constraints:</p>
...
<p>To validate many properties, just run...</p>
<pre><code class="language-javascript">var errors = validate.validate(user, constraints);
</code></pre>
<p>The <code>once</code> method allows validating just a single value.</p>
<pre><code class="language-javascript">var errors = validate.once(user.firstName, constraints.firstName, 'firstName');
</code></pre>
<h2>Shims and Validation Libraries</h2>
<p>A shim registers a validation library with can-validate. It also processes properties and values into a structure more acceptable by the validation library. This allows consuming libraries to switch validation libraries simply by switching out their shim - any new behavior or legacy behavior can be baked into the new shim.</p>
<p>Don't have a library of choice? Can.Validate ships with a shim for <a href="http://validatejs.org/">ValidateJS</a>.</p>
<h2>Change Log</h2>
<p>A change log is maintained <a href="changelog.html">here</a>.</p>
<h2>Contributing</h2>
<p>Want to contribute? <a href="contributing.html">Read the contributing</a> guide to start.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-legacy/docs/can-validate-legacy.md"},"description":"A plugin for CanJS that wraps any validation library to `can.validate`. **Can-Validate doesn't do any validation of its own** but instead provides some abstraction to your library of choice. The chosen library is registered with can-validate using a shim.\n\n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\nCan-Validate provides methods that can be used to validate values regardless of the validation library used.\n\n  ```js\n  var validate = require(\"can-validate-legacy\");\n  require(\"can-validate-legacy/shims/validatejs.shim\");\n\n  var user = {\n\t  firstName: \"juan\"\n  };\n\n  var constraints = {\n\t  firstName: {\n\t\t  required: true,\n\t\t  format: {\n\t\t\t  pattern: /^[A-Z].*/,\n      \t\t  message: \"^ must be proper cased.\"\n\t\t  }\n\t  }\n  };\n\n  var errors = validate.validate(user, constraints);\n  ```\n"}],"name":"can-validate-legacy","parent":"can-legacy","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"readme":{"apis":["can-validate-legacy"]},"parent":"can-validate-legacy"},"browser":{"./can-validate":"./dist/cjs/can-validate/can-validate","./map/validate":"./dist/cjs/can-validate/map/validate/validate","./validations":"./dist/cjs/can-validate/validations","./shims/validatejs.shim":"./dist/cjs/can-validate/shims/validatejs.shim"},"bugs":{"url":"https://github.com/canjs/can-validate-legacy/issues"},"bundleDependencies":false,"dependencies":{"can-util":"^3.9.0-pre.4","validate.js":"^0.11.1"},"deprecated":false,"description":"Validation plugin for CanJS that provides an abstraction layer to your validation library of choice (Shim may be required).","devDependencies":{"bit-docs":"0.0.7","can-compute":"^3.1.0-pre.11","can-map":"^3.1.0-pre.11","can-map-define":"^3.1.0-pre.1","can-stache":"^3.1.0-pre.5","done-serve":"^0.2.5","jquery":"^3.1.1","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-stache":"^3.0.1","steal-tools":"^1.1.2","testee":"^0.3.1"},"homepage":"https://github.com/canjs/can-validate-legacy","keywords":["Validate","plugin","canjs"],"license":"MIT","main":"can-validate.js","name":"can-validate-legacy","repository":{"type":"git","url":"git+https://github.com/canjs/can-validate-legacy.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"ignoreBrowser":true,"npmIgnore":["documentjs","testee","steal-tools"],"npmDependencies":["steal-qunit"],"paths":{"validate.js":"./node_modules/validate.js/validate.js"}},"version":"1.1.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
