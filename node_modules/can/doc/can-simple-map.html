...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-simple-map/docs/simple-map.md
	@module can-simple-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-simple-map</title>
...
way to observe those reads called within a given function.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-simple-map.prototype.attr.html"
							title="Get or set properties on a SimpleMap.">
							attr
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-simple-map.prototype.get.html"
							title="Get properties on a SimpleMap.">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-simple-map.prototype.serialize.html"
							title="Returns the serialized form of the simple-map.">
							serialize
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-simple-map.prototype.set.html"
							title="Set properties on a SimpleMap.">
							set
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-simple-map.html">can-simple-map</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-simple-map</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-simple-map">
						<img src="https://img.shields.io/badge/npm%20package-3.3.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-simple-map" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-simple-map/edit/master/docs/simple-map.md">Edit on GitHub</a>
				</li>
    ...
    <p>A performant live-bound map.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new SimpleMap([props])</code>
  </h2>
  <p>Creates a new instance of can.SimpleMap.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>Properties and values to seed the Observe with.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can.SimpleMap}</code>: <p>An instance of <code>can.SimpleMap</code> with the properties from <em>props</em>.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>SimpleMap.extend([name,] [staticProperties,] instanceProperties)</code>
  </h2>
  <p>Creates a new extended constructor function.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>SimpleMap</code> provides a way to create an Observable whose properties can be changed using <a href="can-simple-map.prototype.attr.html" title="Get or set properties on a SimpleMap.">attr</a>.</p>
<pre><code>var map = new SimpleMap({ age: 29 });
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-simple-map/docs/simple-map.md"},"description":"A performant live-bound map. \n","type":"module","title":"","types":[{"type":"constructor"}],"name":"can-simple-map","parent":"can-infrastructure","inherits":"can","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-simple-map/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.0.3","can-construct":"^3.2.0","can-event":"^3.6.0","can-observation":"^3.3.1","can-reflect":"^1.2.1","can-symbol":"^1.0.0","can-types":"^1.1.0","can-util":"^3.9.0"},"deprecated":false,"description":"A performant live-bound map","devDependencies":{"can-compute":"^3.3.1","jshint":"^2.9.1","steal":"^1.2.9","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"https://canjs.com","keywords":[],"main":"can-simple-map","name":"can-simple-map","repository":{"type":"git","url":"git://github.com/canjs/can-simple-map.git"},"scripts":{"build":"node build.js","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-simple-map","configDependencies":["live-reload"],"npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.3.1"},"signatures":[{"code":"new SimpleMap([props])","description":"\n\nCreates a new instance of can.SimpleMap.\n","params":[{"types":[{"type":"Object","options":[]}],"optional":true,"name":"props","description":"Properties and values to seed the Observe with."}],"returns":{"types":[{"type":"can.SimpleMap"}],"description":"An instance of `can.SimpleMap` with the properties from _props_.\n"}},{"code":"SimpleMap.extend([name,] [staticProperties,] instanceProperties)","description":"\n\nCreates a new extended constructor function.\n","params":[]}],"_curReturn":{"types":[{"type":"can.SimpleMap"}],"description":"An instance of `can.SimpleMap` with the properties from _props_.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
