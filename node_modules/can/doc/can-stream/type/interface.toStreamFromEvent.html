...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/interface.toStreamFromEvent.md
	@function can-stream/type/interface.toStreamFromEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - toStreamFromEvent</title>
...
<div class="breadcrumb">
	...
	<li><a href="interface.toStreamFromEvent.html">toStreamFromEvent</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStreamFromEvent</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/interface.toStreamFromEvent.md">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a stream on a {Observable} object that gets updated whenever the event occurs on the observable object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStreamFromEvent( obs, eventName )</code>
  </h2>
  <p>Creates a stream based on event on observable</p>
...
map.fooList.push('New task');
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>An</b> <code>{Observable}</code>: <p>observable object</p>
</li>
        
          <li><b>property</b> <code>{String}</code>: <p>name</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Stream}</code>: <p>A stream.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStreamFromEvent( obs, propName, eventName )</code>
  </h2>
  <p>Creates a stream based on event trigger on observable property</p>
<pre><code class="language-js">var canStreamKefir = require('can-stream-kefir');
var canStream = require('can-stream');
var canStreaming = canStream(canStreamKefir);
var compute = require('can-compute');
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>observable</b> <code>{String}</code>: <p>property name</p>
</li>
        
          <li><b>observable</b> <code>{String}</code>: <p>event name</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/interface.toStreamFromEvent.md"},"description":"Creates a stream on a {Observable} object that gets updated whenever the event occurs on the observable object. \n","title":"toStreamFromEvent","name":"can-stream/type/interface.toStreamFromEvent","type":"function","parent":"can-stream.types.streamInterface","signatures":[{"code":"canStream.toStreamFromEvent( obs, eventName )","description":"\n\n  Creates a stream based on event on observable\n\n  ```js\n  var canStreamKefir = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n\n  var compute = require('can-compute');\n  var DefineMap = require('can-define/map/map');\n  var DefineList = require('can-define/list/list');\n\n  var MyMap = DefineMap.extend({\n      tasks: {\n          Type: DefineList.List,\n          value: []\n      }\n  });\n  var map = new MyMap();\n\n  var stream = canStreaming.toStreamFromEvent(map, 'tasks');\n\n  stream.onValue(function(ev){\n      console.log('map.tasks has been updated');\n  });\n\n  map.fooList.push('New task');\n  ```\n","params":[{"types":[{"type":"Observable"}],"name":"An","description":"observable object"},{"types":[{"type":"String"}],"name":"property","description":"name\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A stream.\n\n"}},{"code":"canStream.toStreamFromEvent( obs, propName, eventName )","description":"\n\n  Creates a stream based on event trigger on observable property\n\n  ```js\n  var canStreamKefir = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n  var compute = require('can-compute');\n  var DefineMap = require('can-define/map/map');\n  var DefineList = require('can-define/list/list');\n\n  var MyMap = DefineMap.extend({\n      tasks: {\n          Type: DefineList.List,\n          value: []\n      }\n  });\n  var map = new MyMap();\n\n  var stream = canStreaming.toStreamFromEvent(map, 'tasks', 'length');\n\n  stream.onValue(function(ev){\n      console.log('map.tasks has been updated');\n  });\n\n  map.fooList.push('New task');\n  ```\n","params":[{"types":[{"type":"Observable"}],"name":"An","description":"observable object"},{"types":[{"type":"String"}],"name":"observable","description":"property name"},{"types":[{"type":"String"}],"name":"observable","description":"event name\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A stream.\n"}}],"_curReturn":{"types":[{"type":"Stream"}],"description":"A stream.\n"},"_curParam":{"types":[{"type":"String"}],"name":"observable","description":"event name\n"},"pathToRoot":"../../.."};
</script>
</article>
