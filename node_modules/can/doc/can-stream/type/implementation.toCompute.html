...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/implementation.toCompute.md
	@function can-stream/type/implementation.toCompute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="implementation.toCompute.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="implementation.toStream.html"
							title="Create a stream from an observable.">
							toStream
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="../../can-stream.types.streamImplementation.html">StreamImplementation</a></li>
		<li> / </li>
	
	
	<li><a href="implementation.toCompute.html">toCompute</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toCompute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/implementation.toCompute.md">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a <a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> from a stream generator function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>toCompute( makeStream(setStream), [context] )</code>
  </h2>
