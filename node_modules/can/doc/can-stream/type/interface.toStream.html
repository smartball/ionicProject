...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/interface.toStream.md
	@function can-stream/type/interface.toStream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - toStream</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="../../can-stream.types.makeStream.html"
							title="This function takes a stream whose values are bound to the returned can-compute.computed.">
							makeStream
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="../../can-stream.types.streamImplementation.html"
							title="Export an object with a minimal implementation of toStream and toCompute methods specific to a streaming library like Kefir">
					...
					<li class="
           						...
           						expanded">
						<a class="typedef"
							href="../../can-stream.types.streamInterface.html"
							title="Stream interface function returned from can-stream">
							streamInterface
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="interface.toCompute.html"
							title="Create a can-compute.computed from a stream generator function.">
							toCompute
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="interface.toStream.html"
							title="Provides a shorthand for creating a stream from observable objects, properties and events.">
							toStream
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="interface.toStreamFromEvent.html"
							title="Creates a stream on a {Observable} object that gets updated whenever the event occurs on the observable object.">
							toStreamFromEvent
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="interface.toStreamFromProperty.html"
							title="Creates a stream on a {Observable} object that gets updated whenever the property value on the observable changes.">
...
<div class="breadcrumb">
		...
		<li><a href="../../can-stream.html">can-stream</a></li>
		<li> / </li>
	
		<li><a href="../../can-stream.types.streamInterface.html">streamInterface</a></li>
		<li> / </li>
	
	
	<li><a href="interface.toStream.html">toStream</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStream</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/interface.toStream.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a shorthand for creating a stream from observable objects, properties and events.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStream( observable, propAndOrEvent )</code>
  </h2>
  <p>Creates a stream from a <a href="../../can-compute.html" title="Create an observable value.">can-compute</a> compute or an observable. This stream gets updated whenever the observable value changes.</p>
...
c1(1);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>compute</b> <code>{<a href="../../can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute whose value will be the stream values.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Stream}</code>: <p>A stream object.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStream( observable, &quot;eventName&quot; )</code>
  </h2>
  <p>Creates an event stream with the event objects dispatched on <code>obs</code> for <code>eventName</code>.
This is a shorthand for [can-stream.toStreamFromEvent].</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>observable</b> <code>{Observable}</code>: <p>An observable object like a <a href="../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>.
Promises can work too.</p>
</li>
        
          <li><b>eventName</b> <code>{String}</code>: <p>An observable event name.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>A stream make up of the event objects dispatched on <code>obs</code>.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStream( observable, &quot;.propName&quot; )</code>
  </h2>
  <p>Creates a stream from an observable property value. This is a shorthand for [can-stream.toStreamFromProperty].</p>
<pre><code class="language-js">var canStreamKefir = require('can-stream-kefir');
var canStream = require('can-stream');
var canStreaming = canStream(canStreamKefir);
...
<p>Create a stream based on a event on an observable property.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obs</b> <code>{Observable}</code>: <p>An observable object like a <a href="../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>.
Promises can work too.</p>
</li>
        
          <li><b>propName</b> <code>{String}</code>: <p>A property name.  Multiple property names can be provided like <code>&quot;.foo.bar.car&quot;</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>A stream of values at the specified <code>propName</code>.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStream( obs, &quot;.propName eventName&quot; )</code>
  </h2>
  <p>Creates a stream from an observable property value. This is a shorthand for the second signature of [can-stream.toStreamFromEvent].</p>
<pre><code class="language-js">var canStreamKefir = require('can-stream-kefir');
var canStream = require('can-stream');
var canStreaming = canStream(canStreamKefir);
...
Promises can work too.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>A stream of the <code>eventName</code> event objects dispatched on the objects specified by <code>propName</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/interface.toStream.md"},"description":"Provides a shorthand for creating a stream from observable objects, properties and events.\n\n","title":"toStream","name":"can-stream/type/interface.toStream","type":"function","parent":"can-stream.types.streamInterface","signatures":[{"code":"canStream.toStream( observable, propAndOrEvent )","description":"\n\n  Creates a stream from a [can-compute] compute or an observable. This stream gets updated whenever the observable value changes.\n\n  ```js\n  var compute = require('can-compute');\n  var canStreamKefir = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n\n  var c1 = compute(0);\n\n  var resultCompute = canStreaming.toStream(c1);\n\n  resultCompute.onValue(function (val) {\n    console.log(val);\n  });\n\n  c1(1);\n  ```\n","params":[{"types":[{"type":"can-compute"}],"name":"compute","description":"A compute whose value will be the stream values.\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A stream object.\n"}},{"code":"canStream.toStream( observable, \"eventName\" )","description":"\n\n  Creates an event stream with the event objects dispatched on `obs` for `eventName`.\n  This is a shorthand for [can-stream.toStreamFromEvent].\n\n  ```js\n  var DefineList = require('can-define/list/list');\n  var canStream = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n\n  var hobbies = new DefineList([\"js\",\"kayaking\"]);\n\n  var changeCount = canStreaming.toStream(hobbies, \"length\").scan(function(prev){\n\t  return prev + 1;\n  }, 0);\n  changeCount.onValue(function(event) {\n      console.log(event);\n  });\n\n  hobbies.push(\"bball\")\n  //-> console.logs {type: \"add\", args: [2,[\"bball\"]]}\n  hobbies.shift()\n  //-> console.logs {type: \"remove\", args: [0,[\"js\"]]}\n  ```\n","params":[{"types":[{"type":"Observable"}],"name":"observable","description":"An observable object like a [can-define/map/map].\nPromises can work too."},{"types":[{"type":"String"}],"name":"eventName","description":"An observable event name.\n"}],"returns":{"types":[{"type":"String"}],"description":"A stream make up of the event objects dispatched on `obs`.\n\n"}},{"code":"canStream.toStream( observable, \".propName\" )","description":"\n\n  Creates a stream from an observable property value. This is a shorthand for [can-stream.toStreamFromProperty].\n\n  ```js\n  var canStreamKefir = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n\n  var DefineMap = require(\"can-define/map/map\");\n\n  var person = new DefineMap({\n      first: \"Justin\",\n\t  last: \"Meyer\"\n  });\n\n  var first = canStreaming.toStream(person, '.first'),\n      last = canStreaming.toStream(person, '.last');\n\n  var fullName = Kefir.combine(first, last, function(first, last){\n\t  return first + last;\n  });\n\n  fullName.onValue(function(newVal){\n      console.log(newVal);\n  });\n\n  map.first = \"Payal\"\n  //-> console.logs \"Payal Meyer\"\n  ```\n\n  Create a stream based on a event on an observable property.\n","params":[{"types":[{"type":"Observable"}],"name":"obs","description":"An observable object like a [can-define/map/map].\n  Promises can work too."},{"types":[{"type":"String"}],"name":"propName","description":"A property name.  Multiple property names can be provided like `\".foo.bar.car\"`\n"}],"returns":{"types":[{"type":"String"}],"description":"A stream of values at the specified `propName`.\n"}},{"code":"canStream.toStream( obs, \".propName eventName\" )","description":"\n\n  Creates a stream from an observable property value. This is a shorthand for the second signature of [can-stream.toStreamFromEvent].\n\n  ```js\n  var canStreamKefir = require('can-stream-kefir');\n  var canStream = require('can-stream');\n  var canStreaming = canStream(canStreamKefir);\n\n  var DefineMap = require(\"can-define/map/map\");\n  var DefineList = require(\"can-define/list/list\");\n\n  var me = new DefineMap({\n      todos: [\"mow lawn\"]\n  });\n\n  var addStream = canStreaming.toStream(me, \".todos add\");\n\n  addStream.onValue(function(event){\n      console.log(event);\n  });\n\n  map.todos.push(\"do dishes\");\n  //-> console.logs {type: \"add\", args: [1,[\"do dishes\"]]}\n  ```\n\n  Create a stream based on a event on an observable property.\n","params":[{"types":[{"type":"Observable"}],"name":"obs","description":"An observable object like a [can-define/map/map].\n  Promises can work too.\n"},{"types":[{"type":"String"}],"name":"propName","description":"A property name.  Multiple property names can be provided like `\".foo.bar.car\"`"},{"types":[{"type":"String"}],"name":"eventName","description":"An observable event name."}],"returns":{"types":[{"type":"String"}],"description":"A stream of the `eventName` event objects dispatched on the objects specified by `propName`.\n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"A stream of the `eventName` event objects dispatched on the objects specified by `propName`.\n"},"_curParam":{"types":[{"type":"String"}],"name":"eventName","description":"An observable event name."},"pathToRoot":"../../.."};
</script>
</article>
