...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/implementation.toStream.md
	@function can-stream/type/implementation.toStream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="implementation.toStream.html">toStream</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStream</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/implementation.toStream.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a stream from an observable.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>compute</b> <code>{Compute}</code>: <p>An <a href="../../can-compute.html" title="Create an observable value.">can-compute</a> object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/implementation.toStream.md"},"description":"Create a stream from an observable. \n","title":"toStream","name":"can-stream/type/implementation.toStream","type":"function","parent":"can-stream.types.streamImplementation","signatures":[{"code":"toStream( compute )","description":"\n","params":[{"types":[{"type":"Compute"}],"name":"compute","description":"An [can-compute] object\n"}]}],"_curParam":{"types":[{"type":"Compute"}],"name":"compute","description":"An [can-compute] object\n"},"pathToRoot":"../../.."};
</script>
</article>
