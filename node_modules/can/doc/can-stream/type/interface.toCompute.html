...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/interface.toCompute.md
	@function can-stream/type/interface.toCompute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - toCompute</title>
...
<div class="breadcrumb">
	...
	<li><a href="interface.toCompute.html">toCompute</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toCompute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/interface.toCompute.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a <a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> from a stream generator function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toCompute( makeStream(setStream), [context] )</code>
  </h2>
  <p>This returns a <a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> that when <a href="../../can-compute.computed.on.html" title="Listen to when a compute changes value.">bound</a>
takes on the value of the stream returned by <code>makeStream</code>.  <code>makeStream</code>
is called with:</p>
<ul>
<li>its <code>this</code> as the <code>context</code>, and</li>
<li><code>setStream</code> which is a stream of values set on the returned compute (ex: <code>compute(5)</code>).</li>
</ul>
<p>This is used to create computes from streams.</p>
<pre><code class="language-js">var count = Kefir.sequentially(1000, [1, 2]);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>makeStream</b> <code>{function(setStream)}</code>: <p>A stream generator
...
values are used as the value of the returned <a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>.</p>
<p>The <code>setStream</code> is the stream of values set on the returned compute. In the following example, <code>setStream</code> will emit the values <code>1</code> and then <code>2</code>.</p>
<pre><code class="language-js">var returnedCompute = canStream.toCompute(function(setStream){
 return setStream;
});
returnedCompute(1);
returnedCompute(2);
          ...
          <li><b>context</b> <code>{Object}</code>: <p>An optional context which will be the <code>this</code> of <code>makeStream</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>(newVal)}</code>: <p>A compute that when read will return the value of
the stream returned by <code>setStream</code>.  When the compute is written to, it will
update <code>setStream</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/interface.toCompute.md"},"description":"Create a [can-compute.computed] from a stream generator function. \n","title":"toCompute","name":"can-stream/type/interface.toCompute","type":"function","parent":"can-stream.types.streamInterface","signatures":[{"code":"canStream.toCompute( makeStream(setStream), [context] )","description":"\n\nThis returns a [can-compute.computed] that when [can-compute.computed.on bound]\ntakes on the value of the stream returned by `makeStream`.  `makeStream`\nis called with:\n\n - its `this` as the `context`, and\n - `setStream` which is a stream of values set on the returned compute (ex: `compute(5)`).\n\nThis is used to create computes from streams.\n\n```js\nvar count = Kefir.sequentially(1000, [1, 2]);\n\nvar myCompute = canStream.toCompute(function(setStream){\n\treturn setStream.merge(count);\n});\n\n// listen to the compute for it to have a value\nmyCompute.on(\"change\", function(){})\n\nmyCompute(\"A\")\n\n// immediate value\nmyCompute() //-> \"A\"\n\n// 1000ms later\nmyCompute() //-> 1\n\n// 1000ms later\nmyCompute() //-> 2\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"Stream"}]},"params":[{"types":[{"type":"Stream"}],"name":"setStream"}]}],"name":"makeStream","description":"A stream generator\nfunction.  This function takes the stream of set values, and typically other streams\nand manipulates them into the final returned output stream.  The output stream's\nvalues are used as the value of the returned [can-compute.computed].\n\nThe `setStream` is the stream of values set on the returned compute. In the following example, `setStream` will emit the values `1` and then `2`.\n\n```js\nvar returnedCompute = canStream.toCompute(function(setStream){\n return setStream;\n});\nreturnedCompute(1);\nreturnedCompute(2);\n```\n"},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"An optional context which will be the `this` of `makeStream`.\n"}],"returns":{"types":[{"type":"can-compute.computed"}],"description":"A compute that when read will return the value of\nthe stream returned by `setStream`.  When the compute is written to, it will\nupdate `setStream`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"An optional context which will be the `this` of `makeStream`.\n"},"_curReturn":{"types":[{"type":"can-compute.computed"}],"description":"A compute that when read will return the value of\nthe stream returned by `setStream`.  When the compute is written to, it will\nupdate `setStream`.\n"},"pathToRoot":"../../.."};
</script>
</article>
