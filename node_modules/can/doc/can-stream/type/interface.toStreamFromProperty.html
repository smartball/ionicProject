...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/interface.toStreamFromProperty.md
	@function can-stream/type/interface.toStreamFromProperty
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - toStreamFromProperty</title>
...
<div class="breadcrumb">
	...
	<li><a href="interface.toStreamFromProperty.html">toStreamFromProperty</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStreamFromProperty</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/interface.toStreamFromProperty.md">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a stream on a {Observable} object that gets updated whenever the property value on the observable changes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canStream.toStreamFromProperty( obs, propName )</code>
  </h2>
  <p>Creates a stream based on property value change on observable</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/interface.toStreamFromProperty.md"},"description":"Creates a stream on a {Observable} object that gets updated whenever the property value on the observable changes. \n","title":"toStreamFromProperty","name":"can-stream/type/interface.toStreamFromProperty","type":"function","parent":"can-stream.types.streamInterface","signatures":[{"code":"canStream.toStreamFromProperty( obs, propName )","description":"\n\n  Creates a stream based on property value change on observable\n\n  ```js\n  var map = {\n      foo: \"bar\"\n  };\n  var stream = canStreaming.toStreamFromProperty(map, 'foo');\n\n  stream.onValue(function(value){\n    console.log(value); // -> foobar\n  });\n\n  map.foo = \"foobar\";\n  ```","params":[{"types":[{"type":"Observable"}],"name":"An","description":"observable object"},{"types":[{"type":"String"}],"name":"property","description":"name\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A stream.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"property","description":"name\n"},"_curReturn":{"types":[{"type":"Stream"}],"description":"A stream.\n"},"pathToRoot":"../../.."};
</script>
</article>
