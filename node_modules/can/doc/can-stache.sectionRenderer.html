...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/sectionRenderer.md
	@typedef can-stache.sectionRenderer
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - sectionRenderer</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.sectionRenderer.html">sectionRenderer</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>sectionRenderer</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/sectionRenderer.md">Edit on GitHub</a>
				</li>
    ...
    <p>Renders a section. These functions are usually provided as <code>.fn</code> and <code>.inverse</code> on a stache helper's <a href="can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">options</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>context</b> <code>{*|<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>}</code>: <p>Specifies the data the section is rendered
with.  If a <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> is provided, that scope is used to render the
...
scope is used to render the section.</p>
</li>
        
          <li><b>helpers</b> <code>{*|<a href="can-view-scope.Options.html" title="">Options</a>}</code>: <p>Specifies the helpers the section is rendered
with.  If a <a href="can-view-scope.Options.html" title="">Options</a> is provided, that scope is used to render the
section.  If anything else is provided, it is used to create a new scope object
with the current helper scope as it's parent.  If nothing is provided, the current
helper scope is used to render the section.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{documentFragment|String}</code>: <p>Returns the rendered result of the helper. If the
...
<p>a documentFragment is returned.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Renderer functions are provided to stache <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helpers</a> on
the <a href="can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">options</a> argument and are used to render the
content between sections. The <code>context</code> and <code>helpers</code> option let you control
the data and helpers used to render the section.</p>
<p>The following example adds <code>{first: &quot;Justin&quot;}</code> to the lookup
data. Notice how the section has access to <code>first</code> and <code>last</code>.</p>
<pre><code>stache.registerHelper(&quot;myhelper&quot;, function(options){
...
<p>If no <code>context</code> is provided, the current context is passed.  Notice
how the section has access to <code>last</code>:</p>
<pre><code>stache.registerHelper(&quot;myhelper&quot;, function(options){
...
<p>If a <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> is provided, it is used to render the
section. Notice how <code>last</code> is not available in the section:</p>
<pre><code>stache.registerHelper(&quot;myhelper&quot;, function(options){
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/sectionRenderer.md"},"description":"Renders a section. These functions are usually provided as `.fn` and `.inverse` on a stache helper's [can-stache.helperOptions options].\n\n","type":"typedef","title":"sectionRenderer","types":[{"type":"function","returns":{"types":[{"type":"documentFragment"},{"type":"String"}],"description":"Returns the rendered result of the helper. If the\nsection is within a tag, like:\n\n    <h1 {{#helper}}class='power'{{/helper}}>\n\na String is returned.  \n\nIf the section is outside a tag like: \n\n    <div> {{#helper}}<h2>Tasks</h2>{{/helper}} </div>\n    \na documentFragment is returned.\n"},"params":[{"types":[{"type":"*"},{"type":"can-view-scope"}],"optional":true,"name":"context","description":"Specifies the data the section is rendered \nwith.  If a [can-view-scope] is provided, that scope is used to render the\nsection.  If anything else is provided, it is used to create a new scope object\nwith the current scope as it's parent.  If nothing is provided, the current\nscope is used to render the section.\n"},{"types":[{"type":"*"},{"type":"can-view-scope.Options"}],"optional":true,"name":"helpers","description":"Specifies the helpers the section is rendered \nwith.  If a [can-view-scope.Options] is provided, that scope is used to render the\nsection.  If anything else is provided, it is used to create a new scope object\nwith the current helper scope as it's parent.  If nothing is provided, the current\nhelper scope is used to render the section.\n"}]}],"name":"can-stache.sectionRenderer","parent":"can-stache.types","_curParam":{"types":[{"type":"*"},{"type":"can-view-scope.Options"}],"optional":true,"name":"helpers","description":"Specifies the helpers the section is rendered \nwith.  If a [can-view-scope.Options] is provided, that scope is used to render the\nsection.  If anything else is provided, it is used to create a new scope object\nwith the current helper scope as it's parent.  If nothing is provided, the current\nhelper scope is used to render the section.\n"},"_curReturn":{"types":[{"type":"documentFragment"},{"type":"String"}],"description":"Returns the rendered result of the helper. If the\nsection is within a tag, like:\n\n    <h1 {{#helper}}class='power'{{/helper}}>\n\na String is returned.  \n\nIf the section is outside a tag like: \n\n    <div> {{#helper}}<h2>Tasks</h2>{{/helper}} </div>\n    \na documentFragment is returned.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
