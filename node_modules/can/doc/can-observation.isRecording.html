...
<!--####################################################################
	...
	@function can-observation.isRecording
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isRecording</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-observation.isRecording.html">isRecording</a></li>
	...
	<div class="page-type">
		<h1>isRecording</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L647">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>True if a function is in the process of recording observes.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-observation.isRecording","parent":"can-observation.static","src":{"line":646,"codeLine":655,"path":"node_modules/can-observation/can-observation.js"},"description":"","title":"isRecording","signatures":[{"code":"Observation.isRecording()","description":"\n\nReturns if some function is in the process of recording observes.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"True if a function is in the process of recording observes.\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"True if a function is in the process of recording observes.\n"},"pathToRoot":".."};
</script>
</article>
