...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/prototype.get.md
	@function can-view-scope.prototype.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.prototype.get.html">get</a></li>
	...
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/prototype.get.md">Edit on GitHub</a>
				</li>
...
property name that includes a dot.</p>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>scope.get(key)</code> looks up a value in the current scope's
...
<p>Prefixing a key with <code>&quot;./&quot;</code> prevents any parent scope look ups.
Prefixing a key with one or more <code>&quot;../&quot;</code> shifts the lookup path
that many levels up.</p>
<pre><code>var list = [{name: &quot;Justin&quot;},{name: &quot;Brian&quot;}];
