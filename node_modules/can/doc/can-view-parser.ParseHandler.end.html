...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/end.md
	@function can-view-parser.ParseHandler.end
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - end</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.end.html">end</a></li>
	...
	<div class="page-type">
		<h1>end</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/end.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>end(tagName, unary, lineNo)</code>
  </h2>
  <p>Called at the end of parsing a tag.</p>
