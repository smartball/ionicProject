...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/TypeConstructor.md
	@function can-map-define.TypeConstructor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map-define.TypeConstructor.html">Type</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Type</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/TypeConstructor.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a constructor function to be used to convert any value passed into <a href="can-map.prototype.attr.html" title="Get or set properties on a Map.">attr</a> into an appropriate value</p>
...
<pre><code>define: {
  prop: {
    ...
    <section class="body">
    <p>Similar to <a href="can-map-define._type.html" title="Converts a value passed to attr into an appropriate value.">type</a>, this uppercase version provides a mechanism for converting incoming values to another format or type.</p>
<p>Specifically, this constructor will be invoked any time this property is set, and any data passed into the setter will be passed as arguments for the constructor.</p>
<p>If the call to attr passes an object that is already an instance of the constructor specified with <code>Type</code>, no conversion is done.</p>
