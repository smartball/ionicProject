...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/input-radio.md
	@page can-stache-converters.examples.input-radio
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - input[type=radio]</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.examples.input-radio.html">input[type=radio]</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>input[type=radio]</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/input-radio.md">Edit on GitHub</a>
				</li>
    ...
    <p>Cross bind a value to a radio input.</p>
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <h2>Binding to radios</h2>
<p>To bind to a radio input, if you have a set of boolean values you can bind to the input’s <code>checked</code> property as you do with <a href="can-stache-converters.examples.input-checkbox.html" title="Cross bind a value to a checkbox.">input[type=checkbox]</a>.</p>
<pre><code class="language-handlebars">&lt;input type=&quot;radio&quot; {($checked)}=&quot;one&quot; /&gt; One
...
<h2>Binding to a selected value</h2>
<p>More often than binding to boolean values of each radio's <code>checked</code> value, you will want to know what the <code>value</code> is of the radio group. Since each radio has its own <code>value</code>, the radio's selected value is the value of the radio item that is selected.</p>
<p>Using the <a href="can-stache-converters.equal.html" title="A converter that is usually for binding to a &lt;input type=&quot;radio&quot;&gt; group, so that a scope value can be set the radio group’s selected value.">equal</a> <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> you can bind a value within your scope to the radio group’s selected value:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/input-radio.md"},"description":"\nCross bind a value to a radio input.\n","name":"can-stache-converters.examples.input-radio","title":"input[type=radio]","type":"page","parent":"can-stache-converters.examples","comment":" ","pathToRoot":".."};
</script>
</article>
