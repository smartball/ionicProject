...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate/docs/format-errors.md
	@function can-validate.formatErrors
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - formatErrors</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-validate.formatErrors.html"
							title="">
							formatErrors
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-validate.error.html"
							title="An object that defines a validation failure.">
							Error
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-validate.errors.html"
							title="The expected response from a validator if a value fails validation.">
							Errors
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-validate.validator.html"
							title="A function that validates a value against predefined constraints and returns validation errors, if any are found.">
							validator
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-validate.html">can-validate</a></li>
		<li> / </li>
	
	
	<li><a href="can-validate.formatErrors.html">formatErrors</a></li>
	...
	<div class="page-type">
		<h1>formatErrors</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate/edit/master/docs/format-errors.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>formatErrors(errors, format)</code>
  </h2>
  <p>Processes <code>errors</code> (only items that match the <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a> type) and
converts items to a structure defined by <code>format</code>.</p>
<pre><code class="language-js">formatErrors(['is required', {message: 'is invalid'}], 'errors');
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>errors</b> <code>{<a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>}</code>: <p>A value that matches the <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a> type.</p>
</li>
        
          <li><b>format</b> <code>{string}</code>: <p>Should be equal to <code>object</code>, <code>flat</code>, or <code>errors</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array|Object}</code>: <p>The errors either flattened into a single array, grouped in
by key in an object, or a single array of <a href="can-validate.error.html" title="An object that defines a validation failure.">Error</a> items. If no
<code>format</code> is passed, errors will be returned in the raw parsed format.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Usage</h2>
<p>The <code>errors</code> value should match the possible <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a> type.</p>
<p>Given the following...</p>
<pre><code class="language-js">// validate this object
var person = {};
...
<p>We can expect the following responses</p>
<h3>Object Example</h3>
<p>If no key exists in the error response, an array like object will be created.</p>
...
<p>If a key name exists in the error response, then we can expect to see the key name
in <code>related</code>.</p>
<pre><code class="language-json">[
    { &quot;message&quot;: &quot;is required&quot;, &quot;related&quot;: []},
    { &quot;message&quot;: &quot;must be a number&quot;, &quot;related&quot;: []}
]
</code></pre>
<h3>Handling errors without <code>related</code></h3>
<p>Given the following errors object</p>
<pre><code class="language-json">[
    &quot;is required&quot;,
...
<p>Because only one item in the array has a <code>related</code> property, the other two items
will be grouped together by assigning them the wildcard (<code>*</code>) key. Once processed,
the errors will look like</p>
<pre><code class="language-json">[
    {&quot;message&quot;: &quot;is required&quot;, &quot;related&quot;: [&quot;*&quot;]},
    {&quot;message&quot;: &quot;must be a number&quot;, &quot;related&quot;: [&quot;*&quot;]},
    {&quot;message&quot;: &quot;must be a number&quot;, &quot;related&quot;: [&quot;zipCode&quot;]}
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate/docs/format-errors.md"},"description":"\n","title":"formatErrors","name":"can-validate.formatErrors","type":"function","parent":"can-validate.methods","signatures":[{"code":"formatErrors(errors, format)","description":"\n  Processes `errors` (only items that match the [can-validate.errors] type) and\n  converts items to a structure defined by `format`.\n\n  ```js\n  formatErrors(['is required', {message: 'is invalid'}], 'errors');\n  ```\n","params":[{"types":[{"type":"can-validate.errors"}],"name":"errors","description":"A value that matches the [can-validate.errors] type."},{"types":[{"type":"string"}],"optional":true,"name":"format","description":"Should be equal to `object`, `flat`, or `errors`.\n"}],"returns":{"types":[{"type":"Array"},{"type":"Object","options":[]}],"description":"The errors either flattened into a single array, grouped in\nby key in an object, or a single array of [can-validate.error] items. If no\n`format` is passed, errors will be returned in the raw parsed format.\n"}}],"_curParam":{"types":[{"type":"string"}],"optional":true,"name":"format","description":"Should be equal to `object`, `flat`, or `errors`.\n"},"_curReturn":{"types":[{"type":"Array"},{"type":"Object","options":[]}],"description":"The errors either flattened into a single array, grouped in\nby key in an object, or a single array of [can-validate.error] items. If no\n`format` is passed, errors will be returned in the raw parsed format.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
