...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/Map.md
	@property can-list.Map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-list.Map.html">Map</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/Map.md">Edit on GitHub</a>
				</li>
    ...
    <p>Specify the Map type used to make objects added to this list observable.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code><a href="can-map.html" title="Create observable objects.">can-map</a></code>
  </h2>
  <p>When objects are added to a <code>List</code>, those objects are converted into can.Map instances. For example:</p>
...
<p>By changing <a href="can-list.Map.html" title="Specify the Map type used to make objects added to this list observable.">Map</a>, you can specify a different type of Map instance to create. For example:</p>
<pre><code> var User = Map.extend({
   fullName: function(){
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-list/docs/Map.md"},"description":"Specify the Map type used to make objects added to this list observable. \n","types":[{"type":"can-map","description":"When objects are added to a `List`, those objects are converted into can.Map instances. For example:\n\n     var list = new List();\n     list.push({name: \"Justin\"});\n\n     var map = list.attr(0);\n     map.attr(\"name\") //-> \"Justin\"\n\nBy changing [can-list.Map], you can specify a different type of Map instance to create. For example:\n\n     var User = Map.extend({\n       fullName: function(){\n         return this.attr(\"first\")+\" \"+this.attr(\"last\")\n       }\n     });\n\n     User.List = List.extend({\n       Map: User\n     }, {});\n\n     var list = new User.List();\n     list.push({first: \"Justin\", last: \"Meyer\"});\n\n     var user = list.attr(0);\n     user.fullName() //-> \"Justin Meyer\"\n"}],"title":"Map","name":"can-list.Map","type":"property","parent":"can-list.static","pathToRoot":".."};
</script>
</article>
