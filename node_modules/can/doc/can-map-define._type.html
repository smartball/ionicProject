...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/type.md
	@function can-map-define._type
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map-define._type.html">type</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>type</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/type.md">Edit on GitHub</a>
				</li>
    ...
    <p>Converts a value passed to <a href="can-map.prototype.attr.html" title="Get or set properties on a Map.">attr</a> into an appropriate value.</p>
...
as either a type function that returns the type coerced value or one of the following strings:</p>
<ul>
<li><code>&quot;string&quot;</code> - Converts the value to a string except <code>null</code> or <code>undefined</code>.</li>
<li><code>&quot;date&quot;</code> - Converts the value to a date or <code>null</code> if the date can not be converted.</li>
<li><code>&quot;number&quot;</code> - Passes the value through <code>parseFloat</code> except for <code>null</code> or <code>undefined</code>.</li>
<li><code>&quot;boolean&quot;</code> - Converts falsey, <code>&quot;false&quot;</code> or <code>&quot;0&quot;</code> to <code>false</code> and everything else to true.</li>
<li><code>&quot;htmlbool&quot;</code> - Like <code>boolean</code>, but also converts empty strings to
<code>true</code>. Used, for example, when input is from component attributes like
<code>&lt;can-tabs reverse/&gt;</code></li>
<li><code>&quot;compute&quot;</code> - If the value set is a compute, will allow the returning of the computed value.</li>
...
<pre><code>map.attr({count: &quot;4&quot;, items: &quot;1,2,3&quot;});
</code></pre>
...
<p>When an array is passed into a Map setter, it is automatically converted into a List. Likewise, objects are converted into Map instances. This behavior can be prevented like the following:</p>
<pre><code> define: {
   locations: {type: &quot;*&quot;}
 }
</code></pre>
<p>When a user tries to set this property, the resulting value will remain an array.</p>
<pre><code>map.attr('locations', [1, 2, 3]); // locations is an array, not a List
</code></pre>
<h3>Working with the 'compute' type</h3>
<p>Setting type as <a href="can-compute.html" title="Create an observable value."><code>compute</code></a> allows for resolving a computed property with the .attr()
method.</p>
<pre><code class="language-js">MyMap = Map.extend({
  define: {
    value: {
      type: &quot;compute&quot;
    }
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-define/docs/type.md"},"description":"\nConverts a value passed to [can-map.prototype.attr attr] into an appropriate value.\n","title":"type","name":"can-map-define._type","type":"function","parent":"can-map-define","params":[{"types":[{"type":"*"}],"name":"newValue","description":"The value passed to `attr`."},{"types":[{"type":"String"}],"name":"attrName","description":"The attribute name being set."}],"_curParam":{"types":[{"type":"String"}],"name":"attrName","description":"The attribute name being set."},"context":{"types":[{"type":"Map"}],"description":"the instance of the [can-map Map]."},"returns":{"types":[{"type":"*"}],"description":"The value that should be passed to `set` or (if there is no `set` property) the value to set on the map instance.\n"},"_curReturn":{"types":[{"type":"*"}],"description":"The value that should be passed to `set` or (if there is no `set` property) the value to set on the map instance.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
