...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-element/docs/attributes.md
	@module can-element/attributes
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-element/attributes</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-element/attributes</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-element/edit/master/docs/attributes.md">Edit on GitHub</a>
				</li>
    ...
    <p>Sets up attribute bindings when using <a href="../can-define.html" title="Exports the define method that defines observable properties and their behavior on a prototype object.">can-define</a>.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>attribute</b> <code>{Boolean}</code>:
        <p>Defines if this property should be bound to the attribute of the same name.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use this <a href="../can-define.html" title="Exports the define method that defines observable properties and their behavior on a prototype object.">can-define</a> behavior just import it. For any defined property on the element, you can specify <code>attribute: true</code> and the property will be two-way bound to the attribute. Any change in either will update the other.</p>
<p>Since the <a href="../can-define.types.type.html" title="Converts a value set on an instance into an appropriate value.">type</a> can still be specified, you can have properties which are typed even though the attribute will always be a string.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-element/docs/attributes.md"},"description":"\nSets up attribute bindings when using [can-define].\n","type":"module","title":"","types":[{"type":"Object","options":[{"name":"attribute","description":"Defines if this property should be bound to the attribute of the same name.\n","types":[{"type":"Boolean"}],"optional":true}]}],"name":"can-element/attributes","parent":"can-element.modules","comment":" ","pathToRoot":"../.."};
</script>
</article>
