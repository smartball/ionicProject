...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event/can-event.js
	@function can-event.undelegate
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - undelegate</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-event.undelegate.html">undelegate</a></li>
	...
	<div class="page-type">
		<h1>undelegate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L459">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Provides a compatibility layer for removing delegate event listeners.
This doesn't actually implement delegates, but rather allows
logic that assumes a delegate to still function.</p>
<p>Therefore, this is essentially an alias of <a href="can-event.removeEventListener.html" title="can-event.removeEventListener">removeEventListener</a> with the selector ignored.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>selector</b> <code>{String}</code>: <p>The <strong>ignored</strong> selector to use for the delegate.</p>
</li>
        
          <li><b>event</b> <code>{String}</code>: <p>The name of the event to listen for.</p>
</li>
        
          <li><b>handler</b> <code>{function}</code>: <p>The handler that will be executed to handle the event.</p>
</li>
...
<div class="signature">
  ...
  <p>This syntax can be used for objects that don't include the <a href="can-event.html" title="Add event functionality into your objects.
The canEvent object provides a number of methods for handling events in objects. This functionality is best used by mixing the canEvent object into an object or prototype. However, event listeners can still be used even on objects that don't include canEvent.
All methods provided by canEvent assume that they are mixed into an object -- this should be the object dispatching the events.">can-event</a> mixin.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-event.undelegate","type":"function","parent":"can-event.static","src":{"line":458,"codeLine":478,"path":"node_modules/can-event/can-event.js"},"description":"","title":"undelegate","signatures":[{"code":"obj.undelegate(selector, event, handler)","description":"\n\nProvides a compatibility layer for removing delegate event listeners.\nThis doesn't actually implement delegates, but rather allows\nlogic that assumes a delegate to still function.\n\nTherefore, this is essentially an alias of [can-event.removeEventListener removeEventListener] with the selector ignored.\n","params":[{"types":[{"type":"String"}],"name":"selector","description":"The **ignored** selector to use for the delegate."},{"types":[{"type":"String"}],"name":"event","description":"The name of the event to listen for."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"The handler that will be executed to handle the event."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"this\n"}},{"code":"canEvent.undelegate.call(obj, selector, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n","params":[]}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"this\n"},"pathToRoot":".."};
</script>
</article>
