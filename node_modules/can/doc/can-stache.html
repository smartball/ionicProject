			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-stache">
						<img src="https://img.shields.io/badge/npm%20package-3.12.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<li>Enable <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">custom elements</a> and <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">bindings</a>.</li>
</ul>
<p>The following
...
<p><a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> sets up <strong>element and bindings</strong> between a stache template's <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>,
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/stache.md"},"description":"Live binding Mustache and Handlebars-compatible templates. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-stache","parent":"can-views","collection":"can-core","release":"2.1","package":{"name":"can-stache","version":"3.12.0","description":"Live binding handlebars templates","homepage":"http://canjs.com","repository":{"type":"git","url":"git://github.com/canjs/can-stache.git"},"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"scripts":{"preversion":"npm test && npm run build","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/","postversion":"git push --tags && git checkout master && git branch -D release && git push","testee":"testee test/test.html --browsers firefox","test":"npm run detect-cycle && npm run jshint && npm run testee","jshint":"jshint ./*.js --config","release:pre":"npm version prerelease && npm publish --tag pre","release:patch":"npm version patch && npm publish","release:minor":"npm version minor && npm publish","release:major":"npm version major && npm publish","build":"node build.js","detect-cycle":"detect-cyclic-packages"},"main":"can-stache","keywords":["canjs","canjs-plugin","donejs"],"dependencies":{"can-attribute-encoder":"^0.3.0","can-compute":"^3.3.1","can-log":"^0.1.0","can-namespace":"1.0.0","can-observation":"^3.3.1","can-reflect":"^1.2.1","can-route":"^3.2.0","can-stache-key":"0.1.0","can-symbol":"^1.0.0","can-util":"^3.10.6","can-view-callbacks":"^3.2.0","can-view-live":"^3.2.0","can-view-nodelist":"^3.1.0","can-view-parser":"^3.6.0","can-view-scope":"^3.5.1","can-view-target":"^3.1.0","can-globals":"^0.2.0"},"devDependencies":{"can-define":"^1.3.0","can-event":"^3.6.0","can-list":"^3.2.0","can-map":"^3.3.0","can-test-helpers":"^1.1.0","can-vdom":"^3.1.0","detect-cyclic-packages":"^1.1.0","jshint":"^2.9.4","steal":"^1.0.5","steal-benchmark":"^0.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.7.0"}},"link":"../docco/view/stache/mustache_core.html docco","test":"can/view/stache/test/test.html","plugin":"can/view/stache","download":"http://canjs.us/release/latest/can.stache.js","signatures":[{"code":"stache([name,] template)","description":"\n\nProcesses the template and returns a [can-stache.renderer renderer function].\nUse [steal-stache] to import template renderer functions with [http://stealjs.com StealJS].\n","params":[{"types":[{"type":"String"}],"optional":true,"name":"name","description":"Provides an optional name for this type that will show up\nnicely in errors. Files imported with [steal-stache] will use their filename.\n"},{"types":[{"type":"String"}],"name":"template","description":"The text of a stache template.\n"}],"returns":{"types":[{"type":"can-stache.renderer"}],"description":"A [can-stache.renderer renderer] function that returns a live document fragment\nthat can be inserted in the page.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"template","description":"The text of a stache template.\n"},"_curReturn":{"types":[{"type":"can-stache.renderer"}],"description":"A [can-stache.renderer renderer] function that returns a live document fragment\nthat can be inserted in the page.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
