...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-parse-uri/can-parse-uri.js
	@module can-parse-uri
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-parse-uri</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-parse-uri.html">can-parse-uri</a></li>
	...
	<div class="page-type">
		<h1>can-parse-uri</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-parse-uri/edit/master/can-parse-uri.js">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>parseURI(url)</code>
  </h2>
  <p>Parse a URI into its components.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>url</b> <code>{String}</code>: <p>The URL you want to parse.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>Returns an object with properties for each part of the URL.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-parse-uri","parent":"can-infrastructure","src":{"line":0,"codeLine":12,"path":"node_modules/can-parse-uri/can-parse-uri.js"},"description":"","title":"can-parse-uri","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"parseURI(url)","description":"\n\nParse a URI into its components.\n","params":[{"types":[{"type":"String"}],"name":"url","description":"The URL you want to parse.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"Returns an object with properties for each part of the URL.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"url","description":"The URL you want to parse.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"Returns an object with properties for each part of the URL.\n"},"pathToRoot":".."};
</script>
</article>
