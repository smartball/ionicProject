...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.is.html">{{#eq(expressions)}}</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#eq([EXPRESSION...])}}FN{{else}}INVERSE{{/is}}</code>
  </h2>
  <p>Renders the <code>FN</code> if every <code>EXPRESSION</code> argument is equal (<code>===</code>).</p>
<pre><code>{{#eq(user.type, &quot;admin&quot;)}} &lt;button/&gt; {{else}} Login {{/is}}
