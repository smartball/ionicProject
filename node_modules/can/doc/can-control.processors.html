...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-control/docs/processors.md
	@property can-control.processors
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-control.processors.html">processors</a></li>
	...
	<div class="page-type">
		<h1>processors</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-control/edit/master/docs/processors.md">Edit on GitHub</a>
				</li>
...
to that event:</p>
<pre><code>Control.processors.birthday = function(el, ev, selector, callback, control) {
if(selector) {
...
<p>When <code>target</code> is initialized, can.Control will call <code>Control.processors.birthday</code>
...
<p>Control already has processors for these events:</p>
<ul>
<li>change</li>
<li>click</li>
<li>contextmenu</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-control/docs/processors.md"},"description":"A collection of hookups for custom events on Controls. ","types":[{"type":"Object","template":[{"types":[{"type":"can-control.processor"}]}]}],"title":"processors","name":"can-control.processors","type":"property","parent":"can-control.static","comment":" ","pathToRoot":".."};
</script>
</article>
