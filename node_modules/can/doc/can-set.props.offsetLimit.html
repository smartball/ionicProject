...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/src/props.js
	@function can-set.props.offsetLimit
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - offsetLimit</title>
  ...
  set.props.rangeInclusive(&quot;start&quot;,&quot;end&quot;)
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.props.boolean.html"
							title="Supports boolean properties.">
							boolean
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.props.dotNotation.html"
							title="Supports MongoDB-style &#x27;dot notation&#x27; properties.">
							dotNotation
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.props.id.html"
							title="Defines the identify property.">
							id
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-set.props.offsetLimit.html"
							title="Supports sets that include a limit and offset.">
							offsetLimit
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.props.rangeInclusive.html"
							title="Supports ranged properties.">
							rangeInclusive
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.props.sort.html"
							title="Defines the sortable property and behavior.">
							sort
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-set.props.html">props</a></li>
		<li> / </li>
	
	
	<li><a href="can-set.props.offsetLimit.html">offsetLimit</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>offsetLimit</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L408">Edit on GitHub</a>
				</li>
    ...
    <p>Supports sets that include a limit and offset.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>set.props.offsetLimit( [offsetProperty][, limitProperty] )</code>
  </h2>
  <p>Makes a prop for two ranged properties that specify a range of items
that includes both the offsetProperty and limitProperty.  For example, set like:
<code>{offset: 20, limit: 10}</code> loads 10 items starting at index 20.</p>
<pre><code>new set.Algebra( set.props.offsetLimit(&quot;offset&quot;,&quot;limit&quot;) );
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>offsetProperty</b> <code>{String}</code>: <p>The offset property name on sets.  Defaults to <code>&quot;offset&quot;</code> if none is provided.</p>
</li>
        
          <li><b>limitProperty</b> <code>{String}</code>: <p>The offset limit name on sets. Defaults to <code>&quot;limit&quot;</code> if none is provided.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-set.compares.html" title="An object of property names and prop functions.
{
  // return `true` if the values should be considered the same:
  lastName: function(aValue, bValue){
    return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
  }
}">Compares</a>}</code>: <p>Returns a comparator used to build a set algebra.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.offsetLimit","parent":"can-set.props","src":{"line":407,"codeLine":427,"path":"node_modules/can-set/src/props.js"},"description":"Supports sets that include a limit and offset. \n","title":"offsetLimit","signatures":[{"code":"set.props.offsetLimit( [offsetProperty][, limitProperty] )","description":"\n\nMakes a prop for two ranged properties that specify a range of items\nthat includes both the offsetProperty and limitProperty.  For example, set like:\n`{offset: 20, limit: 10}` loads 10 items starting at index 20.\n\n```\nnew set.Algebra( set.props.offsetLimit(\"offset\",\"limit\") );\n```\n","params":[{"types":[{"type":"String"}],"name":"offsetProperty","description":"The offset property name on sets.  Defaults to `\"offset\"` if none is provided."},{"types":[{"type":"String"}],"name":"limitProperty","description":"The offset limit name on sets. Defaults to `\"limit\"` if none is provided."}],"returns":{"types":[{"type":"can-set.compares"}],"description":"Returns a comparator used to build a set algebra.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"limitProperty","description":"The offset limit name on sets. Defaults to `\"limit\"` if none is provided."},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"Returns a comparator used to build a set algebra.\n"},"pathToRoot":".."};
</script>
</article>
