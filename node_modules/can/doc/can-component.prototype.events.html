...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/events.md
	@property can-component.prototype.events
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - events</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-component.prototype.events.html">events</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>events</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/events.md">Edit on GitHub</a>
				</li>
    ...
    <p>Listen to events on elements and observables.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>Object&lt;<a href="can-control.eventDescription.html" title="">eventDescription</a>,<a href="can-control.eventHandler.html" title="">eventHandler(element, event)</a>()&gt;</code>
  </h2>
  <p>An object of event names and methods
...
<p>A component’s events object is used as the prototype of a <a href="can-control.html" title="Create organized, memory-leak free, rapidly performing, stateful controls with declarative event binding. Use Control to create UI
controls like tabs, grids, and context menus,
and organize them into higher-order business rules with
...
<h2>High performance view rendering</h2>
<p>While <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> conveniently allows you to call a <a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a> method from a view like:</p>
...
<p>By contrast, events bound using <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>’s events object use event delegation, which is useful for high performance view rendering. In a large grid or list, event delegation only binds a single event handler rather than one per row.</p>
