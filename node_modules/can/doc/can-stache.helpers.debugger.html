...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/debugger.md
	@function can-stache.helpers.debugger
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{debugger()}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.debugger.html">{{debugger()}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{debugger()}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/debugger.md">Edit on GitHub</a>
				</li>
    ...
    <p>In development, breaks at the given point in the template to inspect the current scope in the console.</p>
...
<div class="signature">
  ...
  <p>The zero argument debugger breaks any time the helper evaluates.</p>
<pre><code>&lt;!-- break each render --&gt;
{{debugger()}}
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{debugger(CONDITION)}}</code>
  </h2>
  <p>The one argument debugger breaks any time the helper evaluates and the argument evaluates to a truthy value.</p>
<pre><code>&lt;!-- break each render when value is truthy --&gt;
{{debugger(value)}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>CONDITION</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>an EXPRESSION that if evaluates to a truthy value triggers the debugger.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{debugger(LEFT, RIGHT)}}</code>
  </h2>
  <p>The two argument debugger breaks any time the helper evaluates and the two evaluated arguments are equal to each other.</p>
<pre><code>&lt;!-- break each render when leftValue === rightValue --&gt;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>LEFT</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>an EXPRESSION which compares with RIGHT which if equal triggers the debugger.</p>
</li>
        
          <li><b>RIGHT</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>an EXPRESSION which compares with LEFT which if equal triggers the debugger.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>debugger</code> helper breaks at its place in the template.</p>
<p>During a break, in the paused inspector there is a special <code>get(&lt;path&gt;)</code> function to help inspect the current scope. For example, <code>get(&quot;book.title&quot;)</code> will attempt to locate <code>book</code> in the current scope and return its <code>title</code> property.</p>
<p>Use the helper in development and debugging.
In production, the <code>debugger</code> never breaks and instead prints a warning.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/debugger.md"},"description":"\nIn development, breaks at the given point in the template to inspect the current scope in the console.\n","title":"{{debugger()}}","name":"can-stache.helpers.debugger","type":"function","parent":"can-stache.htags","order":10,"signatures":[{"code":"{{debugger()}}","description":"\nThe zero argument debugger breaks any time the helper evaluates.\n\n```\n<!-- break each render -->\n{{debugger()}}\n```\n","params":[]},{"code":"{{debugger(CONDITION)}}","description":"\nThe one argument debugger breaks any time the helper evaluates and the argument evaluates to a truthy value.\n\n```\n<!-- break each render when value is truthy -->\n{{debugger(value)}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"CONDITION","description":"an EXPRESSION that if evaluates to a truthy value triggers the debugger.\n"}]},{"code":"{{debugger(LEFT, RIGHT)}}","description":"\nThe two argument debugger breaks any time the helper evaluates and the two evaluated arguments are equal to each other.\n\n```\n<!-- break each render when leftValue === rightValue -->\n{{debugger(leftValue, rightValue)}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"LEFT","description":"an EXPRESSION which compares with RIGHT which if equal triggers the debugger.\n"},{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"RIGHT","description":"an EXPRESSION which compares with LEFT which if equal triggers the debugger.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"RIGHT","description":"an EXPRESSION which compares with LEFT which if equal triggers the debugger.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
