...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate/docs/validator.md
	@typedef can-validate.validator
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - validator</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate.validator.html">validator</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>validator</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate/edit/master/docs/validator.md">Edit on GitHub</a>
				</li>
    ...
    <p>A function that validates a value against predefined constraints and returns validation errors, if any are found.</p>
...
<div class="signature">
  ...
  <pre><code class="language-js">function (value) {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{*}</code>: <p>A simple value to validate</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Error|String|undefined|Array&lt;Error|String&gt;}</code>: <p>Returns undefined if no errors found. Otherwise, will return an error type with the error message.</p>
</p>
  </div>
...
<p>Given that a <code>required</code> validation exists</p>
<pre><code class="language-js">// Custom required check
...
<p>Typically a validator can be created like so</p>
<pre><code class="language-js">// Validator factory
...
<p>Now, creating a validator for any value is possible by doing</p>
<pre><code class="language-js">var nameValidator = makeValidator({required: true});
</code></pre>
<p>Which then allows validating values as needed</p>
<pre><code class="language-js">nameValidator('Juan'); //&gt; undefined
nameValidator(); //&gt; 'is required'
</code></pre>
<h2>Validator Response</h2>
<p>The response should match the <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a> type. The most flexible response
is the <a href="can-validate.error.html" title="An object that defines a validation failure.">Error</a> type which describes the error message any value keys that
triggered the error state.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate/docs/validator.md"},"description":"\nA function that validates a value against predefined constraints and returns validation errors, if any are found.\n","type":"typedef","title":"validator","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-validate.validator","parent":"can-validate.types","signatures":[{"code":"validator(value)","description":"\n\n  ```js\n  function (value) {\n  \tif (typeof value === 'undefined' || value === '')) {\n  \t\treturn 'is required';\n  \t}\n  }\n  ```\n","params":[{"types":[{"type":"*"}],"name":"value","description":"A simple value to validate\n"}],"returns":{"types":[{"type":"Error"},{"type":"String"},{"type":"undefined"},{"type":"Array","template":[{"types":[{"type":"Error"},{"type":"String"}]}]}],"description":"Returns undefined if no errors found. Otherwise, will return an error type with the error message.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"A simple value to validate\n"},"_curReturn":{"types":[{"type":"Error"},{"type":"String"},{"type":"undefined"},{"type":"Array","template":[{"types":[{"type":"Error"},{"type":"String"}]}]}],"description":"Returns undefined if no errors found. Otherwise, will return an error type with the error message.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
