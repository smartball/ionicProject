...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/can-symbol.md
	@page can-symbol
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-symbol</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/isFunctionLike.html"
							title="Set to true on objects with numeric indexes and length.">
							can.isFunctionLike
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/isListLike.html"
							title="Set to true on objects with numeric indexes and length.">
							can.isListLike
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/isMapLike.html"
							title="Set to true to show that an object is usable like a Map with named properties.">
							can.isMapLike
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/isValueLike.html"
							title="Set to true to show than an object is usable like an atomic value (a number, string, boolean, or undefined value).">
							can.isValueLike
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/assignDeep.html"
							title="Defines how to copy values onto an object.">
							can.assignDeep
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getName.html"
							title="Returns a human-readable name of an object">
							can.getName
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getOwnEnumerableKeys.html"
							title="List the enumerable keys (as defined by its property descriptor) an object has, but not those from its prototype chain.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getOwnKeyDescriptor.html"
							title="Describe the attributes of an object&#x27;s keyed property.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getOwnKeys.html"
							title="List which keys an object has of its own (not other objects on the prototype chain).">
							can.getOwnKeys
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/hasOwnKey.html"
							title="Define a function to determine key membership of an object">
							can.hasOwnKey
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/proto.html"
							title="Defines the &quot;proto&quot; (first element in the prototype chain) of an object">
							can.proto
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/size.html"
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/updateDeep.html"
							title="Defines how to change the state of the current object to match the state of another object.">
							can.updateDeep
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getKeyDependencies.html"
							title="A symbol placed on a constructor to reference a function that returns the other events that will trigger an event for the key on the object.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getValueDependencies.html"
							title="A symbol placed on a constructor to reference a function that returns the other events that will trigger a value change event on the object.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/keyHasDependencies.html"
							title="Check if there are any other objects that affect the value of a named property.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/offKeyValue.html"
							title="Defines how observable values can be listened to on a type.">
							can.offKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/offValue.html"
							title="Defines how observables can stop listening to the object&#x27;s value changing.">
							can.offValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/onKeyValue.html"
							title="Defines how observable values can be listened to on a type.">
							can.onKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/onKeys.html"
							title="Define a function used to listen to when the object&#x27;s key set changes.">
							can.onKeys
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/onKeysAdded.html"
							title="Define a function used to listen to when the object&#x27;s key set has new additions.">
							can.onKeysAdded
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/onKeysRemoved.html"
							title="Define a function used to listen to when the object&#x27;s key set has keys removed through deletion.">
							can.onKeysRemoved
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/onValue.html"
							title="Defines how observables can listen to the object&#x27;s value changing.">
							can.onValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/valueHasDependencies.html"
							title="Define a function that checks if there are any other observable objects that affect the value of the object.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/deleteKeyValue.html"
							title="Defines a function that deletes one of an object&#x27;s named properties.">
							can.deleteKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getKeyValue.html"
							title="Defines a function to access and return the value of one of the object&#x27;s named properties.">
							can.getKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/getValue.html"
							title="Defines a function that returns the object&#x27;s current value when called.">
							can.getValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/setKeyValue.html"
							title="Defines a function that sets the value of one of an object&#x27;s named properties.">
							can.setKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/setValue.html"
							title="Define a function that sets the object&#x27;s value.">
							can.setValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/updateValues.html"
							title="Add and remove multiple values at once.">
							can.updateValues
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-symbol/symbols/apply.html"
							title="How to apply a List-like as the arguments to a call of the function.">
							can.apply
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-symbol/symbols/new.html"
							title="Create a new instance of a constructor function or prototype object.">
							can.new
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-symbol.for.html"
							title="Get a symbol based on a known string identifier, or create it if it doesn&#x27;t exist.">
							for
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-symbol.keyFor.html"
							title="Get the description for a symbol.">
							keyFor
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-symbol.html">can-symbol</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-symbol</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-symbol">
						<img src="https://img.shields.io/badge/npm%20package-1.4.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-symbol" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/can-symbol.md">Edit on GitHub</a>
				</li>
    ...
    <p>Symbols used to detail how CanJS may operate on different objects
CanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop
with external libraries.  CanJS uses symbols to identify object types, property access methods, and for event
handling.</p>
<p><code>can-symbol</code> also has a polyfill function that will fake symbols on unsupported platforms.</p>
...
<div class="signature">
  ...
  <p>Create or reuse symbols based on an optional string description</p>
    ...
    <section class="body">
    <pre><code>    var MyIDSymbol = CanSymbol(&quot;my_ID&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/can-symbol.md"},"description":"Symbols used to detail how CanJS may operate on different objects \nCanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop\nwith external libraries.  CanJS uses symbols to identify object types, property access methods, and for event\nhandling.\n\n`can-symbol` also has a polyfill function that will fake symbols on unsupported platforms.\n\n","name":"can-symbol","type":"page","parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"core@donejs.com","url":"http://donejs.com"},"bugs":{"url":"https://github.com/canjs/can-symbol/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"^1.0.0"},"deprecated":false,"description":"Well known symbols used to detail how to operate on different objects","devDependencies":{"bit-docs":"0.0.7","detect-cyclic-packages":"^1.1.0","done-serve":"^1.0.0-alpha.0","donejs-cli":"^1.0.0-alpha.2","generator-donejs":"^1.0.0-alpha.0","jshint":"^2.9.1","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"homepage":"http://canjs.com","keywords":["Done","JS"],"main":"can-symbol","name":"can-symbol","repository":{"type":"git","url":"git://github.com/canjs/can-symbol.git"},"scripts":{"detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postpublish":"git push --tags && git push","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"system":{"main":"can-symbol","configDependencies":["live-reload"],"npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"1.4.1"},"signatures":[{"code":"canSymbol(String)","description":"\n\nCreate or reuse symbols based on an optional string description\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
