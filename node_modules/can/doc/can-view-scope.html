...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/can-view-scope.md
	@module can-view-scope
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-scope</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.Options.html"
							title="">
							Options
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.prototype.add.html"
							title="">
							add
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.prototype.compute.html"
							title="">
							compute
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.prototype.get.html"
							title="">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.prototype.peek.html"
							title="Read a value from the scope without being observable.">
							peek
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-scope.prototype.set.html"
							title="">
							set
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.html">can-view-scope</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-scope</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-scope">
						<img src="https://img.shields.io/badge/npm%20package-3.3.9-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-scope" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/can-view-scope.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a lookup node for [can-mustache.key keys].</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new Scope(context, [parent], [meta] )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>context</b> <code>{*}</code>: <p>A value that represents the
current context. This is often an object or observable and is the first
place a <code>key</code> is looked up.</p>
</li>
        
          <li><b>parent</b> <code>{<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>}</code>: <p>The parent scope. If a <code>key</code> value
is not found in the current scope, it will then look in the parent
scope.</p>
</li>
        
          <li><b>meta</b> <code>{<a href="can-view-scope/Meta.html" title="">Meta</a>}</code>: <p>A configuration object that
can specify special behavior of the context.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>}</code>: <p>Returns a scope instance.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> represents a lookup context and parent contexts
that can be used to lookup a <a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a> value.</p>
<p>If no parent scope is provided, only the scope's context will be
explored for values.  For example:</p>
<pre><code>var data = {name: {first: &quot;Justin&quot;}},
    scope = new Scope(data);

scope.get(&quot;name.first&quot;) //-&gt; &quot;Justin&quot;
scope.get(&quot;length&quot;)     //-&gt; undefined
</code></pre>
<p>However, if a <code>parent</code> scope is provided, key values will be
searched in the parent's context after the initial context is explored.  For example:</p>
<pre><code>var list = [{name: &quot;Justin&quot;},{name: &quot;Brian&quot;}],
    justin = list[0];
...
<p>Use <a href="can-view-scope.prototype.add.html" title="">add</a> to easily create a new scope from a parent scope like:</p>
<pre><code>var list = [{name: &quot;Justin&quot;},{name: &quot;Brian&quot;}],
    justin = list[0];
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-scope/docs/can-view-scope.md"},"description":"Create a lookup node for [can-mustache.key keys]. \n\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-view-scope","parent":"can-infrastructure","inherits":"can","test":"can/view/scope/test.html","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-view-scope/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.0.3","can-compute":"^3.3.7","can-construct":"^3.2.0","can-event":"^3.5.0","can-log":"^0.1.0","can-namespace":"1.0.0","can-observation":"^3.3.1","can-reflect":"^1.2.1","can-simple-map":"^3.3.0","can-stache-key":"^0.1.0","can-symbol":"^1.0.0","can-util":"^3.9.5"},"deprecated":false,"description":"Observable scopes","devDependencies":{"can-define":"^1.3.3","can-list":"^3.2.0","can-map":"^3.3.1","can-test-helpers":"^1.0.1","detect-cyclic-packages":"^1.1.0","jshint":"^2.9.1","steal":"^1.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-view-scope","name":"can-view-scope","repository":{"type":"git","url":"git://github.com/canjs/can-view-scope.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.3.9"},"signatures":[{"code":"new Scope(context, [parent], [meta] )","description":"\n","params":[{"types":[{"type":"*"}],"name":"context","description":"A value that represents the\ncurrent context. This is often an object or observable and is the first\nplace a `key` is looked up.\n"},{"types":[{"type":"can-view-scope"}],"optional":true,"name":"parent","description":"The parent scope. If a `key` value\nis not found in the current scope, it will then look in the parent\nscope.\n"},{"types":[{"type":"can-view-scope/Meta"}],"optional":true,"name":"meta","description":"A configuration object that\ncan specify special behavior of the context.\n"}],"release":"2.0.1","returns":{"types":[{"type":"can-view-scope"}],"description":"Returns a scope instance.\n"}}],"_curParam":{"types":[{"type":"can-view-scope/Meta"}],"optional":true,"name":"meta","description":"A configuration object that\ncan specify special behavior of the context.\n"},"_curReturn":{"types":[{"type":"can-view-scope"}],"description":"Returns a scope instance.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
