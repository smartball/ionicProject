...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/if.md
	@function can-stache.helpers.if
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#if(expression)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.if.html">{{#if(expression)}}</a></li>
	...
	<div class="page-type">
		<h1>{{#if(expression)}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/if.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#if(EXPRESSION)}}FN{{else}}INVERSE{{/if}}</code>
  </h2>
  <p>Renders <code>FN</code> if <code>EXPRESSION</code> is truthy or <code>INVERSE</code> if <code>EXPRESSION</code>
is falsey. Both <code>FN</code> and <code>INVERSE</code> will be rendered with the
current scope.</p>
<pre><code>{{#if(person.isAwake())}} Hello {{/if}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>A lookup expression that will provide a truthy or falsey value.</p>
</li>
        
          <li><b>FN</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>A subsection that can be optionally rendered.</p>
</li>
...
if <code>EXPRESSION</code> is falsey and <a href="can-stache.helpers.else.html" title="">{{else}}</a> is used.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>{{#if(key)}}</code> provides explicit conditional truthy tests. For example,</p>
<p>The template:</p>
<pre><code>{{#if(user.isFemale)}}
  {{#if(user.isMarried)}}
    Mrs
  {{/if}}
  {{#if(user.isSingle)}}
...
<p>Rendered with:</p>
<pre><code>{user: {isFemale: true, isMarried: true}}
</code></pre>
<p>Results in:</p>
<pre><code>Mrs
</code></pre>
<p>If can be used with <a href="can-stache.helpers.else.html" title="">{{else}}</a> too. For example,</p>
<pre><code>{{#if(user.isFemale)}}
  {{#if(user.isMarried)}}
    Mrs
  {{else}}
...
<p>Rendered with:</p>
<pre><code>{user: {isFemale: true, isMarried: false}}
</code></pre>
<p>Results in:</p>
<pre><code>Miss
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/if.md"},"description":"","title":"{{#if(expression)}}","name":"can-stache.helpers.if","type":"function","parent":"can-stache.htags","order":2,"signatures":[{"code":"{{#if(EXPRESSION)}}FN{{else}}INVERSE{{/if}}","description":"\n\nRenders `FN` if `EXPRESSION` is truthy or `INVERSE` if `EXPRESSION`\nis falsey. Both `FN` and `INVERSE` will be rendered with the\ncurrent scope.\n\n```\n{{#if(person.isAwake())}} Hello {{/if}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"A lookup expression that will provide a truthy or falsey value.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"name":"FN","description":"A subsection that can be optionally rendered.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"optional":true,"name":"INVERSE","description":"An optional subsection that will be rendered\nif `EXPRESSION` is falsey and [can-stache.helpers.else] is used.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"optional":true,"name":"INVERSE","description":"An optional subsection that will be rendered\nif `EXPRESSION` is falsey and [can-stache.helpers.else] is used.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
