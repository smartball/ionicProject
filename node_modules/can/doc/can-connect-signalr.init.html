...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/init.md
	@function can-connect-signalr.init
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-signalr.init.html">init</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>init</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/init.md">Edit on GitHub</a>
				</li>
    ...
    <p>Establishes a connection to the <code>SignalR</code> hub, sets up proxy methods and RPC listeners.</p>
<p>The <code>init</code> method establishes a connection to the <code>SignalR</code> hub, and creates a hub proxy. For each CRUD method,
...
method. The listener corresponding to that method, by default called <code>createdData</code>, is registered on the proxy.</p>
<p>The <code>init</code> method is called automatically.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/init.md"},"description":"Establishes a connection to the `SignalR` hub, sets up proxy methods and RPC listeners. \n\nThe `init` method establishes a connection to the `SignalR` hub, and creates a hub proxy. For each CRUD method,\na corresponding RPC listener is registered on the proxy. For example, `can-connect-signalr` implements a `createData`\nmethod. The listener corresponding to that method, by default called `createdData`, is registered on the proxy.\n\nThe `init` method is called automatically.\n","title":"init","name":"can-connect-signalr.init","type":"function","parent":"can-connect-signalr/methods","types":[],"pathToRoot":".."};
</script>
</article>
