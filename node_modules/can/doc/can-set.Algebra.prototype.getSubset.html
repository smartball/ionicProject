...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.getSubset.html">getSubset</a></li>
	...
	<div class="page-type">
		<h1>getSubset</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L578">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Gets <code>a</code> set's items given a super set <code>b</code> and its items.</p>
<pre><code class="language-js">algebra.getSubset(
  {type: &quot;dog&quot;},
  {},
  [{id: 1, type:&quot;cat&quot;},
   {id: 2, type: &quot;dog&quot;},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>a</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set whose data will be returned.</p>
</li>
        
          <li><b>b</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A superset of set <code>a</code>.</p>
</li>
        
          <li><b>bData</b> <code>{Array&lt;Object&gt;}</code>: <p>The data in set <code>b</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array&lt;Object&gt;}</code>: <p>The data in set <code>a</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.getSubset","parent":"can-set.Algebra.prototype","src":{"line":577,"codeLine":601,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"getSubset","signatures":[{"code":"algebra.getSubset(a, b, bData)","description":"\n\nGets `a` set's items given a super set `b` and its items.\n\n```js\nalgebra.getSubset(\n  {type: \"dog\"},\n  {},\n  [{id: 1, type:\"cat\"},\n   {id: 2, type: \"dog\"},\n   {id: 3, type: \"dog\"},\n   {id: 4, type: \"zebra\"}]\n) //-> [{id: 2, type: \"dog\"},{id: 3, type: \"dog\"}]\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"a","description":"The set whose data will be returned."},{"types":[{"type":"can-set/Set"}],"name":"b","description":"A superset of set `a`."},{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}]}],"name":"bData","description":"The data in set `b`."}],"returns":{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"The data in set `a`.\n "}}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}]}],"name":"bData","description":"The data in set `b`."},"_curReturn":{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"The data in set `a`.\n "},"pathToRoot":".."};
</script>
</article>
