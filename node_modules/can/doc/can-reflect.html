...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-reflect/can-reflect.md
	@module can-reflect
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-reflect</title>
...
way to observe those reads called within a given function.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.assign.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.assignDeep.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.assignSymbols.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.each.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.eachIndex.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.eachKey.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.getOwnEnumerableKeys.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.getOwnKeyDescriptor.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.getOwnKeys.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.hasOwnKey.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.size.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.toArray.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.update.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-reflect/shape.updateDeep.html"
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-reflect</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-reflect">
						<img src="https://img.shields.io/badge/npm%20package-1.7.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-reflect" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/can-reflect.md">Edit on GitHub</a>
				</li>
    ...
    <p>Perform operations and read information on unknown data types.</p>
...
<div class="signature">
  ...
  <p>The <code>can-reflect</code> package exports an object with
methods used to perform operations and read information on unknown data
types. For example the sets the <code>name</code> property on some type of map:</p>
<pre><code class="language-js">const canReflect = require(&quot;can-reflect&quot;);

const map = CREATE_MAP_SOMEHOW();

canReflect.setKeyValue(map,&quot;name&quot;, &quot;my map&quot;);
</code></pre>
<p>Any object can interact with the reflect APIs by having the right
<a href="can-symbol.html" title="Symbols used to detail how CanJS may operate on different objects
CanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop
with external libraries.  CanJS uses symbols to identify object types, property access methods, and for event
handling.
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">can-symbol</a> symbols.  The following creates an object that informs how
<a href="can-reflect.getKeyValue.html" title="Get the value of a named property on a MapLike object.">getKeyValue</a> and <a href="can-reflect.setKeyValue.html" title="Set the value of a named property on a MapLike object.">setKeyValue</a> behave:</p>
<pre><code class="language-js">const canSymbol = require(&quot;can-symbol&quot;);
...
<p><code>can-reflect</code> organizes it's methods into the following groups:</p>
<ul>
<li><strong>Type Reflections</strong> - Determine if an object matches a familiar type to CanJS.</li>
<li><strong>Get/Set Reflections</strong> - Read and write to objects.</li>
<li><strong>Call Reflections</strong> - Call functions and function-like objects.</li>
<li><strong>Shape Reflections</strong> - Perform operations based on multiple values within an object.</li>
<li><strong>Observable Reflections</strong> - Listen to changes in observable objects.</li>
</ul>
