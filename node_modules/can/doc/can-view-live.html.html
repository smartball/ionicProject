...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-live/lib/html.js
	@function can-view-live.html
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - html</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-live.html.html">html</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>html</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-live/edit/master/lib/html.js#L8">Edit on GitHub</a>
				</li>
    ...
    <p>Live binds a compute's value to a collection of elements.</p>
...
<div class="signature">
  ...
  <p><code>live.html</code> is used to setup incremental live-binding on a block of html.</p>
<pre><code class="language-js">// a compute that changes its list
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>compute</b> <code>{can.compute}</code>: <p>A [can.compute] whose value is HTML.</p>
</li>
