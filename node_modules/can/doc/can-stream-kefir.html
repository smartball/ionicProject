...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream-kefir/docs/can-stream-kefir.md
	@module can-stream-kefir
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-stream-kefir</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-stream-kefir</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-stream-kefir">
						<img src="https://img.shields.io/badge/npm%20package-0.3.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-stream-kefir" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream-kefir/edit/master/docs/can-stream-kefir.md">Edit on GitHub</a>
				</li>
    ...
    <p>Convert observable values into streams. <a href="https://rpominov.github.io/kefir/">Kefir</a> is used to provide the stream functionality.</p>
...
<div class="signature">
  ...
  <p>The <code>can-stream-kefir</code> module exports methods useful for converting observable values like <a href="can-compute.html" title="Create an observable value.">can-compute</a>s
or <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> properties into streams.</p>
...
me.name = &quot;Obaid&quot;;
    ...
    <section class="body">
    <h2>Usage</h2>
<p>The <a href="can-stream-kefir.toStream.html" title="Provides a shorthand for creating a stream from observable objects, properties and events.">toStream</a> method takes a compute and returns a <a href="https://rpominov.github.io/kefir/">Kefir</a> stream instance.</p>
<pre><code>var canStream = require(&quot;can-stream-kefir&quot;);

canStream.toStream(compute)                    //-&gt; stream
</code></pre>
<p>For example:</p>
<p><strong>Converting a compute to a stream</strong></p>
<pre><code class="language-js">var canCompute = require(&quot;can-compute&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream-kefir/docs/can-stream-kefir.md"},"description":"Convert observable values into streams. [Kefir](https://rpominov.github.io/kefir/) is used to provide the stream functionality. \n","type":"module","title":"can-stream-kefir","types":[{"type":"Object","options":[],"description":"\n\n  The `can-stream-kefir` module exports methods useful for converting observable values like [can-compute]s\n  or [can-define/map/map] properties into streams.\n\n  ```js\n  var canStream = require(\"can-stream-kefir\");\n  var DefineMap = require(\"can-define/map/map\");\n\n  var me = new DefineMap({name: \"Justin\"});\n\n  var nameStream = canStream.toStream(me,\".name\");\n\n\n  nameStream.onValue(function(name){\n\t  // name -> \"Obaid\";\n  });\n\n  me.name = \"Obaid\";\n  ```\n"}],"name":"can-stream-kefir","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-stream-kefir/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.1.0","can-event":"^3.5.0","can-namespace":"^1.0.0","can-observation":"^3.2.0","can-stream":"^0.3.0","can-util":"^3.9.0","kefir":"^3.5.1"},"deprecated":false,"description":"Stream values into and out of computes","devDependencies":{"can-define":"^1.2.3","detect-cyclic-packages":"^1.1.0","done-serve":"^1.3.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.5.4","steal-qunit":"^1.0.1","steal-tools":"^1.3.6","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-stream-kefir","name":"can-stream-kefir","repository":{"type":"git","url":"git://github.com/canjs/can-stream-kefir.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"0.3.2"},"comment":" ","pathToRoot":".."};
</script>
</article>
