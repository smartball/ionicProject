...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/remove.md
	@function can-map-define.remove
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map-define.remove.html">remove</a></li>
	...
	<div class="page-type">
		<h1>remove</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/remove.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*|false}</code>: <p>If <code>false</code> is returned, the value is not removed.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The following prevents removing the <em>prop</em> attribute if someone tries to remove the value 0:</p>
<pre><code>define: {
  prop: {
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-define/docs/remove.md"},"description":"\nCalled when an attribute is removed.\n","title":"remove","name":"can-map-define.remove","type":"function","parent":"can-map-define","signatures":[{"code":"remove( currentValue )","description":"\n","params":[],"returns":{"types":[{"type":"*"},{"type":"false"}],"description":"If `false` is returned, the value is not removed.\n"}}],"_curReturn":{"types":[{"type":"*"},{"type":"false"}],"description":"If `false` is returned, the value is not removed.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
