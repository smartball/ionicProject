...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/location/location.js
	@module can-globals/location/location
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>location</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/location/location.js#L6">Edit on GitHub</a>
				</li>
    ...
    <p>Get the global <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/location"><code>location</code></a> object for the current context.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>LOCATION([newLocation])</code>
  </h2>
  <p>Optionally sets, and returns, the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/location"><code>location</code></a> object for the context.</p>
<pre><code class="language-js">var locationShim = { path: '/' };
...
LOCATION().path; // -&gt; '/'
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>location</b> <code>{Object}</code>: <p>An optional location-like object to set as the context's location</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The location object for this JavaScript environment.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":5,"codeLine":26,"path":"node_modules/can-globals/location/location.js"},"type":"module","description":"\nGet the global [`location`](https://developer.mozilla.org/en-US/docs/Web/API/Window/location) object for the current context.\n","title":"location","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-globals/location/location","parent":"can-globals/modules","signatures":[{"code":"LOCATION([newLocation])","description":"\n\nOptionally sets, and returns, the [`location`](https://developer.mozilla.org/en-US/docs/Web/API/Window/location) object for the context.\n\n```js\nvar locationShim = { path: '/' };\nvar LOCATION = require('can-globals/location/location');\nLOCATION(locationShim);\nLOCATION().path; // -> '/'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"location","description":"An optional location-like object to set as the context's location\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The location object for this JavaScript environment.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"location","description":"An optional location-like object to set as the context's location\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The location object for this JavaScript environment.\n"},"pathToRoot":"../../.."};
</script>
</article>
