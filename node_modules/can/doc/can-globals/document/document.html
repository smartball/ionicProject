...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/document/document.js
	@module can-globals/document/document
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>document</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/document/document.js#L6">Edit on GitHub</a>
				</li>
    ...
    <p>Get the global <a href="https://developer.mozilla.org/en-US/docs/Web/API/document"><code>document</code></a> object for the current context.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DOCUMENT([newDocument])</code>
  </h2>
  <p>Optionally sets, and returns, the <a href="https://developer.mozilla.org/en-US/docs/Web/API/document"><code>document</code></a> object for the context.</p>
<pre><code class="language-js">var documentShim = { getElementById() {...} };
...
DOCUMENT().getElementById('foo');
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newDocument</b> <code>{Object}</code>: <p>An optional document-like object to set as the context's document</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The window object for this JavaScript environment.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":5,"codeLine":26,"path":"node_modules/can-globals/document/document.js"},"type":"module","description":"\nGet the global [`document`](https://developer.mozilla.org/en-US/docs/Web/API/document) object for the current context.\n","title":"document","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-globals/document/document","parent":"can-globals/modules","signatures":[{"code":"DOCUMENT([newDocument])","description":"\n\nOptionally sets, and returns, the [`document`](https://developer.mozilla.org/en-US/docs/Web/API/document) object for the context.\n\n```js\nvar documentShim = { getElementById() {...} };\nvar DOCUMENT = require('can-globals/document/document');\nDOCUMENT(documentShim); //-> document\nDOCUMENT().getElementById('foo');\n```\n","params":[{"types":[{"type":"Object","options":[]}],"optional":true,"name":"newDocument","description":"An optional document-like object to set as the context's document \n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The window object for this JavaScript environment.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"newDocument","description":"An optional document-like object to set as the context's document \n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The window object for this JavaScript environment.\n"},"pathToRoot":"../../.."};
</script>
</article>
