...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/mutation-observer/mutation-observer.js
	@module can-globals/mutation-observer/mutation-observer
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>mutation-observer</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/mutation-observer/mutation-observer.js#L6">Edit on GitHub</a>
				</li>
    ...
    <p>Get the global <a href="https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver"><code>MutationObserver</code></a> object for the current context.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>MUTATIONOBSERVER([newMutationObserver])</code>
  </h2>
  <p>Optionally sets, and returns, the <a href="https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver"><code>MutationObserver</code></a> object for the context.</p>
<pre><code class="language-js">var mutationObserverShim = require('can-globals/mutation-observer/mutation-observer');
...
MUTATIONOBSERVER() //-&gt; MutationObserver
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>MutationObserver</b> <code>{Object}</code>: <p>An optional MutationObserver-like object to set as the context's MutationObserver</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The MutationObserver object for this JavaScript environment.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":5,"codeLine":26,"path":"node_modules/can-globals/mutation-observer/mutation-observer.js"},"type":"module","description":"\nGet the global [`MutationObserver`](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver) object for the current context.\n","title":"mutation-observer","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-globals/mutation-observer/mutation-observer","parent":"can-globals/modules","signatures":[{"code":"MUTATIONOBSERVER([newMutationObserver])","description":"\n\nOptionally sets, and returns, the [`MutationObserver`](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver) object for the context.\n\n```js\nvar mutationObserverShim = require('can-globals/mutation-observer/mutation-observer');\nMUTATIONOBSERVER(mutationObserverShim);\nMUTATIONOBSERVER() //-> MutationObserver\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"MutationObserver","description":"An optional MutationObserver-like object to set as the context's MutationObserver\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The MutationObserver object for this JavaScript environment.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"MutationObserver","description":"An optional MutationObserver-like object to set as the context's MutationObserver\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The MutationObserver object for this JavaScript environment.\n"},"pathToRoot":"../../.."};
</script>
</article>
