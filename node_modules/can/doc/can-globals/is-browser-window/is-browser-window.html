...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/is-browser-window/is-browser-window.js
	@module can-globals/is-browser-window/is-browser-window
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<div class="page-type">
		<h1>is-browser-window</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/is-browser-window/is-browser-window.js#L5">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns <code>true</code> if the code is running within a Browser window. Use this function if you need special code paths for when running in a Browser window, a Web Worker, or another environment (such as Node.js).</p>
<pre><code class="language-js">var isBrowserWindow = require(&quot;can-globals/is-browser-window/is-browser-window&quot;);
...
if(isBrowserWindow()) {
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>True if the environment is a Browser window.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":23,"path":"node_modules/can-globals/is-browser-window/is-browser-window.js"},"type":"module","description":"","title":"is-browser-window","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-globals/is-browser-window/is-browser-window","parent":"can-globals/modules","signatures":[{"code":"isBrowserWindow()","description":"\n\nReturns `true` if the code is running within a Browser window. Use this function if you need special code paths for when running in a Browser window, a Web Worker, or another environment (such as Node.js).\n\n```js\nvar isBrowserWindow = require(\"can-globals/is-browser-window/is-browser-window\");\nvar GLOBAL = require(\"can-globals/global/global\");\n\nif(isBrowserWindow()) {\n  console.log(GLOBAL() === window); // -> true\n}\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"True if the environment is a Browser window.\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"True if the environment is a Browser window.\n"},"pathToRoot":"../../.."};
</script>
</article>
