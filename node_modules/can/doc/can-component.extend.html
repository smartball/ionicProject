...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/extend.md
...
<div class="breadcrumb">
	...
	<li><a href="can-component.extend.html">extend</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>extend</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/extend.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define the behavior of a custom element.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>Component.extend(prototype)</code>
  </h2>
  <p>Extends the <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a> <a href="can-construct.html" title="Provides a way to easily use the power of prototypal inheritance
without worrying about hooking up all the particulars yourself. Use
can-construct.extend to create an inheritable
constructor function of your own.">constructor function</a> with prototype
properties and methods.  Registers the component by its <a href="can-component.prototype.tag.html" title="Specifies the HTML tag (or node-name) the can-component will be created on.">tag</a> with
<a href="can-view-callbacks.tag.html" title="">can-view-callbacks.tag</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prototype</b> <code>{Object}</code>: <p>An object set as the prototype of the
constructor function. You will typically provide the following values
on the prototype object:</p>
<ul>
<li><p><strong>tag</strong> {<a href="can-component.prototype.tag.html" title="Specifies the HTML tag (or node-name) the can-component will be created on.">tag</a>} - Defines the
tag on which instances of the component constructor function will be
  created.</p></li>
<li><p><strong>ViewModel</strong> {<a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a>} - Specifies an object
that is used to render the component’s view.</p></li>
<li><p><strong>view</strong> {<a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
component’s can-component::ViewModel instance.  &lt;content/&gt; elements within the view are replaced by the source elements within the component’s tag.">view</a>} - Specifies the view
rendered within the custom element.</p></li>
</ul>
<p>And sometimes the following values are provided:</p>
<ul>
<li><p><strong>events</strong> {<a href="can-component.prototype.events.html" title="Listen to events on elements and observables.">events</a>} - Defines events on
dom elements or observable objects the component listens to.</p></li>
<li><p><strong>helpers</strong> {<a href="can-component.prototype.helpers.html" title="Helper functions used with the component’s view.">helpers</a>} - Specifies mustache helpers
used to render the component’s view.</p></li>
</ul>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Note that inheriting from components works differently than other CanJS APIs. You can’t call <code>.extend</code> on a particular component to create a “subclass” of that component.</p>
<p>Instead, components work more like HTML elements. To reuse functionality from a base component, build on top of it with parent components that wrap other components in their view and pass any needed viewModel properties via attributes.</p>
