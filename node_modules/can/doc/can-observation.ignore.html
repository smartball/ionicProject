...
<!--####################################################################
	...
	@function can-observation.ignore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-observation.ignore.html">ignore</a></li>
	...
	<div class="page-type">
		<h1>ignore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L556">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Creates a function that, when called, will prevent observations from
being applied.</p>
<pre><code class="language-js">var fn = Observation.ignore(function(){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>fn</b> <code>{function}</code>: <p>Any function that contains potential calls to
[Observation.add].</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>A function that is free of observation side-effects.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-observation.ignore","parent":"can-observation.static","src":{"line":555,"codeLine":578,"path":"node_modules/can-observation/can-observation.js"},"description":"","title":"ignore","signatures":[{"code":"Observation.ignore(fn)","description":"\n\nCreates a function that, when called, will prevent observations from\nbeing applied.\n\n```js\nvar fn = Observation.ignore(function(){\n  // This will be ignored\n  Observation.add(obj, \"prop1\");\n});\n\nfn();\nObservation.trapCount(); // -> 0\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"fn","description":"Any function that contains potential calls to\n[Observation.add].\n"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that is free of observation side-effects.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"fn","description":"Any function that contains potential calls to\n[Observation.add].\n"},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that is free of observation side-effects.\n"},"pathToRoot":".."};
</script>
</article>
