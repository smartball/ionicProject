...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/methods.toStreamFromEvent.md
	@function can-define-stream.tostreamfromevent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.tostreamfromevent.html">toStreamFromEvent</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStreamFromEvent</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/methods.toStreamFromEvent.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a stream based on an event</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DefineMap.toStreamFromEvent( eventName )</code>
  </h2>
  <p>Creates a stream from an event that gets updated whenever the event is triggered.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{String}</code>: <p>An event name</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/methods.toStreamFromEvent.md"},"description":"Create a stream based on an event \n","title":"toStreamFromEvent","name":"can-define-stream.tostreamfromevent","type":"function","parent":"can-define-stream.fns","signatures":[{"code":"DefineMap.toStreamFromEvent( eventName )","description":"\n\nCreates a stream from an event that gets updated whenever the event is triggered.\n\n```js\nvar DefineList = require('can-define/list/list');\nvar canStream = require(\"can-stream-kefir\");\nvar canDefineStream = require(\"can-define-stream\");\n\nvar PeopleList = DefineList.extend({});\n\ncanDefineStream(canStream)(PeopleList);\n\nvar people = new PeopleList([\n    { first: \"Justin\", last: \"Meyer\" },\n    { first: \"Paula\", last: \"Strozak\" }\n]);\n\nvar stream = people.toStreamFromEvent('length'); // using eventName\n\nstream.onValue(function(val) {\n    val //-> 2, 3\n});\n\npeople.push({\n    first: 'Obaid',\n    last: 'Ahmed'\n}); //-> stream.onValue -> 3\n```\n","params":[{"types":[{"type":"String"}],"name":"event","description":"An event name\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"event","description":"An event name\n"},"_curReturn":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"},"pathToRoot":".."};
</script>
</article>
