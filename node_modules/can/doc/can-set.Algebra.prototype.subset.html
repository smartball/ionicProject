...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.subset.html">subset</a></li>
	...
	<div class="page-type">
		<h1>subset</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L269">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns true if <em>A</em> is a subset of <em>B</em> or <em>A</em> is equal to <em>B</em> (<em>A</em> ⊆ <em>B</em>).</p>
<pre><code class="language-js">algebra.subset({type: &quot;critical&quot;}, {}) //-&gt; true
algebra.subset({}, {}) //-&gt; true
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <code>a</code> is a subset of <code>b</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.subset","parent":"can-set.Algebra.prototype","src":{"line":268,"codeLine":285,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"subset","signatures":[{"code":"algebra.subset(a, b)","description":"\n\nReturns true if _A_ is a subset of _B_ or _A_ is equal to _B_ (_A_ ⊆ _B_).\n\n```js\nalgebra.subset({type: \"critical\"}, {}) //-> true\nalgebra.subset({}, {}) //-> true\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"a","description":"A set."},{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if `a` is a subset of `b`.\n "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if `a` is a subset of `b`.\n "},"pathToRoot":".."};
</script>
</article>
