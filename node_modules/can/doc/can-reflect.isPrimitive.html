...
<!--####################################################################
	...
	@function can-reflect.isPrimitive
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isPrimitive</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isPrimitive.html">isPrimitive</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isPrimitive</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L102">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value is a JavaScript primitive.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isPrimitive(obj)</code>
  </h2>
  <p>Return <code>true</code> if <code>obj</code> is not a function nor an object via <code>typeof</code>, or is null; <code>false</code> otherwise.</p>
<pre><code>canReflect.isPrimitive(null); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>maybe a primitive value</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isPrimitive","parent":"can-reflect/type","src":{"line":101,"codeLine":123,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value is a JavaScript primitive. ","title":"isPrimitive","signatures":[{"code":"isPrimitive(obj)","description":"\n\nReturn `true` if `obj` is not a function nor an object via `typeof`, or is null; `false` otherwise.\n\n```\ncanReflect.isPrimitive(null); // -> true\ncanReflect.isPrimitive({}); // -> false\ncanReflect.isPrimitive(undefined); // -> true\ncanReflect.isPrimitive(1); // -> true\ncanReflect.isPrimitive([]); // -> false\ncanReflect.isPrimitive(function() {}); // -> false\ncanReflect.isPrimitive(\"foo\"); // -> true\n\n```\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"maybe a primitive value"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"obj","description":"maybe a primitive value"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
