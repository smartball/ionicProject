...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/registerSimpleHelper.md
	@function can-stache.registerSimpleHelper
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - registerSimpleHelper</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.registerSimpleHelper.html">registerSimpleHelper</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>registerSimpleHelper</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/registerSimpleHelper.md">Edit on GitHub</a>
				</li>
    ...
    <p>Register a helper that gets passed values.</p>
...
<div class="signature">
  ...
  <p>Registers a helper with stache that always returns
the arguments value (instead of a compute).
Pass the name of the helper followed by the
function to which Mustache should invoke.</p>
<p>See <a href="can-stache.Helpers.html" title="Helpers are functions that can be registered and called from within templates.  These functions
are typically used to provide functionality that is more appropriate for
the view than the viewModel.">Helpers</a> for more details on using helpers
and <a href="can-stache.registerHelper.html" title="Register a helper.">registerHelper</a> to get computes for observable values.</p>
<pre><code class="language-js">stache.registerSimpleHelper(&quot;upper&quot;, function(str){
    return str.toUpperCase();
});
</code></pre>
<p>See <a href="can-stache.Helpers.html" title="Helpers are functions that can be registered and called from within templates.  These functions
are typically used to provide functionality that is more appropriate for
the view than the viewModel.">Helpers</a> for more details on using helpers.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>The name of the helper.</p>
</li>
        
          <li><b>helper</b> <code>{<a href="can-stache.simpleHelper.html" title="A helper function passed to can-stache.registerSimpleHelper.">simpleHelper</a>(arg..., <a href="can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">options</a>)}</code>: <p>The helper function.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/registerSimpleHelper.md"},"description":"Register a helper that gets passed values. \n","title":"registerSimpleHelper","name":"can-stache.registerSimpleHelper","type":"function","parent":"can-stache.static","signatures":[{"code":"stache.registerSimpleHelper(name, helper)","description":"\n\nRegisters a helper with stache that always returns\nthe arguments value (instead of a compute).\nPass the name of the helper followed by the\nfunction to which Mustache should invoke.\n\nSee [can-stache.Helpers] for more details on using helpers\nand [can-stache.registerHelper] to get computes for observable values.\n\n```js\nstache.registerSimpleHelper(\"upper\", function(str){\n\treturn str.toUpperCase();\n});\n```\n\nSee [can-stache.Helpers] for more details on using helpers.\n","params":[{"types":[{"type":"String"}],"name":"name","description":"The name of the helper."},{"types":[{"type":"can-stache.simpleHelper"}],"name":"helper","description":"The helper function.\n"}]}],"_curParam":{"types":[{"type":"can-stache.simpleHelper"}],"name":"helper","description":"The helper function.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
