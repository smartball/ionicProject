...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate/docs/can-validate.md
	@module can-validate
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-validate</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-validate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-validate">
						<img src="https://img.shields.io/badge/npm%20package-1.1.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-validate" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate/edit/master/docs/can-validate.md">Edit on GitHub</a>
				</li>
    ...
    <p>Shared utilities and type definitions to process validation errors.</p>
...
<div class="signature">
  ...
  <p>The <code>can-validate</code> module exports helpful methods used for validation and also describes
the different types used during validation.</p>
<pre><code class="language-javascript">var validate = require('my-validator');
...
var errors = utils.formatErrors(validate(obj, constraints), 'flat');
    ...
    <section class="body">
    <h2>Usage</h2>
<p>The <a href="can-validate.formatErrors.html" title="">formatErrors</a> method can be used to convert errors into something more useful.</p>
<pre><code class="language-javascript">var formatErrors = require('can-validate').formatErrors;
var errors = [
    'is required',
    {
...
<h2>Types</h2>
<p>Core definitions of types used in validation.</p>
<ul>
<li><a href="can-validate.error.html" title="An object that defines a validation failure.">Error</a> A flexible typedef that describes a validation error.</li>
<li><a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a> Different error types understood by <code>can-validate</code>.</li>
<li><a href="can-validate.validator.html" title="A function that validates a value against predefined constraints and returns validation errors, if any are found.">validator</a> A function that validates a given value against registered constraints.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate/docs/can-validate.md"},"description":"\nShared utilities and type definitions to process validation errors.\n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\nThe `can-validate` module exports helpful methods used for validation and also describes\nthe different types used during validation.\n\n```javascript\nvar validate = require('my-validator');\nvar utils = require('can-validate');\n\n// Normalize errors into a flat structure\nvar errors = utils.formatErrors(validate(obj, constraints), 'flat');\n```\n"}],"name":"can-validate","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"readme":{"apis":["can-validate"]},"parent":"can-validate"},"browser":{},"bugs":{"url":"https://github.com/canjs/can-validate/issues"},"bundleDependencies":false,"dependencies":{"can-util":"^3.9.0-pre.4"},"deprecated":false,"description":"Validation plugin for CanJS.","devDependencies":{"bit-docs":"0.0.7","http-server":"^0.9.0","jshint":"^2.9.4","steal":"^1.0.8","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"homepage":"https://github.com/canjs/can-validate","keywords":["Validate","plugin","canjs"],"license":"MIT","main":"can-validate.js","name":"can-validate","repository":{"type":"git","url":"git+https://github.com/canjs/can-validate.git"},"scripts":{"build":"node build.js","develop":"http-server -c-1","document":"bit-docs","jshint":"jshint .","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"ignoreBrowser":true,"npmIgnore":["documentjs","testee","steal-tools"],"npmAlgorithm":"flat","npmDependencies":["steal-qunit"],"transpiler":"babel"},"version":"1.1.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
