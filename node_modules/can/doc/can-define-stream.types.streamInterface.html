...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/types.streamInterface.md
	@typedef can-define-stream.types.streamInterface
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.types.streamInterface.html">streamInterface</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>streamInterface</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/types.streamInterface.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stream.types.streamInterface.html" title="Stream interface function returned from can-stream">streamInterface</a> function.</p>
...
<div class="signature">
  ...
  <p>The stream interface function returned from <a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a> that will be used to add streamable props to a provided <a href="can-define-stream.types.DefineMap.html" title="A map constructor to add stream methods to.">DefineMap.prototype</a> or <a href="can-define-stream.types.DefineList.html" title="A list constructor to add stream methods to.">DefineList.prototype</a> and has the following property methods:</p>
<ul>
...
justin.toStream('.first'); //-&gt; Stream
    ...
    <section class="body">
    <h2>Use</h2>
<p>See <a href="can-stream.types.streamInterface.html" title="Stream interface function returned from can-stream">streamInterface</a>.</p>
<p>See <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> for an example implementation.</p>
