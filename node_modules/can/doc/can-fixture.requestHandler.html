...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/requestHandler.md
	@typedef can-fixture.requestHandler
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - requestHandler</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture.requestHandler.html">requestHandler</a></li>
	...
	<div class="page-type">
		<h1>requestHandler</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/requestHandler.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Defines the XHR response for a given trapped request.</p>
...
<p>Templated <code>url</code> data will be added to the <code>requestHandler</code>'s <code>request</code> argument's <code>data</code> property:</p>
<pre><code class="language-js">fixture({url: &quot;/todos/{action}&quot;},
  function(request, response, headers, ajaxSettings){
    request //-&gt; {
            //    method: &quot;post&quot;,
            //    url: &quot;/todos&quot;,
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>request</b> <code>{<a href="can-fixture/types/request.html" title="An object with easily digestible values derived from the mock XHR
object.">request</a>}</code>: <p>Information about the request. The request's data property will contain data from the request's querystring or request body. Also
any templated values in the <a href="can-fixture/types/ajaxSettings.html" title="An object used to match incoming request objects.">ajaxSettings</a>'s <code>url</code> will be added.</p>
</li>
        
          <li><b>response</b> <code>{<a href="can-fixture.response.html" title="">response</a>()}</code>: <p>A callback function that provides response information.</p>
</li>
        
          <li><b>requestHeaders</b> <code>{Object}</code>: <p>Headers used to make the request.</p>
</li>
        
          <li><b>ajaxSettings</b> <code>{Object}</code>: <p>The settings object used to match this request.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/requestHandler.md"},"description":"\n","type":"typedef","title":"requestHandler","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"can-fixture/types/request"}],"name":"request"},{"types":[{"type":"can-fixture.response"}],"name":"response"},{"types":[{"type":"Object","options":[]}],"name":"requestHeaders"},{"types":[{"type":"Object","options":[]}],"name":"ajaxSettings"}]}],"name":"can-fixture.requestHandler","parent":"can-fixture.types","signatures":[{"code":"requestHandler(request, response(...), requestHeaders, ajaxSettings)","description":"\n\nDefines the XHR response for a given trapped request.\n\n```js\nfixture({method: \"get\", url: \"/todos\"},\n  function(request, response, headers, ajaxSettings){\n    request //-> {\n            //    method: \"get\",\n            //    url: \"/todos\",\n            //    data: {complete: true}\n            //   }\n\n  }\n});\n\n$.ajax({ method: \"get\", url: \"/todos?complete=true\" })\n```\n\nTemplated `url` data will be added to the `requestHandler`'s `request` argument's `data` property:\n\n```js\nfixture({url: \"/todos/{action}\"},\n  function(request, response, headers, ajaxSettings){\n    request //-> {\n            //    method: \"post\",\n            //    url: \"/todos\",\n            //    data: {action: delete}\n            //   }\n  }\n});\n\n$.post(\"/todos/delete\");\n```","params":[{"types":[{"type":"can-fixture/types/request"}],"name":"request","description":"Information about the request. The request's data property will contain data from the request's querystring or request body. Also\nany templated values in the [can-fixture/types/ajaxSettings]'s `url` will be added. "},{"types":[{"type":"can-fixture.response"}],"name":"response","description":"A callback function that provides response information."},{"types":[{"type":"Object","options":[]}],"name":"requestHeaders","description":"Headers used to make the request."},{"types":[{"type":"Object","options":[]}],"name":"ajaxSettings","description":"The settings object used to match this request.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"ajaxSettings","description":"The settings object used to match this request.\n"},"pathToRoot":".."};
</script>
</article>
