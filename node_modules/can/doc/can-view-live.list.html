...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-live/lib/list.js
...
<div class="breadcrumb">
	...
	<li><a href="can-view-live.list.html">list</a></li>
	...
	<div class="page-type">
		<h1>list</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-live/edit/master/lib/list.js#L85">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Live binds a compute's list incrementally.</p>
<pre><code class="language-js">// a compute that change's it's list
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>el</b> <code>{HTMLElement}</code>: <p>An html element to replace with the live-section.</p>
</li>
        
          <li><b>list</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>|<a href="can-list.html" title="">can-list</a>|<a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>An observable list type.</p>
</li>
        
          <li><b>render</b> <code>{function(index, index)}</code>: <p>A function that when called with
the incremental item to render and the index of the item in the list.</p>
</li>
        
          <li><b>context</b> <code>{Object}</code>: <p>The <code>this</code> the <code>render</code> function will be called with.</p>
</li>
        
          <li><b>parentNode</b> <code>{HTMLElement}</code>: <p>An overwritable parentNode if <code>el</code>'s parent is
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-live.list","parent":"can-view-live","src":{"line":84,"codeLine":124,"path":"node_modules/can-view-live/lib/list.js"},"description":"\n","title":"list","release":"2.0.4","signatures":[{"code":"live.list(el, list, render, context, [parentNode])","description":"\n\nLive binds a compute's list incrementally.\n\n```js\n// a compute that change's it's list\nvar todos = compute(function(){\n  return new Todo.List({page: can.route.attr(\"page\")})\n})\n\nvar placeholder = document.createTextNode(\" \");\n$(\"ul#todos\").append(placeholder);\n\ncan.view.live.list(\n  placeholder,\n  todos,\n  function(todo, index){\n    return \"<li>\"+todo.attr(\"name\")+\"</li>\"\n  });\n```\n","params":[{"types":[{"type":"HTMLElement"}],"name":"el","description":"An html element to replace with the live-section.\n"},{"types":[{"type":"can-compute"},{"type":"can-list"},{"type":"can-define/list/list"}],"name":"list","description":"An observable list type.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"String"}]},"params":[{"types":[{"type":"*"}],"name":"index"},{"types":[{"type":"index"}],"name":"index"}],"context":{"types":[{"type":"*"}]}}],"name":"render","description":"A function that when called with\nthe incremental item to render and the index of the item in the list.\n"},{"types":[{"type":"Object","options":[]}],"name":"context","description":"The `this` the `render` function will be called with.\n"},{"types":[{"type":"HTMLElement"}],"optional":true,"name":"parentNode","description":"An overwritable parentNode if `el`'s parent is\na documentFragment.\n\n\n"}]}],"_curParam":{"types":[{"type":"HTMLElement"}],"optional":true,"name":"parentNode","description":"An overwritable parentNode if `el`'s parent is\na documentFragment.\n\n\n"},"pathToRoot":".."};
</script>
</article>
