...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/docs/types.propDefinition.md
	@typedef can-define.types.propDefinition
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - PropDefinition</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define.types.propDefinition.html">PropDefinition</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>PropDefinition</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/docs/types.propDefinition.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Either creates a method or Defines a <a href="can-define.types.TypeConstructor.html" title="Provides a constructor function to be used to convert any set value into an appropriate
value.">Type</a> setting with a constructor function.  Constructor functions are identified with <a href="can-reflect.isConstructorLike.html" title="Test if a value looks like a constructor function.">isConstructorLike</a>.</p>
<pre><code>propertyName: Constructor
</code></pre>
<p>OR</p>
<pre><code>propertyName: function() {}
</code></pre>
<p>For example:</p>
<pre><code class="language-js">subMap: DefineMap // &lt;- sets Type to DefineMap
</code></pre>
<p>OR</p>
<pre><code class="language-js">increment: function() { ++this.count } // &lt;- sets method prop
</code></pre>
