...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/src/set-core.js
	@function can-set.Algebra.prototype.difference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - difference</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.difference.html">difference</a></li>
	...
	<div class="page-type">
		<h1>difference</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L329">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns a set that represents the difference of sets <em>A</em> and <em>B</em> (<em>A</em> \ <em>B</em>), or
returns if a difference exists.</p>
<pre><code class="language-js">algebra1 = new set.Algebra(set.props.boolean(&quot;completed&quot;));
...
algebra2.difference( {completed: true}, {} )  //-&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>a</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A set.</p>
</li>
        
          <li><b>b</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A set.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>|Boolean}</code>: <p>If an object is returned, it is difference of sets <em>A</em> and <em>B</em> (<em>A</em> \ <em>B</em>).</p>
<p>If <code>true</code> is returned, that means that <em>B</em> is a subset of <em>A</em>, but no set object
can be returned that represents that set.</p>
<p>If <code>false</code> is returned, that means there is no difference or the sets are not comparable.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.difference","parent":"can-set.Algebra.prototype","src":{"line":328,"codeLine":360,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"difference","signatures":[{"code":"algebra.difference(a, b)","description":"\n\nReturns a set that represents the difference of sets _A_ and _B_ (_A_ \\ _B_), or\nreturns if a difference exists.\n\n```js\nalgebra1 = new set.Algebra(set.props.boolean(\"completed\"));\nalgebra2 = new set.Algebra();\n\n// A has all of B\nalgebra1.difference( {} , {completed: true} ) //-> {completed: false}\n\n// A has all of B, but we can't figure out how to create a set object\nalgebra2.difference( {} , {completed: true} ) //-> true\n\n// A is totally inside B\nalgebra2.difference( {completed: true}, {} )  //-> false\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"a","description":"A set."},{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."}],"returns":{"types":[{"type":"can-set/Set"},{"type":"Boolean"}],"description":"If an object is returned, it is difference of sets _A_ and _B_ (_A_ \\ _B_).\n\nIf `true` is returned, that means that _B_ is a subset of _A_, but no set object\ncan be returned that represents that set.\n\nIf `false` is returned, that means there is no difference or the sets are not comparable.\n "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."},"_curReturn":{"types":[{"type":"can-set/Set"},{"type":"Boolean"}],"description":"If an object is returned, it is difference of sets _A_ and _B_ (_A_ \\ _B_).\n\nIf `true` is returned, that means that _B_ is a subset of _A_, but no set object\ncan be returned that represents that set.\n\nIf `false` is returned, that means there is no difference or the sets are not comparable.\n "},"pathToRoot":".."};
</script>
</article>
