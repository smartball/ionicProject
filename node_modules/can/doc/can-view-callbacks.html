...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-callbacks/docs/can-view-callbacks.md
	@module can-view-callbacks
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-callbacks</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-callbacks</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-callbacks">
						<img src="https://img.shields.io/badge/npm%20package-3.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-callbacks" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-callbacks/edit/master/docs/can-view-callbacks.md">Edit on GitHub</a>
				</li>
    ...
    <p>Registered callbacks for behaviors</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <p>Allows registering callback functions that will be called when tags and attributes are rendered in <a href="can-view-target.html" title="">can-view-target</a>.</p>
<h2>Registering tags</h2>
<p><a href="can-view-callbacks.tag.html" title="">callbacks.tag</a> allows you to register a tag that custom behavior will be attached to.</p>
<p>This will style elements using the <em>blue-el</em> tag with a blue background.</p>
...
<pre><code class="language-html">&lt;blue-el&gt;&lt;p&gt;Some content with a blue background, gross!&lt;/p&gt;&lt;/blue-el&gt;
</code></pre>
<h2>Registering attributes</h2>
<p>Similarly you can register a callback for an attribute. Here we are using a regular expression to match an attribute that starts with <code>foo-</code>:</p>
<pre><code class="language-js">callbacks.attr(/foo-[\w\.]+/, function(el, attrData){
...
<p>So that:</p>
<pre><code class="language-html">&lt;div foo-bar&gt;&lt;/div&gt;
</code></pre>
<p>Renders as:</p>
<pre><code class="language-html">&lt;div foo-bar&gt;bar&lt;/div&gt;
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-callbacks/docs/can-view-callbacks.md"},"description":"Registered callbacks for behaviors \n","type":"module","title":"can-view-callbacks","types":[{"type":"Object","options":[]}],"name":"can-view-callbacks","parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-view-callbacks/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"1.0.0","can-observation":"^3.3.1","can-util":"^3.9.5"},"deprecated":false,"description":"Registered callbacks for behaviors","devDependencies":{"done-serve":"^1.2.0","jshint":"^2.9.1","steal":"^1.5.6","steal-qunit":"^1.0.1","steal-tools":"^1.4.0","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-view-callbacks","name":"can-view-callbacks","repository":{"type":"git","url":"git://github.com/canjs/can-view-callbacks.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"3.2.2"},"comment":" ","pathToRoot":".."};
</script>
</article>
