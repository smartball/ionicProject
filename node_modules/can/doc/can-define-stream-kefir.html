...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream-kefir/docs/can-define-stream-kefir.md
	@module can-define-stream-kefir
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-define-stream-kefir</title>
...
functions from inside inheriting functions.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-define-stream-kefir.types.DefineList.html"
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-define-stream-kefir.types.DefineMap.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream-kefir.toCompute.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream-kefir.toStream.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream-kefir.toStreamFromEvent.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream-kefir.toStreamFromProperty.html"
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream-kefir.html">can-define-stream-kefir</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-define-stream-kefir</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-define-stream-kefir">
						<img src="https://img.shields.io/badge/npm%20package-0.1.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-define-stream-kefir" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream-kefir/edit/master/docs/can-define-stream-kefir.md">Edit on GitHub</a>
				</li>
    ...
    <p>Export a function that takes a <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> or <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> constructor and uses <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> to create streamable properties.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canDefineStreamKefir(DefineMap)</code>
  </h2>
  <p>The <code>can-define-stream-kefir</code> module exports a function that will take a <a href="can-define-stream-kefir.types.DefineMap.html" title="A map constructor to add stream methods to.">DefineMap</a> or <a href="can-define-stream-kefir.types.DefineList.html" title="A list constructor to add stream methods to.">DefineList</a> constructor and add the following methods using the <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> stream implementation:</p>
<ul>
...
<pre><code class="language-js">var canDefineStreamKefir = require(&quot;can-define-stream-kefir&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream-kefir/docs/can-define-stream-kefir.md"},"description":"Export a function that takes a [can-define/map/map] or [can-define/list/list] constructor and uses [can-stream-kefir] to create streamable properties. \n","type":"module","title":"can-define-stream-kefir","types":[{"type":"Object","options":[]}],"name":"can-define-stream-kefir","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-define-stream-kefir/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.2.0","can-define":"^1.2.0","can-define-stream":"^0.2.1","can-observation":"^3.2.0","can-stream-kefir":"^0.3.0","can-util":"^3.9.0","kefir":"^3.5.1"},"deprecated":false,"description":"Adds the ability to define properties with streams on can-define types.","devDependencies":{"jshint":"^2.9.1","steal":"^1.0.6","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-define-stream-kefir","name":"can-define-stream-kefir","repository":{"type":"git","url":"git://github.com/canjs/can-define-stream-kefir.git"},"scripts":{"jshint":"jshint *.js --config","postversion":"git push --tags && git push","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"system":{"configDependencies":["live-reload"],"npmAlgorithm":"flat"},"version":"0.1.2"},"signatures":[{"code":"canDefineStreamKefir(DefineMap)","description":"\n\nThe `can-define-stream-kefir` module exports a function that will take a [can-define-stream-kefir.types.DefineMap DefineMap] or [can-define-stream-kefir.types.DefineList DefineList] constructor and add the following methods using the [can-stream-kefir] stream implementation:\n\n- .toStream(observable, propAndOrEvent[,event])\n- .toStreamFromProperty(property)\n- .toStreamFromEvent(property)\n- .toCompute([can-stream.types.makeStream makeStream(setStream)], context):compute\n\n```js\nvar canDefineStreamKefir = require(\"can-define-stream-kefir\");\nvar DefineMap = require(\"can-define/map/map\");\n\nvar Person = DefineMap.extend({\n    first: \"string\",\n    last: \"string\",\n    fullName: {\n        get: function() {\n            return this.first + \" \" + this.last;\n        }\n    },\n    fullNameChangeCount: {\n        stream: function() {\n            return this.toStream(\".fullName\").scan(function(last) {\n                return last + 1;\n            }, 0);\n        }\n    }\n});\n\ncanDefineStreamKefir(Person);\n\nvar me = new Person({name: \"Justin\", last: \"Meyer\"});\n\nme.on(\"fullNameChangeCount\", function(ev, newVal) {\n    console.log(newVal);\n});\n\nme.fullNameChangeCount //-> 0\n\nme.first = \"Obaid\"; //-> console.logs 1\nme.last = \"Ahmed\"; //-> console.logs 2\n\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
