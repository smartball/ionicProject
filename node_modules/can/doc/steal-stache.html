...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/steal-stache/steal-stache.md
	@module steal-stache
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - steal-stache</title>
...
<div class="breadcrumb">
	...
	<li><a href="steal-stache.html">steal-stache</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>steal-stache</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/steal-stache">
						<img src="https://img.shields.io/badge/npm%20package-3.1.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/steal-stache" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/steal-stache/edit/master/steal-stache.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="http://stealjs.com">StealJS</a> extension that allows stache templates as dependencies.</p>
...
<div class="signature">
  ...
  <p>Import a <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">stache</a> module in your code and use it to render.</p>
<pre><code class="language-js">var template = require(&quot;./main.stache&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>STACHE_MODULE_NAME</b> <code>{moduleName}</code>: <p>The module name of a stache template. This
will typically be something like <code>templates/main.stache</code>.</p>
</li>
...
references to other collections.">nodeList</a>)}</code>: <p>A renderer function that will render the template into a document fragment.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>With <a href="https://stealjs.com">StealJS</a> being used from <code>node_modules</code> like this:</p>
<pre><code class="language-html">&lt;script src=&quot;node_modules/steal/steal.js&quot;&gt;&lt;/script&gt;
</code></pre>
<p>Start by installing <code>steal-stache</code> with npm:</p>
<pre><code class="language-shell">npm install steal-stache --save
</code></pre>
<p>Then add the plugins configuration to your <code>package.json</code>:</p>
...
<p>Now you can load <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> modules like this:</p>
...
<p>This plugin allows <a href="can-view-import.html" title="">&lt;can-import&gt;</a> elements that specify
template dependencies:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/steal-stache/steal-stache.md"},"description":"\nA [StealJS](http://stealjs.com) extension that allows stache templates as dependencies.\n","type":"module","title":"","types":[{"type":"Object","options":[]}],"name":"steal-stache","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/steal-stache/issues"},"bundleDependencies":false,"dependencies":{"can-stache":"^3.10.0","can-stache-bindings":"^3.2.0","can-view-import":"^3.1.0","jquery":"2.x - 3.x"},"deprecated":false,"description":"Load can-stache templates with StealJS","devDependencies":{"bit-docs":"0.0.7","can-view-nodelist":"^3.1.0","done-serve":"^0.2.5","donejs-cli":"^0.9.5","generator-donejs":"^0.9.6","jshint":"^2.9.4","steal":"^1.5.11","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.4.0"},"homepage":"http://canjs.com","keywords":["canjs","stealjs","donejs"],"main":"steal-stache.js","name":"steal-stache","repository":{"type":"git","url":"git://github.com/canjs/steal-stache.git"},"scripts":{"develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release"},"system":{"main":"steal-stache","configDependencies":["live-reload"],"npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"],"npmAlgorithm":"flat","ext":{"stache":"steal-stache"}},"version":"3.1.2"},"signatures":[{"code":"STACHE_MODULE_NAME!steal-stache","description":"\n\nImport a [can-stache stache] module in your code and use it to render.\n\n```js\nvar template = require(\"./main.stache\");\nvar Map = require(\"can-map\");\n\nvar map = new Map();\nvar frag = template(map);\n\n// frag is a live-bound DocumentFragment\n```\n","params":[{"types":[{"type":"moduleName"}],"name":"STACHE_MODULE_NAME","description":"The module name of a stache template. This\nwill typically be something like `templates/main.stache`.\n"}],"returns":{"types":[{"type":"can-stache.renderer"}],"description":"A renderer function that will render the template into a document fragment.\n"}}],"_curParam":{"types":[{"type":"moduleName"}],"name":"STACHE_MODULE_NAME","description":"The module name of a stache template. This\nwill typically be something like `templates/main.stache`.\n"},"_curReturn":{"types":[{"type":"can-stache.renderer"}],"description":"A renderer function that will render the template into a document fragment.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
