...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-autorender/can-view-autorender.md
	@module can-view-autorender
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-autorender</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-autorender.html">can-view-autorender</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-autorender</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-autorender">
						<img src="https://img.shields.io/badge/npm%20package-3.1.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-autorender" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-autorender/edit/master/can-view-autorender.md">Edit on GitHub</a>
				</li>
    ...
    <p>A module that automatically renders script and other elements with
the <code>can-autorender</code> attribute. This function is useful to know when the templates have finished rendering.</p>
...
<div class="signature">
  ...
  <p>Registers functions to callback when all templates successfully render or an error in rendering happens.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>success</b> <code>{function}</code>: <p>A function to callback when all autorendered templates have been rendered
successfully.</p>
</li>
        
          <li><b>error</b> <code>{function}</code>: <p>A function to callback if a template was not rendered successfully.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>As long is this module is part of your CanJS build or imported with RequireJS, StealJS, or SystemJS,
<a href="can-view-autorender.html" title="A module that automatically renders script and other elements with
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">can-view-autorender</a> will automatically look for <code>can-autorender</code> tags and render them.  Once
all templates have finished rendering, it will call any callbacks passed to <code>can.autorender()</code>.</p>
<p>For example, you might have a page like:</p>
<pre><code>&lt;body&gt;
...
<h2>Rendered placement</h2>
<p>If the template source is a <code>&lt;script&gt;</code> tag within the <code>&lt;body&gt;</code>, the rendered template is placed
immediately following the template.</p>
<p>For example:</p>
<pre><code>&lt;body&gt;
...
<p>If the <code>&lt;script&gt;</code> tag is outside the body, for example in the <code>&lt;head&gt;</code>
tag, the rendered result will be placed just before the closing <code>&lt;/body&gt;</code> tag.</p>
<p>For example:</p>
<pre><code>&lt;head&gt;
  &lt;script type='text/stache' can-autorender message=&quot;Hi&quot;&gt;
    {{message}}!
...
<p>If the template source is any other element, the element's contents will be replaced with the rendered result.  For example:</p>
<pre><code>&lt;body&gt;
...
<h2>Scope</h2>
<p>The template is rendered with a [can.Map] made from the attributes of the
template source element.  That <code>map</code> is available on the
template source element via [can.viewModel].  You can
change the map at any time:</p>
<pre><code>&lt;body&gt;
  &lt;script type='text/stache' can-autorender id='main'&gt;
    {{message}}!
  &lt;/script&gt;
...
<p>You can change attributes on the element and it will update the
viewModel too:</p>
<pre><code>&lt;body&gt;
  &lt;script type='text/stache' can-autorender id='main'&gt;
    {{message}}!
...
<h2>StealJS Use</h2>
<p>For demo pages that require very little setup:</p>
<pre><code>&lt;body&gt;
...
<p>For demo pages that require a little custom setup:</p>
<pre><code>&lt;body&gt;
...
<h2>Errors</h2>
<p>Error callbacks will be called if a template has a parsing error or
a [can/view/stache/system.import] fails.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-autorender/can-view-autorender.md"},"description":"\nA module that automatically renders script and other elements with\nthe `can-autorender` attribute. This function is useful to know when the templates have finished rendering.\n","type":"module","title":"can-view-autorender","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-view-autorender","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"readme":{"apis":["can-view-autorender"]},"parent":"can-view-autorender"},"bugs":{"url":"https://github.com/canjs/can-view-autorender/issues"},"bundleDependencies":false,"dependencies":{"can-event":"^3.6.0","can-util":"^3.9.5","can-view-model":"^3.3.0"},"deprecated":false,"description":"Automatically render templates found in the document","devDependencies":{"bit-docs":"0.0.7","can-component":"^3.2.2","can-define":"^1.3.2","can-stache":"^3.3.0","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"https://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-view-autorender","name":"can-view-autorender","repository":{"type":"git","url":"git://github.com/canjs/can-view-autorender.git"},"scripts":{"build":"node build.js","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tags=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"3.1.1"},"parent":"can-ecosystem","signatures":[{"code":"autorender(success, error)","description":"\n\n  Registers functions to callback when all templates successfully render or an error in rendering happens.\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"success","description":"A function to callback when all autorendered templates have been rendered\nsuccessfully.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"error","description":"A function to callback if a template was not rendered successfully.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"error","description":"A function to callback if a template was not rendered successfully.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
