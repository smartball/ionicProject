...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/prototype.bind.md
	@function can-map.prototype.bind
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - bind</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.bind.html">bind</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>bind</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/prototype.bind.md">Edit on GitHub</a>
				</li>
    ...
    <p>Bind event handlers to a Map.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function}</code>: <p>the handler to be called when this type of event fires
...
for details.</p>
  ...
  <div class="returns">
    ...
    <section class="body">
    <p><code>bind</code> binds event handlers to property changes on <code>Map</code>s. When you change
a property using <code>attr</code>, two events are fired on the Map, allowing other parts
...
if you want to react to all changes on a Map.</p>
...
<li><em>oldVal</em> This is the value of the property before the change. <code>oldVal</code> will be <code>undefined</code> if the property was added.</li>
</ul>
...
<p>(See also <code>[can.Map::removeAttr removeAttr]</code>, which removes properties).</p>
...
[can.Map.prototype.attr attr].</p>
<p>For a more specific way to changes on Observes, see the [can.Map.delegate] plugin.
*/</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/prototype.bind.md"},"description":"Bind event handlers to a Map. \n","title":"bind","name":"can-map.prototype.bind","type":"function","parent":"can-map.prototype","order":3,"signatures":[{"code":"map.bind(eventType, handler)","description":"\n","params":[{"types":[{"type":"String"}],"name":"eventType","description":"the type of event to bind this handler to"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"the handler to be called when this type of event fires\nThe signature of the handler depends on the type of event being bound. See below\nfor details."}],"returns":{"types":[{"type":"can.Map"}],"description":"this Map, for chaining\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"the handler to be called when this type of event fires\nThe signature of the handler depends on the type of event being bound. See below\nfor details."},"_curReturn":{"types":[{"type":"can.Map"}],"description":"this Map, for chaining\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
