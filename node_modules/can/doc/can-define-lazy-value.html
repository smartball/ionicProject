...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-lazy-value/define-lazy-value.js
	@module can-define-lazy-value
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-define-lazy-value</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define-lazy-value.html">can-define-lazy-value</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-define-lazy-value</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-define-lazy-value">
						<img src="https://img.shields.io/badge/npm%20package-1.0.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-define-lazy-value" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-lazy-value/edit/master/define-lazy-value.js">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>defineLazyValue(obj, prop, fn, writable)</code>
  </h2>
  <p>Use Object.defineProperty to define properties whose values will be created lazily when they are first read.</p>
<pre><code class="language-js">var _id = 1;
function getId() {
    return _id++;
}
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>object</b> <code>{Object}</code>: <p>The object to add the property to.</p>
</li>
        
          <li><b>prop</b> <code>{String}</code>: <p>The name of the property.</p>
</li>
        
          <li><b>fn</b> <code>{function}</code>: <p>A function to get the value the property should be set to.</p>
</li>
        
          <li><b>writable</b> <code>{boolean}</code>: <p>Whether the field should be writable (false by default).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-define-lazy-value","parent":"can-infrastructure","src":{"line":0,"codeLine":40,"path":"node_modules/can-define-lazy-value/define-lazy-value.js"},"description":"","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"https://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-define-lazy-value/issues"},"bundleDependencies":false,"dependencies":{},"deprecated":false,"description":"Define properties with lazy values using Object.defineProperty","devDependencies":{"jshint":"^2.9.1","steal":"^1.3.1","steal-qunit":"^1.0.1","steal-tools":"^1.2.0","testee":"^0.3.0"},"homepage":"https://canjs.com","keywords":["canjs","donejs-plugin"],"license":"MIT","main":"define-lazy-value","name":"can-define-lazy-value","repository":{"type":"git","url":"git://github.com/canjs/can-define-lazy-value.git"},"scripts":{"build":"node build.js","jshint":"jshint ./*.js --config","postpublish":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update version number\" && git checkout -b release && git add -f dist/"},"steal":{"npmIgnore":["testee","steal-tools"]},"version":"1.0.0"},"signatures":[{"code":"defineLazyValue(obj, prop, fn, writable)","description":"\n\nUse Object.defineProperty to define properties whose values will be created lazily when they are first read.\n\n```js\nvar _id = 1;\nfunction getId() {\n    return _id++;\n}\n\nfunction MyObj(name) {\n    this.name = name;\n}\n\ndefineLazyValue(MyObj.prototype, 'id', getId);\n\nvar obj1 = new MyObj('obj1');\nvar obj2 = new MyObj('obj2');\n\nconsole.log( obj2 ); // -> { name: \"obj2\" }\nconsole.log( obj1 ); // -> { name: \"obj1\" }\n\n// the first `id` read will get id `1`\nconsole( obj2.id ); // -> 1\nconsole( obj1.id ); // -> 2\n\nconsole.log( obj2 ); // -> { name: \"obj2\", id: 1 }\nconsole.log( obj1 ); // -> { name: \"obj1\", id: 2 }\n\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"object","description":"The object to add the property to."},{"types":[{"type":"String"}],"name":"prop","description":"The name of the property."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"fn","description":"A function to get the value the property should be set to."},{"types":[{"type":"boolean"}],"name":"writable","description":"Whether the field should be writable (false by default).\n"}]}],"_curParam":{"types":[{"type":"boolean"}],"name":"writable","description":"Whether the field should be writable (false by default).\n"},"pathToRoot":".."};
</script>
</article>
