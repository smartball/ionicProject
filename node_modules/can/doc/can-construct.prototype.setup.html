...
<!--####################################################################
	...
	@function can-construct.prototype.setup
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - setup</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.prototype.setup.html">setup</a></li>
	...
	<div class="page-type">
		<h1>setup</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L748">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A setup function for the instantiation of a constructor function.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array|undefined|<a href="can-construct.ReturnValue.html" title="Use to overwrite the return value of new Construct(...).">ReturnValue</a>(value)}</code>: <p>If an array is returned, the array's items are passed as
arguments to <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>. If a <a href="can-construct.ReturnValue.html" title="Use to overwrite the return value of new Construct(...).">ReturnValue</a> instance is returned, the ReturnValue
...
<pre><code class="language-js">    WidgetFactory = Construct.extend({
...
constructor are passed to <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a> and the return value of <code>setup</code> is discarded.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Deciding between <code>setup</code> and <code>init</code></h2>
<p>Usually, you should use <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a> to do your constructor function's initialization.
You should, instead, use <code>setup</code> when:</p>
<ul>
<li>there is initialization code that you want to run before the inheriting constructor's
<code>init</code> method is called.</li>
<li>there is initialization code that should run whether or not inheriting constructors
call their base's <code>init</code> methods.</li>
<li>you want to modify the arguments that will get passed to <code>init</code>.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-construct.prototype.setup","parent":"can-construct.prototype","src":{"line":747,"codeLine":794,"path":"node_modules/can-construct/can-construct.js"},"description":"\n","title":"setup","signatures":[{"code":"construct.setup(...args)","description":"\n\nA setup function for the instantiation of a constructor function.\n","params":[{"types":[{"type":"*"}],"name":"args","description":"The arguments passed to the constructor.\n"}],"returns":{"types":[{"type":"Array"},{"type":"undefined"},{"type":"can-construct.ReturnValue"}],"description":"If an array is returned, the array's items are passed as\narguments to [can-construct::init init]. If a [can-construct.ReturnValue] instance is returned, the ReturnValue\ninstance's value will be returned as the result of calling new Construct(). The following example always makes\nsure that init is called with a jQuery wrapped element:\n\n```js\n\tWidgetFactory = Construct.extend({\n\t\t\tsetup: function(element){\n\t\t\t\t\treturn [$(element)]\n\t\t\t}\n\t});\n\n\tMyWidget = WidgetFactory.extend({\n\t\t\tinit: function($el){\n\t\t\t\t\t$el.html(\"My Widget!!\")\n\t\t\t}\n\t});\n ```\n\nOtherwise, the arguments to the\nconstructor are passed to [can-construct::init] and the return value of `setup` is discarded.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"args","description":"The arguments passed to the constructor.\n"},"_curReturn":{"types":[{"type":"Array"},{"type":"undefined"},{"type":"can-construct.ReturnValue"}],"description":"If an array is returned, the array's items are passed as\narguments to [can-construct::init init]. If a [can-construct.ReturnValue] instance is returned, the ReturnValue\ninstance's value will be returned as the result of calling new Construct(). The following example always makes\nsure that init is called with a jQuery wrapped element:\n\n```js\n\tWidgetFactory = Construct.extend({\n\t\t\tsetup: function(element){\n\t\t\t\t\treturn [$(element)]\n\t\t\t}\n\t});\n\n\tMyWidget = WidgetFactory.extend({\n\t\t\tinit: function($el){\n\t\t\t\t\t$el.html(\"My Widget!!\")\n\t\t\t}\n\t});\n ```\n\nOtherwise, the arguments to the\nconstructor are passed to [can-construct::init] and the return value of `setup` is discarded.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
