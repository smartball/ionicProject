...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-observation/can-observation.js
	@function can-observation.addAll
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addAll</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-observation.addAll.html">addAll</a></li>
	...
	<div class="page-type">
		<h1>addAll</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L516">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>The same as <code>Observation.add</code> but takes an array of <a href="can-observation.observed.html" title="An object representing an observation.
{ &quot;obj&quot;: map, &quot;event&quot;: &quot;prop1&quot; }">Observed</a> objects.
This will most often by used in coordination with <a href="can-observation.trap.html" title="can-observation.trap">trap</a>:</p>
<pre><code class="language-js">var untrap = Observation.trap();
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>observes</b> <code>{Array&lt;<a href="can-observation.observed.html" title="An object representing an observation.
{ &quot;obj&quot;: map, &quot;event&quot;: &quot;prop1&quot; }">Observed</a>&gt;}</code>: <p>An array of <a href="can-observation.observed.html" title="An object representing an observation.
{ &quot;obj&quot;: map, &quot;event&quot;: &quot;prop1&quot; }">Observed</a>s.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-observation.addAll","parent":"can-observation.static","src":{"line":515,"codeLine":534,"path":"node_modules/can-observation/can-observation.js"},"description":"","title":"addAll","signatures":[{"code":"Observation.addAll(observes)","description":"\n\nThe same as `Observation.add` but takes an array of [can-observation.observed] objects.\nThis will most often by used in coordination with [can-observation.trap]:\n\n```js\nvar untrap = Observation.trap();\n\nObservation.add(obj, \"prop3\");\n\nvar traps = untrap();\nOservation.addAll(traps);\n```\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-observation.observed"}]}]}],"name":"observes","description":"An array of [can-observation.observed]s.\n"}]}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"can-observation.observed"}]}]}],"name":"observes","description":"An array of [can-observation.observed]s.\n"},"pathToRoot":".."};
</script>
</article>
