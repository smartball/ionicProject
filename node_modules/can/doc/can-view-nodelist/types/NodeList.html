...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-nodelist/doc/NodeList.md
	@typedef can-view-nodelist/types/NodeList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - NodeList</title>
...
<div class="breadcrumb">
	...
	<li><a href="NodeList.html">NodeList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>NodeList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/doc/NodeList.md">Edit on GitHub</a>
				</li>
    ...
    <p>A collection of nodes being managed by a part of a live-bound template and
references to other collections.</p>
...
<div class="signature">
  ...
  <p>A <code>NodeList</code> is an array of nodes that a part of a live-bound template manages.  For
example <code>{{name}}</code> might manage a single text node while something
like <code>{{#each todos}}{{name}}{{/each}}</code> might manage multiple nodes and other child.</p>
<p>NodeLists are primarily used to teardown live binding.  When a &quot;parent&quot; section of a template
is updated, every sub-section needs to be torn down.  NodeLists provide this structure.</p>
<p><strong>NOTE: The structure of a NodeList is purposefully not documented as it's subject to change.</strong></p>
