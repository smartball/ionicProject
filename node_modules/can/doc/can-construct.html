...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-construct/docs/construct.md
	@module can-construct
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-construct</title>
	...
	<ul>
					...
					<li class="
						...
						<a class="property"
							...
							title="A reference to the constructor function that created the instance. This allows you to access
	...
	<ul>
					...
					<li class="
						...
						<a class="property"
							...
							title="Toggles the behavior of a constructor function called
...
var animal = new Animal();">
					...
					<li class="
						...
						<a class="property"
							...
							title="If you pass a name when creating a Construct, the shortName property will be set to the
name.">
							shortName
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.html">can-construct</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-construct</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-construct">
						<img src="https://img.shields.io/badge/npm%20package-3.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-construct" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/docs/construct.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a way to easily use the power of prototypal inheritance
without worrying about hooking up all the particulars yourself. Use
<a href="can-construct.extend.html" title="">can-construct.extend</a> to create an inheritable
constructor function of your own.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new Construct( ...args )</code>
  </h2>
  <p>Creates a new instance using Construct's constructor functions.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>args</b> <code>{*}</code>: <p>The arguments passed to the constructor.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The instantiated object.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>In the example below, <code>Animal</code> is a constructor function returned by <a href="can-construct.extend.html" title="">can-construct.extend</a>. All instances of <code>Animal</code> will have a <code>speak</code>
method, and the <code>Animal</code> constructor has a <code>legs</code> property.</p>
<pre><code class="language-js">var Construct = require(&quot;can-construct&quot;);
...
<p>An optional <a href="can-construct.prototype.setup.html" title="">setup</a> function can be specified to handle the instantiation of the constructor function.</p>
...
<p><a href="can-construct.prototype.setup.html" title="">setup</a> returns {Array|undefined} If an array is returned, the array's items are passed as arguments to <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>.</p>
<p>In addition <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a> can be specified which is a method that gets called with each new instance.</p>
<pre><code class="language-js">var Animal = Construct.extend({
    legs: 4,
    init: function(sound) {
        this.sound = sound;
...
<p>For more information on deciding when to use <a href="can-construct.prototype.setup.html" title="">setup</a> or <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>
see the bottom of the <a href="can-construct.prototype.setup.html" title="">setup</a> documentation.</p>
<p>You can make instances of your object by calling your constructor function with the <code>new</code> keyword. When an object is created, the <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>
method gets called (if you supplied one):</p>
<pre><code class="language-js">var panther = new Animal('growl');
panther.speak(); // &quot;growl&quot;
panther instanceof Animal; // true
</code></pre>
<h2>Plugins</h2>
<p>There are plugins available to help make using <code>can-construct</code> even simpler.</p>
<ul>
<li><a href="can-construct-super.html" title="can.Construct.super is a plugin that makes it easier to call base
functions from inside inheriting functions.">can-construct-super</a> allows you to easily call base methods by making <code>this._super</code> available in inherited methods.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"name":"can-construct","type":"module","description":" \nProvides a way to easily use the power of prototypal inheritance\nwithout worrying about hooking up all the particulars yourself. Use\n[can-construct.extend can-construct.extend] to create an inheritable\nconstructor function of your own.\n\n","src":{"path":"node_modules/can-construct/docs/construct.md"},"title":"can-construct","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-construct/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"1.0.0","can-util":"^3.9.0"},"deprecated":false,"description":"easy constructor functions","devDependencies":{"detect-cyclic-packages":"^1.1.0","jshint":"^2.9.1","steal":"^1.2.8","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-construct","name":"can-construct","repository":{"type":"git","url":"git://github.com/canjs/can-construct.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"3.2.2"},"signatures":[{"code":"new Construct( ...args )","description":"\n\nCreates a new instance using Construct's constructor functions.\n","params":[{"types":[{"type":"*"}],"optional":true,"name":"args","description":"The arguments passed to the constructor."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The instantiated object.\n"}}],"_curParam":{"types":[{"type":"*"}],"optional":true,"name":"args","description":"The arguments passed to the constructor."},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The instantiated object.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
