...
<!--####################################################################
	...
	@function can-construct.ReturnValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ReturnValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.ReturnValue.html">ReturnValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ReturnValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L710">Edit on GitHub</a>
				</li>
    ...
    <p>Use to overwrite the return value of new Construct(...).</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new Construct.ReturnValue( value )</code>
  </h2>
  <p>This constructor function can be used for creating a return value of the <code>setup</code> method.
<a href="can-construct.html" title="Provides a way to easily use the power of prototypal inheritance
without worrying about hooking up all the particulars yourself. Use
can-construct.extend to create an inheritable
constructor function of your own.">can-construct</a> will check if the return value is an instance of <code>Construct.ReturnValue</code>.
If it is then its <code>value</code> will be used as the new instance.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{Object}</code>: <p>A value to be used for a new instance instead of a new object.</p>
<pre><code>var Student = function( name, school ){
    this.name = name;
    this.school = school;
} 
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-construct.ReturnValue","parent":"can-construct.static","src":{"line":709,"codeLine":743,"path":"node_modules/can-construct/can-construct.js"},"description":"\nUse to overwrite the return value of new Construct(...).\n","title":"ReturnValue","signatures":[{"code":"new Construct.ReturnValue( value )","description":"\n\n  This constructor function can be used for creating a return value of the `setup` method.\n  [can-construct] will check if the return value is an instance of `Construct.ReturnValue`.\n  If it is then its `value` will be used as the new instance.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"value","description":"A value to be used for a new instance instead of a new object.\n\n```\nvar Student = function( name, school ){\n    this.name = name;\n    this.school = school;\n} \n\nvar Person = Construct.extend({\n    setup: function( options ){\n        if (options.school){\n            return new Constructor.ReturnValue( new Student( options.name, options.school ) );\n        } else {\n            return [options];\n        }\n    }\n});\n\nvar myPerson = new Person( {name: \"Ilya\", school: \"PetrSU\"} );\n\nmyPerson instanceof Student // => true\n```\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"value","description":"A value to be used for a new instance instead of a new object.\n\n```\nvar Student = function( name, school ){\n    this.name = name;\n    this.school = school;\n} \n\nvar Person = Construct.extend({\n    setup: function( options ){\n        if (options.school){\n            return new Constructor.ReturnValue( new Student( options.name, options.school ) );\n        } else {\n            return [options];\n        }\n    }\n});\n\nvar myPerson = new Person( {name: \"Ilya\", school: \"PetrSU\"} );\n\nmyPerson instanceof Student // => true\n```\n"},"pathToRoot":".."};
</script>
</article>
