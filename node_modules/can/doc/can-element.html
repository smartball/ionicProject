...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-element/docs/can-custom-elements.md
	@module can-element
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-element</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-element.element.html"
							title="A class that can be extended to create custom elements.
Element is a can-element.CanElement that is derived from the HTMLElement. This is the element you will want to use to derive your own custom elements.">
							Element
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-element/attributes.html"
							title="Sets up attribute bindings when using can-define.">
							./attributes
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-element.CanElement.html"
							title="An interface for derived elements using either can-element or can-element.element.">
							CanElement
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-element.html">can-element</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-element</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-element">
						<img src="https://img.shields.io/badge/npm%20package-0.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-element" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-element/edit/master/docs/can-custom-elements.md">Edit on GitHub</a>
				</li>
    ...
    <p>Allows you to create <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Custom_Elements">customelement</a> classes with CanJS.
...
Element is a can-element.CanElement that is derived from the HTMLElement. This is the element you will want to use to derive your own custom elements.">Element</a>.</p>
...
<div class="signature">
  ...
  <p>Create a base Element class based on <code>Element</code>, any element that derives from <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement">HTMLElement</a>.</p>
<p><strong>Important</strong>: Safari only supports custom elements that derive from [HTMLElement].</p>
<pre><code class="language-js">var CustomElement = require(&quot;can-element&quot;);
...
customElements.define(&quot;super-button&quot;, SuperButton);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>Element</b> <code>{HTMLElement}</code>: <p>The base element from which to derive.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-element.CanElement.html" title="An interface for derived elements using either can-element or can-element.element.">CanElement</a>()}</code>: <p>A derived element with CanJS behaviors added.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-element</code> makes it possible to create standard custom elements (part of <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components">web components</a>).</p>
<p>Use can-element to create a class that can be passed into <a href="https://developer.mozilla.org/en-US/docs/Web/API/CustomElementRegistry/define">customElements.define</a> to register the element in the window.</p>
<pre><code class="language-js">var Element = require(&quot;can-element&quot;).Element;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-element/docs/can-custom-elements.md"},"description":"Allows you to create [customelement](https://developer.mozilla.org/en-US/docs/Web/Web_Components/Custom_Elements) classes with CanJS. \nSafari only supports custom elements that derive from HTMLElement, so you'll usually want to use [can-element.element].\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-element","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-element/issues"},"bundleDependencies":false,"dependencies":{"can-util":"^3.2.2","can-view-nodelist":"^3.0.4","can-view-scope":"^3.3.6"},"deprecated":false,"description":"Create custom elements with CanJS","devDependencies":{"@webcomponents/custom-elements":"github:webcomponents/custom-elements#v1.0.0-alpha.4","bit-docs":"0.0.7","can-compute":"^3.0.5","can-define":"^1.0.0","can-stache":"^3.0.18","can-stache-bindings":"^3.0.6","cloudydom":"1.0.6","detect-cyclic-packages":"^1.1.0","documentjs":"^0.4.4","done-serve":"^1.0.0-alpha.0","donejs-cli":"^1.0.0-alpha.2","generator-donejs":"^1.0.0-alpha.0","jshint":"^2.9.1","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"homepage":"https://github.com/canjs/can-element","keywords":["web component","custom elements","canjs"],"license":"MIT","main":"can-element.js","name":"can-element","repository":{"type":"git","url":"git://github.com/canjs/can-element.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js ./test/ --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"0.2.2"},"signatures":[{"code":"CustomElement(Element)","description":"\n\nCreate a base Element class based on `Element`, any element that derives from [HTMLElement](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement).\n\n**Important**: Safari only supports custom elements that derive from [HTMLElement].\n\n```js\nvar CustomElement = require(\"can-element\");\n\nvar SuperButton = class extends CustomElement(HTMLButtonElement) {\n\n};\n\ncustomElements.define(\"super-button\", SuperButton);\n```\n","params":[{"types":[{"type":"HTMLElement"}],"name":"Element","description":"The base element from which to derive."}],"returns":{"types":[{"type":"can-element.CanElement"}],"description":"A derived element with CanJS behaviors added.\n"}}],"_curParam":{"types":[{"type":"HTMLElement"}],"name":"Element","description":"The base element from which to derive."},"_curReturn":{"types":[{"type":"can-element.CanElement"}],"description":"A derived element with CanJS behaviors added.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
