...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-construct-super/can-construct-super.md
	@module can-construct-super
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-construct-super</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct-super.html">can-construct-super</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-construct-super</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-construct-super">
						<img src="https://img.shields.io/badge/npm%20package-3.1.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-construct-super" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct-super/edit/master/can-construct-super.md">Edit on GitHub</a>
				</li>
    ...
    <p>can.Construct.super is a plugin that makes it easier to call base
...
<div class="signature">
  ...
  <p>Calls the base constructor function's method.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>args</b> <code>{Any}</code>: <p>parameters to pass to the base function</p>
</li>
...
<p>This is especially useful for calling base classes' <code><a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a></code> and <code><a href="can-construct.prototype.setup.html" title="">setup</a></code>, but it can be used in any inheriting function.</p>
<p>The <code>Person</code> and <code>Programmer</code> examples from <code><a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a></code> demonstrate <code>_super</code>'s use.
Here's how those classes look without can.Construct.super:</p>
<pre><code>var Person = Construct.extend({
...
<pre><code>var Programmer = Person.extend({
    init: function(first, last, language) {
        // call base's init
...
<pre><code>var Squarer = can.Construct.extend({
    raise: function(n) {
        return n*n;
    }
}, {});
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-construct-super/can-construct-super.md"},"description":"\ncan.Construct.super is a plugin that makes it easier to call base\nfunctions from inside inheriting functions.\n","type":"module","title":"","name":"can-construct-super","parent":"can-ecosystem","plugin":"can-construct-super","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-construct-super/issues"},"bundleDependencies":false,"dependencies":{"can-construct":"^3.2.0","can-util":"^3.9.0"},"deprecated":false,"description":"Provides a reference to the prototypal parent using this._super in can-construct objects","devDependencies":{"bit-docs":"0.0.7","jshint":"^2.9.3","steal":"^1.2.8","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"https://github.com/canjs/can-construct-super#readme","keywords":["canjs","donejs"],"license":"MIT","main":"can-construct-super","name":"can-construct-super","repository":{"type":"git","url":"git+https://github.com/canjs/can-construct-super.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-construct-super","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.2"},"signatures":[{"code":"construct._super([...args])","description":"\n\nCalls the base constructor function's method.\n","params":[{"types":[{"type":"Any"}],"variable":true,"name":"args","description":"parameters to pass to the base function\n"}]}],"_curParam":{"types":[{"type":"Any"}],"variable":true,"name":"args","description":"parameters to pass to the base function\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
