...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-vdom/can-vdom.md
	@module can-vdom
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-vdom</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-vdom.types.window.html"
							title="An object representing a fake window object.">
							window
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-vdom/make-document/make-document.html"
							title="Exports a function that when called, returns a dom-light document object.">
							./make-document/
						</a>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-vdom/make-window/make-window.html"
							title="Exports a function that window called, returns an object that looks like a window.">
							./make-window/
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-vdom.html">can-vdom</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-vdom</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-vdom">
						<img src="https://img.shields.io/badge/npm%20package-3.2.3-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-vdom" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-vdom/edit/master/can-vdom.md">Edit on GitHub</a>
				</li>
    ...
    <p>A browser-lite environment for Node.js or a worker thread.</p>
...
<div class="signature">
  ...
  <p>The <code>can-vdom</code> module does not export anything, but it changes the current
...
a native DOM.</p>
<pre><code class="language-js">require(&quot;can-vdom&quot;);

window === global; // true

document.getElementsByTagName(&quot;body&quot;); // [HTMLBodyElement]
</code></pre>
<p><code>can-vdom</code> decorates the environment <code>global</code> to include:</p>
<ul>
<li>a non-functional <code>navigator</code>, <code>location</code>, and <code>history</code> object.</li>
<li>a limitedly functional <code>document</code> with basic <code>Node</code> behavior, event binding and dispatching.</li>
</ul>
    ...
    <section class="body">
    <h2>Shiming a browser environment</h2>
<p>Importing <code>can-vdom</code> will shim a browser-like environment into Node's globals. Use this approach to run code that expects a global <code>window</code> and/or <code>document</code> object.</p>
<pre><code class="language-js">require(&quot;can-vdom&quot;);
...
<h2>Loading as a module</h2>
<p>If you want to prevent setting globals you can load <code>can-vdom/make-window/make-window</code> directly:</p>
<pre><code class="language-js">var makeWindow = require(&quot;can-vdom/make-window/make-window&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-vdom/can-vdom.md"},"description":"A browser-lite environment for Node.js or a worker thread. \n","type":"module","title":"","types":[{"type":"undefined","description":"\n\nThe `can-vdom` module does not export anything, but it changes the current\nenvironment to have the limited subset of browser environment behavior and\nfunctionality needed to support CanJS templates and other behavior without\na native DOM.\n\n```js\nrequire(\"can-vdom\");\n\nwindow === global; // true\n\ndocument.getElementsByTagName(\"body\"); // [HTMLBodyElement]\n```\n\n`can-vdom` decorates the environment `global` to include:\n\n - a non-functional `navigator`, `location`, and `history` object.\n - a limitedly functional `document` with basic `Node` behavior, event binding and dispatching.\n\n\n"}],"name":"can-vdom","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-vdom/issues"},"bundleDependencies":false,"dependencies":{"can-assign":"^1.0.0","can-globals":"^0.2.2","can-simple-dom":"^1.1.0","can-view-parser":"^3.5.1"},"deprecated":false,"description":"A browser-lite environment for nodejs","devDependencies":{"bit-docs":"0.0.7","can-util":"^3.9.0","chai":"^3.4.1","detect-cyclic-packages":"^1.1.0","done-serve":"^1.2.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","mocha":"^3.3.0","steal":"^1.2.10","steal-mocha":"^1.0.0","steal-tools":"^1.1.2","testee":"^0.3.1"},"homepage":"http://canjs.com","keywords":["donejs","canjs"],"main":"can-vdom.js","name":"can-vdom","repository":{"type":"git","url":"git://github.com/canjs/can-vdom.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run detect-cycle && npm run test:node && npm run test:browser","test:browser":"testee test/test.html --browsers firefox --reporter Spec","test:node":"mocha test/test.js","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-vdom","map":{"./assert":"chai/chai"},"meta":{"chai/chai":{"format":"global","exports":"chai.assert"}},"plugins":["chai"]},"version":"3.2.3"},"comment":" ","pathToRoot":".."};
</script>
</article>
