...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-import/docs/value.md
	@function can-view-import.value
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - value:to</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-import.value.html">value:to</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>value:to</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-import/edit/master/docs/value.md">Edit on GitHub</a>
				</li>
    ...
    <p>Set the value that is returned from the <a href="can-view-import.html" title="">can-import</a> Promise to a <a href="can-stache-bindings.reference.html" title="Export a viewModel into a template's references scope.">reference scope</a> variable.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>value:to=&quot;*NAME&quot;</code>
  </h2>
  <p>Sets up a <a href="can-stache-bindings.toParent.html" title="One-way bind a value from the viewModel or element to the parent scope.">toParent:to</a> binding to *NAME in the references scope.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>NAME</b> <code>{String}</code>: <p>The variable name to assign to the references scope. This can be any string name you want to use, but must be preceded by <code>*</code> or it will be placed on the template's View Model.</p>
<pre><code class="language-html">&lt;can-import from=&quot;app/person&quot; {^value}=&quot;*person&quot; /&gt;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-import/docs/value.md"},"description":"Set the value that is returned from the [can-view-import can-import] Promise to a [can-stache-bindings.reference reference scope] variable. \n","title":"value:to","name":"can-view-import.value","type":"function","parent":"can-view-import.attributes","signatures":[{"code":"value:to=\"*NAME\"","description":"\n\nSets up a [can-stache-bindings.toParent] binding to \\*NAME in the references scope.\n","params":[{"types":[{"type":"String"}],"name":"NAME","description":"The variable name to assign to the references scope. This can be any string name you want to use, but must be preceded by `*` or it will be placed on the template's View Model.\n\n```html\n<can-import from=\"app/person\" {^value}=\"*person\" />\n\t\n<section>\n\thello {{*person.name}}\n</section>\n```\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"NAME","description":"The variable name to assign to the references scope. This can be any string name you want to use, but must be preceded by `*` or it will be placed on the template's View Model.\n\n```html\n<can-import from=\"app/person\" {^value}=\"*person\" />\n\t\n<section>\n\thello {{*person.name}}\n</section>\n```\n"},"pathToRoot":".."};
</script>
</article>
