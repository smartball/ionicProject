...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/hash.md
	@typedef can-stache/expressions/hash
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Hash Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="hash.html">Hash Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Hash Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/hash.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>[PROPERTY_NAME=EXPRESSION ]+</code>
  </h2>
  <p>A sequence of one or more property names and their values as another expression like:</p>
<pre><code>prop1=1 prop2=key prop3=callExpression()
</code></pre>
<p>In a <a href="call.html" title="">Call Expression</a>, <code>Hash</code> expressions
create an object argument with the specified <code>PROPERTY_NAME</code> properties
and <code>EXPRESSION</code> values.</p>
<p>The following template:</p>
<pre><code class="language-js">{{ method( age=5 first=person.firstName last=person.getLastName() ) }}
</code></pre>
<p>Might call <code>method</code> with:</p>
<pre><code class="language-js">{age: 5, first: &quot;Justin&quot;, last: &quot;Meyer&quot;}
</code></pre>
<p>In a <a href="helper.html" title="">Helper Expression</a>, <code>Hash</code> expressions
add to the <a href="../../can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">helperOptions</a>'s <code>hash</code> object with the specified <code>PROPERTY_NAME</code> properties
and <code>EXPRESSION</code> values.</p>
<p>The following template:</p>
<pre><code class="language-js">{{ method age=5 first=person.firstName last=person.getLastName() }}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>PROPERTY_NAME</b> <code>{String}</code>: <p>The property name on the call expression
argument object or <a href="../../can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">helperOptions</a>'s <code>hash</code> object.</p>
</li>
        
          <li><b>EXPRESSION</b> <code>{<a href="literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>|<a href="call.html" title="">Call Expression</a>}</code>: <p>An expression that provides a
value for the property name.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A hash expression specifies a property value on a object argument in a call expression
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/expressions/hash.md"},"description":"\n","type":"typedef","title":"Hash Expression","types":[{"type":"String"}],"name":"can-stache/expressions/hash","parent":"can-stache/expressions","signatures":[{"code":"[PROPERTY_NAME=EXPRESSION ]+","description":"\n\nA sequence of one or more property names and their values as another expression like:\n\n```\nprop1=1 prop2=key prop3=callExpression()\n```\n\nIn a [can-stache/expressions/call], `Hash` expressions\ncreate an object argument with the specified `PROPERTY_NAME` properties\nand `EXPRESSION` values.\n\nThe following template:\n\n```js\n{{ method( age=5 first=person.firstName last=person.getLastName() ) }}\n```\n\nMight call `method` with:\n\n```js\n{age: 5, first: \"Justin\", last: \"Meyer\"}\n```\n\nIn a [can-stache/expressions/helper], `Hash` expressions\nadd to the [can-stache.helperOptions]'s `hash` object with the specified `PROPERTY_NAME` properties\nand `EXPRESSION` values.\n\nThe following template:\n\n```js\n{{ method age=5 first=person.firstName last=person.getLastName() }}\n```\n\nMight call `method` with:\n\n```js\n{\n\thash: {age: 5, first: compute(\"Justin\"), last: compute(\"Meyer\")}\n}\n```\n\n","params":[{"types":[{"type":"String"}],"name":"PROPERTY_NAME","description":"The property name on the call expression\nargument object or [can-stache.helperOptions]'s `hash` object.\n"},{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression that provides a\nvalue for the property name.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression that provides a\nvalue for the property name.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
