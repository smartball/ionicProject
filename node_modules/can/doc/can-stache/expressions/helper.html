...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/helper.md
	@typedef can-stache/expressions/helper
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Helper Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="helper.html">Helper Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Helper Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/helper.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>method [EXPRESSION...]</code>
  </h2>
  <p>Calls <code>method</code> with zero or many arguments where each argument
is a space separated
<code>EXPRESSION</code>.</p>
<pre><code>{{method 1 key call() hashProp=hashValue}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>|<a href="hash.html" title="">Hash Expression</a>|<a href="call.html" title="">Call Expression</a>}</code>: <p>An expression that will be passed as an argument
to <code>method</code>.</p>
<p>All <a href="hash.html" title="">Hash Expression</a>s will be collectively
added to the <a href="../../can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">helperOptions</a>'s <code>hash</code> object.</p>
<p>If an <code>EXPRESSION</code> reads an observable, a
<a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> will be passed to <code>method</code>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A helpers expression calls a function looked up in the <a href="../../can-view-scope.Options.html" title="">helpers scope</a> followed by
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/expressions/helper.md"},"description":"\n","type":"typedef","title":"Helper Expression","types":[{"type":"String"}],"name":"can-stache/expressions/helper","parent":"can-stache/expressions","signatures":[{"code":"method [EXPRESSION...]","description":"\n\nCalls `method` with zero or many arguments where each argument\nis a space separated\n`EXPRESSION`.  \n\n\n\n```\n{{method 1 key call() hashProp=hashValue}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/hash"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression that will be passed as an argument\nto `method`.\n\n\nAll [can-stache/expressions/hash]s will be collectively\nadded to the [can-stache.helperOptions]'s `hash` object.\n\nIf an `EXPRESSION` reads an observable, a\n[can-compute.computed] will be passed to `method`.\n\n\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/hash"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression that will be passed as an argument\nto `method`.\n\n\nAll [can-stache/expressions/hash]s will be collectively\nadded to the [can-stache.helperOptions]'s `hash` object.\n\nIf an `EXPRESSION` reads an observable, a\n[can-compute.computed] will be passed to `method`.\n\n\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
