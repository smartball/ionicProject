...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/key-lookup.md
	@typedef can-stache/expressions/key-lookup
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - KeyLookup Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="key-lookup.html">KeyLookup Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>KeyLookup Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/key-lookup.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A <a href="../../can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">KeyLookup expression</a> specifies a value in the <a href="../../can-view-scope.html" title="Create a lookup node for keys.">scope</a> or
...
<p>Or they can makeup the method, helper, arguments and hash value parts of
<a href="call.html" title="">Call Expression</a>,
<a href="helper.html" title="">Helper Expression</a>, and <a href="hash.html" title="">Hash Expression</a>s:</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>CALL_EXPRESSION.key</code>
  </h2>
  <p>Looks up <code>key</code> on the return value of <code>CALL_EXPRESSION</code>.</p>
<pre><code>{{#each(Todo.getList(complete=completed).value)}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>CALL_EXPRESSION</b> <code>{<a href="call.html" title="">Call Expression</a>}</code>: <p>A
call expression that may or may not return a value.</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>A property value to look up on
the result of <code>CALL_EXPRESSION</code>.</p>
</li>
...
<ul>
<li><strong><a href="call.html" title="">Call Expression</a> arguments</strong> <code>{{method(key)}}</code> - values are passed.</li>
<li><strong><a href="helper.html" title="">Helper Expression</a> arguments</strong> <code>{{helper key}}</code> - computes are passed.</li>
<li><strong>hash value in <a href="call.html" title="">Call Expression</a></strong> <code>{{method(hash=key)}}</code> - values are set as property values.</li>
<li><strong>hash value in <a href="helper.html" title="">Helper Expression</a></strong> <code>{{method hash=key}}</code> - computes are set as property values.</li>
<li><strong><a href="../keys/special.html" title="Event bindings and some helpers like can-stache.helpers.each provide special values that start with % to prevent potential collisions with
other values. Special values should not be confused with template variables like *self">special operator</a></strong> <code>{{%index}}</code> - lookup values in a special context provided by some helpers.</li>
<li><strong><a href="../keys/compute.html" title="Pass a compute instead of a value if an observable is found within
call.">compute operator</a></strong> <code>{{method(~key)}}</code> - pass a compute instead of a value.</li>
<li><strong><a href="../keys/at.html" title="Return whatever value is at a key, regardless
if it's a function or a compute.">at operator</a></strong> <code>{{method(@key}}</code> - pass a function instead of trying to read the value of the function.</li>
<li><strong><a href="../keys/current.html" title="Lookup a value in only the current context.">current operator</a></strong> <code>{{./key}}</code> - only lookup key at the top of the scope.</li>
<li><strong><a href="../keys/parent.html" title="Start looking for values in the parent context.">parent operator</a></strong> <code>{{../key}}</code> - lookup the value in the parent context.</li>
<li><strong><a href="../keys/this.html" title="Write out or return the current context.">context key</a></strong> <code>{{this}}</code> - return the current context/top of the scope.</li>
</ul>
...
<ul>
<li><a href="helper.html" title="">helper arguments</a> like: <code>{{helper some.key}}</code></li>
</ul>
<p>when compared to the other places they are used:</p>
<ul>
<li><a href="../../can-stache.tags.escaped.html" title="Insert the value of the expression into the output of the template.">insertion tags</a> like: <code>{{some.key}}</code></li>
<li><a href="call.html" title="">call-expression arguments</a> like: <code>{{helper(some.key)}}</code></li>
<li><a href="../../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">event bindings</a> like: <code>($click)=&quot;method(some.key)&quot;</code></li>
<li><a href="../../can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">data bindings</a> like: <code>{some-attr}=&quot;some.key&quot;</code></li>
</ul>
<p>Furthermore keys return different values depending on the data type.</p>
<p>In general:</p>
<ul>
<li>Functions are called to get their return value. (Use the <a href="../keys/at.html" title="Return whatever value is at a key, regardless
if it's a function or a compute."><code>@</code> operator</a> to prevent this).</li>
<li>Keys in helper expression arguments that find observable data return
a <a href="../../can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> that represents the value.</li>
...
different data structures as a <a href="helper.html" title="">Helper Expression</a> and in all other expressions.</p>
