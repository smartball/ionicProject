...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/call.md
	@typedef can-stache/expressions/call
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Call Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="call.html">Call Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Call Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/call.md">Edit on GitHub</a>
				</li>
...
<pre><code>method(1,key,hashProp=hashValue,call(),helper expression)
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>|<a href="hash.html" title="">Hash Expression</a>|<a href="call.html" title="">Call Expression</a>|<a href="helper.html" title="">Helper Expression</a>}</code>: <p>An expression that will be passed as an argument
to <code>method</code>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A call expression calls a function looked up in the <a href="../../can-view-scope.html" title="Create a lookup node for keys.">scope</a> followed by
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/expressions/call.md"},"description":"\n","type":"typedef","title":"Call Expression","types":[{"type":"String"}],"name":"can-stache/expressions/call","parent":"can-stache/expressions","signatures":[{"code":"{{ method( [EXPRESSION...] ) }}","description":"\n\nCalls `method` with zero or many arguments where each argument\nis a comma separated\n`EXPRESSION`.\n\n```\nmethod(1,key,hashProp=hashValue,call(),helper expression)\n```\n\n","params":[{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/hash"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"EXPRESSION","description":"An expression that will be passed as an argument\nto `method`.\n\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/hash"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"EXPRESSION","description":"An expression that will be passed as an argument\nto `method`.\n\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
