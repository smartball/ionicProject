...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/bracket.md
	@typedef can-stache/expressions/bracket
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Bracket Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="bracket.html">Bracket Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Bracket Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/bracket.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Evaluates <code>key</code> and looks up the result in the <a href="../../can-view-scope.html" title="Create a lookup node for keys.">scope</a>.</p>
<pre><code>{{[key]}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{<a href="literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>|<a href="call.html" title="">Call Expression</a>|<a href="helper.html" title="">Helper Expression</a>}</code>: <p>A <a href="literal.html" title="Specify a JavaScript primitive type.">Literal</a>, <a href="key-lookup.html" title="">KeyLookup</a>, <a href="call.html" title="">Call</a>, or <a href="helper.html" title="">Helper</a> expression to evaluate and look up the result in the <a href="../../can-view-scope.html" title="Create a lookup node for keys.">scope</a>.</p>
</li>
...
<div class="signature">
  ...
  <p>Evaluates <code>key</code> and looks up the result in the return value of <code>CALL_EXPRESSION</code>.</p>
<pre><code>{{method()[key]}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>CALL_EXPRESSION</b> <code>{<a href="call.html" title="">Call Expression</a>|<a href="helper.html" title="">Helper Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>}</code>: <p>A <a href="call.html" title="">Call</a>, <a href="helper.html" title="">Helper</a>, or <a href="key-lookup.html" title="">KeyLookup</a> expression that may or may not return a value.</p>
</li>
        
          <li><b>key</b> <code>{<a href="literal.html" title="Specify a JavaScript primitive type.">Literal Expression</a>|<a href="key-lookup.html" title="">KeyLookup Expression</a>|<a href="call.html" title="">Call Expression</a>|<a href="helper.html" title="">Helper Expression</a>}</code>: <p>A <a href="literal.html" title="Specify a JavaScript primitive type.">Literal</a>, <a href="key-lookup.html" title="">KeyLookup</a>, <a href="call.html" title="">Call</a>, or <a href="helper.html" title="">Helper</a> expression to evaluate and look up the result in the result of <code>CALL_EXPRESSION</code>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A bracket expression can be used to look up a dynamic property in the <a href="../../can-view-scope.html" title="Create a lookup node for keys.">scope</a>. This looks like:</p>
<pre><code>Template:
    &lt;h1&gt;{{[key]}}&lt;/h1&gt;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/expressions/bracket.md"},"description":"\n","type":"typedef","title":"Bracket Expression","types":[{"type":"String"}],"name":"can-stache/expressions/bracket","parent":"can-stache/expressions","signatures":[{"code":"[key]","description":"\n\nEvaluates `key` and looks up the result in the [can-view-scope scope].\n\n```\n{{[key]}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"key","description":"A [can-stache/expressions/literal Literal], [can-stache/expressions/key-lookup KeyLookup], [can-stache/expressions/call Call], or [can-stache/expressions/helper Helper] expression to evaluate and look up the result in the [can-view-scope scope].\n"}]},{"code":"CALL_EXPRESSION[key]","description":"\n\nEvaluates `key` and looks up the result in the return value of `CALL_EXPRESSION`.\n\n```\n{{method()[key]}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"},{"type":"can-stache/expressions/key-lookup"}],"name":"CALL_EXPRESSION","description":"A [can-stache/expressions/call Call], [can-stache/expressions/helper Helper], or [can-stache/expressions/key-lookup KeyLookup] expression that may or may not return a value.\n"},{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"key","description":"A [can-stache/expressions/literal Literal], [can-stache/expressions/key-lookup KeyLookup], [can-stache/expressions/call Call], or [can-stache/expressions/helper Helper] expression to evaluate and look up the result in the result of `CALL_EXPRESSION`.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"key","description":"A [can-stache/expressions/literal Literal], [can-stache/expressions/key-lookup KeyLookup], [can-stache/expressions/call Call], or [can-stache/expressions/helper Helper] expression to evaluate and look up the result in the result of `CALL_EXPRESSION`.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
