...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/expressions/literal.md
	@typedef can-stache/expressions/literal
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Literal Expression</title>
...
<div class="breadcrumb">
	...
	<li><a href="literal.html">Literal Expression</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Literal Expression</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/expressions/literal.md">Edit on GitHub</a>
				</li>
    ...
    <p>Specify a JavaScript primitive type.</p>
...
<pre><code>{{myHelper( &quot;this is a string&quot; )}}
</code></pre>
...
<div class="signature">
  ...
  <p>Specifies a number.</p>
<pre><code>{{myHelper( 5.2 )}}
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>null | undefined | true | false</code>
  </h2>
  <p>Specifies a JavaScript <code>null</code>, <code>undefined</code>, <code>true</code>, or <code>false</code> value.</p>
<pre><code>{{myHelper( false )}}
</code></pre>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Literal expressions are usually passed as arguments to <a href="call.html" title="">Call Expression</a> or <a href="helper.html" title="">Helper Expression</a>s like:</p>
<pre><code class="language-js">{{task.filter(&quot;completed&quot;, true)}}
{{pluralize &quot;dog&quot; 2}}
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/expressions/literal.md"},"description":"\nSpecify a JavaScript primitive type.\n","type":"typedef","title":"Literal Expression","types":[{"type":"String"}],"name":"can-stache/expressions/literal","parent":"can-stache/expressions","signatures":[{"code":"\"string\" | 'string'","description":"\n\nSpecifies a string.\n\n```\n{{myHelper( \"this is a string\" )}}\n```\n","params":[]},{"code":"\\-[0-9]+\\.?[0-9]*","description":"\n\nSpecifies a number.\n\n```\n{{myHelper( 5.2 )}}\n```\n","params":[]},{"code":"null | undefined | true | false","description":"\n\nSpecifies a JavaScript `null`, `undefined`, `true`, or `false` value.\n\n```\n{{myHelper( false )}}\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
