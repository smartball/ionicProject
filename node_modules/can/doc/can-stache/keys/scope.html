...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/scope.md
	@typedef can-stache/keys/scope
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - scope</title>
...
or the expression&#x27;s return value.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="../expressions/key-lookup.html"
							title="">
...
call.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="scope/scope.view.html"
							title="Used to reference the current template">
							scope.view
						</a>
	...
	<div class="page-type">
		<h1>scope</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/scope.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.arguments</code>
  </h2>
  <p>In an event binding, <code>scope.arguments</code> references the arguments passed when the event was dispatched/triggered.</p>
<pre><code>&lt;input on:click=&quot;doSomething(scope.arguments)&quot;/&gt;
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.element</code>
  </h2>
  <p>In an event binding, <code>scope.element</code> references the DOM element the event happened on:</p>
<pre><code>&lt;input on:click=&quot;doSomething(scope.element.value)&quot;/&gt;
</code></pre>
...
<div class="signature">
  ...
  <p>In an event binding, <code>scope.event</code> references the dispatched event object:</p>
<pre><code>&lt;input on:click=&quot;doSomething(scope.event)/&gt;&quot;
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.filename</code>
  </h2>
  <p>The filename of the current template (only available in dev mode).</p>
<pre><code>{{scope.filename}}
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.index</code>
  </h2>
  <p>When looping over an array, <a href="../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>, or <a href="../../can-list.html" title="">can-list</a>, you an use <code>scope.index</code> to write out the index of each property:</p>
<pre><code>{{#each(tasks)}}
  &lt;li&gt;{{scope.index}} {{name}}&lt;/li&gt;
{{/each}}
</code></pre>
<p>Indexes start at 0.  If you want to start at 1, you can create a helper like:</p>
<pre><code>stache.registerHelper('scope.indexNum', function(options){
...
<div class="signature">
  ...
  <p>Like <code>scope.index</code>, but provides the key value when looping through an object:</p>
<pre><code>{{#each(style)}}
  {{scope.key}}: {{this}}
{{/each}}
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.lineNumber</code>
  </h2>
  <p>The current line number that is being rendered (only available in dev mode).</p>
<pre><code>{scope.lineNumber}}
</code></pre>
...
<div class="signature">
  ...
  <p>The root scope. This can be used for reading data from the root when in another scope:</p>
<pre><code class="language-html">var view = stache(`
{{#each(tasks)}}
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.vars</code>
  </h2>
  <p>Variables local to the template. See <a href="scope/scope.vars.html" title="Used to reference variables specific to the template context">scope.vars</a> for details.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.view</code>
  </h2>
  <p>The current template. See <a href="scope/scope.view.html" title="Used to reference the current template">scope.view</a> for details.</p>
...
<div class="signature">
  ...
  <p>In an event binding, <code>scope.viewModel</code> references the view model of the current element:</p>
<pre><code>&lt;my-component on:closed=&quot;doSomething(scope.viewModel)&quot;/&gt;
</code></pre>
