...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/current.md
	@typedef can-stache/keys/current
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>./current</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/current.md">Edit on GitHub</a>
				</li>
    ...
    <p>Lookup a value in only the current context.</p>
...
<div class="signature">
  ...
  <p>Only looks up <code>key</code> in the current context.  Returns <code>undefined</code> if
not found.</p>
<pre><code>{{#each(todo)}}
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/current.md"},"description":"\nLookup a value in only the current context.\n","type":"typedef","title":"./current","types":[{"type":"String"}],"name":"can-stache/keys/current","parent":"can-stache/keys","signatures":[{"code":"./key","description":"\n\nOnly looks up `key` in the current context.  Returns `undefined` if\nnot found.\n\n```\n{{#each(todo)}}\n  <input {($checked)}=\"./complete\"/> {{./name}}\n{{/each}}\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
