...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/scope.vars.md
	@module can-stache/keys/variable/scope.vars
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - scope.vars</title>
...
<div class="breadcrumb">
	...
	<li><a href="scope.vars.html">can-stache/keys/variable/scope.vars</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>scope.vars</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/scope.vars.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used to reference variables specific to the template context</p>
...
<div class="signature">
  ...
  <p>A placeholder for a value that is local to the template.</p>
<pre><code>&lt;drivers-licenses selected:to=&quot;scope.vars.selectedDriver&quot;/&gt;
...
template variable <code>scope.vars.variable</code>.  This is, in turn, used to update
the value of <code>propB</code> in <code>&lt;component-b&gt;</code>.</p>
<pre><code>&lt;component-a propA:to=&quot;scope.vars.variable&quot;/&gt;
...
<pre><code>stache.regsiterHelper(&quot;localContext&quot;, function(options){
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/scope.vars.md"},"description":"Used to reference variables specific to the template context \n","type":"module","title":"scope.vars","types":[{"type":"String"}],"name":"can-stache/keys/variable/scope.vars","parent":"can-stache/keys/scope","signatures":[{"code":"scope.vars","description":"\n\nA placeholder for a value that is local to the template.\n\n```\n<drivers-licenses selected:to=\"scope.vars.selectedDriver\"/>\n<edit-driver driver:from=\"scope.vars.selectedDriver\"/>\n```\n","params":[]}],"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
