...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/variable-self.md
	@typedef can-stache/keys/variable/self
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - *self</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>*self</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/variable-self.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used to reference the current template and recursively render it</p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      ...
      <div class='signature-wrapper'>
        <p><code>{{&gt;*self}}</code> is deprecated in favor of <a href="../scope/scope.view.html" title="Used to reference the current template"><code>{{&gt;scope.view}}</code></a></p>
...
<div class="signature">
  ...
  <p>The entirety of the current template is always stored as a <a href="../../../can-stache.tags.named-partial.html" title="Create an inline named partial within the current template.">named partial</a> <code>*self</code></p>
<pre><code>&lt;div&gt;
    {{&gt;*self}}
&lt;/div&gt;
</code></pre>
...
<p>For a more detailed explaination of using partials recursively see <a href="../../../can-stache.tags.named-partial.html#TooMuchRecursion" title="Create an inline named partial within the current template.">Too Much Recursion</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/variable-self.md"},"description":"Used to reference the current template and recursively render it \n","type":"typedef","title":"*self","types":[{"type":"String"}],"name":"can-stache/keys/variable/self","parent":"can-stache/keys","deprecated":[{"version":"4.0","description":"`{{>*self}}` is deprecated in favor of [can-stache/keys/scope/scope.view `{{>scope.view}}`]\n"}],"signatures":[{"code":"{{>*self}}","description":"\n\nThe entirety of the current template is always stored as a [can-stache.tags.named-partial named partial] `*self`\n\n```\n<div>\n\t{{>*self}}\n</div>\n```\n","params":[]}],"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
