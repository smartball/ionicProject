...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/parent.md
	@typedef can-stache/keys/parent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ../parent</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>../parent</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/parent.md">Edit on GitHub</a>
				</li>
    ...
    <p>Start looking for values in the parent context.</p>
...
<div class="signature">
  ...
  <p>Look for values starting in the parent context.</p>
<pre><code>{{#each(todos)}}
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/parent.md"},"description":"\nStart looking for values in the parent context.\n","type":"typedef","title":"../parent","types":[{"type":"String"}],"name":"can-stache/keys/parent","parent":"can-stache/keys","signatures":[{"code":"../key","description":"\n\nLook for values starting in the parent context.\n\n```\n{{#each(todos)}}\n\t<div class='{{#if(../isEditing(this))}}editing{{/if}}'>\n\t\t{{./name}}\n\t</div>\n{{/each}}\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
