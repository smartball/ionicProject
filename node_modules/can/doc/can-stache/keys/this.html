...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/this.md
	@typedef can-stache/keys/this
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - this</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>this</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/this.md">Edit on GitHub</a>
				</li>
    ...
    <p>Write out or return the current context.</p>
...
<div class="signature">
  ...
  <p>Writes out or returns the current context.</p>
<pre><code>{{#each(names)}}{{this}} {{/each}}
{{#each(names)}}
    {{sanitize(this)}}
{{/each}}
</code></pre>
...
<div class="signature">
  ...
  <p>The same as writing <code>this</code>, but with 3 fewer characters!</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/this.md"},"description":"\nWrite out or return the current context.\n","type":"typedef","title":"this","types":[{"type":"String"}],"name":"can-stache/keys/this","parent":"can-stache/keys","signatures":[{"code":"this","description":"\n\nWrites out or returns the current context.\n\n```\n{{#each(names)}}{{this}} {{/each}}\n{{#each(names)}}\n\t{{sanitize(this)}}\n{{/each}}\n```\n\n","params":[]},{"code":".","description":"\n\n  The same as writing `this`, but with 3 fewer characters!\n\n  ```\n  {{#each(names)}}{{.}} {{/each}}\n  {{#each(names)}}\n  \t{{sanitize(.)}}\n  {{/each}}\n  ```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
