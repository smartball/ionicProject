...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/scope.view.md
	@module can-stache/keys/scope.view
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - scope.view</title>
...
call.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="module"
							href="scope.view.html"
							title="Used to reference the current template">
							can-stache/keys/scope.view
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="scope.view.html">can-stache/keys/scope.view</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>scope.view</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/scope.view.md">Edit on GitHub</a>
				</li>
    ...
    <p>Used to reference the current template</p>
...
<div class="signature">
  ...
  <p>The entirety of the current template is always stored as a <a href="../../can-stache.tags.named-partial.html" title="Create an inline named partial within the current template.">named partial</a> <code>scope.view</code></p>
<pre><code>&lt;div&gt;
    {{&gt;scope.view}}
&lt;/div&gt;
</code></pre>
    ...
    <section class="body">
    <h2>Use</h2>
<p>This can be used to recursively render a template given a stop condition.
Note that we use a key expression to set local scope. Also note it is
a dot slash on the child key expression.
The dot slash prevents walking up the scope. See <a href="../../can-stache.tags.named-partial.html#TooMuchRecursion" title="Create an inline named partial within the current template.">Too Much Recursion</a> for more details.</p>
<pre><code>var grandpaWorm = new DefineMap({
    name: &quot;Earthworm Jim&quot;,
    child: {
        name: &quot;Grey Worm&quot;,
        child: {
...
<p>The view variable will be the document fragment:</p>
<pre><code>&lt;span&gt;Earthworm Jim&lt;/span&gt;
&lt;div&gt;
    &lt;span&gt;Grey Worm&lt;/span&gt;
    &lt;div&gt;
        &lt;span&gt;MyDoom&lt;/span&gt;
...
<p>A template variable can be passed in</p>
<pre><code>var grandpaWorm = new DefineMap({
    child: {
        name: &quot;Earthworm Jim&quot;,
        hasArms: false,
...
<p>For a more detailed explanation of using partials recursively see <a href="../../can-stache.tags.named-partial.html#TooMuchRecursion" title="Create an inline named partial within the current template.">Too Much Recursion</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/scope.view.md"},"description":"Used to reference the current template \n","type":"module","title":"scope.view","types":[{"type":"String"}],"name":"can-stache/keys/scope.view","parent":"can-stache/keys/scope","signatures":[{"code":"scope.view","description":"\n\nThe entirety of the current template is always stored as a [can-stache.tags.named-partial named partial] `scope.view`\n\n```\n<div>\n\t{{>scope.view}}\n</div>\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
