...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/special.md
	@typedef can-stache/keys/special
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - %special</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>%special</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/special.md">Edit on GitHub</a>
				</li>
    ...
    <p><a href="../../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">Event bindings</a> and some helpers like <a href="../../can-stache.helpers.each.html" title="">{{#each(expression)}}</a> provide special values that start with <code>%</code> to prevent potential collisions with
other values. Special values should not be confused with <a href="variable.html" title="Store a variable local to the template.">template variables</a> like <a href="variable/self.html" title="Used to reference the current template and recursively render it">*self</a></p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      <h3>Deprecated 4.0</h3>
      <div class='signature-wrapper'>
        <p>The <code>%special</code> values have been deprecated in favor of <a href="scope.html" title="The template context">scope</a>.</p>
...
<div class="signature">
  ...
  <p>When looping over an array, <a href="../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>, or <a href="../../can-list.html" title="">can-list</a>, you an use <code>%index</code> to write out the index of each property:</p>
<pre><code>{{#each(tasks)}}
  &lt;li&gt;{{%index}} {{name}}&lt;/li&gt;
{{/each}}
</code></pre>
<p>Indexes start at 0.  If you want to start at 1, you can create a helper like:</p>
<pre><code>stache.registerHelper('%indexNum', function(options){
...
<div class="signature">
  ...
  <p>Like <code>%index</code>, but provides the key value when looping through an object:</p>
<pre><code>{{#each(style)}}
   {{%key}}: {{this}}
{{/each}}
</code></pre>
...
<div class="signature">
  ...
  <p>In an event binding, <code>%arguments</code> references the arguments passed when the event was dispatched/triggered.</p>
<pre><code>&lt;input ($click)=&quot;doSomething(%arguments)&quot;/&gt;
</code></pre>
