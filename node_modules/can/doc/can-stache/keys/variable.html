...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/variable.md
	@typedef can-stache/keys/variable
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - *variable</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>*variable</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/variable.md">Edit on GitHub</a>
				</li>
    ...
    <p>Store a variable local to the template.</p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      ...
      <div class='signature-wrapper'>
        <p><code>{{*variable}}</code> is deprecated in favor of <a href="scope/scope.vars.html" title="Used to reference variables specific to the template context"><code>{{scope.vars.variable}}</code></a></p>
...
<pre><code>&lt;drivers-licenses {^selected}=&quot;*selectedDriver&quot;/&gt;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/variable.md"},"description":"Store a variable local to the template. \n","type":"typedef","title":"*variable","types":[{"type":"String"}],"name":"can-stache/keys/variable","parent":"can-stache/keys","deprecated":[{"version":"4.0","description":"`{{*variable}}` is deprecated in favor of [can-stache/keys/scope/scope.vars `{{scope.vars.variable}}`]\n\n"}],"signatures":[{"code":"*variable","description":"\n\nA placeholder for a value that is local to the template.\n\n```\n<drivers-licenses {^selected}=\"*selectedDriver\"/>\n<edit-driver {driver}=\"*selectedDriver\"/>\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
