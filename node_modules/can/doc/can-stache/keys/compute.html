...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/compute.md
	@typedef can-stache/keys/compute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>~compute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/compute.md">Edit on GitHub</a>
				</li>
    ...
    <p>Pass a compute instead of a value if an observable is found within
<a href="../expressions/call.html" title="">Call Expression</a>.</p>
...
<div class="signature">
  ...
  <p>This makes non-helper expression arguments behave similarly to helper
expression arguments.</p>
<pre><code>{{#each(~todos)}} ... {{/each}}
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/keys/compute.md"},"description":"\nPass a compute instead of a value if an observable is found within\n[can-stache/expressions/call].\n","type":"typedef","title":"~compute","types":[{"type":"String"}],"name":"can-stache/keys/compute","parent":"can-stache/keys","signatures":[{"code":"~key","description":"\n\nThis makes non-helper expression arguments behave similarly to helper\nexpression arguments.\n\n```\n{{#each(~todos)}} ... {{/each}}\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
