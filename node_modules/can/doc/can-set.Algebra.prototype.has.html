...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.has.html">has</a></li>
	...
	<div class="page-type">
		<h1>has</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L471">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Used to tell if the <code>set</code> contains the instance object <code>props</code>.</p>
...
algebra.has(
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A set.</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>An instance's raw data.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>Returns <code>true</code> if <code>props</code> belongs in <code>set</code> and
<code>false</code> it not.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.has","parent":"can-set.Algebra.prototype","src":{"line":470,"codeLine":493,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"has","signatures":[{"code":"algebra.has(set, props)","description":"\n\nUsed to tell if the `set` contains the instance object `props`.\n\n```\nvar algebra = new set.Algebra(\n  new set.Translate(\"where\",\"$where\")\n);\nalgebra.has(\n  {\"$where\": {playerId: 5}},\n  {id: 5, type: \"3pt\", playerId: 5, gameId: 7}\n) //-> true\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"A set."},{"types":[{"type":"Object","options":[]}],"name":"props","description":"An instance's raw data."}],"returns":{"types":[{"type":"Boolean"}],"description":"Returns `true` if `props` belongs in `set` and\n`false` it not.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"An instance's raw data."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"Returns `true` if `props` belongs in `set` and\n`false` it not.\n "},"pathToRoot":".."};
</script>
</article>
