...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers.md
	...
	<div class="page-type">
		<h1>Helpers</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers.md">Edit on GitHub</a>
				</li>
...
<p>When using the <code><a href="can-stache.helpers.is.html" title="Render something if two values are equal.">{{#eq(key1, key2)}}</a></code> helper you can simply compare
...
<p>You can register your own global helper with the <code><a href="can-stache.registerSimpleHelper.html" title="Register a helper that gets passed values.">registerSimpleHelper</a></code> or <code><a href="can-stache.registerHelper.html" title="Register a helper.">registerHelper</a></code> methods.</p>
