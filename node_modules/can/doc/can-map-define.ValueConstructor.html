...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/ValueConstructor.md
	@function can-map-define.ValueConstructor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map-define.ValueConstructor.html">Value</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Value</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/ValueConstructor.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a constructor function to be used to provide a default value for a certain property of a <a href="can-map.html" title="Create observable objects.">Map</a>.  This constructor will be invoked with <code>new</code> each time a new instance of the map is created.</p>
...
<div class="signature">
  ...
  <p>A constructor function can be provided that is called to create a default value used for this property, like:</p>
<pre><code>define: {
  prop: {
    Value: Array
  },
