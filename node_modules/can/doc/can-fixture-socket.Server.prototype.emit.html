...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture-socket/src/index.js
	@function can-fixture-socket.Server.prototype.emit
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - emit</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.Server.prototype.emit.html">emit</a></li>
	...
	<div class="page-type">
		<h1>emit</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/src/index.js#L86">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>server.emit(event, ...data, [ackFn])</code>
  </h2>
  <p>Emits a socket event.</p>
<pre><code class="language-js">server.emit(&quot;news&quot;, data1, data2, function(ackData){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{string}</code>: <p>The name of the socket event.</p>
</li>
        
          <li><b>data</b> <code>{*}</code>: <p>Data to be sent with the event. Socket.io allows to send more than one data objects.</p>
</li>
        
          <li><b>ackFn</b> <code>{function}</code>: <p>The acknowledgement function that will be executed if the receiver calls the acknowledgement callback.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-fixture-socket.Server.prototype.emit","parent":"can-fixture-socket.Server.prototype","src":{"line":85,"codeLine":105,"path":"node_modules/can-fixture-socket/src/index.js"},"description":"\nEmits a socket event.\n","title":"emit","signatures":[{"code":"server.emit(event, ...data, [ackFn])","description":"\n\nEmits a socket event.\n\n```js\nserver.emit(\"news\", data1, data2, function(ackData){\n  console.log(\"Client acknowledged\", ackData);\n});\n```\n","params":[{"types":[{"type":"string"}],"name":"event","description":"The name of the socket event."},{"types":[{"type":"*"}],"name":"data","description":"Data to be sent with the event. Socket.io allows to send more than one data objects."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"ackFn","description":"The acknowledgement function that will be executed if the receiver calls the acknowledgement callback.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"ackFn","description":"The acknowledgement function that will be executed if the receiver calls the acknowledgement callback.\n"},"pathToRoot":".."};
</script>
</article>
