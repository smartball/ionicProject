...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/Store.prototype.getList.md
	@function can-fixture/StoreType.prototype.getList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="StoreType.prototype.getList.html">getList</a></li>
	...
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/Store.prototype.getList.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns the matching items from the store like: <code>{data: [...]}</code>.</p>
<pre><code class="language-js">todoStore.get({name: &quot;dishes&quot;}) //-&gt; {data: [{id: 1, name: &quot;dishes&quot;}]}
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/Store.prototype.getList.md"},"description":"\n","title":"getList","name":"can-fixture/StoreType.prototype.getList","type":"function","parent":"can-fixture/StoreType.prototype","signatures":[{"code":"Store.prototype.getList(set)","description":"\n\nReturns the matching items from the store like: `{data: [...]}`.\n\n```js\ntodoStore.get({name: \"dishes\"}) //-> {data: [{id: 1, name: \"dishes\"}]}\n```\n","params":[]}],"pathToRoot":"../.."};
</script>
</article>
