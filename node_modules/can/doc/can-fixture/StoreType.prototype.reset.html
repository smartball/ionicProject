...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/Store.prototype.reset.md
	@function can-fixture/StoreType.prototype.reset
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - reset</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.createData.html"
							title="">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.destroyData.html"
							title="">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.get.html"
							title="">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.getData.html"
							title="">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.getList.html"
							title="">
							getList
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.getListData.html"
							title="">
							getListData
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="StoreType.prototype.reset.html"
							title="">
							reset
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="StoreType.prototype.updateData.html"
							title="">
							updateData
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="StoreType.html">Store</a></li>
		<li> / </li>
	
	
	<li><a href="StoreType.prototype.reset.html">reset</a></li>
	...
	<div class="page-type">
		<h1>reset</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/Store.prototype.reset.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Sets the items in the store to their original state or to <code>baseItems</code> if it's passed as an argument.</p>
<pre><code class="language-js">// Creates a store with one item.
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseItems</b> <code>{Array}</code>: <p>If provided, adds these items to the store.<br />
This can be useful for setting up particular testing scenarios.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/Store.prototype.reset.md"},"description":"\n","title":"reset","name":"can-fixture/StoreType.prototype.reset","type":"function","parent":"can-fixture/StoreType.prototype","signatures":[{"code":"Store.prototype.reset([baseItems])","description":"\n\nSets the items in the store to their original state or to `baseItems` if it's passed as an argument.\n\n```js\n// Creates a store with one item.\nvar todoStore = fixture.store(\n    [{id: 1, name: \"dishes\"}],\n    new set.Algebra());\nfixture(\"/todos/{id}\", todoStore)\ntodoStore.getList({}).length //-> 1\n\n// delete that item\n$.ajax({url: \"todos/1\", method: \"delete\"}).then(function(){\n    return todoStore.getList({}).length //-> 0\n}).then(function(){\n    // calling reset adds it back\n    todoStore.reset();\n    todoStore.getList({}).length //-> 1\n});\n```","params":[{"types":[{"type":"Array","options":[]}],"name":"baseItems","description":"If provided, adds these items to the store.  \nThis can be useful for setting up particular testing scenarios.\n"}]}],"_curParam":{"types":[{"type":"Array","options":[]}],"name":"baseItems","description":"If provided, adds these items to the store.  \nThis can be useful for setting up particular testing scenarios.\n"},"pathToRoot":"../.."};
</script>
</article>
