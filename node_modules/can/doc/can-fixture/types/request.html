...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/request.md
	@typedef can-fixture/types/request
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - request</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>request</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/request.md">Edit on GitHub</a>
				</li>
    ...
    <p>An object with easily digestible values derived from the mock XHR
object.</p>
...
<div class="signature">
  ...
  <p>This object is passed to a <a href="../../can-fixture.requestHandler.html" title="">requestHandler</a>
and can be used to determine the response.</p>
<pre><code class="language-js">fixture(&quot;GET /todos/{id}&quot;, function(request, response){
    request.url     //-&gt; &quot;todos/5&quot;
    request.method  //-&gt; &quot;get&quot;
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        ...
        <p>The requested url with anything after the querystring taken off in <code>GET</code> and <code>DESTROY</code> method requests.</p>

      </li>
    
      <li>
        <b>method</b> <code>{String}</code>:
        <p>The method of the request. Ex: <code>GET</code>, <code>PUT</code>, <code>POST</code>, etc.</p>

      </li>
    
      <li>
        <b>data</b> <code>{Object}</code>:
        <p>The data of the querystring or the data to <code>XMLHTTPRequest.prototype.send</code> converted back to JavaScript objects with either <code>JSON.stringify</code> or <a href="../../can-util/js/deparam/deparam.html" title="Deprecated. Use can-deparam instead.">deparam</a>.</p>

      </li>
    
      <li>
        <b>headers</b> <code>{Object}</code>:
        <p>Headers added to the XHR object with <code>XMLHTTPRequest.prototype.setRequestHeader</code>.</p>

      </li>
    
      <li>
        <b>async</b> <code>{Boolean}</code>:
        <p><code>true</code> if the request was a synchronous request.</p>

      </li>
    
      <li>
        <b>xhr</b> <code>{XMLHTTPRequest}</code>:
        <p>The mock xhr request.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/request.md"},"description":"\nAn object with easily digestible values derived from the mock XHR\nobject.  \n","type":"typedef","title":"request","types":[{"type":"Object","options":[{"name":"url","description":"The requested url with anything after the querystring taken off in `GET` and `DESTROY` method requests.","types":[{"type":"String"}]},{"name":"method","description":"The method of the request. Ex: `GET`, `PUT`, `POST`, etc.","types":[{"type":"String"}]},{"name":"data","description":"The data of the querystring or the data to `XMLHTTPRequest.prototype.send` converted back to JavaScript objects with either `JSON.stringify` or [can-util/js/deparam/deparam].","types":[{"type":"Object","options":[]}]},{"name":"headers","description":"Headers added to the XHR object with `XMLHTTPRequest.prototype.setRequestHeader`.","types":[{"type":"Object","options":[]}]},{"name":"async","description":"`true` if the request was a synchronous request.","types":[{"type":"Boolean"}]},{"name":"xhr","description":"The mock xhr request.\n","types":[{"type":"XMLHTTPRequest"}]}],"description":"\n\nThis object is passed to a [can-fixture.requestHandler]\nand can be used to determine the response.\n\n```js\nfixture(\"GET /todos/{id}\", function(request, response){\n    request.url     //-> \"todos/5\"\n    request.method  //-> \"get\"\n    request.data    //-> {id: \"5\", include: [\"owner\"]}\n    request.headers //-> {}\n    request.async   //-> false\n});\n\n$.get(\"/todos/5?include[]=owner\");\n```\n"}],"name":"can-fixture/types/request","parent":"can-fixture.types","pathToRoot":"../../.."};
</script>
</article>
