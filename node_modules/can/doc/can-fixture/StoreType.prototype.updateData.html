...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/Store.prototype.updateData.md
	@function can-fixture/StoreType.prototype.updateData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="StoreType.prototype.updateData.html">updateData</a></li>
	...
	<div class="page-type">
		<h1>updateData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/Store.prototype.updateData.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A <code>requestHandler</code> that updates an item in the store.</p>
<pre><code class="language-js">fixture(&quot;PUT /api/todos/{_id}&quot;, todoStore.updateData);
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/Store.prototype.updateData.md"},"description":"\n","title":"updateData","name":"can-fixture/StoreType.prototype.updateData","type":"function","parent":"can-fixture/StoreType.prototype","signatures":[{"code":"Store.prototype.updateData(request, response)","description":"\n\nA `requestHandler` that updates an item in the store.\n\n```js\nfixture(\"PUT /api/todos/{_id}\", todoStore.updateData);\n```\n","params":[]}],"pathToRoot":"../.."};
</script>
</article>
