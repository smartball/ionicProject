...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/types/Store.prototype.destroyData.md
	@function can-fixture/StoreType.prototype.destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="StoreType.prototype.destroyData.html">destroyData</a></li>
	...
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/types/Store.prototype.destroyData.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A <code>requestHandler</code> that removes an item from the store.</p>
<pre><code class="language-js">fixture(&quot;DELETE /api/todos/{_id}&quot;, todoStore.destroyData)
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/types/Store.prototype.destroyData.md"},"description":"\n","title":"destroyData","name":"can-fixture/StoreType.prototype.destroyData","type":"function","parent":"can-fixture/StoreType.prototype","signatures":[{"code":"Store.prototype.destroyData(request, response)","description":"\n\nA `requestHandler` that removes an item from the store.\n\n```js\nfixture(\"DELETE /api/todos/{_id}\", todoStore.destroyData)\n```\n","params":[]}],"pathToRoot":"../.."};
</script>
</article>
