...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-href/can-view-href.md
	@module can-view-href
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-href</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-href.html">can-view-href</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-href</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-href">
						<img src="https://img.shields.io/badge/npm%20package-3.1.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-href" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-href/edit/master/can-view-href.md">Edit on GitHub</a>
				</li>
    ...
    <p>Sets an element’s <code>href</code> attribute so that its url will set the specified attribute values on <a href="can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a>.</p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      <h3>Deprecated 2.3</h3>
      <div class='signature-wrapper'>
        <p>Use the <a href="can-stache.helpers.routeUrl.html" title="Returns a url using route.url.">routeUrl helper</a> instead like:
<code>href=&quot;{{routeUrl prop=value}}&quot;</code>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>can-href=&#39;{[attrName=attrValue...]}&#39;</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>attrName</b> <code>{String}</code>: </li>
        
          <li><b>attrValue</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>}</code>: </li>
...
<pre><code class="language-html">&lt;li&gt;&lt;a can-href='{page=&quot;recipe&quot; id=5}'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
<p>produces:</p>
<pre><code class="language-html">&lt;li&gt;&lt;a href='#!&amp;page=5&amp;id=5'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
<p>If pretty route is defined like:</p>
<pre><code class="language-js">can.route(&quot;:page/:id&quot;)
</code></pre>
<p>The previous use of <code>can-href</code> will instead produce:</p>
<pre><code class="language-html">&lt;li&gt;&lt;a href='#!page/5'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
<p>You can use values from stache's scope like:</p>
<pre><code class="language-html">&lt;li&gt;&lt;a can-href='{page=&quot;recipe&quot; id=recipeId}'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
<p>If <code>recipeId</code> was 6:</p>
<pre><code class="language-html">&lt;li&gt;&lt;a href='#!page/6'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
<p>If <code>recipeId</code> is observable and changes to 7:</p>
<pre><code class="language-html">&lt;li&gt;&lt;a href='#!page/7'&gt;{{recipe.name}}&lt;/a&gt;&lt;/li&gt;
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-href/can-view-href.md"},"description":"Sets an element’s `href` attribute so that its url will set the specified attribute values on [can-route]. \n","type":"module","title":"","types":[{"type":"undefined"}],"name":"can-view-href","parent":"can-legacy","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.1.0-pre.9","can-route":"^3.1.0-pre.2","can-stache":"^3.1.0-pre.4","can-util":"^3.9.0-pre.4","can-view-callbacks":"^3.1.0-pre.0","can-view-scope":"^3.2.0-pre.10"},"deprecated":false,"description":"Make flexible route links","devDependencies":{"can-map":"^3.1.0-pre.10","can-ssr":"^0.11.6","donejs-cli":"^0.9.5","generator-donejs":"^0.9.6","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.3.1"},"homepage":"https://canjs.com","keywords":["canjs","donejs","canjs-plugin"],"main":"can-view-href","name":"can-view-href","scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","jshint":"jshint *.js test/*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-view-href","configDependencies":["live-reload"],"npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.0"},"deprecated":[{"version":"2.3","description":"Use the [can-stache.helpers.routeUrl routeUrl helper] instead like:\n`href=\"{{routeUrl prop=value}}\"`.\n"}],"signatures":[{"code":"can-href='{[attrName=attrValue...]}'","description":"\n","params":[{"types":[{"type":"String"}],"name":"attrName","description":""},{"types":[{"type":"can-stache/expressions/key-lookup"}],"name":"attrValue","description":"\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/key-lookup"}],"name":"attrValue","description":"\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
