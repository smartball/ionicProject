...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/leakscope.md
	@property can-component.prototype.leakScope
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - leakScope</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-component.prototype.leakScope.html">leakScope</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>leakScope</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/leakscope.md">Edit on GitHub</a>
				</li>
    ...
    <p>Allow reading the outer scope values from a component’s view and a component’s viewModel values in the user content.</p>
...
<div class="signature">
  ...
  <p><code>false</code> limits reading to:</p>
<ul>
<li>the component’s viewModel from the component’s view, and</li>
<li>the outer scope values from the user content.</li>
</ul>
<p><code>true</code> adds the ability to read:</p>
<ul>
<li>the outer <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a> values from the component’s view, and</li>
<li>the component’s <a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
to the component’s view. The constructor function
...
based on some value in the component’s ViewModel.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A component’s <a href="can-component.prototype.leakScope.html" title="Allow reading the outer scope values from a component’s view and a component’s viewModel values in the user content.">leakScope</a> option controls if a
component’s view can access the component’s outer scope and the
user content can read the component’s view model.</p>
<p>Let’s define what <strong>outer scope</strong>, <strong>component’s view</strong> and <strong>user content</strong> mean.</p>
<p>If I have a <code>&lt;hello-world&gt;</code> component in a view like:</p>
<pre><code>{{#data}}
...
<code>&lt;hello-world&gt;</code> is the view between its tags.  In this case, the <strong>user content</strong>
...
<p><code>{{greeting}} &lt;content/&gt;{{exclamation}}</code> represents the <strong>component’s view</strong>.</p>
<h2>Using outer scope in component view</h2>
<p>If <code>leakScope</code> is <code>true</code>, the <strong>component’s view</strong> can read the data in the outer scope and will
