...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone/docs/addWait.md
	@function can-zone.prototype.addWait
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addWait</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone.prototype.addWait.html">addWait</a></li>
	...
	<div class="page-type">
		<h1>addWait</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone/edit/master/docs/addWait.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Adds a wait to the <a href="can-zone.html" title="A library that tracks asynchronous activity and lets you know when it has completed. Useful when you need to call a function and wait for all async behavior to complete, such as when performing server-side rendering.">Zone</a>. Adding a wait will delay the Zone's Promise from resolving (the promise created by calling <a href="can-zone.prototype.run.html" title="">zone.run</a>) by incrementing its internal counter.</p>
<p>Usually a corresponding <a href="can-zone.prototype.removeWait.html" title="">removeWait</a> will be called to decrement the counter.</p>
<pre><code class="language-js">new Zone().run(function(){
