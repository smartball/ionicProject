...
<!--####################################################################
	...
	@property can-types.DefaultMap
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DefaultMap</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-types.DefaultMap.html">DefaultMap</a></li>
	...
	<div class="page-type">
		<h1>DefaultMap</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-types/edit/master/can-types.js#L75">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>The default map type to create if a map is needed.  If both <a href="can-map.html" title="Create observable objects.">can-map</a> and <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>
are imported, the default type will be <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-types.DefaultMap","type":"property","parent":"can-types","src":{"line":74,"codeLine":82,"path":"node_modules/can-types/can-types.js"},"description":"\n","types":[{"type":"Map","description":"\n\n  The default map type to create if a map is needed.  If both [can-map] and [can-define/map/map]\n  are imported, the default type will be [can-define/map/map].\n "}],"title":"DefaultMap","pathToRoot":".."};
</script>
</article>
