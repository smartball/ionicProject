...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/content.md
	@typedef can-component/content
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - &lt;content&gt;</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>&lt;content&gt;</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/content.md">Edit on GitHub</a>
				</li>
    ...
    <p>Positions the <code>LIGHT_DOM</code> within a component’s <a href="../can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;content&gt;DEFAULT_CONTENT&lt;/content&gt;</code>
  </h2>
  <p>When a user creates a new component in a view, the content between the tags is the
<code>LIGHT_DOM</code>.  For example, <code>Hello &lt;b&gt;World&lt;/b&gt;</code> is the <code>LIGHT_DOM</code> in the following:</p>
<pre><code>&lt;my-tag&gt;Hello &lt;b&gt;World&lt;/b&gt;&lt;/my-tag&gt;
</code></pre>
<p>The <code>&lt;content&gt;</code> tag can be used within <code>my-tag</code> to position the <code>LIGHT_DOM</code>.  For
example, to position the <code>LIGHT_DOM</code> within an <code>&lt;h1&gt;</code>, <code>&lt;my-tag&gt;</code> could be defined like:</p>
...
used if there is no <code>LIGHT_DOM</code> passed to the component.</p>
<p>The following, makes <code>my-tag</code> show <code>Hi There!</code> if no <code>LIGHT_DOM</code> is passed:</p>
<pre><code>Component.extend({
    tag: &quot;my-tag&quot;,
