...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/can-template.md
	@typedef can-component/can-template
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - &lt;can-template&gt;</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-template.html">&lt;can-template&gt;</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>&lt;can-template&gt;</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/can-template.md">Edit on GitHub</a>
				</li>
    ...
    <p>Pass templates declaratively to components.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;can-template name=&#39;NAME&#39;/&gt;</code>
  </h2>
  <p>When building widget-like components, it's often useful to allow the consumer of the
component to customize parts of the widget's layout.  These components can accept
templates passed to them using <code>&lt;can-template&gt;</code> and render these templates with
<a href="can-slot.html" title="Position the content of can-template elements.">&lt;can-slot&gt;</a>.  The <code>name</code> attribute of a <code>&lt;can-template&gt;</code>
corresponds to the <code>name</code> attribute of a <code>&lt;can-slot&gt;</code>.</p>
<p>For example, the following passes a <code>&lt;my-modal&gt;</code> component a <code>&lt;can-template&gt;</code>
of the modal content:</p>
...
<p>By default, <code>&lt;can-template&gt;</code> is rendered with the surrounding scope
like <code>&lt;content&gt;</code>. A different context (<a href="../can-stache/keys/this.html" title="Write out or return the current context.">this</a>) can be added
to that scope with bindings.  Read <a href="can-slot.html" title="Position the content of can-template elements.">&lt;can-slot&gt;</a> for more information.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>NAME</b> <code>{String}</code>: <p>The name of the template that will be rendered by a corresponding
<a href="can-slot.html" title="Position the content of can-template elements.">&lt;can-slot&gt;</a>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use <code>&lt;can-template&gt;</code> elements we can create a Component that has <code>&lt;can-slot&gt;</code> elements in it's view
and render that component with <code>&lt;can-template&gt;</code> elements in the <code>LIGHT_DOM</code>.</p>
<p>Any <code>&lt;can-template&gt;</code> that has a name attribute matching the name attribute of a <code>&lt;can-slot&gt;</code> will
have it's inner contents rendered and replace the <code>&lt;can-slot&gt;</code>.</p>
<pre><code class="language-js">Component.extend({
    tag : 'my-email',
    view : stache(
