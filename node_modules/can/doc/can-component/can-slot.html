...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/can-slot.md
	@typedef can-component/can-slot
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - &lt;can-slot&gt;</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-slot.html">&lt;can-slot&gt;</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>&lt;can-slot&gt;</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/can-slot.md">Edit on GitHub</a>
				</li>
    ...
    <p>Position the content of <a href="can-template.html" title="Pass templates declaratively to components."><can-template></a> elements.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;can-slot name=&#39;NAME&#39; BINDING&gt;DEFAULT_CONTENT&lt;/can-slot&gt;</code>
  </h2>
  <p>Replaces any <code>&lt;can-slot name='NAME' /&gt;</code> element found in a component's view with the rendered contents
of the <code>&lt;can-template /&gt;</code> element from the <code>LIGHT_DOM</code> that has a matching [TEMPLATE_NAME] attribute. Uses the scope of
the <code>LIGHT_DOM</code> by default.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>NAME</b> <code>{String}</code>: <p>The name of the <a href="can-template.html" title="Pass templates declaratively to components.">&lt;can-template&gt;</a> to render in place of the <code>&lt;can-slot&gt;</code>.</p>
</li>
        
          <li><b>BINDING</b> <code>{<a href="../can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>}</code>: <p>You can bind to the context (also known as <a href="../can-stache/keys/this.html" title="Write out or return the current context.">this</a>)
of of the corresponding <a href="can-template.html" title="Pass templates declaratively to components.">&lt;can-template&gt;</a>.  This lets you pass data to the
template. The following passes <code>user</code> as <code>this</code> to the corresponding <code>&lt;can-template name=&quot;user-details&quot;&gt;</code>:</p>
<pre><code class="language-html">&lt;can-slot name=&quot;user-details&quot; {this}=&quot;user&quot;&gt;
</code></pre>
<p><a href="../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">toChild:from</a>, <a href="../can-stache-bindings.toParent.html" title="One-way bind a value from the viewModel or element to the parent scope.">toParent:to</a> and <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a> with <code>this</code>
all work.</p>
</li>
        
          <li><b>DEFAULT_CONTENT</b> <code>{<a href="../can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>The content that should be
used if there is no content in the matching <code>&lt;can-template&gt;</code>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use <code>&lt;can-slot&gt;</code> we can create a Component that has <code>&lt;can-slot&gt;</code> elements in it's view
and render that component with &lt;can-template&gt; elements in the <code>LIGHT_DOM</code>.</p>
<p>Any <code>&lt;can-slot&gt;</code> that has a name attribute matching the name attribute of a <code>&lt;can-template&gt;</code> will be
replaced by the rendered inner contents of the &lt;can-template&gt;.</p>
<pre><code class="language-js">Component.extend({
    tag : 'my-email',
    view : stache(
        '&lt;can-slot name=&quot;subject&quot; /&gt;' +
...
<h3>Passing context</h3>
<p>Context (<a href="../can-stache/keys/this.html" title="Write out or return the current context.">this</a>) can be bound to and passed to a template. The following
passes <code>&lt;my-email&gt;</code>'s <code>subject</code> and <code>body</code> to the <code>subject</code> and <code>body</code> templates.  Notice
how <code>subject</code> and <code>body</code> are read by <code>{{this}}</code>.</p>
...
<p>Default content can be specified to be used if there is no matching <code>&lt;can-template&gt;</code>
or the matching <code>&lt;can-template&gt;</code> has no inner content.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-component/docs/can-slot.md"},"description":"Position the content of [can-component/can-template] elements. \n","type":"typedef","title":"<can-slot>","types":[{"type":"can-stache.sectionRenderer"}],"name":"can-component/can-slot","parent":"can-component.elements","signatures":[{"code":"<can-slot name='NAME' BINDING>DEFAULT_CONTENT</can-slot>","description":"\n\nReplaces any `<can-slot name='NAME' />` element found in a component's view with the rendered contents\nof the `<can-template />` element from the `LIGHT_DOM` that has a matching [TEMPLATE_NAME] attribute. Uses the scope of\nthe `LIGHT_DOM` by default.\n\n```js\nComponent.extend({\n\ttag : 'my-email',\n\tview : stache(\n\t\t'<can-slot name=\"subject\" />'\n\t)\n});\n\nvar renderer = stache(\n\t'<my-email>' +\n\t\t'<can-template name=\"subject\">' +\n\t\t\t'{{subject}}' +\n\t\t'</can-template>' +\n\t'</my-email>'\n);\n\nrenderer({\n\tsubject: 'Hello World'\n});\n//-> <my-email>Hello World</my-email>\n```\n","params":[{"types":[{"type":"String"}],"name":"NAME","description":"The name of the [can-component/can-template] to render in place of the `<can-slot>`.\n"},{"types":[{"type":"can-stache-bindings"}],"name":"BINDING","description":"You can bind to the context (also known as [can-stache/keys/this])\nof of the corresponding [can-component/can-template].  This lets you pass data to the\ntemplate. The following passes `user` as `this` to the corresponding `<can-template name=\"user-details\">`:\n\n```html\n<can-slot name=\"user-details\" {this}=\"user\">\n```\n\n[can-stache-bindings.toChild], [can-stache-bindings.toParent] and [can-stache-bindings.twoWay] with `this`\nall work.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"optional":true,"name":"DEFAULT_CONTENT","description":"The content that should be\nused if there is no content in the matching `<can-template>`.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"optional":true,"name":"DEFAULT_CONTENT","description":"The content that should be\nused if there is no content in the matching `<can-template>`.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
