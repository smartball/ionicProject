...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/beforeremove.md
	@typedef can-component/beforeremove
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - beforeremove</title>
...
<div class="breadcrumb">
	...
	<li><a href="beforeremove.html">beforeremove</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>beforeremove</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/beforeremove.md">Edit on GitHub</a>
				</li>
    ...
    <p>An event called only on component’s elements before they are removed from the
document if live binding is performing the removal. It can be listened to
...
and <a href="../can-util/dom/events/removed/removed.html" title="This event fires when the bound element is detached or destroyed.">removed</a> events are available on all elements.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>&quot;{element} beforeremove&quot;: function(element, event)</code>
  </h2>
  <p>Listens to when the component element is removed.<br />
This is commonly used for cleaning up and tearing down a component.</p>
<p>For example, the following might remove the component’s ViewModel
from a parent component’s ViewModel:</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>element</b> <code>{HTMLElement}</code>: <p>The component element.</p>
</li>
        
          <li><b>event</b> <code>{Event}</code>: <p>The <code>beforeremove</code> event object.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>($beforeremove)=&quot;CALL_EXRESSION&quot;</code>
  </h2>
  <p>Uses <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">on:event</a> bindings to listen for a component’s
<code>beforeremove</code> event.</p>
<pre><code>&lt;my-panel ($beforeremove)=&quot;removePanel(%viewModel)&quot;/&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>CALL_EXRESSION</b> <code>{<a href="../can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>A call expression that calls some method when the event happens.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-component/docs/beforeremove.md"},"description":"\nAn event called only on component’s elements before they are removed from the\ndocument if live binding is performing the removal. It can be listened to\nwithin a component’s [can-component.prototype.events] object or on a component\nelement with [can-stache-bindings.event] bindings.  This is an additional\nspecial event only on component elements.  [can-util/dom/events/inserted/inserted]\nand [can-util/dom/events/removed/removed] events are available on all elements.\n","type":"typedef","title":"beforeremove","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-component/beforeremove","parent":"can-component.events","signatures":[{"code":"\"{element} beforeremove\": function(element, event)","description":"\n\nListens to when the component element is removed.  \nThis is commonly used for cleaning up and tearing down a component.\n\nFor example, the following might remove the component’s ViewModel\nfrom a parent component’s ViewModel:\n\n```js\nevents: {\n\t\"{element} beforeremove\": function(){\n\t\tcanViewModel(this.element.parentNode)\n\t\t\t.removePanel(this.viewModel);\n\t}\n}\n```\n","params":[{"types":[{"type":"HTMLElement"}],"name":"element","description":"The component element."},{"types":[{"type":"Event"}],"name":"event","description":"The `beforeremove` event object.\n"}]},{"code":"($beforeremove)=\"CALL_EXRESSION\"","description":"\n\nUses [can-stache-bindings.event] bindings to listen for a component’s\n`beforeremove` event.\n\n```\n<my-panel ($beforeremove)=\"removePanel(%viewModel)\"/>\n```\n","params":[{"types":[{"type":"can-stache/expressions/call"}],"name":"CALL_EXRESSION","description":"A call expression that calls some method when the event happens.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/call"}],"name":"CALL_EXRESSION","description":"A call expression that calls some method when the event happens.\n"},"pathToRoot":"../.."};
</script>
</article>
