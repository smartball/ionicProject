...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture-socket/docs/can-fixture-socket.on-feathers-service.md
	@function can-fixture-socket.Server.prototype.onFeathersService
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onFeathersService</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.Server.prototype.onFeathersService.html">onFeathersService</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onFeathersService</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/docs/can-fixture-socket.on-feathers-service.md">Edit on GitHub</a>
				</li>
    ...
    <p>Subscribes to mocked server socket events to work as FeathersJS CRUD service.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>server.onFeathersService(name, fixtureStore, [options])</code>
  </h2>
  <p>Subscribes to mocked server socket events according to FeathersJS protocol. Uses fixture store [can-fixture.Store] as a resource storage.</p>
<pre><code>var fixtureStore = fixture.store([
  {id: 1, title: 'One'},
  {id: 2, title: 'Two'},
  {id: 3, title: 'Three'}
], new canSet.Algebra({}));
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>The name of Feathers service.</p>
</li>
        
          <li><b>fixtureStore</b> <code>{<a href="can-fixture/StoreType.html" title="">Store</a>()}</code>: <p>A fixture store. See <a href="can-fixture.store.html" title="">store</a> for more details.</p>
</li>
        
          <li><b>options</b> <code>{Object}</code>: <p>Options, e.g. property name for id.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Instantiate fixture store by calling <a href="can-fixture.store.html" title="">store</a> and provide FeathersJS service name:</p>
<pre><code class="language-js">var fixtureStore = fixture.store([
  {_id: 1, title: 'One'},
  {_id: 2, title: 'Two'},
  {_id: 3, title: 'Three'}
...
<p>This will emulate FeathersJS server CRUD service.</p>
<p>Now from Feathers client app you can do:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture-socket/docs/can-fixture-socket.on-feathers-service.md"},"description":"\nSubscribes to mocked server socket events to work as FeathersJS CRUD service.\n","title":"onFeathersService","name":"can-fixture-socket.Server.prototype.onFeathersService","type":"function","parent":"can-fixture-socket.Server.prototype","signatures":[{"code":"server.onFeathersService(name, fixtureStore, [options])","description":"\n\nSubscribes to mocked server socket events according to FeathersJS protocol. Uses fixture store [can-fixture.Store] as a resource storage.\n\n```\nvar fixtureStore = fixture.store([\n  {id: 1, title: 'One'},\n  {id: 2, title: 'Two'},\n  {id: 3, title: 'Three'}\n], new canSet.Algebra({}));\n\nserver.onFeathersService(\"messages\", fixtureStore})\n```\n","params":[{"types":[{"type":"String"}],"name":"name","description":"The name of Feathers service."},{"types":[{"type":"can-fixture/StoreType"}],"name":"fixtureStore","description":"A fixture store. See [can-fixture.store] for more details."},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"options","description":"Options, e.g. property name for id.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"options","description":"Options, e.g. property name for id.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
