...
<!--####################################################################
	...
	@function can-dom-events.addEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addEvent</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-dom-events.addEvent.html">addEvent</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>addEvent</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-dom-events/edit/master/can-dom-events.js#L37">Edit on GitHub</a>
				</li>
    ...
    <p>Add a custom event to the global event registry.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>addEvent( event [, eventType ] )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{EventDefinition}</code>: <p>The custom event definition.</p>
</li>
        
          <li><b>eventType</b> <code>{String}</code>: <p>The event type to associated with the custom event.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>The callback to remove the custom event from the registry.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-dom-events.addEvent","parent":"can-dom-events.static","src":{"line":36,"codeLine":47,"path":"node_modules/can-dom-events/can-dom-events.js"},"description":"\nAdd a custom event to the global event registry.\n","title":"addEvent","signatures":[{"code":"addEvent( event [, eventType ] )","description":"","params":[{"types":[{"type":"EventDefinition"}],"name":"event","description":"The custom event definition."},{"types":[{"type":"String"}],"name":"eventType","description":"The event type to associated with the custom event."}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The callback to remove the custom event from the registry.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"eventType","description":"The event type to associated with the custom event."},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The callback to remove the custom event from the registry.\n"},"pathToRoot":".."};
</script>
</article>
