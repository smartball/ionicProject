...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-cid/can-cid.js
	@module can-cid
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-cid</title>
...
location.pathname; // -&gt; &quot;/user&quot;">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-cid/map/map.html"
							title="Exports the native Map
or a polyfill.">
							./map/
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-cid.html">can-cid</a></li>
	...
	<div class="page-type">
		<h1>can-cid</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-cid">
						<img src="https://img.shields.io/badge/npm%20package-1.1.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-cid" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-cid/edit/master/can-cid.js#L2">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get a unique identifier for the object, optionally prefixed by a type name.</p>
<p>Once set, the unique identifier does not change, even if the type name
changes on subsequent calls.</p>
...
console.log(cid(y));         // -&gt; &quot;2&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>object</b> <code>{Object}</code>: <p>The object to uniquely identify.</p>
</li>
        
          <li><b>name</b> <code>{String}</code>: <p>An optional type name with which to prefix the identifier</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>Returns the unique identifier</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-cid","type":"module","parent":"can-infrastructure","src":{"line":1,"codeLine":27,"path":"node_modules/can-cid/can-cid.js"},"description":"","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-cid/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"1.0.0"},"deprecated":false,"description":"Utility for getting a unique identifier for an object","devDependencies":{"documentjs":"^0.4.2","http-server":"^0.10.0","jshint":"^2.9.1","steal":"^1.2.8","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","test-saucelabs":"0.0.2","testee":"^0.3.1"},"homepage":"http://canjs.com","keywords":["canjs","canjs","plugin","donejs"],"main":"can-cid","name":"can-cid","repository":{"type":"git","url":"git://github.com/canjs/can-cid.git"},"scripts":{"build":"node build.js","ci":"npm run build && npm run test && node test-saucelabs.js","http-server":"http-server -p 3000 --silent","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"1.1.1"},"signatures":[{"code":"cid(object, optionalObjectType)","description":"\n\nGet a unique identifier for the object, optionally prefixed by a type name.\n\nOnce set, the unique identifier does not change, even if the type name\nchanges on subsequent calls.\n\n```js\nvar cid = require(\"can-cid\");\nvar x = {};\nvar y = {};\n\nconsole.log(cid(x, \"demo\")); // -> \"demo1\"\nconsole.log(cid(x, \"prod\")); // -> \"demo1\"\nconsole.log(cid(y));         // -> \"2\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"object","description":"The object to uniquely identify."},{"types":[{"type":"String"}],"name":"name","description":"An optional type name with which to prefix the identifier\n"}],"returns":{"types":[{"type":"String"}],"description":"Returns the unique identifier\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"name","description":"An optional type name with which to prefix the identifier\n"},"_curReturn":{"types":[{"type":"String"}],"description":"Returns the unique identifier\n"},"pathToRoot":".."};
</script>
</article>
