...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/can-symbol.js
	@function can-symbol.for
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - for</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-symbol.for.html">for</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>for</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/can-symbol.js#L28">Edit on GitHub</a>
				</li>
    ...
    <p>Get a symbol based on a known string identifier, or create it if it doesn't exist.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>description</b> <code>{String}</code>: <p>The string value of the symbol</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{CanSymbol}</code>: <p>The globally unique and consistent symbol with the given string value.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-symbol.for","parent":"can-symbol","src":{"line":27,"codeLine":37,"path":"node_modules/can-symbol/can-symbol.js"},"description":"Get a symbol based on a known string identifier, or create it if it doesn't exist. \n","title":"for","signatures":[{"code":"canSymbol.for(String)","description":"\n","params":[{"types":[{"type":"String"}],"name":"description","description":"The string value of the symbol"}],"returns":{"types":[{"type":"CanSymbol"}],"description":"The globally unique and consistent symbol with the given string value.\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"description","description":"The string value of the symbol"},"_curReturn":{"types":[{"type":"CanSymbol"}],"description":"The globally unique and consistent symbol with the given string value.\n "},"pathToRoot":".."};
</script>
</article>
