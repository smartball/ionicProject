...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/fixture.rand.md
	@function can-fixture.rand
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - rand</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture.rand.html">rand</a></li>
	...
	<div class="page-type">
		<h1>rand</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/fixture.rand.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns a random integer in the range [min, max]. If only one argument is provided,
returns a random integer from [0, max].</p>
<pre><code class="language-js">fixture.rand(1, 10) //-&gt; Random number between 1 and 10 inclusive.
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>min</b> <code>{Number}</code>: <p>The lower limit of values that will be returned.</p>
</li>
        
          <li><b>max</b> <code>{Number}</code>: <p>The upper limit of values that will be returned.  <code>max</code> is valid return value.</p>
</li>
...
<div class="signature">
  ...
  <p>An array of between min and max random items from choices. If only <code>min</code> is
provided, <code>max</code> will equal <code>min</code>.  If both <code>max</code> and <code>min</code> are not provided,
<code>min</code> will be 1 and <code>max</code> will be <code>choices.length</code>.</p>
<pre><code class="language-js">// pick a random number of items from an array
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>choices</b> <code>{Array}</code>: <p>An array of values to chose from. The returned array will only include a value once.</p>
</li>
        
          <li><b>min</b> <code>{Number}</code>: <p>The minimum number of items to be in the returned array.</p>
</li>
        
          <li><b>max</b> <code>{Number}</code>: <p>The maximum number of items in the returned array.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/fixture.rand.md"},"description":"\n","title":"rand","name":"can-fixture.rand","type":"function","parent":"can-fixture.properties","signatures":[{"code":"fixture.rand(min, max)","description":"\n\nReturns a random integer in the range [min, max]. If only one argument is provided,\nreturns a random integer from [0, max].\n\n```js\nfixture.rand(1, 10) //-> Random number between 1 and 10 inclusive.\nfixture.rand(10) //-> Random number between 0 and 10 inclusive.\n```","params":[{"types":[{"type":"Number"}],"optional":true,"name":"min","description":"The lower limit of values that will be returned."},{"types":[{"type":"Number"}],"name":"max","description":"The upper limit of values that will be returned.  `max` is valid return value.\n"}]},{"code":"fixture.rand(choices, min, max)","description":"\n\nAn array of between min and max random items from choices. If only `min` is\nprovided, `max` will equal `min`.  If both `max` and `min` are not provided,\n`min` will be 1 and `max` will be `choices.length`.\n\n```js\n// pick a random number of items from an array\nfixture.rand([\"a\",\"b\",\"c\"]) //-> [\"c\"]\nfixture.rand([\"a\",\"b\",\"c\"]) //-> [\"b\",\"a\"]\n\n// pick one item from an array\nfixture.rand([\"a\",\"b\",\"c\"],1) //-> [\"c\"]\n\n// get one item from an array\nfixture.rand([\"a\",\"b\",\"c\"],1)[0] //-> \"b\"\n\n// get 2 or 3 items from the array\nfixture.rand([\"a\",\"b\",\"c\"],2,3) //-> [\"c\",\"a\",\"b\"]\n```","params":[{"types":[{"type":"Array","options":[]}],"name":"choices","description":"An array of values to chose from. The returned array will only include a value once."},{"types":[{"type":"Number"}],"optional":true,"name":"min","description":"The minimum number of items to be in the returned array."},{"types":[{"type":"Number"}],"optional":true,"name":"max","description":"The maximum number of items in the returned array.\n"}]}],"_curParam":{"types":[{"type":"Number"}],"optional":true,"name":"max","description":"The maximum number of items in the returned array.\n"},"pathToRoot":".."};
</script>
</article>
