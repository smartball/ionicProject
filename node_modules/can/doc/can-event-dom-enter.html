...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event-dom-enter/can-event-dom-enter.js
	@module can-event-dom-enter
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-event-dom-enter</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-event-dom-enter.html">can-event-dom-enter</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-event-dom-enter</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-event-dom-enter">
						<img src="https://img.shields.io/badge/npm%20package-1.0.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-event-dom-enter" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-event-dom-enter/edit/master/can-event-dom-enter.js#L32">Edit on GitHub</a>
				</li>
    ...
    <p>Watch for when enter keys are pressed on a DomEventTarget.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-event-dom-enter","type":"module","parent":"can-infrastructure","src":{"line":31,"codeLine":56,"path":"node_modules/can-event-dom-enter/can-event-dom-enter.js"},"description":"\nWatch for when enter keys are pressed on a DomEventTarget.\n","title":"","types":[{"type":"events"}],"package":{"author":{"name":"Chris Andrejewski","email":"core@donejs.com","url":"https://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-event-dom-enter/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.1.0","can-dom-data-state":"^0.1.0","can-dom-events":"^1.0.2"},"deprecated":false,"description":"Custom enter event","devDependencies":{"fixpack":"^2.3.1","jshint":"^2.9.1","steal":"^1.3.1","steal-qunit":"^1.0.1","steal-tools":"^1.2.0","testee":"^0.6.0"},"homepage":"https://canjs.com/doc/can-event-dom-enter.html","keywords":["canjs","change","event","radio"],"license":"MIT","main":"can-event-dom-enter","name":"can-event-dom-enter","repository":{"type":"git","url":"git://github.com/canjs/can-event-dom-enter.git"},"scripts":{"build":"node build.js","install-canary":"npm install --no-shrinkwrap","install-locked":"npm install","jshint":"jshint ./*.js --config","lint":"fixpack && npm run jshint","preversion":"npm test && npm run build","test":"npm run lint && npm run testee","testee":"testee test.html --browsers firefox"},"steal":{"main":"can-event-dom-enter","npmIgnore":["testee","steal-tools"]},"version":"1.0.2"},"pathToRoot":".."};
</script>
</article>
