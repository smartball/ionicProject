...
<!--####################################################################
	...
	@function can-set.props.sort
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - sort</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.props.sort.html">sort</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>sort</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L304">Edit on GitHub</a>
				</li>
    ...
    <p>Defines the sortable property and behavior.</p>
...
<div class="signature">
  ...
  <p>Defines the sortable property and behavior.</p>
<pre><code class="language-js">var algebra = new set.Algebra(set.props.sort(&quot;sortBy&quot;));
algebra.index(
  {sortBy: &quot;name desc&quot;},
  [{name: &quot;Meyer&quot;}],
  {name: &quot;Adams&quot;}) //-&gt; 1
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prop</b> <code>{String}</code>: <p>The sortable property.</p>
</li>
        
          <li><b>sortFunc</b> <code>{function(sortPropValue, item1, item2)}</code>: <p>The
sortable behavior. The default behavior assumes the sort property value
looks like <code>PROPERTY DIRECTION</code> (ex: <code>name desc</code>).</p>
</li>
...
}">Compares</a>}</code>: <p>Returns a compares that can be used to create
a <code>set.Algebra</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.sort","parent":"can-set.props","src":{"line":303,"codeLine":333,"path":"node_modules/can-set/src/props.js"},"description":"Defines the sortable property and behavior. \n","title":"sort","signatures":[{"code":"set.props.sort(prop, [sortFunc])","description":"\n\nDefines the sortable property and behavior.\n\n```js\nvar algebra = new set.Algebra(set.props.sort(\"sortBy\"));\nalgebra.index(\n  {sortBy: \"name desc\"},\n  [{name: \"Meyer\"}],\n  {name: \"Adams\"}) //-> 1\n\nalgebra.index(\n  {sortBy: \"name\"},\n  [{name: \"Meyer\"}],\n  {name: \"Adams\"}) //-> 0\n```\n","params":[{"types":[{"type":"String"}],"name":"prop","description":"The sortable property."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"sortPropValue"}]},{"types":[{"type":"item1"}]},{"types":[{"type":"item2"}]}]}],"optional":true,"name":"sortFunc","description":"The\nsortable behavior. The default behavior assumes the sort property value\nlooks like `PROPERTY DIRECTION` (ex: `name desc`)."}],"returns":{"types":[{"type":"can-set.compares"}],"description":"Returns a compares that can be used to create\na `set.Algebra`.\n "}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"sortPropValue"}]},{"types":[{"type":"item1"}]},{"types":[{"type":"item2"}]}]}],"optional":true,"name":"sortFunc","description":"The\nsortable behavior. The default behavior assumes the sort property value\nlooks like `PROPERTY DIRECTION` (ex: `name desc`)."},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"Returns a compares that can be used to create\na `set.Algebra`.\n "},"pathToRoot":".."};
</script>
</article>
