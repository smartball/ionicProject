...
<!--####################################################################
	...
	@function can-view-nodelist.nestList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - nestList</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-nodelist.nestList.html">nestList</a></li>
	...
	<div class="page-type">
		<h1>nestList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L201">Edit on GitHub</a>
				</li>
...
references to other collections.">NodeList</a>}</code>: <p>The nodeList being nested.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.nestList","parent":"can-view-nodelist/methods","src":{"line":200,"codeLine":213,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"","title":"nestList","signatures":[{"code":"nodeLists.nestList(list)","description":"\n\nIf a given list does not exist in the nodeMap then create an lookup\nid for it in the nodeMap and assign the list to it.\nIf the the provided does happen to exist in the nodeMap update the\nelements in the list.\n","params":[{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"list","description":"The nodeList being nested.\n\n "}]}],"_curParam":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"list","description":"The nodeList being nested.\n\n "},"pathToRoot":".."};
</script>
</article>
