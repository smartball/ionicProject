...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/attrStart.md
	@function can-view-parser.ParseHandler.attrStart
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - attrStart</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.attrEnd.html"
							title="can-view-parser.ParseHandler.attrEnd">
							attrEnd
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-view-parser.ParseHandler.attrStart.html"
							title="can-view-parser.ParseHandler.attrStart">
							attrStart
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.attrValue.html"
							title="can-view-parser.ParseHandler.attrValue">
							attrValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.chars.html"
							title="can-view-parser.ParseHandler.chars">
							chars
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.close.html"
							title="can-view-parser.ParseHandler.close">
							close
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.comment.html"
							title="can-view-parser.ParseHandler.comment">
							comment
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.done.html"
							title="can-view-parser.ParseHandler.done">
							done
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.end.html"
							title="can-view-parser.ParseHandler.end">
							end
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-view-parser.ParseHandler.magicMatch.html"
							title="">
							magicMatch
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-view-parser.ParseHandler.magicStart.html"
							title="">
							magicStart
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-parser.ParseHandler.start.html"
							title="can-view-parser.ParseHandler.start">
							start
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-view-parser.ParseHandler.html">ParseHandler</a></li>
		<li> / </li>
	
	
	<li><a href="can-view-parser.ParseHandler.attrStart.html">attrStart</a></li>
	...
	<div class="page-type">
		<h1>attrStart</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/attrStart.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>attrStart(attrName, lineNo)</code>
  </h2>
  <p>Called when an attribute is found on an element.</p>
<p>Handles encoding of certain characthers using <a href="can-attribute-encoder.html" title="Encode and decode attribute names.">can-attribute-encoder</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>attrName</b> <code>{String}</code>: <p>The name of the attribute.</p>
</li>
        
          <li><b>lineNo</b> <code>{Number}</code>: <p>The line number of the opening tag (undefined in production).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/attrStart.md"},"description":"","title":"attrStart","name":"can-view-parser.ParseHandler.attrStart","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"attrStart(attrName, lineNo)","description":"\n\nCalled when an attribute is found on an element.\n\nHandles encoding of certain characthers using [can-attribute-encoder].\n","params":[{"types":[{"type":"String"}],"name":"attrName","description":"The name of the attribute."},{"types":[{"type":"Number"}],"name":"lineNo","description":"The line number of the opening tag (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lineNo","description":"The line number of the opening tag (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
