...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-live/lib/attr.js
...
<div class="breadcrumb">
	...
	<li><a href="can-view-live.attr.html">attr</a></li>
	...
	<div class="page-type">
		<h1>attr</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-live/edit/master/lib/attr.js#L4">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Keep an attribute live to a <a href="can-compute.html" title="Create an observable value.">can-compute</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>el</b> <code>{HTMLElement}</code>: <p>The element whos attribute will be kept live.</p>
</li>
        
          <li><b>attributeName</b> <code>{String}</code>: <p>The attribute name.</p>
</li>
        
          <li><b>compute</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>The compute.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-live.attr","parent":"can-view-live","src":{"line":3,"codeLine":22,"path":"node_modules/can-view-live/lib/attr.js"},"description":"\n","title":"attr","signatures":[{"code":"live.attr(el, attributeName, compute)","description":"\n\nKeep an attribute live to a [can-compute].\n\n```js\nvar div = document.createElement('div');\nvar compute = canCompute(\"foo bar\");\nlive.attr(div,\"class\", compute);\n```\n","params":[{"types":[{"type":"HTMLElement"}],"name":"el","description":"The element whos attribute will be kept live."},{"types":[{"type":"String"}],"name":"attributeName","description":"The attribute name."},{"types":[{"type":"can-compute"}],"name":"compute","description":"The compute.\n\n"}]}],"_curParam":{"types":[{"type":"can-compute"}],"name":"compute","description":"The compute.\n\n"},"pathToRoot":".."};
</script>
</article>
