...
<div class="breadcrumb">
	...
	<li><a href="can-route.param.html">param</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>param</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L355">Edit on GitHub</a>
				</li>
    ...
    <p>Get a route path from given data.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>object</b> <code>{data}</code>: <p>The data to populate the route with.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The route, with the data populated in it.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Parameterizes the raw JS object representation provided in data.</p>
<pre><code class="language-js">route.param({ type: &quot;video&quot;, id: 5 });
  // -&gt; &quot;type=video&amp;id=5&quot;
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.param","parent":"can-route.static","src":{"line":354,"codeLine":382,"path":"node_modules/can-route/can-route.js"},"description":"Get a route path from given data. ","title":"param","signatures":[{"code":"route.param(data)","description":"","params":[{"types":[{"type":"data"}],"name":"object","description":"The data to populate the route with."}],"returns":{"types":[{"type":"String"}],"description":"The route, with the data populated in it.\n"}}],"_curParam":{"types":[{"type":"data"}],"name":"object","description":"The data to populate the route with."},"_curReturn":{"types":[{"type":"String"}],"description":"The route, with the data populated in it.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
