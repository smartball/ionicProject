...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-cloneable/docs/can-connect-cloneable.md
	@module can-connect-cloneable
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-cloneable</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-cloneable.html">can-connect-cloneable</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-cloneable</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-cloneable">
						<img src="https://img.shields.io/badge/npm%20package-0.2.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-connect-cloneable" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-cloneable/edit/master/docs/can-connect-cloneable.md">Edit on GitHub</a>
				</li>
    ...
    <p>Makes mutable clones of <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a>’d maps. Changes to the clone save back to the original; likewise, changes to the original propagate to the clone.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makeCloneable(Type)</code>
  </h2>
  <p>Makes <code>Type</code> cloneable by giving its instances a <code>clone</code> method.</p>
<pre><code class="language-javascript">var DefineMap = require(&quot;can-define/map/map&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>Type</b> <code>{<a href="can-map.html" title="Create observable objects.">can-map</a>|<a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>}</code>: <p>The DefineMap or CanMap you want to make clonable</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-connect-cloneable</code> can be used with <code><a href="can-define/map/map.html" title="Create observable objects.">DefineMaps</a></code> or legacy <code><a href="can-map.html" title="Create observable objects.">CanMaps</a></code>. To make <code>Map</code> instances clonable, include <code>can-connect-cloneable</code> and call it with the <code>Map</code> constructor as the parameter. This adds a <code>clone</code> method to future instances of <code>Map</code>.</p>
<p>An instance and its clone have a special relationship:</p>
<ol>
<li>Changes to the original instance propogate automatically to the clone.</li>
<li>Changes to the cloned instance do <em>not</em> propogate to the original until you call the clone’s <code>save</code> method.</li>
</ol>
<h3>Using DefineMap (<code><a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a></code>)</h3>
<p>Apply the mixin:</p>
<pre><code class="language-javascript">var makeCloneable = require(&quot;can-connect-cloneable&quot;);
...
<p>Use the clone method:</p>
<pre><code class="language-javascript">var original = new MyDefineMap({ name: &quot;Kyle&quot; });
var clone = original.clone();
</code></pre>
<p>Make changes to the clone and save, updating the original:</p>
<pre><code class="language-javascript">// Change name on the clone instance
clone.name = &quot;Justin&quot;;
...
<p>Make changes to the original, updating the clone:</p>
<pre><code class="language-javascript">original.name; // -&gt; &quot;Justin&quot;
clone.name; // -&gt; &quot;Justin&quot;
...
<h3>Using CanMap (<code><a href="can-map.html" title="Create observable objects.">can-map</a></code>)</h3>
<p>Apply the mixin:</p>
<pre><code class="language-javascript">var makeCloneable = require(&quot;can-connect-cloneable&quot;);
...
<p>Use the clone method:</p>
<pre><code class="language-javascript">var original = new MyCanMap({ name: &quot;Kyle&quot; });
var clone = original.clone();
</code></pre>
<p>Make changes to the clone and save, updating the original:</p>
<pre><code class="language-javascript">// Change name on the clone instance
...
<p>Make changes to the original, updating the clone:</p>
<pre><code class="language-javascript">original.attr(&quot;name&quot;); // -&gt; &quot;Justin&quot;
clone.attr(&quot;name&quot;); // -&gt; &quot;Justin&quot;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-cloneable/docs/can-connect-cloneable.md"},"description":"Makes mutable clones of [can-connect]’d maps. Changes to the clone save back to the original; likewise, changes to the original propagate to the clone. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect-cloneable","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-connect-cloneable/issues"},"bundleDependencies":false,"dependencies":{"can-connect":"^1.5.0","can-util":"^3.9.0"},"deprecated":false,"description":"Allows you to make mutable clones of can-connected maps and save changes back to the original","devDependencies":{"can-define":"^1.2.0","can-fixture":"^1.1.0","can-list":"^3.1.0","can-map":"^3.1.0","can-map-define":"^3.1.0","done-serve":"^1.3.0","donejs-cli":"^1.0.1","jshint":"^2.9.1","steal":"^1.2.4","steal-qunit":"^1.0.0","steal-tools":"^1.1.2","testee":"^0.6.0"},"directories":{"doc":"docs","test":"test"},"homepage":"https://github.com/canjs/can-connect-cloneable","keywords":["clone","plugin","canjs"],"license":"MIT","main":"can-connect-cloneable","name":"can-connect-cloneable","repository":{"type":"git","url":"git://github.com/canjs/can-connect-cloneable.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"configDependencies":["live-reload"],"npmAlgorithm":"flat"},"version":"0.2.1"},"signatures":[{"code":"makeCloneable(Type)","description":"\n\nMakes `Type` cloneable by giving its instances a `clone` method.\n\n```javascript\nvar DefineMap = require(\"can-define/map/map\");\nvar makeCloneable = require(\"can-connect-cloneable\");\n\nvar MyDefineMap = DefineMap.extend({ name: \"string\" });\nmakeCloneable(MyDefineMap);\n\nvar original = new MyDefineMap({ name: \"Kyle\" });\nvar clone = original.clone();\nclone.name; // -> \"Kyle\"\n```\n","params":[{"types":[{"type":"can-map"},{"type":"can-define/map/map"}],"name":"Type","description":"The DefineMap or CanMap you want to make clonable\n\n"}]}],"_curParam":{"types":[{"type":"can-map"},{"type":"can-define/map/map"}],"name":"Type","description":"The DefineMap or CanMap you want to make clonable\n\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
