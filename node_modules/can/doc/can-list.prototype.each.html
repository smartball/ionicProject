...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/prototype.each.md
	@function can-list.prototype.each
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-list.prototype.each.html">each</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>each</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/prototype.each.md">Edit on GitHub</a>
				</li>
    ...
    <p>Call a function on each element of a List.</p>
...
<div class="signature">
  ...
  <p><code>each</code> iterates through the List, calling a function
for each element.</p>
<pre><code class="language-js">var list = new List([1, 2, 3]);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(*, Number)}</code>: <p>the function to call for each element
