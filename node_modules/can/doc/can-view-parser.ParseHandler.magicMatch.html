...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/magicMatch.md
	@property can-view-parser.ParseHandler.magicMatch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - magicMatch</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.magicMatch.html">magicMatch</a></li>
	...
	<div class="page-type">
		<h1>magicMatch</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/magicMatch.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A regular expression that matches from the start of the magic tag to the end of the
magic tag.  It should also have the first capture group match the content within the
magic tag.</p>
<pre><code class="language-js">parser(&quot; ... content ....&quot;, {
    ...
    magicStart: &quot;{&quot;,
    magicMatch:  /\{([^\}]*)\}/g
});
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/magicMatch.md"},"description":"\n","types":[{"type":"RegExp","description":"\n\nA regular expression that matches from the start of the magic tag to the end of the\nmagic tag.  It should also have the first capture group match the content within the\nmagic tag.  \n\n```js\nparser(\" ... content ....\", {\n\t...\n\tmagicStart: \"{\",\n\tmagicMatch:  /\\{([^\\}]*)\\}/g\n});\n```\n"}],"title":"magicMatch","name":"can-view-parser.ParseHandler.magicMatch","type":"property","parent":"can-view-parser.ParseHandler","pathToRoot":".."};
</script>
</article>
