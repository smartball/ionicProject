...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream-kefir/docs/types.DefineMap.prototype.md
	@typedef can-define-stream-kefir.types.DefineMap
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream-kefir.types.DefineMap.html">DefineMap.prototype</a></li>
	...
	<div class="page-type">
		<h1>DefineMap.prototype</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream-kefir/edit/master/docs/types.DefineMap.prototype.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Creates a DefineMap constructor</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream-kefir/docs/types.DefineMap.prototype.md"},"description":"A [can-define/map/map] constructor to add stream methods to. \n","type":"typedef","title":"DefineMap.prototype","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-stream-kefir.types.DefineMap","parent":"can-define-stream-kefir.types","signatures":[{"code":"new DefineMap({props})","description":"\n\nCreates a DefineMap constructor\n\n```js\nimport DefineMap from 'can-define/map/map';\n\nvar Person = DefineMap.extend({\n\tfirst: 'string',\n\tlast: 'string',\n\tfullName: {\n\t\tget() {\n\t\t\treturn this.first + \" \" + this.last;\n\t\t}\n\t}\n});\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
