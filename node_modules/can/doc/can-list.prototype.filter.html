...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/filter.md
	@function can-list.prototype.filter
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-list.prototype.filter.html">filter</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>filter</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/filter.md">Edit on GitHub</a>
				</li>
    ...
    <p>Filter the elements of a List, returning a new List instance with just filtered items.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>filterFunc</b> <code>{function(item, index, <a href="can.List.html" title="undefined">list</a>)}</code>: <p>A function to call with each element of the list. Returning <code>false</code> will remove the index.</p>
</li>
        
          <li><b>context</b> <code>{Object}</code>: <p>The object to use as <code>this</code> inside the callback.</p>
</li>
    ...
    <section class="body">
    <p>A filter function that accepts a function, which is run on every element of the list.  If the
filter callback returns true, the list returned will contain this item, false and it will not.</p>
<p>Returns a new List instance.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-list/docs/filter.md"},"description":"Filter the elements of a List, returning a new List instance with just filtered items. \n","title":"filter","name":"can-list.prototype.filter","type":"function","parent":"can-list.prototype","signatures":[{"code":"list.filter(filterFunc, context)","description":"\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"Boolean"}]},"params":[{"types":[{"type":"*"}],"name":"item"},{"types":[{"type":"Number"}],"name":"index"},{"types":[{"type":"can.List"}],"name":"list"}],"context":{"types":[{"type":"*"}]}}],"name":"filterFunc","description":"A function to call with each element of the list. Returning `false` will remove the index."},{"types":[{"type":"Object","options":[]}],"name":"context","description":"The object to use as `this` inside the callback.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"context","description":"The object to use as `this` inside the callback.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
