...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-simple-map/docs/prototype.get.md
	@function can-simple-map.prototype.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-simple-map.prototype.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-simple-map/edit/master/docs/prototype.get.md">Edit on GitHub</a>
				</li>
    ...
    <p>Get properties on a SimpleMap.</p>
...
<div class="signature">
  ...
  <p>Returns the data of this simple-map as a plain JavaScript object.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The data as a plain JavaScript object of this simple-map.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-simple-map/docs/prototype.get.md"},"description":"Get properties on a SimpleMap. \n","title":"get","name":"can-simple-map.prototype.get","type":"function","parent":"can-simple-map.prototype","signatures":[{"code":"map.get(key)","description":"\n\nReads a property from this `SimpleMap`.\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The property to read."}],"returns":{"types":[{"type":"*"}],"description":"The value assigned to _key_.\n\n"}},{"code":"map.get()","description":"\n\nReturns the data of this simple-map as a plain JavaScript object.\n\n","params":[],"returns":{"types":[{"type":"*"}],"description":"The data as a plain JavaScript object of this simple-map.\n"}}],"_curReturn":{"types":[{"type":"*"}],"description":"The data as a plain JavaScript object of this simple-map.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
