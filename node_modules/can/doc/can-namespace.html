...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-namespace/can-namespace.md
	@module can-namespace
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-namespace</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-namespace.html">can-namespace</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-namespace</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-namespace">
						<img src="https://img.shields.io/badge/npm%20package-1.0.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-namespace" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-namespace/edit/master/can-namespace.md">Edit on GitHub</a>
				</li>
    ...
    <p>Namespace where can-* packages are registered</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-namespace</code> exports an object that can be used to ensure only one version of a module is loaded in an app.</p>
<p>For example, if you have a module <code>can-unicorn</code> that you want to make sure is only loaded a single time, you can use <code>can-namespace</code>:</p>
...
<p>Any module requiring <code>can-namespace</code> will receive the same module because only one version of <code>can-namespace</code> will ever be published.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-namespace/can-namespace.md"},"description":"Namespace where can-* packages are registered \n","type":"module","title":"","types":[{"type":"object"}],"name":"can-namespace","parent":"can-infrastructure","release":"1.0","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-namespace/issues"},"bundleDependencies":false,"dependencies":{},"deprecated":false,"description":"Namespace where can-* packages are registered","devDependencies":{},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-namespace","name":"can-namespace","repository":{"type":"git","url":"git://github.com/canjs/can-namespace.git"},"scripts":{},"system":{"npmAlgorithm":"flat"},"version":"1.0.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
