...
<!--####################################################################
	...
	@function can-dom-events.removeEventListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-dom-events.removeEventListener.html">removeEventListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>removeEventListener</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-dom-events/edit/master/can-dom-events.js#L74">Edit on GitHub</a>
				</li>
    ...
    <p>Remove an event listener for eventType to the target.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>removeEventListener( target, eventType, ...eventArgs )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>The event type with which to unregister.</p>
</li>
        
          <li><b>eventArgs</b> <code>{*}</code>: <p>The arguments which configure the associated event's behavior.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-dom-events.removeEventListener","parent":"can-dom-events.static","src":{"line":73,"codeLine":84,"path":"node_modules/can-dom-events/can-dom-events.js"},"description":"\nRemove an event listener for eventType to the target.\n","title":"removeEventListener","signatures":[{"code":"removeEventListener( target, eventType, ...eventArgs )","description":"","params":[{"types":[{"type":"DomEventTarget"}],"name":"target","description":"The object to which to add the listener."},{"types":[{"type":"String"}],"name":"eventType","description":"The event type with which to unregister."},{"types":[{"type":"*"}],"name":"eventArgs","description":"The arguments which configure the associated event's behavior.\n"}]}],"_curParam":{"types":[{"type":"*"}],"name":"eventArgs","description":"The arguments which configure the associated event's behavior.\n"},"pathToRoot":".."};
</script>
</article>
