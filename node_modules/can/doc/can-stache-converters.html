...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/can-stache-converters.md
	...
	<div class="page-type">
		<h1>can-stache-converters</h1>
			<ul class="title-social">
				...
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-stache-converters" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/can-stache-converters.md">Edit on GitHub</a>
				</li>
...
<p>Add a binding with a converter to an input or select element and
the element's value will be cross-bound to an observable value specified by the binding attribute's value.</p>
<p>Depending on the element and the element's type, different behaviors to properly synchronize view model data
and element attributes.</p>
<h2>input type=text</h2>
<p><code>{($value)}=&quot;key&quot;</code> cross-binds the input's string text value with the observable value.</p>
<p>The value of the observable is changed after the input's <code>change</code> event,
which is after <code>blur</code>.</p>
<h2>input type=checkbox</h2>
<p><code>{($checked)}=&quot;key&quot;</code> cross-binds the checked property to a true or false value.</p>
<p><code>{($checked)}=&quot;boolean-to-inList(~key, list)&quot;</code> cross-binds the checked property to <code>key</code> being added to / removed from <code>list</code>.  The tilde (<code>~</code>) is important here because the compute it sets up acts as a channel between the element's property and the scope's property.</p>
<p><code>{($checked)}=&quot;either-or(~key, checkedval, uncheckedval)&quot;</code> cross-binds the checked property to <code>key</code>, but uses the <code>checkedval</code>
value to represent checked, and the <code>uncheckedval</code> value to represent unchecked.</p>
<h2>input type='radio'</h2>
<p><code>{($checked)}=&quot;key&quot;</code> cross-binds the checked property to <code>key</code> being true or false.</p>
<p><code>{($checked)}=&quot;equal(~key, value)&quot;</code> cross-binds the checked property to <code>key</code> having a value equal to <code>value</code>. This is useful for radio groups representing options for a single data property.</p>
<h2>select</h2>
<p><code>{($value)}=&quot;key&quot;</code> cross-binds the selected option value with an observable value.</p>
<p>For multiple-selection lists, <code>{($values)}=&quot;key&quot;</code> cross-binds selected options with membership in <code>key</code>, with the requirement that <code>key</code> on the scope is an array-like or a string.  If <code>key</code> is a string, it is treated as a comma-separated list of values.</p>
<h2>textarea</h2>
<p><code>{($value)}=&quot;key&quot;</code> cross-binds the textarea's string text value with the observable value.</p>
<p>The value of the observable is changed after the textarea's <code>change</code> event,
which is after <code>blur</code>.</p>
<blockquote>
<p>There is a way of making changes respond to key events as well: <code>($keyup)=&quot;%scope.set('key', %element.value)</code>.  However, this  sets the value of <code>key</code> at the current scope level.  If <code>key</code> was set at a higher level of the scope, the cross binding of <code>{($value)}</code> will not point to the same item as the keyup target.</p>
</blockquote>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/can-stache-converters.md"},"description":"\nProvides a set of [can-stache.registerConverter converters] useful for two-way binding with form elements such as `<input>` and `<select>`.\n","type":"module","title":"","name":"can-stache-converters","parent":"can-ecosystem","package":{"author":{"name":"DoneJS Contributors","email":"contact@bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-stache-converters/issues"},"bundleDependencies":false,"dependencies":{"can-stache":"^3.1.0","can-stache-bindings":"^3.2.0","can-util":"^3.9.0"},"deprecated":false,"description":"Common converters for Stache","devDependencies":{"bit-docs":"0.0.7","can-compute":"^3.1.0","can-define":"^1.2.0","can-event":"^3.5.0","documentjs":"^0.4.2","done-serve":"^1.2.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"https://github.com/canjs/can-stache-converters","keywords":["Done","JS","Can","JS"],"main":"can-stache-converters","name":"can-stache-converters","repository":{"type":"git","url":"git://github.com/canjs/can-stache-converters.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-stache-converters"},"version":"3.2.2"},"comment":" ","pathToRoot":".."};
</script>
</article>
