...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture-socket/docs/can-fixture.server.md
	@constructor can-fixture-socket.Server
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Server</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-fixture-socket.socket-event-listener.html"
							title="A listener handler that will be executed to handle the socket event.">
							SocketEventListener
						</a>
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="constructor"
							href="can-fixture-socket.Server.html"
							title="Intercept socket.io messages and simulates socket.io server responses.">
							Server
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.Server.prototype.emit.html"
							title="Emits a socket event.">
							emit
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.Server.prototype.on.html"
							title="Adds a socket event listener.">
							on
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.Server.prototype.onFeathersService.html"
							title="Subscribes to mocked server socket events to work as FeathersJS CRUD service.">
							onFeathersService
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.Server.prototype.restore.html"
							title="">
							restore
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.requestHandlerToListener.html"
							title="Transforms XHR request handler into socket event listener.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-fixture-socket.storeToListeners.html"
							title="Returns a set of listeners transformed from fixture store request handlers. Useful for working with REST-ful resources.">
							storeToListeners
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-fixture-socket.html">can-fixture-socket</a></li>
		<li> / </li>
	
	
	<li><a href="can-fixture-socket.Server.html">Server</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Server</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/docs/can-fixture.server.md">Edit on GitHub</a>
				</li>
    ...
    <p>Intercept socket.io messages and simulates socket.io server responses.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new Server( io )</code>
  </h2>
  <p>When server is instantiated with socket.io <code>io</code> object it intercepts a socket.io connection and allows to mock socket.io server behaviour. On instantiation we:</p>
<ul>
<li>empty <code>io.managers</code> object which is a cache of socket.io <code>io.Manager</code> instances;</li>
<li>override <code>io.Manager.prototype</code> to work with current instance of the mocked server.</li>
</ul>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>io</b> <code>{Object}</code>: <p>Imported <code>socket.io-client</code> object.</p>
</li>
    ...
    <h2>Use</h2>
<ol>
<li>Instantiate a server to intercept socket.io connection:</li>
</ol>
<pre><code class="language-js">var io = require(&quot;socket.io-client&quot;);
var fixtureSocket = require(&quot;can-fixture-socket&quot;);
var mockServer = new fixtureSocket.Server(io);
...
<ol start="2">
<li>Mock socket.io server behaviour:</li>
</ol>
<pre><code class="language-js">mockServer.on(&quot;connection&quot;, function(){
...
<ol start="3">
<li>Test your client app:</li>
</ol>
<pre><code class="language-js">var socket = io(&quot;http://localhost:8080/ws&quot;);
socket.emit(&quot;some event&quot;, &quot;some data&quot;, function(data){
  assert.equal(data, &quot;thanks&quot;, &quot;Server acknowledged our event&quot;);
});
</code></pre>
<h2>Examples</h2>
<h3>CRUD service with fixture store</h3>
<p>Lets see how we can test a possible implementation of a CRUD service that utilizes socket.io ACK callbacks. We will use fixture store to emulate our CRUD storage and link it to our mocked server.</p>
...
<p>Fixture store is designed to work with XHR requests, thus its methods take two arguments: <code>request</code> and <code>response</code>. See [can-fixture.Store.prototype.getListData] for more details. Our mocked server can listen to socket events and its event listener expects data and an optional ACK callback. To convert a request handler to an event listener we can use <a href="can-fixture-socket.requestHandlerToListener.html" title="Transforms XHR request handler into socket event listener.">requestHandlerToListener</a>:</p>
<p>Now we can create socket event listeners for our CRUD operations:</p>
<pre><code class="language-js">var toListener = fixtureSocket.requestHandlerToListener
...
<p>There is also a helper <a href="can-fixture-socket.storeToListeners.html" title="Returns a set of listeners transformed from fixture store request handlers. Useful for working with REST-ful resources.">storeToListeners</a> to create all listeners at once:</p>
<pre><code>var listeners = fixtureSocket.storeToListeners(messagesStore);
mockServer.on({
...
<p>Now lets implement a CRUD model on our client. We define that all our ACK callbacks take an error as the first argument, and data as the second one.</p>
<pre><code class="language-js">var socket = io(&quot;localhost&quot;);
...
<p>Now lets test the rest of the methods:</p>
<pre><code class="language-js">socket.emit(&quot;messages get&quot;, {id: 1}, function(err, data){s
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture-socket/docs/can-fixture.server.md"},"description":"\nIntercept socket.io messages and simulates socket.io server responses.\n","type":"constructor","name":"can-fixture-socket.Server","title":"Server","parent":"can-fixture-socket.properties","signatures":[{"code":"new Server( io )","description":"\n\nWhen server is instantiated with socket.io `io` object it intercepts a socket.io connection and allows to mock socket.io server behaviour. On instantiation we:\n  - empty `io.managers` object which is a cache of socket.io `io.Manager` instances;\n  - override `io.Manager.prototype` to work with current instance of the mocked server.\n  \n```js\nvar io = require(\"socket.io-client\");\nvar fixtureSocket = require(\"can-fixture-socket\");\nvar mockServer = new fixtureSocket.Server(io);\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"io","description":"Imported `socket.io-client` object.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"io","description":"Imported `socket.io-client` object.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
