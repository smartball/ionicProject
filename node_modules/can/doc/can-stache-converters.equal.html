...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/equal.md
	@function can-stache-converters.equal
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - equal</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="page"
							href="can-stache-converters.examples.input-checkbox.html"
					...
					<li class="
           						...
           						">
						<a class="page"
							href="can-stache-converters.examples.input-radio.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stache-converters.examples.select.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-stache-converters.examples.select-multiple.html"
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="A converter that two-way binds to a checkbox two values provided as arguments. This converter is useful when you have a binary decision between two fixed values.">
							either-or
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="A converter that binds to a &lt;select&gt; value in order to two-way bind a selected item from a list to the selected item&#x27;s index as a viewModel property.">
							index-to-selected
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.equal.html">equal</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>equal</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/equal.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that is usually for binding to a <code>&lt;input type=&quot;radio&quot;&gt;</code> group, so that a scope value can be set the radio group’s selected value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>equal(~compute, value)</code>
  </h2>
  <p>When the getter is called <strong>compute</strong>, a <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>, is compared to <strong>value</strong> and if they are equal, returns true.</p>
<p>When the setter is called, if the radio is now checked the <strong>compute</strong>'s setter is called with <strong>value</strong> as the value.</p>
<pre><code class="language-handlebars">&lt;input type=&quot;radio&quot; {($checked)}=&quot;equal(~color, 'red')&quot; /&gt; Red
&lt;input type=&quot;radio&quot; {($checked)}=&quot;equal(~color, 'blue')&quot; /&gt; Blue
</code></pre>
<p>In this example, the <code>color</code> scope value will be set to 'red' when the first radio is selected and 'blue' when the second radio is selected.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>compute</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute whose value will be compared to the second argument.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>A value of any type, that will be compared to the compute's internal value.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be two-way bound to the radio's checked property.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>equal(valueOne, valueTwo)</code>
  </h2>
  <p>When the getter is called the two values will be compared and if they are equal, returns true.</p>
<p>In this example there is only a one-way binding, parent to child, so there is no setter case.  This removes the requirement that the first argument is converted to a compute with <code>~</code>.</p>
<pre><code class="language-handlebars">&lt;my-modal {show}=&quot;equal(showModal, true)&quot; /&gt;
</code></pre>
<p>In this example, the <code>show</code> value of <code>my-modal</code>'s view model will be set to <code>true</code> when <code>showModal</code> in the scope is set to true.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>valueOne</b> <code>{*}</code>: <p>A value of any type, that will be compared to valueTwo.</p>
</li>
        
          <li><b>valueTwo</b> <code>{*}</code>: <p>A value of any type, that will be compared to valueOne.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be one-way bound to the <code>show</code> property.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>This <a href="can-stache-converters.html" title="Provides a set of converters useful for two-way binding with form elements such as &lt;input&gt; and &lt;select&gt;.">converter</a> will most often be used in conjunction with a radio input in order to bind a scope’s value (such as string, but could be any value) based on the selection of the radio group.</p>
<p>In this example we are using objects, to select a captain from one of three players:</p>
<pre><code class="language-handlebars">{{#each players}}
    &lt;input type=&quot;radio&quot; {($checked)}=&quot;equal(~captain, this)&quot; /&gt; {{name}}
{{/each}}
</code></pre>
<pre><code class="language-js">var template = stache.from(&quot;demo&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/equal.md"},"description":"A [can-stache.registerConverter converter] that is usually for binding to a `<input type=\"radio\">` group, so that a scope value can be set the radio group’s selected value. \n","title":"equal","name":"can-stache-converters.equal","type":"function","parent":"can-stache-converters.converters","signatures":[{"code":"equal(~compute, value)","description":"\n\nWhen the getter is called **compute**, a [can-compute.computed], is compared to **value** and if they are equal, returns true.\n\nWhen the setter is called, if the radio is now checked the **compute**'s setter is called with **value** as the value.\n\n```handlebars\n<input type=\"radio\" {($checked)}=\"equal(~color, 'red')\" /> Red\n<input type=\"radio\" {($checked)}=\"equal(~color, 'blue')\" /> Blue\n```\n\nIn this example, the `color` scope value will be set to 'red' when the first radio is selected and 'blue' when the second radio is selected.\n","params":[{"types":[{"type":"can-compute"}],"name":"compute","description":"A compute whose value will be compared to the second argument."},{"types":[{"type":"*"}],"name":"value","description":"A value of any type, that will be compared to the compute's internal value.\n"}],"returns":{"types":[{"type":"can-compute"}],"description":"A compute that will be two-way bound to the radio's checked property.\n"}},{"code":"equal(valueOne, valueTwo)","description":"\n\nWhen the getter is called the two values will be compared and if they are equal, returns true.\n\nIn this example there is only a one-way binding, parent to child, so there is no setter case.  This removes the requirement that the first argument is converted to a compute with `~`.\n\n```handlebars\n<my-modal {show}=\"equal(showModal, true)\" />\n```\n\nIn this example, the `show` value of `my-modal`'s view model will be set to `true` when `showModal` in the scope is set to true.\n","params":[{"types":[{"type":"*"}],"name":"valueOne","description":"A value of any type, that will be compared to valueTwo."},{"types":[{"type":"*"}],"name":"valueTwo","description":"A value of any type, that will be compared to valueOne.\n"}],"returns":{"types":[{"type":"can-compute"}],"description":"A compute that will be one-way bound to the `show` property.\n"}}],"_curReturn":{"types":[{"type":"can-compute"}],"description":"A compute that will be one-way bound to the `show` property.\n"},"_curParam":{"types":[{"type":"*"}],"name":"valueTwo","description":"A value of any type, that will be compared to valueOne.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
