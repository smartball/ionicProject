...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-ndjson/docs/ndjson.md
	@property can-connect-ndjson.ndjson
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ndjson</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-ndjson.ndjson.html">ndjson</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ndjson</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-ndjson/edit/master/docs/ndjson.md">Edit on GitHub</a>
				</li>
    ...
    <p>Specify the URL of an NDJSON service endpoint. If not specified or not supported in the browser, it falls back to the <code>url</code> endpoint.</p>
...
<div class="signature">
  ...
  <p>Below is an example of how to pass the <code>ndjson</code> option into your connection:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-ndjson/docs/ndjson.md"},"description":"Specify the URL of an NDJSON service endpoint. If not specified or not supported in the browser, it falls back to the `url` endpoint. \n\n","types":[{"type":"String","description":"\n\nBelow is an example of how to pass the `ndjson` option into your connection:\n\n```\nconnect(behaviors, {\n    url: \"/other/endpoint\", //fallback endpoint\n    ndjson: \"/api\" //NDJSON endpoint\n});\n```\n"}],"title":"ndjson","name":"can-connect-ndjson.ndjson","type":"property","parent":"can-connect-ndjson/options","pathToRoot":".."};
</script>
</article>
