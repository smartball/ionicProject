...
<div class="breadcrumb">
	...
	<li><a href="can-set.props.id.html">id</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>id</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L342">Edit on GitHub</a>
				</li>
    ...
    <p>Defines the identify property.</p>
...
<div class="signature">
  ...
  <p>Defines the property name on items that uniquely
identifies them. This is the default sorted property if no
<a href="can-set.props.sort.html" title="Defines the sortable property and behavior.">sort</a> is provided.</p>
<pre><code class="language-js">var algebra = new set.Algebra(set.props.id(&quot;_id&quot;));
algebra.index(
  {sortBy: &quot;name desc&quot;},
  [{name: &quot;Meyer&quot;}],
  {name: &quot;Adams&quot;}) //-&gt; 1
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prop</b> <code>{String}</code>: <p>The property name that defines the unique property id.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.id","parent":"can-set.props","src":{"line":341,"codeLine":370,"path":"node_modules/can-set/src/props.js"},"description":"Defines the identify property. \n","title":"id","signatures":[{"code":"set.props.id(prop)","description":"\n\nDefines the property name on items that uniquely\nidentifies them. This is the default sorted property if no\n[can-set.props.sort] is provided.\n\n```js\nvar algebra = new set.Algebra(set.props.id(\"_id\"));\nalgebra.index(\n  {sortBy: \"name desc\"},\n  [{name: \"Meyer\"}],\n  {name: \"Adams\"}) //-> 1\n\nalgebra.index(\n  {sortBy: \"name\"},\n  [{name: \"Meyer\"}],\n  {name: \"Adams\"}) //-> 0\n```\n","params":[{"types":[{"type":"String"}],"name":"prop","description":"The property name that defines the unique property id."}],"returns":{"types":[{"type":"can-set.compares"}],"description":"Returns a compares that can be used to create\na `set.Algebra`.\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"prop","description":"The property name that defines the unique property id."},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"Returns a compares that can be used to create\na `set.Algebra`.\n "},"pathToRoot":".."};
</script>
</article>
