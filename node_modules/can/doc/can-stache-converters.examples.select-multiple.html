...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/select-multiple.md
	@function can-stache-converters.examples.select-multiple
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - select[multiple]</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.examples.select-multiple.html">select[multiple]</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>select[multiple]</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/select-multiple.md">Edit on GitHub</a>
				</li>
    ...
    <p>Cross bind a value to a <code>&lt;select&gt;</code> element with multiple selections permitted.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;select multiple {($values)}=&quot;KEY&quot;/&gt;</code>
  </h2>
  <p>Cross binds the selected option values with an observable value.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>KEY</b> <code>{can.stache.key}</code>: <p>A named value in the current
scope. <code>KEY</code>’s value is cross bound with the selected <code>&lt;option&gt;</code> in
the <code>&lt;select&gt;</code>. <code>KEY</code>’s value should be an Array-like,
or <code>undefined</code>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Select elements with the multiple attribute (<code>&lt;select multiple {($values)}=&quot;KEY&quot;/&gt;</code>)
have a specified behavior if the value of KEY is Array-like or
<code>undefined</code>.</p>
<h2>Cross binding to Arrays</h2>
<p><code>&lt;select&gt;</code> tags with a multiple attribute cross bind
a <a href="can-map.html" title="Create observable objects.">can-map</a> property, <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> or <a href="can-list.html" title="">can-list</a>
in sync with the selected items of the <code>&lt;select&gt;</code> element.</p>
<p>For example, the following template:</p>
<pre><code>&lt;select multiple {($values)}=&quot;colors&quot;&gt;
  &lt;option value='red'&gt;Red&lt;/option&gt;
  &lt;option value='green'&gt;Green&lt;/option&gt;
  &lt;option value='yellow'&gt;Yellow&lt;/option&gt;
&lt;/select&gt;
</code></pre>
<p>Could be rendered with one of the following:</p>
<pre><code>// A can-map property
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/select-multiple.md"},"description":"\nCross bind a value to a `<select>` element with multiple selections permitted.\n","title":"select[multiple]","name":"can-stache-converters.examples.select-multiple","type":"function","parent":"can-stache-converters.examples","signatures":[{"code":"<select multiple {($values)}=\"KEY\"/>","description":"\n\nCross binds the selected option values with an observable value.\n","params":[{"types":[{"type":"can.stache.key"}],"name":"KEY","description":"A named value in the current \nscope. `KEY`’s value is cross bound with the selected `<option>` in\nthe `<select>`. `KEY`’s value should be an Array-like,\nor `undefined`.\n"}]}],"_curParam":{"types":[{"type":"can.stache.key"}],"name":"KEY","description":"A named value in the current \nscope. `KEY`’s value is cross bound with the selected `<option>` in\nthe `<select>`. `KEY`’s value should be an Array-like,\nor `undefined`.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
