...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-nodelist/can-view-nodelist.js
	@function can-view-nodelist.register
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - register</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-view-nodelist/types/NodeList.html"
							title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.first.html"
							title="can-view-nodelist.first">
							first
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.last.html"
							title="can-view-nodelist.last">
							last
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.nestList.html"
							title="can-view-nodelist.nestList">
							nestList
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.nestReplacements.html"
							title="can-view-nodelist.nestReplacements">
							nestReplacements
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-view-nodelist.register.html"
							title="">
							register
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.unregister.html"
							title="can-view-nodelist.unregister">
							unregister
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.unregisterChildren.html"
							title="can-view-nodelist.unregisterChildren">
							unregisterChildren
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-view-nodelist.update.html"
							title="">
							update
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-view-nodelist.html">can-view-nodelist</a></li>
		<li> / </li>
	
	
	<li><a href="can-view-nodelist.register.html">register</a></li>
	...
	<div class="page-type">
		<h1>register</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L295">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>nodeList</b> <code>{<a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">NodeList</a>}</code>: <p>A nodeList.</p>
</li>
        
          <li><b>unregistered</b> <code>{function}</code>: <p>A callback to call when the nodeList is unregistered.</p>
</li>
        
          <li><b>parent</b> <code>{<a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">NodeList</a>}</code>: <p>The parent nodeList of this nodeList.</p>
</li>
        
          <li><b>directlyNested</b> <code>{Boolean}</code>: <p><code>true</code> if nodes in the nodeList are direct children of the parent.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">NodeList</a>}</code>: <p>The passed in nodeList.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.register","parent":"can-view-nodelist/methods","src":{"line":294,"codeLine":309,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"\n","title":"register","signatures":[{"code":"nodeLists.register(nodeList, unregistered, parent, directlyNested)","description":"\n\nRegisters a nodeList and returns the nodeList passed to register.\n","params":[{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"nodeList","description":"A nodeList."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"unregistered","description":"A callback to call when the nodeList is unregistered."},{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"parent","description":"The parent nodeList of this nodeList."},{"types":[{"type":"Boolean"}],"name":"directlyNested","description":"`true` if nodes in the nodeList are direct children of the parent."}],"returns":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"description":"The passed in nodeList.\n\n "}}],"_curParam":{"types":[{"type":"Boolean"}],"name":"directlyNested","description":"`true` if nodes in the nodeList are direct children of the parent."},"_curReturn":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"description":"The passed in nodeList.\n\n "},"pathToRoot":".."};
</script>
</article>
