...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/comment.md
	@function can-view-parser.ParseHandler.comment
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - comment</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.comment.html">comment</a></li>
	...
	<div class="page-type">
		<h1>comment</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/comment.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>comment(value, lineNo)</code>
  </h2>
  <p>Called when a <a href="https://developer.mozilla.org/en-US/docs/Web/API/Comment">Comment</a> is found within a tag.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{String}</code>: <p>The Comment within the tag.</p>
</li>
        
          <li><b>lineNo</b> <code>{Number}</code>: <p>The starting line number of the comment (undefined in production).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/comment.md"},"description":"","title":"comment","name":"can-view-parser.ParseHandler.comment","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"comment(value, lineNo)","description":"\n\nCalled when a [Comment](https://developer.mozilla.org/en-US/docs/Web/API/Comment) is found within a tag.\n","params":[{"types":[{"type":"String"}],"name":"value","description":"The Comment within the tag."},{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the comment (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the comment (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
