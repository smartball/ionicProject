...
<head>
	<meta charset="utf-8">
	<title>CanJS - constructorExtends</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.constructorExtends.html">constructorExtends</a></li>
	...
	<div class="page-type">
		<h1>constructorExtends</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L140">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-construct.constructorExtends","type":"property","parent":"can-construct.static","src":{"line":139,"codeLine":206,"path":"node_modules/can-construct/can-construct.js"},"description":"  Toggles the behavior of a constructor function called\n without the `new` keyword to extend the constructor function or\n create a new instance.\n\n ```js\n var animal = Animal();\n // vs\n var animal = new Animal();\n ```\n\n","types":[{"type":"Boolean"}],"title":"constructorExtends","comment":" ","pathToRoot":".."};
</script>
</article>
