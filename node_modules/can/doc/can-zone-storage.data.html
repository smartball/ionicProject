...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.properties.data.md
	@property can-zone-storage.data
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.data.html">data</a></li>
	...
	<div class="page-type">
		<h1>data</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.properties.data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>The <code>data</code> property of <code>can-zone-storage</code> is a plain old JavaScript object.  It is used as the memory-based storage when window.CanZone is undefined (when the <a href="can-zone.html" title="A library that tracks asynchronous activity and lets you know when it has completed. Useful when you need to call a function and wait for all async behavior to complete, such as when performing server-side rendering.">can-zone</a> module hasn't been loaded).  If <code>window.CanZone</code> is found (when <a href="can-zone.html" title="A library that tracks asynchronous activity and lets you know when it has completed. Useful when you need to call a function and wait for all async behavior to complete, such as when performing server-side rendering.">can-zone</a> is used), the <code>CanZone.current.data</code> object is used, instead, for Zone-safe storage.</p>
