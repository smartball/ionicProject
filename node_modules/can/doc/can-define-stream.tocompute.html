...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/methods.toCompute.md
	@function can-define-stream.tocompute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.tocompute.html">toCompute</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toCompute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/methods.toCompute.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a compute that gets updated whenever the stream value changes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DefineMap.toCompute( stream )</code>
  </h2>
  <p>Creates a compute that gets updated whenever the stream value changes.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>stream</b> <code>{<a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a>}</code>: <p>A <a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a> stream</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A <a href="can-compute.html" title="Create an observable value.">can-compute</a> compute.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/methods.toCompute.md"},"description":"Create a compute that gets updated whenever the stream value changes. \n","title":"toCompute","name":"can-define-stream.tocompute","type":"function","parent":"can-define-stream.fns","signatures":[{"code":"DefineMap.toCompute( stream )","description":"\n\nCreates a compute that gets updated whenever the stream value changes.\n","params":[{"types":[{"type":"can-stream"}],"name":"stream","description":"A [can-stream] stream\n"}],"returns":{"types":[{"type":"can-compute"}],"description":"A [can-compute] compute.\n"}}],"_curParam":{"types":[{"type":"can-stream"}],"name":"stream","description":"A [can-stream] stream\n"},"_curReturn":{"types":[{"type":"can-compute"}],"description":"A [can-compute] compute.\n"},"pathToRoot":".."};
</script>
</article>
