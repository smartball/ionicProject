...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/input-checkbox.md
	@page can-stache-converters.examples.input-checkbox
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - input[type=checkbox]</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.examples.input-checkbox.html">input[type=checkbox]</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>input[type=checkbox]</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/input-checkbox.md">Edit on GitHub</a>
				</li>
    ...
    <p>Cross bind a value to a checkbox.</p>
...
<p>To bind to a checkbox and set a boolean value within your <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a>, set up a <a href="can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">two-way</a> binding to the input’s <code>checked</code> property like so:</p>
<pre><code>&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;val&quot; /&gt;
</code></pre>
<p><a href="can-stache-converters.html" title="Provides a set of converters useful for two-way binding with form elements such as &lt;input&gt; and &lt;select&gt;.">can-stache-converters</a> provides a couple of convenient converters that handle common use cases for binding to a checkbox.</p>
<h2>Binding based on whether an item is in a list</h2>
<p>Using <a href="can-stache-converters.boolean-to-inList.html" title="A converter that binds a boolean attribute, such as an &lt;input&gt; value, to whether or not an item is in a list.">boolean-to-inList</a> is useful to two-way bind to a checkbox based on whether an item is in a list or not. When the checkbox is checked/unchecked, the list will be updated and that item will either be removed or added to the list.</p>
<div class='demo_wrapper' data-demo-src='demos/can-stache-converters/input-checkbox.html'></div>
<h2>Binding based on a binary decision</h2>
<p>An alternative true and false value can be specified by using <a href="can-stache-converters.either-or.html" title="A converter that two-way binds to a checkbox two values provided as arguments. This converter is useful when you have a binary decision between two fixed values.">either-or</a>. This is used for setting up a “boolean” property that only has two possible valid values, whose values are modelled by the true/false checked property of a checkbox, as in the following example:</p>
<pre><code>&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;either-or(~val, 'a', 'b')&quot; /&gt;
</code></pre>
<p>In this case, the data passed in as <code>val</code> is a <a href="can-compute.html" title="Create an observable value.">can-compute</a> that contains either the value <strong>a</strong> or <strong>b</strong>. If the value of <code>val</code> is <strong>a</strong> then the checkbox will be checked. When the user checks/unchecks the checkbox then the value of <code>val</code> is set to be either <strong>a</strong> or <strong>b</strong> depending on whether it is checked.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/input-checkbox.md"},"description":"\nCross bind a value to a checkbox.\n","name":"can-stache-converters.examples.input-checkbox","title":"input[type=checkbox]","type":"page","parent":"can-stache-converters.examples","comment":" ","pathToRoot":".."};
</script>
</article>
