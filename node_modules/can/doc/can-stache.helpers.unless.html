...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/unless.md
	@function can-stache.helpers.unless
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#unless(expression)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.unless.html">{{#unless(expression)}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{#unless(expression)}}</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/unless.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#unless(EXPRESSION)}}FN{{else}}INVERSE{{/unless}}</code>
  </h2>
  <p>Renders <code>FN</code> if <code>EXPRESSION</code> is falsey or <code>INVERSE</code> if <code>EXPRESSION</code>
is truthy. Both <code>FN</code> and <code>INVERSE</code> will be rendered with the
current scope.</p>
<pre><code>{{#unless(person.isAwake())}} Shhhhh! {{/unless}}
</code></pre>
...
if <code>EXPRESSION</code> is truthy and <a href="can-stache.helpers.else.html" title="">{{else}}</a> is used.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>unless</code> helper evaluates the inverse of the value
