...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-backup/doc/prototype.restore.md
	@function can-map-backup/can-map.prototype.restore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.restore.html">restore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>restore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-backup/edit/master/doc/prototype.restore.md">Edit on GitHub</a>
				</li>
    ...
    <p>Restore saved values of an Observe's properties.</p>
...
will re-add properties that have been removed.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>deep</b> <code>{bool}</code>: <p>whether to restore properties in nested Observes</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../can-map.html" title="Create observable objects.">can-map</a>}</code>: <p>The Observe, for chaining.</p>
</p>
  </div>
...
<em>change</em>, <em>add</em>, and <em>set</em>) as if the values of the properties had been set using <a href="http://canjs.com/docs/can.Map.prototype.attr.html"><code>attr</code></a>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-backup/doc/prototype.restore.md"},"description":"Restore saved values of an Observe's properties. \n","title":"restore","name":"can-map-backup/can-map.prototype.restore","type":"function","parent":"can-map-backup/can-map.prototype","signatures":[{"code":"map.restore( [deep] )","description":"\n\n`restore` sets the properties of an Observe back to what they were the last time\n[can-map-backup.prototype.backup backup] was called. If _deep_ is `true`,\n`restore` will also restore the properties of nested Observes.\n\n`restore` will not remove properties that were added since the last backup, but it\nwill re-add properties that have been removed.\n","params":[{"types":[{"type":"bool"}],"optional":true,"name":"deep","defaultValue":"false","description":"whether to restore properties in nested Observes"}],"returns":{"types":[{"type":"can-map"}],"description":"The Observe, for chaining.\n"}}],"_curParam":{"types":[{"type":"bool"}],"optional":true,"name":"deep","defaultValue":"false","description":"whether to restore properties in nested Observes"},"_curReturn":{"types":[{"type":"can-map"}],"description":"The Observe, for chaining.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
