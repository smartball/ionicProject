...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-backup/doc/prototype.backup.md
	@function can-map-backup/can-map.prototype.backup
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - backup</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.backup.html">backup</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>backup</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-backup/edit/master/doc/prototype.backup.md">Edit on GitHub</a>
				</li>
    ...
    <p>Save the values of the properties of an Map.</p>
...
values can be restored with [can.Map.backup.prototype.restore restore].</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../can-map.html" title="Create observable objects.">can-map</a>}</code>: <p>The map, for chaining.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-backup/doc/prototype.backup.md"},"description":"Save the values of the properties of an Map. \n","title":"backup","name":"can-map-backup/can-map.prototype.backup","type":"function","parent":"can-map-backup/can-map.prototype","signatures":[{"code":"map.backup()","description":"\n\n`backup` backs up the current state of the properties of an Observe and marks\nthe Observe as clean. If any of the properties change value, the original\nvalues can be restored with [can.Map.backup.prototype.restore restore].\n","params":[],"returns":{"types":[{"type":"can-map"}],"description":"The map, for chaining.\n"}}],"_curReturn":{"types":[{"type":"can-map"}],"description":"The map, for chaining.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
