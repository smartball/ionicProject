...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-backup/doc/prototype.isDirty.md
	@function can-map-backup/can-map.prototype.isDirty
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isDirty</title>
...
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-map.prototype.backup.html"
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-map.prototype.isDirty.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-map.prototype.restore.html"
...
<div class="breadcrumb">
		...
		<li><a href="../can-map-backup.html">can-map-backup</a></li>
		<li> / </li>
	
	
	<li><a href="can-map.prototype.isDirty.html">isDirty</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isDirty</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-backup/edit/master/doc/prototype.isDirty.md">Edit on GitHub</a>
				</li>
    ...
    <p>Check whether an Observe has changed since the last time it was backed up.</p>
...
<code>isDirty</code> will include nested Observes in its checks.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>deep</b> <code>{bool}</code>: <p>whether to check nested Observes</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{bool}</code>: <p>Whether the Observe has changed since the last time it was [can.Map.backup.prototype.backup backed up].</p>
</p>
  </div>
    ...
    <section class="body">
    <pre><code>var CanMap = require('can-map');
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-backup/doc/prototype.isDirty.md"},"description":"Check whether an Observe has changed since the last time it was backed up. \n","title":"isDirty","name":"can-map-backup/can-map.prototype.isDirty","type":"function","parent":"can-map-backup/can-map.prototype","signatures":[{"code":"map.isDirty([deep])","description":"\n\n`isDirty` checks whether any properties have changed value or whether any properties have\nbeen added or removed since the last time the Observe was backed up. If _deep_ is `true`,\nIf the Observe has never been backed up, `isDirty` returns `undefined`.\n`isDirty` will include nested Observes in its checks.\n","params":[{"types":[{"type":"bool"}],"optional":true,"name":"deep","defaultValue":"false","description":"whether to check nested Observes"}],"returns":{"types":[{"type":"bool"}],"description":"Whether the Observe has changed since the last time it was [can.Map.backup.prototype.backup backed up].\n\n"}}],"_curParam":{"types":[{"type":"bool"}],"optional":true,"name":"deep","defaultValue":"false","description":"whether to check nested Observes"},"_curReturn":{"types":[{"type":"bool"}],"description":"Whether the Observe has changed since the last time it was [can.Map.backup.prototype.backup backed up].\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
