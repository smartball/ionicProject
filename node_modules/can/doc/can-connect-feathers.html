...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/can-connect-feathers.md
	@module can-connect-feathers
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-feathers</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-connect-feathers/service/service.html"
							title="">
							./service/
						</a>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-connect-feathers/session/session.html"
							title="">
							./session/
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-feathers.html">can-connect-feathers</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-feathers</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-feathers">
						<img src="https://img.shields.io/badge/npm%20package-3.7.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-connect-feathers" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/can-connect-feathers.md">Edit on GitHub</a>
				</li>
    ...
    <p>Integrate can-connect with the FeathersJS Client</p>
...
<div class="signature">
  ...
  <p><code>can-connect-feathers</code> is a set of behaviors for integrating <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> with <a href="https://docs.feathersjs.com/clients/feathers.html">Feathers Client</a>.</p>
<ul>
<li>The <a href="can-connect-feathers/service/service.html" title="">service</a> behavior connects to a Feathers service.</li>
<li>The <a href="can-connect-feathers/session/session.html" title="">session</a> behavior connects to the <a href="https://docs.feathersjs.com/authentication/client.html">feathers-authentication-client</a> methods on a Feathers Client instance.</li>
</ul>
    ...
    <section class="body">
    <p>Both of the included behaviors require a Feathers Client instance.  Here is a basic setup:</p>
<pre><code class="language-js">// models/feathers.js
...
<blockquote>
<p>Pro tip: If you are planning on using Done-SSR, exchange the <code>socket.io-client/dist/socket.io</code> module for <code>steal-socket.io</code> in the above example.</p>
</blockquote>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/can-connect-feathers.md"},"description":"Integrate can-connect with the FeathersJS Client \n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\n`can-connect-feathers` is a set of behaviors for integrating [can-connect] with [Feathers Client](https://docs.feathersjs.com/clients/feathers.html).\n\n - The [can-connect-feathers/service/service service] behavior connects to a Feathers service.\n - The [can-connect-feathers/session/session session] behavior connects to the [feathers-authentication-client](https://docs.feathersjs.com/authentication/client.html) methods on a Feathers Client instance.\n"}],"name":"can-connect-feathers","parent":"can-ecosystem","package":{"author":{"name":"Marshall Thompson","email":"marshall@creativeideal.net","url":"https://github.com/icanjs"},"bugs":{"url":"https://github.com/canjs/can-connect-feathers/issues"},"bundleDependencies":false,"dependencies":{"can-observation":"^3.2.0","can-util":"^3.9.0","can-zone-storage":"^1.0.0","feathers-authentication-popups":"^0.1.2","feathers-errors":"^2.7.0","jwt-decode":"^2.1.0"},"deprecated":false,"description":"Feathers client library for DoneJS and can-connect","devDependencies":{"async":"^2.1.5","babel-polyfill":"^6.23.0","can-connect":"^1.5.0","can-define":"^1.2.0","can-fixture":"^1.1.0","can-fixture-socket":"^0.7.0","can-set":"^1.3.0","concurrently":"^3.1.0","detect-cyclic-packages":"^1.1.0","done-serve":"^1.2.0","donejs-cli":"^1.0.1","feathers":"^2.0.3","feathers-authentication-client":"^0.3.2","feathers-hooks":"^2.0.1","feathers-rest":"^1.5.0","feathers-socketio":"^1.4.2","generator-donejs":"^1.0.5","http-server":"^0.10.0","jquery":"^3.1.0","jshint":"^2.9.4","saucelabs":"^1.4.0","socket.io-client":"^1.7.2","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-socket.io":"^4.0.8","steal-tools":"^1.0.1","test-saucelabs":"0.0.1","testee":"^0.5.0","wd":"^1.1.3"},"homepage":"https://github.com/canjs/can-connect-feathers","keywords":["canjs","can","plugin","donejs","feathersjs","feathers","client","realtime"],"main":"can-connect-feathers.js","name":"can-connect-feathers","repository":{"type":"git","url":"git://github.com/canjs/can-connect-feathers.git"},"scripts":{"build":"node build.js","ci":"node test/test-sauce-labs.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","http-server":"http-server -p 3000 --silent","install-server-deps":". ./build-server.sh","jshint":"jshint --config .jshintrc --exclude node_modules/,dist/,.vscode/,_docs/,test/server/ .","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:prerelease":"npm version prerelease && npm publish --tag pre","start":"node ./test/server/src/index.js","start-test":"node ./test/server/src/index.js --timeout","test":"npm run detect-cycle && npm run jshint && npm run testee","test-integration":"npm run jshint && npm run install-server-deps && concurrently 'npm run start-test' 'npm run testee-integration' ","testee":"testee test/test.html --browsers firefox","testee-integration":"testee test/test-integration.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.7.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
