...
<!--####################################################################
	...
	@function can-reflect.isSymbolLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isSymbolLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isSymbolLike.html">isSymbolLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isSymbolLike</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L353">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value is a symbol or a <a href="can-symbol.html" title="Symbols used to detail how CanJS may operate on different objects
CanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop
with external libraries.  CanJS uses symbols to identify object types, property access methods, and for event
handling.
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">can-symbol</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isSymbolLike(symbol)</code>
  </h2>
  <p>Return <code>true</code> if <code>symbol</code> is a native Symbol, or evaluates to a String with a prefix
equal to that of CanJS's symbol polyfill; <code>false</code> otherwise.</p>
<pre><code>/* ES6 *\/ canReflect.isSymbolLike(Symbol.iterator); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>symbol</b> <code>{*}</code>: <p>maybe a symbol</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect.isSymbolLike","type":"function","parent":"can-reflect/type","src":{"line":352,"codeLine":378,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value is a symbol or a [can-symbol]. \n","title":"isSymbolLike","signatures":[{"code":"isSymbolLike(symbol)","description":"\n\nReturn `true` if `symbol` is a native Symbol, or evaluates to a String with a prefix\nequal to that of CanJS's symbol polyfill; `false` otherwise.\n\n```\n/* ES6 *\\/ canReflect.isSymbolLike(Symbol.iterator); // -> true\ncanReflect.isSymbolLike(canSymbol.for(\"foo\")); // -> true\ncanReflect.isSymbolLike(\"@symbol.can.isSymbol\"); // -> true (due to polyfill for non-ES6)\ncanReflect.isSymbolLike(\"foo\"); // -> false\ncanReflect.isSymbolLike(null); // -> false\ncanReflect.isSymbolLike(1); // -> false\ncanReflect.isSymbolLike({}); // -> false\ncanReflect.isSymbolLike({ toString: function() { return \"@symbol.can.isSymbol\"; } }); // -> true\n```\n","params":[{"types":[{"type":"*"}],"name":"symbol","description":"maybe a symbol"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"symbol","description":"maybe a symbol"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
