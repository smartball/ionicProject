...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/createData.md
	@function can-connect-signalr/createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - createData</title>
...
<div class="breadcrumb">
	...
	<li><a href="createData.html">createData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/createData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Creates an instance on the server.  This is invoked on a new instance by calling [save].</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>createData(instanceData)</code>
  </h2>
  <p>Invokes the method specified by <a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.createName or
<a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.name+&quot;Create&quot; and expects the server to respond
with the created data and a [can-connect.id] property.</p>
...
<p>The following call to <code>.save()</code> invokes a <code>createTheMessage</code> method on the <code>MessageHub</code> hub with the message's serialized data:</p>
<pre><code class="language-js">new Message({
    name: &quot;Justin&quot;,
    message: &quot;Hello World&quot;
}).save()
...
<p>The server should respond with the message data plus it's <code>id</code>:</p>
...
<p>The following <code>signalR</code> connection configurations call their corresponding Hubs and methods:</p>
<pre><code>signalR: { name: 'MessageHub' } //-&gt; MessageHub.createMessageHub(message)
signalR: {
    name: 'MessageHub',
    createName: &quot;createIt&quot;
...
signalR: {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instanceData</b> <code>{Object}</code>: <p>The model to create.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to nothing.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Setup</h2>
<p>If your <code>SignalR</code> hub conforms to the required interface (see <a href="../can-connect-signalr.html" title="Connect to a Hub on a
SignalR server.">can-connect-signalr</a>), there is nothing you need to
do to configure this method on the client. If the method name of the <code>create</code> end point on your <code>SignalR</code> hub deviates from
the standard expected by <code>can-connect-signalr</code>, you can override <code>can-connect-signalr</code>'s default naming by providing
this property with the name expected by your <code>SignalR</code> hub.</p>
<pre><code class="language-js">    signalR: {
        url: 'http://test.com', // URL of the SignalR server
        name: 'MessageHub' // Name of the SignalR hub,
        createName: 'nameOfMethod'
    }
</code></pre>
<p>You can call this method directly off of a connection:</p>
<pre><code class="language-js">connection.createData(message);
</code></pre>
<h2>CanJS Usage</h2>
<p>If your connection is mixed in to a <code>DefineMap</code> (see <a href="../can-connect-signalr.html" title="Connect to a Hub on a
SignalR server.">can-connect-signalr</a>), <code>createData</code> can be called off of the
<code>DefineMap</code> constructor function. Note that <code>can-connect-signalr</code> requires the method signatures
defined on your hub to accept only one parameter. You can pass in multiple values by sending the method
an object:</p>
<pre><code class="language-js">// returns a promise that will be resolved once data is received by the Hub.
// Note: Data returned from the Hub will be received in the proxy listener.
new Message({
    text: 'Hi there!'
}).save();
</code></pre>
<p>While <code>createData</code> returns a <code>Promise</code>, that promise does not contain an instance of the created object. That
will be made available through the associated RPC listener, <code>createdData</code>. This listener takes care of updating
model instances or lists.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/createData.md"},"description":"Creates an instance on the server.  This is invoked on a new instance by calling [save]. \n","title":"createData","name":"can-connect-signalr/createData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"createData(instanceData)","description":"\n\nInvokes the method specified by [can-connect-signalr.signalR].createName or\n[can-connect-signalr.signalR].name+\"Create\" and expects the server to respond\nwith the created data and a [can-connect.id] property.\n\n```js\nconnect([\n  ...\n  require(\"can-connect-signalr\"),\n  ...\n], {\n  signalR: {\n    url: 'http://test.com', // URL of the SignalR server\n    name: 'MessageHub', // Name of the SignalR hub,\n    createName: 'createTheMessage'\n  },\n  Map: Message,\n  ...\n});\n\n```\n\nThe following call to `.save()` invokes a `createTheMessage` method on the `MessageHub` hub with the message's serialized data:\n\n```js\nnew Message({\n    name: \"Justin\",\n    message: \"Hello World\"\n}).save()\n// calls MesageHub.createTheMessage({\n//   name: \"Justin\",\n//   message: \"Hello World\"\n// })\n```\n\nThe server should respond with the message data plus it's `id`:\n\n```js\n{\n  \"id\": 1,\n  \"name\": \"Justin\",\n  \"message\": \"Hello World\"\n}\n```\n\nThe following `signalR` connection configurations call their corresponding Hubs and methods:\n\n```\nsignalR: { name: 'MessageHub' } //-> MessageHub.createMessageHub(message)\nsignalR: {\n    name: 'MessageHub',\n    createName: \"createIt\"\n} //-> MessageHub.createIt(message)\nsignalR: {\n    createName: \"createIt\"\n} //-> THROWS AN ERROR\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The model to create."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to nothing.\n\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The model to create."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to nothing.\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
