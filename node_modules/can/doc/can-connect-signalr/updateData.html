...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/updateData.md
	@function can-connect-signalr/updateData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - updateData</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>updateData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/updateData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Updates an instance on the server.  This is invoked on an existing instance by calling [save].</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>updateData(instanceData)</code>
  </h2>
  <p>Invokes the method specified by <a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.updateName or
<a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.name+&quot;Update&quot; and expects the server to respond
...
<p>The following call to <code>.save()</code> invokes an <code>updateTheMessage</code> method on the <code>MessageHub</code> hub with the message's serialized data:</p>
<pre><code class="language-js">message.name = 'Brian';
message.save();
// calls MesageHub.updateTheMessage({
//   name: &quot;Brian&quot;
// })
</code></pre>
<p>It's expected the server responds with the message:</p>
...
<pre><code>signalR: { name: 'MessageHub' } //-&gt; MessageHub.updateMessageHub(message)
signalR: {
    name: 'MessageHub',
    updateName: &quot;updateIt&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instanceData</b> <code>{object}</code>: <p>The model to update.</p>
</li>
...
do to configure this method on the client. If the method name of the <code>update</code> end point on your <code>SignalR</code> hub deviates from
...
<pre><code class="language-js">connection.updateData(message);
</code></pre>
<h2>CanJS Usage</h2>
...
SignalR server.">can-connect-signalr</a>), <code>updateData</code> can be called off of the
...
<p>While <code>updateData</code> returns a <code>Promise</code>, that promise does not contain an instance of the updated object. That
will be made available through the associated RPC listener, <code>updatedData</code>. This listener takes care of updating
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/updateData.md"},"description":"Updates an instance on the server.  This is invoked on an existing instance by calling [save]. \n","title":"updateData","name":"can-connect-signalr/updateData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"updateData(instanceData)","description":"\n\nInvokes the method specified by [can-connect-signalr.signalR].updateName or\n[can-connect-signalr.signalR].name+\"Update\" and expects the server to respond\nwith the updated data.\n\n```js\nconnect([\n  ...\n  require(\"can-connect-signalr\"),\n  ...\n], {\n  signalR: {\n    url: 'http://test.com', // URL of the SignalR server\n    name: 'MessageHub', // Name of the SignalR hub,\n    updateName: 'updateTheMessage'\n  },\n  Map: Message,\n  ...\n});\n\n```\n\nThe following call to `.save()` invokes an `updateTheMessage` method on the `MessageHub` hub with the message's serialized data:\n\n```js\nmessage.name = 'Brian';\nmessage.save();\n// calls MesageHub.updateTheMessage({\n//   name: \"Brian\"\n// })\n```\n\nIt's expected the server responds with the message:\n\n```js\n{\n  \"id\": 2,\n  \"name\": \"Brian\",\n  \"message\": \"Hello World\"\n}\n```\n\nThe following `signalR` connection configurations call their corresponding Hubs and methods:\n\n```\nsignalR: { name: 'MessageHub' } //-> MessageHub.updateMessageHub(message)\nsignalR: {\n    name: 'MessageHub',\n    updateName: \"updateIt\"\n} //-> MessageHub.updateIt(message)\nsignalR: {\n    updateName: \"updateIt\"\n} //-> THROWS AN ERROR\n```\n","params":[{"types":[{"type":"object"}],"name":"instanceData","description":"The model to update."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to nothing.\n\n"}}],"_curParam":{"types":[{"type":"object"}],"name":"instanceData","description":"The model to update."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to nothing.\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
