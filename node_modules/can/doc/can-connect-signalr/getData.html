...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/getData.md
	@function can-connect-signalr/getData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getData</title>
...
<div class="breadcrumb">
	...
	<li><a href="getData.html">getData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/getData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Gets an instance from the server. This is invoked on a constructor function by calling <a href="../getData.html" title="Get an instance">getData</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getData(id)</code>
  </h2>
  <p>Invokes the method specified by <a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.getData or
<a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.name+&quot;GetData&quot; and expects the server to respond
with the data.</p>
...
<p>The following call to <code>.getData()</code> invokes a <code>getTheMessage</code> method on the <code>MessageHub</code> hub with the provided unique message id:</p>
<pre><code class="language-js">Message.getData(1);
// calls MesageHub.getTheMessage(1)
</code></pre>
<p>It's expected that the server responds with the message:</p>
...
<pre><code>signalR: { name: 'MessageHub' } //-&gt; MessageHub.messageHubGetData(id)
signalR: {
    name: 'MessageHub',
    getData: &quot;getIt&quot;
} //-&gt; MessageHub.getIt(id)
signalR: {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>id</b> <code>{number}</code>: <p>A unique id.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to an instance.</p>
</p>
  </div>
...
do to configure this method on the client. If the method name of the <code>get</code> end point on your <code>SignalR</code> hub deviates from
...
<pre><code class="language-js">connection.getData(1);
</code></pre>
<h2>CanJS Usage</h2>
...
SignalR server.">can-connect-signalr</a>), <code>getData</code> can be called off of the
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/getData.md"},"description":"Gets an instance from the server. This is invoked on a constructor function by calling [getData]. \n","title":"getData","name":"can-connect-signalr/getData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"getData(id)","description":"\n\nInvokes the method specified by [can-connect-signalr.signalR].getData or\n[can-connect-signalr.signalR].name+\"GetData\" and expects the server to respond\nwith the data.\n\n```js\nconnect([\n  ...\n  require(\"can-connect-signalr\"),\n  ...\n], {\n  signalR: {\n    url: 'http://test.com', // URL of the SignalR server\n    name: 'MessageHub', // Name of the SignalR hub,\n    getData: 'getTheMessage'\n  },\n  Map: Message,\n  ...\n});\n\n```\n\nThe following call to `.getData()` invokes a `getTheMessage` method on the `MessageHub` hub with the provided unique message id:\n\n```js\nMessage.getData(1);\n// calls MesageHub.getTheMessage(1)\n```\n\nIt's expected that the server responds with the message:\n\n```js\n{\n  \"id\": 1,\n  \"name\": \"Justin\",\n  \"message\": \"Hello World\"\n}\n```\n\nThe following `signalR` connection configurations call their corresponding Hubs and methods:\n\n```\nsignalR: { name: 'MessageHub' } //-> MessageHub.messageHubGetData(id)\nsignalR: {\n    name: 'MessageHub',\n    getData: \"getIt\"\n} //-> MessageHub.getIt(id)\nsignalR: {\n    getData: \"getIt\"\n} //-> BREAKS\n```\n","params":[{"types":[{"type":"number"}],"name":"id","description":"A unique id."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to an instance.\n\n"}}],"_curParam":{"types":[{"type":"number"}],"name":"id","description":"A unique id."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to an instance.\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
