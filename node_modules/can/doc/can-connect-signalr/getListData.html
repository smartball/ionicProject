...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/getListData.md
	@function can-connect-signalr/getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="getListData.html">getListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/getListData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Gets an list of data from the server. This is invoked on a constructor function by calling <a href="../getListData.html" title="Transforms getListData from fixture to feathers format.">getListData</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getListData(queryParameters)</code>
  </h2>
  <p>Invokes the method specified by <a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.getListData or
<a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.name+&quot;GetListData&quot; and expects the server to respond
with the data.</p>
...
<p>The following call to <code>.getListData()</code> invokes a <code>getListOfMessages</code> method on the <code>MessageHub</code> hub with the provided parameters:</p>
<pre><code class="language-js">Message.getListData({
  name: 'Johnson'
});
...
<p>It's expected that the server responds with the message list:</p>
...
<pre><code>signalR: { name: 'MessageHub' } //-&gt; MessageHub.messageHubGetListData(queryParameters)
signalR: {
    name: 'MessageHub',
    getListData: &quot;getThem&quot;
...
signalR: {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>queryParameters</b> <code>{Object}</code>: <p>The query parameters.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to a list.</p>
</p>
  </div>
...
do to configure this method on the client. If the method name of the <code>getList</code> end point on your <code>SignalR</code> hub deviates from
...
<pre><code class="language-js">connection.getListData(queryParameters);
</code></pre>
<h2>CanJS Usage</h2>
...
SignalR server.">can-connect-signalr</a>), <code>getListData</code> can be called off of the
...
an object:</p>
<pre><code class="language-js">Message.getListData(queryParameters);
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/getListData.md"},"description":"Gets an list of data from the server. This is invoked on a constructor function by calling [getListData]. \n","title":"getListData","name":"can-connect-signalr/getListData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"getListData(queryParameters)","description":"\n\nInvokes the method specified by [can-connect-signalr.signalR].getListData or\n[can-connect-signalr.signalR].name+\"GetListData\" and expects the server to respond\nwith the data.\n\n```js\nconnect([\n  ...\n  require(\"can-connect-signalr\"),\n  ...\n], {\n  signalR: {\n    url: 'http://test.com', // URL of the SignalR server\n    name: 'MessageHub', // Name of the SignalR hub,\n    getListData: 'getMessages'\n  },\n  Map: Message,\n  ...\n});\n\n```\n\nThe following call to `.getListData()` invokes a `getListOfMessages` method on the `MessageHub` hub with the provided parameters:\n\n```js\nMessage.getListData({\n  name: 'Johnson'\n});\n// calls MesageHub.getListOfMessages({\n//   name: 'Johnson'\n// })\n```\n\nIt's expected that the server responds with the message list:\n\n```js\n[\n {\n   \"id\": 1,\n   \"name\": \"Johnson\",\n   \"message\": \"Hello World\"\n },\n {\n   \"id\": 2,\n   \"name\": \"Johnson\",\n   \"message\": \"Hello again World\"\n }\n]\n```\n\nThe following `signalR` connection configurations call their corresponding Hubs and methods:\n\n```\nsignalR: { name: 'MessageHub' } //-> MessageHub.messageHubGetListData(queryParameters)\nsignalR: {\n    name: 'MessageHub',\n    getListData: \"getThem\"\n} //-> MessageHub.getThem(queryParameters)\nsignalR: {\n    getListData: \"getThem\"\n} //-> THROWS ERROR\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"queryParameters","description":"The query parameters."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to a list.\n\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"queryParameters","description":"The query parameters."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to a list.\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
