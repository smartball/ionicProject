...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/destroyData.md
	@function can-connect-signalr/destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - destroyData</title>
...
<div class="breadcrumb">
	...
	<li><a href="destroyData.html">destroyData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/destroyData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Destroys an instance on the server.  This is invoked on an instance by calling [destroy].</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>destroyData(instanceData)</code>
  </h2>
  <p>Invokes the method specified by <a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.destroyName or
<a href="../can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a>.name+&quot;Destroy&quot;.</p>
...
<p>The following call to <code>.destroy()</code> invokes a <code>destroyTheMessage</code> method on the <code>MessageHub</code> hub with the message model:</p>
...
<pre><code>signalR: { name: 'MessageHub' } //-&gt; MessageHub.messageHubDestroy(message)
signalR: {
    name: 'MessageHub',
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instanceData</b> <code>{Object}</code>: <p>The model to delete.</p>
</li>
...
do to configure this method on the client. If the method name of the <code>destroy</code> end point on your <code>SignalR</code> hub deviates from
...
<pre><code class="language-js">connection.destroyData(message);
</code></pre>
<h2>CanJS Usage</h2>
...
SignalR server.">can-connect-signalr</a>), <code>destroyData</code> can be called off of the
...
<p>The <code>messageDestroyed</code> method takes care of updating model instances or lists on connected clients.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/destroyData.md"},"description":"Destroys an instance on the server.  This is invoked on an instance by calling [destroy]. \n\n\n","title":"destroyData","name":"can-connect-signalr/destroyData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"destroyData(instanceData)","description":"\n\nInvokes the method specified by [can-connect-signalr.signalR].destroyName or\n[can-connect-signalr.signalR].name+\"Destroy\".\n\n```js\nconnect([\n  ...\n  require(\"can-connect-signalr\"),\n  ...\n], {\n  signalR: {\n    url: 'http://test.com', // URL of the SignalR server\n    name: 'MessageHub', // Name of the SignalR hub,\n    destroyName: 'destroyTheMessage'\n  },\n  Map: Message,\n  ...\n});\n\n```\n\nThe following call to `.destroy()` invokes a `destroyTheMessage` method on the `MessageHub` hub with the message model:\n\n```js\nmessage.destroy();\n// calls MesageHub.destroyTheMessage(message)\n```\n\nThe following `signalR` connection configurations call their corresponding Hubs and methods:\n\n```\nsignalR: { name: 'MessageHub' } //-> MessageHub.messageHubDestroy(message)\nsignalR: {\n    name: 'MessageHub',\n    destroyName: \"destroyIt\"\n} //-> MessageHub.destroyIt(message)\nsignalR: {\n    destroyName: \"destroyIt\"\n} //-> THROWS AN ERROR\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The model to delete."}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The model to delete."},"comment":" ","pathToRoot":"../.."};
</script>
</article>
