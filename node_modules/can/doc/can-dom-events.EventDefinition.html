...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@typedef can-dom-events.EventDefinition
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - EventDefinition</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-dom-events.EventDefinition.html">EventDefinition</a></li>
  ...
  <section class="title">
    ...
    <p>Definition of a custom event that may be added to an event registry.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>defaultEventType</b> <code>{String}</code>:
        <p>The default event type of the event.</p>

      </li>
    
      <li>
        <b>addEventListener</b> <code>{function(target, eventType, eventArgs)}</code>:
        <p>The function to add the listener to the target.</p>

      </li>
    
      <li>
        <b>removeEventListener</b> <code>{function(target, eventType, eventArgs)}</code>:
        <p>The function to remove the listener from the target.</p>
...
<script type="text/javascript">
  window.docObject = {"description":"Definition of a custom event that may be added to an event registry. ","type":"typedef","title":"EventDefinition","types":[{"type":"Object","options":[{"name":"defaultEventType","description":"\nThe default event type of the event.\n","types":[{"type":"String"}],"optional":true},{"name":"addEventListener","description":"\nThe function to add the listener to the target.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"DomEventTarget"}],"name":"target","description":"The target to which to add the listener."},{"types":[{"type":"String"}],"name":"eventType","description":"The event type which should be used to register the listener."},{"types":[{"type":"*"}],"name":"eventArgs","description":"The arguments should to configure the listener behavior.\n"}]}],"optional":true},{"name":"removeEventListener","description":"\nThe function to remove the listener from the target.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"DomEventTarget"}],"name":"target","description":"The target to which to add the listener."},{"types":[{"type":"String"}],"name":"eventType","description":"The event type which should be used to register the listener."},{"types":[{"type":"*"}],"name":"eventArgs","description":"The arguments should to configure the listener behavior.\n"}]}],"optional":true}],"description":""}],"name":"can-dom-events.EventDefinition","parent":"can-dom-events.types","pathToRoot":".."};
</script>
</article>
