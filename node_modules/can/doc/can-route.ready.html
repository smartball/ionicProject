...
<div class="breadcrumb">
	...
	<li><a href="can-route.ready.html">ready</a></li>
	...
	<div class="page-type">
		<h1>ready</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L582">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Sets up the two-way binding between the hash and the can-route observable
map and sets the route map to its initial values.</p>
...
route.data.page; // -&gt; &quot;home&quot;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a>(template, defaults)}</code>: <p>The can-route object.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>After setting all your routes, call <code>route.ready()</code>.</p>
<pre><code class="language-js">route(&quot;overview/{dateStart}-{dateEnd}&quot;);
route(&quot;{type}/{id}&quot;);
route.ready();
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.ready","parent":"can-route.static","src":{"line":581,"codeLine":613,"path":"node_modules/can-route/can-route.js"},"description":"\nInitializes can-route.\n","title":"ready","signatures":[{"code":"route.ready()","description":"\n\nSets up the two-way binding between the hash and the can-route observable\nmap and sets the route map to its initial values.\n\n```js\nroute(\"{page}\", { page: \"home\" }));\n\nroute.ready();\nroute.data.page; // -> \"home\"\n```\n","params":[],"returns":{"types":[{"type":"can-route"}],"description":"The can-route object.\n"}}],"_curReturn":{"types":[{"type":"can-route"}],"description":"The can-route object.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
