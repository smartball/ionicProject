...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/fixture.delay.md
	@property can-fixture.delay
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - delay</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture.delay.html">delay</a></li>
	...
	<div class="page-type">
		<h1>delay</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/fixture.delay.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Sets the delay until a response is fired in milliseconds.</p>
<pre><code class="language-js">fixture.delay = 1000; // 1 second delay
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/fixture.delay.md"},"description":"","types":[{"type":"Number"}],"title":"delay","name":"can-fixture.delay","type":"property","parent":"can-fixture.properties","signatures":[{"code":"fixture.delay","description":"\n\nSets the delay until a response is fired in milliseconds.\n\n```js\nfixture.delay = 1000; // 1 second delay\n```\n","params":[]}],"pathToRoot":".."};
</script>
</article>
