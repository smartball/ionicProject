...
<div class="breadcrumb">
	...
	<li><a href="getKeyValue.html">getKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/can-globals-proto.js#L89">Edit on GitHub</a>
				</li>
    ...
    <p>Get a global environment variable by name.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>globals.getKeyValue(key)</code>
  </h2>
  <p>Returns the current value at <code>key</code>. If no value has been set, it will return the default value (if it is not a function). If the default value is a function, it will return the output of the function. This execution is cached if the cache flag was set on initialization.</p>
...
globals.getKeyValue('foo'); //-&gt; 'bar'
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>Returns the value of a given key.</p>
</p>
  </div>
