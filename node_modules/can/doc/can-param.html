...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-param/can-param.md
	@module can-param
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-param</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-param.html">can-param</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-param</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-param/edit/master/can-param.md">Edit on GitHub</a>
				</li>
    ...
    <p>Serialize an object or array into a query string.</p>
...
<div class="signature">
  ...
  <p>Serializes an object or array into a query string useful for making Ajax requests. <code>param</code> handles nested objects and arrays.  It uses <code>encodeURIComponent</code> to
escape values and keys.</p>
<pre><code class="language-js">var param = require(&quot;can-param&quot;);
...
<p>This is exported as <code>param</code> on <a href="can-namespace.html" title="Namespace where can-* packages are registered">can-namespace</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>object</b> <code>{Object}</code>: <p>An object or array.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The params formatted into a form-encoded string.</p>
</p>
  </div>
