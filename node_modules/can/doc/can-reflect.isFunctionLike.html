...
<!--####################################################################
	...
	@function can-reflect.isFunctionLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isFunctionLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isFunctionLike.html">isFunctionLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isFunctionLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L67">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value looks like a function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isFunctionLike(obj)</code>
  </h2>
  <p>Return <code>true</code> if <code>func</code> is a function, or implements
<a href="can-symbol/symbols/new.html" title="Create a new instance of a constructor function or prototype object."><code>@@can.new</code></a> or <a href="can-symbol/symbols/apply.html" title="How to apply a List-like as the arguments to a call of the function."><code>@@can.apply</code></a>; <code>false</code> otherwise.</p>
<pre><code>canReflect.isFunctionLike(function() {}); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>maybe a function</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect.isFunctionLike","type":"function","parent":"can-reflect/type","src":{"line":66,"codeLine":84,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value looks like a function. ","title":"isFunctionLike","signatures":[{"code":"isFunctionLike(obj)","description":"\n\n Return `true` if `func` is a function, or implements\n [can-symbol/symbols/new `@@can.new`] or [can-symbol/symbols/apply `@@can.apply`]; `false` otherwise.\n\n```\ncanReflect.isFunctionLike(function() {}); // -> true\ncanReflect.isFunctionLike({}); // -> false\ncanReflect.isFunctionLike({ [canSymbol.for(\"can.apply\")]: function() {} }); // -> true\n```\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"maybe a function"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"obj","description":"maybe a function"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
