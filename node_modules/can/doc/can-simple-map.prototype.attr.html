...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-simple-map/docs/prototype.attr.md
	@function can-simple-map.prototype.attr
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-simple-map.prototype.attr.html">attr</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>attr</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-simple-map/edit/master/docs/prototype.attr.md">Edit on GitHub</a>
				</li>
    ...
    <p>Get or set properties on a SimpleMap.</p>
...
<div class="signature">
  ...
  <p>Reads a property from this <code>SimpleMap</code>.</p>
...
<div class="signature">
  ...
  <p>Assigns <em>value</em> to a property on this <code>SimpleMap</code> called <em>key</em>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{*}</code>: <p>The value to assign to <em>key</em>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can.SimpleMap}</code>: <p>This SimpleMap, for chaining.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.attr(obj)</code>
  </h2>
  <p>Assigns each value in <em>obj</em> to a property on this <code>SimpleMap</code> named after the
corresponding key in <em>obj</em>, effectively merging <em>obj</em> into the SimpleMap.</p>
...
If any properties already exist on the <code>SimpleMap</code>, they will be overwritten.</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>attr</code> gets or sets properties on the <code>SimpleMap</code> it's called on. Here's a tour through how all of its forms work:</p>
...
<p>When properties are changed using attr, the <code>SimpleMap</code> will emit events. Events can be listened to using <a href="can-event.on.html" title="can-event.on">on</a> or <a href="can-event.bind.html" title="can-event.bind">bind</a>.</p>
<pre><code>var map = new SimpleMap({ age: 29 });
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-simple-map/docs/prototype.attr.md"},"description":"Get or set properties on a SimpleMap. \n","title":"attr","name":"can-simple-map.prototype.attr","type":"function","parent":"can-simple-map.prototype","signatures":[{"code":"map.attr(key)","description":"\n\nReads a property from this `SimpleMap`.\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The property to read."}],"returns":{"types":[{"type":"*"}],"description":"The value assigned to _key_.\n"}},{"code":"map.attr(key, value)","description":"\n\nAssigns _value_ to a property on this `SimpleMap` called _key_.\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The property to set."},{"types":[{"type":"*"}],"name":"value","description":"The value to assign to _key_."}],"returns":{"types":[{"type":"can.SimpleMap"}],"description":"This SimpleMap, for chaining.\n"}},{"code":"map.attr(obj)","description":"\n\nAssigns each value in _obj_ to a property on this `SimpleMap` named after the\ncorresponding key in _obj_, effectively merging _obj_ into the SimpleMap.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"A collection of key-value pairs to set.\nIf any properties already exist on the `SimpleMap`, they will be overwritten.\n"}],"returns":{"types":[{"type":"can.SimpleMap"}],"description":"this SimpleMap, for chaining\n"}}],"_curReturn":{"types":[{"type":"can.SimpleMap"}],"description":"this SimpleMap, for chaining\n"},"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"A collection of key-value pairs to set.\nIf any properties already exist on the `SimpleMap`, they will be overwritten.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
