...
<!--####################################################################
	...
	@function can-reflect.isPlainObject
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isPlainObject</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isPlainObject.html">isPlainObject</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isPlainObject</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L510">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value is an object created with <code>{}</code> or <code>new Object()</code>.</p>
...
<pre><code class="language-js">var isPlainObject = require(&quot;can-reflect&quot;).isPlainObject;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to test.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect.isPlainObject","type":"function","parent":"can-reflect/type","src":{"line":509,"codeLine":542,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value is an object created with `{}` or `new Object()`. \n","title":"isPlainObject","signatures":[{"code":"isPlainObject(obj)","description":"\n\nAttempts to determine if an object is a plain object like those you would create using the curly braces syntax: `{}`. The following are not plain objects:\n\n1. Objects with prototypes (created using the `new` keyword).\n2. Booleans.\n3. Numbers.\n4. NaN.\n\n```js\nvar isPlainObject = require(\"can-reflect\").isPlainObject;\n\n// Created with {}\nconsole.log(isPlainObject({})); // -> true\n\n// new Object\nconsole.log(isPlainObject(new Object())); // -> true\n\n// Custom object\nvar Ctr = function(){};\nvar obj = new Ctr();\n\nconsole.log(isPlainObject(obj)); // -> false\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test."}],"returns":{"types":[{"type":"Boolean"}],"description":"\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n "},"pathToRoot":".."};
</script>
</article>
