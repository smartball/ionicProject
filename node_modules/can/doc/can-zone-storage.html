...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.md
	@module can-zone-storage
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-zone-storage</title>
...
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-zone-storage.getItem.html"
							title="">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-zone-storage.getStore.html"
							title="">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-zone-storage.removeItem.html"
							title="">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-zone-storage.setItem.html"
							title="">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-zone-storage.data.html"
							title="Implement Zone-safe memory-based storage">
							data
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.html">can-zone-storage</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-zone-storage</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-zone-storage">
						<img src="https://img.shields.io/badge/npm%20package-1.0.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-zone-storage" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.md">Edit on GitHub</a>
				</li>
    ...
    <p>Implement Zone-safe memory-based storage</p>
...
<div class="signature">
  ...
  <p>Implement a Zone-safe memory-based storage solution.  This is especially useful for Server Side Rendering (SSR).</p>
<pre><code class="language-js">var zoneStorage = require(&quot;can-zone-storage&quot;);
...
zoneStorage.removeItem('key-name');
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-zone-storage</code> provides a Zone-safe method of storing data for a user.</p>
<p>It implements three of the methods from the WebStorage Interface:</p>
<ul>
<li><a href="can-zone-storage.setItem.html" title="">setItem</a> stores keyed data.</li>
<li><a href="can-zone-storage.getItem.html" title="">getItem</a> retrieves keyed data.</li>
<li><a href="can-zone-storage.removeItem.html" title="">removeItem</a> deletes keyed data.</li>
</ul>
<p>One additional method, <a href="can-zone-storage.getStore.html" title="">getStore</a>, allows you to retrieve the current data store and inspect it directly.</p>
<h2>Zone Safe</h2>
<p>Done-SSR, the Server Side Rendering solution built into DoneJS, uses Zones to increase performance.  Other web servers will completely rebuild the app for every incoming request.  Done-SSR uses Zones to keep the app running in memory and share it between all incoming connections.</p>
<p>Sharing modules between connections is often fine, but some data should not be shared.  Private data belonging to one user should not reach another user on the same server.  Can-Zone provides each incoming request with a <code>CanZone.current</code> object that is not shared.  The <code>can-zone-storage</code> module detects if CanZone is in the global namespace.  If it <em>is</em> found, it uses the <code>CanZone.current.data</code> object as the data store.  If <code>CanZone</code> is not found, an internal memory store is used.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone-storage/docs/can-zone-storage.md"},"description":"Implement Zone-safe memory-based storage \n","type":"module","title":"","types":[{"type":"Object","options":[]}],"name":"can-zone-storage","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.4"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"parent":"can-zone-storage","readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-zone-storage/issues"},"bundleDependencies":false,"deprecated":false,"description":"Implement Zone-safe memory-based storage","devDependencies":{"bit-docs":"0.0.7","bit-docs-generate-readme":"0.0.10","can-zone":"^0.6.1","semistandard":"^9.2.1","steal":"^1.0.6","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"homepage":"https://github.com/canjs/can-zone-storage","keywords":["CanJS"],"license":"MIT","main":"can-zone-storage.js","name":"can-zone-storage","repository":{"type":"git","url":"git+https://github.com/canjs/can-zone-storage.git"},"scripts":{"build":"node build.js","lint":"semistandard --fix","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run lint && npm run testee","testee":"testee test/zone-test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-zone-storage"},"version":"1.0.0"},"signatures":[{"code":"define(prototype, propDefinitions)","description":"\n\nImplement a Zone-safe memory-based storage solution.  This is especially useful for Server Side Rendering (SSR).\n\n```js\nvar zoneStorage = require(\"can-zone-storage\");\n\nvar value = 'Store me';\n\nzoneStorage.setItem('key-name', value);\n\nzoneStorage.getItem('key-name') === 'Store me' // --> true\n\nzoneStorage.removeItem('key-name');\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
