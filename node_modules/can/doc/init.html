...
instances when instances are created outside of the can-connect connection.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect/can/ref/ref.Map.Ref.html"
...
<div class="breadcrumb">
		...
		<li><a href="can-connect/can/ref/ref.html">./can/ref/</a></li>
		<li> / </li>
	...
	<div class="page-type">
		<h1>init</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L417">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.init()</code>
  </h2>
  <p>Initializes the base connection and then creates and sets <a href="can-connect/can/ref/ref.Map.Ref.html" title="A reference type with instanceRef.value primed to return an existing instance of the
map._Map type, if available, or lazy load an instance upon accessing instanceRef.value.">Map.Ref</a>.
Typically called by the <code>connect</code> helper after the connection behaviors have been assembled.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{undefined}</code>: <p>no return value</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"init","params":[],"parent":"can-connect/can/ref/ref.methods","src":{"line":416,"codeLine":427,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\n","desc":["Initializes the SignalR Hub Proxy","and sets up the RPC listeners for the standard"],"can":"-connect/can/ref/ref.init init","signatures":[{"code":"connection.init()","description":"\n\nInitializes the base connection and then creates and sets [can-connect/can/ref/ref.Map.Ref].\nTypically called by the `connect` helper after the connection behaviors have been assembled.\n","params":[],"returns":{"types":[{"type":"undefined"}],"description":"no return value\n\t "}}],"_curReturn":{"types":[{"type":"undefined"}],"description":"no return value\n\t "},"pathToRoot":".."};
</script>
</article>
