...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/prototype.compute.md
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.prototype.compute.html">compute</a></li>
	...
	<div class="page-type">
		<h1>compute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/prototype.compute.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get a compute that is two-way bound to the <code>key</code> value in the scope. These computes
can be optimized beyond wrapping a compute around a call to <a href="can-view-scope.prototype.get.html" title="">get</a>.</p>
<pre><code class="language-js">scope.compute(&quot;first.name&quot;);
</code></pre>
...
property name that includes a dot.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>(newVal)}</code>: <p>A compute.</p>
</p>
  </div>
