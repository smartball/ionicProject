...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/map.md
	@module can-map
######################################################################## -->
<html lang="en">
<head>
	...
	<div class="page-type">
		<h1>can-map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-map">
						<img src="https://img.shields.io/badge/npm%20package-3.4.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-map" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/map.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can.Map}</code>: <p>An instance of <code>can.Map</code> with the properties from <em>props</em>.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Creates a new extended constructor function.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Watch this video to see an example of creating an ATM machine using can.Map:</p>
<iframe width="662" height="372" src="https://www.youtube.com/embed/QP9mHyxZNiI" frameborder="0" allowfullscreen></iframe>
<p><code>Map</code> provides a way for you to listen for and keep track of changes
to objects. When you use the getters and setters provided by <code>Map</code>,
events are fired that you can react to. <code>Map</code> also has support for
working with deep properties. Observable arrays are also available with
<code><a href="can-list.html" title="">can-list</a></code>, which is based on <code>Map</code>.</p>
<h2>Working with Observes</h2>
<p>To create an Observe, use <code>new Map([props])</code>. This will return a
copy of <code>props</code> that emits events when its properties are changed with
<code><a href="can-map.prototype.attr.html" title="Get or set properties on a Map.">attr</a></code>.</p>
<p>You can read the values of properties on Observes directly, but you should
never set them directly. You can also read property values using <code>attr</code>.</p>
<pre><code>var aName = {a: 'Alexis'},
...
<p>Find out more about manipulating properties of a map under
[can.Map.prototype.attr attr] and [can.Map.prototype.removeAttr removeAttr].</p>
<h2>Listening to changes</h2>
<p>The real power of maps comes from being able to react to
properties being added, set, and removed. Maps emit events when
properties are changed that you can bind to.</p>
<p><code>Map</code> has two types of events that fire due to changes on a map:</p>
<ul>
<li>the <em>change</em> event fires on every change to a map.</li>
<li>an event named after the property name fires on every change to that property.</li>
</ul>
<pre><code>var o = new Map({});
...
<p>For more detail on how to use these events, see [can.Map.prototype.bind bind] and
...
<h2>Object.prototype.watch</h2>
<p>Due to a method available on the base Object prototype called &quot;watch&quot;, refrain from
using properties with the same name on Gecko based browsers as there will be a
collision. <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/watch">Source</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/map.md"},"description":"Create observable objects. \n","name":"can-map","type":"module","types":[{"type":"constructor"}],"inherits":"can","parent":"can-legacy","test":"can/map/test.html","plugin":"can/map","release":"2.0","link":"../docco/map/map.html docco","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-map/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.0.0","can-compute":"^3.3.0","can-construct":"^3.2.0","can-event":"^3.5.0","can-namespace":"^1.0.0","can-observation":"^3.3.0","can-reflect":"^1.2.0","can-stache-key":"0.1.0","can-symbol":"^1.0.0","can-types":"^1.1.0","can-util":"^3.9.4"},"deprecated":false,"description":"Observable Objects","devDependencies":{"jshint":"^2.9.1","steal":"^1.2.9","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-map","name":"can-map","repository":{"type":"git","url":"git://github.com/canjs/can-map.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"3.4.0"},"signatures":[{"code":"new Map([props])","description":"\n\nCreates a new instance of can.Map.\n","params":[{"types":[{"type":"Object","options":[]}],"optional":true,"name":"props","description":"Properties and values to seed the Observe with."}],"returns":{"types":[{"type":"can.Map"}],"description":"An instance of `can.Map` with the properties from _props_.\n"}},{"code":"Map.extend([name,] [staticProperties,] instanceProperties)","description":"\n\nCreates a new extended constructor function.\n\n","params":[]}],"_curReturn":{"types":[{"type":"can.Map"}],"description":"An instance of `can.Map` with the properties from _props_.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
