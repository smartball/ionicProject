...
<!--####################################################################
	...
	@function can-view-nodelist.remove
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - remove</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-nodelist.remove.html">remove</a></li>
	...
	<div class="page-type">
		<h1>remove</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L463">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Remove all Nodes in <code>oldElements</code> from the DOM.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>oldElements</b> <code>{ArrayLike&lt;Node&gt;}</code>: <p>the list of Elements to remove (must have a common parent)</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.remove","parent":"can-view-nodelist/methods","src":{"line":462,"codeLine":473,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"","title":"remove","hide":true,"signatures":[{"code":"nodeLists.remove(elementsToBeRemoved)","description":"\n\nRemove all Nodes in `oldElements` from the DOM.\n","params":[{"types":[{"type":"ArrayLike","template":[{"types":[{"type":"Node"}]}]}],"name":"oldElements","description":"the list of Elements to remove (must have a common parent)\n\n "}]}],"_curParam":{"types":[{"type":"ArrayLike","template":[{"types":[{"type":"Node"}]}]}],"name":"oldElements","description":"the list of Elements to remove (must have a common parent)\n\n "},"pathToRoot":".."};
</script>
</article>
