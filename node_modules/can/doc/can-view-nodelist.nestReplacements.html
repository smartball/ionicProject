...
<!--####################################################################
	...
	@function can-view-nodelist.nestReplacements
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - nestReplacements</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-nodelist.nestReplacements.html">nestReplacements</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>nestReplacements</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L164">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>nodeLists.nestReplacements(list)</code>
  </h2>
  <p>Goes through each node in the list. <code>[el1, el2, el3, ...]</code>
Finds the nodeList for that node in replacements.  el1's nodeList might look like <code>[el1, [el2]]</code>.
Replaces that element and any other elements in the node list with the
nodelist itself. resulting in <code>[ [el1, [el2]], el3, ...]</code>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">NodeList</a>}</code>: <p>The nodeList of nodes to go over</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.nestReplacements","parent":"can-view-nodelist/methods","src":{"line":163,"codeLine":177,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"","title":"nestReplacements","signatures":[{"code":"nodeLists.nestReplacements(list)","description":"\n\nGoes through each node in the list. `[el1, el2, el3, ...]`\nFinds the nodeList for that node in replacements.  el1's nodeList might look like `[el1, [el2]]`.\nReplaces that element and any other elements in the node list with the\nnodelist itself. resulting in `[ [el1, [el2]], el3, ...]`\nIf a replacement is not found, it was improperly added, so we add it as a deepChild.\n","params":[{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"list","description":"The nodeList of nodes to go over\n\n"}]}],"_curParam":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"list","description":"The nodeList of nodes to go over\n\n"},"pathToRoot":".."};
</script>
</article>
