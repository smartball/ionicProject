...
<!--####################################################################
	...
	@function can-set.props.boolean
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - boolean</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.props.boolean.html">boolean</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>boolean</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L257">Edit on GitHub</a>
				</li>
    ...
    <p>Supports boolean properties.</p>
...
<div class="signature">
  ...
  <p>Makes a compare object with a <code>property</code> function that has the following logic:</p>
<pre><code class="language-js">A(true) ∪ B(false) = undefined

A(undefined) \ B(true) = false
A(undefined) \ B(false) = true
</code></pre>
<p>It understands that <code>true</code> and <code>false</code> are complementary sets that combined to <code>undefined</code>. Another way to think of this is that if you load <code>{complete: false}</code> and <code>{complete: true}</code> you've loaded <code>{}</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>property</b> <code>{String}</code>: <p>The name of the boolean property.</p>
</li>
        
          <li><b>A</b> <code>{<a href="can-set.compares.html" title="An object of property names and prop functions.
{
  // return `true` if the values should be considered the same:
  lastName: function(aValue, bValue){
    return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
  }
}">Compares</a>}</code>: <p><code>Compares</code> object that can be an argument to <a href="can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.boolean","parent":"can-set.props","src":{"line":256,"codeLine":278,"path":"node_modules/can-set/src/props.js"},"description":"Supports boolean properties. \n","title":"boolean","signatures":[{"code":"set.props.boolean(property)","description":"\n\nMakes a compare object with a `property` function that has the following logic:\n\n```js\nA(true) ∪ B(false) = undefined\n\nA(undefined) \\ B(true) = false\nA(undefined) \\ B(false) = true\n```\n\nIt understands that `true` and `false` are complementary sets that combined to `undefined`. Another way to think of this is that if you load `{complete: false}` and `{complete: true}` you've loaded `{}`.\n","params":[{"types":[{"type":"String"}],"name":"property","description":"The name of the boolean property."},{"types":[{"type":"can-set.compares"}],"name":"A","description":"`Compares` object that can be an argument to [can-set.Algebra]\n "}]}],"_curParam":{"types":[{"type":"can-set.compares"}],"name":"A","description":"`Compares` object that can be an argument to [can-set.Algebra]\n "},"pathToRoot":".."};
</script>
</article>
