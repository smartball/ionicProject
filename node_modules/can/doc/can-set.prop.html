...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/docs/can-set.comparator.md
	@typedef can-set.prop
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Prop</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.prop.html">Prop</a></li>
	...
	<div class="page-type">
		<h1>Prop</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/docs/can-set.comparator.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A prop function returns algebra values for two values for a given property.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>aValue</b> <code>{*}</code>: <p>The value of A's property in a set difference A and B (A  B).</p>
</li>
        
          <li><b>bValue</b> <code>{*}</code>: <p>The value of A's property in a set difference A and B (A  B).</p>
</li>
        
          <li><b>a</b> <code>{*}</code>: <p>The A set in a set difference A and B (A  B).</p>
</li>
        
          <li><b>b</b> <code>{*}</code>: <p>The B set in a set difference A and B (A  B).</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object|Boolean}</code>: <p>A prop function should either return a Boolean which indicates if <code>aValue</code> and <code>bValue</code> are
equal or an <code>AlgebraResult</code> object that details information about the union, intersection, and difference of <code>aValue</code> and <code>bValue</code>.</p>
<p>An <code>AlgebraResult</code> object has the following values:</p>
<ul>
<li><code>union</code> - A value the represents the union of A and B.</li>
...
<li><code>count</code> - The count of the items in A.</li>
</ul>
<p>For example, if you had a <code>colors</code> property and A is <code>[&quot;Red&quot;,&quot;Blue&quot;]</code> and B is <code>[&quot;Green&quot;,&quot;Yellow&quot;,&quot;Blue&quot;]</code>, the
...
the real number can not be known.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-set/docs/can-set.comparator.md"},"description":"\n","type":"typedef","title":"Prop","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-set.prop","parent":"can-set.types","signatures":[{"code":"prop(aValue, bValue, a, b, prop, algebra)","description":"\n\nA prop function returns algebra values for two values for a given property.\n","params":[{"types":[{"type":"*"}],"name":"aValue","description":"The value of A's property in a set difference A and B (A  B)."},{"types":[{"type":"*"}],"name":"bValue","description":"The value of A's property in a set difference A and B (A  B)."},{"types":[{"type":"*"}],"name":"a","description":"The A set in a set difference A and B (A  B)."},{"types":[{"type":"*"}],"name":"b","description":"The B set in a set difference A and B (A  B)."}],"returns":{"types":[{"type":"Object"},{"type":"Boolean"}],"description":"A prop function should either return a Boolean which indicates if `aValue` and `bValue` are\nequal or an `AlgebraResult` object that details information about the union, intersection, and difference of `aValue` and `bValue`.\n\nAn `AlgebraResult` object has the following values:\n\n- `union` - A value the represents the union of A and B.\n- `intersection` - A value that represents the intersection of A and B.\n- `difference` - A value that represents all items in A that are not in B.\n- `count` - The count of the items in A.\n\nFor example, if you had a `colors` property and A is `[\"Red\",\"Blue\"]` and B is `[\"Green\",\"Yellow\",\"Blue\"]`, the\nAlgebraResult object might look like:\n\n```js\n{\n  union: [\"Red\",\"Blue\",\"Green\",\"Yellow\"],\n  intersection: [\"Blue\"],\n  difference: [\"Red\"],\n  count: 2000\n}\n```\n\nThe count is `2000` because there might be 2000 items represented by colors \"Red\" and \"Blue\".  Often\nthe real number can not be known.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"b","description":"The B set in a set difference A and B (A  B)."},"_curReturn":{"types":[{"type":"Object"},{"type":"Boolean"}],"description":"A prop function should either return a Boolean which indicates if `aValue` and `bValue` are\nequal or an `AlgebraResult` object that details information about the union, intersection, and difference of `aValue` and `bValue`.\n\nAn `AlgebraResult` object has the following values:\n\n- `union` - A value the represents the union of A and B.\n- `intersection` - A value that represents the intersection of A and B.\n- `difference` - A value that represents all items in A that are not in B.\n- `count` - The count of the items in A.\n\nFor example, if you had a `colors` property and A is `[\"Red\",\"Blue\"]` and B is `[\"Green\",\"Yellow\",\"Blue\"]`, the\nAlgebraResult object might look like:\n\n```js\n{\n  union: [\"Red\",\"Blue\",\"Green\",\"Yellow\"],\n  intersection: [\"Blue\"],\n  difference: [\"Red\"],\n  count: 2000\n}\n```\n\nThe count is `2000` because there might be 2000 items represented by colors \"Red\" and \"Blue\".  Often\nthe real number can not be known.\n"},"pathToRoot":".."};
</script>
</article>
