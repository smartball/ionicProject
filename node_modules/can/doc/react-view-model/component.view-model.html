...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/react-view-model/docs/component-view-model.md
	@property react-view-model/component.view-model
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="component.view-model.html">ViewModel</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ViewModel</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/react-view-model/edit/master/docs/component-view-model.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provide a constructor function that provides values and methods to the component. The constructor function is initialized with the props, and updated as the props change.</p>
...
AppComponent.ViewModel = DefineMap.extend({
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>The initial props that are passed to the component.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A new instance of the ViewModel.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/react-view-model/docs/component-view-model.md"},"description":"Provide a constructor function that provides values and methods to the component. The constructor function is initialized with the props, and updated as the props change. \n","types":[{"type":"function","returns":{"types":[{"type":"Object","options":[]}],"description":"A new instance of the ViewModel.\n\n"},"params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The initial props that are passed to the component.\n"}],"description":"A constructor function usually defined by [can-define/map/map.extend DefineMap.extend] or\n[can-map Map.extend] that will be used to create a new observable instance accessible by\nthe component.\n\n```javascript\nimport { Component } from 'react-view-model';\n\nexport default class AppComponent extends Component {\n  ...\n}\n\nAppComponent.ViewModel = DefineMap.extend({\n  ...\n});\n```\n"}],"title":"ViewModel","name":"react-view-model/component.view-model","type":"property","parent":"react-view-model/component.static","_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The initial props that are passed to the component.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A new instance of the ViewModel.\n\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
