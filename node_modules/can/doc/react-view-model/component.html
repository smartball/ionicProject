...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/react-view-model/docs/component.md
	@function react-view-model/component
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - react-view-model/component</title>
...
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="component.view-model.html"
							title="Provide a constructor function that provides values and methods to the component. The constructor function is initialized with the props, and updated as the props change.">
							ViewModel
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="component.html">react-view-model/component</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>react-view-model/component</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/react-view-model/edit/master/docs/component.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create an auto-rendering container component with an observable view-model.</p>
...
<div class="signature">
  ...
  <p>Create an auto-rendering <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8">container component</a> by connecting an observable <a href="../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> view-model to a React <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0#.v9i90qbq8">presentational component</a>.</p>
<pre><code class="language-javascript">import { Component } from 'react-view-model';
...
<p>Every instance of the component will generate an instance of the ViewModel, initialized with the props, and provide it as <code>this.viewModel</code>. Whenever the container component receives new props, the new values are passed to the viewModel’s <code>.set()</code> method, which may in turn cause an observable change event, which will re-run the observed render process.</p>
<p><em>Note: If you extend any of the <a href="https://facebook.github.io/react/docs/react-component.html#the-component-lifecycle">React lifecycle methods</a>, you must call <code>super</code> so as not to break the view-model binding. This includes: <code>componentWillReceiveProps</code>, <code>componentWillMount</code>, <code>componentDidMount</code>, <code>componentWillUpdate</code>, <code>componentDidUpdate</code>, and <code>componentWillUnmount</code>.</em></p>
...
<p><a class="jsbin-embed" href="https://jsbin.com/lunajov/1/embed?js,output">react-view-model/component demo on jsbin.com</a></p>
<p>You can also use this module with <a href="https://preactjs.com">Preact</a>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/fuxerik/2/embed?js,output">react-view-model/component demo with Preact on jsbin.com</a></p>
<p>Here’s a recreation of the clock example from <a href="https://facebook.github.io/react/docs/state-and-lifecycle.html">React’s State and Lifecycle docs</a>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/zikaxuy/4/embed?js,output">react-view-model/component clock demo on jsbin.com</a></p>
