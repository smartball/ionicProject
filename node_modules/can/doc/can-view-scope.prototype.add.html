...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/prototype.add.md
	@function can-view-scope.prototype.add
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - add</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.prototype.add.html">add</a></li>
	...
	<div class="page-type">
		<h1>add</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/prototype.add.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.add(context [,meta])</code>
  </h2>
  <p>Creates a new scope and sets the current scope to be the parent.</p>
<pre><code class="language-js">var scope = new Scope([
   {name:&quot;Chris&quot;},
   {name: &quot;Justin&quot;}
]).add({name: &quot;Brian&quot;});
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>context</b> <code>{*}</code>: <p>The context to add on top of the current scope.</p>
</li>
        
          <li><b>meta</b> <code>{<a href="can-view-scope/Meta.html" title="">Meta</a>}</code>: <p>A meta option that can be used to configure special behaviors of this context.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>scope.add(context)</code> creates a new scope object that
first looks up values in context and then in the
parent <code>scope</code> object.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-scope/docs/prototype.add.md"},"description":"\n","title":"add","name":"can-view-scope.prototype.add","type":"function","parent":"can-view-scope.prototype","signatures":[{"code":"scope.add(context [,meta])","description":"\n\nCreates a new scope and sets the current scope to be the parent.\n\n```js\nvar scope = new Scope([\n   {name:\"Chris\"},\n   {name: \"Justin\"}\n]).add({name: \"Brian\"});\nscope.get(\"name\") //-> \"Brian\"\n```\n","params":[{"types":[{"type":"*"}],"name":"context","description":"The context to add on top of the current scope."},{"types":[{"type":"can-view-scope/Meta"}],"name":"meta","description":"A meta option that can be used to configure special behaviors of this context.\n"}]}],"_curParam":{"types":[{"type":"can-view-scope/Meta"}],"name":"meta","description":"A meta option that can be used to configure special behaviors of this context.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
