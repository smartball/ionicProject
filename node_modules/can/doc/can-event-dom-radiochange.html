...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event-dom-radiochange/can-event-dom-radiochange.js
	@module can-event-dom-radiochange
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-event-dom-radiochange</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-event-dom-radiochange.html">can-event-dom-radiochange</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-event-dom-radiochange</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-event-dom-radiochange">
						<img src="https://img.shields.io/badge/npm%20package-1.0.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-event-dom-radiochange" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-event-dom-radiochange/edit/master/can-event-dom-radiochange.js#L109">Edit on GitHub</a>
				</li>
    ...
    <p>A custom event for listening to changes of inputs with type &quot;radio&quot;,
which fires when a conflicting radio input changes. A &quot;conflicting&quot;
radio button has the same &quot;name&quot; attribute and exists within in the
same form, or lack thereof. This event coordinates state bound to
whether a radio is checked. The &quot;change&quot; event does not fire for deselected
radios. By using this event instead, deselected radios receive notification.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-event-dom-radiochange","type":"module","parent":"can-infrastructure","src":{"line":108,"codeLine":135,"path":"node_modules/can-event-dom-radiochange/can-event-dom-radiochange.js"},"description":"\nA custom event for listening to changes of inputs with type \"radio\",\nwhich fires when a conflicting radio input changes. A \"conflicting\"\nradio button has the same \"name\" attribute and exists within in the\nsame form, or lack thereof. This event coordinates state bound to\nwhether a radio is checked. The \"change\" event does not fire for deselected\nradios. By using this event instead, deselected radios receive notification.\n","title":"","types":[{"type":"events"}],"package":{"author":{"name":"Chris Andrejewski","email":"core@donejs.com","url":"https://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-event-dom-radiochange/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.1.0","can-dom-data-state":"^0.1.1","can-dom-events":"^1.0.2","can-globals":"^0.2.2"},"deprecated":false,"description":"Custom radiochange event","devDependencies":{"fixpack":"^2.3.1","jshint":"^2.9.1","steal":"^1.3.1","steal-qunit":"^1.0.1","steal-tools":"^1.2.0","testee":"^0.6.0"},"homepage":"https://canjs.com/doc/can-event-dom-radiochange.html","keywords":["canjs","change","event","radio"],"license":"MIT","main":"can-event-dom-radiochange","name":"can-event-dom-radiochange","repository":{"type":"git","url":"git://github.com/canjs/can-event-dom-radiochange.git"},"scripts":{"build":"node build.js","install-canary":"npm install --no-shrinkwrap","install-locked":"npm install","jshint":"jshint ./*.js --config","lint":"fixpack && npm run jshint","preversion":"npm test && npm run build","test":"npm run lint && npm run testee","testee":"testee test.html --browsers firefox"},"steal":{"main":"can-event-dom-radiochange","npmIgnore":["testee","steal-tools"]},"version":"1.0.2"},"pathToRoot":".."};
</script>
</article>
