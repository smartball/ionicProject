...
<div class="breadcrumb">
	...
	<li><a href="can-event.bind.html">bind</a></li>
	...
	<div class="page-type">
		<h1>bind</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L404">Edit on GitHub</a>
				</li>
...
<p>This is an alias of <a href="can-event.addEventListener.html" title="can-event.addEventListener">addEventListener</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event.bind","parent":"can-event.static","src":{"line":403,"codeLine":416,"path":"node_modules/can-event/can-event.js"},"description":"","title":"bind","signatures":[{"code":"obj.bind(event, handler)","description":"\n\nAdd a basic event listener to an object.\n\nThis is an alias of [can-event.addEventListener addEventListener].\n","params":[]},{"code":"canEvent.bind.call(obj, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n","params":[]}],"pathToRoot":".."};
</script>
</article>
