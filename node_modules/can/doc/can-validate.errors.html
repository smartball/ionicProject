...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate/docs/errors.md
	@typedef can-validate.errors
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-validate.errors.html">Errors</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Errors</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate/edit/master/docs/errors.md">Edit on GitHub</a>
				</li>
    ...
    <p>The expected response from a validator if a value fails validation.</p>
...
<div class="signature">
  ...
  <p>Expected when value passes validation.</p>
...
<div class="signature">
  ...
  <p>Will be treated similarly as <code>undefined</code>; value passed validation.</p>
...
<div class="signature">
  ...
  <p>A message explaining the validation failure.</p>
<pre><code class="language-javascript">&quot;is required&quot;
</code></pre>
...
<div class="signature">
  ...
  <p>An object used to describe an error message. See <a href="can-validate.error.html" title="An object that defines a validation failure.">Error</a>.</p>
...
<div class="signature">
  ...
  <p>Items can be any of the valid <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>.</p>
<pre><code class="language-json">[
    &quot;is required&quot;,
    {
        &quot;message&quot;: &quot;is required&quot;,
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate/docs/errors.md"},"description":"\nThe expected response from a validator if a value fails validation.\n","type":"typedef","title":"Errors","types":[{"type":"undefined","description":"Expected when value passes validation.\n"},{"type":"null","description":"Will be treated similarly as `undefined`; value passed validation.\n"},{"type":"string","description":"A message explaining the validation failure.\n\n```javascript\n\"is required\"\n```\n"},{"type":"ERROR","description":"An object used to describe an error message. See [can-validate.error].\n\n```json\n{\n    \"message\": \"is required\",\n    \"related\": [\"billingZip\", \"residenceZip\"]\n}\n```\n"},{"type":"array","description":"Items can be any of the valid [can-validate.errors].\n\n```json\n[\n    \"is required\",\n    {\n        \"message\": \"is required\",\n        \"related\": [\"billingZip\", \"residenceZip\"]\n    }\n]\n```\n"}],"name":"can-validate.errors","parent":"can-validate.types","pathToRoot":".."};
</script>
</article>
