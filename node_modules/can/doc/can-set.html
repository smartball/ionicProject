...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/docs/can-set.md
	@module can-set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-set</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-set">
						<img src="https://img.shields.io/badge/npm%20package-1.3.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-set" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/docs/can-set.md">Edit on GitHub</a>
				</li>
    ...
    <p>can-set is a utility for comparing <a href="can-set/Set.html" title="An object that represents a set of data.">sets</a> that are represented by the parameters commonly passed to service requests.</p>
...
<div class="signature">
  ...
  <p>Once you've imported the <code>can-set</code> module into your project, use it to create a <code>set.Algebra</code> and then use that to compare and perform operations on sets.</p>
...
//-&gt; [{id: 2},{id: 3}]
    ...
    <section class="body">
    <h2>Use</h2>
<p>A <a href="can-set/Set.html" title="An object that represents a set of data.">Set</a> is a plain JavaScript object used to represent a
<a href="https://en.wikipedia.org/wiki/Set_theory" title="set">set</a> of data usually sent to the server to fetch a list of records.  For example,
a list of all completed todos might be represented by:</p>
<pre><code>{complete: true}
</code></pre>
<p>This set might be passed to <a href="can-connect/can/map/map.getList.html" title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">getList</a> like:</p>
<pre><code>Todo.getList({complete: true})
</code></pre>
<p>An <a href="can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a> is used to detail the behavior of these sets,
...
<p>These algebra's are typically used internally by either <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> or
...
<pre><code class="language-js">var todoStore = fixture.store([
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-set/docs/can-set.md"},"description":" \ncan-set is a utility for comparing [can-set/Set sets] that are represented by the parameters commonly passed to service requests.\n\n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\nOnce you've imported the `can-set` module into your project, use it to create a `set.Algebra` and then use that to compare and perform operations on sets.  \n\n```js\nvar set = require('can-set');\n// create an algebra\nvar algebra = new set.Algebra(\n    // specify the unique identifier on data\n    set.props.id(\"_id\"),  \n    // specify that completed can be true, false or undefined\n    set.props.boolean(\"completed\"),\n    // specify properties that define pagination\n    set.props.rangeInclusive(\"start\",\"end\"),\n    // specify the property that controls sorting\n    set.props.sort(\"orderBy\"),\n)\n\n// compare two sets\nalgebra.subset({start: 2, end: 3}, {start: 1, end: 4}) //-> true\nalgebra.difference({} , {completed: true}) //-> {completed: false}\n\n// perform operations on sets\nalgebra.getSubset({start: 2,end: 3},{start: 1,end: 4},\n            [{id: 1},{id: 2},{id: 3},{id: 4}])\n//-> [{id: 2},{id: 3}]\n```\n"}],"name":"can-set","parent":"can-core","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.4","bit-docs-generate-readme":"^0.0.10"},"glob":{"pattern":"**/*.{js,md}","ignore":"node_modules/**/*"},"parent":"can-set","readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-set/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"^1.0.0","can-util":"^3.9.0-pre.4"},"deprecated":false,"description":"Set logic for CanJS","devDependencies":{"bit-docs":"^0.0.7","jshint":"^2.7.0","steal":"^1.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.7.0"},"homepage":"https://github.com/canjs/can-set","keywords":["canjs"],"license":"MIT","main":"src/set.js","name":"can-set","repository":{"type":"git","url":"git+https://github.com/canjs/can-set.git"},"scripts":{"build":"node build.js","jshint":"jshint src/. --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"plugins":["steal-qunit"]},"version":"1.3.2"},"comment":" ","pathToRoot":".."};
</script>
</article>
