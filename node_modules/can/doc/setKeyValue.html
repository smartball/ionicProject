...
<div class="breadcrumb">
	...
	<li><a href="setKeyValue.html">setKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>setKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/can-globals-proto.js#L260">Edit on GitHub</a>
				</li>
    ...
    <p>Overwrite an existing global environment variable.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>globals.setKeyValue(key, value)</code>
  </h2>
  <pre><code class="language-javascript">globals.define('foo', 'bar');
globals.setKeyValue('foo', 'baz');
globals.getKeyValue('foo'); //-&gt; 'baz'
</code></pre>
<p>Sets the new value at <code>key</code>. Will override previously set values, but preserves the default (see <code>deleteKeyValue</code>).</p>
<p>Setting a key which was not previously defined will call <code>define</code> with the key and value.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key value to access.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>The new value.</p>
</li>
