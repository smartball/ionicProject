...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone/docs/waitFor.md
	@function can-zone.waitFor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - waitFor</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone.waitFor.html">waitFor</a></li>
	...
	<div class="page-type">
		<h1>waitFor</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone/edit/master/docs/waitFor.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p><strong>Zone.waitFor</strong> is a function that creates a callback that can be used with any async functionality. Calling Zone.waitFor registers a wait with the currently running request and returns a function that, when called, will decrement the wait count.</p>
<p>This is useful if there is async functionality other than what <a href="#tasks">we implement</a>. You might be using a library that has C++ bindings and doesn't go through the normal JavaScript async APIs.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>fn</b> <code>{function}</code>: </li>
