...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/whitespace.md
	@page can-stache.Whitespace
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Whitespace Control</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.Whitespace.html">Whitespace Control</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Whitespace Control</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/whitespace.md">Edit on GitHub</a>
				</li>
    ...
    <p>Omit whitespace from around the output of the template.</p>
...
<div class="signature">
  ...
  <p>Whitespace may be omitted from either or both ends of a magic tag by including a
<code>-</code> character by the braces. When present, all whitespace on that side will be
omitted up to the next tag, magic tag, or non-whitespace character. It also works with <a href="can-stache.tags.unescaped.html" title="Insert the unescaped value of the expression into the output of the template.">{{{expression}}}</a>.</p>
...
<p>would render as:</p>
<pre><code class="language-html">&lt;div&gt;{{#if(user.isMarried)}}Mrs{{else}}Miss{{/if}}&lt;/div&gt;
</code></pre>
<p>and</p>
<pre><code class="language-html">&lt;div&gt;
    {{{- toMarkdown(content) -}}}
...
<p>would render as:</p>
<pre><code class="language-html">&lt;div&gt;{{{ toMarkdown(content) }}}&lt;/div&gt;
</code></pre>
<h3>Span Elements</h3>
<p>One use case is to remove spaces around span elements.</p>
<pre><code class="language-html">&lt;div&gt;
    &lt;span&gt;
        {{-#if(user.isMarried)-}}
            Mrs.
...
<p>Another would be to assure that empty elements are able to match the <code>:empty</code>
css pseudo-class (the whitespace that would be otherwise present prevents this),
while still being cleanly formatted for human consumption.</p>
<pre><code class="language-html">&lt;div&gt;
...
<p>would render as:</p>
<pre><code class="language-html">&lt;div&gt;{{-! output the users name }}{{-#if(user.name)}}
        {{ user.name }}
    {{/if-}}&lt;/div&gt;
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/whitespace.md"},"description":"Omit whitespace from around the output of the template. \n","name":"can-stache.Whitespace","title":"Whitespace Control","type":"page","parent":"can-stache.pages","order":6,"signatures":[{"code":"{{-EXPRESSION-}}","description":"\n\nWhitespace may be omitted from either or both ends of a magic tag by including a\n`-` character by the braces. When present, all whitespace on that side will be\nomitted up to the next tag, magic tag, or non-whitespace character. It also works with [can-stache.tags.unescaped].\n","params":[{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"EXPRESSION","description":"An expression whose unescaped result is inserted into the page.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/literal"},{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"},{"type":"can-stache/expressions/helper"}],"name":"EXPRESSION","description":"An expression whose unescaped result is inserted into the page.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
