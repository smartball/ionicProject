...
<!--####################################################################
	...
	@function can-reflect.setKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - setKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.setKeyValue.html">setKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>setKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/get-set/get-set.js#L10">Edit on GitHub</a>
				</li>
    ...
    <p>Set the value of a named property on a MapLike object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>setKeyValue(obj, key, value)</code>
  </h2>
  <p>Set the property on Map-like <code>obj</code>, identified by the String, Symbol or Object value <code>key</code>, to the value <code>value</code>.
The default behavior can be overridden on <code>obj</code> by implementing <a href="can-symbol/symbols/setKeyValue.html" title="Defines a function that sets the value of one of an object's named properties.">@@can.setKeyValue</a>,
otherwise native named property access is used for string keys, and <code>Object.defineProperty</code> is used to set symbols.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key for the property to set</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>the value to set on the object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.setKeyValue","parent":"can-reflect/get-set","src":{"line":9,"codeLine":30,"path":"node_modules/can-reflect/reflections/get-set/get-set.js"},"description":"Set the value of a named property on a MapLike object. \n","title":"setKeyValue","signatures":[{"code":"setKeyValue(obj, key, value)","description":"\n\nSet the property on Map-like `obj`, identified by the String, Symbol or Object value `key`, to the value `value`.\nThe default behavior can be overridden on `obj` by implementing [can-symbol/symbols/setKeyValue @@can.setKeyValue],\notherwise native named property access is used for string keys, and `Object.defineProperty` is used to set symbols.\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\n\ncanReflect.setKeyValue(foo, \"bar\", \"quux\");\nfoo[bar]; // -> \"quux\"\n```","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to set on"},{"types":[{"type":"String"}],"name":"key","description":"the key for the property to set"},{"types":[{"type":"*"}],"name":"value","description":"the value to set on the object\n "}]}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"the value to set on the object\n "},"pathToRoot":".."};
</script>
</article>
