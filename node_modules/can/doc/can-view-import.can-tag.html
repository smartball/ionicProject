...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-import/docs/can-tag.md
	@function can-view-import.can-tag
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-tag</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-import.can-tag.html">can-tag</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-tag</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-import/edit/master/docs/can-tag.md">Edit on GitHub</a>
				</li>
    ...
    <p>Use another <a href="can-view-callbacks.tag.html" title="">tag</a> (such as a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>) to control the <code>&lt;content&gt;</code> of a <a href="can-view-import.html" title="">can-view-import</a>.</p>
...
<div class="signature">
  ...
  <p>Instantiates the provided <a href="can-view-callbacks.tag.html" title="">tag</a> and sets its <a href="can-component.prototype.view-model.html" title="Return the view model instance or type with which the component’s can-component.prototype.view
is rendered.  This is used when more fine grained control is needed over can-component::ViewModel.">viewModel</a> to be the Promise for the import.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>TAG_NAME</b> <code>{String}</code>: <p>The tag name (usually a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>) to use.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><strong>can-tag</strong> allows a component to be injected using the imported promise as the
injected component’s view model.</p>
<p>The example below shows a loading graphic until the cart component has been loaded.
Once the cart promise is resolved, <code>&lt;shopping-cart&gt;&lt;/shopping-cart&gt;</code> is injected
into the page.</p>
<p>For example, here’s a <code>loading-indicator</code> component:</p>
<pre><code>var template = stache('{{#isResolved}}&lt;content/&gt;{{else}}&lt;img src=&quot;loading.gif&quot;/&gt;{{/isResolved}}');
...
<p>Here’s how <code>can-tag</code> can be used to show the loading indicator before the <code>shopping-cart</code> component is imported:</p>
<pre><code>&lt;can-import from=&quot;cart&quot; can-tag=&quot;loading-indicator&quot;&gt;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-import/docs/can-tag.md"},"description":"Use another [can-view-callbacks.tag] (such as a [can-component]) to control the `<content>` of a [can-view-import].  \n","title":"can-tag","name":"can-view-import.can-tag","type":"function","parent":"can-view-import.attributes","signatures":[{"code":"can-tag=\"TAG_NAME\"","description":"\n\nInstantiates the provided [can-view-callbacks.tag] and sets its [can-component.prototype.view-model viewModel] to be the Promise for the import.\n","params":[{"types":[{"type":"String"}],"name":"TAG_NAME","description":"The tag name (usually a [can-component]) to use.\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"TAG_NAME","description":"The tag name (usually a [can-component]) to use.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
