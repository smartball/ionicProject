...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/done.md
	@function can-view-parser.ParseHandler.done
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - done</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.done.html">done</a></li>
	...
	<div class="page-type">
		<h1>done</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/done.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>done(lines)</code>
  </h2>
  <p>Called at the end of parsing the template.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>lines</b> <code>{Number}</code>: <p>The number of lines in the template (undefined in production).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/done.md"},"description":"","title":"done","name":"can-view-parser.ParseHandler.done","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"done(lines)","description":"\n\nCalled at the end of parsing the template.\n","params":[{"types":[{"type":"Number"}],"name":"lines","description":"The number of lines in the template (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lines","description":"The number of lines in the template (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
