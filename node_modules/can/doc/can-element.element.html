...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-element/docs/can-element.element.md
	@function can-element.element
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-element.element.html">Element</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Element</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-element/edit/master/docs/can-element.element.md">Edit on GitHub</a>
				</li>
    ...
    <p>A class that can be extended to create custom elements.
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use this element, just extend your own element based off of it:</p>
...
<p>This element uses the <a href="can-element.CanElement.html" title="An interface for derived elements using either can-element or can-element.element.">CanElement</a> interface, so any properties of CanElement are supported.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-element/docs/can-element.element.md"},"description":"A class that can be extended to create custom elements. \nElement is a [can-element.CanElement] that is derived from the [HTMLElement](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement). This is the element you will want to use to derive your own custom elements.\n\n","title":"Element","name":"can-element.element","type":"function","parent":"can-element.properties","comment":" ","pathToRoot":".."};
</script>
</article>
