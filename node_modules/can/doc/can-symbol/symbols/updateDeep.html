...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-updateDeep.md
	@typedef can-symbol/symbols/updateDeep
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.updateDeep</title>
...
<div class="breadcrumb">
	...
	<li><a href="updateDeep.html">can.updateDeep</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.updateDeep</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-updateDeep.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines how to change the state of the current object to match the state of another object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.updateDeep( source )</code>
  </h2>
  <p>The <code>can.updateDeep</code> symbol specifies how a deep update should happen. This means the copying of
all of source's values, and child values onto the current object and removal of values from the current
object that are not in source and its children..</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>source</b> <code>{Object}</code>: <p>The source of values that will be copied.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-updateDeep.md"},"description":"Defines how to change the state of the current object to match the state of another object. \n","type":"typedef","title":"can.updateDeep","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/updateDeep","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.updateDeep( source )","description":"\n\nThe `can.updateDeep` symbol specifies how a deep update should happen. This means the copying of\nall of source's values, and child values onto the current object and removal of values from the current\nobject that are not in source and its children..  \n\n","params":[{"types":[{"type":"Object","options":[]}],"name":"source","description":"The source of values that will be copied.\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"An object with named properties"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"source","description":"The source of values that will be copied.\n"},"pathToRoot":"../../.."};
</script>
</article>
