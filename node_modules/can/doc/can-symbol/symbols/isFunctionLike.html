...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-isListLike.md
	@typedef can-symbol/symbols/isFunctionLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.isFunctionLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="isFunctionLike.html">can.isFunctionLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.isFunctionLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-isListLike.md">Edit on GitHub</a>
				</li>
    ...
    <p>Set to <code>true</code> on objects with numeric indexes and length.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.isFunctionLike</code>
  </h2>
  <p>Setting the value of <code>can.isFunctionLike</code> to <code>true</code> on an object shows that this object can be called as a function. Setting it to <code>false</code> on a function shows that it should not be called as a function.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-isListLike.md"},"description":"Set to `true` on objects with numeric indexes and length. \n","type":"typedef","title":"can.isFunctionLike","types":[{"type":"Boolean"}],"name":"can-symbol/symbols/isFunctionLike","parent":"can-symbol/symbols/type","signatures":[{"code":"@@can.isFunctionLike","description":"\n\nSetting the value of `can.isFunctionLike` to `true` on an object shows that this object can be called as a function. Setting it to `false` on a function shows that it should not be called as a function.\n","params":[]}],"pathToRoot":"../../.."};
</script>
</article>
