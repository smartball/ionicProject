...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-offKeyValue.md
	@typedef can-symbol/symbols/offKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.offKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="offKeyValue.html">can.offKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.offKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-offKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines how observable values can be listened to on a type.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.offKeyValue( key, handler(newValue) )</code>
  </h2>
  <p>the <code>@@can.offKeyValue</code> symbol is placed on a Map-like object to point to a function used to stop listening to changes on the <code>key</code> property with the <code>handler</code> function.</p>
<pre><code>var obj = {
    handlers: {},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the string key to stop binding on changes to.</p>
</li>
        
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler that was previously bound with <a href="onKeyValue.html" title="Defines how observable values can be listened to on a type."><code>@@can.onKeyValue</code></a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-offKeyValue.md"},"description":"Defines how observable values can be listened to on a type. \n\n","type":"typedef","title":"can.offKeyValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}]}]}],"name":"can-symbol/symbols/offKeyValue","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.offKeyValue( key, handler(newValue) )","description":"\n\nthe `@@can.offKeyValue` symbol is placed on a Map-like object to point to a function used to stop listening to changes on the `key` property with the `handler` function.\n\n\n```\nvar obj = {\n\thandlers: {},\n\tsetKeyValue: function(key, value){\n\t\tthis[key] = value;\n\t\tvar self = this;\n\t\tobj.handlers[key].forEach(function(handler){\n\t\t\thandler.call(self, value);\n\t\t});\n\t}\n};\n\nobj[canSymbol.for(\"can.offKeyValue\")] = function(key, handler){\n\tif(!obj.handlers[key]) {\n\t\tobj.handlers[key] = [];\n\t}\n\tobj.handlers[key].splice(obj.handlers[key].indexOf(handler), 1);\n}\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the string key to stop binding on changes to."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler that was previously bound with [can-symbol/symbols/onKeyValue `@@can.onKeyValue`]\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any Map-like object with named properties"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler that was previously bound with [can-symbol/symbols/onKeyValue `@@can.onKeyValue`]\n"},"pathToRoot":"../../.."};
</script>
</article>
