...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-onKeys.md
	@typedef can-symbol/symbols/onKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.onKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="onKeys.html">can.onKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onKeys</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-onKeys.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function used to listen to when the object's key set changes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.onKeys( handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.onKeys</code> symbol points to a function that registers
<code>handler</code> to be called back when the keys on the object
change via new properties or deletions.</p>
<pre><code>var obj = {
    handlers: {},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler must be called back with <code>this</code> as the instance of the observable, and passed the current key set as an Array.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-onKeys.md"},"description":"Define a function used to listen to when the object's key set changes. \n","type":"typedef","title":"can.onKeys","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}]}]}],"name":"can-symbol/symbols/onKeys","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.onKeys( handler(newValue) )","description":"\n\nThe `@@can.onKeys` symbol points to a function that registers \n `handler` to be called back when the keys on the object\n change via new properties or deletions.\n\n```\nvar obj = {\n\thandlers: {},\n\tsetKeyValue: function(key, value){\n\t\tvar newKey = this[canSymbol.for(\"hasOwnKey\")](key);\n\t\tthis[key] = value;\n\t\tvar self = this;\n\t\tif(newKey) {\n\t\t\tobj.handlers.__keys.forEach(function(handler){\n\t\t\t\thandler.call(self, this[canSymbol.for(\"getOwnKeys\")]());\n\t\t\t});\n\t\t}\n\t}\n};\n\nobj[canSymbol.for(\"can.onKeys\")] = function(handler){\n\tif(!obj.handlers.__keys) {\n\t\tobj.handlers.__keys = [];\n\t}\n\tobj.handlers.__keys.push(handler);\n}\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the current key set as an Array.\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any Map-like object with named properties"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the current key set as an Array.\n"},"pathToRoot":"../../.."};
</script>
</article>
