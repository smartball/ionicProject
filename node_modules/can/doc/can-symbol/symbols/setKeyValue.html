...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-setKeyValue.md
	@typedef can-symbol/symbols/setKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.setKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="setKeyValue.html">can.setKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.setKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-setKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines a function that sets the value of one of an object's named properties.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.setKeyValue( key, value )</code>
  </h2>
  <p>The <code>@@can.setKeyValue</code> symbol points to a Map-like object's property mutator function, which updates the value of the
object's property with the supplied key. This is only applicable to objects where keyed properties are relevant (like maps).</p>
<pre><code>var map = {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key to set on the object</p>
</li>
        
          <li><b>key</b> <code>{*}</code>: <p>the property value to set on the object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-setKeyValue.md"},"description":"Defines a function that sets the value of one of an object's named properties. \n","type":"typedef","title":"can.setKeyValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"*"}]}]}],"name":"can-symbol/symbols/setKeyValue","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.setKeyValue( key, value )","description":"\n\nThe `@@can.setKeyValue` symbol points to a Map-like object's property mutator function, which updates the value of the \nobject's property with the supplied key. This is only applicable to objects where keyed properties are relevant (like maps).\n\n```\nvar map = {\n\tset: function (key, value) {\n\t\tObservation.add(this, key);\n\t\tthis[key] = value;\n\t}\n}\n\nmap[canSymbol.for('can.setKeyValue')] = map.set;\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the key to set on the object"},{"types":[{"type":"*"}],"name":"key","description":"the property value to set on the object\n\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"}}],"_curParam":{"types":[{"type":"*"}],"name":"key","description":"the property value to set on the object\n\n"},"pathToRoot":"../../.."};
</script>
</article>
