...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-onKeyValue.md
	@typedef can-symbol/symbols/onKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.onKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="onKeyValue.html">can.onKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-onKeyValue.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.onKeyValue( key, handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.onKeyValue</code> symbol points to a function that registers
<code>handler</code> to be called back with the new value of <code>key</code> when <code>key</code>
changes.</p>
<pre><code>var obj = {
   handlers: {},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the string key to bind on changes to.</p>
</li>
        
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler must be called back with <code>this</code> as the instance of the observable.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-onKeyValue.md"},"description":"Defines how observable values can be listened to on a type. \n","type":"typedef","title":"can.onKeyValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}]}]}],"name":"can-symbol/symbols/onKeyValue","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.onKeyValue( key, handler(newValue) )","description":"\n\nThe `@@can.onKeyValue` symbol points to a function that registers \n `handler` to be called back with the new value of `key` when `key`\n changes.  \n\n ```\nvar obj = {\n\thandlers: {},\n\tsetKeyValue: function(key, value){\n\t\tthis[key] = value;\n\t\tvar self = this;\n\t\tobj.handlers[key].forEach(function(handler){\n\t\t\thandler.call(self, value);\n\t\t});\n\t}\n};\n\nobj[canSymbol.for(\"can.onKeyValue\")] = function(key, handler){\n\tif(!obj.handlers[key]) {\n\t\tobj.handlers[key] = [];\n\t}\n\tobj.handlers[key].push(handler);\n}\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the string key to bind on changes to."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable. \n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any Map-like object with named properties"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable. \n"},"pathToRoot":"../../.."};
</script>
</article>
