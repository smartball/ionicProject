...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-valueHasDependencies.md
	@typedef can-symbol/symbols/valueHasDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.valueHasDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="valueHasDependencies.html">can.valueHasDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.valueHasDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-valueHasDependencies.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function that checks if there are any other observable objects that affect the value of the object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.valueHasDependencies()</code>
  </h2>
  <p>The <code>@@can.valueHasDependencies</code> symbol points to a function that returns <code>true</code> if there are any other events or property
changes that will trigger an event for the value on the context object;
<code>false</code> otherwise.  By convention, if an object implementation distinguishes between unbound objects or values, and those
which are bound without external dependencies (as is the case with <a href="../../can-compute.html" title="Create an observable value.">can-compute</a>), <code>@@can.valueHasDependencies</code> may return
...
obj[canSymbol.for(&quot;can.valueHasDependencies&quot;)] = function() {
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>true if there are any other objects or properties that the object's value depends on</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-valueHasDependencies.md"},"description":"Define a function that checks if there are any other observable objects that affect the value of the object. \n","type":"typedef","title":"can.valueHasDependencies","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/valueHasDependencies","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.valueHasDependencies()","description":"\n\nThe `@@can.valueHasDependencies` symbol points to a function that returns `true` if there are any other events or property\nchanges that will trigger an event for the value on the context object; \n`false` otherwise.  By convention, if an object implementation distinguishes between unbound objects or values, and those \nwhich are bound without external dependencies (as is the case with [can-compute]), `@@can.valueHasDependencies` may return \n`undefined` for unbound objects instead of `false`.\n\n```\nvar someOtherObj;\nvar internalValue;\nfunction computed(value) {\n\tif(arguments.length >= 1) {\n\t\tinternalValue = value;\n\t\tobj.__bindEvents.forEach(function(handler) {\n\t\t\thandler.call(this, value);\n\t\t});\n\t} else {\n\t\treturn internalValue;\n\t}\n}\nobj.__bindEvents = [{ \n\thandler: function() {},\n\treads: [{ object: someOtherObj }]\n}];\n\nobj[canSymbol.for(\"can.valueHasDependencies\")] = function() {\n\treturn this.__bindEvents && \n\t\tthis.__bindEvents.filter(function(binding) {\n\t\t\treturn binding.reads && binding.reads.length > 0;\n\t\t}).length > 0;\n};\n```\n","params":[],"context":{"types":[{"type":"*"}],"description":"any value-like object"},"returns":{"types":[{"type":"Boolean"}],"description":"true if there are any other objects or properties that the object's value depends on\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"true if there are any other objects or properties that the object's value depends on\n"},"pathToRoot":"../../.."};
</script>
</article>
