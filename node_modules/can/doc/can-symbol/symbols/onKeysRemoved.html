...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-onKeysRemoved.md
	@typedef can-symbol/symbols/onKeysRemoved
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.onKeysRemoved</title>
...
<div class="breadcrumb">
	...
	<li><a href="onKeysRemoved.html">can.onKeysRemoved</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onKeysRemoved</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-onKeysRemoved.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function used to listen to when the object's key set has keys removed through deletion.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.onKeysRemoved( handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.onKeysRemoved</code> symbol points to a function that registers
<code>handler</code> to be called back when the keys on the object
change via properties deleted.</p>
<pre><code>var obj = {
    handlers: {},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler must be called back with <code>this</code> as the instance of the observable, and passed the removed keys as an Array.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-onKeysRemoved.md"},"description":"Define a function used to listen to when the object's key set has keys removed through deletion. \n","type":"typedef","title":"can.onKeysRemoved","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}]}]}],"name":"can-symbol/symbols/onKeysRemoved","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.onKeysRemoved( handler(newValue) )","description":"\n\nThe `@@can.onKeysRemoved` symbol points to a function that registers \n `handler` to be called back when the keys on the object\n change via properties deleted.\n\n```\nvar obj = {\n\thandlers: {},\n\tremoveKeyValue: function(key){\n\t\tvar result = delete this[key];\n\t\tvar keyStillExists = this[canSymbol.for(\"hasOwnKey\")](key);\n\t\tvar self = this;\n\t\tif(result && !keyStillExists) {\n\t\t\tobj.handlers.__keysRemoved.forEach(function(handler){\n\t\t\t\thandler.call(self, [key]);\n\t\t\t});\n\t\t}\n\t}\n};\n\nobj[canSymbol.for(\"can.onKeysRemoved\")] = function(handler){\n\tif(!obj.handlers.__keysRemoved) {\n\t\tobj.handlers.__keysRemoved = [];\n\t}\n\tobj.handlers.__keysRemoved.push(handler);\n}\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the removed keys as an Array.\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any Map-like object with named properties"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the removed keys as an Array.\n"},"pathToRoot":"../../.."};
</script>
</article>
