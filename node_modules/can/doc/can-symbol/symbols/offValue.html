...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-offValue.md
	@typedef can-symbol/symbols/offValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.offValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="offValue.html">can.offValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.offValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-offValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines how observables can stop listening to the object's value changing.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.offValue( handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.offValue</code> symbol points to a function that unregisters
<code>handler</code> from being called when the object's value
changes.</p>
<pre><code>var obj = function(value) {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler was previously added with <a href="onValue.html" title="Defines how observables can listen to the object's value changing."><code>@@can.onValue</code></a>.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-offValue.md"},"description":"Defines how observables can stop listening to the object's value changing. \n","type":"typedef","title":"can.offValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}]}]}],"name":"can-symbol/symbols/offValue","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.offValue( handler(newValue) )","description":"\n\nThe `@@can.offValue` symbol points to a function that unregisters \n `handler` from being called when the object's value\n changes.  \n\n```\nvar obj = function(value) {\n\tif(arguments.length >= 1) {\n\t\tobj.currentValue = value;\n\t\tobj.handlers.forEach(function(handler){\n\t\t\thandler.call(obj, value);\n\t\t});\n\t} else {\n\t\treturn obj.currentValue;\n\t}\n};\n\nobj[canSymbol.for(\"can.offValue\")] = function(handler){\n\tif(!obj.handlers) {\n\t\tobj.handlers = [];\n\t}\n\tobj.handlers.splice(obj.handlers.indexOf(handler), 1);\n}\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler was previously added with [can-symbol/symbols/onValue `@@can.onValue`]. \n"}],"context":{"types":[{"type":"*"}],"description":"any object with a mutable value"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler was previously added with [can-symbol/symbols/onValue `@@can.onValue`]. \n"},"pathToRoot":"../../.."};
</script>
</article>
