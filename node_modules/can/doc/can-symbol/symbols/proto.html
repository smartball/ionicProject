...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-proto.md
	@typedef can-symbol/symbols/proto
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.proto</title>
...
<div class="breadcrumb">
	...
	<li><a href="proto.html">can.proto</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.proto</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-proto.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines the &quot;proto&quot; (first element in the prototype chain) of an object</p>
...
<div class="signature">
  ...
  <p>The <code>@@can.proto</code> symbol is placed on an object to reference its prototype.  Since the non-standard <code>__proto__</code> is deprecated, this can serve as a prototype chain reference without invoking <code>Object.getPrototypeOf()</code> every time.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-proto.md"},"description":"Defines the \"proto\" (first element in the prototype chain) of an object \n\n","type":"typedef","title":"can.proto","types":[{"type":"Object","options":[]}],"name":"can-symbol/symbols/proto","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.proto","description":"\n\nThe `@@can.proto` symbol is placed on an object to reference its prototype.  Since the non-standard `__proto__` is deprecated, this can serve as a prototype chain reference without invoking `Object.getPrototypeOf()` every time.\n\n```\nfunction Foo() {}\nFoo.prototype = {\n\tbar: \"baz\"\n};\n\nvar obj = new Foo();\nobj[canSymbol.for(\"can.proto\")] = Foo.prototype;\n\n```\n","params":[]}],"pathToRoot":"../../.."};
</script>
</article>
