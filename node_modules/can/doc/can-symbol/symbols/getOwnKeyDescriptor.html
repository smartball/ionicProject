...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getOwnKeyDescriptor.md
	@typedef can-symbol/symbols/getOwnKeyDescriptor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getOwnKeyDescriptor</title>
...
<div class="breadcrumb">
	...
	<li><a href="getOwnKeyDescriptor.html">can.getOwnKeyDescriptor</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getOwnKeyDescriptor</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getOwnKeyDescriptor.md">Edit on GitHub</a>
				</li>
    ...
    <p>Describe the attributes of an object's keyed property.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getOwnKeyDescriptor(key)</code>
  </h2>
  <p>Return a single key's descriptor from the object, as defined by the custom behavior of this function.</p>
<pre><code>var shapeless = {};
...
thingsInMyEar[canSymbol.for('can.getOwnKeyDescriptor')] = function(key) { 
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The string key to look up on the object</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a property descriptor, containing the keys <code>configurable</code>, <code>enumerable</code>, and either <code>value</code> and <code>writable</code>, or <code>get</code> and <code>set</code>, if the property exists on the object; <code>undefined</code> otherwise.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getOwnKeyDescriptor.md"},"description":"Describe the attributes of an object's keyed property. \n","type":"typedef","title":"can.getOwnKeyDescriptor","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/getOwnKeyDescriptor","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.getOwnKeyDescriptor(key)","description":"\n\nReturn a single key's descriptor from the object, as defined by the custom behavior of this function.\n\n\n```\nvar shapeless = {};\n\n// Nothing enumerable in a shapeless object\nshapeless[canSymbol.for('can.getOwnKeyDescriptor')] = function() { return; }\n\n// Banana is on the prototype chain, so default \"own key descriptor\" functions would not return it.\nvar thingsInMyEar = Object.create(\n\t\"banana\": {\n\t\tpeeled: false\n\t}\n});\n\nthingsInMyEar[canSymbol.for('can.getOwnKeyDescriptor')] = function(key) { \n\tif(Object.getOwnPropertyNames(this).indexOf(key) || key === \"banana\") {\n\t\treturn !!Object.getOwnPropertyDescriptor(this, key) ||\n\t\t\tthis[canSysmbol.for('can.getOwnKeyDescritpor')].call(this[canSymbol.for('proto')], key);\n\t};  // There's always a banana in my ear\n};\n\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The string key to look up on the object"}],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"},"returns":{"types":[{"type":"Object","options":[]}],"description":"a property descriptor, containing the keys `configurable`, `enumerable`, and either `value` and `writable`, or `get` and `set`, if the property exists on the object; `undefined` otherwise.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The string key to look up on the object"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a property descriptor, containing the keys `configurable`, `enumerable`, and either `value` and `writable`, or `get` and `set`, if the property exists on the object; `undefined` otherwise.\n"},"pathToRoot":"../../.."};
</script>
</article>
