...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-apply.md
	@typedef can-symbol/symbols/apply
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.apply</title>
...
<div class="breadcrumb">
	...
	<li><a href="apply.html">can.apply</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.apply</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-apply.md">Edit on GitHub</a>
				</li>
    ...
    <p>How to apply a List-like as the arguments to a call of the function.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.apply( obj, args )</code>
  </h2>
  <p>The <code>can.apply</code> symbol points to a Function or callable object's apply function, which converts an ArrayLike of arguments into the positional parameters and calls the function with them.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to call the function on as the bound element</p>
</li>
        
          <li><b>args</b> <code>{ArrayLike}</code>: <p>The list of arguments to pass to the function</p>
<pre><code>function func(c) {
   return c.process();
};
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-apply.md"},"description":"How to apply a List-like as the arguments to a call of the function. \n","type":"typedef","title":"can.apply","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Object","options":[]}]},{"types":[{"type":"ArrayLike"}]}]}],"name":"can-symbol/symbols/apply","parent":"can-symbol/symbols/call","signatures":[{"code":"@@can.apply( obj, args )","description":"\n\nThe `can.apply` symbol points to a Function or callable object's apply function, which converts an ArrayLike of arguments into the positional parameters and calls the function with them.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to call the function on as the bound element"},{"types":[{"type":"ArrayLike"}],"name":"args","description":"The list of arguments to pass to the function\n\n\n ```\nfunction func(c) {\n\treturn c.process();\n};\n\n// Handle non-native lists or even non-list-likes being passed in\nobj[canSymbol.for('can.apply')] = function(ctx, list) {\n\tlist = list.serialize ? list.serialize() : list;\n\tif(!list[canSymbol.for('can.isListLike')]) {\n\t\tlist = [list];\n\t}\n\treturn Function.prototype.apply.call(this, ctx, list); \n};\n```\n"}],"context":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"a function or callable"}}],"_curParam":{"types":[{"type":"ArrayLike"}],"name":"args","description":"The list of arguments to pass to the function\n\n\n ```\nfunction func(c) {\n\treturn c.process();\n};\n\n// Handle non-native lists or even non-list-likes being passed in\nobj[canSymbol.for('can.apply')] = function(ctx, list) {\n\tlist = list.serialize ? list.serialize() : list;\n\tif(!list[canSymbol.for('can.isListLike')]) {\n\t\tlist = [list];\n\t}\n\treturn Function.prototype.apply.call(this, ctx, list); \n};\n```\n"},"pathToRoot":"../../.."};
</script>
</article>
