...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-keyHasDependencies.md
	@typedef can-symbol/symbols/keyHasDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.keyHasDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="keyHasDependencies.html">can.keyHasDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.keyHasDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-keyHasDependencies.md">Edit on GitHub</a>
				</li>
    ...
    <p>Check if there are any other objects that affect the value of a named property.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.keyHasDependencies(key)</code>
  </h2>
  <p>The <code>@@can.keyHasDependencies</code> symbol points to a function that returns <code>true</code> if there are any other events or property
changes that will change the value of the property on the context object with key <code>key</code>; <code>false</code> otherwise.<br />
By convention, if an object implementation distinguishes between unbound objects or values, and those
which are bound without external dependencies (as is the case with <a href="../../can-map.html" title="Create observable objects.">can-map</a>), <code>@@can.keyHasDependencies</code> may return
<code>undefined</code> for unbound objects instead of <code>false</code>.</p>
...
obj[canSymbol.for(&quot;can.keyHasDependencies&quot;)] = function(key) {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key to check for dependent bindings</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>true if there are any other objects that this keyed propertey depends on</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-keyHasDependencies.md"},"description":"Check if there are any other objects that affect the value of a named property. \n","type":"typedef","title":"can.keyHasDependencies","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/keyHasDependencies","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.keyHasDependencies(key)","description":"\n\nThe `@@can.keyHasDependencies` symbol points to a function that returns `true` if there are any other events or property \nchanges that will change the value of the property on the context object with key `key`; `false` otherwise.  \nBy convention, if an object implementation distinguishes between unbound objects or values, and those \nwhich are bound without external dependencies (as is the case with [can-map]), `@@can.keyHasDependencies` may return \n`undefined` for unbound objects instead of `false`.\n\n```\nvar someOtherObj;\nvar obj = {\n\t__bindEvents: {\n\t\tfoo: [{ \n\t\t\thandler: function() {},\n\t\t\treads: [{ object: someOtherObj, key: \"bar\" }]\n\t\t}]\n\t}\n};\n\nobj[canSymbol.for(\"can.keyHasDependencies\")] = function(key) {\n\treturn this.__bindEvents[key] && \n\t\tthis.__bindEvents[key].filter(function(binding) {\n\t\t\treturn binding.reads && binding.reads.length > 0;\n\t\t}).length > 0;\n};\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the key to check for dependent bindings"}],"context":{"types":[{"type":"MapLike"}],"description":"any map-like object with named properties"},"returns":{"types":[{"type":"Boolean"}],"description":"true if there are any other objects that this keyed propertey depends on\n\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key to check for dependent bindings"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"true if there are any other objects that this keyed propertey depends on\n\n"},"pathToRoot":"../../.."};
</script>
</article>
