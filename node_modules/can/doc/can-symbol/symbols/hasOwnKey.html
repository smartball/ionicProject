...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-hasOwnKey.md
	@typedef can-symbol/symbols/hasOwnKey
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.hasOwnKey</title>
...
<div class="breadcrumb">
	...
	<li><a href="hasOwnKey.html">can.hasOwnKey</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.hasOwnKey</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-hasOwnKey.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function to determine key membership of an object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.hasOwnKey(key)</code>
  </h2>
  <p>The <code>@@can.hasOwnKey</code> symbol points to a function on an object that, given a String key, determines whether the key is a member of the object's own key set (not that of the prototype chain).</p>
...
thingsInMyEar[canSymbol('can.hasOwnKey')] = function(key) { 
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the string key for which to test membership in the object</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>true if there is a property on the object with a matching key, false otherwise.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-hasOwnKey.md"},"description":"Define a function to determine key membership of an object \n","type":"typedef","title":"can.hasOwnKey","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/hasOwnKey","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.hasOwnKey(key)","description":"\n\nThe `@@can.hasOwnKey` symbol points to a function on an object that, given a String key, determines whether the key is a member of the object's own key set (not that of the prototype chain).\n\n```\nvar shapeless = {};\n\n// Nothing enumerable in a shapeless object\nshapeless[canSymbol.for('can.hasOwnKey')] = function() { return false; }\n\nvar thingsInMyEar = {};\nObject.setPrototypeOf(thingsInMyEar, {\n\t\"banana\": {\n\t\tpeeled: false\n\t}\n});\n\nthingsInMyEar[canSymbol('can.hasOwnKey')] = function(key) { \n\treturn key === \"banana\" || Object.getOwnPropertyNames(this).indexOf(key) > -1\n\t// There's always a banana in my ear\n};\n\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the string key for which to test membership in the object"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any object with key properties"},"returns":{"types":[{"type":"Boolean"}],"description":"true if there is a property on the object with a matching key, false otherwise.\n\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the string key for which to test membership in the object"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"true if there is a property on the object with a matching key, false otherwise.\n\n"},"pathToRoot":"../../.."};
</script>
</article>
