...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-isFunctionLike.md
	@typedef can-symbol/symbols/isListLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.isListLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="isListLike.html">can.isListLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.isListLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-isFunctionLike.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.isListLike</code>
  </h2>
  <p>Setting the value of <code>can.isListLike</code> to <code>true</code> on an object shows that this object can be used with numeric properties, like a <a href="../../can-define/list/list.html" title="Create observable lists.">DefineList</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-isFunctionLike.md"},"description":"Set to `true` on objects with numeric indexes and length. \n","type":"typedef","title":"can.isListLike","types":[{"type":"Boolean"}],"name":"can-symbol/symbols/isListLike","parent":"can-symbol/symbols/type","signatures":[{"code":"@@can.isListLike","description":"\n\nSetting the value of `can.isListLike` to `true` on an object shows that this object can be used with numeric properties, like a [can-define/list/list DefineList].\n","params":[]}],"pathToRoot":"../../.."};
</script>
</article>
