...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getOwnKeys.md
	@typedef can-symbol/symbols/getOwnKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getOwnKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="getOwnKeys.html">can.getOwnKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getOwnKeys</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getOwnKeys.md">Edit on GitHub</a>
				</li>
    ...
    <p>List which keys an object has of its own (not other objects on the prototype chain).</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getOwnKeys()</code>
  </h2>
  <p>Return all string keys on an object, including those whose corresponding properties are defined not to be enumerable.</p>
...
thingsInMyEar[canSymbol('can.getOwnEnumerableKeys')] = function() { 
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>an array of Strings representing the object's string keys.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getOwnKeys.md"},"description":"List which keys an object has of its own (not other objects on the prototype chain). \n","type":"typedef","title":"can.getOwnKeys","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/getOwnKeys","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.getOwnKeys()","description":"\n\nReturn all string keys on an object, including those whose corresponding properties are defined not to be enumerable.\n\n```\nvar shapeless = {};\n\n// Nothing enumerable in a shapeless object\nshapeless[canSymbol.for('can.getOwnKeys')] = function() { return []; }\n\nvar thingsInMyEar = {};\nObject.setPrototypeOf(thingsInMyEar, {\n\t\"banana\": {\n\t\tpeeled: false\n\t}\n});\n\nthingsInMyEar[canSymbol('can.getOwnEnumerableKeys')] = function() { \n\treturn Object.getOwnPropertyNames(this)\n\t\t.concat([\"banana\"]);  // There's always a banana in my ear\n};\n\n```\n","params":[],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"},"returns":{"types":[{"type":"Array","options":[]}],"description":"an array of Strings representing the object's string keys.\n\n"}}],"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"an array of Strings representing the object's string keys.\n\n"},"pathToRoot":"../../.."};
</script>
</article>
