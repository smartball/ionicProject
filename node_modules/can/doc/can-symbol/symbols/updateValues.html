...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-updateValues.md
	@typedef can-symbol/symbols/updateValues
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.updateValues</title>
...
<div class="breadcrumb">
	...
	<li><a href="updateValues.html">can.updateValues</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.updateValues</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-updateValues.md">Edit on GitHub</a>
				</li>
    ...
    <p>Add and remove multiple values at once.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.updateValues( index, removing, adding )</code>
  </h2>
  <p>The <code>@@can.updateValues</code> symbol points to a function that can add
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>index</b> <code>{Number}</code>: </li>
        
          <li><b>removing</b> <code>{Array}</code>: <p>An array of the items to remove.</p>
</li>
        
          <li><b>adding</b> <code>{Array}</code>: <p>An Array of the items to add.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-updateValues.md"},"description":"Add and remove multiple values at once. \n","type":"typedef","title":"can.updateValues","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/updateValues","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.updateValues( index, removing, adding )","description":"\n\nThe `@@can.updateValues` symbol points to a function that can add\nand remove multiple items at once.  It's similar to splice, but\nis passed an array of items to remove instead of how many items to\nbe removed.\n\n","params":[{"types":[{"type":"Number"}],"name":"index","description":""},{"types":[{"type":"Array","options":[]}],"name":"removing","description":"An array of the items to remove."},{"types":[{"type":"Array","options":[]}],"name":"adding","description":"An Array of the items to add.\n"}],"context":{"types":[{"type":"*"}],"description":"Anything object with this symbol."}}],"_curParam":{"types":[{"type":"Array","options":[]}],"name":"adding","description":"An Array of the items to add.\n"},"pathToRoot":"../../.."};
</script>
</article>
