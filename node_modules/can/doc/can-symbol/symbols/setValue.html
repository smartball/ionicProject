...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-setValue.md
	@typedef can-symbol/symbols/setValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.setValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="setValue.html">can.setValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.setValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-setValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function that sets the object's value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.setValue( value )</code>
  </h2>
  <p>The <code>@@can.setValue</code> symbol points to a function that sets the current value on the context object. &quot;Value&quot; may mean different
things in different contexts; e.g. setting a <a href="../../can-compute.html" title="Create an observable value.">can-compute</a>'s value updates the value stored internally to the compute, while setting an observable object's value will update all of the same-keyed properties of the object argument.</p>
<pre><code>var internalValue = undefined
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{*}</code>: <p>any appropriate value to set on the object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-setValue.md"},"description":"Define a function that sets the object's value.   \n","type":"typedef","title":"can.setValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/setValue","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.setValue( value )","description":"\n\nThe `@@can.setValue` symbol points to a function that sets the current value on the context object. \"Value\" may mean different\nthings in different contexts; e.g. setting a [can-compute]'s value updates the value stored internally to the compute, while setting an observable object's value will update all of the same-keyed properties of the object argument.\n\n```\nvar internalValue = undefined\nexport var foo = function(val) {\n\tif(val) {\n\t\tinternalValue = val;\n\t} else {\n\t\treturn internalValue;\n\t}\n};\n\n// Get the internal value as the representative value\nfoo[canSymbol.for('can.setValue')] = function(value) {\n\tinternalValue = value;\n}\n\n```\n","params":[{"types":[{"type":"*"}],"name":"value","description":"any appropriate value to set on the object\n"}],"context":{"types":[{"type":"*"}],"description":"anything that can be resolved to a value"}}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"any appropriate value to set on the object\n"},"pathToRoot":"../../.."};
</script>
</article>
