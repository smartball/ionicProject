...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getOwnEnumerableKeys.md
	@typedef can-symbol/symbols/getOwnEnumerableKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getOwnEnumerableKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="getOwnEnumerableKeys.html">can.getOwnEnumerableKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getOwnEnumerableKeys</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getOwnEnumerableKeys.md">Edit on GitHub</a>
				</li>
    ...
    <p>List the enumerable keys (as defined by its property descriptor) an object has, but not those from its prototype chain.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getOwnEnumerableKeys()</code>
  </h2>
  <p>Return the array of enumerable keys for the object, as defined by the custom behavior of this function.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>An array of enumerable key strings on the object.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getOwnEnumerableKeys.md"},"description":"List the enumerable keys (as defined by its property descriptor) an object has, but not those from its prototype chain. \n","type":"typedef","title":"can.getOwnEnumerableKeys","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/getOwnEnumerableKeys","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.getOwnEnumerableKeys()","description":"\n\nReturn the array of enumerable keys for the object, as defined by the custom behavior of this function.\n","params":[],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"},"returns":{"types":[{"type":"Array","options":[]}],"description":"An array of enumerable key strings on the object.\n\n\n```\nvar shapeless = {};\n\n// Nothing enumerable in a shapeless object\nshapeless[canSymbol.for('can.getOwnEnumerableKeys')] = function() { return []; }\n\nvar thingsInMyEar = {};\nObject.defineProperty(thingsInMyEar, \"banana\", {\n\tenumerable: false,\n\tvalue: {\n\t\tpeeled: false\n\t}\n});\n\nthingsInMyEar[canSymbol('can.getOwnEnumerableKeys')] = function() { \n\treturn Object.getOwnPropertyNames(this).filter(function(key) { \n\t\treturn !!Object.getOwnPropertyDescriptor(this, key).enumerable \n\t}.bind(this))\n\t.concat([\"banana\"]);  // There's always a banana in my ear\n};\n\n```\n"}}],"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"An array of enumerable key strings on the object.\n\n\n```\nvar shapeless = {};\n\n// Nothing enumerable in a shapeless object\nshapeless[canSymbol.for('can.getOwnEnumerableKeys')] = function() { return []; }\n\nvar thingsInMyEar = {};\nObject.defineProperty(thingsInMyEar, \"banana\", {\n\tenumerable: false,\n\tvalue: {\n\t\tpeeled: false\n\t}\n});\n\nthingsInMyEar[canSymbol('can.getOwnEnumerableKeys')] = function() { \n\treturn Object.getOwnPropertyNames(this).filter(function(key) { \n\t\treturn !!Object.getOwnPropertyDescriptor(this, key).enumerable \n\t}.bind(this))\n\t.concat([\"banana\"]);  // There's always a banana in my ear\n};\n\n```\n"},"pathToRoot":"../../.."};
</script>
</article>
