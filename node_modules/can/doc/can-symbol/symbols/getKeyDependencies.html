...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getKeyDependencies.md
	@typedef can-symbol/symbols/getKeyDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getKeyDependencies</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="getOwnEnumerableKeys.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="getValueDependencies.html"
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="valueHasDependencies.html"
...
<div class="breadcrumb">
	...
	<li><a href="getKeyDependencies.html">can.getKeyDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getKeyDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getKeyDependencies.md">Edit on GitHub</a>
				</li>
    ...
    <p>A symbol placed on a constructor to reference a function that returns the other events that will trigger an event for the key on the object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getKeyDependencies(key)</code>
  </h2>
  <p>The <code>@@can.getKeyDependencies</code> symbol points to a function that returns an object containing all values that affect the
value of a computed property of this Map-like object, keyed on <code>key</code>.<br />
If the dependencies include properties on a Map-like object, they are placed in a <a href="../../can-util/js/cid-map/cid-map.html" title="Deprecated. Use map instead.">CIDMap</a>
keyed on <code>keyDependencies</code> in the return object. If the dependencies include the values of Value-like objects, they are
placed in a <a href="../../can-util/js/cid-set/cid-set.html" title="Deprecated. Use set instead.">CIDSet</a> keyed on <code>valueDependencies</code>.
Return <code>undefined</code> if the value is not computed, or an empty object if a key is computed without external dependencies.</p>
<pre><code>var someOtherObj;
...
obj[canSymbol.for(&quot;can.getKeyDependencies&quot;)] = function(key) {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>a property key on <code>this</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>an object of key dependencies in a CIDMap and value dependencies in a CIDSet</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getKeyDependencies.md"},"description":"A symbol placed on a constructor to reference a function that returns the other events that will trigger an event for the key on the object. \n","type":"typedef","title":"can.getKeyDependencies","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/getKeyDependencies","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.getKeyDependencies(key)","description":"\n\nThe `@@can.getKeyDependencies` symbol points to a function that returns an object containing all values that affect the\nvalue of a computed property of this Map-like object, keyed on `key`.  \nIf the dependencies include properties on a Map-like object, they are placed in a [can-util/js/cid-map/cid-map CIDMap] \nkeyed on `keyDependencies` in the return object. If the dependencies include the values of Value-like objects, they are \nplaced in a [can-util/js/cid-set/cid-set CIDSet] keyed on `valueDependencies`.\nReturn `undefined` if the value is not computed, or an empty object if a key is computed without external dependencies.\n\n```\nvar someOtherObj;\n// This is a clear but not very useful implementation of a computed key value.\n//  Map-likes in CanJS are backed by can-computes and can-observations, and we recommend can-observation for new development.\nvar obj = {\n\t_computedAttrs: {\n\t\tfoo: [{ \n\t\t\thandler: function() { return canReflect.getKeyValue(someOtherObj, \"bar\") },\n\t\t\treads: [{ object: someOtherObj, key: \"bar\" }]\n\t\t}]\n\t}\n};\n\nobj[canSymbol.for(\"can.getKeyDependencies\")] = function(key) {\n  var ret;\n  if(this._computedAttrs[key]) {\n  \tret = {};\n  \tthis._computedAttrs[key].reads.forEach(function(read) {\n  \t\tif(read.key) {\n  \t\t\tret.keyDependencies = ret.keyDependencies || new CIDMap();\n  \t\t\tif(!ret.keyDependencies.has(read.object)) {\n  \t\t\t\tret.keyDependencies.add(read.object, []);\n  \t\t\t}\n  \t\t\tret.keyDependencies.get(read.object).push(read.key);\n  \t\t} else {\n  \t\t\tret.valueDependencies = ret.valueDependencies || new CIDMap();\n  \t\t\tret.valueDependencies.add(read.object);\n  \t\t}\n  \t});\n  }\n  return ret;\n};\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"a property key on `this`"}],"context":{"types":[{"type":"Object","options":[]}],"description":"obj a Map-like object"},"returns":{"types":[{"type":"Object","options":[]}],"description":"an object of key dependencies in a CIDMap and value dependencies in a CIDSet\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"a property key on `this`"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"an object of key dependencies in a CIDMap and value dependencies in a CIDSet\n"},"pathToRoot":"../../.."};
</script>
</article>
