...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-new.md
	@property can-symbol/symbols/new
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.new</title>
...
<div class="breadcrumb">
	...
	<li><a href="new.html">can.new</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.new</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-new.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a new instance of a constructor function or prototype object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.new(...args)</code>
  </h2>
  <p>The <code>@@can.new</code> symbol points to a function that constructs and returns a new instance object.  It is left to the
implementation to create the object, set the prototype chain, and handle any arguments passed to the constructor.</p>
...
prototype[canSymbol.for(&quot;can.new&quot;)] = function(props) {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>args</b> <code>{*}</code>: <p>pass any number of parameters of any type</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A new instance of the type.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-new.md"},"description":"Create a new instance of a constructor function or prototype object. \n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"variable":true}]}],"title":"can.new","name":"can-symbol/symbols/new","type":"property","parent":"can-symbol/symbols/call","signatures":[{"code":"@@can.new(...args)","description":"\n\nThe `@@can.new` symbol points to a function that constructs and returns a new instance object.  It is left to the\nimplementation to create the object, set the prototype chain, and handle any arguments passed to the constructor.\n\n```\nfunction constructor() {}\nconstructor.prototype = { foo: \"bar\" };\n\n// ES6 rest and spread params used below to be concise.\nconstructor[canSymbol.for(\"can.new\")] = function(...args) {\n\treturn new this(...args);\n};\n\nvar prototype = { baz: \"quux\" };\nprototype[canSymbol.for(\"can.new\")] = function(props) {\n\treturn Object.create(this, props);\n};\n```\n","params":[{"types":[{"type":"*"}],"name":"args","description":"pass any number of parameters of any type"}],"context":{"types":[{"type":"*"}],"description":"A callable constructor or a prototype object."},"returns":{"types":[{"type":"Object","options":[]}],"description":"A new instance of the type.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"args","description":"pass any number of parameters of any type"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A new instance of the type.\n"},"pathToRoot":"../../.."};
</script>
</article>
