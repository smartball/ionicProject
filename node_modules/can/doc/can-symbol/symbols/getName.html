...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getName.md
	@typedef can-symbol/symbols/getName
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getName</title>
...
<div class="breadcrumb">
	...
	<li><a href="getName.html">can.getName</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getName</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getName.md">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a human-readable name of an object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getName()</code>
  </h2>
  <p>The <code>@@can.getName</code> symbol points to a function that returns human-readable name of the object. Depending on the context this name could be decorated with extra information, like the <code>cid</code> of a given instance.</p>
...
obj[canSymbol.for('can.getName')]() //-&gt; &quot;MyFooFunction&quot;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The name of the object/function</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getName.md"},"description":"Returns a human-readable name of an object \n","type":"typedef","title":"can.getName","types":[{"type":"Boolean"}],"name":"can-symbol/symbols/getName","parent":"can-symbol/symbols/shape","signatures":[{"code":"@@can.getName()","description":"\n\nThe `@@can.getName` symbol points to a function that returns human-readable name of the object. Depending on the context this name could be decorated with extra information, like the `cid` of a given instance. \n\n\n```js\nvar foo = function() {};\n\nfoo[canSymbol.for('can.getName')] = function() {\n\treturn \"MyFooFunction\";\n};\n\nobj[canSymbol.for('can.getName')]() //-> \"MyFooFunction\"\n```\n","params":[],"returns":{"types":[{"type":"String"}],"description":"The name of the object/function\n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"The name of the object/function\n"},"pathToRoot":"../../.."};
</script>
</article>
