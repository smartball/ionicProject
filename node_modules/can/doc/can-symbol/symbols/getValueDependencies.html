...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getValueDependencies.md
	@typedef can-symbol/symbols/getValueDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getValueDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="getValueDependencies.html">can.getValueDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getValueDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getValueDependencies.md">Edit on GitHub</a>
				</li>
    ...
    <p>A symbol placed on a constructor to reference a function that returns the other events that will trigger a value change event on the object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getValueDependencies()</code>
  </h2>
  <p>The <code>@@can.getValueDependencies</code> symbol points to a function that returns an object containing all values that affect the
...
val[canSymbol.for(&quot;can.getValueDependencies&quot;)] = function(key) {
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>an object with an optional CIDMap of key dependencies and an optional CIDSet of value dependencies</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getValueDependencies.md"},"description":"A symbol placed on a constructor to reference a function that returns the other events that will trigger a value change event on the object. \n","type":"typedef","title":"can.getValueDependencies","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"ValueLike"}]}]}],"name":"can-symbol/symbols/getValueDependencies","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.getValueDependencies()","description":"\n\nThe `@@can.getValueDependencies` symbol points to a function that returns an object containing all values that affect the\nvalue of this Value-like object.\nIf the dependencies include properties on a Map-like object, they are placed in a [can-util/js/cid-map/cid-map CIDMap] \nkeyed on `keyDependencies` in the return object. If the dependencies include the values of Value-like objects, they are \nplaced in a [can-util/js/cid-set/cid-set CIDSet] keyed on `valueDependencies`.\nReturn `undefined` if the value is not computed, or an empty object if a key is computed without external dependencies.\n\n```\nvar someOtherObj;\n// This is a clear but not very useful implementation of a computed value.\n// We recommend can-observation for new development of computed values.\nvar val = function() { \n\treturn canReflect.getKeyValue(someOtherObj, \"bar\");\n};\nval.reads: [{ object: someOtherObj, key: \"bar\" }]\n\nval[canSymbol.for(\"can.getValueDependencies\")] = function(key) {\n  var ret;\n  if(this.reads) {\n  \tret = {};\n  \tthis.reads.forEach(function(read) {\n  \t\tif(read.key) {\n  \t\t\tret.keyDependencies = ret.keyDependencies || new CIDMap();\n  \t\t\tif(!ret.keyDependencies.has(read.object)) {\n  \t\t\t\tret.keyDependencies.add(read.object, []);\n  \t\t\t}\n  \t\t\tret.keyDependencies.get(read.object).push(read.key);\n  \t\t} else {\n  \t\t\tret.valueDependencies = ret.valueDependencies || new CIDMap();\n  \t\t\tret.valueDependencies.add(read.object);\n  \t\t}\n  \t});\n  }\n  return ret;\n};\n```\n","params":[],"context":{"types":[{"type":"ValueLike"}],"description":"obj an object with its own value having possible dependencies on other values"},"returns":{"types":[{"type":"Object","options":[]}],"description":"an object with an optional CIDMap of key dependencies and an optional CIDSet of value dependencies\n"}}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"an object with an optional CIDMap of key dependencies and an optional CIDSet of value dependencies\n"},"pathToRoot":"../../.."};
</script>
</article>
