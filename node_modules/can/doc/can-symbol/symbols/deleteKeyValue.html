...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-deleteKeyValue.md
	@typedef can-symbol/symbols/deleteKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.deleteKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="deleteKeyValue.html">can.deleteKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.deleteKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-deleteKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines a function that deletes one of an object's named properties.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.deleteKeyValue( key )</code>
  </h2>
  <p>The <code>can.deleteKeyValue</code> symbol points to a Map-like object's property removal function, which removes the object's property with the supplied key. This is only applicable to objects where keyed properties are relevant (like maps).</p>
<pre><code>var map = {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key to remove from the object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-deleteKeyValue.md"},"description":"Defines a function that deletes one of an object's named properties. \n","type":"typedef","title":"can.deleteKeyValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/deleteKeyValue","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.deleteKeyValue( key )","description":"\n\nThe `can.deleteKeyValue` symbol points to a Map-like object's property removal function, which removes the object's property with the supplied key. This is only applicable to objects where keyed properties are relevant (like maps).\n\n```\nvar map = {\n\tremoveKey: function (key) {\n\t\tdelete this[key];\n\t}\n}\n\nmap[canSymbol.for('can.deleteKeyValue')] = map.removeKey;\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the key to remove from the object\n\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key to remove from the object\n\n"},"pathToRoot":"../../.."};
</script>
</article>
