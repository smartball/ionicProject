...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-onValue.md
	@typedef can-symbol/symbols/onValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.onValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="onValue.html">can.onValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-onValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines how observables can listen to the object's value changing.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.onValue( handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.onValue</code> symbol points to a function that registers
<code>handler</code> to be called back with the new value of the object when it
changes.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-onValue.md"},"description":"Defines how observables can listen to the object's value changing. \n","type":"typedef","title":"can.onValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}]}]}],"name":"can-symbol/symbols/onValue","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.onValue( handler(newValue) )","description":"\n\nThe `@@can.onValue` symbol points to a function that registers \n `handler` to be called back with the new value of the object when it\n changes.  \n\n```\nvar obj = function(value) {\n\tif(arguments.length >= 1) {\n\t\tobj.currentValue = value;\n\t\tobj.handlers.forEach(function(handler){\n\t\t\thandler.call(obj, value);\n\t\t});\n\t} else {\n\t\treturn obj.currentValue;\n\t}\n};\n\nobj[canSymbol.for(\"can.onValue\")] = function(handler){\n\tif(!obj.handlers) {\n\t\tobj.handlers = [];\n\t}\n\tobj.handlers.push(handler);\n}\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable. \n"}],"context":{"types":[{"type":"*"}],"description":"any object with a mutable value"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable. \n"},"pathToRoot":"../../.."};
</script>
</article>
