...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getIdentity.md
	@typedef can-symbol/symbols/getIdentity
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getIdentity</title>
...
<div class="breadcrumb">
	...
	<li><a href="getIdentity.html">can.getIdentity</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getIdentity</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getIdentity.md">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a name/label that identifies the object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getIdentity()</code>
  </h2>
  <p>The <code>@@can.getIdentity</code> symbol points to a function/value that labels the
identity of the object. Ideally this should be a unique identifier, like the
primary key (id) in a database table. The <code>@@can.getName</code> symbol behavior
uses the value of <code>@can.getIdentity</code> (if set) to decorate its output.</p>
<p>E.g:</p>
...
canReflect.getName(obj); // -&gt; Object&lt;15&gt;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The name/label that identifies the object</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getIdentity.md"},"description":"Returns a name/label that identifies the object \n","type":"typedef","title":"can.getIdentity","types":[{"type":"Boolean"}],"name":"can-symbol/symbols/getIdentity","parent":"can-symbol/symbols/shape","hide":true,"signatures":[{"code":"@@can.getIdentity()","description":"\n\nThe `@@can.getIdentity` symbol points to a function/value that labels the\nidentity of the object. Ideally this should be a unique identifier, like the\nprimary key (id) in a database table. The `@@can.getName` symbol behavior\nuses the value of `@can.getIdentity` (if set) to decorate its output.\n\nE.g:\n\n```js\nvar obj = {};\nvar canReflect = require(\"can-reflect\");\n\n// without setting `can.getIdentity`\ncanReflect.getName(obj); // -> Object<>\n\nfoo[canSymbol.for(\"can.getIdentity\")] = function() {\n\treturn \"15\";\n};\n\nobj[canSymbol.for(\"can.getIdentity\")](); //-> \"15\"\ncanReflect.getName(obj); // -> Object<15>\n```\n","params":[],"returns":{"types":[{"type":"String"}],"description":"The name/label that identifies the object \n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"The name/label that identifies the object \n"},"pathToRoot":"../../.."};
</script>
</article>
