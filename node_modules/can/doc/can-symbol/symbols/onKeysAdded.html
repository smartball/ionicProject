...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-onKeysAdded.md
	@typedef can-symbol/symbols/onKeysAdded
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.onKeysAdded</title>
...
<div class="breadcrumb">
	...
	<li><a href="onKeysAdded.html">can.onKeysAdded</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.onKeysAdded</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-onKeysAdded.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define a function used to listen to when the object's key set has new additions.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.onKeysAdded( handler(newValue) )</code>
  </h2>
  <p>The <code>@@can.onKeysAdded</code> symbol points to a function that registers
<code>handler</code> to be called back when the keys on the object
change via new properties added.</p>
<pre><code>var obj = {
    handlers: {},
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(newValue)}</code>: <p>The handler must be called back with <code>this</code> as the instance of the observable, and passed the added keys as an Array.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-onKeysAdded.md"},"description":"Define a function used to listen to when the object's key set has new additions. \n","type":"typedef","title":"can.onKeysAdded","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}]}]}],"name":"can-symbol/symbols/onKeysAdded","parent":"can-symbol/symbols/observe","signatures":[{"code":"@@can.onKeysAdded( handler(newValue) )","description":"\n\nThe `@@can.onKeysAdded` symbol points to a function that registers \n `handler` to be called back when the keys on the object\n change via new properties added.\n\n```\nvar obj = {\n\thandlers: {},\n\tsetKeyValue: function(key, value){\n\t\tvar newKey = this[canSymbol.for(\"hasOwnKey\")](key);\n\t\tthis[key] = value;\n\t\tvar self = this;\n\t\tif(newKey) {\n\t\t\tobj.handlers.__keysAdded.forEach(function(handler){\n\t\t\t\thandler.call(self, [key]);\n\t\t\t});\n\t\t}\n\t}\n};\n\nobj[canSymbol.for(\"can.onKeysAdded\")] = function(handler){\n\tif(!obj.handlers.__keysAdded) {\n\t\tobj.handlers.__keysAdded = [];\n\t}\n\tobj.handlers.__keysAdded.push(handler);\n}\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the added keys as an Array.\n"}],"context":{"types":[{"type":"Object","options":[]}],"description":"any Map-like object with named properties"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}],"name":"newValue"}],"context":{"types":[{"type":"*"}]}}],"name":"handler","description":"The handler must be called back with `this` as the instance of the observable, and passed the added keys as an Array.\n"},"pathToRoot":"../../.."};
</script>
</article>
