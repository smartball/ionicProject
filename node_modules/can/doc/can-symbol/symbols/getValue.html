...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getValue.md
	@typedef can-symbol/symbols/getValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="getValue.html">can.getValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines a function that returns the object's current value when called.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getValue()</code>
  </h2>
  <p>The <code>@@can.getValue</code> symbol points to a function that returns the context object's value. Value may mean different
things in different contexts; e.g. a <code>can-compute</code>'s value is the value stored internally to the compute, while an observable object's value may be a non-observable, serialized representation of its properties.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getValue.md"},"description":"Defines a function that returns the object's current value when called. \n","type":"typedef","title":"can.getValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-symbol/symbols/getValue","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.getValue()","description":"\n\nThe `@@can.getValue` symbol points to a function that returns the context object's value. Value may mean different\nthings in different contexts; e.g. a `can-compute`'s value is the value stored internally to the compute, while an observable object's value may be a non-observable, serialized representation of its properties.\n\n```\nvar internalValue = undefined\nexport var foo = function(val) {\n\tif(val) {\n\t\tinternalValue = val;\n\t} else {\n\t\treturn internalValue;\n\t}\n};\n\n// Get the internal value as the representative value\nfoo[canSymbol.for('can.getValue')] = function() { \n\treturn internalValue;\n}\n\n```\n","params":[],"context":{"types":[{"type":"*"}],"description":"anything that can be resolved to a value"},"returns":{"types":[{"type":"*"}],"description":"any value\n"}}],"_curReturn":{"types":[{"type":"*"}],"description":"any value\n"},"pathToRoot":"../../.."};
</script>
</article>
