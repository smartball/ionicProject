...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-getKeyValue.md
	@typedef can-symbol/symbols/getKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.getKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="getKeyValue.html">can.getKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.getKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-getKeyValue.md">Edit on GitHub</a>
				</li>
    ...
    <p>Defines a function to access and return the value of one of the object's named properties.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.getKeyValue( key )</code>
  </h2>
  <p>The <code>can.getKeyValue</code> symbol points to a Map-like object's property accessor function, which returns the value of the object's property with the supplied key.   This is only applicable to objects where keyed properties are relevant (like maps).</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key to look up on the object</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>the value of the key</p>
<pre><code>var map = {
    get: function (key) {
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-getKeyValue.md"},"description":"Defines a function to access and return the value of one of the object's named properties.   \n","type":"typedef","title":"can.getKeyValue","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]}]}],"name":"can-symbol/symbols/getKeyValue","parent":"can-symbol/symbols/get-set","signatures":[{"code":"@@can.getKeyValue( key )","description":"\n\nThe `can.getKeyValue` symbol points to a Map-like object's property accessor function, which returns the value of the object's property with the supplied key.   This is only applicable to objects where keyed properties are relevant (like maps).\n","params":[{"types":[{"type":"String"}],"name":"key","description":"the key to look up on the object"}],"context":{"types":[{"type":"Object","options":[]}],"description":"an object with named properties"},"returns":{"types":[{"type":"*"}],"description":"the value of the key\n\n\n```\nvar map = {\n\tget: function (key) {\n\t\tObservation.add(this, key);\n\t\treturn this[key];\n\t}\n}\n\nmap[canSymbol.for('can.getKeyValue')] = map.get;\n```\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key to look up on the object"},"_curReturn":{"types":[{"type":"*"}],"description":"the value of the key\n\n\n```\nvar map = {\n\tget: function (key) {\n\t\tObservation.add(this, key);\n\t\treturn this[key];\n\t}\n}\n\nmap[canSymbol.for('can.getKeyValue')] = map.get;\n```\n"},"pathToRoot":"../../.."};
</script>
</article>
