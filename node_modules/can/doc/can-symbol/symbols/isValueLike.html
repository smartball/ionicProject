...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-symbol/docs/symbols-isValueLike.md
	@typedef can-symbol/symbols/isValueLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can.isValueLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="isValueLike.html">can.isValueLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can.isValueLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-symbol/edit/master/docs/symbols-isValueLike.md">Edit on GitHub</a>
				</li>
    ...
    <p>Set to <code>true</code> to show than an object is usable like an atomic value (a number, string, boolean, or undefined value).</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>@@can.isValueLike = true</code>
  </h2>
  <p>Shows that this object can be used as an atomic value; it may make sense to also implement <code>valueOf()</code> and <a href="getValue.html" title="Defines a function that returns the object's current value when called."><code>@@can.getValue()</code></a></p>
<p>In the case of a MapLike, an object is ValueLike if and only if:</p>
<ul>
<li>it always returns the same value from <code>getValue</code>; and</li>
<li>the same value that is set from <code>setValue</code> is returned by <code>getValue</code></li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-symbol/docs/symbols-isValueLike.md"},"description":"Set to `true` to show than an object is usable like an atomic value (a number, string, boolean, or undefined value). \n","type":"typedef","title":"can.isValueLike","types":[{"type":"Boolean"}],"name":"can-symbol/symbols/isValueLike","parent":"can-symbol/symbols/type","signatures":[{"code":"@@can.isValueLike = true","description":"\n\nShows that this object can be used as an atomic value; it may make sense to also implement `valueOf()` and [can-symbol/symbols/getValue `@@can.getValue()`]\n\nIn the case of a MapLike, an object is ValueLike if and only if:\n\n* it always returns the same value from `getValue`; and\n* the same value that is set from `setValue` is returned by `getValue`\n","params":[]}],"pathToRoot":"../../.."};
</script>
</article>
