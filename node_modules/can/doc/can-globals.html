...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-globals/doc/can-globals.md
	@module can-globals
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-globals</title>
...
radios. By using this event instead, deselected radios receive notification.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-globals/document/document.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-globals/global/global.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-globals/is-browser-window/is-browser-window.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-globals/location/location.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-globals/mutation-observer/mutation-observer.html"
...
<div class="breadcrumb">
	...
	<li><a href="can-globals.html">can-globals</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-globals</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-globals">
						<img src="https://img.shields.io/badge/npm%20package-0.2.3-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-globals" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-globals/edit/master/doc/can-globals.md">Edit on GitHub</a>
				</li>
    ...
    <p>An environment agnostic container for global variables. Useful for testing and server-side rendering (SSR), typically used internally by CanJS.</p>
...
<div class="signature">
  ...
  <p>The <code>can-globals</code> package exports an object with
methods used to set and get global variables. For example, get the global <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/location"><code>location</code></a> object:</p>
<pre><code class="language-js">const globals = require('can-globals');

const LOCATION = globals.getKeyValue('location');
</code></pre>
<p>New keys can be defined with the <code>define</code> method, overwritten with the <code>set</code> method, and reset to their original value with the <code>reset</code> method.
All of these methods are demonstrated in the following example</p>
<pre><code class="language-js">const globals = require('can-globals');
