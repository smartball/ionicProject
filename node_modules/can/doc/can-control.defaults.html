...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-control/docs/defaults.md
	@property can-control.defaults
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-control.defaults.html">defaults</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>defaults</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-control/edit/master/docs/defaults.md">Edit on GitHub</a>
				</li>
    ...
    <p>Default values for the Control's options.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <p>Default options provided for when a new control is created without values set in <code>options</code>.</p>
<p><code>defaults</code> provides default values for a Control's options.
Options passed into the constructor function will be shallowly merged
into the values from defaults in <a href="can-control.prototype.setup.html" title="Perform pre-initialization logic for control instances and classes.">setup</a>, and
the result will be stored in <a href="can-control.prototype.options.html" title="Options used to configure a control.">this.options</a>.</p>
<pre><code>Message = Control.extend({
  defaults: {
    message: &quot;Hello World&quot;
  }
}, {
...
<p>New instances of a Control will create a shallow copy of the default
options. Be aware as shallow copies keep a reference to object types, such as
objects, maps and computes.</p>
<pre><code>var Sample = Control.extend({
  defaults: {
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-control/docs/defaults.md"},"description":"Default values for the Control's options. \n","types":[{"type":"Object","options":[]}],"title":"defaults","name":"can-control.defaults","type":"property","parent":"can-control.static","comment":" ","pathToRoot":".."};
</script>
</article>
