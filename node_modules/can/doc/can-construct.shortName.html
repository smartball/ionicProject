...
<!--####################################################################
	...
	@property can-construct.shortName
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - shortName</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.shortName.html">shortName</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>shortName</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L653">Edit on GitHub</a>
				</li>
    ...
    <p>If you pass a name when creating a Construct, the <code>shortName</code> property will be set to the
name.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <pre><code class="language-js">var MyConstructor = Construct.extend(&quot;MyConstructor&quot;,{},{});
...
<script type="text/javascript">
  window.docObject = {"src":{"line":652,"codeLine":666,"path":"node_modules/can-construct/can-construct.js"},"type":"property","description":"\nIf you pass a name when creating a Construct, the `shortName` property will be set to the\nname.\n","types":[{"type":"String"}],"title":"shortName","name":"can-construct.shortName","parent":"can-construct.static","pathToRoot":".."};
</script>
</article>
