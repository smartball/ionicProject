...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-react-component/docs/can-react-component.md
	@function can-react-component
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-react-component</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-react-component.html">can-react-component</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-react-component</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-react-component">
						<img src="https://img.shields.io/badge/npm%20package-0.1.9-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-react-component" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-react-component/edit/master/docs/can-react-component.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a React component out of a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canReactComponent( displayName, CanComponent )</code>
  </h2>
  <p>Converts a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a> constructor into a React Component and updates the component’s <code>viewModel</code> any time the React props change.</p>
<pre><code class="language-jsx">import CanComponent from &quot;can-component&quot;;
...
<p>Values will be passed to the <code>viewModel</code> in the same way they would be for a normal React Component, e.g. the <code>text</code> prop in the above example would provide the string <code>&quot;inner text&quot;</code> to the <code>viewModel</code>, <code>number</code> would provide the number <code>5</code>, etc.</p>
<p>Since the component doesn’t produce DOM artifacts of its own, you won’t end up with any wrapper divs or anything else to worry about, but <a href="https://github.com/facebook/react-devtools">React Developer Tools</a> will show you the component with the <code>displayName</code> in the React tree.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>displayName</b> <code>{String}</code>: <p>The name of the created component. If this is not specified, it will be the CanComponent’s name appended with “Wrapper”.</p>
</li>
        
          <li><b>CanComponent</b> <code>{CanComponent}</code>: <p>Any <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{ReactComponent}</code>: <p>A React component</p>
</p>
  </div>
...
<p>You can play with the above example on JS Bin:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/cisowob/3/embed?js,output">can-react-component demo on jsbin.com</a></p>
<p>You can also use this module with <a href="https://preactjs.com">Preact</a>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/fexezi/2/embed?js,output">can-react-component demo with Preact on jsbin.com</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-react-component/docs/can-react-component.md"},"description":"Create a React component out of a [can-component]. \n","title":"can-react-component","name":"can-react-component","parent":"can-ecosystem","type":"function","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-react-component/issues"},"bundleDependencies":false,"dependencies":{"can-namespace":"^1.0.0","can-util":"^3.7.0","can-view-scope":"^3.1.1"},"deprecated":false,"description":"Create a React component out of a CanComponent.","devDependencies":{"babel-eslint":"^7.2.3","bit-docs":"0.0.7","can-component":"^3.0.7","can-define":"^1.5.0","can-stache":"^3.0.24","detect-cyclic-packages":"^1.1.0","done-serve":"^1.3.0","eslint":"^3.18.0","eslint-plugin-react":"^7.0.1","react":"^16.0.0","react-dom":"^16.0.0","steal":"^1.5.2","steal-builtins":"^1.0.0","steal-qunit":"^1.0.0","steal-tools":"^1.3.5","testee":"^0.6.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs","react"],"main":"can-react-component","name":"can-react-component","peerDependencies":{"react":"15.x - 16.x"},"repository":{"type":"git","url":"git://github.com/canjs/can-react-component.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","eslint":"eslint \"**/*.js\" --ignore-pattern \"dist\" --ignore-pattern \"node_modules\"","postversion":"git push --tags && git checkout master && git branch -D release && git push","prepublish":"npm run build","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run detect-cycle && npm run eslint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-react-component","configDependencies":["live-reload"],"npmIgnore":["babel-eslint","bit-docs","done-serve","eslint","eslint-plugin-react","testee"]},"version":"0.1.9"},"signatures":[{"code":"canReactComponent( displayName, CanComponent )","description":"\n\nConverts a [can-component] constructor into a React Component and updates the component’s `viewModel` any time the React props change.\n\n```jsx\nimport CanComponent from \"can-component\";\nimport canReactComponent from \"can-react-component\";\nimport ReactDOM from \"react-dom\";\n\nconst MyCanComponent = CanComponent.extend({ ... });\nconst InnerComponent = canReactComponent( \"InnerComponent\", MyCanComponent );\n\nReactDOM.render(\n  <InnerComponent text=\"inner text\" number={ 5 } />,\n  document.getElementById(\"app\")\n)\n```\n\nValues will be passed to the `viewModel` in the same way they would be for a normal React Component, e.g. the `text` prop in the above example would provide the string `\"inner text\"` to the `viewModel`, `number` would provide the number `5`, etc.\n\nSince the component doesn’t produce DOM artifacts of its own, you won’t end up with any wrapper divs or anything else to worry about, but [React Developer Tools](https://github.com/facebook/react-devtools) will show you the component with the `displayName` in the React tree.\n","params":[{"types":[{"type":"String"}],"name":"displayName","description":"The name of the created component. If this is not specified, it will be the CanComponent’s name appended with “Wrapper”."},{"types":[{"type":"CanComponent"}],"name":"CanComponent","description":"Any [can-component].\n"}],"returns":{"types":[{"type":"ReactComponent"}],"description":"A React component\n"}}],"_curParam":{"types":[{"type":"CanComponent"}],"name":"CanComponent","description":"Any [can-component].\n"},"_curReturn":{"types":[{"type":"ReactComponent"}],"description":"A React component\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
