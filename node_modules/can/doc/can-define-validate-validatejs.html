...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-validate-validatejs/docs/can-define-validate-validatejs.md
	@module can-define-validate-validatejs
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-define-validate-validatejs</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-define-validate-validatejs</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-define-validate-validatejs">
						<img src="https://img.shields.io/badge/npm%20package-0.1.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-define-validate-validatejs" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-validate-validatejs/edit/master/docs/can-define-validate-validatejs.md">Edit on GitHub</a>
				</li>
    ...
    <p>Adds validation methods and observables to a <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> using <a href="https://validatejs.org/">validate.js</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>defineValidate(Map)</code>
  </h2>
  <p>Checks for ValidateJS constraints and attaches useful methods.</p>
<pre><code class="language-js">var defineValidate = require('can-define-validate-validatejs');
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>Map</b> <code>{Object}</code>: <p>The <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> constructor. Adds <a href="can-define-validate-validatejs.errors.html" title="The errors method retrieves errors from validator.">errors</a> and [can-define-validate-validatejs.test-set] methods to the prototype of this map.</p>
</li>
    ...
    <section class="body">
    <h2>Usage</h2>
<p>Any validation properties must match the structure used by Validate.JS <a href="https://validatejs.org/#validators">constraints</a>.</p>
<p>For example...</p>
<pre><code class="language-js">var User = DefineMap.extend({
    name: {
        validate: {
            presence: true
        }
...
<p>Initialize the validators on the Define Map by calling the <code>defineValidate</code> function.</p>
<pre><code class="language-js">defineValidate(User);
</code></pre>
<p>When an instance is created, the instance will have validation properties that can be used in other modules or in templates</p>
<p>In a module...</p>
...
<p>In a template...</p>
<pre><code class="language-html">&lt;input type=&quot;submit&quot; {$disabled}=&quot;user.errors()&quot;/&gt;
</code></pre>
<h2>Demo</h2>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-validate-validatejs/docs/can-define-validate-validatejs.md"},"description":"Adds validation methods and observables to a [can-define/map/map] using [validate.js](https://validatejs.org/).\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-validate-validatejs","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"browser":{},"bugs":{"url":"https://github.com/canjs/can-define-validate-validatejs/issues"},"bundleDependencies":false,"dependencies":{"can-define":"^1.4.7","can-util":"^3.9.0","can-validate":"^1.1.0","can-validate-validatejs":"0.1.0"},"deprecated":false,"description":"Validation helpers for can-define maps and lists.","devDependencies":{"bit-docs":"^0.0.7","can-compute":"^3.3.4","http-server":"^0.10.0","jshint":"^2.9.5","steal":"^1.5.14","steal-qunit":"^1.0.0","steal-tools":"^1.9.0","testee":"^0.7.0"},"homepage":"https://github.com/canjs/can-define-validate-validatejs","keywords":["Validate","plugin","canjs"],"license":"MIT","main":"can-define-validate-validatejs.js","name":"can-define-validate-validatejs","repository":{"type":"git","url":"git+https://github.com/canjs/can-define-validate-validatejs.git"},"scripts":{"build":"node build.js","develop":"http-server -c-1","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"ignoreBrowser":true,"npmIgnore":["documentjs","testee","steal-tools"],"npmAlgorithm":"flat","npmDependencies":["steal-qunit"],"transpiler":"babel"},"version":"0.1.2"},"signatures":[{"code":"defineValidate(Map)","description":"\n\n  Checks for ValidateJS constraints and attaches useful methods.\n\n  ```js\n  var defineValidate = require('can-define-validate-validatejs');\n  var User = DefineMap.extend({\n      name: {\n          validate: {\n              presence: true\n          }\n      }\n  });\n  // Attach methods to any instance created of `User`\n  defineValidate(User);\n  var user = new User();\n  user.errors();//-> [{name: ['is required']}]\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"Map","description":"The [can-define/map/map] constructor. Adds [can-define-validate-validatejs.errors] and [can-define-validate-validatejs.test-set] methods to the prototype of this map.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"Map","description":"The [can-define/map/map] constructor. Adds [can-define-validate-validatejs.errors] and [can-define-validate-validatejs.test-set] methods to the prototype of this map.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
