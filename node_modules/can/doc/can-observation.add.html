...
<div class="breadcrumb">
	...
	<li><a href="can-observation.add.html">add</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>add</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-observation/edit/master/can-observation.js#L478">Edit on GitHub</a>
				</li>
    ...
    <p>Signals that an object's property is being observed, so that any functions
that are recording observations will see that this object is a dependency.</p>
...
<div class="signature">
  ...
  <p>Signals that an event should be observed. Adds the observable being read to
the top of the stack.</p>
<pre><code class="language-js">Observation.add(obj, &quot;prop1&quot;);
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>An observable object which is being observed.</p>
</li>
        
          <li><b>event</b> <code>{String}</code>: <p>The name of the event (or property) that is being observed.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-observation.add","parent":"can-observation.static","src":{"line":477,"codeLine":497,"path":"node_modules/can-observation/can-observation.js"},"description":"\nSignals that an object's property is being observed, so that any functions\nthat are recording observations will see that this object is a dependency.\n","title":"add","signatures":[{"code":"Observation.add(obj, event)","description":"\n\nSignals that an event should be observed. Adds the observable being read to\nthe top of the stack.\n\n```js\nObservation.add(obj, \"prop1\");\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An observable object which is being observed."},{"types":[{"type":"String"}],"name":"event","description":"The name of the event (or property) that is being observed.\n\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"event","description":"The name of the event (or property) that is being observed.\n\n"},"pathToRoot":".."};
</script>
</article>
