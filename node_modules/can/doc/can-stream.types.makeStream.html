...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream/docs/types.makeStream.md
	@typedef can-stream.types.makeStream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - makeStream</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stream.types.makeStream.html">makeStream</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>makeStream</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream/edit/master/docs/types.makeStream.md">Edit on GitHub</a>
				</li>
    ...
    <p>This function takes a stream whose values are bound to the returned <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makeStream(setStream)</code>
  </h2>
  <pre><code class="language-js">var Kefir = require('kefir');
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>setStream</b> <code>{Stream}</code>: <p>A stream to bind to the returned <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream/docs/types.makeStream.md"},"description":"This function takes a stream whose values are bound to the returned [can-compute.computed]. \n","type":"typedef","title":"makeStream","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-stream.types.makeStream","parent":"can-stream.types","signatures":[{"code":"makeStream(setStream)","description":"\n\n```js\nvar Kefir = require('kefir');\nvar count = Kefir.sequentially(1000, [1, 2]);\n\nvar myCompute = canStream.toCompute(function(setStream) {\n\treturn setStream.merge(count);\n});\n```\n","params":[{"types":[{"type":"Stream"}],"name":"setStream","description":"A stream to bind to the returned [can-compute.computed].\n"}]}],"_curParam":{"types":[{"type":"Stream"}],"name":"setStream","description":"A stream to bind to the returned [can-compute.computed].\n"},"pathToRoot":".."};
</script>
</article>
