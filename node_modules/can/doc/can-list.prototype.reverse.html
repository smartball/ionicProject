...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/prototype.reverse.md
	@function can-list.prototype.reverse
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - reverse</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-list.prototype.reverse.html">reverse</a></li>
	...
	<div class="page-type">
		<h1>reverse</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/prototype.reverse.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p><code>reverse</code> reverses the elements of the List in place.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-list.html" title="">can-list</a>}</code>: <p>the List, for chaining</p>
</p>
  </div>
...
<p><code>reverse</code> calls <code>replace</code> internally and triggers corresponding <code>add</code>, <code>remove</code>, <code>change</code> and <code>length</code> events respectively.</p>
<h2>Demo</h2>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-list/docs/prototype.reverse.md"},"description":"Reverse the order of a List. ","title":"reverse","name":"can-list.prototype.reverse","type":"function","parent":"can-list.prototype","signatures":[{"code":"list.reverse()","description":"\n\n`reverse` reverses the elements of the List in place.\n","params":[],"returns":{"types":[{"type":"can-list"}],"description":"the List, for chaining\n"}}],"_curReturn":{"types":[{"type":"can-list"}],"description":"the List, for chaining\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
