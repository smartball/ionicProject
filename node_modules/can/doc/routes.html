...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>routes</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L559">Edit on GitHub</a>
				</li>
    ...
    <p>A list of routes recognized by the router indixed by the url used to add it.
...
<script type="text/javascript">
  window.docObject = {"name":"routes","type":"property","parent":"node_modules/can-route/can-route.js","src":{"line":558,"codeLine":577,"path":"node_modules/can-route/can-route.js"},"description":"\nA list of routes recognized by the router indixed by the url used to add it.\nEach route is an object with these members:\n","types":[{"type":"Object","options":[]}],"title":"","hide":true,"pathToRoot":".."};
</script>
</article>
