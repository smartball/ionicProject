...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-model/can-view-model.md
			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-model">
						<img src="https://img.shields.io/badge/npm%20package-3.5.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-model" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-model/edit/master/can-view-model.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a <a href="can-types.DefaultMap.html" title="">DefaultMap</a> if it doesn’t already exist, and returns the map.</p>
...
var vm4 = canViewModel(document.querySelectorAll(&quot;.element4class&quot;));
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>element</b> <code>{HTMLElement|String|ArrayLike}</code>: <p>Any element in the DOM, represented by a reference to the element itself, a query selector string, or an Array-like holding the element in its zero index.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-map.html" title="Create observable objects.">can-map</a>|<a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>|Object}</code>: <p>The ViewModel associated with this element.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a <a href="can-types.DefaultMap.html" title="">DefaultMap</a> if it doesn’t already exist. Then, gets the <strong>property</strong> inside of the ViewModel and returns that.</p>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a <a href="can-types.DefaultMap.html" title="">DefaultMap</a> if it doesn’t already exist. Sets the <strong>property</strong> on that map to <strong>value</strong>.</p>
...
console.log(foo); // -&gt; &quot;bar&quot;
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><strong>can-view-model</strong> is used to get and set properties on an element’s ViewModel. Each element in the DOM can have an associated ViewModel. An example of this is a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a> and its associated <a href="can-component.prototype.ViewModel.html" title="Provides or describes a constructor function that provides values and methods
...
<p>The other signatures provide the ability to get and set properties on the ViewModel. For example, this sets the <code>foo</code> property on a component’s viewModel:</p>
<pre><code class="language-js">var canViewModel = require(&quot;can-view-model&quot;);
