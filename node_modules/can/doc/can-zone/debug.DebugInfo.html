...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone/docs/zones/debuginfo.md
	@typedef can-zone/debug.DebugInfo
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DebugInfo</title>
...
<div class="breadcrumb">
	...
	<li><a href="debug.DebugInfo.html">DebugInfo</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>DebugInfo</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone/edit/master/docs/zones/debuginfo.md">Edit on GitHub</a>
				</li>
    ...
    <p>An array of objects containing information useful for debugging. Gives you the name of the <strong>task</strong> that failed to complete and a <strong>stack</strong> trace of where the error occured.
Each object has a shape of:</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>task</b> <code>{String}</code>:
        <p>An identifier of the task that failed to complete. This can be any of the <a href="https://github.com/canjs/can-zone#tasks">asynchronous tasks</a> supported by can-zone like <code>setTimeout</code> or <code>Promise</code>.</p>

      </li>
    
      <li>
        <b>stack</b> <code>{String}</code>:
        <p>A stack trace taken as a snapshot when the task was called. This allows you t see the source of the call to help debug why the task never completed.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone/docs/zones/debuginfo.md"},"description":"An array of objects containing information useful for debugging. Gives you the name of the **task** that failed to complete and a **stack** trace of where the error occured. \nEach object has a shape of:\n\n```js\n{\n\t\"task\": \"setTimeout\",\n\t\"stack\": Error ....\"\n}\n```\n\n","type":"typedef","title":"DebugInfo","types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[]}]}],"options":[{"name":"task","description":"An identifier of the task that failed to complete. This can be any of the [asynchronous tasks](https://github.com/canjs/can-zone#tasks) supported by can-zone like `setTimeout` or `Promise`.\n\n","types":[{"type":"String"}]},{"name":"stack","description":"A stack trace taken as a snapshot when the task was called. This allows you t see the source of the call to help debug why the task never completed.\n","types":[{"type":"String"}]}]}],"name":"can-zone/debug.DebugInfo","parent":"can-zone/debug","pathToRoot":"../.."};
</script>
</article>
