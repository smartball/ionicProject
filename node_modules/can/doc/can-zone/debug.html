...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone/docs/zones/debug.md
	...
	<div class="page-type">
		<h1>can-zone/debug</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone/edit/master/docs/zones/debug.md">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>ms</b> <code>{Number}</code>: <p>The timeout, in milliseconds, before the <a href="../can-zone.html" title="A library that tracks asynchronous activity and lets you know when it has completed. Useful when you need to call a function and wait for all async behavior to complete, such as when performing server-side rendering.">Zone</a> will be rejected and debug information attached to the <a href="../can-zone.prototype.data.html" title="">zone's data</a> object.</p>
</li>
