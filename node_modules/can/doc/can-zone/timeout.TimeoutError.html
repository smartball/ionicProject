...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone/docs/zones/timeouterror.md
	@typedef can-zone/timeout.TimeoutError
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - TimeoutError</title>
...
<div class="breadcrumb">
	...
	<li><a href="timeout.TimeoutError.html">TimeoutError</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>TimeoutError</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone/edit/master/docs/zones/timeouterror.md">Edit on GitHub</a>
				</li>
    ...
    <p>A special type of Error that also includes the number of milliseconds that were waited before timing out.
The error object is included with the timeout module:</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>timeout</b> <code>{Number}</code>:
        <p>Specifies the timeout that was exceeded.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone/docs/zones/timeouterror.md"},"description":"A special type of Error that also includes the number of milliseconds that were waited before timing out. \nThe error object is included with the timeout module:\n\n```js\nvar timeout = require(\"can-zone/timeout\");\n\nvar TimeoutError = timeout.TimeoutError;\n// Maybe use this to check `instanceof`.\n```\n\n","type":"typedef","title":"TimeoutError","types":[{"type":"Error","options":[{"name":"timeout","description":"Specifies the timeout that was exceeded.\n","types":[{"type":"Number"}]}]}],"name":"can-zone/timeout.TimeoutError","parent":"can-zone/timeout","pathToRoot":"../.."};
</script>
</article>
