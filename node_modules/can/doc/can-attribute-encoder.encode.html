...
<!--####################################################################
	...
	@function can-attribute-encoder.encode
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - encode</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-attribute-encoder.encode.html">encode</a></li>
	...
	<div class="page-type">
		<h1>encode</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-attribute-encoder/edit/master/can-attribute-encoder.js#L76">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>encoder.encode(attributeName)</code>
  </h2>
  <p>Note: specific encoding may change, but encoded attributes
can always be decoded using <a href="can-attribute-encoder.decode.html" title="Decode an attribute name encoded by can-attribute-encoder.encode">decode</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>attributeName</b> <code>{String}</code>: <p>The attribute name.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The encoded attribute name.</p>
</p>
  </div>
    ...
    <section class="body">
    <pre><code class="language-js">var encodedAttributeName = encoder.encode(&quot;{(^$foo/bar baz)}&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-attribute-encoder.encode","parent":"can-attribute-encoder","src":{"line":75,"codeLine":96,"path":"node_modules/can-attribute-encoder/can-attribute-encoder.js"},"description":"Encode an attribute name \n","title":"encode","signatures":[{"code":"encoder.encode(attributeName)","description":"\n\nNote: specific encoding may change, but encoded attributes\ncan always be decoded using [can-attribute-encoder.decode].\n","params":[{"types":[{"type":"String"}],"name":"attributeName","description":"The attribute name."}],"returns":{"types":[{"type":"String"}],"description":"The encoded attribute name.\n\n"}}],"comment":" ","_curParam":{"types":[{"type":"String"}],"name":"attributeName","description":"The attribute name."},"_curReturn":{"types":[{"type":"String"}],"description":"The encoded attribute name.\n\n"},"pathToRoot":".."};
</script>
</article>
