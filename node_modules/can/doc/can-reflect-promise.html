...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-reflect-promise/can-reflect-promise.md
	@function can-reflect-promise
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-reflect-promise</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect-promise.html">can-reflect-promise</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-reflect-promise</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-reflect-promise">
						<img src="https://img.shields.io/badge/npm%20package-1.1.4-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-reflect-promise" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect-promise/edit/master/can-reflect-promise.md">Edit on GitHub</a>
				</li>
    ...
    <p>Expose an observable, Map-like API on Promise types.</p>
...
<div class="signature">
  ...
  <p>If <code>promise</code> is an instance of a Promise type (either provided natively by the platform or by a polyfill library), the prototype
of the Promise type is decorated with <a href="can-symbol.html" title="Symbols used to detail how CanJS may operate on different objects
CanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop
with external libraries.  CanJS uses symbols to identify object types, property access methods, and for event
handling.
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">can-symbol</a> symbols for <code>@@can.onKeyValue</code>, <code>@@can.offKeyValue</code>,
<code>@@can.getKeyValue</code>, <code>@@can.onValue</code>, and <code>@@can.offValue</code>, which allow it to be used like an observable Map-like in
reflection.</p>
<p>Then <code>promise</code> and all future instances of <code>promise.constructor</code> will be initialized on first access to have the following keys
available through <a href="can-symbol/symbols/getKeyValue.html" title="Defines a function to access and return the value of one of the object's named properties.">@@can.getKeyValue</a>:</p>
<ul>
<li>&quot;state&quot; -- one of &quot;pending&quot;, &quot;resolved&quot;, or &quot;rejected&quot;</li>
<li>&quot;isPending&quot; -- true if the promise neither resolved nor rejected, false otherwise.</li>
<li>&quot;isResolved&quot; -- true if the promise is resolved, false otherwise.</li>
<li>&quot;isRejected&quot; -- true if the promise is rejected, false otherwise.</li>
<li>&quot;value&quot; -- the resolved value of the promise if resolved, otherwise undefined.</li>
<li>&quot;reason&quot; -- the rejected value of the promise if rejected, otherwise undefined.</li>
</ul>
<blockquote>
<p>Note that, due to native Promises' lack of inspection, it is impossible to tell whether a Promise is resolved or rejected
without using <code>.then()</code>. If the Promise is Promises/A+ compliant, then at the time the Promise is initialized by
<code>can-reflect-promise</code>, <code>isPending</code> will always be true, even if
...
<code>resolved</code>/<code>rejected</code> if the Promise has already updated its state.  The best strategy for ensuring a proper read of a resolved
value or rejected reason is to listen for the change in state or
value with <a href="can-symbol/symbols/onKeyValue.html" title="Defines how observable values can be listened to on a type.">@@can.onKeyValue</a> immediately after creating a Promise.</p>
</blockquote>
<p>In the cases where <code>promise</code> is a plain object (e.g. if it is a <code>jQuery.Deferred</code>), the symbols will be applied to <code>promise</code>
itself, not to the proto.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>promise</b> <code>{Promise}</code>: <p>any Promise, Promise-like, or thenable.</p>
</li>
