...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream-kefir/docs/types.DefineList.prototype.md
	@typedef can-define-stream-kefir.types.DefineList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream-kefir.types.DefineList.html">DefineList.prototype</a></li>
	...
	<div class="page-type">
		<h1>DefineList.prototype</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream-kefir/edit/master/docs/types.DefineList.prototype.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Creates a DefineList constructor</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream-kefir/docs/types.DefineList.prototype.md"},"description":"A [can-define/list/list] constructor to add stream methods to. \n","type":"typedef","title":"DefineList.prototype","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-stream-kefir.types.DefineList","parent":"can-define-stream-kefir.types","signatures":[{"code":"new DefineList([items])","description":"\n\nCreates a DefineList constructor\n\n```js\nimport DefineMap from 'can-define/map/map';\nimport DefineList from 'can-define/list/list';\n\nvar People = DefineList.extend([\n\t'#': {\n\t\ttype: {\n\t\t\tfirst: 'string',\n\t\t\tlast: 'string'\n\t\t}\n\t}\n]);\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
