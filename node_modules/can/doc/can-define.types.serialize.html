...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/docs/serialize.md
	...
	<div class="page-type">
		<h1>serialize</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/docs/serialize.md">Edit on GitHub</a>
				</li>
...
<a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a>ed instance on the server or serializing [can-route.map can-route.map]'s internal
