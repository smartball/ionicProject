...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/livebinding.md
	@page can-stache.Binding
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Live Binding</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.Binding.html">Live Binding</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Live Binding</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/livebinding.md">Edit on GitHub</a>
				</li>
    ...
    <p>Live binding refers to templates which update themselves when their state or data changes.
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <p>Live binding lets you focus on changing data and state without having to worry about also updating the
DOM to reflect those changes.</p>
...
<p>The template evaluates the <code>messages</code> and adds the hooks for live binding automatically.
Since we have no message it will render:</p>
<pre><code>&lt;h1&gt;Welcome Tina Fey!&lt;/h1&gt;
&lt;p&gt;You no messages.&lt;/p&gt;
</code></pre>
<p>Now say we have a request that updates
the <code>messages</code> attribute to have <code>5</code> messages.</p>
<pre><code>data.message = 5;
</code></pre>
<p>After the template receives this update, it will automatically
update the paragraph tag to reflect the new value.</p>
<pre><code>&lt;p&gt;You have 5 new message.&lt;/p&gt;
</code></pre>
<p>For more information visit the <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> documentation.</p>
<h3>Binding between components</h3>
<p>If you are looking for information on bindings between components like this:</p>
<pre><code>on:event=&quot;key()&quot; for event binding.
prop:from=&quot;key&quot; for one-way binding to a child.
prop:to=&quot;key&quot; for one-way binding to a parent.
prop:bind=&quot;key&quot; for two-way binding.
</code></pre>
<p>See <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>.</p>
