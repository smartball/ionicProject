...
<!--####################################################################
	...
	@function can-types.wrapElement
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - wrapElement</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-types.wrapElement.html">wrapElement</a></li>
	...
	<div class="page-type">
		<h1>wrapElement</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-types/edit/master/can-types.js#L103">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>types.wrapElement(element)</code>
  </h2>
  <p>Wraps an element into an object useful by DOM libraries ala jQuery.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>element</b> <code>{Node}</code>: <p>Any object inheriting from the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Node">Node interface</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A wrapped object.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-types.wrapElement","parent":"can-types","src":{"line":102,"codeLine":110,"path":"node_modules/can-types/can-types.js"},"description":"","title":"wrapElement","signatures":[{"code":"types.wrapElement(element)","description":"\n  Wraps an element into an object useful by DOM libraries ala jQuery.\n","params":[{"types":[{"type":"Node"}],"name":"element","description":"Any object inheriting from the [Node interface](https://developer.mozilla.org/en-US/docs/Web/API/Node)."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A wrapped object.\n "}}],"_curParam":{"types":[{"type":"Node"}],"name":"element","description":"Any object inheriting from the [Node interface](https://developer.mozilla.org/en-US/docs/Web/API/Node)."},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A wrapped object.\n "},"pathToRoot":".."};
</script>
</article>
