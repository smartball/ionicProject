...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event/lifecycle/lifecycle.md
	@module can-event/lifecycle/lifecycle
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-event/lifecycle/lifecycle</title>
...
<div class="breadcrumb">
	...
	<li><a href="lifecycle.html">can-event/lifecycle/lifecycle</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-event/lifecycle/lifecycle</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/lifecycle/lifecycle.md">Edit on GitHub</a>
				</li>
    ...
    <p>Mixin lifecycle events onto a prototype.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>lifecycle(prototype)</code>
  </h2>
  <p>The <code>can-event/lifecycle/lifecycle</code> module adds lifecycle events to a prototype that already has <code>addEventListener</code> and <code>removeEventListener</code>. It allows you to define:</p>
<ul>
<li><code>_eventSetup</code>: A method that is called the first time a binding is added to the object.</li>
<li><code>_eventTeardown</code>: A method that is called when there are no longer any more bindings on an object.</li>
</ul>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use lifecycle events, provide an object with add/removeEventListener methods.</p>
<pre><code class="language-js">var Todo = function(){
