...
<!--####################################################################
	...
	@function can-event/batch/batch.collecting
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - collecting</title>
...
<div class="breadcrumb">
	...
	<li><a href="batch.collecting.html">collecting</a></li>
	...
	<div class="page-type">
		<h1>collecting</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L198">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>batch.collecting()</code>
  </h2>
  <p>Returns the Queue that is currently collecting tasks.</p>
<pre><code>batch.start();
...
batch.collecting() //-&gt; null
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can-event/batch/Queue}</code>: <p>The queue currently collecting tasks.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/batch/batch.collecting","parent":"can-event/batch/batch","src":{"line":197,"codeLine":215,"path":"node_modules/can-event/batch/batch.js"},"description":"\n","title":"collecting","signatures":[{"code":"batch.collecting()","description":"\n\nReturns the Queue that is currently collecting tasks.\n\n```\nbatch.start();\nbatch.collecting() //-> Queue\n\nbatch.stop();\nbatch.collecting() //-> null\n```\n","params":[],"returns":{"types":[{"type":"can-event/batch/Queue"}],"description":"The queue currently collecting tasks.\n "}}],"_curReturn":{"types":[{"type":"can-event/batch/Queue"}],"description":"The queue currently collecting tasks.\n "},"pathToRoot":"../../.."};
</script>
</article>
