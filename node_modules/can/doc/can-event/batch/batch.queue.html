...
<!--####################################################################
	...
	@function can-event/batch/batch.queue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="batch.queue.html">queue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>queue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L445">Edit on GitHub</a>
				</li>
    ...
    <p>Queues a method to be called.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>batch.queue(task)</code>
  </h2>
  <p>Queues a method to be called in the current <a href="batch.collecting.html" title="">collecting</a>
queue if there is one.  If there is a <a href="batch.dispatching.html" title="">dispatching</a> queue,
it will create a batch and add the task to that batch.
Finally, if there is no batch, the task will be executed immediately.</p>
<pre><code>var me = {
