...
<!--####################################################################
	...
	@function can-event/batch/batch.stop
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - stop</title>
...
<div class="breadcrumb">
	...
	<li><a href="batch.stop.html">stop</a></li>
	...
	<div class="page-type">
		<h1>stop</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L246">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canBatch.stop([force[, callStart]])</code>
  </h2>
  <p>If this call to <code>stop</code> matches the number of calls to <code>start</code>, all of this batch's [can-event/batch/batch.trigger triggered]
events will be dispatched.  If the firing of those events creates new events, those new events will be dispatched
after the current batch in their own batch.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>force</b> <code>{bool}</code>: <p>Whether to stop batching events immediately.</p>
</li>
        
          <li><b>callStart</b> <code>{bool}</code>: <p>Whether to call <a href="batch.start.html" title="Begin an event batch.">start</a> after firing batched events.</p>
</li>
    ...
    <section class="body">
    <p><code>canBatch.stop</code> matches an earlier <code><a href="batch.start.html" title="Begin an event batch.">start</a></code> call. If <code>canBatch.stop</code> has been
called as many times as <code>canBatch.start</code> (or if <em>force</em> is true), all batched events will be
fired and any callbacks passed to <code>canBatch.start</code> since the beginning of the batch will be
called. If <em>force</em> and <em>callStart</em> are both true, a new batch will be started when all
the events and callbacks have been fired.</p>
<p>See <code><a href="batch.start.html" title="Begin an event batch.">start</a></code> for examples of <code>canBatch.start</code> and <code>canBatch.stop</code> in normal use.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/batch/batch.stop","parent":"can-event/batch/batch","src":{"line":245,"codeLine":270,"path":"node_modules/can-event/batch/batch.js"},"description":"End an event batch. \n","title":"stop","signatures":[{"code":"canBatch.stop([force[, callStart]])","description":"\n\nIf this call to `stop` matches the number of calls to `start`, all of this batch's [can-event/batch/batch.trigger triggered]\nevents will be dispatched.  If the firing of those events creates new events, those new events will be dispatched\nafter the current batch in their own batch.\n","params":[{"types":[{"type":"bool"}],"optional":true,"name":"force","defaultValue":"false","description":"Whether to stop batching events immediately."},{"types":[{"type":"bool"}],"optional":true,"name":"callStart","defaultValue":"false","description":"Whether to call [can-event/batch/batch.start] after firing batched events.\n"}]}],"_curParam":{"types":[{"type":"bool"}],"optional":true,"name":"callStart","defaultValue":"false","description":"Whether to call [can-event/batch/batch.start] after firing batched events.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
