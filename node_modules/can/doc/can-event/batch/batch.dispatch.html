...
<!--####################################################################
	...
	@function can-event/batch/batch.dispatch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - dispatch</title>
...
<div class="breadcrumb">
	...
	<li><a href="batch.dispatch.html">dispatch</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>dispatch</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L357">Edit on GitHub</a>
				</li>
    ...
    <p>Dispatchs an event within the event batching system.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canBatch.trigger(item, event [, args])</code>
  </h2>
  <p>Makes sure an event is fired at the appropriate time within the appropriate batch.
How and when the event fires depends on the batching state.</p>
<p>There are three states of batching:</p>
<ul>
<li>no queues - <code>trigger</code> is called outside of any <code>start</code> or <code>stop</code> call -&gt; The event is dispatched immediately.</li>
<li>collecting batch - <code>trigger</code> is called between a <code>start</code> or <code>stop</code> call -&gt; The event is dispatched when <code>stop</code> is called.</li>
<li>firing queues -  <code>trigger</code> is called due to another <code>trigger</code> called within a batch -&gt; The event is dispatched after the current batch has completed in a new batch.</li>
</ul>
<p>Finally, if the event has a <code>batchNum</code> it is fired immediately.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>item</b> <code>{Object}</code>: <p>the target of the event.</p>
</li>
        
          <li><b>event</b> <code>{String|Object}</code>: <p>the type of event, or an event object with a type given like <code>{type: 'name'}</code></p>
</li>
        
          <li><b>args</b> <code>{Array}</code>: <p>the parameters to trigger the event with.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/batch/batch.dispatch","parent":"can-event/batch/batch","src":{"line":356,"codeLine":380,"path":"node_modules/can-event/batch/batch.js"},"description":"Dispatchs an event within the event batching system. ","title":"dispatch","signatures":[{"code":"canBatch.trigger(item, event [, args])","description":"\n\nMakes sure an event is fired at the appropriate time within the appropriate batch.\nHow and when the event fires depends on the batching state.\n\nThere are three states of batching:\n\n- no queues - `trigger` is called outside of any `start` or `stop` call -> The event is dispatched immediately.\n- collecting batch - `trigger` is called between a `start` or `stop` call -> The event is dispatched when `stop` is called.\n- firing queues -  `trigger` is called due to another `trigger` called within a batch -> The event is dispatched after the current batch has completed in a new batch.\n\nFinally, if the event has a `batchNum` it is fired immediately.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"item","description":"the target of the event."},{"types":[{"type":"String"},{"type":"Object","options":[{"name":"type","types":[{"type":"String"}]}]}],"name":"event","description":"the type of event, or an event object with a type given like `{type: 'name'}`"},{"types":[{"type":"Array","options":[]}],"optional":true,"name":"args","description":"the parameters to trigger the event with.\n"}]}],"_curParam":{"types":[{"type":"Array","options":[]}],"optional":true,"name":"args","description":"the parameters to trigger the event with.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
