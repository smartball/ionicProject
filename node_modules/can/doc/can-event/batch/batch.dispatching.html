...
<!--####################################################################
	...
	@function can-event/batch/batch.dispatching
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - dispatching</title>
...
<div class="breadcrumb">
	...
	<li><a href="batch.dispatching.html">dispatching</a></li>
	...
	<div class="page-type">
		<h1>dispatching</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L219">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>batch.dispatching()</code>
  </h2>
  <p>Returns the Queue that is executing tasks.</p>
<pre><code>var canEvent = require(&quot;can-event&quot;);
...
batch.stop();
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can-event/batch/Queue}</code>: <p>The queue currently executing tasks.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/batch/batch.dispatching","parent":"can-event/batch/batch","src":{"line":218,"codeLine":242,"path":"node_modules/can-event/batch/batch.js"},"description":"\n","title":"dispatching","signatures":[{"code":"batch.dispatching()","description":"\n\nReturns the Queue that is executing tasks.\n\n```\nvar canEvent = require(\"can-event\");\nvar batch = require(\"can-event/batch/batch\");\n\n\nvar obj = Object.assign({}, canEvent);\n\n\n\nbatch.start();\nobj.dispatch(\"first\");\nbatch.stop();\n```\n","params":[],"returns":{"types":[{"type":"can-event/batch/Queue"}],"description":"The queue currently executing tasks.\n "}}],"_curReturn":{"types":[{"type":"can-event/batch/Queue"}],"description":"The queue currently executing tasks.\n "},"pathToRoot":"../../.."};
</script>
</article>
