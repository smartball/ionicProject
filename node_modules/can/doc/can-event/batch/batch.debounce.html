...
<!--####################################################################
	...
	@function can-event/batch/batch.debounce
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - debounce</title>
...
<div class="breadcrumb">
	...
	<li><a href="batch.debounce.html">debounce</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>debounce</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/batch/batch.js#L589">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a debounced event listener</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canBatch.debounce(handler)</code>
  </h2>
  <p>Makes sure an event handler function is only run once per batch.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>The debounced function</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":588,"codeLine":599,"path":"node_modules/can-event/batch/batch.js"},"type":"function","description":"Provides a debounced event listener ","title":"debounce","name":"can-event/batch/batch.debounce","parent":"can-event/batch/batch","signatures":[{"code":"canBatch.debounce(handler)","description":"\n\nMakes sure an event handler function is only run once per batch.\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"The handler that will be executed to handle the event."}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The debounced function\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"The handler that will be executed to handle the event."},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"The debounced function\n"},"pathToRoot":"../../.."};
</script>
</article>
