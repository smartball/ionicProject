...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event/async/async.md
	@module can-event/async/async
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-event/async/async</title>
...
All methods provided by canEvent assume that they are mixed into an object -- this should be the object dispatching the events.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="async.dispatch.html"
							title="Dispatch events asynchronously.">
							dispatch
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="async.queue.html"
							title="Queues a method to be called asynchronously.">
							queue
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="async.html">can-event/async/async</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-event/async/async</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/async/async.md">Edit on GitHub</a>
				</li>
    ...
    <p>Makes the event system asynchronous. <strong>WARNING:</strong> This is experimental technology.</p>
...
<div class="signature">
  ...
  <p>The <code>can-event/async/async</code> module makes the event system asynchronous.  It:</p>
<ul>
<li>Provides an <a href="async.async.html" title="">async</a> method which converts event binding and dispatching to happen asynchronously.</li>
<li>Provides <a href="async.sync.html" title="">sync</a>  method which converts event binding and dispatching to happen synchronously.</li>
<li>Provides an asynchronous <a href="async.dispatch.html" title="Dispatch events asynchronously.">dispatch</a>, <a href="async.queue.html" title="Queues a method to be called asynchronously.">queue</a>,
[can-event/async/async.addEventListener] and [can-event/async/async.removeEventListener].</li>
<li>Provides a <a href="async.flush.html" title="">flush</a> which can be used to immediately run all tasks in the
task queue.</li>
</ul>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Use <code>can-event/async/async</code>'s <code>async</code> method to make event binding and
dispatching happen immediately following the current event loop.</p>
...
<p>This means you never have to call <a href="../batch/batch.start.html" title="Begin an event batch.">start</a> and <a href="../batch/batch.stop.html" title="End an event batch.">stop</a>. Notice
that in the following example <code>&quot;change&quot;</code> is only fired once:</p>
<pre><code class="language-js">var canAsync = require(&quot;can-event/async/async&quot;);
canAsync.async();
