...
<!--####################################################################
	...
	@function can-event/async/async.queue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - queue</title>
...
<div class="breadcrumb">
	...
	<li><a href="async.queue.html">queue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>queue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/async/async.js#L50">Edit on GitHub</a>
				</li>
    ...
    <p>Queues a method to be called asynchronously.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>async.queue(task)</code>
  </h2>
  <p>Queues a method to be run scheduled to
<a href="../../can-util/js/set-immediate/set-immediate.html" title="can-util/js/set-immediate/set-immediate">immediately</a> after the current
event loop.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>task</b> <code>{Array&lt;function,*,Array&gt;}</code>: <p>An array that details a
function to be called, the context the function should be called with, and
the arguments to the function like: <code>[function,context, [arg1, arg2]]</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/async/async.queue","parent":"can-event/async/async","src":{"line":49,"codeLine":64,"path":"node_modules/can-event/async/async.js"},"description":"Queues a method to be called asynchronously. \n","title":"queue","signatures":[{"code":"async.queue(task)","description":"\n\nQueues a method to be run scheduled to\n[can-util/js/set-immediate/set-immediate immediately] after the current\nevent loop.\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"types":[{"type":"*"}]},{"types":[{"type":"Array","options":[]}]}]}],"name":"task","description":"An array that details a\nfunction to be called, the context the function should be called with, and\nthe arguments to the function like: `[function,context, [arg1, arg2]]`\n "}]}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"types":[{"type":"*"}]},{"types":[{"type":"Array","options":[]}]}]}],"name":"task","description":"An array that details a\nfunction to be called, the context the function should be called with, and\nthe arguments to the function like: `[function,context, [arg1, arg2]]`\n "},"pathToRoot":"../../.."};
</script>
</article>
