...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-event/async/async.js
	@function can-event/async/async.dispatch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="async.dispatch.html">dispatch</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>dispatch</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/async/async.js#L20">Edit on GitHub</a>
				</li>
    ...
    <p>Dispatch events asynchronously.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>asych.dispatch.call(target, event, [args])</code>
  </h2>
  <p>Dispatches <code>event</code> on <code>target</code> in a task queue scheduled to
run <a href="../../can-util/js/set-immediate/set-immediate.html" title="can-util/js/set-immediate/set-immediate">immediately</a> after the current
event loop.</p>
<p>If <a href="async.async.html" title="">async</a> is called, this will replace
the default <a href="../../can-event.dispatch.html" title="can-event.dispatch">dispatch</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{*}</code>: <p>The object to dispatch the event on.</p>
</li>
        
          <li><b>event</b> <code>{String|Object}</code>: <p>The event to dispatch.</p>
</li>
        
          <li><b>args</b> <code>{Array}</code>: <p>Additional arguments to pass to event handlers</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>event The resulting event object</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event/async/async.dispatch","parent":"can-event/async/async","src":{"line":19,"codeLine":39,"path":"node_modules/can-event/async/async.js"},"description":"Dispatch events asynchronously. \n","title":"dispatch","signatures":[{"code":"asych.dispatch.call(target, event, [args])","description":"\n\nDispatches `event` on `target` in a task queue scheduled to\nrun [can-util/js/set-immediate/set-immediate immediately] after the current\nevent loop.\n\nIf [can-event/async/async.async] is called, this will replace\nthe default [can-event.dispatch].\n\n","params":[{"types":[{"type":"*"}],"name":"target","description":"The object to dispatch the event on."},{"types":[{"type":"String"},{"type":"Object","options":[]}],"name":"event","description":"The event to dispatch."},{"types":[{"type":"Array","options":[]}],"optional":true,"name":"args","description":"Additional arguments to pass to event handlers"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"event The resulting event object\n "}}],"_curParam":{"types":[{"type":"Array","options":[]}],"optional":true,"name":"args","description":"Additional arguments to pass to event handlers"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"event The resulting event object\n "},"pathToRoot":"../../.."};
</script>
</article>
