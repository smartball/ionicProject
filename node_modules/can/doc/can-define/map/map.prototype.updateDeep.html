...
<!--####################################################################
	...
	@function can-define/map/map.prototype.updateDeep
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.updateDeep.html">updateDeep</a></li>
	...
	<div class="page-type">
		<h1>updateDeep</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/map/map.js#L239">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.updateDeep(props)</code>
  </h2>
  <p>Assigns each value in <code>props</code> to a property on this map instance named after the
corresponding key in <code>props</code>, effectively merging <code>props</code> into the Map.
Properties not in <code>props</code> will be set to <code>undefined</code>.</p>
<pre><code class="language-js">var MyMap = DefineMap.extend({
    list: DefineList,
    name: 'string'
});
var obj = new MyMap({
