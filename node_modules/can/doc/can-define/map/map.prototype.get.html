...
<!--####################################################################
	...
	@function can-define/map/map.prototype.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/map/map.js#L109">Edit on GitHub</a>
				</li>
    ...
    <p>Get a value or all values from a DefineMap.</p>
...
<div class="signature">
  ...
  <p>Returns a plain JavaScript object that contains the properties and values of the map instance.  Any property values
that also have a <code>get</code> method will have their <code>get</code> method called and the resulting value will be used as
the property value.  This can be used to recursively convert a map instance to an object of other plain
JavaScript objects.  Cycles are supported and only create one object.</p>
<p><code>.get()</code> can still return other non plain JS objects like Date.
Use <a href="map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children.">serialize</a> when a form proper for <code>JSON.stringify</code> is needed.</p>
<pre><code class="language-js">var map = new DefineMap({foo: new DefineMap({bar: &quot;zed&quot;})});
map.get() //-&gt; {foo: {bar: &quot;zed&quot;}};
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A plain JavaScript <code>Object</code> that contains all the properties and values of the map instance.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Get a single property on a DefineMap instance.</p>
<p><code>.get(propName)</code> only should be used when reading properties that might not have been defined yet, but
will be later via <a href="map.prototype.set.html" title="Sets multiple properties on a map instance or a property that wasn't predefined.">set</a>.</p>
...
map.get(&quot;name&quot;) //-&gt; undefined;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>propName</b> <code>{String}</code>: <p>The property name of a property that may not have been defined yet.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The value of that property.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/map/map.prototype.get","parent":"can-define/map/map.prototype","src":{"line":108,"codeLine":146,"path":"node_modules/can-define/map/map.js"},"description":"Get a value or all values from a DefineMap. \n","title":"get","signatures":[{"code":"map.get()","description":"\n\nReturns a plain JavaScript object that contains the properties and values of the map instance.  Any property values\nthat also have a `get` method will have their `get` method called and the resulting value will be used as\nthe property value.  This can be used to recursively convert a map instance to an object of other plain\nJavaScript objects.  Cycles are supported and only create one object.\n\n`.get()` can still return other non plain JS objects like Date.\nUse [can-define/map/map.prototype.serialize] when a form proper for `JSON.stringify` is needed.\n\n```js\nvar map = new DefineMap({foo: new DefineMap({bar: \"zed\"})});\nmap.get() //-> {foo: {bar: \"zed\"}};\n```\n","params":[],"returns":{"types":[{"type":"Object","options":[]}],"description":"A plain JavaScript `Object` that contains all the properties and values of the map instance.\n"}},{"code":"map.get(propName)","description":"\n\nGet a single property on a DefineMap instance.\n\n`.get(propName)` only should be used when reading properties that might not have been defined yet, but\nwill be later via [can-define/map/map.prototype.set].\n\n```js\nvar map = new DefineMap();\nmap.get(\"name\") //-> undefined;\n```\n","params":[{"types":[{"type":"String"}],"name":"propName","description":"The property name of a property that may not have been defined yet."}],"returns":{"types":[{"type":"*"}],"description":"The value of that property.\n "}}],"_curReturn":{"types":[{"type":"*"}],"description":"The value of that property.\n "},"_curParam":{"types":[{"type":"String"}],"name":"propName","description":"The property name of a property that may not have been defined yet."},"pathToRoot":"../../.."};
</script>
</article>
