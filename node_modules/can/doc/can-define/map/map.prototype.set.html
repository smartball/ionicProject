...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/map/map.js
	@function can-define/map/map.prototype.set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.set.html">set</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/map/map.js#L154">Edit on GitHub</a>
				</li>
    ...
    <p>Sets multiple properties on a map instance or a property that wasn't predefined.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.set(props [,removeProps])</code>
  </h2>
  <p>Assigns each value in <code>props</code> to a property on this map instance named after the
corresponding key in <code>props</code>, effectively merging <code>props</code> into the Map. If <code>removeProps</code> is true, properties not in
<code>props</code> will be set to <code>undefined</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>A collection of key-value pairs to set.
If any properties already exist on the map, they will be overwritten.</p>
</li>
        
          <li><b>removeProps</b> <code>{Boolean}</code>: <p>Whether to set keys not present in <code>props</code> to <code>undefined</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="map.html" title="Create observable objects.">can-define/map/map</a>}</code>: <p>The map instance for chaining.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Assigns <em>value</em> to a property on this map instance called <em>propName</em>.  This will define
the property if it hasn't already been predefined.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>propName</b> <code>{String}</code>: <p>The property to set.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>The value to assign to <code>propName</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="map.html" title="Create observable objects.">can-define/map/map</a>}</code>: <p>This map instance, for chaining.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/map/map.prototype.set","parent":"can-define/map/map.prototype","src":{"line":153,"codeLine":183,"path":"node_modules/can-define/map/map.js"},"description":"Sets multiple properties on a map instance or a property that wasn't predefined. \n","title":"set","deprecated":[{"version":"3.10.1","description":"Using .set with {Object} `props` has been deprecated in favour of `assign` and `update`\n"}],"signatures":[{"code":"map.set(props [,removeProps])","description":"\n\nAssigns each value in `props` to a property on this map instance named after the\ncorresponding key in `props`, effectively merging `props` into the Map. If `removeProps` is true, properties not in\n`props` will be set to `undefined`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"A collection of key-value pairs to set.\nIf any properties already exist on the map, they will be overwritten.\n"},{"types":[{"type":"Boolean"}],"optional":true,"name":"removeProps","defaultValue":"false","description":"Whether to set keys not present in `props` to `undefined`.\n"}],"returns":{"types":[{"type":"can-define/map/map"}],"description":"The map instance for chaining.\n"}},{"code":"map.set(propName, value)","description":"\n\nAssigns _value_ to a property on this map instance called _propName_.  This will define\nthe property if it hasn't already been predefined.\n","params":[{"types":[{"type":"String"}],"name":"propName","description":"The property to set."},{"types":[{"type":"*"}],"name":"value","description":"The value to assign to `propName`."}],"returns":{"types":[{"type":"can-define/map/map"}],"description":"This map instance, for chaining.\n "}}],"_curReturn":{"types":[{"type":"can-define/map/map"}],"description":"This map instance, for chaining.\n "},"_curParam":{"types":[{"type":"*"}],"name":"value","description":"The value to assign to `propName`."},"pathToRoot":"../../.."};
</script>
</article>
