...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/map/docs/events.keys.md
	@typedef can-define/map/map/KeysEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - __keys</title>
...
<div class="breadcrumb">
	...
	<li><a href="KeysEvent.html">__keys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>__keys</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/map/docs/events.keys.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when a property is added.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(event)</code>
  </h2>
  <p>Handlers registered on <code>__keys</code> events will be called
back as follows.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/map/docs/events.keys.md"},"description":"\nEvent fired when a property is added.\n","type":"typedef","title":"__keys","types":[{"type":"Event"}],"name":"can-define/map/map/KeysEvent","parent":"can-define/map/map/events","signatures":[{"code":"handler(event)","description":"\n\nHandlers registered on `__keys` events will be called\nback as follows.\n\n```\nvar person = new DefineMap({name: \"Justin\"});\nlist.on(\"__keys\", function(event){ ... });\nperson.set(\"age\", 33);\n```\n\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object.\n"}]}],"_curParam":{"types":[{"type":"Event"}],"name":"event","description":"An event object.\n"},"pathToRoot":"../../../.."};
</script>
</article>
