...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/map/docs/prototype.forEach.md
	@function can-define/map/map.prototype.forEach
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.forEach.html">forEach</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>forEach</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/map/docs/prototype.forEach.md">Edit on GitHub</a>
				</li>
    ...
    <p>Call a function on each property of a DefineMap.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.forEach( callback(value, propName ) )</code>
  </h2>
  <p><code>forEach</code> iterates through the map instance, calling a function
for each property value and key.</p>
<pre><code class="language-js">map.forEach(function(value, propName){ ... });
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(value, propName)}</code>: <p>The function to call for each property
The value and key of each property will be passed as the first and second
arguments, respectively, to the callback. If the callback returns <code>false</code>,
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/map/docs/prototype.forEach.md"},"description":"Call a function on each property of a DefineMap. \n","title":"forEach","name":"can-define/map/map.prototype.forEach","type":"function","parent":"can-define/map/map.prototype","signatures":[{"code":"map.forEach( callback(value, propName ) )","description":"\n\n`forEach` iterates through the map instance, calling a function\nfor each property value and key.\n\n```js\nmap.forEach(function(value, propName){ ... });\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"},{"types":[{"type":"String"}],"name":"propName"}]}],"name":"callback","description":"The function to call for each property\nThe value and key of each property will be passed as the first and second\narguments, respectively, to the callback. If the callback returns `false`,\nthe loop will stop.\n"}],"returns":{"types":[{"type":"can-define/map/map"}],"description":"The map instance for chaining.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"value"},{"types":[{"type":"String"}],"name":"propName"}]}],"name":"callback","description":"The function to call for each property\nThe value and key of each property will be passed as the first and second\narguments, respectively, to the callback. If the callback returns `false`,\nthe loop will stop.\n"},"_curReturn":{"types":[{"type":"can-define/map/map"}],"description":"The map instance for chaining.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
