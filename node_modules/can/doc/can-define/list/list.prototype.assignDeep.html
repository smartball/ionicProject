...
<!--####################################################################
	...
	@function can-define/list/list.prototype.assignDeep
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.assignDeep.html">assignDeep</a></li>
	...
	<div class="page-type">
		<h1>assignDeep</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L345">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.assignDeep(newProps)</code>
  </h2>
  <p>Updates the properties on the list with <code>newProps</code>. Properties not in <code>newProps</code> will be left unchanged.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newProps</b> <code>{Array}</code>: <p>Properties that need to be assigned to the list instance</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.assignDeep","parent":"can-define/list/list.prototype","src":{"line":344,"codeLine":367,"path":"node_modules/can-define/list/list.js"},"description":"\nSets an item or property or items or properties on a list.\n","title":"assignDeep","signatures":[{"code":"list.assignDeep(newProps)","description":"\n\nUpdates the properties on the list with `newProps`. Properties not in `newProps` will be left unchanged.\n\n```js\nvar list = new DefineList([\"A\",\"B\"]);\nlist.assign({count: 1, skip: 2});\nlist.get(\"count\") //-> 1\n\nlist.assignDeep({count: 1000});\nlist.get(\"count\") //-> 1000\nlist.get(\"skip\") //-> 2\n```\n","params":[{"types":[{"type":"Array","options":[]}],"name":"newProps","description":"Properties that need to be assigned to the list instance"}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n\t "}}],"_curParam":{"types":[{"type":"Array","options":[]}],"name":"newProps","description":"Properties that need to be assigned to the list instance"},"_curReturn":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
