...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/prototype.wildcard.md
	@property can-define/list/list.prototype.wildcard
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.wildcard.html">*</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>*</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/prototype.wildcard.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define default behavior for all properties and items in the list. Use <a href="list.prototype.wildcardItems.html" title="Define default behavior for items in the list.">#</a> to define the default type of items in the list.</p>
...
default behavior for every property in the list.  The default wildcard <code>&quot;*&quot;</code> definition
...
<p>Setting the wildcard is useful when all properties should be converted to a particular type.</p>
<pre><code class="language-js">var Person = DefineList.extend({ ... });
