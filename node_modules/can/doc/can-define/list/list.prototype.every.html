...
<!--####################################################################
	...
	@function can-define/list/list.prototype.every
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - every</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.every.html">every</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>every</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L950">Edit on GitHub</a>
				</li>
    ...
    <p>Return true if every item in a list matches a predicate.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.every( callback [,thisArg] )</code>
  </h2>
  <p>Tests each item in <code>list</code> by calling <code>callback</code> on it.  If <code>callback</code> returns truthy for every element in
<code>list</code>, <code>every</code> returns <code>true</code>.</p>
<pre><code>var names = new DefineList([&quot;alice&quot;,&quot;adam&quot;,&quot;zack&quot;,&quot;zeffer&quot;]);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(item, index, <a href="list.html" title="Create observable lists.">list</a>)}</code>: <p>A
function to call with each element of the DefineList. The three parameters that callback gets passed are:</p>
<ul>
<li>item (*) - the element at index.</li>
<li>index (Integer) - the index of the current element of the list.</li>
<li>list (DefineList) - the <code>DefineList</code> the elements are coming from.</li>
</ul>
<p>If <code>callback</code> returns a truthy result, <code>every</code> will evaluate the callback on the next element.  Otherwise, <code>every</code>
will return <code>false</code>.</p>
</li>
        
          <li><b>thisArg</b> <code>{Object}</code>: <p>What <code>this</code> should be in the <code>callback</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if calling the callback on every element in <code>list</code> returns a truthy value, <code>false</code> otherwise.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.every( props )</code>
  </h2>
  <p>Tests each item in <code>list</code> by comparing its properties to <code>props</code>.  If <code>props</code> match for every element in
<code>list</code>, <code>every</code> returns <code>true</code>.</p>
<pre><code>var todos = new DefineList([
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>An object of key-value properties.  Each key and value in
<code>props</code> must be present on an <code>item</code> for the <code>item</code> to match.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if every element in <code>list</code> matches <code>props</code>, <code>false</code> otherwise</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.every","type":"function","parent":"can-define/list/list.prototype","src":{"line":949,"codeLine":997,"path":"node_modules/can-define/list/list.js"},"description":"\nReturn true if every item in a list matches a predicate.\n","title":"every","signatures":[{"code":"list.every( callback [,thisArg] )","description":"\n\nTests each item in `list` by calling `callback` on it.  If `callback` returns truthy for every element in\n`list`, `every` returns `true`.\n\n```\nvar names = new DefineList([\"alice\",\"adam\",\"zack\",\"zeffer\"]);\nvar aNames = names.every(function(name){\n  return name[0] === \"a\"\n});\naNames //-> false\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"item"},{"types":[{"type":"Number"}],"name":"index"},{"types":[{"type":"can-define/list/list"}],"name":"list"}]}],"name":"callback","description":"A\nfunction to call with each element of the DefineList. The three parameters that callback gets passed are:\n - item (*) - the element at index.\n - index (Integer) - the index of the current element of the list.\n - list (DefineList) - the `DefineList` the elements are coming from.\n\nIf `callback` returns a truthy result, `every` will evaluate the callback on the next element.  Otherwise, `every`\nwill return `false`.\n"},{"types":[{"type":"Object","options":[]}],"name":"thisArg","description":"What `this` should be in the `callback`."}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if calling the callback on every element in `list` returns a truthy value, `false` otherwise.\n"}},{"code":"list.every( props )","description":"\n\nTests each item in `list` by comparing its properties to `props`.  If `props` match for every element in\n`list`, `every` returns `true`.\n\n```\nvar todos = new DefineList([\n  {name: \"dishes\", complete: false},\n  {name: \"lawn\", complete: true}\n]);\nvar complete = todos.every({complete: true});\ncomplete //-> false\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"An object of key-value properties.  Each key and value in\n`props` must be present on an `item` for the `item` to match."}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if every element in `list` matches `props`, `false` otherwise\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if every element in `list` matches `props`, `false` otherwise\n "},"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"An object of key-value properties.  Each key and value in\n`props` must be present on an `item` for the `item` to match."},"pathToRoot":"../../.."};
</script>
</article>
