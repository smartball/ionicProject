...
<!--####################################################################
	...
	@function can-define/list/list.prototype.splice
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.splice.html">splice</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>splice</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L419">Edit on GitHub</a>
				</li>
    ...
    <p>Insert and remove elements from a DefineList.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.splice(index[, howMany[, ...newItems]])</code>
  </h2>
  <p>Removes <code>howMany</code> items at <code>index</code> and adds <code>newItems</code> in their place.</p>
...
If <em>howMany</em> is not provided, <code>splice</code> will remove all elements from <code>index</code> to the end of the DefineList.</p>
</li>
        
          <li><b>newItems</b> <code>{*}</code>: <p>Items to insert into the DefineList</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>splice</code> lets you remove elements from and insert elements into a DefineList.</p>
<p>This example demonstrates how to do surgery on a list of numbers:</p>
<pre><code>var list = new DefineList([0, 1, 2, 3]);
...
<h2>Events</h2>
<p><code>splice</code> causes the DefineList it's called on to emit
<em>add</em> events, <em>remove</em> events, and <em>length</em> events. If there are
any elements to remove, a <em>remove</em> event, and a
<em>length</em> event will be fired. If there are any elements to insert, a
separate <em>add</em> event, and a separate <em>length</em> event
will be fired.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.splice","parent":"can-define/list/list.prototype","src":{"line":418,"codeLine":463,"path":"node_modules/can-define/list/list.js"},"description":"Insert and remove elements from a DefineList. ","title":"splice","signatures":[{"code":"list.splice(index[, howMany[, ...newItems]])","description":"\n\nRemoves `howMany` items at `index` and adds `newItems` in their place.\n\n\n","params":[{"types":[{"type":"Number"}],"name":"index","description":"Where to start removing or inserting elements.\n"},{"types":[{"type":"Number"}],"optional":true,"name":"howMany","description":"The number of elements to remove\nIf _howMany_ is not provided, `splice` will remove all elements from `index` to the end of the DefineList.\n"},{"types":[{"type":"*"}],"name":"newItems","description":"Items to insert into the DefineList\n"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"The elements removed by `splice`.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"newItems","description":"Items to insert into the DefineList\n"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"The elements removed by `splice`.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
