...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/prototype.on.md
	@function can-define/list/list.prototype.on
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.on.html">on</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>on</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/prototype.on.md">Edit on GitHub</a>
				</li>
    ...
    <p>Add event handlers to a list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.on(eventType, handler)</code>
  </h2>
  <p>Listens to <code>eventType</code> on <code>list</code> and calls <code>handler</code> when the event is dispatched.  This is simply
...
<pre><code class="language-js">var list = new DefineList([&quot;CanJS&quot;,&quot;StealJS&quot;])
...
The signature of the handler depends on the type of event being bound.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>This list, for chaining.</p>
</p>
  </div>
