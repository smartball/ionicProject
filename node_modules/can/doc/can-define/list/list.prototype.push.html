...
<!--####################################################################
	...
	@function can-define/list/list.prototype.push
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - push</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.push.html">push</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>push</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L550">Edit on GitHub</a>
				</li>
    ...
    <p>Add elements to the end of a list.</p>
...
<div class="signature">
  ...
  <p><code>push</code> adds elements onto the end of a DefineList.</p>
<pre><code>var names = new DefineList(['Alice']);
names.push('Bob', 'Eve');
names //-&gt; DefineList['Alice','Bob', 'Eve']
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>elements</b> <code>{*}</code>: <p>the elements to add to the DefineList</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Number}</code>: <p>the new length of the DefineList</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>push</code> adds elements onto the end of a DefineList here is an example:</p>
<pre><code>var list = new DefineList(['Alice']);

list.push('Bob', 'Eve');
list.get(); // ['Alice', 'Bob', 'Eve']
</code></pre>
<p>If you have an array you want to concatenate to the end
of the DefineList, you can use <code>apply</code>:</p>
<pre><code>var names = ['Bob', 'Eve'],
...
<h2>Events</h2>
<p><code>push</code> causes <em>add</em>, and <em>length</em> events to be fired.</p>
<h2>See also</h2>
<p><code>push</code> has a counterpart in <a href="list.prototype.pop.html" title="Remove an element from the end of a DefineList.">pop</a>, or you may be
looking for <a href="list.prototype.unshift.html" title="Add items to the beginning of a DefineList.">unshift</a> and its counterpart <a href="list.prototype.shift.html" title="Remove an item from the front of a list.">shift</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.push","type":"function","parent":"can-define/list/list.prototype","src":{"line":549,"codeLine":599,"path":"node_modules/can-define/list/list.js"},"description":"Add elements to the end of a list. ","title":"push","signatures":[{"code":"list.push(...elements)","description":"\n\n`push` adds elements onto the end of a DefineList.\n\n```\nvar names = new DefineList(['Alice']);\nnames.push('Bob', 'Eve');\nnames //-> DefineList['Alice','Bob', 'Eve']\n```\n","params":[{"types":[{"type":"*"}],"name":"elements","description":"the elements to add to the DefineList\n"}],"returns":{"types":[{"type":"Number"}],"description":"the new length of the DefineList\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"elements","description":"the elements to add to the DefineList\n"},"_curReturn":{"types":[{"type":"Number"}],"description":"the new length of the DefineList\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
