...
<!--####################################################################
	...
	@function can-define/list/list.prototype.some
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - some</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.some.html">some</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>some</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L999">Edit on GitHub</a>
				</li>
    ...
    <p>Return true if at least one item in a list matches a predicate.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.some( callback [,thisArg] )</code>
  </h2>
  <p>Tests each item in <code>list</code> by calling <code>callback</code> on it.  If <code>callback</code> returns truthy for some element in
<code>list</code>, <code>some</code> returns <code>true</code>.</p>
...
<li>list (DefineList) - the DefineList the elements are coming from.</li>
</ul>
<p>If <code>callback</code> returns a falsy result, <code>some</code> will evaluate the callback on the next element.  Otherwise, <code>some</code>
will return <code>true</code>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>false</code> if calling the callback on some element in <code>list</code> returns a falsy value, <code>true</code> otherwise.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.some( props )</code>
  </h2>
  <p>Tests each item in <code>list</code> by comparing its properties to <code>props</code>.  If <code>props</code> match for some element in
<code>list</code>, <code>some</code> returns <code>true</code>.</p>
...
<code>props</code> must be present on an <code>item</code> for the <code>item</code> to match.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>false</code> if every element in <code>list</code> fails to match <code>props</code>, <code>true</code> otherwise</p>
</p>
  </div>
