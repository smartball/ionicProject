...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/prototype.wildcardItems.md
	@property can-define/list/list.prototype.wildcardItems
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.wildcardItems.html">#</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>#</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/prototype.wildcardItems.md">Edit on GitHub</a>
				</li>
    ...
    <p>Define default behavior for items in the list.</p>
...
Constructor function, Array, a getter expression, or setter expression.">PropDefinition</a></code>
  ...
  <p>By defining a wildcard property (<code>&quot;#&quot;</code>) on the prototype, this will supply a
default behavior for items in the list.  The default wildcard (<code>&quot;#&quot;</code>) definition
makes every item run through the &quot;observable&quot; <a href="../../can-define.types.html" title="Defines the type, initial value, and get, set, and serialize behavior for an
...
<p>Setting the wildcard is useful when items should be converted to a particular type.</p>
...
<p>The wildcard property has optional <code>added</code> and <code>removed</code> functions that will be called after
an item is added or removed from the list with <code>this</code> being the list.</p>
