...
<!--####################################################################
	...
	@function can-define/list/list.prototype.unshift
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - unshift</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.unshift.html">unshift</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>unshift</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L601">Edit on GitHub</a>
				</li>
    ...
    <p>Add items to the beginning of a DefineList.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.unshift(...items)</code>
  </h2>
  <p><code>unshift</code> adds items onto the beginning of a DefineList.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>items</b> <code>{*}</code>: <p>The items to add to the DefineList.</p>
</li>
...
<h2>Events</h2>
<p><code>unshift</code> causes <em>add</em> and <em>length</em> events to be fired.</p>
<h2>See also</h2>
<p><code>unshift</code> has a counterpart in <a href="list.prototype.shift.html" title="Remove an item from the front of a list.">shift</a>, or you may be
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.unshift","type":"function","parent":"can-define/list/list.prototype","src":{"line":600,"codeLine":644,"path":"node_modules/can-define/list/list.js"},"description":"Add items to the beginning of a DefineList. ","title":"unshift","signatures":[{"code":"list.unshift(...items)","description":"\n\n`unshift` adds items onto the beginning of a DefineList.\n\n```\nvar list = new DefineList(['Alice']);\n\nlist.unshift('Bob', 'Eve');\nlist; // DefineList['Bob', 'Eve', 'Alice']\n```\n","params":[{"types":[{"type":"*"}],"name":"items","description":"The items to add to the DefineList.\n"}],"returns":{"types":[{"type":"Number"}],"description":"The new length of the DefineList.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"items","description":"The items to add to the DefineList.\n"},"_curReturn":{"types":[{"type":"Number"}],"description":"The new length of the DefineList.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
