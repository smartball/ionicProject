...
<!--####################################################################
	...
	@function can-define/list/list.prototype.reduce
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - reduce</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.reduce.html">reduce</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>reduce</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L872">Edit on GitHub</a>
				</li>
    ...
    <p>Map the values in this list to a single value</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.reduce(callback, initialValue, [, thisArg])</code>
  </h2>
  <p>Loops through the values of the list, calling <code>callback</code> for each one until the list
