...
<!--####################################################################
	...
	@function can-define/list/list.prototype.map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.map.html">map</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L791">Edit on GitHub</a>
				</li>
    ...
    <p>Map the values in this list to another list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.map(callback[, thisArg])</code>
  </h2>
  <p>Loops through the values of the list, calling <code>callback</code> for each one until the list
ends.  The return values of <code>callback</code> are used to populate the returned list.</p>
...
The three parameters that callback gets passed are:</p>
<ul>
...
<p>The return value of <code>callback</code>, including <code>undefined</code> values are used to populate the resulting list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>a new <code>DefineList</code> with the results of the map transform.</p>
</p>
  </div>
