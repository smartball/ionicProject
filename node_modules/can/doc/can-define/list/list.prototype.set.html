...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/list.js
	@function can-define/list/list.prototype.set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - set</title>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Sets items or properties on a list.">
							assign
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.set.html">set</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L184">Edit on GitHub</a>
				</li>
    ...
    <p>Sets an item or property or items or properties on a list.</p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      ...
      <div class='signature-wrapper'>
        <p>Using .set with {Object} <code>props</code> has been deprecated in favour of <code>assign</code> and <code>update</code></p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.set(prop, value)</code>
  </h2>
  <p>Sets the property at <code>prop</code>. This should be used when the property
isn't already defined.</p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
list.set(&quot;count&quot;,1000);
list.get(&quot;count&quot;) //-&gt; 1000;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prop</b> <code>{Number}</code>: <p>A property name.</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>The value to add to the list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>The list instance.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.set(newProps)</code>
  </h2>
  <p>Updates the properties on the list with <code>newProps</code>.</p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newProps</b> <code>{Object}</code>: <p>An object of properties and values to set on the list.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.set(index, value)</code>
  </h2>
  <p>Sets the item at <code>index</code>.  Typically, <a href="list.prototype.splice.html" title="Insert and remove elements from a DefineList.">splice</a> should be used instead.</p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
list.set(2,&quot;C&quot;);
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>index</b> <code>{Number}</code>: <p>A numeric position in the list.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.set(newItems [,replaceAll])</code>
  </h2>
  <p>Replaces items in the list with <code>newItems</code></p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newItems</b> <code>{Array}</code>: <p>Items used to replace existing items in the list.</p>
</li>
        
          <li><b>replaceAll</b> <code>{Boolean}</code>: <p>If true, will remove items at the end of the list.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.set","parent":"can-define/list/list.prototype","src":{"line":183,"codeLine":246,"path":"node_modules/can-define/list/list.js"},"description":"Sets an item or property or items or properties on a list. \n","title":"set","deprecated":[{"version":"3.10.1","description":"Using .set with {Object} `props` has been deprecated in favour of `assign` and `update`\n"}],"signatures":[{"code":"list.set(prop, value)","description":"\n\nSets the property at `prop`. This should be used when the property\nisn't already defined.\n\n```js\nvar list = new DefineList([\"A\",\"B\"]);\nlist.set(\"count\",1000);\nlist.get(\"count\") //-> 1000;\n```\n","params":[{"types":[{"type":"Number"}],"name":"prop","description":"A property name."},{"types":[{"type":"*"}],"name":"value","description":"The value to add to the list."}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n"}},{"code":"list.set(newProps)","description":"\n\nUpdates the properties on the list with `newProps`.\n\n```js\nvar list = new DefineList([\"A\",\"B\"]);\nlist.set({count: 1000, skip: 2});\nlist.get(\"count\") //-> 1000\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"newProps","description":"An object of properties and values to set on the list."}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n"}},{"code":"list.set(index, value)","description":"\n\nSets the item at `index`.  Typically, [can-define/list/list::splice] should be used instead.\n\n```js\nvar list = new DefineList([\"A\",\"B\"]);\nlist.set(2,\"C\");\n```\n","params":[{"types":[{"type":"Number"}],"name":"index","description":"A numeric position in the list."},{"types":[{"type":"*"}],"name":"value","description":"The value to add to the list."}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n"}},{"code":"list.set(newItems [,replaceAll])","description":"\n\nReplaces items in the list with `newItems`\n\n```js\nvar list = new DefineList([\"A\",\"B\"]);\nlist.set([\"c\"])        //-> DefineList[\"c\",\"B\"]\nlist.set([\"x\"], true)  //-> DefineList[\"x\"]\n```\n","params":[{"types":[{"type":"Array","options":[]}],"name":"newItems","description":"Items used to replace existing items in the list."},{"types":[{"type":"Boolean"}],"optional":true,"name":"replaceAll","description":"If true, will remove items at the end of the list."}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n\t "}}],"_curReturn":{"types":[{"type":"can-define/list/list"}],"description":"The list instance.\n\t "},"_curParam":{"types":[{"type":"Boolean"}],"optional":true,"name":"replaceAll","description":"If true, will remove items at the end of the list."},"pathToRoot":"../../.."};
</script>
</article>
