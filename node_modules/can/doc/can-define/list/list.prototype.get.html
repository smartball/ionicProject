...
<!--####################################################################
	...
	@function can-define/list/list.prototype.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L122">Edit on GitHub</a>
				</li>
    ...
    <p>Gets an item or all items from a DefineList.</p>
...
<div class="signature">
  ...
  <p>Returns the list converted into a plain JS array. Any items that also have a
<code>get</code> method will have their <code>get</code> method called and the resulting value will be used as item value.</p>
<p>This can be used to recursively convert a list instance to an Array of other plain JavaScript objects.
Cycles are supported and only create one object.</p>
<p><code>get()</code> can still return other non-plain JS objects like Dates.
Use <a href="../map/map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children.">serialize</a> when a form proper for <code>JSON.stringify</code> is needed.</p>
...
list.get() //-&gt; [&quot;A&quot;,&quot;B&quot;]
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>A plain JavaScript <code>Array</code> that contains each item in the list.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Gets the item at <code>index</code>. <code>list.get(index)</code> should be used instead of
<code>list[index]</code> if the list's items are going to be updated via <a href="list.prototype.set.html" title="Sets an item or property or items or properties on a list.">list.set(index, value)</a>
(as opposed to <a href="list.prototype.splice.html" title="Insert and remove elements from a DefineList.">splice</a> which is the better way).</p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
list.get(1) //-&gt; &quot;B&quot;
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The value at index.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.get(prop)</code>
  </h2>
  <p>Gets the property at <code>prop</code> if it might not have already been defined.</p>
<pre><code class="language-js">var list = new DefineList([&quot;A&quot;,&quot;B&quot;]);
list.set(&quot;count&quot;,1000)
list.get(&quot;count&quot;) //-&gt; 1000
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prop</b> <code>{String}</code>: <p>A property on the list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The value at <code>prop</code>.</p>
</p>
  </div>
