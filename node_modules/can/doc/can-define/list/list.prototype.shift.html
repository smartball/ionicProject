...
<!--####################################################################
	...
	@function can-define/list/list.prototype.shift
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - shift</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.shift.html">shift</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>shift</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L723">Edit on GitHub</a>
				</li>
    ...
    <p>Remove an item from the front of a list.</p>
...
<div class="signature">
  ...
  <p><code>shift</code> removes an element from the beginning of a DefineList.</p>
<pre><code>var list = new DefineList(['Alice','Adam']);
list.shift(); //-&gt; 'Alice'
list.shift(); //-&gt; 'Adam'
list.shift(); //-&gt; undefined
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The element just shifted off the DefineList, or <code>undefined</code> if the DefineList is empty</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>shift</code> is the opposite action from <code><a href="list.prototype.unshift.html" title="Add items to the beginning of a DefineList.">unshift</a></code>:</p>
<h2>Events</h2>
<p><code>pop</code> causes <em>remove</em> and <em>length</em> events to be fired if the DefineList is not empty
when it is called.</p>
<h2>See also</h2>
<p><code>shift</code> has a counterpart in <a href="list.prototype.unshift.html" title="Add items to the beginning of a DefineList.">unshift</a>, or you may be
looking for <a href="list.prototype.push.html" title="Add elements to the end of a list.">push</a> and its counterpart <a href="list.prototype.pop.html" title="Remove an element from the end of a DefineList.">pop</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.shift","type":"function","parent":"can-define/list/list.prototype","src":{"line":722,"codeLine":754,"path":"node_modules/can-define/list/list.js"},"description":"Remove an item from the front of a list. ","title":"shift","signatures":[{"code":"list.shift()","description":"\n\n`shift` removes an element from the beginning of a DefineList.\n\n```\nvar list = new DefineList(['Alice','Adam']);\nlist.shift(); //-> 'Alice'\nlist.shift(); //-> 'Adam'\nlist.shift(); //-> undefined\n```\n","params":[],"returns":{"types":[{"type":"*"}],"description":"The element just shifted off the DefineList, or `undefined` if the DefineList is empty\n"}}],"_curReturn":{"types":[{"type":"*"}],"description":"The element just shifted off the DefineList, or `undefined` if the DefineList is empty\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
