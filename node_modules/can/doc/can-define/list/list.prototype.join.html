...
<!--####################################################################
	...
	@function can-define/list/list.prototype.join
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - join</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.join.html">join</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>join</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L1141">Edit on GitHub</a>
				</li>
    ...
    <p>Join a DefineList's elements into a string.</p>
...
<div class="signature">
  ...
  <p><code>join</code> turns a DefineList into a string by inserting <em>separator</em> between the string representations
of all the elements of the DefineList.</p>
...
list.join(', '); // 'Alice, Bob, Eve'
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>separator</b> <code>{String}</code>: <p>The string to seperate elements.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The joined string.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.join","parent":"can-define/list/list.prototype","src":{"line":1140,"codeLine":1158,"path":"node_modules/can-define/list/list.js"},"description":"Join a DefineList's elements into a string. ","title":"join","signatures":[{"code":"list.join(separator)","description":"\n\n`join` turns a DefineList into a string by inserting _separator_ between the string representations\nof all the elements of the DefineList.\n\n```\nvar list = new DefineList(['Alice', 'Bob', 'Eve']);\nlist.join(', '); // 'Alice, Bob, Eve'\n```\n","params":[{"types":[{"type":"String"}],"name":"separator","description":"The string to seperate elements.\n"}],"returns":{"types":[{"type":"String"}],"description":"The joined string.\n\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"separator","description":"The string to seperate elements.\n"},"_curReturn":{"types":[{"type":"String"}],"description":"The joined string.\n\n "},"pathToRoot":"../../.."};
</script>
</article>
