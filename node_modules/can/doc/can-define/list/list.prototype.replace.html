...
<!--####################################################################
	...
	@function can-define/list/list.prototype.replace
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.replace.html">replace</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>replace</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L1334">Edit on GitHub</a>
				</li>
    ...
    <p>Replace all the elements of a DefineList.</p>
...
<div class="signature">
  ...
  <p>Replaces every item in the list with <code>collection</code>.</p>
<pre><code>var names = new DefineList([&quot;alice&quot;,&quot;adam&quot;,&quot;eve&quot;]);
...
names //-&gt; DefineList[&quot;Justin&quot;,&quot;Xena&quot;]
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>collection</b> <code>{Array|<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>The collection of items that will be in <code>list</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>Returns the <code>list</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>replace</code> is essentially a shortcut for <a href="list.prototype.splice.html" title="Insert and remove elements from a DefineList.">splice</a>.</p>
<h2>Events</h2>
<p><code>replace</code> causes <em>remove</em>, <em>add</em>, and <em>length</em> events.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.replace","parent":"can-define/list/list.prototype","src":{"line":1333,"codeLine":1359,"path":"node_modules/can-define/list/list.js"},"description":"Replace all the elements of a DefineList. ","title":"replace","signatures":[{"code":"list.replace(collection)","description":"\n\nReplaces every item in the list with `collection`.\n\n```\nvar names = new DefineList([\"alice\",\"adam\",\"eve\"]);\nnames.replace([\"Justin\",\"Xena\"]);\nnames //-> DefineList[\"Justin\",\"Xena\"]\n```\n","params":[{"types":[{"type":"Array"},{"type":"can-define/list/list"}],"name":"collection","description":"The collection of items that will be in `list`."}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"Returns the `list`.\n"}}],"_curParam":{"types":[{"type":"Array"},{"type":"can-define/list/list"}],"name":"collection","description":"The collection of items that will be in `list`."},"_curReturn":{"types":[{"type":"can-define/list/list"}],"description":"Returns the `list`.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
