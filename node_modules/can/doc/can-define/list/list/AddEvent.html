...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/events.add.md
	@typedef can-define/list/list/AddEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="AddEvent.html">add</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>add</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/events.add.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when items are added to the list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(event, added, index)</code>
  </h2>
...
items are added to a list.</p>
<pre><code>list.on(&quot;add&quot;, function(event, added, index){ ... });
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>added</b> <code>{Array}</code>: <p>An array of the items added to the list.</p>
</li>
        
          <li><b>index</b> <code>{Number}</code>: <p>The location where the items were added.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/list/docs/events.add.md"},"description":"\nEvent fired when items are added to the list.\n","type":"typedef","title":"add","types":[{"type":"Event"}],"name":"can-define/list/list/AddEvent","parent":"can-define/list/list/events","signatures":[{"code":"handler(event, added, index)","description":"\n\nHandlers registered with [can-event] methods on `list` will be called back when\nitems are added to a list.\n\n```\nlist.on(\"add\", function(event, added, index){ ... });\n```\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object."},{"types":[{"type":"Array","options":[]}],"name":"added","description":"An array of the items added to the list."},{"types":[{"type":"Number"}],"name":"index","description":"The location where the items were added.\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"index","description":"The location where the items were added.\n"},"pathToRoot":"../../../.."};
</script>
</article>
