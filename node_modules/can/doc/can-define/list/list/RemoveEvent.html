...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/events.remove.md
	@typedef can-define/list/list/RemoveEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="RemoveEvent.html">remove</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>remove</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/events.remove.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when items are removed from the list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(event, removed, index)</code>
  </h2>
  <p>Handlers registered with <a href="../../../can-event.html" title="Add event functionality into your objects.
The canEvent object provides a number of methods for handling events in objects. This functionality is best used by mixing the canEvent object into an object or prototype. However, event listeners can still be used even on objects that don't include canEvent.
All methods provided by canEvent assume that they are mixed into an object -- this should be the object dispatching the events.">can-event</a> methods on <code>list</code> will be called back when
items are removed to a list.</p>
<pre><code>list.on(&quot;remove&quot;, function(event, removed, index){ ... });
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{Event}</code>: <p>An event object.</p>
</li>
        
          <li><b>removed</b> <code>{Array}</code>: <p>An array of the items removed from the list.</p>
</li>
        
          <li><b>index</b> <code>{Number}</code>: <p>The location where the items were removed.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/list/docs/events.remove.md"},"description":"\nEvent fired when items are removed from the list.\n","type":"typedef","title":"remove","types":[{"type":"Event"}],"name":"can-define/list/list/RemoveEvent","parent":"can-define/list/list/events","signatures":[{"code":"handler(event, removed, index)","description":"\n\nHandlers registered with [can-event] methods on `list` will be called back when\nitems are removed to a list.\n\n```\nlist.on(\"remove\", function(event, removed, index){ ... });\n```\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object."},{"types":[{"type":"Array","options":[]}],"name":"removed","description":"An array of the items removed from the list."},{"types":[{"type":"Number"}],"name":"index","description":"The location where the items were removed.\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"index","description":"The location where the items were removed.\n"},"pathToRoot":"../../../.."};
</script>
</article>
