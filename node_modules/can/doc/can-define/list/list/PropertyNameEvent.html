...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/events.propertyName.md
	@typedef can-define/list/list/PropertyNameEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - propertyName</title>
...
<div class="breadcrumb">
	...
	<li><a href="PropertyNameEvent.html">propertyName</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>propertyName</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/events.propertyName.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when a property on the list changes values.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(event, newValue, oldValue)</code>
  </h2>
  <p>Handlers registered on <code>propertyName</code> events will be called
back as follows.</p>
<pre><code>list.set(&quot;totalCount&quot;, 500);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newVal</b> <code>{*}</code>: <p>The new value of the <code>propertyName</code> property.</p>
</li>
        
          <li><b>oldVal</b> <code>{*}</code>: <p>The old value of the <code>propertyName</code> property.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/list/docs/events.propertyName.md"},"description":"\nEvent fired when a property on the list changes values.\n","type":"typedef","title":"propertyName","types":[{"type":"Event"}],"name":"can-define/list/list/PropertyNameEvent","parent":"can-define/list/list/events","signatures":[{"code":"handler(event, newValue, oldValue)","description":"\n\nHandlers registered on `propertyName` events will be called\nback as follows.\n\n```\nlist.set(\"totalCount\", 500);\nlist.on(\"totalCount\", function(event, newVal, oldVal){\n  newVal //-> 5\n  oldVal //-> 500\n});\nlist.set(\"totalCount\", 5);\n```\n\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object."},{"types":[{"type":"*"}],"name":"newVal","description":"The new value of the `propertyName` property."},{"types":[{"type":"*"}],"name":"oldVal","description":"The old value of the `propertyName` property.\n"}]}],"_curParam":{"types":[{"type":"*"}],"name":"oldVal","description":"The old value of the `propertyName` property.\n"},"pathToRoot":"../../../.."};
</script>
</article>
