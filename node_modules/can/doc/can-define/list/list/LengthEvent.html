...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/events.length.md
	@typedef can-define/list/list/LengthEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - length</title>
...
<div class="breadcrumb">
	...
	<li><a href="LengthEvent.html">length</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>length</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/events.length.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when items are added or removed from the list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>handler(event, length)</code>
  </h2>
  <p>Handlers registered on &quot;length&quot; events will be called
back as follows.</p>
<pre><code>list.on(&quot;length&quot;, function(event, length){ ... });
</code></pre>
<p>It's possible that the length was not changed, but an item was <a href="../list.prototype.set.html" title="Sets an item or property or items or properties on a list.">set</a> on the list.
In this case, a <code>length</code> event will still be fired.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>length</b> <code>{Number}</code>: <p>The new length of the list.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/list/docs/events.length.md"},"description":"\nEvent fired when items are added or removed from the list.\n","type":"typedef","title":"length","types":[{"type":"Event"}],"name":"can-define/list/list/LengthEvent","parent":"can-define/list/list/events","signatures":[{"code":"handler(event, length)","description":"\n\nHandlers registered on \"length\" events will be called\nback as follows.\n\n```\nlist.on(\"length\", function(event, length){ ... });\n```\n\nIt's possible that the length was not changed, but an item was [can-define/list/list::set] on the list.\nIn this case, a `length` event will still be fired.\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object."},{"types":[{"type":"Number"}],"name":"length","description":"The new length of the list.\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"length","description":"The new length of the list.\n"},"pathToRoot":"../../../.."};
</script>
</article>
