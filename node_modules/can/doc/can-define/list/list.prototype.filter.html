...
<!--####################################################################
	...
	@function can-define/list/list.prototype.filter
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - filter</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.filter.html">filter</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>filter</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L825">Edit on GitHub</a>
				</li>
    ...
    <p>Filter a list to a new list of the matched items.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.filter( callback [,thisArg] )</code>
  </h2>
  <p>Filters <code>list</code> based on the return value of <code>callback</code>.</p>
...
<p>If <code>callback</code> returns a truthy result, <code>item</code> will be added to the result.  Otherwise, the <code>item</code> will be
excluded.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>A new instance of this <code>DefineList</code> (may be a subclass), containing the items that passed the filter.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.filter( props )</code>
  </h2>
  <p>Filters items in <code>list</code> based on the property values in <code>props</code>.</p>
...
<code>props</code> must be present on an <code>item</code> for the <code>item</code> to be in the returned list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>A new <code>DefineList</code> of the same type.</p>
</p>
  </div>
