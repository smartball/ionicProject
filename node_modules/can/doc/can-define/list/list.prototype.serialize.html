...
<!--####################################################################
	...
	@function can-define/list/list.prototype.serialize
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.serialize.html">serialize</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serialize</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L513">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the a serialized version of this list.</p>
...
<div class="signature">
  ...
  <p>Goes through each item in the list and gets its serialized
value and returns them in a plain Array.</p>
<p>Each items serialized value is the result of calling <code>.serialize()</code>
on the item or if the item doesn't have a <code>serialize</code> method,
the item itself.</p>
<pre><code>var list = new DefineList([&quot;first&quot;, {foo: &quot;bar&quot;}]);
...
serializedList //-&gt; [&quot;first&quot;, {foo: &quot;bar&quot;}]
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>An array with each item's serialied value.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.serialize","parent":"can-define/list/list.prototype","src":{"line":512,"codeLine":536,"path":"node_modules/can-define/list/list.js"},"description":"\nReturns the a serialized version of this list.\n","title":"serialize","signatures":[{"code":"list.serialize()","description":"\n\nGoes through each item in the list and gets its serialized\nvalue and returns them in a plain Array.\n\nEach items serialized value is the result of calling `.serialize()`\non the item or if the item doesn't have a `serialize` method,\nthe item itself.\n\n```\nvar list = new DefineList([\"first\", {foo: \"bar\"}]);\nvar serializedList = list.serialize();\n\nserializedList //-> [\"first\", {foo: \"bar\"}]\n```\n","params":[],"returns":{"types":[{"type":"Array","options":[]}],"description":"An array with each item's serialied value.\n\t "}}],"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"An array with each item's serialied value.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
