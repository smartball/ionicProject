...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/static.extend.md
	@function can-define/list/list.extend
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.extend.html">extend</a></li>
	...
	<div class="page-type">
		<h1>extend</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/static.extend.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DefineList.extend([name,] [static,] prototype)</code>
  </h2>
  <p>Extends DefineList, or constructor functions derived from DefineList,
...
Constructor function, Array, a getter expression, or setter expression.">PropDefinition</a>&gt;}</code>: <p>A definition of the properties or methods on this type.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>A DefineList constructor function.</p>
</p>
  </div>
