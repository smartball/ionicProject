...
<!--####################################################################
	...
	@function can-define/list/list.prototype.slice
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - slice</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.slice.html">slice</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>slice</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L1190">Edit on GitHub</a>
				</li>
    ...
    <p>Make a copy of a part of a DefineList.</p>
...
<div class="signature">
  ...
  <p><code>slice</code> creates a copy of a portion of the DefineList.</p>
<pre><code class="language-js">var list = new DefineList(['Alice', 'Bob', 'Charlie', 'Daniel', 'Eve']);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>start</b> <code>{Number}</code>: <p>The index to start copying from. Defaults to <code>0</code>.</p>
</li>
        
          <li><b>end</b> <code>{Number}</code>: <p>The first index not to include in the copy
If <em>end</em> is not supplied, <code>slice</code> will copy until the end of the list.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>A new <code>DefineList</code> with the extracted elements.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>slice</code> is the simplest way to copy a DefineList:</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-define/list/list.prototype.slice","parent":"can-define/list/list.prototype","src":{"line":1189,"codeLine":1223,"path":"node_modules/can-define/list/list.js"},"description":"Make a copy of a part of a DefineList. ","title":"slice","signatures":[{"code":"list.slice([start[, end]])","description":"\n\n`slice` creates a copy of a portion of the DefineList.\n\n```js\nvar list = new DefineList(['Alice', 'Bob', 'Charlie', 'Daniel', 'Eve']);\nvar newList = list.slice(1, 4);\nnewList //-> DefineList['Bob', 'Charlie', 'Daniel']\n```\n","params":[{"types":[{"type":"Number"}],"optional":true,"name":"start","defaultValue":"0","description":"The index to start copying from. Defaults to `0`.\n"},{"types":[{"type":"Number"}],"optional":true,"name":"end","description":"The first index not to include in the copy\nIf _end_ is not supplied, `slice` will copy until the end of the list.\n"}],"returns":{"types":[{"type":"can-define/list/list"}],"description":"A new `DefineList` with the extracted elements.\n"}}],"_curParam":{"types":[{"type":"Number"}],"optional":true,"name":"end","description":"The first index not to include in the copy\nIf _end_ is not supplied, `slice` will copy until the end of the list.\n"},"_curReturn":{"types":[{"type":"can-define/list/list"}],"description":"A new `DefineList` with the extracted elements.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
