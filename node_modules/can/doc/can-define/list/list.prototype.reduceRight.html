...
<!--####################################################################
	...
	@function can-define/list/list.prototype.reduceRight
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - reduceRight</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.reduceRight.html">reduceRight</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>reduceRight</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L911">Edit on GitHub</a>
				</li>
    ...
    <p>Map the values in this list to a single value from right to left</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>list.reduceRight(callback, initialValue, [, thisArg])</code>
  </h2>
  <p>Loops through the values of the list in reverse order, calling <code>callback</code> for each one until the list
ends.  The return value of <code>callback</code> is passed to the next iteration as the first argument,
and finally returned by <code>reduce</code>.</p>
<pre><code class="language-js">var todos = new DefineList([
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(item, index, list)}</code>: <p>A function to call with each element of the DefineList.
The four parameters that callback gets passed are:</p>
<ul>
<li>current (*) - the current aggregate value of reducing over the list -- the initial value if the first iteration</li>
...
<p>The return value of <code>callback</code> is passed to the next iteration as the first argument, and returned from
<code>reduce</code> if the last iteration.</p>
</li>
        
          <li><b>initialValue</b> <code>{*}</code>: <p>The initial value to use as <code>current</code> in the first iteration</p>
</li>
        
          <li><b>thisArg</b> <code>{Object}</code>: <p>The object to use as <code>this</code> inside the callback.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The result of the final call of <code>callback</code> on the list.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.reduceRight","type":"function","parent":"can-define/list/list.prototype","src":{"line":910,"codeLine":948,"path":"node_modules/can-define/list/list.js"},"description":"Map the values in this list to a single value from right to left \n","title":"reduceRight","signatures":[{"code":"list.reduceRight(callback, initialValue, [, thisArg])","description":"\n\nLoops through the values of the list in reverse order, calling `callback` for each one until the list\nends.  The return value of `callback` is passed to the next iteration as the first argument,\nand finally returned by `reduce`.\n\n```js\nvar todos = new DefineList([\n  {name: \"dishes\", complete: false},\n  {name: \"lawn\", complete: true}\n]);\nvar todosAsOneObject = todos.reduce(function(todos, todo){\n  todos[todo.name] = todo.complete;\n  return todos;\n}, {});\ntodosAsOneObject //-> { dishes: false, lawn: true }\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"item"}]},{"types":[{"type":"index"}]},{"types":[{"type":"list"}]}]}],"name":"callback","description":"A function to call with each element of the DefineList.\nThe four parameters that callback gets passed are:\n   - current (*) - the current aggregate value of reducing over the list -- the initial value if the first iteration\n   - item (*) - the element at index.\n   - index (Integer) - the index of the current element of the list.\n   - list (DefineList) - the `DefineList` the elements are coming from.\n\nThe return value of `callback` is passed to the next iteration as the first argument, and returned from\n`reduce` if the last iteration.\n"},{"types":[{"type":"*"}],"optional":true,"name":"initialValue","description":"The initial value to use as `current` in the first iteration"},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"thisArg","description":"The object to use as `this` inside the callback."}],"returns":{"types":[{"type":"*"}],"description":"The result of the final call of `callback` on the list."}}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"thisArg","description":"The object to use as `this` inside the callback."},"_curReturn":{"types":[{"type":"*"}],"description":"The result of the final call of `callback` on the list."},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
