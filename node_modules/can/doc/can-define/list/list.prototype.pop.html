...
<!--####################################################################
	...
	@function can-define/list/list.prototype.pop
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - pop</title>
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.pop.html">pop</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>pop</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L683">Edit on GitHub</a>
				</li>
    ...
    <p>Remove an element from the end of a DefineList.</p>
...
<div class="signature">
  ...
  <p><code>pop</code> removes an element from the end of a DefineList.</p>
<pre><code class="language-js">var names = new DefineList(['Alice', 'Bob', 'Eve']);
names.pop() //-&gt; 'Eve'
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The element just popped off the DefineList, or <code>undefined</code> if the DefineList was empty</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>pop</code> is the opposite action from <a href="list.prototype.push.html" title="Add elements to the end of a list.">push</a>:</p>
<pre><code>var list = new DefineList(['Alice', 'Bob', 'Eve']);
...
<h2>Events</h2>
<p><code>pop</code> causes <em>remove</em> and <em>length</em> events to be fired if the DefineList is not empty
when it is called.</p>
<h2>See also</h2>
<p><code>pop</code> has its counterpart in <a href="list.prototype.push.html" title="Add elements to the end of a list.">push</a>, or you may be
...
<script type="text/javascript">
  window.docObject = {"name":"can-define/list/list.prototype.pop","type":"function","parent":"can-define/list/list.prototype","src":{"line":682,"codeLine":721,"path":"node_modules/can-define/list/list.js"},"description":"Remove an element from the end of a DefineList. ","title":"pop","signatures":[{"code":"list.pop()","description":"\n\n`pop` removes an element from the end of a DefineList.\n\n```js\nvar names = new DefineList(['Alice', 'Bob', 'Eve']);\nnames.pop() //-> 'Eve'\n```\n","params":[],"returns":{"types":[{"type":"*"}],"description":"The element just popped off the DefineList, or `undefined` if the DefineList was empty\n"}}],"_curReturn":{"types":[{"type":"*"}],"description":"The element just popped off the DefineList, or `undefined` if the DefineList was empty\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
