...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/list/docs/define-list.md
	...
	<div class="page-type">
		<h1>can-define/list/list</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/docs/define-list.md">Edit on GitHub</a>
				</li>
...
<p>Finally, DefineList instances are observable, so you can use the <a href="../../can-event.html" title="Add event functionality into your objects.
The canEvent object provides a number of methods for handling events in objects. This functionality is best used by mixing the canEvent object into an object or prototype. However, event listeners can still be used even on objects that don't include canEvent.
...
<p><strong>NOTE:</strong> Only changes made to indexed values using the list's <code>set</code> method will dispatch change events.
👍  <code>defineList.set(0, 'newValue'); // will dispatch event</code>
👎  <code>defineList[0] = 'newValue'; // will NOT dispatch event</code></p>
