...
<!--####################################################################
	...
	@function can-define/list/list.prototype.forEach
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="list.prototype.forEach.html">forEach</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>forEach</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L1287">Edit on GitHub</a>
				</li>
    ...
    <p>Call a function for each element of a DefineList.</p>
...
<div class="signature">
  ...
  <p>Loops through the values of the list, calling <code>callback</code> for each one until the list ends
or <code>false</code> is returned.</p>
<pre><code>list.forEach(function(item, index, list){ ... })
</code></pre>
...
<li>index - the current element of the list.</li>
<li>list - the DefineList the elements are coming from.</li>
</ul>
<p>If the callback returns <code>false</code> the looping stops.</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>forEach</code> calls a callback for each element in the DefineList.</p>
<pre><code>var list = new DefineList([1, 2, 3]);
