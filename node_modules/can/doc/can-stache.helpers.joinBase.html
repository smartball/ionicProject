...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/joinBase.md
	@function can-stache.helpers.joinBase
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{joinBase(expressions)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.joinBase.html">{{joinBase(expressions)}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{joinBase(expressions)}}</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/joinBase.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{joinBase([EXPRESSION...])}}</code>
  </h2>
  <p>Return an application-relative url for a resource.</p>
<pre><code>{{joinBase(&quot;hello/&quot;, name, &quot;.png&quot;)}}
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>Expression or key arguments that reference a value within the current or parent scope.</p>
</li>
    ...
    <section class="body">
    <p>The <code>joinBase</code> helper is used to create urls within your application for static resources, such as images. An example usage:</p>
<pre><code>{{joinBase(&quot;hello/&quot;, name, &quot;.png&quot;)}}
</code></pre>
<p>Where <code>name</code> is a scope value, this might return <code>http://example.com/app/hello/world.png</code> if the application is <code>http://example.com/app</code>.</p>
<p>The url to join with is determined by the following factors:</p>
<ul>
<li>If attempting to load a relative url, such as <code>{{joinBase(&quot;../foo.png&quot;)}}</code> and using StealJS the template's address will be used as a reference to look up the location.</li>
<li>If the <code>can.baseURL</code> string is set, this will be used.</li>
<li>If the <code>System.baseURL</code> is set, this will be used.</li>
<li>Lastly we fall back to <code>location.pathname</code>.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/joinBase.md"},"description":"\n","title":"{{joinBase(expressions)}}","name":"can-stache.helpers.joinBase","type":"function","parent":"can-stache.htags","order":16,"signatures":[{"code":"{{joinBase([EXPRESSION...])}}","description":"\n\nReturn an application-relative url for a resource.\n\n```\n{{joinBase(\"hello/\", name, \".png\")}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"optional":true,"name":"EXPRESSION","variable":true,"description":"Expression or key arguments that reference a value within the current or parent scope.\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"optional":true,"name":"EXPRESSION","variable":true,"description":"Expression or key arguments that reference a value within the current or parent scope.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
