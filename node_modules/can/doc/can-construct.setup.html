...
<div class="breadcrumb">
	...
	<li><a href="can-construct.setup.html">setup</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>setup</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L319">Edit on GitHub</a>
				</li>
    ...
    <p>Perform initialization logic for a constructor function.</p>
...
<div class="signature">
  ...
  <p>A static <code>setup</code> method provides inheritable setup functionality
for a Constructor function. The following example
creates a Group constructor function.  Any constructor
functions that inherit from Group will be added to
<code>Group.childGroups</code>.</p>
<pre><code>Group = Construct.extend({
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>base</b> <code>{<a href="Object.html" title="constructor">constructor</a>}</code>: <p>The base constructor that is being inherited from.</p>
</li>
        
          <li><b>fullName</b> <code>{String}</code>: <p>The name of the new constructor.</p>
</li>
        
          <li><b>staticProps</b> <code>{Object}</code>: <p>The static properties of the new constructor.</p>
</li>
        
          <li><b>protoProps</b> <code>{Object}</code>: <p>The prototype properties of the new constructor.</p>
</li>
    ...
    <section class="body">
    <p>The static <code>setup</code> method is called immediately after a constructor
function is created and
set to inherit from its base constructor. It is useful for setting up
additional inheritance work.
Do not confuse this with the prototype <code><a href="can-construct.prototype.setup.html" title="">setup</a></code> method.</p>
<h2>Example</h2>
...
<pre><code class="language-js">Parent = Construct.extend({
