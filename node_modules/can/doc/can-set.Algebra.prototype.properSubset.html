...
<head>
	<meta charset="utf-8">
	<title>CanJS - properSubset</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.properSubset.html">properSubset</a></li>
	...
	<div class="page-type">
		<h1>properSubset</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L309">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns true if <em>A</em> is a strict subset of <em>B</em> (<em>A</em> ⊂ <em>B</em>).</p>
<pre><code class="language-js">algebra.properSubset({type: &quot;critical&quot;}, {}) //-&gt; true
algebra.properSubset({}, {}) //-&gt; false
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <code>a</code> is a subset of <code>b</code> and not equal to <code>b</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.properSubset","parent":"can-set.Algebra.prototype","src":{"line":308,"codeLine":325,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"properSubset","signatures":[{"code":"algebra.properSubset(a, b)","description":"\n\nReturns true if _A_ is a strict subset of _B_ (_A_ ⊂ _B_).\n\n```js\nalgebra.properSubset({type: \"critical\"}, {}) //-> true\nalgebra.properSubset({}, {}) //-> false\n```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"a","description":"A set."},{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if `a` is a subset of `b` and not equal to `b`.\n "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"b","description":"A set."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if `a` is a subset of `b` and not equal to `b`.\n "},"pathToRoot":".."};
</script>
</article>
