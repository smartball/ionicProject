...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-legacy/docs/changelog.md
	@page can-validate-legacy.changelog
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Changelog</title>
...
of a Map.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="page"
							href="can-validate-legacy.changelog.html"
							title="UNRELEASED - 2016-11-23">
							Changelog
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-validate-legacy.core.html"
							title="Returns an object with helpful methods that will call a validation library to validate
values.
How each method behaves depends on the chosen shim and validation library.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-validate-legacy.map-plugin.html"
							title="The can.Map plugin will works alongside can.Map.define to add validation to properties on a can.Map. Importing the plugin, validation library, and a shim will
...
are stored on the can.Map instance and are observable.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-validate-legacy.shims.html"
							title="Shims allow the flexibility of using any validation library with can.validate.
...
<div class="breadcrumb">
		...
		<li><a href="can-validate-legacy.html">can-validate-legacy</a></li>
		<li> / </li>
	
	
	<li><a href="can-validate-legacy.changelog.html">Changelog</a></li>
	...
	<div class="page-type">
		<h1>Changelog</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-legacy/edit/master/docs/changelog.md">Edit on GitHub</a>
				</li>
...
<section class="on-this-page-table">
    ...
    <h3>Changed</h3>
<ul>
<li>Restructured repository, main files live in root now; no <code>can-validate</code> subdirectory now.</li>
<li>Refactored tests to match CanJS standard of using QUnit.</li>
<li>Refactored codebase to match CanJS standard of using ES5.</li>
<li>Restructured Demos after repo changes</li>
<li>Updated dependencies to use CanJS 3.0 modules</li>
<li>Moved repository to <code>can-validate-legacy</code>. Original repository will continue but will soon change to match CanJS 3.0 patterns.</li>
<li>Updated docs to work with Bit-Docs</li>
</ul>
<h2>[0.9.2] - 2015-06-02</h2>
<h3>Changed</h3>
<ul>
<li>Cleaning up code after incorrect merge.</li>
</ul>
<h2>[0.9.1] - 2015-06-02</h2>
<h3>Changed</h3>
<ul>
<li>Fixed Validate all bug where some properties would not get properly validate when undefined in map instance.</li>
<li>Fixed overloading of validate list on validate all method.</li>
</ul>
<h2>[0.9.0] - 2015-06-01</h2>
<h3>Changed</h3>
<ul>
<li><a href="https://github.com/canjs/can-validate/issues/26">#26</a> Fixed bug that overwrote validate properties for all instances of a Map or Model. Computes are now cached to a dunder property versus overwriting the main <code>validate</code> property.</li>
<li><a href="https://github.com/canjs/can-validate/issues/27">#27</a> Fixed the <code>validate</code> method so it resolves computes. Computes are created from functions passed as validate options so validation can be triggered when compute change is triggered.</li>
<li>Improved validate init. Using a better method for detecting when Map is initing.</li>
</ul>
<h2>[0.8.4] - 2016-06-01</h2>
<h3>Added</h3>
<ul>
<li>Added tests for issue <a href="https://github.com/canjs/can-validate/issues/26">#26</a></li>
<li>Added tests for issue <a href="https://github.com/canjs/can-validate/issues/27">#27</a></li>
</ul>
<h3>Changed</h3>
<ul>
<li>Updated dependencies</li>
<li>Switched to Mocha</li>
<li>Improved tests</li>
</ul>
<h2>[0.8.3] - 2016-04-21</h2>
<h3>Changed</h3>
<ul>
<li>Fixed bug when errors was blank would cause console error</li>
</ul>
<h2>[0.8.2] - 2016-03-02</h2>
<h3>Changed</h3>
<ul>
<li>Improved handling of validation strings, passes strings through to Validate.JS.</li>
</ul>
<h2>[0.8.1] - 2016-02-03</h2>
<h3>Added</h3>
<ul>
<li>This change log</li>
<li>Contributing guide</li>
</ul>
<h3>Changed</h3>
<ul>
<li>Changed documentation root to <code>can-validate-plugin</code>, changed from <code>can-validate-library</code>.</li>
<li>Improved readme.</li>
<li>Improved overall documentation.</li>
</ul>
<h3>Removed</h3>
<ul>
<li>Removed CanJS Validations library documentation since it is still a WIP.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/0b98de198af17980174531146e43fb8c4b5e11a6">0.8.0</a> - 2015-12-03</h2>
<h3>Changed</h3>
<ul>
<li>Fixed memory leaks.</li>
<li>Improved validate object compute handling.</li>
<li>Updated to work with CanJS 2.3.x.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/2a58bf9ef280c2bb378221c6c18e85c7fed6daa3">0.7.1</a> - 2015-11-23</h2>
<h3>Changed</h3>
<ul>
<li>Improved build.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/6be268da2a02e2985f71fa1f7196bfad94c84ca5">0.7.0</a> - 2015-10-19</h2>
<h3>Added</h3>
<ul>
<li>Added XO for linting.</li>
</ul>
<h3>Changed</h3>
<ul>
<li>Cleaned up lint errors in repo.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/0383d482353319a6eec3cf218daaa99b8ce62585">0.6.0</a> - 2015-10-19</h2>
<h3>Added</h3>
<ul>
<li>Improved ability to pass functions to validation properties.</li>
</ul>
<h3>Changed</h3>
<ul>
<li>Fixed map init bug.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/17f46a11fb3f788e029359476bca83a67dca2b94">0.5.2</a> - 2015-10-18</h2>
<h3>Changed</h3>
<ul>
<li>Fixed tests.</li>
<li>Fixed merge conflicts/errors.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/5280c965df668b3eb1b95d10847f20676a3c5820">0.5.1</a> - 2015-10-01</h2>
<h3>Changed</h3>
<ul>
<li>Fixed require bug.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/53d965869263f39ea03dca97822fd5173cf62cdc">0.5.0</a> - 2015-07-16</h2>
<h3>Added</h3>
<ul>
<li>Added &quot;validate all&quot; method to can.Map plugin</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/608ee0cefdc161ecdf186980738952c86c937981">0.4.2</a> - 2015-07-13</h2>
<h3>Added</h3>
<ul>
<li>Published to NPM</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/c15d0b72bcc3e7343615d41baccbf3cf10242898">0.4.1</a> - 2015-07-13</h2>
<h3>Added</h3>
<ul>
<li>Inline docs.</li>
<li>Added DocumentJS dependency.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/a1d581aa31c304b04a7bdb4dc40106cf5c48771d">0.4.0</a> - 2015-07-10</h2>
<h3>Changed</h3>
<ul>
<li>Restructured repository.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/4a7de30a12c27e7db992ac2bfcdb55e94e61c17a">0.3.0</a> - 2015-07-10</h2>
<h3>Added</h3>
<ul>
<li>Browserify build.</li>
</ul>
<h3>Changed</h3>
<ul>
<li>Overall build improvements.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/7ba46b1ea42315f68532f4246031d9bf074b785d">0.2.0</a> - 2015-07-09</h2>
<h3>Changed</h3>
<ul>
<li>Made buildable. Using <code>import</code> over Steal syntax.</li>
</ul>
<h2><a href="https://github.com/canjs/can-validate/commit/b9a9aa2c43d672d9c238a506d788bafb3f89ee70">0.1.0</a> - 2015-07-08</h2>
<h3>Added</h3>
<ul>
<li>Created can-validate entry point.</li>
<li>Created can.Map plugin.</li>
<li>Created ValidateJS shim</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-legacy/docs/changelog.md"},"description":"\n## UNRELEASED - 2016-11-23\n","name":"can-validate-legacy.changelog","title":"Changelog","type":"page","parent":"can-validate-legacy","pathToRoot":".."};
</script>
</article>
