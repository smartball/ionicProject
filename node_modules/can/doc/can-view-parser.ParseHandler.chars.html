...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/chars.md
	@function can-view-parser.ParseHandler.chars
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - chars</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.chars.html">chars</a></li>
	...
	<div class="page-type">
		<h1>chars</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/chars.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>chars(value, lineNo)</code>
  </h2>
  <p>Called when <a href="https://developer.mozilla.org/en-US/docs/Web/API/CharacterData">CharacterData</a> is found within a tag.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{String}</code>: <p>The character data within the tag.</p>
</li>
        
          <li><b>lineNo</b> <code>{Number}</code>: <p>The starting line number of the text (undefined in production).</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/chars.md"},"description":"","title":"chars","name":"can-view-parser.ParseHandler.chars","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"chars(value, lineNo)","description":"\n\nCalled when [CharacterData](https://developer.mozilla.org/en-US/docs/Web/API/CharacterData) is found within a tag.\n","params":[{"types":[{"type":"String"}],"name":"value","description":"The character data within the tag."},{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the text (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lineNo","description":"The starting line number of the text (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
