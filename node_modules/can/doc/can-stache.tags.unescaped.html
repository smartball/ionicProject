...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/tags/unescaped.md
	@function can-stache.tags.unescaped
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.tags.unescaped.html">{{{expression}}}</a></li>
	...
	<div class="page-type">
		<h1>{{{expression}}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/tags/unescaped.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Behaves just like <a href="can-stache.tags.escaped.html" title="Insert the value of the expression into the output of the template.">{{expression}}</a> but does not
escape the result.</p>
<pre><code class="language-js">&lt;div&gt; {{{ toMarkdown(content) }}} &lt;/div&gt;
</code></pre>
