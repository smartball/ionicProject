...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/string-to-any.md
	@function can-stache-converters.string-to-any
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - string-to-any</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.string-to-any.html">string-to-any</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>string-to-any</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/string-to-any.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that binds a value to a primitive value, two-way converted back to that primitive value when the attribute changes.</p>
...
<div class="signature">
  ...
  <p>When the getter is called, gets the value of the compute and calls <code>.toString()</code> on that value.</p>
<p>When the setter is called, takes the new value and converts it to the primitive value using <a href="can-util/js/string-to-any/string-to-any.html" title="Turns a string representation of a primitive type back into the associated primitive.">string-to-any</a> and sets the compute using that converted value.</p>
<pre><code class="language-handlebars">&lt;select {($value)}=&quot;string-to-any(~favePlayer)&quot;&gt;
...
&lt;/select&gt;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>item</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute holding a primitive value.</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>This is usually used with <code>&lt;select&gt;</code>s where you would like to two-way bind a string to a primitive value.</p>
<pre><code class="language-handlebars">&lt;select {($value)}=&quot;string-to-any(~someValue)&quot;&gt;
...
<pre><code class="language-js">var str = document.getElementById('select-template').innerHTML;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/string-to-any.md"},"description":"A [can-stache.registerConverter converter] that binds a value to a primitive value, two-way converted back to that primitive value when the attribute changes. \n","title":"string-to-any","name":"can-stache-converters.string-to-any","type":"function","parent":"can-stache-converters.converters","signatures":[{"code":"string-to-any(~item)","description":"\n\nWhen the getter is called, gets the value of the compute and calls `.toString()` on that value.\n\nWhen the setter is called, takes the new value and converts it to the primitive value using [can-util/js/string-to-any/string-to-any] and sets the compute using that converted value.\n\n```handlebars\n<select {($value)}=\"string-to-any(~favePlayer)\">\n  <option value=\"23\">Michael Jordan</option>\n\t<option value=\"32\">Magic Johnson</option>\n</select>\n```\n","params":[{"types":[{"type":"can-compute"}],"name":"item","description":"A compute holding a primitive value."}],"returns":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter when the element’s value changes.\n"}}],"_curParam":{"types":[{"type":"can-compute"}],"name":"item","description":"A compute holding a primitive value."},"_curReturn":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter when the element’s value changes.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
