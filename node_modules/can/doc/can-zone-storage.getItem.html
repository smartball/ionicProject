...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.methods.getItem.md
	@function can-zone-storage.getItem
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-zone-storage.getItem</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.getItem.html">can-zone-storage.getItem</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-zone-storage.getItem</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.methods.getItem.md">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key name from which the data will be retrieved.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone-storage/docs/can-zone-storage.methods.getItem.md"},"description":"\n","title":"","name":"can-zone-storage.getItem","type":"function","parent":"can-zone-storage.methods","signatures":[{"code":"getItem(key)","description":"\n\nStores keyed data in the current data store.\n\n```js\nvar zoneStorage = require(\"can-zone-storage\");\n\nvar test = zoneStorage.getItem('key-name') // test === undefined\n\nvar value = 'Store me';\n\nzoneStorage.setItem('key-name', value);\nzoneStorage.getItem('key-name') // test === 'Store me'\n\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The key name from which the data will be retrieved."}]}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The key name from which the data will be retrieved."},"pathToRoot":".."};
</script>
</article>
