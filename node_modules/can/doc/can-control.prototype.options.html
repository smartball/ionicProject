...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-control/docs/options.md
	@property can-control.prototype.options
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - options</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-control.prototype.options.html">options</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>options</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-control/edit/master/docs/options.md">Edit on GitHub</a>
				</li>
    ...
    <p>Options used to configure a control.</p>
...
<p>The <code>this.options</code> property is an Object that contains
configuration data passed to a control when it is
created (<code>new Control(element, options)</code>).</p>
<p>In the following example, an options object with
a message is passed to a <code>Greeting</code> control. The
<code>Greeting</code> control changes the text of its <a href="can-control.prototype.element.html" title="The element passed to the Control when creating a new instance.">element</a>
to the options' message value.</p>
<pre><code>var Greeting = Control.extend({
    init: function(){
...
<p>The options argument passed when creating the control
is merged with <a href="can-control.defaults.html" title="Default values for the Control's options.">defaults</a> in
<a href="can-control.prototype.setup.html" title="Perform pre-initialization logic for control instances and classes.">setup</a>.</p>
<p>In the following example, if no message property is provided,
the defaults' message property is used.</p>
<pre><code>var Greeting = Control.extend({
    defaults: {
...
<h2>Options Observable</h2>
<p>An observable <a href="can-map.html" title="Create observable objects.">CanMap</a> or <a href="can-define/map/map.html" title="Create observable objects.">DefineMap</a> can also be passed instead of an options object.</p>
<p>In the following example, the defaults' message property is set on the <a href="can-define/map/map.html" title="Create observable objects.">DefineMap</a> options observable, which is then set directly as <code>this.options</code>:</p>
<pre><code>    var GreetingControl = Control.extend({
        defaults: {
            message: 'Hello'
        }
    }, {
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-control/docs/options.md"},"description":"Options used to configure a control. \n","types":[{"type":"Object","options":[]}],"title":"options","name":"can-control.prototype.options","type":"property","parent":"can-control.prototype","comment":" ","pathToRoot":".."};
</script>
</article>
