...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-ndjson/docs/isStreaming.md
	@property can-connect-ndjson/DefineList.prototype.isStreaming
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isStreaming</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="property"
							href="DefineList.prototype.isStreaming.html"
					...
					<li class="
           						...
           						">
						<a class="property"
							href="DefineList.prototype.streamError.html"
...
<div class="breadcrumb">
	...
	<li><a href="DefineList.prototype.isStreaming.html">isStreaming</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isStreaming</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-ndjson/edit/master/docs/isStreaming.md">Edit on GitHub</a>
				</li>
    ...
    <p>Set to <code>true</code> on the list if underlying stream is streaming and <code>false</code> when the stream is completed.</p>
...
<div class="signature">
  ...
  <p>Below is an example using <code>isStreaming</code> with a <code>DefineList</code> named <code>todos</code>:</p>
<pre><code>var todos = Todo.getList({}).then(todos =&gt; {
  console.log(todos.value.isStreaming);
  return todos;
});

</code></pre>
<p>Here we are using <code>isStreaming</code> in a <code>can-stache</code> template to communicate to your users that data is still being recieved from the stream:</p>
<pre><code>  {{#if todos.value.isStreaming}}
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-ndjson/docs/isStreaming.md"},"description":"Set to `true` on the list if underlying stream is streaming and `false` when the stream is completed. \n\n","types":[{"type":"Boolean","description":"\n\nBelow is an example using `isStreaming` with a `DefineList` named `todos`:\n\n```\nvar todos = Todo.getList({}).then(todos => {\n  console.log(todos.value.isStreaming);\n  return todos;\n});\n\n```\n\nHere we are using `isStreaming` in a `can-stache` template to communicate to your users that data is still being recieved from the stream:\n\n```\n  {{#if todos.value.isStreaming}}\n    <li style=\"color:#ccc\">Still loading...</li>\n  {{/if}}\n```"}],"title":"isStreaming","name":"can-connect-ndjson/DefineList.prototype.isStreaming","type":"property","parent":"can-connect-ndjson/DefineList","pathToRoot":"../.."};
</script>
</article>
