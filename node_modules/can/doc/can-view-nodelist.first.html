...
<!--####################################################################
	...
	@function can-view-nodelist.first
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - first</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-nodelist.first.html">first</a></li>
	...
	<div class="page-type">
		<h1>first</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L259">Edit on GitHub</a>
				</li>
...
references to other collections.">NodeList</a>}</code>: <p>A nodeList.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{HTMLElement}</code>: <p>The first element of the first list nested in this list.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.first","parent":"can-view-nodelist/methods","src":{"line":258,"codeLine":272,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"","title":"first","signatures":[{"code":"nodeLists.first(nodeList)","description":"\n\nReturn the first HTMLElement in a nodeList; if the first\nelement is a nodeList, returns the first HTMLElement of\nthe child list, etc.\n","params":[{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"nodeList","description":"A nodeList."}],"returns":{"types":[{"type":"HTMLElement"}],"description":"The first element of the first list nested in this list.\n\n\n "}}],"_curParam":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"nodeList","description":"A nodeList."},"_curReturn":{"types":[{"type":"HTMLElement"}],"description":"The first element of the first list nested in this list.\n\n\n "},"pathToRoot":".."};
</script>
</article>
