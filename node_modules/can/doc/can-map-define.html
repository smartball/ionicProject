...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/define.md
	@module can-map-define
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-map-define</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-map-define</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-map-define">
						<img src="https://img.shields.io/badge/npm%20package-3.1.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-map-define" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/define.md">Edit on GitHub</a>
				</li>
...
of a <a href="can-map.html" title="Create observable objects.">Map</a>.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>define</b> <code>{Object}</code>:
        <p>Exports object with helper methods internal to
<code>can-map-define</code>.  The export of <code>can-map-define</code> is not used directly, instead
the module is imported and all <a href="can-map.html" title="Create observable objects.">can-map</a>'s can have their properties defined like:</p>
...
var Person = CanMap.extend({
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="can-map-define.html" title="Defines the
type, initial value, get, set, remove, and serialize behavior for attributes
of a Map.">define</a> plugin allows you to completely control the behavior
of attributes on a <a href="can-map.html" title="Create observable objects.">Map</a>. To use it, you specify
an <code>define</code> object that is a mapping of properties
to <a href="can-map-define.attrDefinition.html" title="Defines the type, initial value, and get, set, and remove behavior for an attribute of a Map.">attribute definitions</a>. The following example
...
<p>The <a href="can-map-define.html" title="Defines the
type, initial value, get, set, remove, and serialize behavior for attributes
of a Map.">define</a> plugin not only allows you to define
individual attribute behaviors on a <a href="can-map.html" title="Create observable objects.">Map</a>, but you can also define default
...
a <a href="can-map.html" title="Create observable objects.">Map</a> but won't be certain of what every attribute will be.</p>
<p>The following example is a <a href="can-map.html" title="Create observable objects.">Map</a> that is tied to <a href="can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">route</a> where only
specified attributes that are serialized will be updated in the location hash:</p>
<pre><code>var State = Map.extend({
  define: {
    foo: {
      serialize: true
    },
...
<h2>Overview</h2>
<p>This plugin is a replacement for the now deprecated attributes and setter plugins. It intends to provide a single place to define the behavior of all the properties of a <a href="can-map.html" title="Create observable objects.">Map</a>.</p>
<p>Here is the cliffnotes version of this plugin.  To define...</p>
<ul>
<li>The default value for a property - use <a href="can-map-define.value.html" title="Returns the default value for instances of this Map.  This is called before init.">value</a></li>
<li>That default value as a constructor function - use <a href="can-map-define.ValueConstructor.html" title="Provides a constructor function to be used to provide a default value for a certain property of a Map.  This constructor will be invoked with new each time a new instance of the map is created.">Value</a></li>
<li>What value is returned when a property is read - use <a href="can-map-define.get.html" title="Specify what happens when a certain property is read on a map. get functions
work like a compute and automatically update themselves when a dependent
observable value is changed.">get</a></li>
<li>Behavior when a property is set - use <a href="can-map-define.set.html" title="Specify what happens when a value is set on a map attribute.">set</a></li>
<li>How a property is serialized when <a href="can-map.prototype.serialize.html" title="Serialize this object to something that can be passed to JSON.stringify.">serialize</a> is called on it - use <a href="can-map-define.serialize.html" title="Called when an attribute is removed.">serialize</a></li>
<li>Behavior when a property is removed - use <a href="can-map-define.remove.html" title="Called when an attribute is removed.">remove</a></li>
<li>A custom converter method or a pre-defined standard converter called whenever a property is set - use <a href="can-map-define._type.html" title="Converts a value passed to attr into an appropriate value.">type</a></li>
<li>That custom converter method as a constructor function - use <a href="can-map-define.TypeConstructor.html" title="Provides a constructor function to be used to convert any value passed into attr into an appropriate value">Type</a></li>
</ul>
<h2>Demo</h2>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-define/docs/define.md"},"description":"\nDefines the\n`type`, initial `value`, `get`, `set`, `remove`, and `serialize` behavior for attributes\nof a [can-map Map].\n","type":"module","title":"can-map-define","types":[{"type":"Object","options":[{"name":"define","description":"Exports object with helper methods internal to\n`can-map-define`.  The export of `can-map-define` is not used directly, instead\nthe module is imported and all [can-map]'s can have their properties defined like:\n\n```js\nvar CanMap = require(\"can-map\");\nrequire(\"can-map-define\");\n\nvar Person = CanMap.extend({\n    define: {\n        fullName: function(){\n            return this.attr(\"first\") + \" \"+ this.attr(\"last\")\n        }\n    }\n})\n```\n","types":[{"type":"Object","options":[]}]}]}],"name":"can-map-define","parent":"can-legacy","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":["**/node_modules/*","node_modules/**/*","**/*{-,_,}{test,qunit}{s,}.js"]},"readme":{"apis":"./doc/apis.json"},"parent":"can-map-define"},"bugs":{"url":"https://github.com/canjs/can-map-define/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.1.0-pre.9","can-event":"^3.5.0-pre.2","can-list":"^3.1.0-pre.9","can-map":"^3.1.0-pre.10","can-util":"^3.9.0-pre.4"},"deprecated":false,"description":"Define rich attribute behavior","devDependencies":{"bit-docs":"0.0.7","can-component":"^3.1.0-pre.0","can-route":"^3.1.0-pre.2","can-stache":"^3.1.0-pre.4","done-serve":"^0.2.5","donejs-cli":"^0.9.5","generator-donejs":"^0.9.6","jshint":"^2.9.4","steal":"^1.2.9","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.3.1"},"homepage":"https://canjs.com","keywords":["canjs"],"main":"can-map-define","name":"can-map-define","repository":{"type":"git","url":"git://github.com/canjs/can-map-define.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-map-define"},"version":"3.1.1"},"comment":" ","pathToRoot":".."};
</script>
</article>
