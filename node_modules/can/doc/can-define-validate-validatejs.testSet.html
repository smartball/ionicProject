...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-validate-validatejs/docs/test-set.md
	@function can-define-validate-validatejs.testSet
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - testSet</title>
...
functions from inside inheriting functions.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-validate-validatejs.errors.html"
							title="The errors method retrieves errors from validator.">
							errors
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="can-define-validate-validatejs.testSet.html"
							title="Tests value changes against constraints. Does not set errors on map instance.">
							testSet
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-define-validate-validatejs.html">can-define-validate-validatejs</a></li>
		<li> / </li>
	
	
	<li><a href="can-define-validate-validatejs.testSet.html">testSet</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>testSet</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-validate-validatejs/edit/master/docs/test-set.md">Edit on GitHub</a>
				</li>
    ...
    <p>Tests value changes against constraints. Does not set errors on map instance.</p>
...
<div class="signature">
  ...
  <p>Calls validator on the current values of a <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>. This is essentially the same as
calling <code>errors()</code>.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>}</code>: <p>Will return <code>undefined</code> if map is valid.
Otherwise, will return an array of [can-validate/types/errors].</p>
<pre><code class="language-js">  var Person = new DefineMap({
      name: {
          validate: {
              presence: true
          }
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.testSet(keyName, value)</code>
  </h2>
  <p>Changes <code>keyName</code>'s value in the map instance clone. Then checks if the object is valid.</p>
<pre><code class="language-js">var Person = new DefineMap({
name: {
    validate: {
        presence: true
...
//=&gt; [{message: &quot;is required&quot;, related: &quot;name&quot;}]
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>keyName</b> <code>{string}</code>: <p>The property key to test</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>The new value to test for <code>keyName</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>}</code>: <p>Will return <code>undefined</code> if test map is valid.
Otherwise, will return an array of <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.testSet(props, useNewInstance)</code>
  </h2>
  <p>Replaces many values on the map instance clone. Making <code>useNewInstance</code> set to
<code>true</code> will create a new instance of the map and test changes on the clean instance.</p>
<pre><code class="language-js">var Person = new DefineMap({
    name: {
        validate: {
            presence: true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{object}</code>: <p>An object of key/value pairs, where <code>key</code> is a property in
the map instance that will update to the new <code>value</code>.</p>
</li>
        
          <li><b>useNewInstance</b> <code>{boolean}</code>: <p>If <code>true</code>, will use a new instance of the
map constructor, then test changes against that new map instance.</p>
</li>
...
Otherwise, will return an array of <a href="can-validate.errors.html" title="The expected response from a validator if a value fails validation.">Errors</a>.</p>
    ...
    <section class="body">
    <h2>Usage</h2>
<p>With the exception of calling <code>testSet</code> with no arguments, <code>testSet</code> is called on a copy of the map instance, this is to prevent errors from
being set on the map instance when using <code>testSet</code>. This means that errors returned are a result of the values provided through arguments being merged with the existing values.</p>
<p>This behavior can be controlled when testing multiple values by passing <code>true</code> for <code>useNewInstance</code>. This will test values with a new instance of the map constructor, allowing better control of what values are tested.</p>
<pre><code class="language-javascript">map.testSet({name: '', age: 100}, true);
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-validate-validatejs/docs/test-set.md"},"description":"\nTests value changes against constraints. Does not set errors on map instance.\n","title":"testSet","name":"can-define-validate-validatejs.testSet","type":"function","parent":"can-define-validate-validatejs.defineMap","signatures":[{"code":"testSet()","description":"\n\n  Calls validator on the current values of a [can-define/map/map]. This is essentially the same as\n  calling `errors()`.\n","params":[],"returns":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if map is valid.\nOtherwise, will return an array of [can-validate/types/errors].\n\n```js\n  var Person = new DefineMap({\n      name: {\n          validate: {\n              presence: true\n          }\n      }\n  });\n  var person = new Person();\n  person.testSet();\n  // returns: [{message: \"is required\", related: \"name\"}]\n```\n"}},{"code":"map.testSet(keyName, value)","description":"\n\n  Changes `keyName`'s value in the map instance clone. Then checks if the object is valid.\n  ```js\n  var Person = new DefineMap({\n  name: {\n      validate: {\n          presence: true\n      }\n  }\n  });\n  var person = new Person({name: 'Juan'});\n  person.testSet('name', '');\n  //=> [{message: \"is required\", related: \"name\"}]\n  ```\n","params":[{"types":[{"type":"string"}],"name":"keyName","description":"The property key to test"},{"types":[{"type":"*"}],"name":"value","description":"The new value to test for `keyName`.\n"}],"returns":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if test map is valid.\nOtherwise, will return an array of [can-validate.errors].\n"}},{"code":"map.testSet(props, useNewInstance)","description":"\n\n  Replaces many values on the map instance clone. Making `useNewInstance` set to\n  `true` will create a new instance of the map and test changes on the clean instance.\n\n  ```js\n  var Person = new DefineMap({\n      name: {\n          validate: {\n              presence: true\n          }\n      },\n      age: {\n          validate: {\n              numericality: true\n          }\n      }\n  });\n  var person = new Person({name: 'Juan', age: 35});\n\n  // this returns [{message: \"is required\", related: \"name\"}]\n  person.testSet({name: ''});\n\n  //this returns [{message: \"is required\", related: \"name\"}]\n  person.testSet({age: 35}, true);\n  ```\n","params":[{"types":[{"type":"object"}],"name":"props","description":"An object of key/value pairs, where `key` is a property in\nthe map instance that will update to the new `value`.\n"},{"types":[{"type":"boolean"}],"optional":true,"name":"useNewInstance","defaultValue":"false","description":"If `true`, will use a new instance of the\nmap constructor, then test changes against that new map instance.\n"}],"returns":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if test map is valid.\nOtherwise, will return an array of [can-validate.errors].\n"}}],"_curReturn":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if test map is valid.\nOtherwise, will return an array of [can-validate.errors].\n"},"_curParam":{"types":[{"type":"boolean"}],"optional":true,"name":"useNewInstance","defaultValue":"false","description":"If `true`, will use a new instance of the\nmap constructor, then test changes against that new map instance.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
