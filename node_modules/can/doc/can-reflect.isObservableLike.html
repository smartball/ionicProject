...
<!--####################################################################
	...
	@function can-reflect.isObservableLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isObservableLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isObservableLike.html">isObservableLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isObservableLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L262">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value (or its keys) can be observed for changes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isObservableLike(obj)</code>
  </h2>
  <p>Return  <code>true</code> if <code>obj</code> is <em>not</em> a primitive and implements any of
<a href="can-symbol/symbols/onValue.html" title="Defines how observables can listen to the object's value changing."><code>@@can.onValue</code></a>, <a href="can-symbol/symbols/onKeyValue.html" title="Defines how observable values can be listened to on a type."><code>@@can.onKeyValue</code></a>,
<a href="can-symbol/symbols/onKeys.html" title="Define a function used to listen to when the object's key set changes."><code>@@can.onKeys</code></a>,
or <a href="can-symbol/symbols/onKeysAdded.html" title="Define a function used to listen to when the object's key set has new additions."><code>@@can.onKeysAdded</code></a>; <code>false</code> otherwise.</p>
<pre><code>canReflect.isObservableLike(null); // -&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>maybe an observable</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect.isObservableLike","type":"function","parent":"can-reflect/type","src":{"line":261,"codeLine":287,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value (or its keys) can be observed for changes. \n","title":"isObservableLike","signatures":[{"code":"isObservableLike(obj)","description":"\n\nReturn  `true` if `obj` is _not_ a primitive and implements any of\n[can-symbol/symbols/onValue `@@can.onValue`], [can-symbol/symbols/onKeyValue `@@can.onKeyValue`],\n[can-symbol/symbols/onKeys `@@can.onKeys`],\nor [can-symbol/symbols/onKeysAdded `@@can.onKeysAdded`]; `false` otherwise.\n\n```\ncanReflect.isObservableLike(null); // -> false\ncanReflect.isObservableLike({}); // -> false\ncanReflect.isObservableLike([]); // -> false\ncanReflect.isObservableLike(function() {}); // -> false\ncanReflect.isObservableLike({ [canSymbol.for(\"can.onValue\")]: function() {} }); // -> true\ncanReflect.isObservableLike({ [canSymbol.for(\"can.onKeyValue\")]: function() {} }); // -> true\ncanReflect.isObservableLike(canCompute())); // -> true\ncanReflect.isObservableLike(new DefineMap())); // -> true\n```\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"maybe an observable"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"obj","description":"maybe an observable"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
