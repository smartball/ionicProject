...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-kefir/doc/can-kefir.md
	@module can-kefir
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-kefir</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-kefir/can.getKeyValue.html"
							title="Used by can-reflect.getKeyValue to read the stream&#x27;s last emitted value or error and make those properties observable
by can-observation.">
							can.getKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-kefir/can.offKeyValue.html"
							title="Used by can-reflect.offKeyValue to stop listening to when the underlying stream emits either a value or error with a new value.">
							can.offKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-kefir/can.onKeyValue.html"
							title="Used by can-reflect.onKeyValue to listen to when the underlying stream emits either a value or error with a new value.">
							can.onKeyValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-kefir/can.setKeyValue.html"
							title="Used by can-reflect.setKeyValue to set the stream&#x27;s last emitted value or error.  This symbol is only added to
emitterProperty objects.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-kefir/emitterProperty.html"
...
<div class="breadcrumb">
	...
	<li><a href="can-kefir.html">can-kefir</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-kefir</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-kefir">
						<img src="https://img.shields.io/badge/npm%20package-0.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-kefir" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-kefir/edit/master/doc/can-kefir.md">Edit on GitHub</a>
				</li>
    ...
    <p>Integrate <a href="https://rpominov.github.io/kefir/">KefirJS</a> streams directly within <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> and other parts of CanJS.</p>
...
<div class="signature">
  ...
  <p><code>can-kefir</code> exposes <code>value</code> and <code>error</code> key values on a stream that can be read and listened to
by <a href="can-reflect.html" title="Perform operations and read information on unknown data types.">can-reflect</a> and therefore many other CanJS libraries like <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> and <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>.</p>
<p>The <code>can-kefir</code> module imports <a href="https://rpominov.github.io/kefir/">KefirJS</a> and mutates it in two ways:</p>
<p>First, it adds <a href="can-symbol.html" title="Symbols used to detail how CanJS may operate on different objects
CanJS has a consistent internal interface for objects to interact with each other, and this is also important for interop
with external libraries.  CanJS uses symbols to identify object types, property access methods, and for event
handling.
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">symbols</a>
to Kefir's types so Kefir streams can be read and listened to for changes by <a href="can-reflect.html" title="Perform operations and read information on unknown data types.">can-reflect</a>.  This allows integration with various parts of CanJS like <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> and <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>.</p>
<p>Second, it adds a <a href="can-kefir/emitterProperty.html" title=".emitterProperty()">emitterProperty</a> method that creates a stream that is more easily writable.</p>
<p>The decorated <code>Kefir</code> object is exported by the <code>can-kefir</code> module.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use it with <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a>, create a stream and use <code>.value</code> or <code>.error</code> to write out the<br />
last emitted value or error.</p>
<p>The following will show a number increasing to 3 over 3 seconds:</p>
...
<h2>emitterProperty</h2>
<p>Use <a href="can-kefir/emitterProperty.html" title=".emitterProperty()">emitterProperty</a> to create an stream object that also
has an emitter-like object attached.  The following creates an <code>age</code> stream that we can emit events on with its <code>emitter.value()</code> method:</p>
<pre><code class="language-js">var Kefir = require(&quot;can-kefir&quot;);
