...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helperOptions.md
	@typedef can-stache.helperOptions
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - helperOptions</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helperOptions.html">helperOptions</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>helperOptions</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helperOptions.md">Edit on GitHub</a>
				</li>
    ...
    <p>The options argument passed to a <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helper function</a> when called by a <a href="can-stache/expressions/helper.html" title="">Helper Expression</a>.</p>
...
<div class="signature">
  ...
  <p>When a <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helper function</a>
is called by a <a href="can-stache/expressions/helper.html" title="">Helper Expression</a>, a <code>helperOptions</code>
object is passed with the following properties:</p>
<pre><code>stache.registerHelper(&quot;myHelper&quot;, function(helperOptions){
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>fn</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>:
        <p>Renders the &quot;truthy&quot; subsection
...
or the expression's return value.">{{#expression}}</a> or <a href="can-stache.tags.inverse.html" title="Like can-stache.tags.section, but renders the opposite subsection depending on the type of expression
or the expression's return value.">{{^expression}}</a>. Read about
<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">section renderer</a> for more information.</p>

      </li>
    
      <li>
        <b>inverse</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>:
        <p>Renders the &quot;falsey&quot; subsection
INVERSE.  <code>options.inverse</code> is only available if the helper is called as a
<a href="can-stache.tags.section.html" title="Renders a subsection one or more times depending on the type of expression
or the expression's return value.">{{#expression}}</a> or <a href="can-stache.tags.inverse.html" title="Like can-stache.tags.section, but renders the opposite subsection depending on the type of expression
or the expression's return value.">{{^expression}}</a> and <a href="can-stache.helpers.else.html" title="">{{else}}</a>
is used. Read about
<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">section renderer</a> for more information.</p>
      ...
      <li>
        <b>hash</b> <code>{Object}</code>:
        <p>An object containing all of the
<a href="can-stache.expressions.html" title="In addition to different magic tag types, stache supports different expression
types.  These can be used in various combinations to call helper methods
or viewModel methods.  The following is an example of all the expressions
combined:">Hash expression</a> keys and values. For example:</p>
<pre><code>{{helper arg1 arg2 name=value other=3 position=&quot;top&quot;}}
</code></pre>
<p>might provide a <code>hash</code> like:</p>
<pre><code>{
        name: compute(&quot;Mr. Pig&quot;),
        other: 3,
        position: &quot;top&quot;
      ...
      <li>
        <b>context</b> <code>{*}</code>:
        <p>The current context the stache helper is called within. Read
<a href="can-stache.scopeAndContext.html" title="">Scope and Context</a> for more information.</p>

      </li>
    
      <li>
        <b>scope</b> <code>{<a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a>}</code>:
        <p>An object that represents the current context and all parent
contexts. It can be used to look up <a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a> values in the current scope.
Read <a href="can-stache.scopeAndContext.html" title="">Scope and Context</a> and <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> for more information.</p>

      </li>
    
      <li>
        <b>options</b> <code>{<a href="can-view-scope.Options.html" title="">Options</a>}</code>:
        <p>It can be used to look up <a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a> values in the current options scope.
Read <a href="can-stache.scopeAndContext.html" title="">Scope and Context</a> and <a href="can-view-scope.Options.html" title="">Options</a> for more information.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helperOptions.md"},"description":"The options argument passed to a [can-stache.helper helper function] when called by a [can-stache/expressions/helper].\n\n","type":"typedef","title":"helperOptions","types":[{"type":"Object","options":[{"name":"fn","description":"Renders the \"truthy\" subsection\nBLOCK.  `options.fn` is only available if the helper is called as a\n[can-stache.tags.section] or [can-stache.tags.inverse]. Read about\n[can-stache.sectionRenderer section renderer] for more information.\n","types":[{"type":"can-stache.sectionRenderer"}],"optional":true},{"name":"inverse","description":"Renders the \"falsey\" subsection\nINVERSE.  `options.inverse` is only available if the helper is called as a\n[can-stache.tags.section] or [can-stache.tags.inverse] and [can-stache.helpers.else]\nis used. Read about\n[can-stache.sectionRenderer section renderer] for more information.\n","types":[{"type":"can-stache.sectionRenderer"}],"optional":true},{"name":"hash","description":"An object containing all of the\n[can-stache.expressions Hash expression] keys and values. For example:\n\n```\n{{helper arg1 arg2 name=value other=3 position=\"top\"}}\n```\n\nmight provide a `hash` like:\n\n```\n{\n\t\tname: compute(\"Mr. Pig\"),\n\t\tother: 3,\n\t\tposition: \"top\"\n}\n```\n","types":[{"type":"Object","options":[]}]},{"name":"context","description":"The current context the stache helper is called within. Read\n[can-stache.scopeAndContext] for more information.\n\n","types":[{"type":"*"}]},{"name":"scope","description":"An object that represents the current context and all parent\ncontexts. It can be used to look up [can-stache.key key] values in the current scope.\nRead [can-stache.scopeAndContext] and [can-view-scope] for more information.\n","types":[{"type":"can-view-scope"}]},{"name":"options","description":"It can be used to look up [can-stache.key key] values in the current options scope.\nRead [can-stache.scopeAndContext] and [can-view-scope.Options] for more information.\n","types":[{"type":"can-view-scope.Options"}]}],"description":"\n\nWhen a [can-stache.helper helper function]\nis called by a [can-stache/expressions/helper], a `helperOptions`\nobject is passed with the following properties:\n\n```\nstache.registerHelper(\"myHelper\", function(helperOptions){\n  helperOptions.fn      //-> sectionRenderer(){}\n  helperOptions.inverse //-> sectionRenderer(){}\n  helperOptions.hash    //-> Object\n  helperOptions.context //-> *\n  helperOptions.scope   //-> Scope\n  helperOptions.option  //-> Scope.Options\n});\n```\n"}],"name":"can-stache.helperOptions","parent":"can-stache.types","pathToRoot":".."};
</script>
</article>
