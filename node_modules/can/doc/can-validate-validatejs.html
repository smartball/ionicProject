...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-validatejs/docs/can-validate-validatejs.md
	@module can-validate-validatejs
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-validate-validatejs</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-validate-validatejs.many.html"
							title="">
							many
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate-validatejs.html">can-validate-validatejs</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-validate-validatejs</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-validate-validatejs">
						<img src="https://img.shields.io/badge/npm%20package-0.1.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-validate-validatejs" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-validatejs/edit/master/docs/can-validate-validatejs.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create <a href="can-validate.validator.html" title="A function that validates a value against predefined constraints and returns validation errors, if any are found.">validator</a> functions using <a href="https://validatejs.org/">validate.js</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makeValidator(constraints)</code>
  </h2>
  <p>Returns a validator function that can be used to validate a single value.</p>
<pre><code class="language-js">var validateAge = makeValidator({
    numericality: true
});
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>constraints</b> <code>{Object}</code>: <p>An object of definitions used by the Validate.js library to run validations on a value.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Validator}</code>: <p>A validator type function that takes a value and validates it against the provided constraints.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Usage</h2>
<p>A validator can be created either for a single value or for many values.  More information on how to configure Validate.JS constraints can be found <a href="https://validatejs.org/#validators">here</a>.</p>
<h3>Single value validation</h3>
<p>Using the <a href="https://validatejs.org/">Validate.js</a> library validators and configuration, call <code>makeValidator</code> and pass the desired constraints. The resulting function can then be used to validate specific values.</p>
<pre><code class="language-js">var makeValidator = require('can-validate-validatejs');
...
<h3>Multiple value validation</h3>
<p>Using the <a href="can-validate-validatejs.many.html" title="">many</a> works similar to <code>makeValidator</code>, except that <code>makeValidator.many</code> produces a validator that expects an object of values. The validator will run constraints on respective values based on the keys provided.</p>
<pre><code class="language-javascript">var makeValidator = require('can-validate-validatejs');
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-validatejs/docs/can-validate-validatejs.md"},"description":"Create [can-validate.validator] functions using [validate.js](https://validatejs.org/). \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-validate-validatejs","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-validate-validatejs/issues"},"bundleDependencies":false,"dependencies":{"can-util":"^3.9.0-pre.4","validate.js":"^0.11.1"},"deprecated":false,"description":"Create validator functions that use ValidateJS to validate values.","devDependencies":{"bit-docs":"^0.0.7","http-server":"^0.9.0","jshint":"^2.9.4","steal":"^1.0.8","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"homepage":"https://github.com/canjs/can-validate-validatejs#readme","keywords":["Validate","Validate.js","can-validate","plugin","canjs"],"license":"MIT","main":"can-validate-validatejs.js","name":"can-validate-validatejs","repository":{"type":"git","url":"git+https://github.com/canjs/can-validate-validatejs.git"},"scripts":{"build":"node build.js","develop":"http-server -c-1","jshint":"jshint .","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"ignoreBrowser":true,"npmIgnore":["bit-docs","testee","steal-tools"],"npmAlgorithm":"flat","npmDependencies":["steal-qunit"],"paths":{"validate.js":"./node_modules/validate.js/validate.js"},"transpiler":"babel"},"version":"0.1.0"},"signatures":[{"code":"makeValidator(constraints)","description":"\n\nReturns a validator function that can be used to validate a single value.\n\n  ```js\n  var validateAge = makeValidator({\n      numericality: true\n  });\n  ```\n\n","params":[{"types":[{"type":"Object","options":[]}],"name":"constraints","description":"An object of definitions used by the Validate.js library to run validations on a value.\n"}],"returns":{"types":[{"type":"Validator"}],"description":"A validator type function that takes a value and validates it against the provided constraints.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"constraints","description":"An object of definitions used by the Validate.js library to run validations on a value.\n"},"_curReturn":{"types":[{"type":"Validator"}],"description":"A validator type function that takes a value and validates it against the provided constraints.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
