...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>dev</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-test-helpers/edit/master/lib/dev.js">Edit on GitHub</a>
				</li>
    ...
    <p>The <code>dev</code> utilities group contains functions to assist with testing with the <a href="../can-util/js/dev/dev.html" title="Deprecated. Use can-dev instead.">can-util dev</a> module.
can-util's dev provides facilities for development that are switched off in production builds.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-test-helpers/dev","type":"module","parent":"can-test-helpers","src":{"line":0,"codeLine":8,"path":"node_modules/can-test-helpers/lib/dev.js"},"description":"\nThe `dev` utilities group contains functions to assist with testing with the [can-util/js/dev/dev can-util dev] module.\ncan-util's dev provides facilities for development that are switched off in production builds.\n","title":"dev","types":[{"type":"Object","options":[]}],"pathToRoot":"../.."};
</script>
</article>
