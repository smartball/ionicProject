...
<!--####################################################################
	...
	@function can-test-helpers/lib/dev.willError
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - willError</title>
...
<div class="breadcrumb">
	...
	<li><a href="dev.willError.html">willError</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>willError</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-test-helpers/edit/master/lib/dev.js#L109">Edit on GitHub</a>
				</li>
    ...
    <p>Requests that [can-util/js/dev/dev.error canDev.error] track and notify about matching errors.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dev.willError(expected, [fn])</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>expected</b> <code>{String|Regexp}</code>: <p>The error message to check for</p>
</li>
        
          <li><b>fn</b> <code>{function(String, Boolean)}</code>: <p>an optional callback to fire on every error; each call has the actual error
message and a Boolean indicating whether it was matched</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>A function that tears down the error check and returns the number of matched errors when called.</p>
</p>
  </div>
    ...
    <section class="body">
    <p><code>willError()</code> takes either a String or a RegExp as its <code>expected</code> error, and does a full, case-sensitive String
match in the case of a String, or a regex test in the case of a RegExp, for every error logged through
[can-util/js/dev/dev.error].  In addition, if <code>fn</code> is provided, it is fired on <em>every</em> error logged by dev.error
with the content of the error message and whether it matched <code>expected</code>.</p>
<p><code>willError()</code> returns a teardown function, which must be called at least once to disable the tracking of the matched
error.  when called, the teardown function returns the number of times <code>expected</code> was matched by a dev error.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-test-helpers/lib/dev.willError","type":"function","parent":"can-test-helpers/dev","src":{"line":108,"codeLine":144,"path":"node_modules/can-test-helpers/lib/dev.js"},"description":"Requests that [can-util/js/dev/dev.error canDev.error] track and notify about matching errors. \n","title":"willError","signatures":[{"code":"dev.willError(expected, [fn])","description":"","params":[{"types":[{"type":"String"},{"type":"Regexp"}],"name":"expected","description":"The error message to check for"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"Boolean"}]}]}],"optional":true,"name":"fn","description":"an optional callback to fire on every error; each call has the actual error\n message and a Boolean indicating whether it was matched"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that tears down the error check and returns the number of matched errors when called.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"Boolean"}]}]}],"optional":true,"name":"fn","description":"an optional callback to fire on every error; each call has the actual error\n message and a Boolean indicating whether it was matched"},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that tears down the error check and returns the number of matched errors when called.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
