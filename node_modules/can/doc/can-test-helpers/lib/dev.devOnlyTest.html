...
<!--####################################################################
	...
	@function can-test-helpers/lib/dev.devOnlyTest
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - devOnlyTest</title>
...
<div class="breadcrumb">
	...
	<li><a href="dev.devOnlyTest.html">devOnlyTest</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>devOnlyTest</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-test-helpers/edit/master/lib/dev.js#L147">Edit on GitHub</a>
				</li>
    ...
    <p>Defines a test that runs only in development mode.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>waits</b> <code>{Number}</code>: <p>an optional number of async waits</p>
</li>
        
          <li><b>name</b> <code>{String}</code>: <p>the String identifier for the test in the test module</p>
</li>
        
          <li><b>fn</b> <code>{function}</code>: <p>the function body of the test.</p>
<p>The parameter list above assumes that <code>test</code> on the global object is a QUnit test function. With <code>devOnlyTest</code>,
...
behavior that only exists in development builds.</p>
</li>
    ...
    <section class="body">
    <pre><code>dev.devOnlyTest(&quot;it works&quot;, function() {
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-test-helpers/lib/dev.devOnlyTest","parent":"can-test-helpers/dev","src":{"line":146,"codeLine":171,"path":"node_modules/can-test-helpers/lib/dev.js"},"description":"Defines a test that runs only in development mode. \n","title":"devOnlyTest","signatures":[{"code":"dev.devOnlyTest(...)","description":"\n","params":[{"types":[{"type":"Number"}],"optional":true,"name":"waits","description":"an optional number of async waits"},{"types":[{"type":"String"}],"name":"name","description":"the String identifier for the test in the test module"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"fn","description":"the function body of the test.\n\n\nThe parameter list above assumes that `test` on the global object is a QUnit test function. With `devOnlyTest`,\nthe global test function will be run with the supplied parameters when the system environment is either\nunknown or not one of the production tests.  This is to help facilitate tests that rely on, e.g., canDev\nbehavior that only exists in development builds.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"fn","description":"the function body of the test.\n\n\nThe parameter list above assumes that `test` on the global object is a QUnit test function. With `devOnlyTest`,\nthe global test function will be run with the supplied parameters when the system environment is either\nunknown or not one of the production tests.  This is to help facilitate tests that rely on, e.g., canDev\nbehavior that only exists in development builds.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
