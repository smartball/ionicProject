...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-test-helpers/lib/dev.js
	@function can-test-helpers/lib/dev.willWarn
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - willWarn</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
						...
						<a class="module"
							href="../dev.html"
							title="The dev utilities group contains functions to assist with testing with the can-util dev module.
can-util&#x27;s dev provides facilities for development that are switched off in production builds.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="dev.devOnlyTest.html"
							title="Defines a test that runs only in development mode.">
							devOnlyTest
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="dev.willError.html"
							title="Requests that canDev.error track and notify about matching errors.">
							willError
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="dev.willWarn.html"
							title="Requests that canDev.warn track and notify about matching warnings.">
							willWarn
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="../../can-test-helpers.html">can-test-helpers</a></li>
		<li> / </li>
	...
	<li><a href="dev.willWarn.html">willWarn</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>willWarn</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-test-helpers/edit/master/lib/dev.js#L71">Edit on GitHub</a>
				</li>
    ...
    <p>Requests that [can-util/js/dev/dev.warn canDev.warn] track and notify about matching warnings.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dev.willWarn(expected, [fn])</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>expected</b> <code>{String|Regexp}</code>: <p>The warning message to check for</p>
</li>
        
          <li><b>fn</b> <code>{function(String, Boolean)}</code>: <p>an optional callback to fire on every warning; each call has the actual warning
message and a Boolean indicating whether it was matched</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>A function that tears down the warning check and returns the number of matched warnings when called.</p>
</p>
  </div>
    ...
    <section class="body">
    <p><code>willWarn()</code> takes either a String or a RegExp as its <code>expected</code> warning, and does a full, case-sensitive String
match in the case of a String, or a regex test in the case of a RegExp, for every warning logged through
[can-util/js/dev/dev.warn].  In addition, if <code>fn</code> is provided, it is fired on <em>every</em> warning with the content
of the warning message and whether it matched <code>expected</code>.</p>
<p><code>willWarn()</code> returns a teardown function, which must be called at least once to disable the tracking of the matched
warning.  when called, the teardown function returns the number of times <code>expected</code> was matched by a dev warning.</p>
<pre><code>var dev = require('can-util/js/dev/dev');
...
<script type="text/javascript">
  window.docObject = {"name":"can-test-helpers/lib/dev.willWarn","type":"function","parent":"can-test-helpers/dev","src":{"line":70,"codeLine":106,"path":"node_modules/can-test-helpers/lib/dev.js"},"description":"Requests that [can-util/js/dev/dev.warn canDev.warn] track and notify about matching warnings. \n","title":"willWarn","signatures":[{"code":"dev.willWarn(expected, [fn])","description":"","params":[{"types":[{"type":"String"},{"type":"Regexp"}],"name":"expected","description":"The warning message to check for"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"Boolean"}]}]}],"optional":true,"name":"fn","description":"an optional callback to fire on every warning; each call has the actual warning\n message and a Boolean indicating whether it was matched"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that tears down the warning check and returns the number of matched warnings when called.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"String"}]},{"types":[{"type":"Boolean"}]}]}],"optional":true,"name":"fn","description":"an optional callback to fire on every warning; each call has the actual warning\n message and a Boolean indicating whether it was matched"},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that tears down the warning check and returns the number of matched warnings when called.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
