...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-import/docs/dynamic.md
	@page can-view-import.pages.dynamic
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Dynamic Imports</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-import.pages.dynamic.html">Dynamic Imports</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Dynamic Imports</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-import/edit/master/docs/dynamic.md">Edit on GitHub</a>
				</li>
    ...
    <p>Dynamic imports are used in conditional situations such as within an <a href="can-stache.helpers.if.html" title="can-stache.helpers.if">{{#if(expression)}}</a> to prevent unnecessarily fetching resources that might not be needed in all cases.</p>
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <h3>Example</h3>
<p>These <code>can-dynamic-import</code> and Steal import examples are equivalent:</p>
<pre><code>&lt;can-dynamic-import from=&quot;components/foobar&quot;&gt;
  {{#if isResolved}}
    &lt;foobar/&gt;
  {{/if}}
&lt;/can-dynamic-import&gt;
</code></pre>
<pre><code>steal.import('components/foobar').then(function(foobar) {
 // access to the module you loaded.
 // e.g. access to a component's ViewModel 
 // foobar.ViewModel
});
</code></pre>
<p><strong>Note:</strong> when dynamically importing modules in a stache file, the scope inside <a href="can-view-import.html" title="">&lt;can-import&gt;</a> is a Promise, so you have to wait until it is resolved before injecting something like a <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>. Use the <code>{{#if isResolved}}</code> helper to determine whether the Promise has been resolved.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-import/docs/dynamic.md"},"description":"\nDynamic imports are used in conditional situations such as within an [can-stache.helpers.if] to prevent unnecessarily fetching resources that might not be needed in all cases.\n","name":"can-view-import.pages.dynamic","title":"Dynamic Imports","type":"page","parent":"can-view-import.pages","pathToRoot":".."};
</script>
</article>
