...
<div class="breadcrumb">
	...
	<li><a href="can-set.Translate.html">Translate</a></li>
	...
	<div class="page-type">
		<h1>Translate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L10">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Localizes a clause's properties within another nested property.</p>
...
<p>This is useful when filters (which are <code>where</code> clauses) are
within a nested object.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>clause</b> <code>{String}</code>: <p>A clause type.  One of <code>'where'</code>, <code>'order'</code>, <code>'paginate'</code>, <code>'id'</code>.</p>
</li>
        
          <li><b>propertyName</b> <code>{String|Object}</code>: <p>The property name which contains the clauses's properties.</p>
</li>
...
}">Compares</a>}</code>: <p>A set compares object that can do the translation.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Translate","parent":"can-set.properties","src":{"line":9,"codeLine":33,"path":"node_modules/can-set/src/set-core.js"},"description":"","title":"Translate","signatures":[{"code":"new set.Translate(clauseType, propertyName)","description":"\n\nLocalizes a clause's properties within another nested property.\n\n```js\nvar algebra = new set.Algebra(\n  new set.Translate(\"where\",\"$where\")\n);\nalgebra.has(\n  {$where: {complete: true}},\n  {id: 5, complete: true}\n) //-> true\n```\n\nThis is useful when filters (which are `where` clauses) are\nwithin a nested object.\n","params":[{"types":[{"type":"String"}],"name":"clause","description":"A clause type.  One of `'where'`, `'order'`, `'paginate'`, `'id'`."},{"types":[{"type":"String"},{"type":"Object","options":[]}],"name":"propertyName","description":"The property name which contains the clauses's properties."}],"returns":{"types":[{"type":"can-set.compares"}],"description":"A set compares object that can do the translation.\n"}}],"_curParam":{"types":[{"type":"String"},{"type":"Object","options":[]}],"name":"propertyName","description":"The property name which contains the clauses's properties."},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"A set compares object that can do the translation.\n"},"pathToRoot":".."};
</script>
</article>
