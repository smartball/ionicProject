...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/compute.md
	@module can-compute
######################################################################## -->
<html lang="en">
<head>
			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-compute">
						<img src="https://img.shields.io/badge/npm%20package-3.3.8-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-compute" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/compute.md">Edit on GitHub</a>
				</li>
...
<h2>Caching values</h2>
<p>A compute that has an event listener will cache its value and only update when one of its source observables change.</p>
<p>For example:</p>
...
<p>In contrast, if we didn't bind to the compute:</p>
<pre><code class="language-js">var foo = {
    first: &quot;Wonder&quot;
};
var last = compute(&quot;Woman&quot;);
