...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/can-view-parser.md
	@module can-view-parser
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-view-parser</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-view-parser.ParseHandler.html"
							title="An object consisting of callback functions that handle stages in the parsing process and settings that configure the parsing process.">
							ParseHandler
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.html">can-view-parser</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-view-parser</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-view-parser">
						<img src="https://img.shields.io/badge/npm%20package-3.6.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-view-parser" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/can-view-parser.md">Edit on GitHub</a>
				</li>
    ...
    <p>Parse HTML and mustache tokens.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>html</b> <code>{String|Object}</code>: <p>A mustache and html string to parse or an intermediate object the represents a previous parsing.</p>
</li>
        
          <li><b>handler</b> <code>{<a href="can-view-parser.ParseHandler.html" title="An object consisting of callback functions that handle stages in the parsing process and settings that configure the parsing process.">ParseHandler</a>}</code>: <p>An object of callbacks.</p>
</li>
        
          <li><b>returnIntermediate</b> <code>{Boolean}</code>: <p>If true, returns a JS object representation of the parsing.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/can-view-parser.md"},"description":"Parse HTML and mustache tokens. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-view-parser","parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-view-parser/issues"},"bundleDependencies":false,"dependencies":{"can-attribute-encoder":"^0.3.1","can-log":"^0.1.0","can-namespace":"1.0.0"},"deprecated":false,"description":"Parses html and magic tags","devDependencies":{"bit-docs":"0.0.7","can-test-helpers":"^1.0.1","detect-cyclic-packages":"^1.1.0","done-serve":"^1.2.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.7.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-view-parser","name":"can-view-parser","repository":{"type":"git","url":"git://github.com/canjs/can-view-parser.git"},"scripts":{"build":"node build.js","detect-cycle":"detect-cyclic-packages --ignore done-serve","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run detect-cycle && npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.6.2"},"signatures":[{"code":"parse(html, handler, [returnIntermediate])","description":"\n\nParse an html string:\n\n```js\nvar parser = require(\"can-view-parser\");\n\nvar html = '<h1><span bob=\"phillips\"></span><span bob=\"meyers\"></span>' +\n\t'</h1>';\n\nvar bobs = {};\nvar curAttr;\n\nparser(html, {\n\tattrStart: function(attrName){\n\t\tcurAttr = attrName;\n\t},\n\tattrValue: function(value){\n\t\tbobs[curAttr] = value;\n\t}\n});\n\nfor(var first in bobs) {\n\tvar last = bobs[first];\n\tconsole.log(\"Hello\", first, last);\n}\n```\n","params":[{"types":[{"type":"String"},{"type":"Object","options":[]}],"name":"html","description":"A mustache and html string to parse or an intermediate object the represents a previous parsing."},{"types":[{"type":"can-view-parser.ParseHandler"}],"name":"handler","description":"An object of callbacks."},{"types":[{"type":"Boolean"}],"optional":true,"name":"returnIntermediate","defaultValue":"false","description":"If true, returns a JS object representation of the parsing.\n"}]}],"_curParam":{"types":[{"type":"Boolean"}],"optional":true,"name":"returnIntermediate","defaultValue":"false","description":"If true, returns a JS object representation of the parsing.\n"},"pathToRoot":".."};
</script>
</article>
