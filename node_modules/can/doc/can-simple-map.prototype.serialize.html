...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-simple-map/docs/prototype.serialize.md
	@function can-simple-map.prototype.serialize
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-simple-map.prototype.serialize.html">serialize</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serialize</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-simple-map/edit/master/docs/prototype.serialize.md">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the serialized form of the simple-map.</p>
...
<div class="signature">
  ...
  <p>Returns the serialized form of the simple-map, with any values in the map that
have a serialize method also having serialized called.</p>
<pre><code class="language-js">var map = new SimpleMap();
...
map.serialize() //-&gt;  {deep: {a: &quot;b&quot;}}
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A plain JavaScript object that will only contain
primitives and other plain JavaScript objects.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-simple-map/docs/prototype.serialize.md"},"description":"Returns the serialized form of the simple-map. \n","title":"serialize","name":"can-simple-map.prototype.serialize","type":"function","parent":"can-simple-map.prototype","signatures":[{"code":"map.serialize()","description":"\n\nReturns the serialized form of the simple-map, with any values in the map that\nhave a serialize method also having serialized called.\n\n```js\nvar map = new SimpleMap();\nmap.set(\"deep\", new SimpleMap({a: \"b\"}));\n\nmap.serialize() //->  {deep: {a: \"b\"}}\n```\n","params":[],"returns":{"types":[{"type":"Object","options":[]}],"description":"A plain JavaScript object that will only contain\nprimitives and other plain JavaScript objects.\n"}}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A plain JavaScript object that will only contain\nprimitives and other plain JavaScript objects.\n"},"pathToRoot":".."};
</script>
</article>
