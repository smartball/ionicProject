...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/tag.md
	@property can-component.prototype.tag
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-component.prototype.tag.html">tag</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>tag</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/tag.md">Edit on GitHub</a>
				</li>
    ...
    <p>Specifies the HTML tag (or node-name) the <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a> will be created on.</p>
...
<div class="signature">
  ...
  <p>The tag name the <a href="can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a>
will be created on.  Tag names are typically lower cased and
hyphenated like: <code>foo-bar</code>.  Components register their
tag with <a href="can-view-callbacks.tag.html" title="">tag</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-component/docs/tag.md"},"description":"\nSpecifies the HTML tag (or node-name) the [can-component] will be created on.\n","types":[{"type":"String","description":"The tag name the [can-component]\nwill be created on.  Tag names are typically lower cased and\nhyphenated like: `foo-bar`.  Components register their\ntag with [can-view-callbacks.tag tag].\n\n\n"}],"title":"tag","name":"can-component.prototype.tag","type":"property","parent":"can-component.prototype","pathToRoot":".."};
</script>
</article>
