...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-component/docs/ViewModel.md
	...
	<div class="page-type">
		<h1>ViewModel</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-component/edit/master/docs/ViewModel.md">Edit on GitHub</a>
				</li>
...
is initialized with values specified by the component element’s <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">data bindings</a>.</p>
...
<a href="can-map.html" title="Create observable objects.">Map.extend</a> that will be used to create a new observable instance accessible by
the component’s <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>properties</b> <code>{Object}</code>: <p>The initial properties that are passed by the <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">data bindings</a>.</p>
...
added to the top of the <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> the component’s <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
component’s can-component::ViewModel instance.  &lt;content/&gt; elements within the view are replaced by the source elements within the component’s tag.">view</a> is rendered with.</p>
</p>
  </div>
...
<pre><code class="language-js">var renderer = stache(&quot;&lt;my-paginate/&gt;&quot;);
var frag = renderer();
...
<p>Next, the values are passed into <code>viewModel</code> from the <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">data bindings</a> within <code>&lt;my-paginate&gt;</code>
(in this case there is none).</p>
<p>And finally, that data is used to render the component’s view and inserted into the element using <a href="can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a> and <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a>:</p>
...
<a href="can-types.DefaultMap.html" title="">default Map type</a> (typically <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>)
...
<a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>, the following binding types can be setup:</p>
<ul>
<li><a href="can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">toChild:from</a> — Update the component’s viewModel instance when the parent scope value changes.</li>
<li><a href="can-stache-bindings.toParent.html" title="One-way bind a value from the viewModel or element to the parent scope.">toParent:to</a> — Update the parent scope when the component’s viewModel instance changes.</li>
<li><a href="can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a> — Update the parent scope or the component’s viewModel instance when the other changes.</li>
</ul>
...
<pre><code class="language-js">var renderer = stache(&quot;&lt;my-paginate {offset}='index' {limit}='size' /&gt;&quot;);
...
<p>... the component’s offset value will change and its view will update to:</p>
...
<h2>Calling methods on ViewModel from events within the view</h2>
<p>Using html attributes like <code>can-EVENT-METHOD</code>, you can directly call a ViewModel method
from a view. For example, we can make <code>&lt;my-paginate&gt;</code> elements include a next
...
dispatches a <code>&quot;close&quot;</code> event when its close method is called:</p>
<pre><code class="language-js">Component.extend({
    tag: &quot;player-edit&quot;,
...
<p>These can be listened to with <a href="can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">on:event</a> bindings like:</p>
