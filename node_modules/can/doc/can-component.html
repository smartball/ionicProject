...
is initialized with values specified by the component element’s data bindings.">
					...
					<li class="
						...
						<a class="property"
							...
							title="Provides a view to render directly within the component’s element. The view is rendered with the
			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-component">
						<img src="https://img.shields.io/badge/npm%20package-3.3.5-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>&lt;TAG BINDINGS...&gt;[TEMPLATES][LIGHT_DOM]&lt;/TAG&gt;</code>
  </h2>
  <p>Create an instance of a component on a particular tag in a <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> view.
In 2.3, use the <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">bindings</a> syntaxes to set up bindings.</p>
<p>The following creates a <code>my-autocomplete</code> element and passes the <code>my-autocomplete</code>'s
...
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a> the <code>Search</code> model as its <code>source</code> property and
a <a href="can-component/can-template.html" title="Pass templates declaratively to components.">&lt;can-template&gt;</a> that is used to render the search results:</p>
<pre><code class="language-html">&lt;my-autocomplete {source}=&quot;Search&quot;&gt;
...
<code>acme-tabs</code> or <code>acme:tabs</code>.</p>
          ...
          <li><b>BINDINGS</b> <code>{<a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a>}</code>: <p>Use the following binding syntaxes
...
to the component’s view. The constructor function
is initialized with values specified by the component element’s data bindings.">ViewModel</a> to the view's <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a>:</p>
<ul>
<li><a href="can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">toChild:from</a>=<a href="can-stache.expressions.html" title="In addition to different magic tag types, stache supports different expression
...
<li><a href="can-stache-bindings.toParent.html" title="One-way bind a value from the viewModel or element to the parent scope.">toParent:to</a>=<a href="can-stache.expressions.html" title="In addition to different magic tag types, stache supports different expression
types.  These can be used in various combinations to call helper methods
or viewModel methods.  The following is an example of all the expressions
combined:">expression</a> — one-way data binding to parent</li>
<li><a href="can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a>=<a href="can-stache.expressions.html" title="In addition to different magic tag types, stache supports different expression
types.  These can be used in various combinations to call helper methods
or viewModel methods.  The following is an example of all the expressions
combined:">expression</a> — two-way data binding child to parent</li>
<li><a href="can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">on:event</a>=<a href="can-stache/expressions/call.html" title="">expression</a> — event binding on the view model</li>
</ul>
...
<pre><code>&lt;my-tag {to-child}=&quot;expression&quot;
        ...
        (event)=&quot;callExpression()&quot;&gt;&lt;/my-tag&gt;
          ...
          <li><b>TEMPLATES</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>Between the starting and ending tag
can exist one or many <a href="can-component/can-template.html" title="Pass templates declaratively to components.">&lt;can-template&gt;</a> elements.  Use to <a href="can-component/can-template.html" title="Pass templates declaratively to components.">&lt;can-template&gt;</a> elements
to pass custom templates to child components.  Each <code>&lt;can-template&gt;</code>
is given a <code>name</code> attribute and can be rendered by a corresponding <a href="can-component/can-slot.html" title="Position the content of can-template elements.">&lt;can-slot&gt;</a>
in the component's <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
...
<p>For example, the following passes how each search result should look and an error message if
the source is unable to request data:</p>
<pre><code class="language-html">&lt;my-autocomplete {source}=&quot;Search&quot;&gt;
  &lt;can-template name=&quot;search-results&quot;&gt;
    &lt;li&gt;{{name}}&lt;/li&gt;
  &lt;/can-template&gt;
...
<p>The <code>LIGHT_DOM</code> can be positioned with a component’s <a href="can-component.prototype.view.html" title="Provides a view to render directly within the component’s element. The view is rendered with the
component’s can-component::ViewModel instance.  &lt;content/&gt; elements within the view are replaced by the source elements within the component’s tag.">view</a> with
the <a href="can-component/content.html" title="Positions the LIGHT_DOM within a component’s can-component.prototype.view."><content></a> element.  The data accessible to the <code>LIGHT_DOM</code> can be controlled
with <a href="can-component.prototype.leakScope.html" title="Allow reading the outer scope values from a component’s view and a component’s viewModel values in the user content.">leakScope</a>.</p>
</li>
...
add <code>&lt;hello-world/&gt;</code> to a <a href="can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a> view, render
the view, and insert the result in the page like:</p>
<pre><code>var renderer = stache(&quot;&lt;hello-world/&gt;&quot;);
...
you'll render a view with many custom tags like:</p>
<pre><code>&lt;srchr-app&gt;
...
components that wrap other components in their view and pass any needed viewModel properties via attributes.</p>
<h3>Tag</h3>
...
component’s can-component::ViewModel instance.  &lt;content/&gt; elements within the view are replaced by the source elements within the component’s tag.">view</a> is a template that is rendered as
...
<p>Use the <a href="can-component/content.html" title="Positions the LIGHT_DOM within a component’s can-component.prototype.view."><content></a> tag to position the custom element’s source HTML.</p>
<p>The following component:</p>
<pre><code>Component.extend({
  tag: &quot;hello-world&quot;,
...
are typically set by attribute <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">data bindings</a> on the custom element.
...
<p>Changes the following rendered view:</p>
<pre><code>var renderer = stache(&quot;&lt;hello-world {message}='greeting'/&gt;&quot;);
renderer({
...
<p>The following view, with the previous <code>hello-world</code> component:</p>
<pre><code>var renderer = stache(&quot;&lt;hello-world message='Howdy'/&gt;&quot;);
renderer({})
</code></pre>
<p>Renders:</p>
...
listened to with <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">view bindings</a>). The following component
...
<h3>Helpers</h3>
<p>A component’s <a href="can-component.prototype.helpers.html" title="Helper functions used with the component’s view.">helpers</a> object provides <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
...
value of the <code>websitesPromise</code>’s resolved <code>value</code>’s <code>count</code>.</p>
