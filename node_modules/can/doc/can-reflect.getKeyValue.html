...
<!--####################################################################
	...
	@function can-reflect.getKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.getKeyValue.html">getKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/get-set/get-set.js#L52">Edit on GitHub</a>
				</li>
    ...
    <p>Get the value of a named property on a MapLike object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getKeyValue(obj, key)</code>
  </h2>
  <p>Retrieve the property on Map-like <code>obj</code> identified by the String or Symbol value <code>key</code>.  The default behavior
can be overridden on <code>obj</code> by implementing <a href="can-symbol/symbols/getKeyValue.html" title="Defines a function to access and return the value of one of the object's named properties.">@@can.getKeyValue</a>,
otherwise native named property access is used.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key of the property to get</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.getKeyValue","parent":"can-reflect/get-set","src":{"line":51,"codeLine":71,"path":"node_modules/can-reflect/reflections/get-set/get-set.js"},"description":"Get the value of a named property on a MapLike object. \n","title":"getKeyValue","signatures":[{"code":"getKeyValue(obj, key)","description":"\n\nRetrieve the property on Map-like `obj` identified by the String or Symbol value `key`.  The default behavior\ncan be overridden on `obj` by implementing [can-symbol/symbols/getKeyValue @@can.getKeyValue],\notherwise native named property access is used.\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\n\ncanReflect.getKeyValue(foo, \"bar\"); // -> \"baz\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to get from"},{"types":[{"type":"String"}],"name":"key","description":"the key of the property to get\n "}]}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key of the property to get\n "},"pathToRoot":".."};
</script>
</article>
