...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-canjs/can-core.md
	@page can-core
######################################################################## -->
<html lang="en">
<head>
...
<p>In the next section will use <code>todoAlgebra</code> to build a model with <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a>.</p>
<h2>can-connect</h2>
<p><a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> connects a data type, typically a <code>DefineMap</code> and its <code>DefineList</code>,
...
<p><a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> is also middleware, so custom connections can
be assembled too:</p>
...
<p><a href="can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">One-way to child</a> examples:</p>
...
<p><a href="can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">One-way to parent</a> examples:</p>
...
<p><a href="can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a> connects a <code>DefineMap</code>’s properties to values in the
...
core libraries.  After that, check out the <a href="guides/api.html" title="This page walks through how to use and understand CanJS’s API documentation.">Reading the Docs (API Guide)</a> on how to use and learn from these API docs.</p>
