...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/can-define-stream.md
	@module can-define-stream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-define-stream</title>
...
functions from inside inheriting functions.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-define-stream.types.DefineList.html"
							title="A list constructor to add stream methods to.">
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-define-stream.types.DefineMap.html"
							title="A map constructor to add stream methods to.">
							DefineMap.prototype
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="can-define-stream.types.streamInterface.html"
							title="A can-stream.types.streamInterface function.">
							streamInterface
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream.toStream.html"
							title="Provide a shorthand for creating a stream on properties and/or events.">
							toStream
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream.tocompute.html"
							title="Create a compute that gets updated whenever the stream value changes.">
							toCompute
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream.tostreamfromevent.html"
							title="Create a stream based on an event">
							toStreamFromEvent
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-define-stream.tostreamfromproperty.html"
							title="Create a stream based on a property">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.html">can-define-stream</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-define-stream</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-define-stream">
						<img src="https://img.shields.io/badge/npm%20package-0.2.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-define-stream" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/can-define-stream.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canDefineStream(streamInterface)</code>
  </h2>
  <p>The <code>can-define-stream</code> module exports a function that takes a <a href="can-define-stream.types.streamInterface.html" title="A can-stream.types.streamInterface function.">streamInterface</a> and returns a function that takes a <a href="can-define-stream.types.DefineMap.html" title="A map constructor to add stream methods to.">DefineMap.prototype</a> or <a href="can-define-stream.types.DefineList.html" title="A list constructor to add stream methods to.">DefineList.prototype</a> and uses the supplied stream interface to create streamed property definitions.</p>
<pre><code class="language-js">var canStream = require(&quot;can-stream-kefir&quot;);
...
me.last = &quot;Ahmed&quot;; //-&gt; console.logs 2
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>streamInterface</b> <code>{<a href="can-define-stream.types.streamInterface.html" title="A can-stream.types.streamInterface function.">streamInterface</a>()}</code>: <p>A <a href="can-define-stream.types.streamInterface.html" title="A can-stream.types.streamInterface function.">streamInterface</a> function. See <a href="can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a> for implementation.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>A function that takes a <a href="can-define-stream.types.DefineMap.html" title="A map constructor to add stream methods to.">DefineMap.prototype</a> or <a href="can-define-stream.types.DefineList.html" title="A list constructor to add stream methods to.">DefineList.prototype</a>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="can-define-stream.toStream.html" title="Provide a shorthand for creating a stream on properties and/or events.">toStream</a> method has shorthands for all of the other methods:</p>
<pre><code class="language-js">toStream(&quot;eventName&quot;)           //-&gt; stream
toStream(&quot;.propName&quot;)           //-&gt; stream
toStream(&quot;.propName eventName&quot;) //-&gt; stream
</code></pre>
<p>For example:</p>
<p><strong>Update map property based on stream value</strong></p>
...
<p><strong>Stream on DefineList</strong></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/can-define-stream.md"},"description":"Add useful stream conversion methods to a supplied [can-define/map/map] or [can-define/list/list] constructor using a [can-define-stream.types.streamInterface stream interface] such as [can-stream-kefir]. \n","type":"module","title":"can-define-stream","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-stream","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-define-stream/issues"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.2.0","can-define":"^1.2.0","can-observation":"^3.2.0","can-stream":"^0.3.0","can-util":"^3.9.0","kefir":"^3.5.1"},"deprecated":false,"description":"Adds the ability to define properties with streams on can-define types.","devDependencies":{"done-serve":"^1.2.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.2.8","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.5.0"},"homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-define-stream","name":"can-define-stream","repository":{"type":"git","url":"git://github.com/canjs/can-define-stream.git"},"scripts":{"develop":"done-serve --static --develop --port 8080","jshint":"jshint *.js --config","postversion":"git push --tags && git push","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"steal":{"configDependencies":["live-reload"]},"version":"0.2.1"},"signatures":[{"code":"canDefineStream(streamInterface)","description":"\n\nThe `can-define-stream` module exports a function that takes a [can-define-stream.types.streamInterface] and returns a function that takes a [can-define-stream.types.DefineMap DefineMap.prototype] or [can-define-stream.types.DefineList DefineList.prototype] and uses the supplied stream interface to create streamed property definitions.\n\n```js\nvar canStream = require(\"can-stream-kefir\");\nvar canDefineStream = require(\"can-define-stream\");\nvar DefineMap = require(\"can-define/map/map\");\n\nvar Person = DefineMap.extend({\n    first: \"string\",\n    last: \"string\",\n    fullName: {\n        get: function() {\n            return this.first + \" \" + this.last;\n        }\n    },\n    fullNameChangeCount: {\n        stream: function() {\n            return this.toStream(\".fullName\").scan(function(last) {\n                return last + 1;\n            }, 0);\n        }\n    }\n});\n\ncanDefineStream(canStream)(Person);\n\nvar me = new Person({name: \"Justin\", last: \"Meyer\"});\n\nme.on(\"fullNameChangeCount\", function(ev, newVal) {\n    console.log(newVal);\n});\nme.fullNameChangeCount //-> 0\nme.first = \"Obaid\"; //-> console.logs 1\nme.last = \"Ahmed\"; //-> console.logs 2\n```\n","params":[{"types":[{"type":"can-define-stream.types.streamInterface"}],"name":"streamInterface","description":"A [can-define-stream.types.streamInterface] function. See [can-stream-kefir] for implementation.\n"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that takes a [can-define-stream.types.DefineMap DefineMap.prototype] or [can-define-stream.types.DefineList DefineList.prototype].\n"}}],"_curParam":{"types":[{"type":"can-define-stream.types.streamInterface"}],"name":"streamInterface","description":"A [can-define-stream.types.streamInterface] function. See [can-stream-kefir] for implementation.\n"},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A function that takes a [can-define-stream.types.DefineMap DefineMap.prototype] or [can-define-stream.types.DefineList DefineList.prototype].\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
