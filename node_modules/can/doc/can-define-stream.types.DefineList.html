...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/types.DefineList.prototype.md
	@typedef can-define-stream.types.DefineList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DefineList.prototype</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.types.DefineList.html">DefineList.prototype</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>DefineList.prototype</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/types.DefineList.prototype.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> constructor to add stream methods to.</p>
...
<div class="signature">
  ...
  <p>Creates a DefineList type instance</p>
...
var people = new People([
    ...
    <section class="body">
    <h2>Use</h2>
<p>See: <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> and the related <a href="can-define/list/list.extend.html" title="Define a custom list type.">extend</a> method.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/types.DefineList.prototype.md"},"description":"A [can-define/list/list] constructor to add stream methods to. \n","type":"typedef","title":"DefineList.prototype","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-stream.types.DefineList","parent":"can-define-stream.types","signatures":[{"code":"new DefineList([items])","description":"\n\nCreates a DefineList type instance\n\n```js\nimport DefineMap from 'can-define/map/map';\nimport DefineList from 'can-define/list/list';\n\nvar People = DefineList.extend([\n\t'#': {\n\t\ttype: {\n\t\t\tfirst: 'string',\n\t\t\tlast: 'string'\n\t\t}\n\t}\n]);\n\nvar people = new People([\n\t{ first: 'John', last: 'Gardner' },\n\t{ first: 'Justin', last: 'Meyer' }\n])\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
