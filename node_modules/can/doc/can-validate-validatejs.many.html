...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-validatejs/docs/validate-many.md
	@function can-validate-validatejs.many
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - many</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate-validatejs.many.html">many</a></li>
	...
	<div class="page-type">
		<h1>many</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-validatejs/edit/master/docs/validate-many.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makeValidator.many(constraints)</code>
  </h2>
  <p>Returns a validator function that can be used to validate many values at once.</p>
<pre><code class="language-js">var validatePerson = makeValidator.many({
    age: {
        numericality: true
    },
    name: {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>constraints</b> <code>{Object}</code>: <p>A map of objects which contain definitions used by the Validate.js library.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Validator}</code>: <p>A <a href="can-validate.validator.html" title="A function that validates a value against predefined constraints and returns validation errors, if any are found.">validator</a> type function that takes an object of values and validates every value based on the provided constraints.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-validatejs/docs/validate-many.md"},"description":"\n","title":"many","name":"can-validate-validatejs.many","type":"function","parent":"can-validate-validatejs.methods","signatures":[{"code":"makeValidator.many(constraints)","description":"\n\n  Returns a validator function that can be used to validate many values at once.\n\n  ```js\n  var validatePerson = makeValidator.many({\n      age: {\n          numericality: true\n      },\n      name: {\n          presence: true\n      }\n  });\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"constraints","description":"A map of objects which contain definitions used by the Validate.js library.\n"}],"returns":{"types":[{"type":"Validator"}],"description":"A [can-validate.validator] type function that takes an object of values and validates every value based on the provided constraints.\n\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"constraints","description":"A map of objects which contain definitions used by the Validate.js library.\n"},"_curReturn":{"types":[{"type":"Validator"}],"description":"A [can-validate.validator] type function that takes an object of values and validates every value based on the provided constraints.\n\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
