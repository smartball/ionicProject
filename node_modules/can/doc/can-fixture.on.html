...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/fixture.on.md
	@property can-fixture.on
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture.on.html">on</a></li>
	...
	<div class="page-type">
		<h1>on</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/fixture.on.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Turns the fixtures on or off. Defaults to <code>true</code> for on.</p>
<pre><code class="language-js">fixture.on = false; //-&gt; AJAX requests will not be trapped
</code></pre>
<p>To remove a fixture you can also use <code>fixture(ajaxSetting, null)</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-fixture/docs/fixture.on.md"},"description":"\n","types":[{"type":"Boolean"}],"title":"on","name":"can-fixture.on","type":"property","parent":"can-fixture.properties","signatures":[{"code":"fixture.on","description":"\n\nTurns the fixtures on or off. Defaults to `true` for on.\n\n```js\nfixture.on = false; //-> AJAX requests will not be trapped\n```\n\nTo remove a fixture you can also use `fixture(ajaxSetting, null)`.\n","params":[]}],"pathToRoot":".."};
</script>
</article>
