...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/switch.md
	@function can-stache.helpers.switch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#switch(expression)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.switch.html">{{#switch(expression)}}</a></li>
	...
	<div class="page-type">
		<h1>{{#switch(expression)}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/switch.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#switch(EXPRESSION)}}BLOCK{{/switch}}</code>
  </h2>
  <p>Renders the <code>BLOCK</code> with contextual <a href="can-stache.helpers.case.html" title="">{{#case(expression)}}</a> and <a href="can-stache.helpers.default.html" title="">{{#default()}}</a> helpers.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>EXPRESSION</b> <code>{<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>|<a href="can-stache/expressions/call.html" title="">Call Expression</a>}</code>: <p>An expression or key that references a value that will be switched on.</p>
</li>
        
          <li><b>BLOCK</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>a template that is rendered, uses <a href="can-stache.helpers.case.html" title="">{{#case(expression)}}</a> and <a href="can-stache.helpers.default.html" title="">{{#default()}}</a> helpers to match <code>EXPRESSION</code>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>switch</code> helper is used to render a block where one of several cases matches expr. It works just like a JavaScript switch.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/switch.md"},"description":"\n","title":"{{#switch(expression)}}","name":"can-stache.helpers.switch","type":"function","parent":"can-stache.htags","order":13,"signatures":[{"code":"{{#switch(EXPRESSION)}}BLOCK{{/switch}}","description":"\n\nRenders the `BLOCK` with contextual [can-stache.helpers.case] and [can-stache.helpers.default] helpers.\n\n```\n{{#switch(user.type)}}\n\t{{#case(\"admin\")}}\n\t\t<button value=\"edit\"/>\n\t{{/case}}\n\t{{#case(\"manager\")}}\n\t\t<button value=\"view\">\n\t{{/case}}\n\t{{#default()}}\n\t\tYou do not have permission!\n\t{{/default}}\n{{/switch}}\n```\n","params":[{"types":[{"type":"can-stache/expressions/key-lookup"},{"type":"can-stache/expressions/call"}],"name":"EXPRESSION","description":"An expression or key that references a value that will be switched on.\n"},{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"a template that is rendered, uses [can-stache.helpers.case] and [can-stache.helpers.default] helpers to match `EXPRESSION`.\n\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"name":"BLOCK","description":"a template that is rendered, uses [can-stache.helpers.case] and [can-stache.helpers.default] helpers to match `EXPRESSION`.\n\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
