...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-simple-observable/can-simple-observable.js
	@module can-simple-observable
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-simple-observable</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-simple-observable.html">can-simple-observable</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-simple-observable</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-simple-observable">
						<img src="https://img.shields.io/badge/npm%20package-1.0.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-simple-observable" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-simple-observable/edit/master/can-simple-observable.js#L7">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>observable(initialValue)</code>
  </h2>
  <p>Creates an observable value that can be read, written, and observed using <a href="can-reflect.html" title="Perform operations and read information on unknown data types.">can-reflect</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>initialValue</b> <code>{*}</code>: <p>The initial value of the observable.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-simple-observable.html" title="Create an observable value.">can-simple-observable</a>}</code>: <p>The observable.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code class="language-js"> var obs = observable('one');
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-simple-observable","parent":"can-infrastructure","src":{"line":6,"codeLine":41,"path":"node_modules/can-simple-observable/can-simple-observable.js"},"description":"Create an observable value. \n","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"https://www.bitovi.com/"},"bugs":{"url":"https://github.com/canjs/can-simple-observable/issues"},"bundleDependencies":false,"dependencies":{"can-cid":"^1.0.3","can-event":"^3.7.4","can-namespace":"1.0.0","can-observation":"^3.3.5","can-reflect":"^1.4.1"},"deprecated":false,"description":"Create an observable value.","devDependencies":{"jshint":"^2.9.1","steal":"^1.3.1","steal-qunit":"^1.0.1","steal-tools":"^1.2.0","testee":"^0.3.0"},"homepage":"https://canjs.com","keywords":["canjs","donejs-plugin"],"license":"MIT","main":"can-simple-observable","name":"can-simple-observable","repository":{"type":"git","url":"git://github.com/canjs/can-simple-observable.git"},"scripts":{"build":"node build.js","jshint":"jshint ./*.js --config","postpublish":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update version number\" && git checkout -b release && git add -f dist/"},"steal":{"npmIgnore":["testee","steal-tools"]},"version":"1.0.1"},"signatures":[{"code":"observable(initialValue)","description":"\n\nCreates an observable value that can be read, written, and observed using [can-reflect].\n","params":[{"types":[{"type":"*"}],"name":"initialValue","description":"The initial value of the observable.\n"}],"returns":{"types":[{"type":"can-simple-observable"}],"description":"The observable.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"initialValue","description":"The initial value of the observable.\n"},"_curReturn":{"types":[{"type":"can-simple-observable"}],"description":"The observable.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
