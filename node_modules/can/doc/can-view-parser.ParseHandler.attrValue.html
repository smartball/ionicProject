...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-parser/docs/attrValue.md
	@function can-view-parser.ParseHandler.attrValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - attrValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-parser.ParseHandler.attrValue.html">attrValue</a></li>
	...
	<div class="page-type">
		<h1>attrValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-parser/edit/master/docs/attrValue.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>attrValue(value, lineNo)</code>
  </h2>
  <p>Called when an attribute's <strong>value</strong> has been found.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{String}</code>: <p>The value discovered associated with an attribute.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/attrValue.md"},"description":"","title":"attrValue","name":"can-view-parser.ParseHandler.attrValue","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"attrValue(value, lineNo)","description":"\n\nCalled when an attribute's **value** has been found.\n","params":[{"types":[{"type":"String"}],"name":"value","description":"The value discovered associated with an attribute."},{"types":[{"type":"Number"}],"name":"lineNo","description":"The line number of the opening tag (undefined in production).\n"}]}],"_curParam":{"types":[{"type":"Number"}],"name":"lineNo","description":"The line number of the opening tag (undefined in production).\n"},"pathToRoot":".."};
</script>
</article>
