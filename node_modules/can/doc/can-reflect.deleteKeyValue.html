...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-reflect/reflections/get-set/get-set.js
	@function can-reflect.deleteKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - deleteKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.deleteKeyValue.html">deleteKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>deleteKeyValue</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/get-set/get-set.js#L79">Edit on GitHub</a>
				</li>
    ...
    <p>Delete a named property from a MapLike object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>deleteKeyValue(obj, key)</code>
  </h2>
  <p>Remove the property identified by the String or Symbol <code>key</code> from the Map-like object <code>obj</code>, if possible.
Property definitions may interfere with deleting key values; the behavior on <code>obj</code> if <code>obj[key]</code> cannot
be deleted is undefined.  The default use of the native <code>delete</code> keyword can be overridden by <code>obj</code> if it
implements <a href="can-symbol/symbols/deleteKeyValue.html" title="Defines a function that deletes one of an object's named properties.">@@can.deleteKeyValue</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to delete on</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>the key for the property to delete</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.deleteKeyValue","parent":"can-reflect/get-set","src":{"line":78,"codeLine":107,"path":"node_modules/can-reflect/reflections/get-set/get-set.js"},"description":"Delete a named property from a MapLike object. \n","title":"deleteKeyValue","signatures":[{"code":"deleteKeyValue(obj, key)","description":"\n\nRemove the property identified by the String or Symbol `key` from the Map-like object `obj`, if possible.\nProperty definitions may interfere with deleting key values; the behavior on `obj` if `obj[key]` cannot\nbe deleted is undefined.  The default use of the native `delete` keyword can be overridden by `obj` if it\nimplements [can-symbol/symbols/deleteKeyValue @@can.deleteKeyValue].\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\nvar quux = new CanMap({ thud: \"jeek\" });\n\ncanReflect.deleteKeyValue(foo, \"bar\");\ncanReflect.deleteKeyValue(quux, \"thud\");\n\n\"bar\" in foo; // ->  true  -- DefineMaps use property defs which cannot be un-defined\nfoo.bar // -> undefined    --  but set values to undefined when deleting\n\n\"thud\" in quux; // -> false\nquux.thud; // -> undefined\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to delete on"},{"types":[{"type":"String"}],"name":"key","description":"the key for the property to delete\n "}]}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key for the property to delete\n "},"pathToRoot":".."};
</script>
</article>
