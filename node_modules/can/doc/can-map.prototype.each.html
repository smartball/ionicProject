...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/prototype.each.md
	@function can-map.prototype.each
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.each.html">each</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>each</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/prototype.each.md">Edit on GitHub</a>
				</li>
    ...
    <p>Call a function on each property of a Map.</p>
...
<div class="signature">
  ...
  <p><code>each</code> iterates through the Map, calling a function
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(item, propName)}</code>: <p>the function to call for each property
...
the loop will stop.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-map.html" title="Create observable objects.">can-map</a>}</code>: <p>this Map, for chaining</p>
</p>
  </div>
