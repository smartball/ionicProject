...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/tags/else.md
	@function can-stache.helpers.else
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{else}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.else.html">{{else}}</a></li>
	...
	<div class="page-type">
		<h1>{{else}}</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/tags/else.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Creates an <code>inverse</code> block for a <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helper function</a>'s
<a href="can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">options argument</a>'s <code>inverse</code> property.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>INVERSE</b> <code>{<a href="can-stache.sectionRenderer.html" title="Renders a section. These functions are usually provided as .fn and .inverse on a stache helper's options.">sectionRenderer</a>(context, helpers)}</code>: <p>A partial stache template
converted into a function and set as the <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helper function</a>'s
<a href="can-stache.helperOptions.html" title="The options argument passed to a helper function when called by a helper.">options argument</a>'s <code>inverse</code> property.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>For more information on how <code>{{else}}</code> is used checkout:</p>
<ul>
<li><a href="can-stache.helpers.if.html" title="can-stache.helpers.if">{{#if(expression)}}</a></li>
<li><a href="can-stache.tags.section.html" title="Renders a subsection one or more times depending on the type of expression
or the expression's return value.">{{#expression}}</a></li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/tags/else.md"},"description":"\n","title":"{{else}}","name":"can-stache.helpers.else","type":"function","parent":"can-stache.tags","order":4,"signatures":[{"code":"{{#helper()}}BLOCK{{else}}INVERSE{{/helper}}","description":"\n\nCreates an `inverse` block for a [can-stache.helper helper function]'s\n[can-stache.helperOptions options argument]'s `inverse` property.\n","params":[{"types":[{"type":"can-stache.sectionRenderer"}],"name":"INVERSE","description":"A partial stache template\nconverted into a function and set as the [can-stache.helper helper function]'s\n[can-stache.helperOptions options argument]'s `inverse` property.\n"}]}],"_curParam":{"types":[{"type":"can-stache.sectionRenderer"}],"name":"INVERSE","description":"A partial stache template\nconverted into a function and set as the [can-stache.helper helper function]'s\n[can-stache.helperOptions options argument]'s `inverse` property.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
