...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/boolean-to-inList.md
	@function can-stache-converters.boolean-to-inList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - boolean-to-inList</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.boolean-to-inList.html">boolean-to-inList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>boolean-to-inList</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/boolean-to-inList.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that binds a boolean attribute, such as an <code>&lt;input&gt;</code> value, to whether or not an item is in a list.</p>
...
<div class="signature">
  ...
  <p>When the getter is called, returns true if <strong>item</strong> is within the <strong>list</strong>, determined using <code>.indexOf</code>.</p>
<p>When the setter is called, if the new value is truthy then the item will be added to the list using <code>.push</code>; if it is falsey the item will removed from the list using <code>.splice</code>.</p>
<pre><code class="language-handlebars">&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;boolean-to-inList(item, list)&quot; /&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>item</b> <code>{*}</code>: <p>The item to which to check</p>
</li>
        
          <li><b>list</b> <code>{<a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>|<a href="can-list.html" title="">can-list</a>|Array}</code>: <p>The list</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be used by <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> as a getter/setter when the element’s value changes.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Use this converter when two-way binding to an element with a boolean attribute, such as a checkbox.</p>
<pre><code class="language-js">var map = new DefineMap({
    item: 5,
    list: [1, 2, 3, 4, 5]
});
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/boolean-to-inList.md"},"description":"A [can-stache.registerConverter converter] that binds a boolean attribute, such as an `<input>` value, to whether or not an item is in a list. \n","title":"boolean-to-inList","name":"can-stache-converters.boolean-to-inList","type":"function","parent":"can-stache-converters.converters","signatures":[{"code":"boolean-to-inList(item, list)","description":"\n\nWhen the getter is called, returns true if **item** is within the **list**, determined using `.indexOf`.\n\nWhen the setter is called, if the new value is truthy then the item will be added to the list using `.push`; if it is falsey the item will removed from the list using `.splice`.\n\n```handlebars\n<input type=\"checkbox\" {($checked)}=\"boolean-to-inList(item, list)\" />\n```\n","params":[{"types":[{"type":"*"}],"name":"item","description":"The item to which to check"},{"types":[{"type":"can-define/list/list"},{"type":"can-list"},{"type":"Array","options":[]}],"name":"list","description":"The list"}],"returns":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter when the element’s value changes.\n"}}],"_curParam":{"types":[{"type":"can-define/list/list"},{"type":"can-list"},{"type":"Array","options":[]}],"name":"list","description":"The list"},"_curReturn":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter when the element’s value changes.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
