...
<!--####################################################################
	...
	@function can-fixture-socket.Server.prototype.on
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.Server.prototype.on.html">on</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>on</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/src/index.js#L38">Edit on GitHub</a>
				</li>
    ...
    <p>Adds a socket event listener.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>server.on(event, handler)</code>
  </h2>
  <p>Adds a socket event listener.</p>
<pre><code class="language-js">server.on(&quot;notifications&quot;, function(data, ackFn){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{string}</code>: <p>The name of the socket event to listen for.</p>
</li>
        
          <li><b>handler</b> <code>{<a href="can-fixture-socket.socket-event-listener.html" title="A listener handler that will be executed to handle the socket event.">SocketEventListener</a>()}</code>: <p>The handler that will be executed to handle the socket event.</p>
</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>server.on(eventsObject)</code>
  </h2>
  <p>A short hand method to add multiple event listeners.</p>
<pre><code class="language-js">server.on({
  &quot;news&quot;: handleNews,
  &quot;tweets&quot;: handleTweets,
  &quot;users&quot;: handleUsers
});
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventsObject</b> <code>{object}</code>: </li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-fixture-socket.Server.prototype.on","parent":"can-fixture-socket.Server.prototype","src":{"line":37,"codeLine":71,"path":"node_modules/can-fixture-socket/src/index.js"},"description":"\nAdds a socket event listener.\n","title":"on","signatures":[{"code":"server.on(event, handler)","description":"\n\nAdds a socket event listener.\n\n```js\nserver.on(\"notifications\", function(data, ackFn){\n  console.log(\"Received \" + data);\n  ackFn(\"Acknowledged, thank you\");\n});\n```\n","params":[{"types":[{"type":"string"}],"name":"event","description":"The name of the socket event to listen for."},{"types":[{"type":"can-fixture-socket.socket-event-listener"}],"name":"handler","description":"The handler that will be executed to handle the socket event.\n"}]},{"code":"server.on(eventsObject)","description":"\n\nA short hand method to add multiple event listeners.\n\n```js\nserver.on({\n  \"news\": handleNews,\n  \"tweets\": handleTweets,\n  \"users\": handleUsers\n});\n```\n","params":[{"types":[{"type":"object"}],"name":"eventsObject","description":"\n"}]}],"_curParam":{"types":[{"type":"object"}],"name":"eventsObject","description":"\n"},"pathToRoot":".."};
</script>
</article>
