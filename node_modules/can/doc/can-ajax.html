...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-ajax/can-ajax.js
	@module can-ajax
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-ajax</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-ajax.html">can-ajax</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-ajax</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-ajax/edit/master/can-ajax.js#L9">Edit on GitHub</a>
				</li>
    ...
    <p>Make an asynchronous HTTP (AJAX) request.</p>
...
<div class="signature">
  ...
  <p>Is used to make an asynchronous HTTP (AJAX) request similar to <a href="http://api.jquery.com/jQuery.ajax/jQuery.ajax" title="http://api.jquery.com/jQuery.ajax/jQuery.ajax">http://api.jquery.com/jQuery.ajax/jQuery.ajax</a>.</p>
<pre><code>var ajax = require(&quot;can-ajax&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>ajaxOptions</b> <code>{Object}</code>: <p>Configuration options for the AJAX request.</p>
<ul>
<li><strong>url</strong> <code>{String}</code> The requested url.</li>
<li><strong>type</strong> <code>{String}</code> The method of the request. Ex: <code>GET</code>, <code>PUT</code>, <code>POST</code>, etc. Capitalization is ignored. <em>Default is <code>GET</code></em>.</li>
<li><strong>data</strong> <code>{Object}</code> The data of the request. If data needs to be urlencoded (e.g. for GET requests or for CORS) it is serialized with <a href="can-param.html" title="Serialize an object or array into a query string.">can-param</a>.</li>
<li><strong>dataType</strong> <code>{String}</code> Type of data. <em>Default is <code>json</code></em>.</li>
<li><strong>crossDomain</strong> <code>{Boolean}</code> If you wish to force a crossDomain request (such as JSONP) on the same domain, set the value of crossDomain to true. This allows, for example, server-side redirection to another domain. Default: <code>false</code> for same-domain requests, <code>true</code> for cross-domain requests.</li>
<li><strong>xhrFields</strong> <code>{Object}</code> Any fields to be set directly on the xhr request, <a href="https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest" title="https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest">https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest</a> such as the withCredentials attribute that indicates whether or not cross-site Access-Control requests should be made using credentials such as cookies or authorization headers.</li>
</ul>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>A Promise that resolves to the data. The Promise instance is abortable and exposes an <code>abort</code> method. Invoking abort on the Promise instance indirectly rejects it.</p>
</p>
  </div>
...
<div class="signature">
  <h2 class="signature-title">
    <code>ajaxSetup( ajaxOptions )</code>
  </h2>
  <p>Is used to persist ajaxOptions across all ajax requests and they can be over-written in the ajaxOptions of the actual request.
<a href="https://api.jquery.com/jquery.ajaxsetup/" title="https://api.jquery.com/jquery.ajaxsetup/">https://api.jquery.com/jquery.ajaxsetup/</a></p>
<pre><code>var ajax = require(&quot;can-ajax&quot;);
