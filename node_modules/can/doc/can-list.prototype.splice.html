...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/prototype.splice.md
	@function can-list.prototype.splice
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - splice</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-list.prototype.splice.html">splice</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>splice</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/prototype.splice.md">Edit on GitHub</a>
				</li>
    ...
    <p>Insert and remove elements from a List.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>index</b> <code>{Number}</code>: <p>where to start removing or inserting elements</p>
</li>
        
          <li><b>howMany</b> <code>{Number}</code>: <p>the number of elements to remove
If <em>howMany</em> is not provided, <code>splice</code> will remove all elements from <code>index</code> to the end of the List.</p>
</li>
        
          <li><b>newElements</b> <code>{*}</code>: <p>elements to insert into the List</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>the elements removed by <code>splice</code></p>
</p>
  </div>
...
<pre><code> var list = new List([0, 1, 2, 3]);
...
<pre><code> var list = new List(['a', 'b', 'c', 'd']);
...
<p>More information about binding to these events can be found under [can.List.attr attr].</p>
