...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/change.md
	@typedef can-compute.computed.ChangeEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - change</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.computed.ChangeEvent.html">change</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>change</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/change.md">Edit on GitHub</a>
				</li>
    ...
    <p>Event fired when the value of the <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a> changes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>function(event, newVal, oldVal)</code>
  </h2>
  <p>handler(event, newValue, oldValue)</p>
<p>Handlers registered on <code>&quot;change&quot;</code> events will be called back as follows:</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>newVal</b> <code>{*}</code>: <p>The new value of the compute.</p>
</li>
        
          <li><b>oldVal</b> <code>{*}</code>: <p>The old value of the compute.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-compute/docs/change.md"},"description":"\nEvent fired when the value of the [can-compute.computed] changes.\n","type":"typedef","title":"change","types":[{"type":"Event"}],"name":"can-compute.computed.ChangeEvent","parent":"can-compute/computed/events","signatures":[{"description":"handler(event, newValue, oldValue)\n\nHandlers registered on `\"change\"` events will be called back as follows:\n\n```js\nvar age = compute(33);\n\nage.on('change', function(ev, newVal, oldVal){\n\tev //-> {type: \"change\", batchNum: 5}\n\tnewVal //-> 34\n\toldVal //-> 33\n});\n\nage(34);\n```\n\n\n","params":[{"types":[{"type":"Event"}],"name":"event","description":"An event object."},{"types":[{"type":"*"}],"name":"newVal","description":"The new value of the compute."},{"types":[{"type":"*"}],"name":"oldVal","description":"The old value of the compute.\n"}]}],"_curParam":{"types":[{"type":"*"}],"name":"oldVal","description":"The old value of the compute.\n"},"pathToRoot":".."};
</script>
</article>
