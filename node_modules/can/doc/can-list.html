...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-list/docs/list.md
	@module can-list
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-list</title>
...
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.attr.html"
							title="Get or set elements in a List.">
							attr
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.each.html"
							title="Call a function on each element of a List.">
							each
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.filter.html"
							title="Filter the elements of a List, returning a new List instance with just filtered items.">
							filter
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.map.html"
							title="Call a function on each element of a List and return a new List instance from the results.">
							map
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.reverse.html"
							title="Reverse the order of a List.">
							reverse
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-list.prototype.splice.html"
							title="Insert and remove elements from a List.">
							splice
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-list.Map.html"
							title="Specify the Map type used to make objects added to this list observable.">
							Map
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-list.html">can-list</a></li>
	...
	<div class="page-type">
		<h1>can-list</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-list">
						<img src="https://img.shields.io/badge/npm%20package-3.2.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-list" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-list/edit/master/docs/list.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Create an observable array-like object.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>array</b> <code>{Array}</code>: <p>Items to seed the List with.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-list.html" title="">can-list</a>}</code>: <p>An instance of <code>List</code> with the elements from <em>array</em>.</p>
</p>
  </div>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>deferred</b> <code>{can.Deferred}</code>: <p>A deferred that resolves to an
array.  When the deferred resolves, its values will be added to the list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-list.html" title="">can-list</a>}</code>: <p>An initially empty <code>List</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Use for observable array-like objects.</p>
<h2>Use</h2>
<p><code>List</code> is used to observe changes to an Array.  <code>List</code> extends <code><a href="can-map.html" title="Create observable objects.">can-map</a></code>, so all the
ways that you're used to working with Maps also work here.</p>
<p>Use <a href="can-list.prototype.attr.html" title="Get or set elements in a List.">attr</a> to read and write properties of a list:</p>
<pre><code>var hobbies = new List([&quot;JS&quot;,&quot;Party Rocking&quot;])
hobbies.attr(0)        //-&gt; &quot;JS&quot;
...
<p>Just as you shouldn't set properties of an Map directly, you shouldn't change elements
of a List directly. Always use <code>attr</code> to set the elements of a List, or use [can-list::push push],
[can-list::pop pop], [can-list::shift shift], [can-list::unshift unshift], or <a href="can-list.prototype.splice.html" title="Insert and remove elements from a List.">splice</a>.</p>
<p>Here is a tour through the forms of <code>List</code>'s <code>attr</code> that parallels the one found under <a href="can-map.prototype.attr.html" title="Get or set properties on a Map.">attr</a>:</p>
...
<p>As with <code>Map</code>s, the real power of observable arrays comes from being able to
react to changes in the member elements of the array. Lists emit five types of events:</p>
<ul>
...
<pre><code>var list = new List(['Alice', 'Bob', 'Eve']);
...
<p>More information about binding to these events can be found under <a href="can-list.prototype.attr.html" title="Get or set elements in a List.">attr</a>.</p>
