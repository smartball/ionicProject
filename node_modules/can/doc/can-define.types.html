...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/docs/define.types.md
	@property can-define.types
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - types</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define.types.html">types</a></li>
	...
	<div class="page-type">
		<h1>types</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/docs/define.types.md">Edit on GitHub</a>
				</li>
...
the <code>&quot;htmlbool&quot;</code> type converter.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>observable</b> <code>{function}</code>:
        <p>The default type behavior. It converts plain Objects to
<a href="can-define/map/map.html" title="Create observable objects.">DefineMaps</a> and plain Arrays to <a href="can-define/list/list.html" title="Create observable lists.">DefineLists</a>. Everything else is left as is.</p>

      </li>
    
      <li>
        <b>any</b> <code>{function}</code>:
        <p>Leaves the set value as is, performs no type conversion. Aliased as <code>*</code>.</p>

      </li>
    
      <li>
        <b>string</b> <code>{function}</code>:
        <p>Converts to a string with <code>&quot;&quot;+val</code>.</p>

      </li>
    
      <li>
        <b>date</b> <code>{function}</code>:
        <p>Converts to a JavaScript date using <code>Date.parse(val)</code> if a string is given or <code>new Date(val)</code> if a number is passed.</p>

      </li>
    
      <li>
        <b>number</b> <code>{function}</code>:
        <p>Converts to a number with <code>+(val)</code>.</p>

      </li>
    
      <li>
        <b>boolean</b> <code>{function}</code>:
        <p>Converts to <code>false</code> if <code>val</code> is falsey, <code>&quot;0&quot;</code>, or <code>&quot;false&quot;</code>; otherwise, converts to <code>true</code>.</p>

      </li>
    
      <li>
        <b>htmlbool</b> <code>{function}</code>:
        <p>Like <code>boolean</code>, but converts to <code>true</code> if empty string (<code>&quot;&quot;</code>) is passed.</p>

      </li>
    
      <li>
        <b>compute</b> <code>{function}</code>:
        <p>Allows computes to be passed and the property take on the value of the compute.</p>

      </li>
    
      <li>
        <b>stringOrObservable</b> <code>{function}</code>:
        <p>Converts plain Objects to <a href="can-define/map/map.html" title="Create observable objects.">DefineMaps</a>, plain Arrays to <a href="can-define/list/list.html" title="Create observable lists.">DefineLists</a> and everything else to strings.  This is useful for routing.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Use any of the type names on a <a href="can-define.types.propDefinition.html" title="Defines the type, initial value, and get, set, and serialize behavior for an
observable property.  These behaviors can be specified with as an Object, String,
Constructor function, Array, a getter expression, or setter expression.">PropDefinition</a>'s <code>type</code> or directly on the prototype of a <a href="can-define/map/map.html" title="Create observable objects.">DefineMap</a> or <a href="can-define/map/map.html" title="Create observable objects.">DefineList</a>.</p>
<pre><code class="language-js">var define = require(&quot;can-define&quot;);
...
<p>You can also pass these functions in directly:</p>
<pre><code class="language-js">var define = require(&quot;can-define&quot;);
var DefineMap = require(&quot;can-define/map/map&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define/docs/define.types.md"},"description":"Defines the type, initial value, and get, set, and serialize behavior for an\nobservable property. All type converters leave `null` and `undefined` as is except for\nthe `\"htmlbool\"` type converter.\n","types":[{"type":"Object","options":[{"name":"observable","description":"The default type behavior. It converts plain Objects to\n[can-define/map/map DefineMaps] and plain Arrays to [can-define/list/list DefineLists]. Everything else is left as is.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"any","description":"Leaves the set value as is, performs no type conversion. Aliased as `*`.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"string","description":"Converts to a string with `\"\"+val`.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"date","description":"Converts to a JavaScript date using `Date.parse(val)` if a string is given or `new Date(val)` if a number is passed.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"number","description":"Converts to a number with `+(val)`.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"boolean","description":"Converts to `false` if `val` is falsey, `\"0\"`, or `\"false\"`; otherwise, converts to `true`.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"htmlbool","description":"Like `boolean`, but converts to `true` if empty string (`\"\"`) is passed.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"compute","description":"Allows computes to be passed and the property take on the value of the compute.","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"stringOrObservable","description":"Converts plain Objects to [can-define/map/map DefineMaps], plain Arrays to [can-define/list/list DefineLists] and everything else to strings.  This is useful for routing.\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]}]}],"title":"types","name":"can-define.types","type":"property","parent":"can-define.static","comment":" ","pathToRoot":".."};
</script>
</article>
