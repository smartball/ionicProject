...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/omit/omit.js
	@module can-util/js/omit/omit
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - omit</title>
	...
	<div class="page-type">
		<h1>omit</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/omit/omit.js#L3">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>omit(source, propsToOmit)</code>
  </h2>
  <p>Omit properties from an object.</p>
<pre><code class="language-js">var omit = require(&quot;can-util/js/omit/omit&quot;);
...
console.log(newObj); // -&gt; { a: 1, c: 3 }
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>source</b> <code>{Object}</code>: <p>The source object whose non-omitted properties will be uses to source the result.</p>
</li>
        
          <li><b>propsToOmit</b> <code>{Array}</code>: <p>List of properties to omit from the result.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>Returns a new object with all of the properties from <code>source</code> that were not omitted.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/omit/omit","parent":"can-util/js","src":{"line":2,"codeLine":24,"path":"node_modules/can-util/js/omit/omit.js"},"description":"","title":"omit","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"omit(source, propsToOmit)","description":"\n\nOmit properties from an object.\n\n```js\nvar omit = require(\"can-util/js/omit/omit\");\n\nvar obj = { a: 1, b: 2, c: 3, d: 4};\n\nvar newObj = omit(obj, [ 'b', 'd' ]);\n\nconsole.log(newObj); // -> { a: 1, c: 3 }\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"source","description":"The source object whose non-omitted properties will be uses to source the result."},{"types":[{"type":"Array","options":[]}],"name":"propsToOmit","description":"List of properties to omit from the result.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"Returns a new object with all of the properties from `source` that were not omitted.\n"}}],"_curParam":{"types":[{"type":"Array","options":[]}],"name":"propsToOmit","description":"List of properties to omit from the result.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"Returns a new object with all of the properties from `source` that were not omitted.\n"},"pathToRoot":"../../../.."};
</script>
</article>
