...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/ajax/ajax.js
	@module can-util/js/ajax/ajax
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>ajax</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/ajax/ajax.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Deprecated. Use <a href="../../../can-ajax.html" title="Make an asynchronous HTTP (AJAX) request.">can-ajax</a> instead.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":10,"path":"node_modules/can-util/dom/ajax/ajax.js"},"type":"module","description":"Deprecated. Use [can-ajax] instead. \n","title":"ajax","name":"can-util/js/ajax/ajax","parent":"can-util/js","pathToRoot":"../../../.."};
</script>
</article>
