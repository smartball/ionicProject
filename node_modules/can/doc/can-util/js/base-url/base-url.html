...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/base-url/base-url.js
	@module can-util/js/base-url/base-url
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - base-url</title>
...
<div class="breadcrumb">
	...
	<li><a href="base-url.html">./base-url/</a></li>
	...
	<div class="page-type">
		<h1>base-url</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/base-url/base-url.js#L6">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get and/or set the &quot;base&quot; (containing path) of the document.</p>
<pre><code class="language-js">var baseUrl = require(&quot;can-util/js/base-url/base-url&quot;);
...
console.log(baseUrl());           // -&gt; &quot;http://localhost:8080/foo/bar&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>setUrl</b> <code>{String}</code>: <p>An optional base url to override reading the base URL from the known path.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>Returns the set or computed base URL</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":5,"codeLine":25,"path":"node_modules/can-util/js/base-url/base-url.js"},"type":"module","description":"","title":"base-url","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/js/base-url/base-url","parent":"can-util/js","signatures":[{"code":"baseUrl(optionalBaseUrlToSet)","description":"\n\nGet and/or set the \"base\" (containing path) of the document.\n\n```js\nvar baseUrl = require(\"can-util/js/base-url/base-url\");\n\nconsole.log(baseUrl());           // -> \"http://localhost:8080\"\nconsole.log(baseUrl(baseUrl() + \"/foo/bar\")); // -> \"http://localhost:8080/foo/bar\"\nconsole.log(baseUrl());           // -> \"http://localhost:8080/foo/bar\"\n```\n","params":[{"types":[{"type":"String"}],"name":"setUrl","description":"An optional base url to override reading the base URL from the known path.\n"}],"returns":{"types":[{"type":"String"}],"description":"Returns the set or computed base URL\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"setUrl","description":"An optional base url to override reading the base URL from the known path.\n"},"_curReturn":{"types":[{"type":"String"}],"description":"Returns the set or computed base URL\n"},"pathToRoot":"../../../.."};
</script>
</article>
