...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/diff-object/diff-object.js
	@module can-util/js/diff-object/diff-object
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - diff-object</title>
...
<div class="breadcrumb">
	...
	<li><a href="diff-object.html">./diff-object/</a></li>
	...
	<div class="page-type">
		<h1>diff-object</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/diff-object/diff-object.js#L5">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>oldObject</b> <code>{Object}</code>: <p>the object to diff from</p>
</li>
        
          <li><b>newObject</b> <code>{Object}</code>: <p>the object to diff to</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>an array of object-patch objects</p>
<p>Find the differences between two objects, based on properties and values</p>
<p>The object-patch object format has the following keys:</p>
<ul>
<li><strong>property</strong>: the property key on the new object</li>
<li><strong>type</strong>:     the type of operation on this property: add, remove, or set</li>
<li><strong>value</strong>:    the new value (if type is &quot;add&quot; or &quot;set&quot;)</li>
</ul>
<pre><code class="language-js">var diffObject = require(&quot;can-util/js/diff-object/diff-object&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/diff-object/diff-object","parent":"can-util/js","src":{"line":4,"codeLine":30,"path":"node_modules/can-util/js/diff-object/diff-object.js"},"description":"","title":"diff-object","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"diffObject(oldObject, newObject)","description":"\n","params":[{"types":[{"type":"Object","options":[]}],"name":"oldObject","description":"the object to diff from"},{"types":[{"type":"Object","options":[]}],"name":"newObject","description":"the object to diff to"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"an array of object-patch objects\n\nFind the differences between two objects, based on properties and values\n\nThe object-patch object format has the following keys:\n- **property**: the property key on the new object\n- **type**:     the type of operation on this property: add, remove, or set\n- **value**:    the new value (if type is \"add\" or \"set\")\n\n```js\nvar diffObject = require(\"can-util/js/diff-object/diff-object\");\n\nconsole.log(diffObject({a: 1, b: 2}, {b: 3, c: 4})); // ->\n  [{property: \"a\", type: \"remove\"},\n   {property: \"b\", type: \"set\": value: 3},\n   {property: \"c\", type: \"add\", \"value\": 4}]\n```\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"newObject","description":"the object to diff to"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"an array of object-patch objects\n\nFind the differences between two objects, based on properties and values\n\nThe object-patch object format has the following keys:\n- **property**: the property key on the new object\n- **type**:     the type of operation on this property: add, remove, or set\n- **value**:    the new value (if type is \"add\" or \"set\")\n\n```js\nvar diffObject = require(\"can-util/js/diff-object/diff-object\");\n\nconsole.log(diffObject({a: 1, b: 2}, {b: 3, c: 4})); // ->\n  [{property: \"a\", type: \"remove\"},\n   {property: \"b\", type: \"set\": value: 3},\n   {property: \"c\", type: \"add\", \"value\": 4}]\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
