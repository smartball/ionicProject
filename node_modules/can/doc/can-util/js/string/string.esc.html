...
<!--####################################################################
	...
	@function can-util/js/string/string.esc
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - string.esc</title>
...
<div class="breadcrumb">
	...
	<li><a href="string.esc.html">string.esc</a></li>
	...
	<div class="page-type">
		<h1>string.esc</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/string/string.js#L51">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>content</b> <code>{String}</code>: <p>a string</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>the string safely HTML-escaped</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/js/string/string.esc","parent":"can-util/js/string/string","src":{"line":50,"codeLine":62,"path":"node_modules/can-util/js/string/string.js"},"description":"","title":"string.esc","signatures":[{"code":"string.esc(content)","description":"","params":[{"types":[{"type":"String"}],"name":"content","description":"a string"}],"returns":{"types":[{"type":"String"}],"description":"the string safely HTML-escaped\n\n```js\nvar string = require(\"can-util/js/string/string\");\n\nstring.esc(\"<div>&nbsp;</div>\"); //-> \"&lt;div&gt;&amp;nbsp;&lt;/div&gt;\"\n```\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"content","description":"a string"},"_curReturn":{"types":[{"type":"String"}],"description":"the string safely HTML-escaped\n\n```js\nvar string = require(\"can-util/js/string/string\");\n\nstring.esc(\"<div>&nbsp;</div>\"); //-> \"&lt;div&gt;&amp;nbsp;&lt;/div&gt;\"\n```\n "},"pathToRoot":"../../../.."};
</script>
</article>
