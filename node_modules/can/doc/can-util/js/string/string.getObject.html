...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/string/string.js
	@function can-util/js/string/string.getObject
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - string.getObject</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../assign-non-enumerable/assign-non-enumerable.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../deep-assign/deep-assign.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../diff-object/diff-object.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-array-like/is-array-like.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-empty-object/is-empty-object.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-plain-object/is-plain-object.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-promise/is-promise.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-promise-like/is-promise-like.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../is-web-worker/is-web-worker.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../make-array/make-array.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../make-promise/make-promise.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../set-immediate/set-immediate.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.camelize.html"
							title="can-util/js/string/string.camelize">
							string.camelize
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.capitalize.html"
							title="can-util/js/string/string.capitalize">
							string.capitalize
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.esc.html"
							title="can-util/js/string/string.esc">
							string.esc
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="string.getObject.html"
							title="can-util/js/string/string.getObject">
							string.getObject
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.hyphenate.html"
							title="can-util/js/string/string.hyphenate">
							string.hyphenate
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="string.strReplacer.html"
							title="The regex used to find replacement sections in string.sub">
							string.strReplacer
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="string.strUndHash.html"
							title="A regex which matches an underscore or hyphen character">
							string.strUndHash
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.sub.html"
							title="can-util/js/string/string.sub">
							string.sub
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="string.underscore.html"
							title="can-util/js/string/string.underscore">
							string.underscore
						</a>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../string-to-any/string-to-any.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../../dom/child-nodes/child-nodes.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../../dom/class-name/class-name.html"
...
var domData = require(&quot;can-util/dom/data/data&quot;);">
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../../dom/dispatch/dispatch.html"
...
<div class="breadcrumb">
	...
	<li><a href="string.getObject.html">string.getObject</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>string.getObject</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/string/string.js#L71">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>a String of dot-separated keys, representing a path of properties</p>
</li>
        
          <li><b>roots</b> <code>{Object|Array}</code>: <p>the object to use as the root for property based navigation</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>the value at the property path descending from <code>roots</code></p>
<p>Return the result of descending the path <code>name</code> through the properties of the object or objects
<code>roots</code></p>
<p>If <code>roots</code> is an Array, each element of the array is evaluated, in order, until
the path is found in an element's properties (and properties-of-properties, etc.).  Otherwise
<code>roots</code> is evaluated as the root object, returning either the object at the property path
descended from <code>roots</code> or <code>undefined</code> if any subpath is not found.</p>
<p>A <em>path</em> is a dot-delimited sequence of zero or more property names, such that &quot;foo.bar&quot; means &quot;the property
'bar' of the object at the property 'foo' of the root.&quot;  An empty path returns the first object in <code>roots</code>
if it's an array, <code>roots</code> itself otherwise.</p>
<pre><code class="language-js">var string = require(&quot;can-util/js/string/string&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/js/string/string.getObject","parent":"can-util/js/string/string","src":{"line":70,"codeLine":97,"path":"node_modules/can-util/js/string/string.js"},"description":"","title":"string.getObject","signatures":[{"code":"string.getObject(name, roots)","description":"","params":[{"types":[{"type":"String"}],"name":"name","description":"a String of dot-separated keys, representing a path of properties"},{"types":[{"type":"Object"},{"type":"Array","options":[]}],"name":"roots","description":"the object to use as the root for property based navigation"}],"returns":{"types":[{"type":"*"}],"description":"the value at the property path descending from `roots`\n\nReturn the result of descending the path `name` through the properties of the object or objects\n`roots`\n\nIf `roots` is an Array, each element of the array is evaluated, in order, until\nthe path is found in an element's properties (and properties-of-properties, etc.).  Otherwise\n`roots` is evaluated as the root object, returning either the object at the property path\ndescended from `roots` or `undefined` if any subpath is not found.\n\nA *path* is a dot-delimited sequence of zero or more property names, such that \"foo.bar\" means \"the property\n'bar' of the object at the property 'foo' of the root.\"  An empty path returns the first object in `roots`\nif it's an array, `roots` itself otherwise.\n\n```js\nvar string = require(\"can-util/js/string/string\");\n\nconsole.log(string.getObject(\"a.b.c\", {a: {b: {c: \"foo\"}}})); // -> \"foo\"\nconsole.log(string.getObject(\"a.b.c\", {a: {}})); // -> undefined\nconsole.log(string.getObject(\"a.b\", [{a: {}}, {a: {b: \"bar\"}}])); // -> \"bar\"\n```\n "}}],"_curParam":{"types":[{"type":"Object"},{"type":"Array","options":[]}],"name":"roots","description":"the object to use as the root for property based navigation"},"_curReturn":{"types":[{"type":"*"}],"description":"the value at the property path descending from `roots`\n\nReturn the result of descending the path `name` through the properties of the object or objects\n`roots`\n\nIf `roots` is an Array, each element of the array is evaluated, in order, until\nthe path is found in an element's properties (and properties-of-properties, etc.).  Otherwise\n`roots` is evaluated as the root object, returning either the object at the property path\ndescended from `roots` or `undefined` if any subpath is not found.\n\nA *path* is a dot-delimited sequence of zero or more property names, such that \"foo.bar\" means \"the property\n'bar' of the object at the property 'foo' of the root.\"  An empty path returns the first object in `roots`\nif it's an array, `roots` itself otherwise.\n\n```js\nvar string = require(\"can-util/js/string/string\");\n\nconsole.log(string.getObject(\"a.b.c\", {a: {b: {c: \"foo\"}}})); // -> \"foo\"\nconsole.log(string.getObject(\"a.b.c\", {a: {}})); // -> undefined\nconsole.log(string.getObject(\"a.b\", [{a: {}}, {a: {b: \"bar\"}}])); // -> \"bar\"\n```\n "},"pathToRoot":"../../../.."};
</script>
</article>
