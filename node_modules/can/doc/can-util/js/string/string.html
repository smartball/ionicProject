...
<!--####################################################################
	...
	@module can-util/js/string/string
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - string</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>string</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/string/string.js#L13">Edit on GitHub</a>
				</li>
    ...
    <p>String utilities used by CanJS libraries</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/js/string/string","type":"module","parent":"can-util/js","src":{"line":12,"codeLine":18,"path":"node_modules/can-util/js/string/string.js"},"description":"String utilities used by CanJS libraries \n","title":"string","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
