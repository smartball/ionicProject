...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/import/import.js
	@module can-util/js/import/import
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - import</title>
	...
	<div class="page-type">
		<h1>import</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/import/import.js#L6">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <pre><code class="language-js">var importModule = require(&quot;can-util/js/import/import&quot;);
...
importModule(&quot;foo.stache&quot;).then(function(){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>moduleName</b> <code>{String}</code>: <p>The module to be imported.</p>
</li>
        
          <li><b>parentName</b> <code>{String}</code>: <p>A parent module that will be used as a reference for resolving relative module imports.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>A Promise that will resolve when the module has been imported.</p>
</p>
  </div>
