...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/each/each.md
	@module can-util/js/each/each
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<div class="page-type">
		<h1>each</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/each/each.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>A generic iterator function that can be used to iterate over both Array-Like and object data structure. Array-Like data structures are iterated by their numerical index. Objects are iterated by their named properties, i.e. in each stage of iteration the each function emits the key and its corresponding value.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>elements</b> <code>{Object|ArrayLike}</code>: <p>the object or Array-Like elements to iterate over</p>
</li>
        
          <li><b>callback</b> <code>{function(element, key, <a href="../../../elements.html" title="This module must be CJS format because is uses with () { ... }
statements which will not work in ES6 since it forces strict mode.">elements</a>)}</code>: <p>the function that would be executed in each iteration</p>
</li>
        
          <li><b>context</b> <code>{Object}</code>: <p>the context object</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object|ArrayLike}</code>: <p>the original elements</p>
<pre><code class="language-js"> var each = require(&quot;can-util/js/each/each&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-util/js/each/each.md"},"description":"\n","type":"module","title":"each","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/js/each/each","parent":"can-util/js","signatures":[{"code":"each(elements, callback, context)","description":"\n\nA generic iterator function that can be used to iterate over both Array-Like and object data structure. Array-Like data structures are iterated by their numerical index. Objects are iterated by their named properties, i.e. in each stage of iteration the each function emits the key and its corresponding value.\n","params":[{"types":[{"type":"Object"},{"type":"ArrayLike"}],"optional":true,"name":"elements","description":"the object or Array-Like elements to iterate over"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"element"}]},{"types":[{"type":"key"}]},{"types":[{"type":"elements"}]}]}],"optional":true,"name":"callback","description":"the function that would be executed in each iteration"},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"the context object\n"}],"returns":{"types":[{"type":"Object"},{"type":"ArrayLike"}],"description":"the original elements\n\n```js\n var each = require(\"can-util/js/each/each\");\n \n each([2,1,0], function(i) { console.log(this[i]); }, [4,5,6]); // -> 6 \\n 5 \\n 4\n each({foo: 'bar', abc: 'xyz'}, function(val, key) {\n   console.log(key + ': ' + val);\n }); // -> \"foo: bar\" \\n \"abc: xyz\"\n```\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"the context object\n"},"_curReturn":{"types":[{"type":"Object"},{"type":"ArrayLike"}],"description":"the original elements\n\n```js\n var each = require(\"can-util/js/each/each\");\n \n each([2,1,0], function(i) { console.log(this[i]); }, [4,5,6]); // -> 6 \\n 5 \\n 4\n each({foo: 'bar', abc: 'xyz'}, function(val, key) {\n   console.log(key + ': ' + val);\n }); // -> \"foo: bar\" \\n \"abc: xyz\"\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
