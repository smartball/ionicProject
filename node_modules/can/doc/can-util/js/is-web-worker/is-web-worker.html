...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@module can-util/js/is-web-worker/is-web-worker
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - is-web-worker</title>
...
<div class="breadcrumb">
	...
	<li><a href="is-web-worker.html">./is-web-worker/</a></li>
  ...
  <section class="title">
    ...
    <p>Determines if the code is running with a <a href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers">Web Worker</a>.</p>
...
<div class="signature">
  ...
  <pre><code class="language-js">var isWebWorker = require(&quot;can-util/js/is-web-worker/is-web-worker&quot;);
...
if(isWebWorker()) {
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>True if running in a Web Worker.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"description":"Determines if the code is running with a [Web Worker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers). ","type":"module","title":"is-web-worker","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/js/is-web-worker/is-web-worker","parent":"can-util/js","signatures":[{"code":"isWebWorker()","description":"\n\n```js\nvar isWebWorker = require(\"can-util/js/is-web-worker/is-web-worker\");\nvar GLOBAL = require(\"can-globals/global/global\");\n\nif(isWebWorker()) {\n  console.log(GLOBAL() === self); // -> true\n}\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"True if running in a Web Worker.\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"True if running in a Web Worker.\n"},"pathToRoot":"../../../.."};
</script>
</article>
