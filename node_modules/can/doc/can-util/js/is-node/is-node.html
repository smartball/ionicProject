...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/is-node/is-node.js
	@module can-util/js/is-node/is-node
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - is-node</title>
...
<div class="breadcrumb">
	...
	<li><a href="is-node.html">./is-node/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>is-node</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/is-node/is-node.js#L3">Edit on GitHub</a>
				</li>
    ...
    <p>Determines if your code is running in <a href="https://nodejs.org">Node.js</a>.</p>
...
<div class="signature">
  ...
  <pre><code class="language-js">var isNode = require(&quot;can-util/js/is-node/is-node&quot;);
...
if(isNode()) {
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>True if running in Node.js</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/is-node/is-node","parent":"can-util/js","src":{"line":2,"codeLine":20,"path":"node_modules/can-util/js/is-node/is-node.js"},"description":"Determines if your code is running in [Node.js](https://nodejs.org). ","title":"is-node","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"isNode()","description":"\n\n```js\nvar isNode = require(\"can-util/js/is-node/is-node\");\nvar GLOBAL = require(\"can-globals/global/global\");\n\nif(isNode()) {\n  console.log(GLOBAL() === global); // -> true\n}\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"True if running in Node.js\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"True if running in Node.js\n"},"pathToRoot":"../../../.."};
</script>
</article>
