...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/log/log.js
	@module can-util/js/log/log
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - log</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>log</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/log/log.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Deprecated. Use <a href="../../../can-log.html" title="Utilities for logging to the console.">log</a> instead.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":10,"path":"node_modules/can-util/js/log/log.js"},"type":"module","description":"Deprecated. Use [can-log] instead. \n","title":"log","name":"can-util/js/log/log","parent":"can-util/js","pathToRoot":"../../../.."};
</script>
</article>
