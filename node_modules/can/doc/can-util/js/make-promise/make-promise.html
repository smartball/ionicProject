...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/make-promise/make-promise.js
	@module can-util/js/make-promise/make-promise
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - make-promise</title>
...
<div class="breadcrumb">
	...
	<li><a href="make-promise.html">./make-promise/</a></li>
	...
	<div class="page-type">
		<h1>make-promise</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/make-promise/make-promise.js#L3">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makePromise(obj)</code>
  </h2>
  <p>Will make isPromiseLike object into <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a>.</p>
<pre><code class="language-js">var makePromise = require(&quot;can-util/js/make-promise/make-promise&quot;);
...
console.log(isPromise(obj)); // -&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>An object to be made into Promise.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>the object as a Promise.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/js/make-promise/make-promise","type":"module","parent":"can-util/js","src":{"line":2,"codeLine":22,"path":"node_modules/can-util/js/make-promise/make-promise.js"},"description":"","title":"make-promise","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makePromise(obj)","description":"\n\nWill make isPromiseLike object into [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise).\n\n```js\nvar makePromise = require(\"can-util/js/make-promise/make-promise\");\n\nvar obj = {};\nvar promise = makePromise(obj);\n\nconsole.log(isPromise(promise)); // -> true\nconsole.log(isPromise(obj)); // -> false\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An object to be made into Promise."}],"returns":{"types":[{"type":"Promise"}],"description":"the object as a Promise.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An object to be made into Promise."},"_curReturn":{"types":[{"type":"Promise"}],"description":"the object as a Promise.\n"},"pathToRoot":"../../../.."};
</script>
</article>
