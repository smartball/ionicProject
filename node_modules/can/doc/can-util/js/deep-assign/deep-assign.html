...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/deep-assign/deep-assign.md
	@module can-util/js/deep-assign/deep-assign
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - deep-assign</title>
...
<div class="breadcrumb">
	...
	<li><a href="deep-assign.html">./deep-assign/</a></li>
	...
	<div class="page-type">
		<h1>deep-assign</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/deep-assign/deep-assign.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Assign properties from a source object to a target object, deeply copying properties that are objects or arrays.</p>
<pre><code class="language-js">var deepAssign = require(&quot;can-util/js/deep-assign/deep-assign&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{Object}</code>: <p>The target object who's properties will be assigned from the source objects.</p>
</li>
        
          <li><b>source</b> <code>{Object}</code>: <p>Source objects from which properties will be assigned to the <code>target</code> object. Sources will be copied deeply; meaning any object or array properties will be traversed and copied (like a clone).</p>
</li>
