...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/make-map/make-map.js
	@module can-util/js/make-map/make-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - make-map</title>
...
<div class="breadcrumb">
	...
	<li><a href="make-map.html">./make-map/</a></li>
	...
	<div class="page-type">
		<h1>make-map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/make-map/make-map.js#L5">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>string</b> <code>{String}</code>: <p>A comma separated list of values</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A JavaScript object with the same keys as the passed-in comma-separated values</p>
<p>makeMap takes a comma-separated string (can-list, NodeList, etc.) and converts it to a JavaScript object</p>
<pre><code>var makeMap = require(&quot;can-util/js/make-map/make-map&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/make-map/make-map","parent":"can-util/js","src":{"line":4,"codeLine":19,"path":"node_modules/can-util/js/make-map/make-map.js"},"description":"","title":"make-map","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeMap( string )","description":"","params":[{"types":[{"type":"String"}],"name":"string","description":"A comma separated list of values"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A JavaScript object with the same keys as the passed-in comma-separated values\n\nmakeMap takes a comma-separated string (can-list, NodeList, etc.) and converts it to a JavaScript object\n\n```\nvar makeMap = require(\"can-util/js/make-map/make-map\");\n\nmakeMap(\"a,b,c\"); //-> { a: true, b: true, c: true }\n```\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"string","description":"A comma separated list of values"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A JavaScript object with the same keys as the passed-in comma-separated values\n\nmakeMap takes a comma-separated string (can-list, NodeList, etc.) and converts it to a JavaScript object\n\n```\nvar makeMap = require(\"can-util/js/make-map/make-map\");\n\nmakeMap(\"a,b,c\"); //-> { a: true, b: true, c: true }\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
