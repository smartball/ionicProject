...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/diff/diff.js
	@module can-util/js/diff/diff
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - diff</title>
	...
	<div class="page-type">
		<h1>diff</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/diff/diff.js#L41">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>oldList</b> <code>{ArrayLike}</code>: <p>the array to diff from</p>
</li>
        
          <li><b>newList</b> <code>{ArrayLike}</code>: <p>the array to diff to</p>
</li>
        
          <li><b>identity</b> <code>{function}</code>: <p>an optional identity function for comparing elements</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>a list of Patch objects representing the differences</p>
<p>Returns the difference between two ArrayLike objects (that have nonnegative
integer keys and the <code>length</code> property) as an array of patch objects.</p>
<p>A patch object returned by this function has the following properties:</p>
<ul>
<li><strong>index</strong>:  the index of newList where the patch begins</li>
<li><strong>deleteCount</strong>: the number of items deleted from that index in newList</li>
<li><strong>insert</strong>: an Array of items newly inserted at that index in newList</li>
</ul>
<pre><code class="language-js">var diff = require(&quot;can-util/js/diff/diff&quot;);
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/js/diff/diff","type":"module","parent":"can-util/js","src":{"line":40,"codeLine":73,"path":"node_modules/can-util/js/diff/diff.js"},"description":"","title":"diff","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"diff( oldList, newList, [identity] )","description":"\n","params":[{"types":[{"type":"ArrayLike"}],"name":"oldList","description":"the array to diff from"},{"types":[{"type":"ArrayLike"}],"name":"newList","description":"the array to diff to"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"identity","description":"an optional identity function for comparing elements"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"a list of Patch objects representing the differences\n\nReturns the difference between two ArrayLike objects (that have nonnegative\ninteger keys and the `length` property) as an array of patch objects.\n\nA patch object returned by this function has the following properties:\n- **index**:  the index of newList where the patch begins\n- **deleteCount**: the number of items deleted from that index in newList\n- **insert**: an Array of items newly inserted at that index in newList\n\n```js\nvar diff = require(\"can-util/js/diff/diff\");\n\nconsole.log(diff([1], [1, 2])); // -> [{index: 1, deleteCount: 0, insert: [2]}]\nconsole.log(diff([1, 2], [1])); // -> [{index: 1, deleteCount: 1, insert: []}]\n\n// with an optional identity function:\ndiff(\n    [{id:1},{id:2}],\n    [{id:1},{id:3}],\n    (a,b) => a.id === b.id\n); // -> [{index: 1, deleteCount: 1, insert: [{id:3}]}]\n```\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"identity","description":"an optional identity function for comparing elements"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"a list of Patch objects representing the differences\n\nReturns the difference between two ArrayLike objects (that have nonnegative\ninteger keys and the `length` property) as an array of patch objects.\n\nA patch object returned by this function has the following properties:\n- **index**:  the index of newList where the patch begins\n- **deleteCount**: the number of items deleted from that index in newList\n- **insert**: an Array of items newly inserted at that index in newList\n\n```js\nvar diff = require(\"can-util/js/diff/diff\");\n\nconsole.log(diff([1], [1, 2])); // -> [{index: 1, deleteCount: 0, insert: [2]}]\nconsole.log(diff([1, 2], [1])); // -> [{index: 1, deleteCount: 1, insert: []}]\n\n// with an optional identity function:\ndiff(\n    [{id:1},{id:2}],\n    [{id:1},{id:3}],\n    (a,b) => a.id === b.id\n); // -> [{index: 1, deleteCount: 1, insert: [{id:3}]}]\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
