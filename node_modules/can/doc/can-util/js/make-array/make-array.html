...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/make-array/make-array.js
	@module can-util/js/make-array/make-array
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - make-array</title>
...
<div class="breadcrumb">
	...
	<li><a href="make-array.html">./make-array/</a></li>
	...
	<div class="page-type">
		<h1>make-array</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/make-array/make-array.js#L6">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>element</b> <code>{ArrayLike|Object}</code>: <p>any array-like or object data structure</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>a JavaScript array object with the same elements as the passed-in ArrayLike</p>
<p>makeArray takes any array-like object (can-list, NodeList, etc.) and converts it to a JavaScript array</p>
<pre><code>var makeArray = require(&quot;can-util/js/make-array/make-array&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/make-array/make-array","parent":"can-util/js","src":{"line":5,"codeLine":21,"path":"node_modules/can-util/js/make-array/make-array.js"},"description":"","title":"make-array","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeArray(element)","description":"","params":[{"types":[{"type":"ArrayLike"},{"type":"Object","options":[]}],"name":"element","description":"any array-like or object data structure"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"a JavaScript array object with the same elements as the passed-in ArrayLike\n\nmakeArray takes any array-like object (can-list, NodeList, etc.) and converts it to a JavaScript array\n\n```\nvar makeArray = require(\"can-util/js/make-array/make-array\");\n\nmakeArray({0: \"a\", length: 1}); //-> [\"a\"]\n\n```\n"}}],"_curParam":{"types":[{"type":"ArrayLike"},{"type":"Object","options":[]}],"name":"element","description":"any array-like or object data structure"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"a JavaScript array object with the same elements as the passed-in ArrayLike\n\nmakeArray takes any array-like object (can-list, NodeList, etc.) and converts it to a JavaScript array\n\n```\nvar makeArray = require(\"can-util/js/make-array/make-array\");\n\nmakeArray({0: \"a\", length: 1}); //-> [\"a\"]\n\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
