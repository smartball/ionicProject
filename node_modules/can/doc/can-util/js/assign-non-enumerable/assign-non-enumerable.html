...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/assign-non-enumerable/assign-non-enumerable.js
	@module can-util/js/assign-non-enumerable/assign-non-enumerable
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - assign-non-enumerable</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="module"
							href="assign-non-enumerable.html"
...
<div class="breadcrumb">
	...
	<li><a href="assign-non-enumerable.html">./assign-non-enumerable/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>assign-non-enumerable</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/assign-non-enumerable/assign-non-enumerable.js#L3">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>assignNonEnumerable(target, source)</code>
  </h2>
  <p>A simplified version of <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign">Object.assign</a>, which only accepts a single source argument
and makes all assigned properties non enumerable and writable.</p>
<pre><code class="language-js">var assignNonEnumerable = require(&quot;can-util/js/assign-non-enumerable/assign-non-enumerable&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{Object}</code>: <p>The destination object. This object's properties will be mutated based on the object provided as <code>source</code>.</p>
</li>
        
          <li><b>source</b> <code>{Object}</code>: <p>The source object whose own properties will be applied to <code>target</code>.</p>
</li>
