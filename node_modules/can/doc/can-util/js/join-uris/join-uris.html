...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/join-uris/join-uris.md
	@module can-util/js/join-uris/join-uris
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - join-uris</title>
...
<div class="breadcrumb">
	...
	<li><a href="join-uris.html">./join-uris/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>join-uris</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/join-uris/join-uris.md">Edit on GitHub</a>
				</li>
    ...
    <p>Join together a URI path to a base.</p>
...
<div class="signature">
  ...
  <p>Provides a convenient way to join together URIs handling relative paths.</p>
<pre><code class="language-js">var joinURIs = require(&quot;can-util/js/join-uris&quot;);
...
console.log(res); // -&gt; http://example.com/images/foo.png
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>base</b> <code>{String}</code>: </li>
        
          <li><b>href</b> <code>{String}</code>: </li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The result of joining the two parts.</p>
</p>
  </div>
