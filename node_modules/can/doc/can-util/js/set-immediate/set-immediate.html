...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/set-immediate/set-immediate.js
	@module can-util/js/set-immediate/set-immediate
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - set-immediate</title>
...
<div class="breadcrumb">
	...
	<li><a href="set-immediate.html">./set-immediate/</a></li>
	...
	<div class="page-type">
		<h1>set-immediate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/set-immediate/set-immediate.js#L5">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>cb</b> <code>{function}</code>: <p>Polyfill for setImmediate() if it doesn't exist in the global context</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/set-immediate/set-immediate","parent":"can-util/js","src":{"line":4,"codeLine":12,"path":"node_modules/can-util/js/set-immediate/set-immediate.js"},"description":"","title":"set-immediate","signatures":[{"code":"setImmediate(function())","description":"","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"cb","description":"\n\nPolyfill for setImmediate() if it doesn't exist in the global context\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"cb","description":"\n\nPolyfill for setImmediate() if it doesn't exist in the global context\n"},"pathToRoot":"../../../.."};
</script>
</article>
