...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/is-string/is-string.js
	@module can-util/js/is-string/is-string
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - is-string</title>
...
<div class="breadcrumb">
	...
	<li><a href="is-string.html">./is-string/</a></li>
	...
	<div class="page-type">
		<h1>is-string</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/is-string/is-string.js#L6">Edit on GitHub</a>
				</li>
...
Use <code>typeof obj === 'string'</code> instead of <code>isString(obj)</code>.</p>
<p>Determines if the provided argument is a string.</p>
<pre><code class="language-js">var isString = require(&quot;can-util/js/is-string/is-string&quot;);
...
console.log(isString({})); // -&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>An object to test if is a string.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>True if the object is a string.</p>
</p>
  </div>
