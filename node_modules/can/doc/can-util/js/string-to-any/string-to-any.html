...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/string-to-any/string-to-any.md
	@module can-util/js/string-to-any/string-to-any
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="string-to-any.html">./string-to-any/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>string-to-any</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/string-to-any/string-to-any.md">Edit on GitHub</a>
				</li>
    ...
    <p>Turns a string representation of a primitive type back into the associated primitive.</p>
...
<div class="signature">
  ...
  <p>Examines the provided string to see if it can be converted to a primitive type. Supported arguments are:</p>
<ul>
<li>&quot;true&quot;</li>
<li>&quot;false&quot;</li>
<li>&quot;null&quot;</li>
...
<li>&quot;NaN&quot;</li>
<li>&quot;Infinity&quot;</li>
<li>Any <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">Number</a></li>
<li>Any <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">String</a></li>
</ul>
<pre><code class="language-js">var stringToAny = require(&quot;can-util/js/string-to-any/string-to-any&quot;);
...
stringToAny(&quot;false&quot;); // -&gt; false
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>string</b> <code>{String}</code>: <p>A string to convert back to its primitive type.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The primitive representation of the provided string.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-util/js/string-to-any/string-to-any.md"},"description":"Turns a string representation of a primitive type back into the associated primitive. \n","type":"module","title":"string-to-any","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/js/string-to-any/string-to-any","parent":"can-util/js","signatures":[{"code":"stringToAny(string)","description":"\n\nExamines the provided string to see if it can be converted to a primitive type. Supported arguments are:\n\n* \"true\"\n* \"false\"\n* \"null\"\n* \"undefined\"\n* \"NaN\"\n* \"Infinity\"\n* Any [Number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)\n* Any [String](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)\n\n```js\nvar stringToAny = require(\"can-util/js/string-to-any/string-to-any\");\n\nstringToAny(\"NaN\"); // -> NaN\nstringToAny(\"44.4\"); // -> 44.4\nstringToAny(\"false\"); // -> false\n```\n","params":[{"types":[{"type":"String"}],"name":"string","description":"A string to convert back to its primitive type.\n"}],"returns":{"types":[{"type":"*"}],"description":"The primitive representation of the provided string.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"string","description":"A string to convert back to its primitive type.\n"},"_curReturn":{"types":[{"type":"*"}],"description":"The primitive representation of the provided string.\n"},"pathToRoot":"../../../.."};
</script>
</article>
