...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/types/types.js
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>types</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/types/types.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Deprecated. Use <a href="../../../can-types.html" title="A stateful container for CanJS type information.">can-types</a> instead.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":10,"path":"node_modules/can-util/js/types/types.js"},"type":"module","description":"Deprecated. Use [can-types] instead. \n","title":"types","name":"can-util/js/types/types","parent":"can-util/js","pathToRoot":"../../../.."};
</script>
</article>
