...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/get/get.js
	@module can-util/js/get/get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/get/get.js#L5">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to use as the root for property based navigation</p>
</li>
        
          <li><b>path</b> <code>{String}</code>: <p>a String of dot-separated keys, representing a path of properties</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>the value at the property path</p>
<p>A <em>path</em> is a dot-delimited sequence of zero or more property names, such that &quot;foo.bar&quot; means &quot;the property
'bar' of the object at the property 'foo' of the root.&quot;  An empty path returns the object passed.</p>
<pre><code class="language-js">var get = require(&quot;can-util/js/get/get&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/js/get/get","parent":"can-util/js","src":{"line":4,"codeLine":23,"path":"node_modules/can-util/js/get/get.js"},"description":"\n","title":"get","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"get(obj, path)","description":"","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to use as the root for property based navigation"},{"types":[{"type":"String"}],"name":"path","description":"a String of dot-separated keys, representing a path of properties"}],"returns":{"types":[{"type":"*"}],"description":"the value at the property path\n\nA *path* is a dot-delimited sequence of zero or more property names, such that \"foo.bar\" means \"the property\n'bar' of the object at the property 'foo' of the root.\"  An empty path returns the object passed.\n\n```js\nvar get = require(\"can-util/js/get/get\");\nconsole.log(get({a: {b: {c: \"foo\"}}}, \"a.b.c\")); // -> \"foo\"\nconsole.log(get({a: {}}, \"a.b.c\")); // -> undefined\nconsole.log(get([{a: {}}, {a: {b: \"bar\"}}], \"a.b\")); // -> \"bar\"\n```\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"path","description":"a String of dot-separated keys, representing a path of properties"},"_curReturn":{"types":[{"type":"*"}],"description":"the value at the property path\n\nA *path* is a dot-delimited sequence of zero or more property names, such that \"foo.bar\" means \"the property\n'bar' of the object at the property 'foo' of the root.\"  An empty path returns the object passed.\n\n```js\nvar get = require(\"can-util/js/get/get\");\nconsole.log(get({a: {b: {c: \"foo\"}}}, \"a.b.c\")); // -> \"foo\"\nconsole.log(get({a: {}}, \"a.b.c\")); // -> undefined\nconsole.log(get([{a: {}}, {a: {b: \"bar\"}}], \"a.b\")); // -> \"bar\"\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
