...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/cid-set/cid-set.js
	@module can-util/js/cid-set/cid-set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - cid-set</title>
...
<div class="breadcrumb">
	...
	<li><a href="cid-set.html">./cid-set/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>cid-set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/cid-set/cid-set.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Deprecated. Use [can-cid/set/set] instead.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p>This module exports the native <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set">Set</a>
object if <code>Set</code> is present.  If not, a <code>Set</code>-like constructor function is exported that supports <code>O(1)</code> insertion and
deletion by adding a <a href="../../../can-cid.html" title="can-cid">can-cid</a> property to objects passed to <code>.set</code>.</p>
<pre><code class="language-js">var Set = require(&quot;can-util/js/cid-set/cid-set&quot;);
...
<p>The following methods and properties are supported by the polyfill:</p>
<ul>
<li><code>clear()</code></li>
<li><code>delete(value)</code></li>
<li><code>forEach(callback[,thisArg])</code></li>
<li><code>get(value)</code></li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":10,"path":"node_modules/can-util/js/cid-set/cid-set.js"},"description":"Deprecated. Use [can-cid/set/set] instead. \n","type":"module","title":"cid-set","types":[{"type":"Map"}],"name":"can-util/js/cid-set/cid-set","parent":"can-util/js","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
