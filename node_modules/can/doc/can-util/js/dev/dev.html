...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/js/dev/dev.js
	@module can-util/js/dev/dev
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - dev</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>dev</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/dev/dev.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Deprecated. Use [can-dev] instead.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":10,"path":"node_modules/can-util/js/dev/dev.js"},"type":"module","description":"Deprecated. Use [can-dev] instead. \n","title":"dev","name":"can-util/js/dev/dev","parent":"can-util/js","pathToRoot":"../../../.."};
</script>
</article>
