...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/child-nodes/child-nodes.js
	@module can-util/dom/child-nodes/child-nodes
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - child-nodes</title>
...
<div class="breadcrumb">
	...
	<li><a href="child-nodes.html">./child-nodes/</a></li>
	...
	<div class="page-type">
		<h1>child-nodes</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/child-nodes/child-nodes.js#L3">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get all of the childNodes of a given node.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>node</b> <code>{Object}</code>: <p>The Node that you want child nodes for.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/dom/child-nodes/child-nodes","parent":"can-util/dom","src":{"line":2,"codeLine":22,"path":"node_modules/can-util/dom/child-nodes/child-nodes.js"},"description":"","title":"child-nodes","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"childNodes(node)","description":"\n\nGet all of the childNodes of a given node.\n\n```js\nvar stache = require(\"can-stache\");\nvar childNodes = require(\"can-util/child-nodes/child-nodes\");\n\nvar html = \"<div><h1><span></span></h1></div>\";\nvar frag = stache(html)();\n\nconsole.log(childNodes(frag)[0].nodeName); // -> DIV\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"node","description":"The Node that you want child nodes for.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"node","description":"The Node that you want child nodes for.\n"},"pathToRoot":"../../../.."};
</script>
</article>
