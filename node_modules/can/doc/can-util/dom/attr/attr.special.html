...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/attr/attr-special.md
	@property can-util/dom/attr/attr.special
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>special</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/attr/attr-special.md">Edit on GitHub</a>
				</li>
    ...
    <p>An object used to set up special properties. Each key on <code>attr.special</code> is a name of a property/attribute that has special behaviors when being get, set, or bound to.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <pre><code class="language-js">attr.special.foo = {
    get: function(){
        return this.foo;
    },
    set: function(val){
...
<p>CanJS comes with a couple of special properties that can be used in bindings:</p>
<ul>
<li><a href="attr.special.values.html" title="A special property that represents the selected values in a &lt;select&gt; element, usually a &lt;select multiple&gt;. The special property is needed because the DOM's native value property on a multiple select only gives you one of the selected options' values.">values</a></li>
<li><a href="attr.special.focused.html" title="Signifies if an element, usually an &lt;input&gt; is the focused element on the page.">focused</a></li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-util/dom/attr/attr-special.md"},"description":"\nAn object used to set up special properties. Each key on `attr.special` is a name of a property/attribute that has special behaviors when being get, set, or bound to.\n","types":[{"type":"Object","options":[]}],"title":"special","name":"can-util/dom/attr/attr.special","type":"property","parent":"can-util/dom/attr/attr","pathToRoot":"../../../.."};
</script>
</article>
