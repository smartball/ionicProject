...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/attr/attr-special.focused.md
	@property can-util/dom/attr/attr.special.focused
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - focused</title>
...
can-symbol also has a polyfill function that will fake symbols on unsupported platforms.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../../js/base-url/base-url.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../../js/location/localtion.html"
							title="Deprecated. Use can-globals instead.">
							./location/localtion
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						expanded">
						<a class="property"
							href="attr.special.html"
							title="An object used to set up special properties. Each key on attr.special is a name of a property/attribute that has special behaviors when being get, set, or bound to.">
							special
						</a>
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="property"
							href="attr.special.focused.html"
							title="Signifies if an element, usually an &lt;input&gt; is the focused element on the page.">
							focused
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="attr.special.values.html"
							title="A special property that represents the selected values in a &lt;select&gt; element, usually a &lt;select multiple&gt;. The special property is needed because the DOM&#x27;s native value property on a multiple select only gives you one of the selected options&#x27; values.">
							values
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="attr.special.html">special</a></li>
		<li> / </li>
	
	
	<li><a href="attr.special.focused.html">focused</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>focused</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/attr/attr-special.focused.md">Edit on GitHub</a>
				</li>
    ...
    <p>Signifies if an element, usually an <code>&lt;input&gt;</code> is the focused element on the page.</p>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <pre><code class="language-js">domAttr.get(input, &quot;focused&quot;); // -&gt; false

domAttr.set(input, &quot;focused&quot;, true);
domAttr.get(input, &quot;focused&quot;); // -&gt; true
</code></pre>
<h2>One-way binding to set focus</h2>
<p>Use <code>focused</code> in event bindings to have a way to set focus to an input. In this example we are one-way binding to <code>focused</code> to a function that will recompute:</p>
<pre><code class="language-handlebars">&lt;input type=&quot;text&quot; {$focused}=&quot;isEditing()&quot; /&gt;
...
<p>In this example whenever the <code>editing</code> property changes to <code>true</code>, <code>isEditing</code> will be reevaluated to <code>true</code> when will set focus on the input. You can imagine there might be some other use, such as a button, that triggers the editing status to change.</p>
<h2>Two-way binding to focused</h2>
<p>Another scenario is that you would like to know when an element is focused, perhaps to show a message (such as a tooltip) somewhere else in the DOM. The example below two-way binds to a boolean property on the ViewModel. When focus is set, the property is updated.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-util/dom/attr/attr-special.focused.md"},"description":"\nSignifies if an element, usually an `<input>` is the focused element on the page.\n","types":[{"type":"Boolean"}],"title":"focused","name":"can-util/dom/attr/attr.special.focused","type":"property","parent":"can-util/dom/attr/attr.special","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
