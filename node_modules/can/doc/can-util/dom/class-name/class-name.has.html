...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/class-name/class-name.js
	@function can-util/dom/class-name/class-name.has
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - className.has</title>
...
fooDiv.outerHTML; //-&gt; &#x27;&lt;div class=&quot;foo&quot;&gt;&lt;/div&gt;&#x27;">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="class-name.add.html"
							title="can-util/dom/class-name/class-name.add">
							className.add
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="class-name.has.html"
							title="can-util/dom/class-name/class-name.has">
							className.has
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="class-name.remove.html"
							title="can-util/dom/class-name/class-name.remove">
							className.remove
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="class-name.html">./class-name/</a></li>
		<li> / </li>
	
	
	<li><a href="class-name.has.html">className.has</a></li>
	...
	<div class="page-type">
		<h1>className.has</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/class-name/class-name.js#L27">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Determine wheter a DOM node has a given class name.</p>
<pre><code class="language-js">var className = require(&quot;can-util/dom/class-name/class-name&quot;);
...
var isContainer = className.has.call(el, &quot;container&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>className</b> <code>{String}</code>: <p>A string representing a single class name token</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>true if the element's class attribute contains the token, false otherwise.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/class-name/class-name.has","type":"function","parent":"can-util/dom/class-name/class-name","src":{"line":26,"codeLine":43,"path":"node_modules/can-util/dom/class-name/class-name.js"},"description":"","title":"className.has","signatures":[{"code":"className.has.call(el, cls)","description":"\n\nDetermine wheter a DOM node has a given class name.\n\n```js\nvar className = require(\"can-util/dom/class-name/class-name\");\n\nvar isContainer = className.has.call(el, \"container\");\n```\n","params":[{"types":[{"type":"String"}],"name":"className","description":"A string representing a single class name token\n"}],"returns":{"types":[{"type":"Boolean"}],"description":"true if the element's class attribute contains the token, false otherwise.\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"className","description":"A string representing a single class name token\n"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"true if the element's class attribute contains the token, false otherwise.\n "},"pathToRoot":"../../../.."};
</script>
</article>
