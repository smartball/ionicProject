...
<!--####################################################################
	...
	@module can-util/dom/class-name/class-name
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - class-name</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>class-name</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/class-name/class-name.js#L13">Edit on GitHub</a>
				</li>
    ...
    <p>Allows querying and manipulation of classes on HTML elements</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/class-name/class-name","type":"module","parent":"can-util/dom","src":{"line":12,"codeLine":25,"path":"node_modules/can-util/dom/class-name/class-name.js"},"description":"Allows querying and manipulation of classes on HTML elements \n```js\nvar className = require(\"can-util/dom/class-name/class-name\");\n\nvar fooDiv = document.createElement(\"div\");\nclassName.add(fooDiv, \"foo\");\nfooDiv.outerHTML; //-> '<div class=\"foo\"></div>'\n```\n\n","title":"class-name","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
