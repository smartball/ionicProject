...
<!--####################################################################
	...
	@function can-util/dom/class-name/class-name.remove
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - className.remove</title>
...
<div class="breadcrumb">
	...
	<li><a href="class-name.remove.html">className.remove</a></li>
	...
	<div class="page-type">
		<h1>className.remove</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/class-name/class-name.js#L70">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Remove a class name from a DOM node if it exists on the node</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/dom/class-name/class-name.remove","parent":"can-util/dom/class-name/class-name","src":{"line":69,"codeLine":86,"path":"node_modules/can-util/dom/class-name/class-name.js"},"description":"","title":"className.remove","signatures":[{"code":"className.remove.call(el, cls)","description":"\n\nRemove a class name from a DOM node if it exists on the node\n\n```js\nvar className = require(\"can-util/dom/class-name/class-name\");\n\nclassName.remove.call(el, \"container\");\n```\n","params":[{"types":[{"type":"String"}],"name":"className","description":"A string representing a single class name token\n"}],"returns":{"types":[{"type":"void"}],"description":"\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"className","description":"A string representing a single class name token\n"},"_curReturn":{"types":[{"type":"void"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
