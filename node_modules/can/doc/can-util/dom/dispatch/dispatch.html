...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/dispatch/dispatch.js
	@module can-util/dom/dispatch/dispatch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<div class="page-type">
		<h1>dispatch</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/dispatch/dispatch.js#L5">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Dispatch an event on an element.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{Object|String}</code>: <p>An object specifies options applied to this event.</p>
</li>
        
          <li><b>args</b> <code>{Array}</code>: <p>Arguments passed into this event.</p>
</li>
        
          <li><b>bubbles</b> <code>{Boolean}</code>: <p>Specifies whether this event should bubble (by default it will).</p>
</li>
