...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/frag/frag.js
	@module can-util/dom/frag/frag
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - frag</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>frag</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/frag/frag.js#L8">Edit on GitHub</a>
				</li>
    ...
    <p>Convert a String, HTMLElement, documentFragment, or contentArray into a documentFragment.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>item</b> <code>{String|HTMLElement|documentFragment|contentArray}</code>: </li>
        
          <li><b>doc</b> <code>{Document}</code>: <p>an optional DOM document in which to build the fragment</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>ContentArrays can be used to combine multiple HTMLElements into a single document fragment.  For example:</p>
<pre><code>var frag = require(&quot;can-util/dom/frag/frag&quot;);
...
<p><code>fragment</code> will be a documentFragment with the following elements:</p>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/dom/frag/frag","parent":"can-util/dom","src":{"line":7,"codeLine":40,"path":"node_modules/can-util/dom/frag/frag.js"},"description":"\nConvert a String, HTMLElement, documentFragment, or contentArray into a documentFragment.\n","title":"frag","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"frag: function(item, doc)","description":"\n","params":[{"types":[{"type":"String"},{"type":"HTMLElement"},{"type":"documentFragment"},{"type":"contentArray"}],"name":"item","description":""},{"types":[{"type":"Document"}],"name":"doc","description":"an optional DOM document in which to build the fragment\n"}],"returns":{"types":[{"type":"documentFragment"}],"description":"\n"}}],"_curParam":{"types":[{"type":"Document"}],"name":"doc","description":"an optional DOM document in which to build the fragment\n"},"_curReturn":{"types":[{"type":"documentFragment"}],"description":"\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
