...
<!--####################################################################
	...
	@function can-util/dom/data/data.set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.set</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.set.html">domData.set</a></li>
	...
	<div class="page-type">
		<h1>domData.set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L93">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>name</b> <code>{String}</code>: <p>the key to store the value under</p>
</li>
        
          <li><b>value</b> <code>{*}</code>: <p>the value to store under the key</p>
<p>Set data to be associated with a DOM Node using the specified <code>key</code>. If data already exists for this key, it will be overwritten.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/dom/data/data.set","parent":"can-util/dom/data/data","src":{"line":92,"codeLine":109,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.set","signatures":[{"code":"domData.set.call(el, name, value)","description":"\n","params":[{"types":[{"type":"String"}],"name":"name","description":"the key to store the value under"},{"types":[{"type":"*"}],"name":"value","description":"the value to store under the key\n\nSet data to be associated with a DOM Node using the specified `key`. If data already exists for this key, it will be overwritten.\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n\ndomData.set.call(el, \"metadata\", {\n  foo: \"bar\"\n});\n```\n "}]}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"the value to store under the key\n\nSet data to be associated with a DOM Node using the specified `key`. If data already exists for this key, it will be overwritten.\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n\ndomData.set.call(el, \"metadata\", {\n  foo: \"bar\"\n});\n```\n "},"pathToRoot":"../../../.."};
</script>
</article>
