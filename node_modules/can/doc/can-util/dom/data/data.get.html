...
<!--####################################################################
	...
	@function can-util/dom/data/data.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.get</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.get.html">domData.get</a></li>
	...
	<div class="page-type">
		<h1>domData.get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L78">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get data that was stored in a DOM Node using the specified <code>key</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>A string used as a unique key for storing data associated with this DOM Node.</p>
</li>
