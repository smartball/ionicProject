...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/data/data.js
	@function can-util/dom/data/data.cid
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.cid</title>
...
var domData = require(&quot;can-util/dom/data/data&quot;);">
	...
	<ul>
					...
					<li class="current
						...
						<a class="function"
							href="data.cid.html"
							title="can-util/dom/data/data.cid">
							domData.cid
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="data.clean.html"
							title="can-util/dom/data/data.clean">
							domData.clean
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="can-util/dom/data/data.delete">
							domData.delete
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="data.expando.html"
							title="The key in which elements&#x27; cids are stored">
							domData.expando
						</a>
					...
					<li class="
						...
						<a class="function"
							href="data.get.html"
							title="can-util/dom/data/data.get">
							domData.get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="data.getCid.html"
							title="can-util/dom/data/data.getCid">
							domData.getCid
						</a>
					...
					<li class="
						...
						<a class="function"
							href="data.set.html"
							title="can-util/dom/data/data.set">
							domData.set
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="data.cid.html">domData.cid</a></li>
	...
	<div class="page-type">
		<h1>domData.cid</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L42">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Number}</code>: <p>The value of the element's unique CID</p>
<p>Set a unique identifier for the dom node, using the
<a href="data.expando.html" title="The key in which elements' cids are stored">expando</a> property.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>If a unique cid value has not yet been set for this element, set it
using the <a href="data.expando.html" title="The key in which elements' cids are stored">expando</a> property.  Return the
unique cid whether or not it is newly set</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data.cid","type":"function","parent":"can-util/dom/data/data","src":{"line":41,"codeLine":55,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.cid","signatures":[{"code":"domData.cid.call(el)","description":"","params":[],"returns":{"types":[{"type":"Number"}],"description":"The value of the element's unique CID\n\nSet a unique identifier for the dom node, using the\n[can-util/dom/data/data.expando expando] property.\n"}}],"_curReturn":{"types":[{"type":"Number"}],"description":"The value of the element's unique CID\n\nSet a unique identifier for the dom node, using the\n[can-util/dom/data/data.expando expando] property.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
