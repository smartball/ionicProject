...
<!--####################################################################
	...
	@function can-util/dom/data/data.clean
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.clean</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.clean.html">domData.clean</a></li>
	...
	<div class="page-type">
		<h1>domData.clean</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L64">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Remove data from an element previously added by <a href="data.set.html" title="can-util/dom/data/data.set">set</a></p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data.clean","type":"function","parent":"can-util/dom/data/data","src":{"line":63,"codeLine":76,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.clean","signatures":[{"code":"domData.clean.call(el, key)","description":"\n\nRemove data from an element previously added by [can-util/dom/data/data.set set]\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n\ndomData.clean.call(el, \"metadata\");\n```\n ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
