...
<!--####################################################################
	...
	@property can-util/dom/data/data.expando
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.expando</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.expando.html">domData.expando</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>domData.expando</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L57">Edit on GitHub</a>
				</li>
    ...
    <p>The key in which elements' cids are stored</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data.expando","type":"property","parent":"can-util/dom/data/data","src":{"line":56,"codeLine":62,"path":"node_modules/can-util/dom/data/data.js"},"description":"\nThe key in which elements' cids are stored\n","types":[],"title":"domData.expando","pathToRoot":"../../../.."};
</script>
</article>
