...
<!--####################################################################
	...
	@function can-util/dom/data/data.getCid
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.getCid</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.getCid.html">domData.getCid</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>domData.getCid</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L34">Edit on GitHub</a>
				</li>
...
<p>Return the previously set unique identifier for the dom node.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data.getCid","type":"function","parent":"can-util/dom/data/data","src":{"line":33,"codeLine":40,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.getCid","signatures":[{"code":"domData.getCid.call(el)","description":"","params":[],"returns":{"types":[{"type":"Number"}],"description":"The value of the element's unique CID\n\nReturn the previously set unique identifier for the dom node.\n "}}],"_curReturn":{"types":[{"type":"Number"}],"description":"The value of the element's unique CID\n\nReturn the previously set unique identifier for the dom node.\n "},"pathToRoot":"../../../.."};
</script>
</article>
