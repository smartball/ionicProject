...
<!--####################################################################
	...
	@function can-util/dom/data/data.delete
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - domData.delete</title>
...
<div class="breadcrumb">
	...
	<li><a href="data.delete.html">domData.delete</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>domData.delete</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L119">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>domData.delete.call(el)</code>
  </h2>
  <p>Remove all data for an element previously added by <a href="data.set.html" title="can-util/dom/data/data.set">set</a></p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data.delete","type":"function","parent":"can-util/dom/data/data","src":{"line":118,"codeLine":130,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.delete","signatures":[{"code":"domData.delete.call(el)","description":"\n\nRemove all data for an element previously added by [can-util/dom/data/data.set set]\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n\ndomData.delete.call(el);\n```\n ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
