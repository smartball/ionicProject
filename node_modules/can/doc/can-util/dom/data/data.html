...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>data</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/data/data.js#L23">Edit on GitHub</a>
				</li>
    ...
    <p>Allows associating data as a key/value pair for a particular DOM Node.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/data/data","type":"module","parent":"can-util/dom","src":{"line":22,"codeLine":32,"path":"node_modules/can-util/dom/data/data.js"},"description":"Allows associating data as a key/value pair for a particular DOM Node.\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n```\n\n","title":"data","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
