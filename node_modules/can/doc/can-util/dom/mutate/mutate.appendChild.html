...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/mutate/mutate.js
	@function can-util/dom/mutate/mutate.appendChild
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - appendChild</title>
...
mutate.appendChild.call(document.body, el);">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="mutate.appendChild.html"
							title="can-util/dom/mutate/mutate.appendChild">
							appendChild
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="mutate.insertBefore.html"
							title="can-util/dom/mutate/mutate.insertBefore">
							insertBefore
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="mutate.removeChild.html"
							title="can-util/dom/mutate/mutate.removeChild">
							removeChild
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="mutate.replaceChild.html"
							title="can-util/dom/mutate/mutate.replaceChild">
							replaceChild
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="mutate.appendChild.html">appendChild</a></li>
	...
	<div class="page-type">
		<h1>appendChild</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/mutate/mutate.js#L115">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Used to append a node to an element and trigger the &quot;inserted&quot; event on all of the newly inserted children. Since <code>mutated</code> takes an array we convert the child to an array, or in the case of a DocumentFragment we first convert the childNodes to an array and call inserted on those.</p>
