...
<!--####################################################################
	...
	@module can-util/dom/mutate/mutate
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - mutate</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>mutate</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/mutate/mutate.js#L97">Edit on GitHub</a>
				</li>
    ...
    <p>Mutate an element by appending, inserting, and removing DOM nodes. Use this so that on the server &quot;inserted&quot; will be fired.</p>
<pre><code class="language-js">var mutate = require(&quot;can-util/dom/mutate/mutate&quot;);
...
<script type="text/javascript">
  window.docObject = {"name":"can-util/dom/mutate/mutate","type":"module","parent":"can-util/dom","src":{"line":96,"codeLine":113,"path":"node_modules/can-util/dom/mutate/mutate.js"},"description":"Mutate an element by appending, inserting, and removing DOM nodes. Use this so that on the server \"inserted\" will be fired. \n```js\nvar mutate = require(\"can-util/dom/mutate/mutate\");\n\nvar el = document.createElement(\"div\");\n\nel.addEventListener(\"inserted\", function(){\n  console.log(\"Inserted was fired!\");\n});\n\nmutate.appendChild.call(document.body, el);\n```\n\n","title":"mutate","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
