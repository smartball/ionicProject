...
<!--####################################################################
	...
	@function can-util/dom/events/delegate/delegate.removeDelegateListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - events.removeDelegateListener</title>
...
<div class="breadcrumb">
	...
	<li><a href="delegate.removeDelegateListener.html">events.removeDelegateListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>events.removeDelegateListener</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/events/delegate/delegate.js#L137">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>events.removeDelegateListener(eventType, selector, handler)</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>The type of the event to unbind</p>
</li>
        
          <li><b>selector</b> <code>{String}</code>: <p>A CSS selector that matches a delegate selector added for this event type</p>
</li>
        
          <li><b>handler</b> <code>{function(event)}</code>: <p>The function bound as handler when the listener was added</p>
<p>Remove a delegated event added by in [can-util/dom/delegate/delegate.addDelegateListener addDelegateListener]</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/dom/events/delegate/delegate.removeDelegateListener","parent":"can-util/dom/events/delegate/delegate","src":{"line":136,"codeLine":146,"path":"node_modules/can-util/dom/events/delegate/delegate.js"},"description":"","title":"events.removeDelegateListener","signatures":[{"code":"events.removeDelegateListener(eventType, selector, handler)","description":"","params":[{"types":[{"type":"String"}],"name":"eventType","description":"The type of the event to unbind"},{"types":[{"type":"String"}],"name":"selector","description":"A CSS selector that matches a delegate selector added for this event type"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]}]}],"name":"handler","description":"The function bound as handler when the listener was added\n\nRemove a delegated event added by in [can-util/dom/delegate/delegate.addDelegateListener addDelegateListener]\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]}]}],"name":"handler","description":"The function bound as handler when the listener was added\n\nRemove a delegated event added by in [can-util/dom/delegate/delegate.addDelegateListener addDelegateListener]\n"},"pathToRoot":"../../../../.."};
</script>
</article>
