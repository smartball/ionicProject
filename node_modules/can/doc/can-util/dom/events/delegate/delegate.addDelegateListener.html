...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/events/delegate/delegate.js
	@function can-util/dom/events/delegate/delegate.addDelegateListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - events.addDelegateListener</title>
...
event handlers do not have to be attached to each new node.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="delegate.addDelegateListener.html"
							title="can-util/dom/events/delegate/delegate.addDelegateListener">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="delegate.removeDelegateListener.html"
							title="can-util/dom/events/delegate/delegate.removeDelegateListener">
							events.removeDelegateListener
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="delegate.html">./delegate/</a></li>
		<li> / </li>
	
	
	<li><a href="delegate.addDelegateListener.html">events.addDelegateListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>events.addDelegateListener</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/events/delegate/delegate.js#L97">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>events.addDelegateListener(eventType, selector, handler)</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>The type of the event to virtually bind to delegates</p>
</li>
        
          <li><b>selector</b> <code>{String}</code>: <p>A CSS selector that matches all intended delegates</p>
</li>
        
          <li><b>handler</b> <code>{function(event)}</code>: <p>The function to call when the event is dispatched</p>
<p>Add an event as in [can-util/dom/events/events.addEventListener addEventListener] but with a selector
matching child nodes (&quot;delegates&quot;) for which the event should fire.</p>
<p>Delegate events are limited to firing in the bubble phase.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/dom/events/delegate/delegate.addDelegateListener","parent":"can-util/dom/events/delegate/delegate","src":{"line":96,"codeLine":109,"path":"node_modules/can-util/dom/events/delegate/delegate.js"},"description":"","title":"events.addDelegateListener","signatures":[{"code":"events.addDelegateListener(eventType, selector, handler)","description":"","params":[{"types":[{"type":"String"}],"name":"eventType","description":"The type of the event to virtually bind to delegates"},{"types":[{"type":"String"}],"name":"selector","description":"A CSS selector that matches all intended delegates"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]}]}],"name":"handler","description":"The function to call when the event is dispatched\n\nAdd an event as in [can-util/dom/events/events.addEventListener addEventListener] but with a selector\nmatching child nodes (\"delegates\") for which the event should fire.\n\nDelegate events are limited to firing in the bubble phase.\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]}]}],"name":"handler","description":"The function to call when the event is dispatched\n\nAdd an event as in [can-util/dom/events/events.addEventListener addEventListener] but with a selector\nmatching child nodes (\"delegates\") for which the event should fire.\n\nDelegate events are limited to firing in the bubble phase.\n"},"pathToRoot":"../../../../.."};
</script>
</article>
