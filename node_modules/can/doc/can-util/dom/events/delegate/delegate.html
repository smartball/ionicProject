...
<!--####################################################################
	...
	@module can-util/dom/events/delegate/delegate
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - delegateEvents</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>delegateEvents</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/events/delegate/delegate.js#L18">Edit on GitHub</a>
				</li>
    ...
    <p>Add delegate listeners to DOM events.  Delegated listeners use a selector on an
ancestor element to determine when to fire the event for an item.  This can help
cases where large numbers of similar DOM nodes are added into a DOM subtree, since
event handlers do not have to be attached to each new node.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/dom/events/delegate/delegate","params":[{"name":"ev","types":[{"type":"*"}]}],"parent":"can-util/dom/events/events","src":{"line":17,"codeLine":43,"path":"node_modules/can-util/dom/events/delegate/delegate.js"},"description":"\nAdd delegate listeners to DOM events.  Delegated listeners use a selector on an\nancestor element to determine when to fire the event for an item.  This can help\ncases where large numbers of similar DOM nodes are added into a DOM subtree, since\nevent handlers do not have to be attached to each new node.\n","title":"delegateEvents","types":[{"type":"events"}],"pathToRoot":"../../../../.."};
</script>
</article>
