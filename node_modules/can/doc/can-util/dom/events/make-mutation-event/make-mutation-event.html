...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-util/dom/events/make-mutation-event/make-mutation-event.js
	@module can-util/dom/events/make-mutation-event/make-mutation-event
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - makeMutationEvent</title>
...
<div class="breadcrumb">
	...
	<li><a href="make-mutation-event.html">./make-mutation-event/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>makeMutationEvent</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/events/make-mutation-event/make-mutation-event.js#L17">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>specialEventName</b> <code>{String}</code>: <p>the event to handle as a mutation observer-based event</p>
</li>
        
          <li><b>mutationNodesProperty</b> <code>{String}</code>: <p>the property of interest in a DOM mutation</p>
<p>This function provides a simple interface to bind the DOM events interface to the mutation
observer interface, by firing an event when a matching mutation is generated by the client</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-util/dom/events/make-mutation-event/make-mutation-event","parent":"can-util/dom/events/events","src":{"line":16,"codeLine":28,"path":"node_modules/can-util/dom/events/make-mutation-event/make-mutation-event.js"},"description":"\n","title":"makeMutationEvent","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeMutationEvent(specialEventName, mutationNodesProperty)","description":"\n","params":[{"types":[{"type":"String"}],"name":"specialEventName","description":"the event to handle as a mutation observer-based event"},{"types":[{"type":"String"}],"name":"mutationNodesProperty","description":"the property of interest in a DOM mutation\n\nThis function provides a simple interface to bind the DOM events interface to the mutation\nobserver interface, by firing an event when a matching mutation is generated by the client\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"mutationNodesProperty","description":"the property of interest in a DOM mutation\n\nThis function provides a simple interface to bind the DOM events interface to the mutation\nobserver interface, by firing an event when a matching mutation is generated by the client\n"},"pathToRoot":"../../../../.."};
</script>
</article>
