...
<div class="breadcrumb">
	...
	<li><a href="can-route.deparam.html">deparam</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>deparam</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L451">Edit on GitHub</a>
				</li>
    ...
    <p>Extract data from a route path.</p>
...
<div class="signature">
  ...
  <p>Extract data from a url, creating an object representing its values.</p>
...
console.log(result.page); // -&gt; &quot;home&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>url</b> <code>{String}</code>: <p>A route fragment to extract data from.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>An object containing the extracted data.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Creates a data object based on the query string passed into it. This is
useful to create an object based on the <code>location.hash</code>.</p>
<pre><code class="language-js">route.deparam(&quot;id=5&amp;type=videos&quot;);
  // -&gt; { id: 5, type: &quot;videos&quot; }
</code></pre>
<p>It's important to make sure the hash or exclamation point is not passed
to <code>route.deparam</code> otherwise it will be included in the first property's
name.</p>
...
<p><code>route.deparam</code> will try and find a matching route and, if it does,
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.deparam","parent":"can-route.static","src":{"line":450,"codeLine":502,"path":"node_modules/can-route/can-route.js"},"description":"Extract data from a route path. ","title":"deparam","signatures":[{"code":"route.deparam(url)","description":"\n\nExtract data from a url, creating an object representing its values.\n\n```js\nroute(\"{page}\");\n\nvar result = route.deparam(\"page=home\");\nconsole.log(result.page); // -> \"home\"\n```\n","params":[{"types":[{"type":"String"}],"name":"url","description":"A route fragment to extract data from."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"An object containing the extracted data.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"url","description":"A route fragment to extract data from."},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"An object containing the extracted data.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
