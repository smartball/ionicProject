...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/methods.toStreamFromProperty.md
	@function can-define-stream.tostreamfromproperty
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.tostreamfromproperty.html">toStreamFromProperty</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStreamFromProperty</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/methods.toStreamFromProperty.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create a stream based on a property</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DefineMap.toStreamFromProperty( property )</code>
  </h2>
  <p>Creates a stream from a property that gets updated whenever the property value changes.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>property</b> <code>{String}</code>: <p>A property name prepended by a dot. '.prop'</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/methods.toStreamFromProperty.md"},"description":"Create a stream based on a property \n","title":"toStreamFromProperty","name":"can-define-stream.tostreamfromproperty","type":"function","parent":"can-define-stream.fns","signatures":[{"code":"DefineMap.toStreamFromProperty( property )","description":"\n\nCreates a stream from a property that gets updated whenever the property value changes.\n\n```js\nvar DefineMap = require('can-define/map/map');\nvar canStream = require(\"can-stream-kefir\");\nvar canDefineStream = require(\"can-define-stream\");\n\nvar Person = DefineMap.extend({\n    name: \"string\",\n    lastValidName: {\n        stream: function() {\n            return this.toStreamFromProperty(\".name\").filter(function(name) { // using propName\n                return name.indexOf(\" \") >= 0;\n            });\n        }\n    }\n});\n\ncanDefineStream(canStream)(Person);\n\nvar me = new Person({name: \"James\"});\n\nme.on(\"lastValidName\", function(lastValid) {});\n\nme.name = \"JamesAtherton\"; //lastValidName -> undefined\nme.name = \"James Atherton\"; //lastValidName -> James Atherton\n```\n","params":[{"types":[{"type":"String"}],"name":"property","description":"A property name prepended by a dot. '.prop'\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"property","description":"A property name prepended by a dot. '.prop'\n"},"_curReturn":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"},"pathToRoot":".."};
</script>
</article>
