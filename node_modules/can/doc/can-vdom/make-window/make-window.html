...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-vdom/make-window/make-window.js
	@module can-vdom/make-window/make-window
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ./make-window/make-window</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../make-document/make-document.html"
...
<div class="breadcrumb">
	...
	<li><a href="make-window.html">./make-window/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>./make-window/make-window</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-vdom/edit/master/make-window/make-window.js">Edit on GitHub</a>
				</li>
    ...
    <p>Exports a function that window called, returns an object that looks like a <code>window</code>.</p>
...
<div class="signature">
  ...
  <p>Creates a document and places it, along with other common browser globals,
on a new object and then returns that object.</p>
...
window.document.body //-&gt; Node
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-vdom.types.window.html" title="An object representing a fake window object.">window</a>}</code>: <p>An object with common browser globals.</p>
</p>
  </div>
...
<div class="signature">
  ...
  <p>Creates a document and places it, along with other common browser globals, on the <code>global</code> object.</p>
<pre><code class="language-js">var makeWindow = require(&quot;can-vdom/make-window/make-window&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>global</b> <code>{<a href="../../can-vdom.types.window.html" title="An object representing a fake window object.">window</a>}</code>: <p>An object that represents the environment's global.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-vdom/make-window/make-window","type":"module","parent":"can-vdom.modules","src":{"line":0,"codeLine":34,"path":"node_modules/can-vdom/make-window/make-window.js"},"description":"\nExports a function that window called, returns an object that looks like a `window`.\n","title":"./make-window/make-window","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeWindow()","description":"\n\nCreates a document and places it, along with other common browser globals,\non a new object and then returns that object.\n\n```js\nvar makeWindow = require(\"can-vdom/make-window/make-window\");\nmakeWindow();\n\nwindow.document.body //-> Node\n```\n","params":[],"returns":{"types":[{"type":"can-vdom.types.window"}],"description":"An object with common browser globals.\n"}},{"code":"makeWindow(global)","description":"\n\nCreates a document and places it, along with other common browser globals, on the `global` object.\n\n```js\nvar makeWindow = require(\"can-vdom/make-window/make-window\");\n\nvar window = makeWindow({});\n```\n","params":[{"types":[{"type":"can-vdom.types.window"}],"name":"global","description":"An object that represents the environment's global."}]}],"_curReturn":{"types":[{"type":"can-vdom.types.window"}],"description":"An object with common browser globals.\n"},"_curParam":{"types":[{"type":"can-vdom.types.window"}],"name":"global","description":"An object that represents the environment's global."},"pathToRoot":"../../.."};
</script>
</article>
