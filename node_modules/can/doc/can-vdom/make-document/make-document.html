...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-vdom/make-document/make-document.js
	@module can-vdom/make-document/make-document
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ./make-document/make-document</title>
...
Safari only supports custom elements that derive from HTMLElement, so you&#x27;ll usually want to use can-element.element.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../make-window/make-window.html"
...
<div class="breadcrumb">
	...
	<li><a href="make-document.html">./make-document/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>./make-document/make-document</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-vdom/edit/master/make-document/make-document.js">Edit on GitHub</a>
				</li>
    ...
    <p>Exports a function that when called, returns a dom-light document object.</p>
...
<div class="signature">
  ...
  <p>Creates a new simple document using <a href="../../can-simple-dom.html" title="can-simple-dom">can-simple-dom</a>. Provides light-weight document needs,
mostly for server-side rendering.</p>
<pre><code class="language-js">var makeDocument = require(&quot;can-vdom/make-document/make-document&quot;);
...
document.body //-&gt; Node
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{can-simple-dom/document/document}</code>: <p>A can-simple-dom document.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-vdom/make-document/make-document","type":"module","parent":"can-vdom.modules","src":{"line":0,"codeLine":22,"path":"node_modules/can-vdom/make-document/make-document.js"},"description":"\nExports a function that when called, returns a dom-light document object.\n","title":"./make-document/make-document","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeDocument()","description":"\n\n\nCreates a new simple document using [can-simple-dom]. Provides light-weight document needs,\nmostly for server-side rendering.\n\n```js\nvar makeDocument = require(\"can-vdom/make-document/make-document\");\nvar document = makeDocument();\n\ndocument.body //-> Node\n```\n","params":[],"returns":{"types":[{"type":"can-simple-dom/document/document"}],"description":"A can-simple-dom document.\n\n"}}],"_curReturn":{"types":[{"type":"can-simple-dom/document/document"}],"description":"A can-simple-dom document.\n\n"},"pathToRoot":"../../.."};
</script>
</article>
