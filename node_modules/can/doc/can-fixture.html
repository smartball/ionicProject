...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture/docs/can-fixture.md
	@module can-fixture
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-fixture</title>
	...
	<ul>
					...
					<li class="
						...
						<a class="typedef"
							...
							title="An object used to match incoming request objects.">
							ajaxSettings
						</a>
					...
					<li class="
						...
						<a class="typedef"
							...
							title="An object with easily digestible values derived from the mock XHR
object.">
							request
						</a>
	...
	<div class="page-type">
		<h1>can-fixture</h1>
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-fixture">
						<img src="https://img.shields.io/badge/npm%20package-1.1.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-fixture" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture/edit/master/docs/can-fixture.md">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>ajaxSettings</b> <code>{<a href="can-fixture/types/ajaxSettings.html" title="An object used to match incoming request objects.">ajaxSettings</a>}</code>: <p>An object that is used to match values on an XHR object, namely the url and method. url can be templated like /todos/{_id}.</p>
</li>
        
          <li><b>requestHandler</b> <code>{<a href="can-fixture.requestHandler.html" title="">requestHandler</a>(<a href="can-fixture/types/request.html" title="An object with easily digestible values derived from the mock XHR
object.">request</a>, <a href="can-fixture.response.html" title="">response</a>, requestHeaders, ajaxSettings)}</code>: <p>Handles the request and provides a response. The next section details this function's use.</p>
</li>
...
<div class="signature">
  ...
  <p>A short hand for creating an <a href="can-fixture/types/ajaxSettings.html" title="An object used to match incoming request objects.">ajaxSettings</a> with a <code>method</code> and <code>url</code>.</p>
...
<div class="signature">
  ...
  <p>A short hand for creating an <a href="can-fixture/types/ajaxSettings.html" title="An object used to match incoming request objects.">ajaxSettings</a> with just a <code>url</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>fixtures</b> <code>{Object&lt;methodAndUrl,String|Object|<a href="can-fixture.requestHandler.html" title="">requestHandler</a>(<a href="can-fixture/types/request.html" title="An object with easily digestible values derived from the mock XHR
object.">request</a>, <a href="can-fixture.response.html" title="">response</a>, requestHeaders, ajaxSettings)|<a href="can-fixture/StoreType.html" title="">Store</a>()&gt;}</code>: <p>A mapping of methodAndUrl to
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>store</b> <code>{<a href="can-fixture/StoreType.html" title="">Store</a>()}</code>: <p>A store produced by <a href="can-fixture.store.html" title="">store</a>.</p>
</li>
