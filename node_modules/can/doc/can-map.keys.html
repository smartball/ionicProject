...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/static.keys.md
	@function can-map.keys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - keys</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-map.keys.html">keys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>keys</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/static.keys.md">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an array of the map's keys.</p>
...
<div class="signature">
  ...
  <pre><code class="language-js">var people = new Map({
        a: 'Alice',
        b: 'Bob',
        e: 'Eve'
});
...
Map.keys(people); // ['a', 'b', 'e']
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>map</b> <code>{<a href="can-map.html" title="Create observable objects.">can-map</a>}</code>: <p>the <code>Map</code> to get the keys from</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>array An array containing the keys from <em>map</em>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/static.keys.md"},"description":"Returns an array of the map's keys. \n","title":"keys","name":"can-map.keys","type":"function","parent":"can-map.static","order":0,"signatures":[{"code":"Map.keys(map)","description":"\n\n```js\nvar people = new Map({\n\t\ta: 'Alice',\n\t\tb: 'Bob',\n\t\te: 'Eve'\n});\n\nMap.keys(people); // ['a', 'b', 'e']\n```\n","params":[{"types":[{"type":"can-map"}],"name":"map","description":"the `Map` to get the keys from"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"array An array containing the keys from _map_.\n"}}],"_curParam":{"types":[{"type":"can-map"}],"name":"map","description":"the `Map` to get the keys from"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"array An array containing the keys from _map_.\n"},"pathToRoot":".."};
</script>
</article>
