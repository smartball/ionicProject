...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-legacy/docs/can-map-plugin.md
	@function can-validate-legacy.map-plugin
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Map Plugin</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate-legacy.map-plugin.html">Map Plugin</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Map Plugin</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-legacy/edit/master/docs/can-map-plugin.md">Edit on GitHub</a>
				</li>
    ...
    <p>The can.Map plugin will works alongside can.Map.define to add validation to properties on a can.Map. Importing the plugin, validation library, and a shim will
allow the ability to dynamically check values against validation configuration. errors
are stored on the can.Map instance and are observable.</p>
...
<p>Import the validation library, validate plugin and a shim to immediately use the
can.Map.validate plugin.</p>
<pre><code class="language-js">import &quot;validatejs&quot;;
import &quot;can-validate/map/validate&quot;;
import &quot;can-validate/shims/validatejs.shim&quot;;
</code></pre>
<h2>Usage</h2>
<p>Using can-validate Map plugin only requires two extra actions,</p>
<ul>
<li>add a validate object to the desired property</li>
<li>add a check in the view for the errors object</li>
</ul>
<p>The validate object depends on the desired valdiation library. The examples
below use ValidateJS.</p>
<pre><code class="language-js">var ViewModel = can.Map.extend({
  define: {
    name: {
      value: &quot;&quot;,
      validate: {
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-legacy/docs/can-map-plugin.md"},"description":"The can.Map plugin will works alongside can.Map.define to add validation to properties on a can.Map. Importing the plugin, validation library, and a shim will\nallow the ability to dynamically check values against validation configuration. errors\nare stored on the can.Map instance and are observable.\n\n","title":"Map Plugin","name":"can-validate-legacy.map-plugin","type":"function","parent":"can-validate-legacy","comment":" ","pathToRoot":".."};
</script>
</article>
