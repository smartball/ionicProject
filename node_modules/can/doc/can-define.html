			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-define">
						<img src="https://img.shields.io/badge/npm%20package-1.5.3-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
all of <a href="can-event.html" title="Add event functionality into your objects.
The canEvent object provides a number of methods for handling events in objects. This functionality is best used by mixing the canEvent object into an object or prototype. However, event listeners can still be used even on objects that don't include canEvent.
All methods provided by canEvent assume that they are mixed into an object -- this should be the object dispatching the events.">can-event</a>'s methods.</p>
</li>
...
<pre><code class="language-js">var person = new Person(&quot;Justin&quot;, &quot;Meyer&quot;);
person.first    //-&gt; &quot;Justin&quot;
person.last     //-&gt; &quot;Meyer&quot;
...
<p>The observable properties call <a href="can-observation.add.html" title="Signals that an object's property is being observed, so that any functions
that are recording observations will see that this object is a dependency.">Observation.add</a> so they can be observed by
