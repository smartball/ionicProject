...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-legacy/docs/can-validate-legacy-core.md
	@function can-validate-legacy.core
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-validate-legacy.core.html">Core</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Core</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-legacy/edit/master/docs/can-validate-legacy-core.md">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an object with helpful methods that will call a validation library to validate
values.</p>
<p>How each method behaves depends on the chosen shim and validation library.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>validate.register(LIBRARY_NAME, MAP_OF_METHODS)</code>
  </h2>
  <p>The <code>MAP_OF_METHODS</code> consists of three methods that define the three main uses cases, validate many, validate one, and check one.</p>
<h2>Demo</h2>
...
<pre><code class="language-javascript">var validate = require('can-validate-legacy');
// Validation library
require('validate.js');
// Shim for library
require('can-validate-legacy/shims/validatejs');
</code></pre>
<p>The key initializing part is the shim. The shim will define how the can-validate methods
behave and will also define the necessary parameters.</p>
<h2>Registering a Shim</h2>
<p>If a new shim is needed, it must first be register itself with can-validate.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-legacy/docs/can-validate-legacy-core.md"},"description":"  Returns an object with helpful methods that will call a validation library to validate\n values.\n\n How each method behaves depends on the chosen shim and validation library.\n\n","title":"Core","name":"can-validate-legacy.core","type":"function","parent":"can-validate-legacy","comment":" ","signatures":[{"code":"validate.register(LIBRARY_NAME, MAP_OF_METHODS)","description":"\n\nThe `MAP_OF_METHODS` consists of three methods that define the three main uses cases, validate many, validate one, and check one.\n\n## Demo\n","params":[]}],"pathToRoot":".."};
</script>
</article>
