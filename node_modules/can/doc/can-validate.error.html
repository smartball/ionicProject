...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate/docs/error-object.md
	@typedef can-validate.error
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Error</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate.error.html">Error</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Error</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate/edit/master/docs/error-object.md">Edit on GitHub</a>
				</li>
    ...
    <p>An object that defines a validation failure.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>message</b> <code>{string}</code>:
        <p>A reason why value is in an invalid state.</p>
<pre><code class="language-javascript">var error = { &quot;message&quot;: &quot;is required&quot;};
</code></pre>

      </li>
    
      <li>
        <b>related</b> <code>{string|array}</code>:
        <p>Key names that are related to triggering the
invalid state of the current value.</p>
<pre><code class="language-json">{ &quot;message&quot;: &quot;is required&quot;, &quot;related&quot;: &quot;age&quot;}
</code></pre>
<pre><code class="language-json">{ &quot;message&quot;: &quot;is required&quot;, &quot;related&quot;: [&quot;billingZip&quot;, &quot;residenceZip&quot;]}
</code></pre>
<p>If no value is passed, the wild card value (<code>*</code>) is used internally for grouping.</p>
    ...
    <section class="body">
    <h2>Wild card</h2>
<p>It is common to group errors by the property that triggered the error state. In
some cases, it possible to group errors where one error is not identified with
a property.</p>
<pre><code class="language-javascript">var errors = [
    { message: 'is required'},
    {
...
<p>In this situation, the first object in the array is not identified with a property.
This item will have a <code>related</code> assumed to be <code>*</code>. It possible for this error item
to be grouped with other &quot;orphaned&quot; errors.</p>
<pre><code class="language-javascript">var errors = [
    {
        message: 'is required',
        related: '*'
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate/docs/error-object.md"},"description":"\nAn object that defines a validation failure.\n","type":"typedef","title":"Error","types":[{"type":"object","options":[{"name":"message","description":"A reason why value is in an invalid state.\n\n```javascript\nvar error = { \"message\": \"is required\"};\n```\n","types":[{"type":"string"}]},{"name":"related","description":"Key names that are related to triggering the\ninvalid state of the current value.\n\n```json\n{ \"message\": \"is required\", \"related\": \"age\"}\n```\n\n```json\n{ \"message\": \"is required\", \"related\": [\"billingZip\", \"residenceZip\"]}\n```\n\nIf no value is passed, the wild card value (`*`) is used internally for grouping.\n","types":[{"type":"string"},{"type":"array"}],"optional":true,"defaultValue":"*"}]}],"name":"can-validate.error","parent":"can-validate.types","comment":" ","pathToRoot":".."};
</script>
</article>
