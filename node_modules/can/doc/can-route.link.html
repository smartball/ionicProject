...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-route/can-route.js
	@function can-route.link
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - link</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-route.link.html">link</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>link</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L672">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a string representation of an anchor link using data and the registered routes.</p>
...
<div class="signature">
  ...
  <p>Make an anchor tag (<code>&lt;A&gt;</code>) that when clicked on will update can-route's
properties to match those in <code>data</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>innerText</b> <code>{Object}</code>: <p>The text inside the link.</p>
</li>
        
          <li><b>data</b> <code>{Object}</code>: <p>The data to populate the route with.</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>Properties for the anchor other than <code>href</code>.</p>
</li>
        
          <li><b>merge</b> <code>{Boolean}</code>: <p>Whether the given options should be merged into the current state of the route.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>A string with an anchor tag that points to the populated route.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Creates and returns an anchor tag with an href of the route
attributes passed into it, as well as any properties desired
for the tag.</p>
<pre><code class="language-js">route.link( &quot;My videos&quot;, { type: &quot;videos&quot; }, {}, false )
...
<pre><code class="language-js">route.link( &quot;My videos&quot;, { type: &quot;videos&quot; },
  { className: &quot;new&quot; }, false )
...
the route options passed into <code>canRoute.link</code> will be passed into the
current ones.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.link","parent":"can-route.static","src":{"line":671,"codeLine":721,"path":"node_modules/can-route/can-route.js"},"description":"Creates a string representation of an anchor link using data and the registered routes.\n","title":"link","signatures":[{"code":"route.link(innerText, data, props [, merge])","description":"\n\nMake an anchor tag (`<A>`) that when clicked on will update can-route's\nproperties to match those in `data`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"innerText","description":"The text inside the link."},{"types":[{"type":"Object","options":[]}],"name":"data","description":"The data to populate the route with."},{"types":[{"type":"Object","options":[]}],"name":"props","description":"Properties for the anchor other than `href`."},{"types":[{"type":"Boolean"}],"optional":true,"name":"merge","description":"Whether the given options should be merged into the current state of the route."}],"returns":{"types":[{"type":"String"}],"description":"A string with an anchor tag that points to the populated route.\n"}}],"_curParam":{"types":[{"type":"Boolean"}],"optional":true,"name":"merge","description":"Whether the given options should be merged into the current state of the route."},"_curReturn":{"types":[{"type":"String"}],"description":"A string with an anchor tag that points to the populated route.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
