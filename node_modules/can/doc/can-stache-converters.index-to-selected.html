...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/index-to-selected.md
	@function can-stache-converters.index-to-selected
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - index-to-selected</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.index-to-selected.html">index-to-selected</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>index-to-selected</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/index-to-selected.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that binds to a <code>&lt;select&gt;</code> value in order to two-way bind a selected item from a list to the selected item's index as a viewModel property.</p>
...
<div class="signature">
  ...
  <p>When the getter is called, returns the index of the passed in item (which should be a <a href="can-compute.html" title="Create an observable value.">can-compute</a> from the provided list.</p>
<p>When the setter is called, takes the selected index value and finds the item from the list with that index and passes that to set the compute’s value.</p>
<pre><code class="language-handlebars">&lt;select {($value)}=&quot;index-to-selected(~person, people)&quot;&gt;
...
&lt;/select&gt;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>item</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute whose item is in the list.</p>
</li>
        
          <li><b>list</b> <code>{<a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>|<a href="can-list.html" title="">can-list</a>|Array}</code>: <p>A list used to find the <code>item</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be two-way bound to the select’s value.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>This will most often be used in conjunction with a <code>&lt;select&gt;</code> element and a bunch of options.</p>
<p>The provided <code>item</code> <strong>must</strong> be a <a href="can-compute.html" title="Create an observable value.">can-compute</a> so that its value can be set when the user selects own of the dropdown options.</p>
<p>You <strong>must</strong> use the indexes from the list as your <code>&lt;option&gt;</code> values. This is how it looks up items in the list both in the getter and the setter.</p>
