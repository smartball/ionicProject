...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-callbacks/docs/tagData.md
	@typedef can-view-callbacks.tagData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - tagData</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-callbacks.tagData.html">tagData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>tagData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-callbacks/edit/master/docs/tagData.md">Edit on GitHub</a>
				</li>
    ...
    <p>The data passed to <a href="can-view-callbacks.tag.html" title="">tag</a>.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>subtemplate</b> <code>{<a href="can-stache.renderer.html" title="A function returned by can-stache that renders a template into an html documentFragment.">renderer</a>(data, helpers, <a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">nodeList</a>)}</code>:
        <p>If the special tag has content,
the content can be rendered with subtemplate.  For example:</p>
<pre><code class="language-js">callbacks.tag(&quot;foo-bar&quot;, function(el, tagData){
  ...
  $(el).html(frag);
      ...
      <li>
        ...
        <p>The scope of the element.</p>

      </li>
    
      <li>
        <b>options</b> <code>{<a href="can-view-scope.Options.html" title="">Options</a>}</code>:
        <p>The mustache helpers and other non-data values passed to the template.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-callbacks/docs/tagData.md"},"description":"\nThe data passed to [can-view-callbacks.tag].\n","type":"typedef","title":"tagData","types":[{"type":"Object","options":[{"name":"subtemplate","description":"If the special tag has content,\nthe content can be rendered with subtemplate.  For example:\n\n```js\ncallbacks.tag(\"foo-bar\", function(el, tagData){\n  var frag = tagData.subtemplate(tagData.scope, tagData.options);\n  $(el).html(frag);\n});\n```\n","types":[{"type":"can-stache.renderer"}],"optional":true},{"name":"scope","description":"The scope of the element.  \n","types":[{"type":"can-view-scope"}]},{"name":"options","description":"The mustache helpers and other non-data values passed to the template.\n","types":[{"type":"can-view-scope.Options"}]}],"description":"\n"}],"name":"can-view-callbacks.tagData","parent":"can-view-callbacks/types","pathToRoot":".."};
</script>
</article>
