...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-import/docs/from.md
	@function can-view-import.from
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - from</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-import.from.html">from</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>from</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-import/edit/master/docs/from.md">Edit on GitHub</a>
				</li>
    ...
    <p>Set the module name that will be imported into the template.</p>
...
<div class="signature">
  ...
  <p>Passes MODULE_NAME to <a href="can-util/js/import/import.html" title="can-util/js/import/import">import</a> and sets the <a href="can-view-import.html" title="">&lt;can-import&gt;</a>'s viewModel to be the returned Promise.</p>
<pre><code class="language-js">&lt;can-import from=&quot;bootstrap/bootstrap.css&quot; /&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>MODULE_NAME</b> <code>{String}</code>: <p>The name of the module to import.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-import/docs/from.md"},"description":"Set the module name that will be imported into the template. \n","title":"from","name":"can-view-import.from","type":"function","parent":"can-view-import.attributes","signatures":[{"code":"from=\"MODULE_NAME\"","description":"\n\nPasses MODULE_NAME to [can-util/js/import/import] and sets the [can-view-import <can-import>]'s viewModel to be the returned Promise.\n\n```js\n<can-import from=\"bootstrap/bootstrap.css\" />\n```\n","params":[{"types":[{"type":"String"}],"name":"MODULE_NAME","description":"The name of the module to import.\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"MODULE_NAME","description":"The name of the module to import.\n"},"pathToRoot":".."};
</script>
</article>
