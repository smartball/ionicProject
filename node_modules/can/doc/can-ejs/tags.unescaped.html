...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-ejs/doc/tags.unescaped.md
	@function can-ejs/tags.unescaped
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="tags.unescaped.html">&lt;%== CODE %&gt;</a></li>
	...
	<div class="page-type">
		<h1>&lt;%== CODE %&gt;</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-ejs/edit/master/doc/tags.unescaped.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Runs JS Code and writes the <em>unescaped</em> result into the result of the template.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-ejs/doc/tags.unescaped.md"},"description":"\n","title":"<%== CODE %>","name":"can-ejs/tags.unescaped","type":"function","parent":"can-ejs/tags","order":2,"signatures":[{"code":"<%== CODE %>","description":"\n\nRuns JS Code and writes the _unescaped_ result into the result of the template.\n\nThe following results in \"my favorite element is <B>B</B>.\". Using `<%==` is useful\nfor sub-templates.\n\n         <div>my favorite element is <%== '<B>B</B>' %>.</div>\n","params":[]}],"pathToRoot":"../.."};
</script>
</article>
