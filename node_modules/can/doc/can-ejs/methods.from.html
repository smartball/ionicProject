...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-ejs/doc/from.md
	@function can-ejs/methods.from
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="methods.from.html">from</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>from</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-ejs/edit/master/doc/from.md">Edit on GitHub</a>
				</li>
    ...
    <p>Return a template loaded from an element.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>ejs.from(id)</code>
  </h2>
  <p>Load a template from an HTML element (usually a <code>&lt;script&gt;</code> element)
specified by id.  This is used typically for demo purposes.</p>
<p>For example, with a <code>&lt;script&gt;</code> tag as follows in your HTML:</p>
<pre><code>&lt;script type='text/ejs' id='my-template'&gt;
&lt;h1&gt;&lt;%= message %&gt;&lt;/h1&gt;
&lt;/script&gt;
</code></pre>
<p>Load and render that template like:</p>
<pre><code>var template = ejs.from(&quot;my-template&quot;);
template({message: &quot;Hello There!&quot;});
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>id</b> <code>{String}</code>: <p>The id of the element, whose <code>innerHTML</code> will be used to create a template.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function}</code>: <p>A renderer function that will render the
template.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-ejs/doc/from.md"},"description":"Return a template loaded from an element. \n","title":"from","name":"can-ejs/methods.from","type":"function","parent":"can-ejs/methods","signatures":[{"code":"ejs.from(id)","description":"\n\nLoad a template from an HTML element (usually a `<script>` element)\nspecified by id.  This is used typically for demo purposes.\n\nFor example, with a `<script>` tag as follows in your HTML:\n\n```\n<script type='text/ejs' id='my-template'>\n<h1><%= message %></h1>\n<\/script>\n```\n\nLoad and render that template like:\n\n```\nvar template = ejs.from(\"my-template\");\ntemplate({message: \"Hello There!\"});\n```\n\n","params":[{"types":[{"type":"String"}],"name":"id","description":"The id of the element, whose `innerHTML` will be used to create a template."}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A renderer function that will render the\ntemplate.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"id","description":"The id of the element, whose `innerHTML` will be used to create a template."},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"description":"A renderer function that will render the\ntemplate.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
