...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/types.Meta.md
	@typedef can-view-scope/Meta
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Meta</title>
	...
	<div class="page-type">
		<h1>Meta</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/types.Meta.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Specify special behavior of a scope.</p>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>notContext</b> <code>{Boolean}</code>:
        <p>The context should not be reference-able with <code>./</code> or <code>../</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-scope/docs/types.Meta.md"},"description":"\n","type":"typedef","title":"Meta","types":[{"type":"Object","options":[{"name":"notContext","description":"The context should not be reference-able with `./` or `../`.\n","types":[{"type":"Boolean"}]}],"description":"\n\n  Specify special behavior of a scope.\n\n"}],"name":"can-view-scope/Meta","parent":"can-view-scope.types","pathToRoot":"../.."};
</script>
</article>
