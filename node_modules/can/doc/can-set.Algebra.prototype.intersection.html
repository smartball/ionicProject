...
<head>
	<meta charset="utf-8">
	<title>CanJS - intersection</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.Algebra.prototype.intersection.html">intersection</a></li>
	...
	<div class="page-type">
		<h1>intersection</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/set-core.js#L418">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>algebra.intersection(a, b)</code>
  </h2>
  <p>Returns a set that represents the intersection of sets <em>A</em> and <em>B</em> (<em>A</em> ∩ <em>B</em>).</p>
<pre><code class="language-js">algebra.intersection(
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>a</b> <code>{[}</code>: <p>A set.</p>
</li>
        
          <li><b>b</b> <code>{[}</code>: <p>A set.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-set/Set.html" title="An object that represents a set of data.">Set</a>|Boolean}</code>: <p>If an object is returned, it
represents the intersection of sets <em>A</em> and <em>B</em> (<em>A</em> ∩ <em>B</em>).</p>
<p>If <code>true</code> is returned, that means that an intersection exists, but no set object
can be returned that represents that set.</p>
<p>If <code>false</code> is returned, that means there is intersection.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.Algebra.prototype.intersection","parent":"can-set.Algebra.prototype","src":{"line":417,"codeLine":442,"path":"node_modules/can-set/src/set-core.js"},"description":"\n","title":"intersection","signatures":[{"code":"algebra.intersection(a, b)","description":"\n\nReturns a set that represents the intersection of sets _A_ and _B_ (_A_ ∩ _B_).\n\n```js\nalgebra.intersection(\n  {completed: true, due: \"tomorrow\"},\n  {completed: true, type: \"critical\"},\n) //-> {completed: true, due: \"tomorrow\", type: \"critical\"}\n```\n","params":[{"types":[{"type":"["}],"name":"a","description":"A set."},{"types":[{"type":"["}],"name":"b","description":"A set."}],"returns":{"types":[{"type":"can-set/Set"},{"type":"Boolean"}],"description":"If an object is returned, it\nrepresents the intersection of sets _A_ and _B_ (_A_ ∩ _B_).\n\nIf `true` is returned, that means that an intersection exists, but no set object\ncan be returned that represents that set.\n\nIf `false` is returned, that means there is intersection.\n "}}],"_curParam":{"types":[{"type":"["}],"name":"b","description":"A set."},"_curReturn":{"types":[{"type":"can-set/Set"},{"type":"Boolean"}],"description":"If an object is returned, it\nrepresents the intersection of sets _A_ and _B_ (_A_ ∩ _B_).\n\nIf `true` is returned, that means that an intersection exists, but no set object\ncan be returned that represents that set.\n\nIf `false` is returned, that means there is intersection.\n "},"pathToRoot":".."};
</script>
</article>
