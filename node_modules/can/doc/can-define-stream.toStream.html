...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-stream/docs/methods.toStream.md
	@function can-define-stream.toStream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.toStream.html">toStream</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toStream</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-stream/edit/master/docs/methods.toStream.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provide a shorthand for creating a stream on properties and/or events.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DefineMap.toStream( propAndOrEvent[,event] )</code>
  </h2>
  <p>Creates a stream that gets updated whenever the property value changes or event is triggered.</p>
...
me.name = &quot;James Atherton&quot;; //lastValidName -&gt; James Atherton
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>prop</b> <code>{String}</code>: <p>A property name prepended by a dot '.prop'</p>
</li>
        
          <li><b>event</b> <code>{String}</code>: <p>An event name 'event'</p>
</li>
        
          <li><b>propAndEvent</b> <code>{String}</code>: <p>A property name prepended by a dot follow by an event name seperated by a space '.prop event'</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Stream}</code>: <p>A <a href="can-stream.html" title="Create useful stream methods from a minimal stream wrapper implementation.">can-stream</a> stream.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream/docs/methods.toStream.md"},"description":"Provide a shorthand for creating a stream on properties and/or events. \n","title":"toStream","name":"can-define-stream.toStream","type":"function","parent":"can-define-stream.fns","signatures":[{"code":"DefineMap.toStream( propAndOrEvent[,event] )","description":"\n\nCreates a stream that gets updated whenever the property value changes or event is triggered.\n\n```js\nvar DefineMap = require('can-define/map/map');\nvar canStream = require(\"can-stream-kefir\");\nvar canDefineStream = require(\"can-define-stream\");\n\nvar Person = DefineMap.extend({\n    name: \"string\",\n    lastValidName: {\n        stream: function() {\n            return this.toStream(\".name\").filter(function(name) { // using propName\n                return name.indexOf(\" \") >= 0;\n            });\n        }\n    }\n});\n\ncanDefineStream(canStream)(Person);\n\nvar me = new Person({name: \"James\"});\n\nme.on(\"lastValidName\", function(lastValid) {});\n\nme.name = \"JamesAtherton\"; //lastValidName -> undefined\nme.name = \"James Atherton\"; //lastValidName -> James Atherton\n```\n","params":[{"types":[{"type":"String"}],"name":"prop","description":"A property name prepended by a dot '.prop'\n"},{"types":[{"type":"String"}],"name":"event","description":"An event name 'event'\n"},{"types":[{"type":"String"}],"name":"propAndEvent","description":"A property name prepended by a dot follow by an event name seperated by a space '.prop event'\n"}],"returns":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"propAndEvent","description":"A property name prepended by a dot follow by an event name seperated by a space '.prop event'\n"},"_curReturn":{"types":[{"type":"Stream"}],"description":"A [can-stream] stream.\n"},"pathToRoot":".."};
</script>
</article>
