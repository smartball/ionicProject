...
<div class="breadcrumb">
	...
	<li><a href="can-event.on.html">on</a></li>
	...
	<div class="page-type">
		<h1>on</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L188">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event.on","parent":"can-event.static","src":{"line":187,"codeLine":200,"path":"node_modules/can-event/can-event.js"},"description":"","title":"on","signatures":[{"code":"obj.on(event, handler)","description":"\n\nAdd a basic event listener to an object.\n\nThis is an alias of [can-event.addEventListener addEventListener].\n","params":[]},{"code":"can-event.on.call(obj, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n ","params":[]}],"pathToRoot":".."};
</script>
</article>
