...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/removeEventListene.md
	@function can-compute.computed.removeEventListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.computed.removeEventListener.html">removeEventListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>removeEventListener</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/removeEventListene.md">Edit on GitHub</a>
				</li>
    ...
    <p>Listen to when a compute changes value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>compute.removeEventListener(eventType, handler)</code>
  </h2>
...
age(34);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>The name of the event to bind on, usually <code>change</code>.</p>
</li>
        
          <li><b>handler</b> <code>{function(event, args...)}</code>: <p>The handler to be called when this type of event fires.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>(newVal)}</code>: <p>The compute instance.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-compute/docs/removeEventListene.md"},"description":"\nListen to when a compute changes value.\n","title":"removeEventListener","name":"can-compute.computed.removeEventListener","type":"function","parent":"can-compute/computed/methods","signatures":[{"code":"compute.removeEventListener(eventType, handler)","description":"\n\n```js\nvar age = compute(33);\n\nage.removeEventListener('change', function(ev, newVal, oldVal){\n\tev //-> {type: \"change\", batchNum: 5}\n\tnewVal //-> 34\n\toldVal //-> 33\n});\n\nage(34);\n```\n","params":[{"types":[{"type":"String"}],"name":"eventType","description":"The name of the event to bind on, usually `change`.\n"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]},{"variable":true,"types":[{"type":"args"}]}]}],"name":"handler","description":"The handler to be called when this type of event fires.\n"}],"returns":{"types":[{"type":"can-compute.computed"}],"description":"The compute instance.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"event"}]},{"variable":true,"types":[{"type":"args"}]}]}],"name":"handler","description":"The handler to be called when this type of event fires.\n"},"_curReturn":{"types":[{"type":"can-compute.computed"}],"description":"The compute instance.\n"},"pathToRoot":".."};
</script>
</article>
