...
<!--####################################################################
	...
	@function can-reflect.isValueLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isValueLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isValueLike.html">isValueLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isValueLike</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L178">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value represents a single value (as opposed to several values).</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isValueLike(obj)</code>
  </h2>
  <p>Return <code>true</code> if <code>obj</code> is a primitive or implements <a href="can-symbol/symbols/getValue.html" title="Defines a function that returns the object's current value when called."><code>@can.getValue</code></a>,
<code>false</code> otherwise.</p>
<pre><code>canReflect.isValueLike(null); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>maybe a primitive or an object that yields a value</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isValueLike","parent":"can-reflect/type","src":{"line":177,"codeLine":201,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value represents a single value (as opposed to several values). \n","title":"isValueLike","signatures":[{"code":"isValueLike(obj)","description":"\n\nReturn `true` if `obj` is a primitive or implements [can-symbol/symbols/getValue `@can.getValue`],\n`false` otherwise.\n\n```\ncanReflect.isValueLike(null); // -> true\ncanReflect.isValueLike({}); // -> false\ncanReflect.isValueLike(function() {}); // -> false\ncanReflect.isValueLike({ [canSymbol.for(\"can.isValueLike\")]: true}); // -> true\ncanReflect.isValueLike({ [canSymbol.for(\"can.getValue\")]: function() {} }); // -> true\ncanReflect.isValueLike(canCompute()); // -> true\ncanReflect.isValueLike(new DefineMap()); // -> false\n\n```\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"maybe a primitive or an object that yields a value"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"obj","description":"maybe a primitive or an object that yields a value"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
