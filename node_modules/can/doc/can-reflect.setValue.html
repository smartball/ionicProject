...
<!--####################################################################
	...
	@function can-reflect.setValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - setValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.setValue.html">setValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>setValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/get-set/get-set.js#L148">Edit on GitHub</a>
				</li>
    ...
    <p>Set the value of a mutable object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>setValue(obj, value)</code>
  </h2>
  <p>Set the value of a Value-like object <code>obj</code> to the value <code>value</code>.  <code>obj</code> <em>must</em> implement
<a href="can-symbol/symbols/setValue.html" title="Define a function that sets the object's value.">@@can.setValue</a> to be used with <code>canReflect.setValue</code>.
Map-like objects may want to implement <code>@@can.setValue</code> to merge objects of properties
into themselves.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{*}</code>: <p>the value to set for the object</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.setValue","parent":"can-reflect/get-set","src":{"line":147,"codeLine":172,"path":"node_modules/can-reflect/reflections/get-set/get-set.js"},"description":"Set the value of a mutable object. \n","title":"setValue","signatures":[{"code":"setValue(obj, value)","description":"\n\nSet the value of a Value-like object `obj` to the value `value`.  `obj` *must* implement\n[can-symbol/symbols/setValue @@can.setValue] to be used with `canReflect.setValue`.\nMap-like objects may want to implement `@@can.setValue` to merge objects of properties\ninto themselves.\n\n```\nvar compute = canCompute(\"foo\");\nvar plain = {};\n\ncanReflect.setValue(compute, \"bar\");\ncompute(); // -> bar\n\ncanReflect.setValue(plain, { quux: \"thud\" }); // throws \"can-reflect.setValue - Can not set value.\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to set on"},{"types":[{"type":"*"}],"name":"value","description":"the value to set for the object\n "}]}],"_curParam":{"types":[{"type":"*"}],"name":"value","description":"the value to set for the object\n "},"pathToRoot":".."};
</script>
</article>
