...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-interface/can-validate-interface.md
	@module can-validate-interface
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-validate-interface</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-validate-interface.html">can-validate-interface</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-validate-interface</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-validate-interface">
						<img src="https://img.shields.io/badge/npm%20package-0.1.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-validate-interface" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-interface/edit/master/can-validate-interface.md">Edit on GitHub</a>
				</li>
    ...
    <p><code>can-validate-interface</code> provides simple property existence validation. Use to prevent errors resulting from missing properties on input objects.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>makeInterfaceValidator(propertyArrays)</code>
  </h2>
  <p>Get a function that validates a given object for the provided properties:</p>
<pre><code class="language-js">var makeInterfaceValidator = require(&quot;can-validate-interface&quot;);
...
// errors == undefined
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>propertyArrays</b> <code>{Array&lt;String,Array&lt;String&gt;&gt;}</code>: <p>Property names and arrays of property names to validate existence of</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{function(Object)}</code>: <p>Function that validates an object for properties in propertyArrays and returns an error record or undefined if no properties are missing.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-interface/can-validate-interface.md"},"description":"`can-validate-interface` provides simple property existence validation. Use to prevent errors resulting from missing properties on input objects.\n\n\n","type":"module","title":"","types":[{"type":"Object","options":[]}],"name":"can-validate-interface","parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-validate-interface/issues"},"bundleDependencies":false,"dependencies":{},"deprecated":false,"description":"Utility to validate property existence. Test for missing properties before they cause errors later.","devDependencies":{"can-connect":"^1.3.11","chai":"^3.5.0","mocha":"^3.3.0","sinon":"^2.2.0","steal-tools":"^1.3.5"},"homepage":"https://github.com/canjs/can-validate-interface#readme","keywords":["interface","canjs","can","can-validate"],"license":"MIT","main":"index.js","name":"can-validate-interface","repository":{"type":"git","url":"git://github.com/canjs/can-validate-interface.git"},"scripts":{"build":"node build.js","postpublish":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"mocha","version":"git commit -am \"Update version number\" && git checkout -b release && git add -f dist/"},"version":"0.1.0"},"signatures":[{"code":"makeInterfaceValidator(propertyArrays)","description":"\n\nGet a function that validates a given object for the provided properties:\n\n```js\nvar makeInterfaceValidator = require(\"can-validate-interface\");\nvar dataMethods = [\"create\",\"read\",\"update\",\"delete\"];\nvar daoValidator = makeInterfaceValidator([dataMethods, \"id\"]);\n\nvar dao = {\n    create: function() {},\n    read: function() {},\n    update: function() {},\n    delete: function() {}\n};\n\nvar errors = daoValidator(dao);\n// errors == {message:\"missing expected properties\", related: [\"id\"]}\n\ndao.id = 10;\n\nerrors = daoValidator(dao);\n// errors == undefined\n```\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"String"}]},{"types":[{"type":"Array","template":[{"types":[{"type":"String"}]}]}]}]}],"name":"propertyArrays","description":"Property names and arrays of property names to validate existence of\n"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"Object","options":[{"name":"{"}]}]},"params":[{"types":[{"type":"Object","options":[{"name":"*"}]}]}]}],"description":"Function that validates an object for properties in propertyArrays and returns an error record or undefined if no properties are missing."}}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"String"}]},{"types":[{"type":"Array","template":[{"types":[{"type":"String"}]}]}]}]}],"name":"propertyArrays","description":"Property names and arrays of property names to validate existence of\n"},"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"Object","options":[{"name":"{"}]}]},"params":[{"types":[{"type":"Object","options":[{"name":"*"}]}]}]}],"description":"Function that validates an object for properties in propertyArrays and returns an error record or undefined if no properties are missing."},"pathToRoot":".."};
</script>
</article>
