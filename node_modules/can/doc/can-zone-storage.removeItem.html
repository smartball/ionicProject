...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.methods.removeItem.md
	@function can-zone-storage.removeItem
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-zone-storage.removeItem</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.removeItem.html">can-zone-storage.removeItem</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-zone-storage.removeItem</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.methods.removeItem.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>removeItem(key, value)</code>
  </h2>
  <p>Removes keyed data from the current data store.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key name that will be deleted from the data store.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone-storage/docs/can-zone-storage.methods.removeItem.md"},"description":"\n","title":"","name":"can-zone-storage.removeItem","type":"function","parent":"can-zone-storage.methods","signatures":[{"code":"removeItem(key, value)","description":"\n\nRemoves keyed data from the current data store.\n\n```js\nvar zoneStorage = require(\"can-zone-storage\");\n\nzoneStorage.removeItem('key-name');\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The key name that will be deleted from the data store.\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The key name that will be deleted from the data store.\n"},"pathToRoot":".."};
</script>
</article>
