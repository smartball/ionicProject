...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/addEventListener.md
	@function can-compute.computed.addEventListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addEventListener</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.computed.addEventListener.html">addEventListener</a></li>
	...
	<div class="page-type">
		<h1>addEventListener</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/addEventListener.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>compute.addEventListener(eventType, handler)</code>
  </h2>
