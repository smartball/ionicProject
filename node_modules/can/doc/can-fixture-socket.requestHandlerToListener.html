...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-fixture-socket/src/store.js
	@function can-fixture-socket.requestHandlerToListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - requestHandlerToListener</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.requestHandlerToListener.html">requestHandlerToListener</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>requestHandlerToListener</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/src/store.js#L3">Edit on GitHub</a>
				</li>
    ...
    <p>Transforms XHR request handler into socket event listener.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>requestHandlerToListener( reqHandler )</code>
  </h2>
  <p>Transforms request handler that expects two arguments <code>request</code> and <code>response</code> into socket event listener.</p>
<pre><code class="language-js">server.on(&quot;news find&quot;, requestHandlerToListener( fixtureStore.getListData ));
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>reqHandler</b> <code>{function}</code>: <p>A request handler, e.g. <a href="can-fixture/StoreType.prototype.getListData.html" title="">getListData</a>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Fixture <a href="can-fixture.store.html" title="">store</a> methods expect two arguments <code>req</code> and <code>res</code> and work like this:</p>
<ul>
<li>grab query from <code>req.data</code>;</li>
<li>on error call <code>res( 403, err )</code>;</li>
<li>on success call <code>res( data )</code>.</li>
</ul>
<p>The format of the returned data is:</p>
<ul>
<li>for [can-fixture/StoreType.prototype.getDataList]: {count: <number>, limit: <number>, offset: <number> , data: [{...},{...}, ...]}</li>
<li>for <a href="can-fixture/StoreType.prototype.getData.html" title="">getData</a>: the item object.</li>
</ul>
<p>We can use the helper to transform fixture store methods into event listeners:</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-fixture-socket.requestHandlerToListener","parent":"can-fixture-socket.properties","src":{"line":2,"codeLine":50,"path":"node_modules/can-fixture-socket/src/store.js"},"description":"\nTransforms XHR request handler into socket event listener.\n","title":"requestHandlerToListener","signatures":[{"code":"requestHandlerToListener( reqHandler )","description":"\n\nTransforms request handler that expects two arguments `request` and `response` into socket event listener.\n\n```js\nserver.on(\"news find\", requestHandlerToListener( fixtureStore.getListData ));\n```\n    ","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"reqHandler","description":"A request handler, e.g. [can-fixture/StoreType.prototype.getListData]."}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"reqHandler","description":"A request handler, e.g. [can-fixture/StoreType.prototype.getListData]."},"returns":"{can-fixture-store.socket-event-listener}","comment":" ","pathToRoot":".."};
</script>
</article>
