...
<!--####################################################################
	...
	@function can-set.props.dotNotation
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - dotNotation</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.props.dotNotation.html">dotNotation</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>dotNotation</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L497">Edit on GitHub</a>
				</li>
    ...
    <p>Supports MongoDB-style 'dot notation' properties.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>set.props.dotNotation(dotProperty)</code>
  </h2>
  <p>Defines a property that specifies a MongoDB-style nested property match.
For example, a set property of &quot;address.city&quot; matches against the value of the nested <code>{address: {city}}</code> value.</p>
<pre><code>set.props.dotNotation(&quot;address.city&quot;)
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>dotProperty</b> <code>{String}</code>: <p>The MongoDB-style nested property name</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.dotNotation","parent":"can-set.props","src":{"line":496,"codeLine":514,"path":"node_modules/can-set/src/props.js"},"description":"Supports MongoDB-style 'dot notation' properties. \n","title":"dotNotation","signatures":[{"code":"set.props.dotNotation(dotProperty)","description":"\n\nDefines a property that specifies a MongoDB-style nested property match.\nFor example, a set property of \"address.city\" matches against the value of the nested `{address: {city}}` value.\n\n```\nset.props.dotNotation(\"address.city\")\n```\n","params":[{"types":[{"type":"String"}],"name":"dotProperty","description":"The MongoDB-style nested property name"}],"returns":{"types":[{"type":"can-set.compares"}],"description":"Returns a comparator used to build a set algebra\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"dotProperty","description":"The MongoDB-style nested property name"},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"Returns a comparator used to build a set algebra\n"},"pathToRoot":".."};
</script>
</article>
