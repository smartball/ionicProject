...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/service/options.feathers-service.md
	@property can-connect-feathers/service/service.options.feathersService
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - feathersService</title>
...
<div class="breadcrumb">
	...
	<li><a href="service.options.feathersService.html">feathersService</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>feathersService</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/service/options.feathers-service.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>FeathersService</code>
  </h2>
  <p>Specifies a <a href="https://docs.feathersjs.com/clients/feathers.html">FeathersClient</a> Service instance to use for the data connection.  See the <a href="../../can-connect-feathers.html" title="Integrate can-connect with the FeathersJS Client">can-connect-feathers</a> page for an example Feathers Client configuration.</p>
<pre><code class="language-js">// Bring in the feathersClient instance and setup a service.
...
<p>See <a href="service.html" title="">can-connect-feathers/service/service</a> for a complete Todo Model example.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/service/options.feathers-service.md"},"description":"\n","types":[{"type":"FeathersService","description":"\n\nSpecifies a [FeathersClient](https://docs.feathersjs.com/clients/feathers.html) Service instance to use for the data connection.  See the [can-connect-feathers] page for an example Feathers Client configuration.\n\n```js\n// Bring in the feathersClient instance and setup a service.\nvar feathersClient = require('./feathers');\nvar todoService = feathersClient.service('/api/todos');\n\nconnect([\n  feathersService,\n  realtime\n], {\n  // Pass the service as the `feathersService` property\n  feathersService: todoService\n});\n```\n\nSee [can-connect-feathers/service/service] for a complete Todo Model example."}],"title":"feathersService","name":"can-connect-feathers/service/service.options.feathersService","type":"property","parent":"can-connect-feathers/service/service.options","pathToRoot":"../../.."};
</script>
</article>
