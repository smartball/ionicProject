...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/service/service.md
	@module can-connect-feathers/service/service
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-feathers/service/service</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="service.options.feathersService.html"
							title="">
							feathersService
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="service.data-methods.createData.html"
							title="">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="service.data-methods.destroyData.html"
							title="">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="service.data-methods.getData.html"
							title="">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="service.data-methods.getListData.html"
							title="">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="service.data-methods.updateData.html"
							title="">
							updateData
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-feathers/service/service</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/service/service.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>feathersService(baseConnect)</code>
  </h2>
  <p>Connects the <a href="../../can-connect/DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to the Feathers <a href="https://docs.feathersjs.com/services/readme.html#service-methods">Service Interface</a> methods.</p>
...
<p>For can-connect's real-time functionality to work with this behavior, the <a href="../../can-connect/real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time behavior</a> must also be included as shown in the examples.</p>
    ...
    <section class="body">
    <p>The <code>feathers-service</code> behavior maps can-connect's <a href="../../can-connect/DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to FeathersJS's <a href="https://docs.feathersjs.com/services/readme.html#service-methods">Service Interface</a> methods.</p>
<pre><code>| DataInterface method | Feathers method | HTTP method | Example Path |
|----------------------|-----------------|-------------|--------------|
...
<h2>Use</h2>
<p>Setting up the Feathers Client is a prerequisite for using this behavior.  See the <a href="../../can-connect-feathers.html" title="Integrate can-connect with the FeathersJS Client">can-connect-feathers</a> page for an example of a basic Feathers Client configuration.  With the Feathers client setup, it can be used with the <code>feathers-service</code> behavior as demonstrated in the example, below.  Also note that the <a href="../../can-connect/real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a> behavior is included to receive real-time push events from the server.</p>
...
<p>In the above example, both <code>Todo</code> and <code>Todo.connection</code> will have methods for handling data, as described in the <a href="../../can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">basic use</a> section.</p>
