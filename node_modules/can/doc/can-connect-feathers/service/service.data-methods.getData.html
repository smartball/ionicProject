...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/service/data-methods.get-data.md
	@function can-connect-feathers/service/service.data-methods.getData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="service.data-methods.getData.html">getData</a></li>
	...
	<div class="page-type">
		<h1>getData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/service/data-methods.get-data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Calls the <a href="service.options.feathersService.html" title="">feathersService</a> <code>get</code> method to retrieve instance data for the provided <code>params</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/service/data-methods.get-data.md"},"description":"\n","title":"getData","name":"can-connect-feathers/service/service.data-methods.getData","type":"function","parent":"can-connect-feathers/service/service.data-methods","signatures":[{"code":"getData(params)","description":"\n\nCalls the [can-connect-feathers/service/service.options.feathersService feathersService] `get` method to retrieve instance data for the provided `params`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"A object that represents the set of data needed to be loaded."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the instance data."}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"A object that represents the set of data needed to be loaded."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the instance data."},"pathToRoot":"../../.."};
</script>
</article>
