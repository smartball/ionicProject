...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/session/options.feathers-client.md
	@property can-connect-feathers/service/service.options.feathersClient
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - feathersClient</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="property"
							href="service.options.feathersClient.html"
							title="">
							feathersClient
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="../session/session.data-methods.createData.html"
							title="">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="../session/session.data-methods.destroyData.html"
							title="">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="../session/session.data-methods.getData.html"
							title="">
							getData
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="service.options.feathersClient.html">feathersClient</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>feathersClient</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/session/options.feathers-client.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>FeathersClient</code>
  </h2>
  <p>Specifies a FeathersClient instance to use for authentication.  The <a href="https://github.com/feathersjs/feathers-authentication-client">feathers-authentication-client plugin</a> is required.  See the <a href="../../can-connect-feathers.html" title="Integrate can-connect with the FeathersJS Client">can-connect-feathers</a> page for an example Feathers Client configuration.</p>
<pre><code class="language-js">// Bring in the feathers client instance.
...
<p>See <a href="../session/session.html" title="">can-connect-feathers/session/session</a> for a complete Session Model example.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/session/options.feathers-client.md"},"description":"\n","types":[{"type":"FeathersClient","description":"\n\nSpecifies a FeathersClient instance to use for authentication.  The [feathers-authentication-client plugin](https://github.com/feathersjs/feathers-authentication-client) is required.  See the [can-connect-feathers] page for an example Feathers Client configuration.\n\n```js\n// Bring in the feathers client instance.\nvar feathersClient = require('./feathers');\n\nconnect([\n  feathersSession\n], {\n  // Pass the feathers client as the `feathersClient` property.\n  feathersClient: feathersClient\n});\n```\n\nSee [can-connect-feathers/session/session] for a complete Session Model example."}],"title":"feathersClient","name":"can-connect-feathers/service/service.options.feathersClient","type":"property","parent":"can-connect-feathers/session/session.options","pathToRoot":"../../.."};
</script>
</article>
