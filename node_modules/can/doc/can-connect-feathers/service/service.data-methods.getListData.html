...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/service/data-methods.get-list-data.md
	@function can-connect-feathers/service/service.data-methods.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="service.data-methods.getListData.html">getListData</a></li>
	...
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/service/data-methods.get-list-data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Calls the <a href="service.options.feathersService.html" title="">feathersService</a> <code>find</code> method to retrieve list data for a particular <code>set</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A object that represents the set of data needed to be loaded.  The <code>set</code> object is passed to the Feathers service's <code>find</code> method as the query params: <code>.find({query: set})</code>.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/service/data-methods.get-list-data.md"},"description":"\n","title":"getListData","name":"can-connect-feathers/service/service.data-methods.getListData","type":"function","parent":"can-connect-feathers/service/service.data-methods","signatures":[{"code":"getListData(set)","description":"\n\nCalls the [can-connect-feathers/service/service.options.feathersService feathersService] `find` method to retrieve list data for a particular `set`.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"A object that represents the set of data needed to be loaded.  The `set` object is passed to the Feathers service's `find` method as the query params: `.find({query: set})`."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the ListData format."}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"A object that represents the set of data needed to be loaded.  The `set` object is passed to the Feathers service's `find` method as the query params: `.find({query: set})`."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the ListData format."},"pathToRoot":"../../.."};
</script>
</article>
