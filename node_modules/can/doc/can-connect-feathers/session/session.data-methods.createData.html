...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/session/data-methods.create-data.md
	@function can-connect-feathers/session/session.data-methods.createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="session.data-methods.createData.html">createData</a></li>
	...
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/session/data-methods.create-data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>createData(sessionData)</code>
  </h2>
  <p>Uses the [can-connect-feathers/session/session.options.feathersClient feathersClient] <code>authenticate</code> method to authenticate with a Feathers server.  See the <a href="https://docs.feathersjs.com/authentication/client.html">Feathers Authentication Client documentation</a> for details about Feathers authentication.  Upon successful authentication, the Feathers server will return a JSON Web Token (JWT) containing information about the current &quot;session&quot;.  Note that Feathers uses JWT instead of server sessions.</p>
<p>For Socket.io connections, the current socket connection's state will be marked as authenticated on the server side.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>sessionData</b> <code>{Object}</code>: <p>The serialized data for creating a session.  The <code>sessionData</code> payload will vary depending on which authentication strategy is used on the server.  For example, <a href="https://github.com/feathersjs/feathers-authentication-local">feathers-authentication-local</a> requires an <code>email</code> and <code>password</code>, but another strategy may have different requirements.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the server's response.  On success, a JSON Web Token created by the server will be returned.  On error, a <a href="https://github.com/feathersjs/feathers-errors">feathers-errors</a> instance will be returned.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/session/data-methods.create-data.md"},"description":"\n","title":"createData","name":"can-connect-feathers/session/session.data-methods.createData","type":"function","parent":"can-connect-feathers/session/session.data-methods","signatures":[{"code":"createData(sessionData)","description":"\n\nUses the [can-connect-feathers/session/session.options.feathersClient feathersClient] `authenticate` method to authenticate with a Feathers server.  See the [Feathers Authentication Client documentation](https://docs.feathersjs.com/authentication/client.html) for details about Feathers authentication.  Upon successful authentication, the Feathers server will return a JSON Web Token (JWT) containing information about the current \"session\".  Note that Feathers uses JWT instead of server sessions.\n\nFor Socket.io connections, the current socket connection's state will be marked as authenticated on the server side.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"sessionData","description":"The serialized data for creating a session.  The `sessionData` payload will vary depending on which authentication strategy is used on the server.  For example, [feathers-authentication-local](https://github.com/feathersjs/feathers-authentication-local) requires an `email` and `password`, but another strategy may have different requirements."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the server's response.  On success, a JSON Web Token created by the server will be returned.  On error, a [feathers-errors](https://github.com/feathersjs/feathers-errors) instance will be returned.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"sessionData","description":"The serialized data for creating a session.  The `sessionData` payload will vary depending on which authentication strategy is used on the server.  For example, [feathers-authentication-local](https://github.com/feathersjs/feathers-authentication-local) requires an `email` and `password`, but another strategy may have different requirements."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the server's response.  On success, a JSON Web Token created by the server will be returned.  On error, a [feathers-errors](https://github.com/feathersjs/feathers-errors) instance will be returned.\n"},"pathToRoot":"../../.."};
</script>
</article>
