...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/session/data-methods.destroy-data.md
	@function can-connect-feathers/session/session.data-methods.destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="session.data-methods.destroyData.html">destroyData</a></li>
	...
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/session/data-methods.destroy-data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>destroyData()</code>
  </h2>
  <p>Uses the [can-connect-feathers/session/session.options.feathersClient feathersClient] <code>logout</code> method to remove the current JSON Web Token from the client.  See the <a href="https://docs.feathersjs.com/authentication/client.html">Feathers Authentication Client documentation</a> for details about Feathers authentication.</p>
<p>For Socket.io connections, the current socket connection's state will be marked as unauthenticated on the server side.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to a success message.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/session/data-methods.destroy-data.md"},"description":"\n","title":"destroyData","name":"can-connect-feathers/session/session.data-methods.destroyData","type":"function","parent":"can-connect-feathers/session/session.data-methods","signatures":[{"code":"destroyData()","description":"\n\nUses the [can-connect-feathers/session/session.options.feathersClient feathersClient] `logout` method to remove the current JSON Web Token from the client.  See the [Feathers Authentication Client documentation](https://docs.feathersjs.com/authentication/client.html) for details about Feathers authentication.\n\nFor Socket.io connections, the current socket connection's state will be marked as unauthenticated on the server side.\n","params":[],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to a success message.\n"}}],"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to a success message.\n"},"pathToRoot":"../../.."};
</script>
</article>
