...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/session/session.md
	@module can-connect-feathers/session/session
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-feathers/session/session</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="../service/service.options.feathersClient.html"
							title="">
							feathersClient
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="session.data-methods.createData.html"
							title="">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="session.data-methods.destroyData.html"
							title="">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="session.data-methods.getData.html"
							title="">
							getData
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-feathers/session/session</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/session/session.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>feathersSession(baseConnect)</code>
  </h2>
  <p>Connects <a href="../../can-connect/DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to the <a href="https://github.com/feathersjs/feathers-authentication-client">feathers-authentication-client</a> plugin methods for authentication.</p>
<pre><code class="language-js">connect([
  ...
  Map: SessionMap
    ...
    <section class="body">
    <p>The <code>feathers-session</code> behavior uses the <a href="https://github.com/feathersjs/feathers-authentication-client">feathers-authentication-client</a> to authenticate with a Feathers server.  Three of the <a href="../../can-connect/DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods are used:</p>
<ul>
<li><a href="session.data-methods.createData.html" title="">createData</a> attempts to authenticate with the Feathers server, which upon success returns a JSON Web Token (JWT).  The JWT contains a payload with information about the current session.  That payload is returned as the session object.</li>
<li><a href="session.data-methods.getData.html" title="">getData</a> validates a stored JWT and returns its payload if the token hasn't expired.</li>
<li><a href="session.data-methods.destroyData.html" title="">destroyData</a> unauthenticates from the server and discards the JWT token on the client.</li>
</ul>
<h2>Use</h2>
<p>Setting up the Feathers Client is a prerequisite for using this behavior.  See the <a href="../../can-connect-feathers.html" title="Integrate can-connect with the FeathersJS Client">can-connect-feathers</a> page for an example of a basic Feathers Client configuration.  With the Feathers client setup, it can be used with the <code>feathers-session</code> behavior as demonstrated in the example, below.</p>
<pre><code class="language-js">// models/session.js
...
<h3>Obtaining current session data</h3>
<p>Once authentication has been established, the Map or DefineMap provided as the <code>Map</code> option on the can-connect Model will have a new <code>current</code> property defined.  So, if you passed a <code>Session</code> object, <code>Session.current</code> will always hold the current session data.  This greatly simplifies the session property in your application ViewModel.  Here's an abbreviated example.</p>
<pre><code class="language-js">import Session from 'my-app/models/session';
...
<p>That's it!  The <code>session</code> property in the above example will automatically populate when the user authenticates.</p>
<h3>Handling OAuth Logins</h3>
<p>The <code>feathers-session</code> behavior is preconfigured to listen to <code>login</code> messages coming in over the <a href="https://github.com/feathersjs/feathers-authentication-popups">feathers-authentication-popups</a> <code>authAgent</code>.  When any message is received through the <code>authAgent</code>, its validity is checked.  If it's a valid JWT token, a Session instance will be created automatically.  This will both populate <code>Session.current</code> and dispatch a <code>created</code> event on the connected Session Map.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/session/session.md"},"description":"\n","type":"module","title":"","types":[{"type":"connect.Behavior"}],"name":"can-connect-feathers/session/session","parent":"can-connect-feathers.behaviors","signatures":[{"code":"feathersSession(baseConnect)","description":"\n\nConnects [can-connect/DataInterface] methods to the [feathers-authentication-client](https://github.com/feathersjs/feathers-authentication-client) plugin methods for authentication.\n\n```js\nconnect([\n  feathersSession,\n  realtime\n], {\n  feathersClient: feathersClient,\n  Map: SessionMap\n});\n``` \n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
