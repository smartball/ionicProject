...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-feathers/_docs/session/data-methods.get-data.md
	@function can-connect-feathers/session/session.data-methods.getData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="session.data-methods.getData.html">getData</a></li>
	...
	<div class="page-type">
		<h1>getData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-feathers/edit/master/_docs/session/data-methods.get-data.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Uses the [can-connect-feathers/session/session.options.feathersClient feathersClient] <code>getJWT</code> method to retrieve and verify the current JSON Web Token (JWT).</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the JWT payload if the token was valid.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/session/data-methods.get-data.md"},"description":"\n","title":"getData","name":"can-connect-feathers/session/session.data-methods.getData","type":"function","parent":"can-connect-feathers/session/session.data-methods","signatures":[{"code":"getData()","description":"\n\nUses the [can-connect-feathers/session/session.options.feathersClient feathersClient] `getJWT` method to retrieve and verify the current JSON Web Token (JWT).\n","params":[],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the JWT payload if the token was valid.\n"}}],"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the JWT payload if the token was valid.\n"},"pathToRoot":"../../.."};
</script>
</article>
