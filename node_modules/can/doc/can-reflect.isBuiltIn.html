...
<!--####################################################################
	...
	@function can-reflect.isBuiltIn
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isBuiltIn</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isBuiltIn.html">isBuiltIn</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isBuiltIn</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L134">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value is a JavaScript built-in type.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isBuiltIn(obj)</code>
  </h2>
  <p>Return <code>true</code> if <code>obj</code> is some type of JavaScript native built-in; <code>false</code> otherwise.</p>
<pre><code>canReflect.isBuiltIn(null); // -&gt; true
...
<p>Not supported in browsers that have implementations of Map/Set where
<code>toString</code> is not properly implemented to return <code>[object Map]</code>/<code>[object Set]</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>maybe a built-in value</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isBuiltIn","parent":"can-reflect/type","src":{"line":133,"codeLine":160,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value is a JavaScript built-in type. ","title":"isBuiltIn","signatures":[{"code":"isBuiltIn(obj)","description":"\n\nReturn `true` if `obj` is some type of JavaScript native built-in; `false` otherwise.\n\n```\ncanReflect.isBuiltIn(null); // -> true\ncanReflect.isBuiltIn({}); // -> true\ncanReflect.isBuiltIn(1); // -> true\ncanReflect.isBuiltIn([]); // -> true\ncanReflect.isBuiltIn(function() {}); // -> true\ncanReflect.isBuiltIn(\"foo\"); // -> true\ncanReflect.isBuiltIn(new Date()); // -> true\ncanReflect.isBuiltIn(/[foo].[bar]/); // -> true\ncanReflect.isBuiltIn(new DefineMap); // -> false\n\n```\n\nNot supported in browsers that have implementations of Map/Set where\n`toString` is not properly implemented to return `[object Map]`/`[object Set]`.\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"maybe a built-in value"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"obj","description":"maybe a built-in value"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n"},"pathToRoot":".."};
</script>
</article>
