...
<!--####################################################################
	...
	@function can-event.removeEventListener
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - removeEventListener</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-event.removeEventListener.html">removeEventListener</a></li>
	...
	<div class="page-type">
		<h1>removeEventListener</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-event/edit/master/can-event.js#L92">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Removes a basic event listener from an object. Don't pass arguments to remove all event listeners.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>event</b> <code>{String}</code>: <p>The name of the event to remove. If not specified, all events are removed.</p>
</li>
        
          <li><b>handler</b> <code>{function}</code>: <p>The handler that will be removed from the event. If not specified, all handlers for the event are removed.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-event.removeEventListener","parent":"can-event.static","src":{"line":91,"codeLine":106,"path":"node_modules/can-event/can-event.js"},"description":"","title":"removeEventListener","signatures":[{"code":"obj.removeEventListener(event, handler)","description":"\n\nRemoves a basic event listener from an object. Don't pass arguments to remove all event listeners.\n","params":[{"types":[{"type":"String"}],"name":"event","description":"The name of the event to remove. If not specified, all events are removed."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"handler","description":"The handler that will be removed from the event. If not specified, all handlers for the event are removed."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"this\n"}},{"code":"canEvent.removeEventListener.call(obj, event, handler)","description":"\n\nThis syntax can be used for objects that don't include the [can-event] mixin.\n ","params":[]}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"this\n"},"pathToRoot":".."};
</script>
</article>
