...
<!--####################################################################
	...
	@function can-construct.prototype.init
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - init</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-construct.prototype.init.html">init</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>init</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-construct/edit/master/can-construct.js#L796">Edit on GitHub</a>
				</li>
    ...
    <p>Called when a new instance of a Construct is created.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>args</b> <code>{*}</code>: <p>the arguments passed to the constructor (or the items of the array returned from <a href="can-construct.prototype.setup.html" title="">setup</a>)</p>
</li>
    ...
    <section class="body">
    <p>If a prototype <code>init</code> method is provided, <code>init</code> is called when a new Construct is created---
after <a href="can-construct.prototype.setup.html" title="">setup</a>. The <code>init</code> method is where the bulk of your initialization code
should go. A common thing to do in <code>init</code> is save the arguments passed into the constructor.</p>
<h2>Examples</h2>
<p>First, we'll make a Person constructor that has a first and last name:</p>
<pre><code class="language-js">var Person = Construct.extend({
...
<pre><code class="language-js">var Programmer = Person.extend({
...
<h2>Modified Arguments</h2>
<p><a href="can-construct.prototype.setup.html" title="">setup</a> is able to modify the arguments passed to <code>init</code>.
If you aren't receiving the arguments you passed to <code>new Construct(args)</code>,
check that they aren't being changed by <code>setup</code> along
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-construct.prototype.init","parent":"can-construct.prototype","src":{"line":795,"codeLine":854,"path":"node_modules/can-construct/can-construct.js"},"description":"Called when a new instance of a Construct is created. \n","title":"init","signatures":[{"code":"construct.init(...args)","description":"","params":[{"types":[{"type":"*"}],"name":"args","description":"the arguments passed to the constructor (or the items of the array returned from [can-construct::setup])\n"}]}],"_curParam":{"types":[{"type":"*"}],"name":"args","description":"the arguments passed to the constructor (or the items of the array returned from [can-construct::setup])\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
