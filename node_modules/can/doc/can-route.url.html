...
<div class="breadcrumb">
	...
	<li><a href="can-route.url.html">url</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>url</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L623">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a URL fragment based on registered routes given a set of data.</p>
...
to match those in <code>data</code>.</p>
<pre><code class="language-js">route.url({ page: &quot;home&quot; });
// -&gt; &quot;#!page=home&quot;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>merge</b> <code>{Boolean}</code>: <p>Whether the given options should be merged into
the current state of the route.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The route URL and query string.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Similar to <a href="can-route.link.html" title="Creates a string representation of an anchor link using data and the registered routes.">link</a>, but instead of creating an anchor tag,
<code>route.url</code> creates only the URL based on the route options passed into it.</p>
<pre><code class="language-js">route.url( { type: &quot;videos&quot;, id: 5 } );
  // -&gt; &quot;#!type=videos&amp;id=5&quot;
</code></pre>
<p>If a route matching the provided data is found the URL is built from the
data. Any remaining data is added at the end of the URL as &amp; separated
key/value parameters.</p>
<pre><code class="language-js">route(&quot;{type}/{id}&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-route.url","parent":"can-route.static","src":{"line":622,"codeLine":662,"path":"node_modules/can-route/can-route.js"},"description":"Creates a URL fragment based on registered routes given a set of data. ","title":"url","signatures":[{"code":"route.url(data [, merge])","description":"\n\nMake a URL fragment that when set to window.location.hash will update can-route's properties\nto match those in `data`.\n\n```js\nroute.url({ page: \"home\" });\n// -> \"#!page=home\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"data","description":"The data to populate the route with."},{"types":[{"type":"Boolean"}],"optional":true,"name":"merge","description":"Whether the given options should be merged into\nthe current state of the route."}],"returns":{"types":[{"type":"String"}],"description":"The route URL and query string.\n"}}],"_curParam":{"types":[{"type":"Boolean"}],"optional":true,"name":"merge","description":"Whether the given options should be merged into\nthe current state of the route."},"_curReturn":{"types":[{"type":"String"}],"description":"The route URL and query string.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
