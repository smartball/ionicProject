...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/keys/key.md
	@typedef can-stache.key
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.key.html">key</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>key</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/keys/key.md">Edit on GitHub</a>
				</li>
    ...
    <p>A named reference to a value in the <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a> or <a href="can-view-scope.Options.html" title="">helper scope</a> in a template.</p>
...
<div class="signature">
  ...
  <p>Looks up a value in the <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a> or
<a href="can-view-scope.Options.html" title="">helper scope</a>.  This results in a
<a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>. <a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>
expressions can provide different values depending on what type of expression they
are within.  These rules are detailed in <a href="can-stache/expressions/key-lookup.html" title="">KeyLookup Expression</a>.</p>
<pre><code>{{name}}
{{#canVote(age)}}
</code></pre>
...
<div class="signature">
  <h2 class="signature-title">
    <code>EXPRESSION.key</code>
  </h2>
  <p>Looks up <code>key</code> on the result of a subexpression <code>EXPRESSION</code>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>a\\.single\\.key</code>
  </h2>
  <p>Looks up a value without reading intermediate properties.</p>
<pre><code>{{meta\\.data}}
</code></pre>
<p>This is deprecated.  If you do have properties with dots in them, use a <a href="can-stache/expressions/bracket.html" title="">Bracket Expression</a>:</p>
<pre><code>{{[&quot;meta.data&quot;]}}
</code></pre>
    ...
    <section class="body">
    <h2>Use</h2>
<p>A key references a value within the <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a> of a
