...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/prototype.unbind.md
	@function can-map.prototype.unbind
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.unbind.html">unbind</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>unbind</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/prototype.unbind.md">Edit on GitHub</a>
				</li>
    ...
    <p>Unbind event handlers from a Map.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventType</b> <code>{String}</code>: <p>the type of event to unbind, exactly as passed to <code>bind</code></p>
</li>
        
          <li><b>handler</b> <code>{function}</code>: <p>the handler to unbind</p>
<pre><code class="language-js">var map = new Map({ a: 1 });
...
map.unbind(&quot;change&quot;, log);
    ...
    <section class="body">
    <p><code>unbind</code> unbinds event handlers previously bound with <a href="can-map.prototype.bind.html" title="Bind event handlers to a Map.">bind</a>.
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/prototype.unbind.md"},"description":"Unbind event handlers from a Map. \n","title":"unbind","name":"can-map.prototype.unbind","type":"function","parent":"can-map.prototype","order":8,"signatures":[{"code":"map.unbind(eventType[, handler])","description":"","params":[{"types":[{"type":"String"}],"name":"eventType","description":"the type of event to unbind, exactly as passed to `bind`"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"handler","description":"the handler to unbind\n\n```js\nvar map = new Map({ a: 1 });\n\nfunction log(){\n\tconsole.log(\"val\", map.attr(\"a\");\n}\n\nmap.bind(\"change\", log);\n\nmap.attr(\"a\", 2);\n\n// Bind callback called.\nmap.unbind(\"change\", log);\n```\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"handler","description":"the handler to unbind\n\n```js\nvar map = new Map({ a: 1 });\n\nfunction log(){\n\tconsole.log(\"val\", map.attr(\"a\");\n}\n\nmap.bind(\"change\", log);\n\nmap.attr(\"a\", 2);\n\n// Bind callback called.\nmap.unbind(\"change\", log);\n```\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
