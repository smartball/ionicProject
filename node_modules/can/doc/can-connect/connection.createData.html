...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/createData.md
	@typedef can-connect/connection.createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
a map.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.clear.html"
							title="Deletes all records on a connection.">
							clear
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="typedef"
							href="connection.createData.html"
							title="Creates a new record in the connection.">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.destroyData.html"
							title="Destroys a record in the collection.">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.getData.html"
							title="Retrieves a record.">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.getListData.html"
							title="Retrieves list of records for the given set.">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.getSets.html"
							title="Gets the sets that are available in the connection.">
							getSets
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.updateData.html"
							title="Updates a record in the collection.">
							updateData
						</a>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="connection.updateListData.html"
							title="Updates records for a particular set in the connection.">
							updateListData
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="DataInterface.html">DataInterface</a></li>
		<li> / </li>
	
	
	<li><a href="connection.createData.html">createData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/createData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a new record in the connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>function(instanceData, cid)</code>
  </h2>
  <p>Creates a new record given the serialized form of the data. Resolves to a promise with any additional
properties that should be added to the
instance. A <a href="../can-util/js/cid/cid.html" title="Deprecated. Use can-cid instead.">client ID</a> is passed of the instance that is
being created.</p>
<p>The following shows how <a href="constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> calls <code>createData</code>
and what it does with the response:</p>
<pre><code class="language-js">var CID = require(&quot;can-util/js/cid/cid&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instanceData</b> <code>{Object}</code>: <p>The serialized data of the instance.</p>
</li>
        
          <li><b>cid</b> <code>{Number}</code>: <p>A unique id that represents the instance that is being created.  Given this value,
the instance can be retrieved in the <a href="constructor/constructor.cidStore.html" title="Temporarily hold references to new instances via their cid while they are undergoing creation.">cidStore</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise resolved with the <em>created</em> data of the newly created instance. The <em>created</em>
data <strong>must</strong> have the <a href="base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> of the created record.</p>
<p>By default, <a href="constructor/constructor.createdInstance.html" title="A method run whenever a new instance has been saved to the data source. Updates the instance with response data.">createdInstance</a> only adds the data in <code>createdInstanceData</code> to
<code>myInstance</code>, it does not remove it.  To remove &quot;missing&quot; properties on <code>myInstance</code> that are not in <code>createdInstanceData</code>, overwrite
<a href="constructor/constructor.createdInstance.html" title="A method run whenever a new instance has been saved to the data source. Updates the instance with response data.">createdInstance</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/data_interface/createData.md"},"description":"Creates a new record in the connection. \n","type":"typedef","title":"createData","types":[{"type":"function","returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise resolved with the _created_ data of the newly created instance. The _created_\ndata __must__ have the [can-connect/base/base.id] of the created record.  \n\nBy default, [can-connect/constructor/constructor.createdInstance] only adds the data in `createdInstanceData` to\n`myInstance`, it does not remove it.  To remove \"missing\" properties on `myInstance` that are not in `createdInstanceData`, overwrite\n[can-connect/constructor/constructor.createdInstance].\n"},"params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance.\n"},{"types":[{"type":"Number"}],"optional":true,"name":"cid","description":"A unique id that represents the instance that is being created.  Given this value,\nthe instance can be retrieved in the [can-connect/constructor/constructor.cidStore].\n"}],"description":"\n\nCreates a new record given the serialized form of the data. Resolves to a promise with any additional\nproperties that should be added to the\ninstance. A [can-util/js/cid/cid client ID] is passed of the instance that is\nbeing created.\n\nThe following shows how [can-connect/constructor/constructor] calls `createData`\nand what it does with the response:\n\n```js\nvar CID = require(\"can-util/js/cid/cid\");\n\n// Create an instance of a special type\nvar myInstance = new MyType({ ... });\n\n// get its CID\nvar cid = CID(myInstance);\n\n// get its raw data\nvar instanceData = connection.serializeInstance(myInstance);\n\nconnection.createData(instanceData, cid).then(function(createdInstanceData){\n\tconnection.createdInstance(myInstance, createdInstanceData);\n})\n```\n\n"}],"name":"can-connect/connection.createData","parent":"can-connect/DataInterface","_curParam":{"types":[{"type":"Number"}],"optional":true,"name":"cid","description":"A unique id that represents the instance that is being created.  Given this value,\nthe instance can be retrieved in the [can-connect/constructor/constructor.cidStore].\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise resolved with the _created_ data of the newly created instance. The _created_\ndata __must__ have the [can-connect/base/base.id] of the created record.  \n\nBy default, [can-connect/constructor/constructor.createdInstance] only adds the data in `createdInstanceData` to\n`myInstance`, it does not remove it.  To remove \"missing\" properties on `myInstance` that are not in `createdInstanceData`, overwrite\n[can-connect/constructor/constructor.createdInstance].\n"},"pathToRoot":"../.."};
</script>
</article>
