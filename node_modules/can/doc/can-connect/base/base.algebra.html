...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/base/base.algebra
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="base.algebra.html">algebra</a></li>
  ...
  <section class="title">
    ...
    <p><code>can-set</code> <a href="../../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">set algebra</a> used for list comparison, instance identification and membership
...
<div class="signature">
  <h2 class="signature-title">
    <code><a href="../../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a>(<a href="../../can-set.compares.html" title="An object of property names and prop functions.
{
  ...
  <p>A <a href="../../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">set algebra</a> that is used to perform calculations using set
definition objects passed to <a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> and <a href="../connection.getList.html" title="Gets a can-connect.List of instances.">getList</a>.
Needed to enable <a href="../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">caching</a>,
<a href="../data/combine-requests/combine-requests.html" title="Combines multiple incoming lists requests into a single list request when possible.">request combining</a>, <a href="../real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a> and other
behaviors. By default no algebra is provided.</p>
<p>An example of the types of calculations behaviors will make using the algebra:</p>
