...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/base/base.js
	@function can-connect/base/base.id
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - id</title>
...
lists.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="base.algebra.html"
							title="can-set set algebra used for list comparison, instance identification and membership
...
on them.">
					...
					<li class="
           						...
           						">
						<a class="property"
							href="base.cacheConnection.html"
							title="An underlying can-connect connection used when fetching data from a cache.">
							cacheConnection
						</a>
	...
	<ul>
					...
					<li class="current
						...
						<a class="function"
							href="base.id.html"
							title="Uniquely identify an instance or raw instance data.">
							id
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="base.listSet.html"
							title="Uniquely identify the set of data a list contains.">
							listSet
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="base.listSetProp.html"
							title="Specifies the property that uniquely identifies a list.">
							listSetProp
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="base.id.html">id</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>id</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/base/base.js#L41">Edit on GitHub</a>
				</li>
    ...
    <p>Uniquely identify an instance or raw instance data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.id(instance)</code>
  </h2>
  <p>Returns the instance id as determined by <a href="base.algebra.html" title="can-set set algebra used for list comparison, instance identification and membership
calculations. A way for the can-connect behaviors to understand what the properties of a request mean and act
on them.">algebra</a>'s id values if they exist, else return
the instance value indicated by <a href="base.idProp.html" title="Specifies the property that uniquely identifies an instance.">idProp</a> if it exists, otherwise the return the value of
<code>instance.id</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{Instance|Object}</code>: <p>An instance or raw properties for an instance.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String|Number}</code>: <p>A string or number uniquely representing <code>instance</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Many behaviors, such as the <a href="../constructor/store/store.html" title="Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
application.">constructor/store</a>, need to have a unique identifier for an
instance or instance data.  This <code>connection.id</code> method should return that.</p>
<p>Typically, an item's id is a simply property value on the object. For example, &quot;Todo&quot; data might look like:</p>
<pre><code class="language-js">{_id: 5, name: &quot;do the dishes&quot;}
</code></pre>
<p>In this case, <a href="base.algebra.html" title="can-set set algebra used for list comparison, instance identification and membership
calculations. A way for the can-connect behaviors to understand what the properties of a request mean and act
on them.">algebra</a>'s <code>id</code> property should be set to &quot;_id&quot;:</p>
...
<p>However, some data records may have compound ids.  For example, &quot;Class Assignment&quot; data may be uniquely
identified by a combination of two properties, the <code>studentId</code> and the <code>classId</code>. For this kind of setup, you
can provide your own id function as follows:</p>
<pre><code class="language-js">var customIdBehavior = {
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/base/base.id","parent":"can-connect/base/base.identifiers","src":{"line":40,"codeLine":99,"path":"node_modules/can-connect/base/base.js"},"description":"\nUniquely identify an instance or raw instance data.\n","title":"id","signatures":[{"code":"connection.id(instance)","description":"\n\n  Returns the instance id as determined by [can-connect/base/base.algebra]'s id values if they exist, else return\n  the instance value indicated by [can-connect/base/base.idProp] if it exists, otherwise the return the value of\n  `instance.id`.\n","params":[{"types":[{"type":"Instance"},{"type":"Object","options":[]}],"name":"instance","description":"An instance or raw properties for an instance.\n"}],"returns":{"types":[{"type":"String"},{"type":"Number"}],"description":"A string or number uniquely representing `instance`.\n\n"}}],"_curParam":{"types":[{"type":"Instance"},{"type":"Object","options":[]}],"name":"instance","description":"An instance or raw properties for an instance.\n"},"_curReturn":{"types":[{"type":"String"},{"type":"Number"}],"description":"A string or number uniquely representing `instance`.\n\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
