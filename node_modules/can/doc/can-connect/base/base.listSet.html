...
<!--####################################################################
	...
	@function can-connect/base/base.listSet
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - listSet</title>
...
<div class="breadcrumb">
	...
	<li><a href="base.listSet.html">listSet</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>listSet</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/base/base.js#L153">Edit on GitHub</a>
				</li>
    ...
    <p>Uniquely identify the set of data a list contains.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.listSet(list)</code>
  </h2>
  <p>Returns the value of the property referenced by <a href="base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> if it exists.
By default, this will return <code>list.__listSet</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>A list instance.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>An object that can be passed to <code>JSON.stringify</code> to represent the list.</p>
</p>
  </div>
...
being used by the application at once. Allows other behaviors to look up instances currently active in the
application.">constructor/store</a>, need to have a unique identifier for a list.
This <code>connection.listSet</code> method should return that.</p>
<p>Typically, a list's set identifier is a property on the list object.  As example, a list of Todos might look like
the following:</p>
<pre><code>var dueTodos = todoConnection.getList({due: &quot;today&quot;});
...
<p>In the above example the <a href="base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> would be the default <code>&quot;__listSet&quot;</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/base/base.listSet","parent":"can-connect/base/base.identifiers","src":{"line":152,"codeLine":186,"path":"node_modules/can-connect/base/base.js"},"description":"\nUniquely identify the set of data a list contains.\n","title":"listSet","signatures":[{"code":"connection.listSet(list)","description":"\n\n  Returns the value of the property referenced by [can-connect/base/base.listSetProp] if it exists.\n  By default, this will return `list.__listSet`.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"A list instance.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"An object that can be passed to `JSON.stringify` to represent the list.\n"}}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"A list instance.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"An object that can be passed to `JSON.stringify` to represent the list.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
