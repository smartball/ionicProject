...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>base</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/base/base.js#L2">Edit on GitHub</a>
				</li>
    ...
    <p>The first behavior added to every <code>can-connect</code> connection. Provides methods to uniquely identify instances and
lists.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>base(connectionOptions)</code>
  </h2>
  <p>Provides instance and list identifiers. Added automatically to every connection created by the <code>connect</code> helper.
So even if we do:</p>
<pre><code>var connection = connect([],{});
</code></pre>
<p>The connection still has the identification functionality provided by <code>base</code>:</p>
<pre><code>connection.id({id: 1, ...}) //-&gt; 1
</code></pre>
<p><code>can-connect</code> connections are typically created by the <code>connect</code> helper rather than by calling the behaviors directly.
This ensures the behaviors are called in the required order and is more elegant than requiring the user to chain
together the calls to all the behaviors.</p>
<p>See the <a href="base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> and <a href="base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a> methods for more specifics on
how ids are determined.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>connectionOptions</b> <code>{Object}</code>: <p>Object containing the configuration for the behaviors of the connection. Added to the
prototype of the returned connection object. <code>base</code> is almost always configured with an <a href="base.algebra.html" title="can-set set algebra used for list comparison, instance identification and membership
calculations. A way for the can-connect behaviors to understand what the properties of a request mean and act
on them.">algebra</a> option since it
<a href="base.id.html" title="Uniquely identify an instance or raw instance data.">defines the id property</a> and the majority of behaviors also require the algebra.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A <code>can-connect</code> connection containing the methods provided by <code>base</code>.</p>
</p>
  </div>
