...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/base/base.cacheConnection
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - cacheConnection</title>
...
<div class="breadcrumb">
	...
	<li><a href="base.cacheConnection.html">cacheConnection</a></li>
  ...
  <section class="title">
    ...
    <p>An underlying <code>can-connect</code> connection used when fetching data from a cache.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code><a href="../DataInterface.html" title="The most common raw data methods.">DataInterface</a></code>
  </h2>
  <p>A connection that provides access to a cache via <a href="../DataInterface.html" title="The most common raw data methods.">DataInterface</a>
requests. Several behaviors including <a href="../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> expect this property.</p>
...
<script type="text/javascript">
  window.docObject = {"description":"\nAn underlying `can-connect` connection used when fetching data from a cache.\n","types":[{"type":"can-connect/DataInterface","description":"A connection that provides access to a cache via [can-connect/DataInterface]\nrequests. Several behaviors including [can-connect/fall-through-cache/fall-through-cache] expect this property.\n"}],"title":"cacheConnection","name":"can-connect/base/base.cacheConnection","type":"property","parent":"can-connect/base/base.options","comment":" ","pathToRoot":"../../.."};
</script>
</article>
