...
<!--####################################################################
	...
	@property can-connect/base/base.idProp
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - idProp</title>
...
<div class="breadcrumb">
	...
	<li><a href="base.idProp.html">idProp</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>idProp</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/base/base.js#L123">Edit on GitHub</a>
				</li>
    ...
    <p>Specifies the property that uniquely identifies an instance.</p>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      <h3>Deprecated 0.5.3</h3>
      <div class='signature-wrapper'>
        <p>Instead of specifying idProp users should set an <a href="../../can-set.props.id.html" title="Defines the identify property.">id property</a> on the
<a href="base.algebra.html" title="can-set set algebra used for list comparison, instance identification and membership
calculations. A way for the can-connect behaviors to understand what the properties of a request mean and act
on them.">algebra</a> included in the connection configuration options.</p>
...
<div class="signature">
  ...
  <p>The name of the property that uniquely identifies an instance.  Defaults to <code>&quot;id&quot;</code>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code>var todoConnect = connect([
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/base/base.idProp","type":"property","parent":"can-connect/base/base.identifiers","src":{"line":122,"codeLine":150,"path":"node_modules/can-connect/base/base.js"},"description":"\nSpecifies the property that uniquely identifies an instance.\n","types":[{"type":"String","description":"The name of the property that uniquely identifies an instance.  Defaults to `\"id\"`.\n"}],"title":"idProp","hide":true,"deprecated":[{"version":"0.5.3","description":"Instead of specifying idProp users should set an [can-set.props.id id property] on the\n[can-connect/base/base.algebra] included in the connection configuration options.\n\n"}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
