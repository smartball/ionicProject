...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/service-worker/service-worker.js
	@module can-connect/service-worker
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/service-worker</title>
...
<div class="breadcrumb">
	...
	<li><a href="service-worker.html">./service-worker</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/service-worker</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/service-worker/service-worker.js#L6">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-connect/service-worker","params":[{"name":"baseConnection","types":[{"type":"*"}]}],"parent":"can-connect.behaviors","src":{"line":5,"codeLine":10,"path":"node_modules/can-connect/service-worker/service-worker.js"},"description":"\n","title":"","hide":true,"pathToRoot":"../.."};
</script>
</article>
