...
<!--####################################################################
	...
	@function can-connect/cache-requests/cache-requests.getDiff
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getDiff</title>
...
<div class="breadcrumb">
	...
	<li><a href="cache-requests.getDiff.html">getDiff</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getDiff</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/cache-requests/cache-requests.js#L104">Edit on GitHub</a>
				</li>
    ...
    <p>Compares the cached sets to the requested set and returns a description of what subset can be loaded from the
cache and what subset must be loaded from the base connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.getDiff( set, availableSets )</code>
  </h2>
  <p>This determines the minimal amount of data that must be loaded from the base connection by going through each
cached set (<code>availableSets</code>) and doing a <a href="../../can-set.Algebra.prototype.subset.html" title="">subset</a> check and a
<a href="../../can-set.Algebra.prototype.difference.html" title="">set difference</a> with the requested set (<code>set</code>).</p>
<p>If <code>set</code> is a subset of an <code>availableSet</code>, <code>{cached: set}</code> will be returned.</p>
<p>If <code>set</code> is neither a subset of, nor intersects with any <code>availableSets</code>, <code>{needed: set}</code> is returned.</p>
<p>If <code>set</code> has an intersection with one or more <code>availableSets</code>, a description of the difference that has the fewest
missing elements will be returned. An example diff description looks like:</p>
<pre><code>{
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set that is being requested.</p>
</li>
        
          <li><b>availableSets</b> <code>{Array&lt;<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>&gt;}</code>: <p>An array of <a href="../connection.getSets.html" title="Gets the sets that are available in the connection.">available sets</a> in the
<a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>a difference description object. Described above.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/cache-requests/cache-requests.getDiff","parent":"can-connect/cache-requests/cache-requests.algebra","src":{"line":103,"codeLine":137,"path":"node_modules/can-connect/cache-requests/cache-requests.js"},"description":"\nCompares the cached sets to the requested set and returns a description of what subset can be loaded from the\ncache and what subset must be loaded from the base connection.\n","title":"getDiff","signatures":[{"code":"connection.getDiff( set, availableSets )","description":"\n\n  This determines the minimal amount of data that must be loaded from the base connection by going through each\n  cached set (`availableSets`) and doing a [can-set.Algebra.prototype.subset subset] check and a\n  [can-set.Algebra.prototype.difference set difference] with the requested set (`set`).\n\n  If `set` is a subset of an `availableSet`, `{cached: set}` will be returned.\n\n  If `set` is neither a subset of, nor intersects with any `availableSets`, `{needed: set}` is returned.\n\n  If `set` has an intersection with one or more `availableSets`, a description of the difference that has the fewest\n  missing elements will be returned. An example diff description looks like:\n\n  ```\n  {\n    needed: {start: 50, end: 99}, // the difference, the set that is not cached\n    cached: {start: 0, end: 49}, // the intersection, the set that is cached\n    count: 49 // the size of the needed set\n  }\n  ```\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set that is being requested."},{"types":[{"type":"Array","template":[{"types":[{"type":"can-set/Set"}]}]}],"name":"availableSets","description":"An array of [can-connect/connection.getSets available sets] in the\n  [can-connect/base/base.cacheConnection cache]."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[{"name":"needed","types":[{"type":"Set"}]},{"name":"cached","types":[{"type":"Set"}]},{"name":"count","types":[{"type":"Integer"}]}]}]}]}],"description":"a difference description object. Described above.\n\n\t "}}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"can-set/Set"}]}]}],"name":"availableSets","description":"An array of [can-connect/connection.getSets available sets] in the\n  [can-connect/base/base.cacheConnection cache]."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[{"name":"needed","types":[{"type":"Set"}]},{"name":"cached","types":[{"type":"Set"}]},{"name":"count","types":[{"type":"Integer"}]}]}]}]}],"description":"a difference description object. Described above.\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
