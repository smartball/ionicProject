...
<!--####################################################################
	...
	@function can-connect/cache-requests/cache-requests.getUnion
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getUnion</title>
...
<div class="breadcrumb">
	...
	<li><a href="cache-requests.getUnion.html">getUnion</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getUnion</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/cache-requests/cache-requests.js#L177">Edit on GitHub</a>
				</li>
    ...
    <p>Create the requested data set, a union of the cached and un-cached data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.getUnion(set, diff, neededData, cachedData)</code>
  </h2>
  <p>Uses <a href="../../can-set.Algebra.prototype.getUnion.html" title="">getUnion</a> to merge the two sets of data (<code>neededData</code> &amp; <code>cachedData</code>).</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The parameters of the data set requested.</p>
</li>
        
          <li><b>diff</b> <code>{Object}</code>: <p>The result of <a href="cache-requests.getDiff.html" title="Compares the cached sets to the requested set and returns a description of what subset can be loaded from the
cache and what subset must be loaded from the base connection.">getDiff</a>.</p>
</li>
        
          <li><b>neededData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>The data loaded from the base connection.</p>
</li>
        
          <li><b>cachedData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>The data loaded from the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>A merged <a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> representation of the the cached and requested data.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/cache-requests/cache-requests.getUnion","parent":"can-connect/cache-requests/cache-requests.algebra","src":{"line":176,"codeLine":193,"path":"node_modules/can-connect/cache-requests/cache-requests.js"},"description":"\nCreate the requested data set, a union of the cached and un-cached data.\n","title":"getUnion","signatures":[{"code":"connection.getUnion(set, diff, neededData, cachedData)","description":"\n\n  Uses [can-set.Algebra.prototype.getUnion] to merge the two sets of data (`neededData` & `cachedData`).\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The parameters of the data set requested."},{"types":[{"type":"Object","options":[]}],"name":"diff","description":"The result of [can-connect/cache-requests/cache-requests.getDiff]."},{"types":[{"type":"can-connect.listData"}],"name":"neededData","description":"The data loaded from the base connection."},{"types":[{"type":"can-connect.listData"}],"name":"cachedData","description":"The data loaded from the [can-connect/base/base.cacheConnection].\n"}],"returns":{"types":[{"type":"can-connect.listData"}],"description":"A merged [can-connect.listData] representation of the the cached and requested data.\n\t "}}],"_curParam":{"types":[{"type":"can-connect.listData"}],"name":"cachedData","description":"The data loaded from the [can-connect/base/base.cacheConnection].\n"},"_curReturn":{"types":[{"type":"can-connect.listData"}],"description":"A merged [can-connect.listData] representation of the the cached and requested data.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
