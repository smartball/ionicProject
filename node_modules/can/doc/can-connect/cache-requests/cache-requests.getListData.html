...
<!--####################################################################
	...
	@function can-connect/cache-requests/cache-requests.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="cache-requests.getListData.html">getListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/cache-requests/cache-requests.js#L199">Edit on GitHub</a>
				</li>
    ...
    <p>Only request data that isn't already present in the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a>.</p>
...
<div class="signature">
  ...
  <p>Overwrites a base connection's <code>getListData</code> to use data in the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a>
whenever possible.  This works by <a href="../connection.getSets.html" title="Gets the sets that are available in the connection.">getting the stored sets</a>
from the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a> and
doing a <a href="cache-requests.getDiff.html" title="Compares the cached sets to the requested set and returns a description of what subset can be loaded from the
cache and what subset must be loaded from the base connection.">diff</a> to see what needs to be loaded from the base
connection and what can be loaded from the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a>.</p>
<p>With that information, this <code>getListData</code> requests data from the cache or the base connection as needed.
Data loaded from different sources is combined via <a href="cache-requests.getUnion.html" title="Create the requested data set, a union of the cached and un-cached data.">getUnion</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the parameters of the list that is being requested.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>&gt;}</code>: <p>a promise that returns an object conforming to the <a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> format.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/cache-requests/cache-requests.getListData","parent":"can-connect/cache-requests/cache-requests.data","src":{"line":198,"codeLine":218,"path":"node_modules/can-connect/cache-requests/cache-requests.js"},"description":"\nOnly request data that isn't already present in the [can-connect/base/base.cacheConnection cache].\n","title":"getListData","signatures":[{"code":"connection.getListData(set)","description":"\n\n  Overwrites a base connection's `getListData` to use data in the [can-connect/base/base.cacheConnection cache]\n  whenever possible.  This works by [can-connect/connection.getSets getting the stored sets]\n  from the [can-connect/base/base.cacheConnection cache] and\n  doing a [can-connect/cache-requests/cache-requests.getDiff diff] to see what needs to be loaded from the base\n  connection and what can be loaded from the [can-connect/base/base.cacheConnection cache].\n\n  With that information, this `getListData` requests data from the cache or the base connection as needed.\n  Data loaded from different sources is combined via [can-connect/cache-requests/cache-requests.getUnion].\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters of the list that is being requested."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"a promise that returns an object conforming to the [can-connect.listData] format.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters of the list that is being requested."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"a promise that returns an object conforming to the [can-connect.listData] format.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
