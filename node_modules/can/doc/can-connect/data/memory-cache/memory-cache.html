...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/memory-cache/memory-cache.js
	@module can-connect/data/memory-cache/memory-cache
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - memory-cache</title>
...
up to date.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.createData.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.destroyData.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.getData.html"
							title="Get an instance&#x27;s data from the memory cache.">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.getListData.html"
							title="Gets a set of data from the memory cache.">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.getSets.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.updateData.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="memory-cache.updateListData.html"
...
<div class="breadcrumb">
	...
	<li><a href="memory-cache.html">./data/memory-cache/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>memory-cache</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/memory-cache/memory-cache.js">Edit on GitHub</a>
				</li>
    ...
    <p>Saves raw data in JavaScript memory that disappears when the page refreshes.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>memoryCache( baseConnection )</code>
  </h2>
  <p>Creates a cache of instances and a cache of sets of instances that is
accessible to read via <a href="memory-cache.getSets.html" title="Returns the sets contained within the cache.">getSets</a>,
<a href="memory-cache.getData.html" title="Get an instance's data from the memory cache.">getData</a>, and <a href="memory-cache.getListData.html" title="Gets a set of data from the memory cache.">getListData</a>.
The caches are updated via <a href="memory-cache.createData.html" title="Called when an instance is created and should be added to cache.">createData</a>,
<a href="memory-cache.updateData.html" title="Called when an instance is updated.">updateData</a>, <a href="memory-cache.destroyData.html" title="Called when an instance should be removed from the cache.">destroyData</a>,
and <a href="memory-cache.updateListData.html" title="Saves a set of data in the cache.">updateListData</a>.</p>
<p><a href="memory-cache.createData.html" title="Called when an instance is created and should be added to cache.">createData</a>,
<a href="memory-cache.updateData.html" title="Called when an instance is updated.">updateData</a>,
<a href="memory-cache.destroyData.html" title="Called when an instance should be removed from the cache.">destroyData</a> are able to move items in and out
of sets.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>data/memory-cache</code> is often used with a caching strategy like <a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> or
<a href="../../cache-requests/cache-requests.html" title="Cache response data and use it to prevent unnecessary future requests or make future requests smaller.">cache-requests</a>.</p>
