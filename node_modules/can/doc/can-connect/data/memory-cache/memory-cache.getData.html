...
<!--####################################################################
	...
	@function can-connect/data/memory-cache/memory-cache.getData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="memory-cache.getData.html">getData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/memory-cache/memory-cache.js#L311">Edit on GitHub</a>
				</li>
    ...
    <p>Get an instance's data from the memory cache.</p>
...
<div class="signature">
  ...
  <p>Looks in the instance store for the requested instance.</p>
...
If the memory cache does not have this item, it rejects the promise.</p>
</p>
  </div>
