...
<!--####################################################################
	...
	@function can-connect/data/localstorage-cache/localstorage-cache.updateListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - updateListData</title>
...
<div class="breadcrumb">
	...
	<li><a href="localstorage-cache.updateListData.html">updateListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updateListData</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/localstorage-cache/localstorage-cache.js#L376">Edit on GitHub</a>
				</li>
    ...
    <p>Saves a set of data in the cache.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updateListData(listData, set)</code>
  </h2>
  <p>Tries to merge this set of data with any other saved sets of data. If
unable to merge this data, saves the set by itself.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: </li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: </li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>Promise resolves if and when the data has been successfully saved.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/localstorage-cache/localstorage-cache.updateListData","parent":"can-connect/data/localstorage-cache/localstorage-cache.data-methods","src":{"line":375,"codeLine":390,"path":"node_modules/can-connect/data/localstorage-cache/localstorage-cache.js"},"description":"\nSaves a set of data in the cache.\n","title":"updateListData","signatures":[{"code":"connection.updateListData(listData, set)","description":"\n\n  Tries to merge this set of data with any other saved sets of data. If\n  unable to merge this data, saves the set by itself.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":""},{"types":[{"type":"can-set/Set"}],"name":"set","description":""}],"returns":{"types":[{"type":"Promise"}],"description":"Promise resolves if and when the data has been successfully saved.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":""},"_curReturn":{"types":[{"type":"Promise"}],"description":"Promise resolves if and when the data has been successfully saved.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
