...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/localstorage-cache/localstorage-cache.js
	@module can-connect/data/localstorage-cache/localstorage-cache
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - localstorage-cache</title>
...
up to date.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="localstorage-cache.name.html"
							title="Specify a name to use when saving data in localstorage.">
							name
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.clear.html"
							title="Resets the memory cache so it contains nothing.">
							clear
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.createData.html"
							title="Called when an instance is created and should be added to cache.">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.destroyData.html"
							title="Called when an instance should be removed from the cache.">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.getData.html"
							title="Get an instance&#x27;s data from localstorage.">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.getListData.html"
							title="Gets a set of data from localstorage.">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.getSets.html"
							title="Returns the sets contained within the cache.">
							getSets
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.updateData.html"
							title="Called when an instance is updated.">
							updateData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="localstorage-cache.updateListData.html"
							title="Saves a set of data in the cache.">
							updateListData
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="localstorage-cache.html">./data/localstorage-cache/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>localstorage-cache</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/localstorage-cache/localstorage-cache.js">Edit on GitHub</a>
				</li>
    ...
    <p>Saves raw data in localStorage.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>localStorage( baseConnection )</code>
  </h2>
  <p>Creates a cache of instances and a cache of sets of instances that is
accessible to read via <a href="localstorage-cache.getSets.html" title="Returns the sets contained within the cache.">getSets</a>,
<a href="localstorage-cache.getData.html" title="Get an instance's data from localstorage.">getData</a>, and <a href="localstorage-cache.getListData.html" title="Gets a set of data from localstorage.">getListData</a>.
The caches are updated via <a href="localstorage-cache.createData.html" title="Called when an instance is created and should be added to cache.">createData</a>,
<a href="localstorage-cache.updateData.html" title="Called when an instance is updated.">updateData</a>, <a href="localstorage-cache.destroyData.html" title="Called when an instance should be removed from the cache.">destroyData</a>,
and <a href="localstorage-cache.updateListData.html" title="Saves a set of data in the cache.">updateListData</a>.</p>
<p><a href="localstorage-cache.createData.html" title="Called when an instance is created and should be added to cache.">createData</a>,
<a href="localstorage-cache.updateData.html" title="Called when an instance is updated.">updateData</a>,
<a href="localstorage-cache.destroyData.html" title="Called when an instance should be removed from the cache.">destroyData</a> are able to move items in and out
of sets.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>data/localstorage-cache</code> is often used with a caching strategy like <a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> or
<a href="../../cache-requests/cache-requests.html" title="Cache response data and use it to prevent unnecessary future requests or make future requests smaller.">cache-requests</a>.  Make sure you configure the connection's <a href="localstorage-cache.name.html" title="Specify a name to use when saving data in localstorage.">name</a>.</p>
<pre><code>var cacheConnection = connect([
