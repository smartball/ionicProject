...
<!--####################################################################
	...
	@function can-connect/data/localstorage-cache/localstorage-cache.getSets
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getSets</title>
...
<div class="breadcrumb">
	...
	<li><a href="localstorage-cache.getSets.html">getSets</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getSets</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/localstorage-cache/localstorage-cache.js#L271">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the sets contained within the cache.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.getSets(set)</code>
  </h2>
  <p>Returns the sets added by <a href="localstorage-cache.updateListData.html" title="Saves a set of data in the cache.">updateListData</a>.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Array&lt;Set&gt;&gt;}</code>: <p>A promise that resolves to the list of sets.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code>connection.getSets() //-&gt; Promise( [{type: &quot;completed&quot;},{user: 5}] )
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/localstorage-cache/localstorage-cache.getSets","parent":"can-connect/data/localstorage-cache/localstorage-cache.data-methods","src":{"line":270,"codeLine":291,"path":"node_modules/can-connect/data/localstorage-cache/localstorage-cache.js"},"description":"\nReturns the sets contained within the cache.\n","title":"getSets","signatures":[{"code":"connection.getSets(set)","description":"\n\n  Returns the sets added by [can-connect/data/localstorage-cache/localstorage-cache.updateListData].\n","params":[],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Array","template":[{"types":[{"type":"Set"}]}]}]}]}],"description":"A promise that resolves to the list of sets.\n"}}],"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Array","template":[{"types":[{"type":"Set"}]}]}]}]}],"description":"A promise that resolves to the list of sets.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
