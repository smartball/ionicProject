...
<!--####################################################################
	...
	@property can-connect/data/localstorage-cache/localstorage-cache.name
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - name</title>
...
<div class="breadcrumb">
	...
	<li><a href="localstorage-cache.name.html">name</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>name</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/localstorage-cache/localstorage-cache.js#L213">Edit on GitHub</a>
				</li>
    ...
    <p>Specify a name to use when saving data in localstorage.</p>
...
<div class="signature">
  ...
  <p>This name is used to find and save data in
localstorage. Instances are saved in <code>{name}/instance/{id}</code>
and sets are saved in <code>{name}/set/{set}</code>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code>var cacheConnection = connect([&quot;data-localstorage-cache&quot;],{
  name: &quot;todos&quot;
});
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":212,"codeLine":234,"path":"node_modules/can-connect/data/localstorage-cache/localstorage-cache.js"},"type":"property","description":"\nSpecify a name to use when saving data in localstorage.\n","types":[{"type":"String","description":"This name is used to find and save data in\nlocalstorage. Instances are saved in `{name}/instance/{id}`\nand sets are saved in `{name}/set/{set}`.\n"}],"title":"name","name":"can-connect/data/localstorage-cache/localstorage-cache.name","parent":"can-connect/data/localstorage-cache/localstorage-cache.identifiers","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
