...
<!--####################################################################
	...
	@function can-connect/data/localstorage-cache/localstorage-cache.updateData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="localstorage-cache.updateData.html">updateData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updateData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/localstorage-cache/localstorage-cache.js#L436">Edit on GitHub</a>
				</li>
    ...
    <p>Called when an instance is updated.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updateData(props)</code>
  </h2>
  <p>Overwrites the stored instance with the new props. Then, goes
through every set and adds or removes the instance if it belongs or not.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/localstorage-cache/localstorage-cache.updateData","parent":"can-connect/data/localstorage-cache/localstorage-cache.data-methods","src":{"line":435,"codeLine":446,"path":"node_modules/can-connect/data/localstorage-cache/localstorage-cache.js"},"description":"\nCalled when an instance is updated.\n","title":"updateData","signatures":[{"code":"connection.updateData(props)","description":"\n\n  Overwrites the stored instance with the new props. Then, goes\n  through every set and adds or removes the instance if it belongs or not.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
