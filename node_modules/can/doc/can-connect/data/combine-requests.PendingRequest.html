...
<!--####################################################################
	...
	@typedef can-connect/data/combine-requests.PendingRequest
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - PendingRequest</title>
...
<div class="breadcrumb">
	...
	<li><a href="combine-requests.PendingRequest.html">PendingRequest</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>PendingRequest</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/combine-requests/combine-requests.js#L289">Edit on GitHub</a>
				</li>
    ...
    <p>Type to keep track of the multiple requests that were unified into a single request.</p>
...
<div class="signature">
  ...
  <p>Record of an individual request that has been unified as part of the combined request. After
the unified request completes instances of these types are processed to complete the individual requests with the
subset of the unified data.</p>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>:
        <p>a requested <a href="../../can-set/Set.html" title="An object that represents a set of data.">set</a> of data that has been unified into the combined request</p>

      </li>
    
      <li>
        <b>deferred</b> <code>{Object}</code>:
        <p>a type that keeps track of the individual <a href="combine-requests.getListData.html" title="Combines multiple list data requests into a single request, when possible.">getListData</a>
promise that will be resolved after the unified request completes</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":288,"codeLine":303,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"type":"typedef","description":"Type to keep track of the multiple requests that were unified into a single request. \n","title":"PendingRequest","types":[{"type":"PendingRequest","description":"Record of an individual request that has been unified as part of the combined request. After\nthe unified request completes instances of these types are processed to complete the individual requests with the\nsubset of the unified data.\n","options":[{"name":"set","description":"a requested [can-set/Set set] of data that has been unified into the combined request","types":[{"type":"can-set/Set"}]},{"name":"deferred","description":"a type that keeps track of the individual [can-connect/data/combine-requests.getListData]\npromise that will be resolved after the unified request completes\n","types":[{"type":"Object","options":[]}]}]}],"name":"can-connect/data/combine-requests.PendingRequest","parent":"can-connect/data/combine-requests.types","pathToRoot":"../../.."};
</script>
</article>
