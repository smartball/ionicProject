...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/data/worker/worker.worker
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - worker</title>
...
<div class="signature">
  ...
  <p>A <a href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers">web-worker</a> that &quot;data instance&quot; methods will be sent to.  This
web-worker should include a connection that matches the name of the window's
connection. If a worker isn't provided, the connection behaves as if the <code>data/worker</code> behavior
was not added.</p>
<pre><code class="language-js">var worker = new Worker(&quot;path/to/script.js&quot;);
connect([...],{
  worker: worker
})
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"description":"\n","types":[{"type":"Worker","description":"A [web-worker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers) that \"data instance\" methods will be sent to.  This\nweb-worker should include a connection that matches the name of the window's\nconnection. If a worker isn't provided, the connection behaves as if the `data/worker` behavior\nwas not added.\n\n```js\nvar worker = new Worker(\"path/to/script.js\");\nconnect([...],{\n  worker: worker\n})\n```\n\t\t "}],"title":"worker","name":"can-connect/data/worker/worker.worker","type":"property","parent":"can-connect/data/worker/worker.identifiers","pathToRoot":"../../../.."};
</script>
</article>
