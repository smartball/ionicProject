...
<!--####################################################################
	...
	@function can-connect/data/worker/worker.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.getListData.html">getListData</a></li>
	...
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L65">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>getListData</code> is overwritten
to forward calling <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> for more information.</p>
