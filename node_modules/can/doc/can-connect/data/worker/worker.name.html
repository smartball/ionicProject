...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/data/worker/worker.name
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="signature">
  ...
  <p>The connection must be provided a unique name. This
makes sure the connections in both windows are linked.</p>
...
<script type="text/javascript">
  window.docObject = {"description":"\n","types":[{"type":"String","description":"The connection must be provided a unique name. This\nmakes sure the connections in both windows are linked.\n\n```js\nconnect([...],{\n  name: \"todos\"\n})\n```\n\t\t "}],"title":"name","name":"can-connect/data/worker/worker.name","type":"property","parent":"can-connect/data/worker/worker.identifiers","pathToRoot":"../../../.."};
</script>
</article>
