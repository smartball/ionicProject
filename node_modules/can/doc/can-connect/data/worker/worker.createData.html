...
<!--####################################################################
	...
	@function can-connect/data/worker/worker.createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.createData.html">createData</a></li>
	...
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L130">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>createData</code> is overwritten
to forward calling <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a> for more information.</p>
