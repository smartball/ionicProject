...
<!--####################################################################
	...
	@function can-connect/data/worker/worker.destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.destroyData.html">destroyData</a></li>
	...
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L156">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>destroyData</code> is overwritten
to forward calling <a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> for more information.</p>
