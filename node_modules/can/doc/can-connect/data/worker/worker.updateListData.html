...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/worker/worker.js
	@function can-connect/data/worker/worker.updateListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.updateListData.html">updateListData</a></li>
	...
	<div class="page-type">
		<h1>updateListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L78">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>.updateListData(listData, set)</code>
  </h2>
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>updateListData</code> is overwritten
to forward calling <a href="../../connection.updateListData.html" title="Updates records for a particular set in the connection.">updateListData</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.updateListData.html" title="Updates records for a particular set in the connection.">updateListData</a> for more information.</p>
