...
<!--####################################################################
	...
	@function can-connect/data/worker/worker.clear
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.clear.html">clear</a></li>
	...
	<div class="page-type">
		<h1>clear</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L104">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>clear</code> is overwritten
to forward calling <a href="../../connection.clear.html" title="Deletes all records on a connection.">clear</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.clear.html" title="Deletes all records on a connection.">clear</a> for more information.</p>
