...
<!--####################################################################
	...
	@function can-connect/data/worker/worker.getSets
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="worker.getSets.html">getSets</a></li>
	...
	<div class="page-type">
		<h1>getSets</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/worker/worker.js#L91">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>If passed a <a href="worker.worker.html" title="">worker</a> option, <code>getSets</code> is overwritten
to forward calling <a href="../../connection.getSets.html" title="Gets the sets that are available in the connection.">getSets</a> on a connection in the worker that
shares this connection's <a href="worker.name.html" title="">name</a>.</p>
<p>See <a href="../../connection.getSets.html" title="Gets the sets that are available in the connection.">getSets</a> for more information.</p>
