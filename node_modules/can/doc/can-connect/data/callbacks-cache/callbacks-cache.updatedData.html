...
<!--####################################################################
	...
	@function can-connect/data/callbacks-cache/callbacks-cache.updatedData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - updatedData</title>
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-cache.updatedData.html">updatedData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks-cache/callbacks-cache.js#L71">Edit on GitHub</a>
				</li>
    ...
    <p>Data callback that updates the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a> when a data record is modified.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updatedData(responseData, requestData)</code>
  </h2>
  <p>Calls <code>updateData</code> on the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> to modify a data record stored in the cache.
Calls and returns the response from any underlying behavior's <code>updatedData</code> callback.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>responseData</b> <code>{Object}</code>: <p>the data returned by the data update request</p>
</li>
        
          <li><b>requestData</b> <code>{Object}</code>: <p>the data that was passed to the data update request</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the data returned from an underlying behavior's <code>updatedData</code> callback, if one exists. Otherwise
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.updatedData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":70,"codeLine":87,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nData callback that updates the [can-connect/base/base.cacheConnection cache] when a data record is modified.\n","title":"updatedData","signatures":[{"code":"connection.updatedData(responseData, requestData)","description":"\n\nCalls `updateData` on the [can-connect/base/base.cacheConnection] to modify a data record stored in the cache.\nCalls and returns the response from any underlying behavior's `updatedData` callback.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"the data returned by the data update request"},{"types":[{"type":"Object","options":[]}],"name":"requestData","description":"the data that was passed to the data update request\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `updatedData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"requestData","description":"the data that was passed to the data update request\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `updatedData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
