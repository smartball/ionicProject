...
<head>
	<meta charset="utf-8">
	<title>CanJS - data/callbacks-cache</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>data/callbacks-cache</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks-cache/callbacks-cache.js">Edit on GitHub</a>
				</li>
    ...
    <p>Implements the data interface callbacks to call the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dataCallbacksCache( baseConnection )</code>
  </h2>
  <p>Implements the data interface callbacks so that a corresponding <a href="../../DataInterface.html" title="The most common raw data methods.">DataInterface</a> method is called on the
<a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a>. This updates the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> contents whenever
data is updated on the primary connection.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>data/callbacks-cache</code> behavior added
on to it.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a <code>can-connect</code> connection containing the method implementations provided by <code>data/callbacks-cache</code>.</p>
<h3>Example</h3>
<p>Shows synchronization between primary connection and cacheConnection data when using this behavior:</p>
<pre><code>import dataUrl from &quot;can-connect/data/url/&quot;;
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":43,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nImplements the data interface callbacks to call the [can-connect/base/base.cacheConnection]\n[can-connect/DataInterface]. These calls keep the [can-connect/base/base.cacheConnection] contents\nup to date.\n","title":"data/callbacks-cache","signatures":[{"code":"dataCallbacksCache( baseConnection )","description":"\nImplements the data interface callbacks so that a corresponding [can-connect/DataInterface] method is called on the\n[can-connect/base/base.cacheConnection]. This updates the [can-connect/base/base.cacheConnection] contents whenever\ndata is updated on the primary connection.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `data/callbacks-cache` behavior added\non to it.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `data/callbacks-cache`.\n\n### Example\nShows synchronization between primary connection and cacheConnection data when using this behavior:\n```\nimport dataUrl from \"can-connect/data/url/\";\nimport dataCallbacks from \"can-connect/data/callbacks/\";\nimport cacheCallbacks from \"can-connect/data/callbacks-cache/\";\nimport memoryCache from \"can-connect/data/memory-cache/\";\n\nvar cacheConnection = connect([memoryCache], {});\nvar todoConnection = connect([dataUrl, dataCallback, cacheCallbacks], {\n  cacheConnection,\n  url: \"/todo\"\n});\n\ntodoConnection.createData({name:'do the dishes', completed: false}).then(function(data) {\n  todoConnection.cacheConnection.getData({id: data.id}).then(function(cachedData) {\n    // data returned from connection and data returned from cache have the same contents\n    data.id === cachedData.id; // true\n    data.name === cachedData.name; // true\n    data.completed === cachedData.completed; // true\n    data === cachedData; // false, since callbacks-cache creates a copy of the data when adding it to the cache\n  })\n});\n```\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `data/callbacks-cache` behavior added\non to it.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `data/callbacks-cache`.\n\n### Example\nShows synchronization between primary connection and cacheConnection data when using this behavior:\n```\nimport dataUrl from \"can-connect/data/url/\";\nimport dataCallbacks from \"can-connect/data/callbacks/\";\nimport cacheCallbacks from \"can-connect/data/callbacks-cache/\";\nimport memoryCache from \"can-connect/data/memory-cache/\";\n\nvar cacheConnection = connect([memoryCache], {});\nvar todoConnection = connect([dataUrl, dataCallback, cacheCallbacks], {\n  cacheConnection,\n  url: \"/todo\"\n});\n\ntodoConnection.createData({name:'do the dishes', completed: false}).then(function(data) {\n  todoConnection.cacheConnection.getData({id: data.id}).then(function(cachedData) {\n    // data returned from connection and data returned from cache have the same contents\n    data.id === cachedData.id; // true\n    data.name === cachedData.name; // true\n    data.completed === cachedData.completed; // true\n    data === cachedData; // false, since callbacks-cache creates a copy of the data when adding it to the cache\n  })\n});\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
