...
<!--####################################################################
	...
	@function can-connect/data/callbacks-cache/callbacks-cache.destroyedData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - destroyedData</title>
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-cache.destroyedData.html">destroyedData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks-cache/callbacks-cache.js#L90">Edit on GitHub</a>
				</li>
    ...
    <p>Data callback that updates the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a> when a data record is deleted.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.destroyedData(responseData, requestData)</code>
  </h2>
  <p>Calls <code>destroyData</code> on the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> to remove a data record stored in the cache.
Calls and returns the response from any underlying behavior's <code>destroyedData</code> callback.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>responseData</b> <code>{Object}</code>: <p>the data returned by the data destroy request</p>
</li>
        
          <li><b>requestData</b> <code>{Object}</code>: <p>the data that was passed to the data destroy request</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the data returned from an underlying behavior's <code>destroyedData</code> callback, if one exists. Otherwise
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.destroyedData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":89,"codeLine":106,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nData callback that updates the [can-connect/base/base.cacheConnection cache] when a data record is deleted.\n","title":"destroyedData","signatures":[{"code":"connection.destroyedData(responseData, requestData)","description":"\n\nCalls `destroyData` on the [can-connect/base/base.cacheConnection] to remove a data record stored in the cache.\nCalls and returns the response from any underlying behavior's `destroyedData` callback.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"the data returned by the data destroy request"},{"types":[{"type":"Object","options":[]}],"name":"requestData","description":"the data that was passed to the data destroy request\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `destroyedData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"requestData","description":"the data that was passed to the data destroy request\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `destroyedData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
