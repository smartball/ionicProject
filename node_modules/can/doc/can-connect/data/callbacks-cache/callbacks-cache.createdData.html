...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/callbacks-cache/callbacks-cache.js
	@function can-connect/data/callbacks-cache/callbacks-cache.createdData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - createdData</title>
...
up to date.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="callbacks-cache.createdData.html"
							title="Data callback that updates the cache when a new data record is created.">
							createdData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-cache.destroyedData.html"
							title="Data callback that updates the cache when a data record is deleted.">
							destroyedData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-cache.updatedData.html"
							title="Data callback that updates the cache when a data record is modified.">
							updatedData
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="callbacks-cache.html">./data/callbacks-cache/</a></li>
		<li> / </li>
	
	
	<li><a href="callbacks-cache.createdData.html">createdData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks-cache/callbacks-cache.js#L50">Edit on GitHub</a>
				</li>
    ...
    <p>Data callback that updates the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cache</a> when a new data record is created.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.createdData(responseData, requestData, cid)</code>
  </h2>
  <p>Calls <code>createData</code> on the <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> to add a newly created data record to the cache.
Calls and returns the response from any underlying behavior's <code>createdData</code> callback.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>responseData</b> <code>{Object}</code>: <p>the data returned by the data creation request</p>
</li>
        
          <li><b>requestData</b> <code>{Object}</code>: <p>the data that was passed to the data creation request</p>
</li>
        
          <li><b>cid</b> <code>{Number}</code>: <p>the unique identifier for this data. Used before data has a <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> added
at creation time.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the data returned from an underlying behavior's <code>createdData</code> callback, if one exists. Otherwise
returns the <code>responseData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.createdData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":49,"codeLine":68,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nData callback that updates the [can-connect/base/base.cacheConnection cache] when a new data record is created.\n","title":"createdData","signatures":[{"code":"connection.createdData(responseData, requestData, cid)","description":"\n\nCalls `createData` on the [can-connect/base/base.cacheConnection] to add a newly created data record to the cache.\nCalls and returns the response from any underlying behavior's `createdData` callback.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"the data returned by the data creation request"},{"types":[{"type":"Object","options":[]}],"name":"requestData","description":"the data that was passed to the data creation request"},{"types":[{"type":"Number"}],"name":"cid","description":"the unique identifier for this data. Used before data has a [can-connect/base/base.id] added\nat creation time.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `createdData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "}}],"_curParam":{"types":[{"type":"Number"}],"name":"cid","description":"the unique identifier for this data. Used before data has a [can-connect/base/base.id] added\nat creation time.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the data returned from an underlying behavior's `createdData` callback, if one exists. Otherwise\nreturns the `responseData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
