...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/combine-requests/combine-requests.js
	@module can-connect/data/combine-requests/combine-requests
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - combine-requests</title>
...
application.">
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../callbacks-cache/callbacks-cache.html"
...
up to date.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="../combine-requests.time.html"
							title="Specifies the amount of time to wait to combine requests.">
							time
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="typedef"
							href="../combine-requests.PendingRequest.html"
							title="Type to keep track of the multiple requests that were unified into a single request.">
							PendingRequest
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="../combine-requests.getListData.html"
							title="Combines multiple list data requests into a single request, when possible.">
							getListData
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="../combine-requests.unionPendingRequests.html"
							title="Group pending requests by the request that they are a subset of.">
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../localstorage-cache/localstorage-cache.html"
					...
					<li class="
           						...
           						">
						<a class="module"
							href="../memory-cache/memory-cache.html"
...
<div class="breadcrumb">
	...
	<li><a href="combine-requests.html">./data/combine-requests/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>combine-requests</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/combine-requests/combine-requests.js#L8">Edit on GitHub</a>
				</li>
    ...
    <p>Combines multiple incoming lists requests into a single list request when possible.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>combineRequests( baseConnection )</code>
  </h2>
  <p>Implements <a href="../combine-requests.getListData.html" title="Combines multiple list data requests into a single request, when possible.">getListData</a> to collect the requested sets for some
<a href="../combine-requests.time.html" title="Specifies the amount of time to wait to combine requests.">time</a>.  Once the configured amount of time has passed, it tries to take the
<a href="../combine-requests.unionPendingRequests.html" title="Group pending requests by the request that they are a subset of.">union</a> of the requested sets. It then makes requests with
those unified sets. Once the unified set requests have returned, the original requests are resolved by taking
[can-connect/data/combine-requests.getSubset subsets] of the unified response data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>combine-requests</code> behavior added
on to it. Should already contain a behavior that provides <code>getListData</code> (e.g <a href="../url/url.html" title="">data/url</a>). If
the <code>connect</code> helper is used to build the connection, the behaviors will automatically be ordered as required.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a <code>can-connect</code> connection containing the method implementations provided by <code>combine-requests</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Create a connection with the <code>combine-requests</code> plugin:</p>
<pre><code>var combineRequests = require(&quot;can-connect/data/combine-requests/&quot;);
var dataUrl = require(&quot;can-connect/data/url/&quot;);
var todosConnection = connect([dataUrl, combineRequests], {
  url: &quot;/todos&quot;
});
</code></pre>
<p>Since the configuration above doesn't include the <a href="../combine-requests.time.html" title="Specifies the amount of time to wait to combine requests.">time</a> option, the following
will only make a single request if all requests are made during the same &quot;thread of execution&quot; (i.e before the
browser takes a break from executing the current JavaScript):</p>
<pre><code>todosConnection.getListData({})
todosConnection.getListData({userId: 5});
todosConnection.getListData({userId: 5, type: &quot;critical&quot;});
</code></pre>
<p>The above requests can all be joined since <a href="../../../can-set.html" title="can-set is a utility for comparing sets that are represented by the parameters commonly passed to service requests.">can-set</a> intuitively knows that
<code>{userId: 5, type: &quot;critical&quot;}</code> and <code>{userId: 5}</code> are subsets of the complete set of todos, <code>{}</code>.</p>
<p>For more advanced combining, a <a href="../../../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">set algebra</a> must be configured. This allows <a href="../../../can-set.html" title="can-set is a utility for comparing sets that are represented by the parameters commonly passed to service requests.">can-set</a> to understand
what certain parameters of a set mean, and how they might be combined.</p>
<p>The following connection supports combining ranges:</p>
<pre><code>var set = require(&quot;can-set&quot;);
...
<p>Now the following will also be unified to make single request:</p>
<pre><code>todosConnection.getListData({start: 0, end: 49})
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-connect/data/combine-requests/combine-requests","parent":"can-connect.behaviors","src":{"line":7,"codeLine":81,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nCombines multiple incoming lists requests into a single list request when possible.\n","title":"combine-requests","signatures":[{"code":"combineRequests( baseConnection )","description":"\n\nImplements [can-connect/data/combine-requests.getListData] to collect the requested sets for some\n[can-connect/data/combine-requests.time].  Once the configured amount of time has passed, it tries to take the\n[can-connect/data/combine-requests.unionPendingRequests union] of the requested sets. It then makes requests with\nthose unified sets. Once the unified set requests have returned, the original requests are resolved by taking\n[can-connect/data/combine-requests.getSubset subsets] of the unified response data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `combine-requests` behavior added\non to it. Should already contain a behavior that provides `getListData` (e.g [can-connect/data/url/url]). If\nthe `connect` helper is used to build the connection, the behaviors will automatically be ordered as required.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `combine-requests`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `combine-requests` behavior added\non to it. Should already contain a behavior that provides `getListData` (e.g [can-connect/data/url/url]). If\nthe `connect` helper is used to build the connection, the behaviors will automatically be ordered as required.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `combine-requests`.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
