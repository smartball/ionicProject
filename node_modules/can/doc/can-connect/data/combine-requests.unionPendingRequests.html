...
<!--####################################################################
	...
	@function can-connect/data/combine-requests.unionPendingRequests
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - unionPendingRequests</title>
...
up to date.">
					...
					<li class="
           						...
           						expanded">
						<a class="module"
							href="combine-requests/combine-requests.html"
...
<div class="breadcrumb">
		...
		<li><a href="combine-requests/combine-requests.html">./data/combine-requests/</a></li>
		<li> / </li>
	
	
	<li><a href="combine-requests.unionPendingRequests.html">unionPendingRequests</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>unionPendingRequests</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/combine-requests/combine-requests.js#L86">Edit on GitHub</a>
				</li>
    ...
    <p>Group pending requests by the request that they are a subset of.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.unionPendingRequests( pendingRequests )</code>
  </h2>
  <p>This is called by <a href="combine-requests.getListData.html" title="Combines multiple list data requests into a single request, when possible.">getListData</a> to determine which pending requests can be unified
into a broader request. This produces a grouping of 'parent' sets to 'child' requests whose data will be
derived from the data retrieved by the parent.</p>
<p>After this grouping is returned, <a href="combine-requests.getListData.html" title="Combines multiple list data requests into a single request, when possible.">getListData</a> executes requests for the parent
sets. After a parent request succeeds, the child requests will have their data calculated from the parent data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>pendingRequests</b> <code>{Array&lt;<a href="combine-requests.PendingRequest.html" title="Type to keep track of the multiple requests that were unified into a single request.">PendingRequest</a>&gt;}</code>: <p>an array of objects, each containing:</p>
<ul>
<li><code>set</code> - the requested set</li>
<li><code>deferred</code> - a wrapper around a <code>Promise</code> that will be resolved with this sets data</li>
</ul>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array&lt;Object&gt;}</code>: <p>an array of each of the unified requests to be made.  Each unified request should have:</p>
<ul>
<li><code>set</code> - the set to request</li>
<li><code>pendingRequests</code> - the array of <a href="combine-requests.PendingRequest.html" title="Type to keep track of the multiple requests that were unified into a single request.">pending requests</a> the <code>set</code> satisfies</li>
</ul>
<h3>Example</h3>
<p>This function converts something like:</p>
<pre><code>[
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/combine-requests.unionPendingRequests","parent":"can-connect/data/combine-requests.algebra","src":{"line":85,"codeLine":136,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nGroup pending requests by the request that they are a subset of.\n","title":"unionPendingRequests","signatures":[{"code":"connection.unionPendingRequests( pendingRequests )","description":"\n\nThis is called by [can-connect/data/combine-requests.getListData] to determine which pending requests can be unified\ninto a broader request. This produces a grouping of 'parent' sets to 'child' requests whose data will be\nderived from the data retrieved by the parent.\n\nAfter this grouping is returned, [can-connect/data/combine-requests.getListData] executes requests for the parent\nsets. After a parent request succeeds, the child requests will have their data calculated from the parent data.\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-connect/data/combine-requests.PendingRequest"}]}]}],"name":"pendingRequests","description":"\nan array of objects, each containing:\n  - `set` - the requested set\n  - `deferred` - a wrapper around a `Promise` that will be resolved with this sets data\n"}],"returns":{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[{"name":"set","types":[{"type":"Set"}]},{"name":"pendingRequests","types":[{"type":"can-connect/data/combine-requests.PendingRequest"}]}]}]}]}],"description":"\nan array of each of the unified requests to be made.  Each unified request should have:\n  - `set` - the set to request\n  - `pendingRequests` - the array of [can-connect/data/combine-requests.PendingRequest pending requests] the `set` satisfies\n\n### Example\n\nThis function converts something like:\n\n```\n[\n  {set: {completed: false}, deferred: def1},\n  {set: {completed: true}, deferred: def2}\n]\n```\n\nto:\n\n```\n[\n  {\n   set: {},\n   pendingRequests: [\n     {set: {completed: false}, deferred: def1},\n     {set: {completed: true}, deferred: def2}\n   ]\n  }\n]\n```\n\n\t "}}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"can-connect/data/combine-requests.PendingRequest"}]}]}],"name":"pendingRequests","description":"\nan array of objects, each containing:\n  - `set` - the requested set\n  - `deferred` - a wrapper around a `Promise` that will be resolved with this sets data\n"},"_curReturn":{"types":[{"type":"Array","template":[{"types":[{"type":"Object","options":[{"name":"set","types":[{"type":"Set"}]},{"name":"pendingRequests","types":[{"type":"can-connect/data/combine-requests.PendingRequest"}]}]}]}]}],"description":"\nan array of each of the unified requests to be made.  Each unified request should have:\n  - `set` - the set to request\n  - `pendingRequests` - the array of [can-connect/data/combine-requests.PendingRequest pending requests] the `set` satisfies\n\n### Example\n\nThis function converts something like:\n\n```\n[\n  {set: {completed: false}, deferred: def1},\n  {set: {completed: true}, deferred: def2}\n]\n```\n\nto:\n\n```\n[\n  {\n   set: {},\n   pendingRequests: [\n     {set: {completed: false}, deferred: def1},\n     {set: {completed: true}, deferred: def2}\n   ]\n  }\n]\n```\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
