...
<!--####################################################################
	...
	@function can-connect/data/combine-requests.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="combine-requests.getListData.html">getListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/combine-requests/combine-requests.js#L208">Edit on GitHub</a>
				</li>
    ...
    <p>Combines multiple list data requests into a single request, when possible.</p>
...
<div class="signature">
  ...
  <p>Extension of <a href="../connection.getListData.html" title="Retrieves list of records for the given set."><code>getListData</code></a> that tries to combine calls to it into a single
call. The calls are fulfilled by an underlying behavior's <code>getListData</code> implementation.</p>
<p>Waits for a configured <a href="combine-requests.time.html" title="Specifies the amount of time to wait to combine requests.">time</a> then tries to unify the sets requested during it.
After unification, calls for the unified sets are made to the underlying <code>getListData</code>. Once the unified
data has returned, the individual calls to <code>getListData</code> are resolved with a
<a href="../../can-set.Algebra.prototype.getSubset.html" title="">calculated subset</a> of the unified data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the parameters of the requested set of data</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>&gt;}</code>: <p><code>Promise</code> resolving the data of the requested set</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/combine-requests.getListData","parent":"can-connect/data/combine-requests.data-methods","src":{"line":207,"codeLine":226,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nCombines multiple list data requests into a single request, when possible.\n","title":"getListData","signatures":[{"code":"connection.getListData( set )","description":"\n\nExtension of [can-connect/connection.getListData `getListData`] that tries to combine calls to it into a single\ncall. The calls are fulfilled by an underlying behavior's `getListData` implementation.\n\nWaits for a configured [can-connect/data/combine-requests.time] then tries to unify the sets requested during it.\nAfter unification, calls for the unified sets are made to the underlying `getListData`. Once the unified\ndata has returned, the individual calls to `getListData` are resolved with a\n[can-set.Algebra.prototype.getSubset calculated subset] of the unified data.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters of the requested set of data"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"`Promise` resolving the data of the requested set\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters of the requested set of data"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"`Promise` resolving the data of the requested set\n\t "},"pathToRoot":"../../.."};
</script>
</article>
