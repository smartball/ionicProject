...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/callbacks/callbacks.js
	@module can-connect/data/callbacks/callbacks
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - data/callbacks</title>
...
application.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.createData.html"
							title="Call createdData with the data returned from underlying behavior&#x27;s implementation of
connection.createData.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.destroyData.html"
							title="Call destroyedData with the data returned from underlying behavior&#x27;s implementation of
connection.destroyData.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.getListData.html"
							title="Call gotListData with the data returned from underlying behavior&#x27;s implementation of
connection.gotListData.">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.updateData.html"
							title="Call updatedData with the data returned from underlying behavior&#x27;s implementation of
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.html">./data/callbacks/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>data/callbacks</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks/callbacks.js">Edit on GitHub</a>
				</li>
    ...
    <p>Extend <a href="../../DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to call callbacks with the raw response data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dataCallbacks( baseConnection )</code>
  </h2>
  <p>Extends the <a href="../../DataInterface.html" title="The most common raw data methods.">DataInterface</a> create, update, read &amp; delete methods to call 'callback' methods following
their execution. Callbacks are called with the data returned from the underlying behavior's <a href="../../DataInterface.html" title="The most common raw data methods.">DataInterface</a>
implementation.</p>
<p>For example:</p>
<pre><code>var dataUrl = require(&quot;can-connect/data/url/&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>data/callbacks</code> behavior added
on to it. Should already contain a behavior that provides the DataInterface (e.g <a href="../url/url.html" title="">data/url</a>). If
the <code>connect</code> helper is used to build the connection, the behaviors will automatically be ordered as required.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a <code>can-connect</code> connection containing the method implementations provided by <code>data/callbacks</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks/callbacks","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":41,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\nExtend [can-connect/DataInterface] methods to call callbacks with the raw response data.\n","title":"data/callbacks","signatures":[{"code":"dataCallbacks( baseConnection )","description":"\n\nExtends the [can-connect/DataInterface] create, update, read & delete methods to call 'callback' methods following\ntheir execution. Callbacks are called with the data returned from the underlying behavior's [can-connect/DataInterface]\nimplementation.\n\nFor example:\n```\nvar dataUrl = require(\"can-connect/data/url/\");\nvar dataCallbacks = require(\"can-connect/data/url\");\nvar logging = {\n  createdData: function(responseData) {\n    console.log('New Todo Saved: ', responseData);\n    return responseData;\n  }\n};\nvar todoConnection = connect([dataUrl, dataCallbacks, logging}],  {\n  url: '/todos'\n});\n\n// create a new todo\ntodoConnection.createData({name: \"do the dishes\", completed: false}).then(function(responseData) {\n  responseData; // {id: 5}\n});\n\n// after create request is completed, following is logged by the \"logging\" createdData callback:\n// > New Todo Saved: {id: 5}\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `data/callbacks` behavior added\non to it. Should already contain a behavior that provides the DataInterface (e.g [can-connect/data/url/url]). If\nthe `connect` helper is used to build the connection, the behaviors will automatically be ordered as required.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `data/callbacks`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `data/callbacks` behavior added\non to it. Should already contain a behavior that provides the DataInterface (e.g [can-connect/data/url/url]). If\nthe `connect` helper is used to build the connection, the behaviors will automatically be ordered as required.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `data/callbacks`.\n"},"pathToRoot":"../../../.."};
</script>
</article>
