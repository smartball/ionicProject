...
<!--####################################################################
	...
	@function can-connect/data/callbacks/callbacks.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.getListData.html">getListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks/callbacks.js#L47">Edit on GitHub</a>
				</li>
    ...
    <p>Call <code>gotListData</code> with the data returned from underlying behavior's implementation of
[can-connect/connection.gotListData].</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getListData(listSet)</code>
  </h2>
  <p>Extends the underlying behavior's <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> to call <code>gotListData</code> with the returned
response data. The result of the call to <code>gotListData</code> will be used as the new response data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listSet</b> <code>{Object}</code>: <p>an object that represents the set of data to be loaded</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p><code>Promise</code> resolving the raw response data, possibly modified by <code>gotListData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks/callbacks.getListData","type":"function","parent":"can-connect/data/callbacks/callbacks","src":{"line":46,"codeLine":61,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\nCall `gotListData` with the data returned from underlying behavior's implementation of\n[can-connect/connection.gotListData].\n","title":"getListData","signatures":[{"code":"getListData(listSet)","description":"\n\n  Extends the underlying behavior's [can-connect/connection.getListData] to call `gotListData` with the returned\n  response data. The result of the call to `gotListData` will be used as the new response data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"listSet","description":"an object that represents the set of data to be loaded"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `gotListData`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"listSet","description":"an object that represents the set of data to be loaded"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `gotListData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
