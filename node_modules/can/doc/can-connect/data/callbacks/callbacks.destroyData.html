...
<!--####################################################################
	...
	@function can-connect/data/callbacks/callbacks.destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.destroyData.html">destroyData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks/callbacks.js#L99">Edit on GitHub</a>
				</li>
    ...
    <p>Call <code>destroyedData</code> with the data returned from underlying behavior's implementation of
<a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>destroyData(params, cid)</code>
  </h2>
  <p>Extends the underlying behavior's <a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> to call <code>destroyedData</code> with the returned
response data. The result of the call to <code>destroyedData</code> will be used as the new response data.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p><code>Promise</code> resolving the raw response data, possibly modified by <code>destroyedData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks/callbacks.destroyData","type":"function","parent":"can-connect/data/callbacks/callbacks","src":{"line":98,"codeLine":113,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\nCall `destroyedData` with the data returned from underlying behavior's implementation of\n[can-connect/connection.destroyData].\n","title":"destroyData","signatures":[{"code":"destroyData(params, cid)","description":"\n\n  Extends the underlying behavior's [can-connect/connection.destroyData] to call `destroyedData` with the returned\n  response data. The result of the call to `destroyedData` will be used as the new response data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"the raw data of an instance"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `destroyedData`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"the raw data of an instance"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `destroyedData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
