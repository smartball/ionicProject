...
<!--####################################################################
	...
	@function can-connect/data/callbacks/callbacks.createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.createData.html">createData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks/callbacks.js#L64">Edit on GitHub</a>
				</li>
    ...
    <p>Call <code>createdData</code> with the data returned from underlying behavior's implementation of
<a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>createData(instanceData, cid)</code>
  </h2>
  <p>Extends the underlying behavior's <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a> to call <code>createdData</code> with the returned
response data. The result of the call to <code>createdData</code> will be used as the new response data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instanceData</b> <code>{Object}</code>: <p>the raw data of an instance</p>
</li>
        
          <li><b>cid</b> <code>{Number}</code>: <p>unique id that represents the instance that is being created</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p><code>Promise</code> resolving the raw response data, possibly modified by <code>createdData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks/callbacks.createData","type":"function","parent":"can-connect/data/callbacks/callbacks","src":{"line":63,"codeLine":79,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\nCall `createdData` with the data returned from underlying behavior's implementation of\n[can-connect/connection.createData].\n","title":"createData","signatures":[{"code":"createData(instanceData, cid)","description":"\n\n  Extends the underlying behavior's [can-connect/connection.createData] to call `createdData` with the returned\n  response data. The result of the call to `createdData` will be used as the new response data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"the raw data of an instance"},{"types":[{"type":"Number"}],"name":"cid","description":"unique id that represents the instance that is being created"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `createdData`.\n "}}],"_curParam":{"types":[{"type":"Number"}],"name":"cid","description":"unique id that represents the instance that is being created"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `createdData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
