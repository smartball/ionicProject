...
<!--####################################################################
	...
	@function can-connect/data/callbacks/callbacks.updateData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.updateData.html">updatedData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/callbacks/callbacks.js#L82">Edit on GitHub</a>
				</li>
    ...
    <p>Call <code>updatedData</code> with the data returned from underlying behavior's implementation of
<a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
...
<div class="signature">
  ...
  <p>Extends the underlying behavior's <a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a> to call <code>updatedData</code> with the returned
response data. The result of the call to <code>updatedData</code> will be used as the new response data.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p><code>Promise</code> resolving the raw response data, possibly modified by <code>updatedData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/callbacks/callbacks.updateData","type":"function","parent":"can-connect/data/callbacks/callbacks","src":{"line":81,"codeLine":96,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\nCall `updatedData` with the data returned from underlying behavior's implementation of\n[can-connect/connection.updateData].\n","title":"updatedData","signatures":[{"code":"updateData(instanceData)","description":"\n\n  Extends the underlying behavior's [can-connect/connection.updateData] to call `updatedData` with the returned\n  response data. The result of the call to `updatedData` will be used as the new response data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"the raw data of an instance"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `updatedData`.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"the raw data of an instance"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"`Promise` resolving the raw response data, possibly modified by `updatedData`.\n "},"pathToRoot":"../../../.."};
</script>
</article>
