...
<!--####################################################################
	...
	@property can-connect/data/url/url.ajax
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ajax</title>
...
<div class="breadcrumb">
	...
	<li><a href="url.ajax.html">ajax</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ajax</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/url/url.js#L214">Edit on GitHub</a>
				</li>
    ...
    <p>Specify the ajax functionality that should be used to make the request.</p>
...
<div class="signature">
  ...
  <p>Provides an alternate function to be used to make
ajax requests.  By default [can-util/dom/ajax/ajax] provides the ajax
functionality. jQuery's ajax method can be substituted as follows:</p>
<pre><code class="language-js">connect([
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>settings</b> <code>{Object}</code>: <p>Configuration options for the AJAX request.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>A Promise that resolves to the data.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":213,"codeLine":236,"path":"node_modules/can-connect/data/url/url.js"},"type":"property","description":"\nSpecify the ajax functionality that should be used to make the request.\n","types":[{"type":"function","returns":{"types":[{"type":"Promise"}],"description":"A Promise that resolves to the data.\n "},"params":[{"types":[{"type":"Object","options":[]}],"name":"settings","description":"Configuration options for the AJAX request."}],"description":"Provides an alternate function to be used to make\najax requests.  By default [can-util/dom/ajax/ajax] provides the ajax\nfunctionality. jQuery's ajax method can be substituted as follows:\n\n```js\nconnect([\n  require(\"can-connect/data/url/url\")\n],{\n  url: \"/things\",\n  ajax: $.ajax\n});\n```\n"}],"title":"ajax","name":"can-connect/data/url/url.ajax","parent":"can-connect/data/url/url.option","_curParam":{"types":[{"type":"Object","options":[]}],"name":"settings","description":"Configuration options for the AJAX request."},"_curReturn":{"types":[{"type":"Promise"}],"description":"A Promise that resolves to the data.\n "},"pathToRoot":"../../../.."};
</script>
</article>
