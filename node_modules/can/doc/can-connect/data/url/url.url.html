...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/data/url/url.url
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - url</title>
...
<div class="breadcrumb">
	...
	<li><a href="url.url.html">url</a></li>
  ...
  <section class="title">
    ...
    <p>Specify the url and methods that should be used for the &quot;Data Methods&quot;.</p>
...
<div class="signature">
  ...
  <p>If a string is provided, it's assumed to be a RESTful interface. For example,
if the following is provided:</p>
<pre><code>url: &quot;/services/todos&quot;
</code></pre>
<p>... the following methods and requests are used:</p>
<ul>
<li><code>getListData</code> - <code>GET /services/todos</code></li>
<li><code>getData</code> - <code>GET /services/todos/{id}</code></li>
<li><code>createData</code> - <code>POST /services/todos</code></li>
<li><code>updateData</code> - <code>PUT /services/todos/{id}</code></li>
<li><code>destroyData</code> - <code>DELETE /services/todos/{id}</code></li>
</ul>
...
<div class="signature">
  ...
  <p>If an object is provided, it can customize each method and URL directly
like:</p>
<pre><code>url: {
...
<p>You can provide a <code>resource</code> property that works like providing <code>url</code> as a string, but overwrite
other values like:</p>
<pre><code>url: {
...
<p>Finally, you can provide your own method to totally control how the request is made:</p>
<pre><code>url: {
  resource: &quot;/services/todo&quot;,
  getListData: &quot;GET /services/todos&quot;,
