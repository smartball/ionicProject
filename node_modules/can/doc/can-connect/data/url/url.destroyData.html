...
<!--####################################################################
	...
	@function can-connect/data/url/url.destroyData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="url.destroyData.html">destroyData</a></li>
	...
	<div class="page-type">
		<h1>destroyData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/url/url.js#L303">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Deletes instance data given the serialized form of the data and
the <a href="url.url.html" title="Specify the url and methods that should be used for the &quot;Data Methods&quot;.">url</a> settings.
If <code>url.destroyData</code> is a function, that function will be called.  If <code>url.destroyData</code> is a
string, a request to that string will be made. If <code>url</code> is a string, a <code>DELETE</code> request is made to
<code>url+&quot;/&quot;+IDPROP</code>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the deleted instance data.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/url/url.destroyData","type":"function","parent":"can-connect/data/url/url.data-methods","src":{"line":302,"codeLine":317,"path":"node_modules/can-connect/data/url/url.js"},"description":"\n","title":"destroyData","signatures":[{"code":"destroyData(instanceData)","description":"\n\nDeletes instance data given the serialized form of the data and\n  the [can-connect/data/url/url.url] settings.\n  If `url.destroyData` is a function, that function will be called.  If `url.destroyData` is a\n  string, a request to that string will be made. If `url` is a string, a `DELETE` request is made to\n  `url+\"/\"+IDPROP`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the deleted instance data.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the deleted instance data.\n "},"pathToRoot":"../../../.."};
</script>
</article>
