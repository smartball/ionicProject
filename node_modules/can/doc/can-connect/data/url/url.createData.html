...
<!--####################################################################
	...
	@function can-connect/data/url/url.createData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="url.createData.html">createData</a></li>
	...
	<div class="page-type">
		<h1>createData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/url/url.js#L270">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Creates instance data given the serialized form of the data and
the <a href="url.url.html" title="Specify the url and methods that should be used for the &quot;Data Methods&quot;.">url</a> settings.
If <code>url.createData</code> is a function, that function will be called.  If <code>url.createData</code> is a
string, a request to that string will be made. If <code>url</code> is a string, a <code>POST</code> request is made to
<code>url</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>cid</b> <code>{Number}</code>: <p>A unique id that represents the instance that is being created.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the newly created instance data.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/url/url.createData","type":"function","parent":"can-connect/data/url/url.data-methods","src":{"line":269,"codeLine":285,"path":"node_modules/can-connect/data/url/url.js"},"description":"\n","title":"createData","signatures":[{"code":"createData(instanceData, cid)","description":"\n\n  Creates instance data given the serialized form of the data and\n  the [can-connect/data/url/url.url] settings.\n  If `url.createData` is a function, that function will be called.  If `url.createData` is a\n  string, a request to that string will be made. If `url` is a string, a `POST` request is made to\n  `url`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance."},{"types":[{"type":"Number"}],"name":"cid","description":"A unique id that represents the instance that is being created."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the newly created instance data.\n "}}],"_curParam":{"types":[{"type":"Number"}],"name":"cid","description":"A unique id that represents the instance that is being created."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the newly created instance data.\n "},"pathToRoot":"../../../.."};
</script>
</article>
