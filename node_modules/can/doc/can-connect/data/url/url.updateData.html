...
<!--####################################################################
	...
	@function can-connect/data/url/url.updateData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="url.updateData.html">updateData</a></li>
	...
	<div class="page-type">
		<h1>updateData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/url/url.js#L287">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Updates instance data given the serialized form of the data and
the <a href="url.url.html" title="Specify the url and methods that should be used for the &quot;Data Methods&quot;.">url</a> settings.
If <code>url.updateData</code> is a function, that function will be called.  If <code>url.updateData</code> is a
string, a request to that string will be made. If <code>url</code> is a string, a <code>PUT</code> request is made to
<code>url+&quot;/&quot;+IDPROP</code>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the updated instance data.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/url/url.updateData","type":"function","parent":"can-connect/data/url/url.data-methods","src":{"line":286,"codeLine":301,"path":"node_modules/can-connect/data/url/url.js"},"description":"\n","title":"updateData","signatures":[{"code":"updateData(instanceData)","description":"\n\nUpdates instance data given the serialized form of the data and\n  the [can-connect/data/url/url.url] settings.\n  If `url.updateData` is a function, that function will be called.  If `url.updateData` is a\n  string, a request to that string will be made. If `url` is a string, a `PUT` request is made to\n  `url+\"/\"+IDPROP`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the updated instance data.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instanceData","description":"The serialized data of the instance."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the updated instance data.\n "},"pathToRoot":"../../../.."};
</script>
</article>
