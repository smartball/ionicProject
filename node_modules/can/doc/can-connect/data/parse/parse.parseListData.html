...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/data/parse/parse.js
	@function can-connect/data/parse/parse.parseListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - parseListData</title>
...
up to date.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="parse.parseInstanceData.html"
							title="Returns the properties that should be used to make an instance given the results of connection.getData, connection.createData, connection.updateData,
and connection.destroyData.">
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="parse.parseListData.html"
							title="Given a response from connection.getListData returns its data in the proper can-connect.listData format.">
							parseListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="parse.parseListProp.html"
							title="The property to find the array-like data that represents each instance item.">
							parseListProp
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="../../../connection.parseInstanceProp.html"
							title="The property to find the data that represents an instance item.">
							parseInstanceProp
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="parse.html">./data/parse/</a></li>
		<li> / </li>
	
	
	<li><a href="parse.parseListData.html">parseListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>parseListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/parse/parse.js#L64">Edit on GitHub</a>
				</li>
    ...
    <p>Given a response from <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> returns its data in the proper <a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> format.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.parseListData(responseData)</code>
  </h2>
  <p>This function uses <a href="parse.parseListProp.html" title="The property to find the array-like data that represents each instance item.">parseListProp</a> to find the array
containing the data for each instance.  Then it uses <a href="parse.parseInstanceData.html" title="Returns the properties that should be used to make an instance given the results of connection.getData, connection.createData, connection.updateData,
and connection.destroyData.">parseInstanceData</a>
on each item in the array  Finally, it returns data in the
<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> format.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>responseData</b> <code>{Object}</code>: <p>The response data from the AJAX request.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>An object like <code>{data: [props, props, ...]}</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>parseListData</code> comes in handy when dealing with an irregular API
that can be improved with data transformation.</p>
<p>Suppose an endpoint responds with a status of 200 OK, even when the
request generates an empty result set. Worse yet, instead of representing
an emtpy set with an empty list, it removes the property.</p>
<p>A request to <code>/services/todos</code> may return:</p>
<pre><code>{
  todos: [
...
<p>What if a request for <code>/services/todos?filterName=bank</code> responds with
200 OK:</p>
<pre><code>{
}
</code></pre>
<p>This response breaks its own schema. One way to bring it in line
with a format compatible with <a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> is:</p>
<pre><code>connect([
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/parse/parse.parseListData","parent":"can-connect/data/parse/parse","src":{"line":63,"codeLine":130,"path":"node_modules/can-connect/data/parse/parse.js"},"description":"Given a response from [can-connect/connection.getListData] returns its data in the proper [can-connect.listData] format.\n\n","title":"parseListData","signatures":[{"code":"connection.parseListData(responseData)","description":"\n\n  This function uses [can-connect/data/parse/parse.parseListProp] to find the array\n  containing the data for each instance.  Then it uses [can-connect/data/parse/parse.parseInstanceData]\n  on each item in the array  Finally, it returns data in the\n  [can-connect.listData] format.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"The response data from the AJAX request.\n"}],"returns":{"types":[{"type":"can-connect.listData"}],"description":"An object like `{data: [props, props, ...]}`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"The response data from the AJAX request.\n"},"_curReturn":{"types":[{"type":"can-connect.listData"}],"description":"An object like `{data: [props, props, ...]}`.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
