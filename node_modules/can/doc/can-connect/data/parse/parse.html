...
<!--####################################################################
	...
	@module can-connect/data/parse/parse
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/data/parse/parse</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/data/parse/parse</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/parse/parse.js">Edit on GitHub</a>
				</li>
    ...
    <p>Extract response data into a format needed for other extensions.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dataParse( baseConnection )</code>
  </h2>
  <p>Overwrites the <a href="../../DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to run their results through
either <a href="parse.parseInstanceData.html" title="Returns the properties that should be used to make an instance given the results of connection.getData, connection.createData, connection.updateData,
and connection.destroyData.">parseInstanceData</a> or <a href="parse.parseListData.html" title="Given a response from connection.getListData returns its data in the proper can-connect.listData format.">parseListData</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p>The base connection.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>data/parse</code> is used to modify the response data of &quot;data interface&quot; methods to comply with what
is expected by &quot;instance interface&quot; methods.  For example, if a service was returning list data
at the <code>/services/todos</code> url like:</p>
<pre><code>{
  todos: [
...
<p>That service does not return <a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> in the right format which should look like:</p>
<pre><code>{
  data: [
    {id: 0, name: &quot;dishes&quot;},
    {id: 2, name: &quot;lawn&quot;}
...
<p>To correct this, you can configure <code>data-parse</code> to use the <a href="parse.parseListProp.html" title="The property to find the array-like data that represents each instance item.">parseListProp</a> and <a href="../../../connection.parseInstanceProp.html" title="The property to find the data that represents an instance item.">parseInstanceProp</a>
as follows:</p>
<pre><code>connect([
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/data/parse/parse","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":55,"path":"node_modules/can-connect/data/parse/parse.js"},"description":"\nExtract response data into a format needed for other extensions.\n","title":"","types":[{"type":"connect.Behavior"}],"signatures":[{"code":"dataParse( baseConnection )","description":"\n\n  Overwrites the [can-connect/DataInterface] methods to run their results through\n  either [can-connect/data/parse/parse.parseInstanceData] or [can-connect/data/parse/parse.parseListData].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"The base connection.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"The base connection.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
