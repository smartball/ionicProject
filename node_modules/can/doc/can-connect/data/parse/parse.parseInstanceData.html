...
<!--####################################################################
	...
	@function can-connect/data/parse/parse.parseInstanceData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - parseInstanceData</title>
...
<div class="breadcrumb">
	...
	<li><a href="parse.parseInstanceData.html">parseInstanceData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>parseInstanceData</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/parse/parse.js#L161">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.parseInstanceData(responseData)</code>
  </h2>
  <p>This function will use <a href="../../../connection.parseInstanceProp.html" title="The property to find the data that represents an instance item.">parseInstanceProp</a> to find the data object
representing the instance that will be created.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>responseData</b> <code>{Object}</code>: <p>The response data from <a href="../../connection.getData.html" title="Retrieves a record.">getData</a>, <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a>, or <a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The data that should be passed to <a href="../../constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>parseInstanceData</code> comes in handy when dealing with an irregular API
that can be improved with data transformation.</p>
<p>Suppose a request to <code>/services/todos</code> returns:</p>
<pre><code>{
  baseUrl: &quot;/proxy/share&quot;,
  todo: {
    id: 0,
...
<p>The baseUrl property is meta-data that needs to be incorporated into the
instance data. One way to deal with this is:</p>
<pre><code>connect([
...
<p>This results in an object like:</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/data/parse/parse.parseInstanceData","parent":"can-connect/data/parse/parse","src":{"line":160,"codeLine":230,"path":"node_modules/can-connect/data/parse/parse.js"},"description":"Returns the properties that should be used to [can-connect/constructor/constructor.hydrateInstance make an instance] given the results of [can-connect/connection.getData], [can-connect/connection.createData], [can-connect/connection.updateData],\nand [can-connect/connection.destroyData].\n\n","title":"parseInstanceData","signatures":[{"code":"connection.parseInstanceData(responseData)","description":"\n\n  This function will use [connection.parseInstanceProp] to find the data object\n  representing the instance that will be created.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"The response data from [can-connect/connection.getData], [can-connect/connection.createData], or [can-connect/connection.updateData].\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The data that should be passed to [can-connect/constructor/constructor.hydrateInstance].\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"responseData","description":"The response data from [can-connect/connection.getData], [can-connect/connection.createData], or [can-connect/connection.updateData].\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The data that should be passed to [can-connect/constructor/constructor.hydrateInstance].\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
