...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/data/parse/parse.parseListProp
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - parseListProp</title>
...
<div class="breadcrumb">
	...
	<li><a href="parse.parseListProp.html">parseListProp</a></li>
  ...
  <section class="title">
    ...
    <p>The property to find the array-like data that represents each instance item.</p>
...
<div class="signature">
  ...
  <p><a href="parse.parseListData.html" title="Given a response from connection.getListData returns its data in the proper can-connect.listData format.">parseListData</a> uses this property to find an array-like data struture
on the result of <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Set <code>parseListProp</code> if your response data does not look like: <code>{data: [props, props]}</code>.</p>
<p>For example, if <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> returns data like:</p>
<pre><code>{
      todos: [{id: 1, name: &quot;dishes&quot;}, {id: 2, name: &quot;lawn&quot;}]
}
</code></pre>
<p>Set <code>parseListProp</code> to <code>&quot;todos&quot;</code> like:</p>
<pre><code>connect([
...
<script type="text/javascript">
  window.docObject = {"description":"\nThe property to find the array-like data that represents each instance item.\n","types":[{"type":"String","description":"[can-connect/data/parse/parse.parseListData] uses this property to find an array-like data struture\non the result of [can-connect/connection.getListData].\n"}],"title":"parseListProp","name":"can-connect/data/parse/parse.parseListProp","type":"property","parent":"can-connect/data/parse/parse","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
