...
<!--####################################################################
	...
	@property can-connect/data/combine-requests.time
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - time</title>
...
<div class="breadcrumb">
	...
	<li><a href="combine-requests.time.html">time</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>time</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/combine-requests/combine-requests.js#L186">Edit on GitHub</a>
				</li>
    ...
    <p>Specifies the amount of time to wait to combine requests.</p>
...
<div class="signature">
  ...
  <p>Defaults to <code>1</code>, meaning only requests made within the same &quot;thread of execution&quot; will be
combined (i.e requests made before the browser takes a break from the ongoing JavaScript execution).</p>
<p>Increasing this number will mean that requests are delayed that length of time in case other requests
are made. In general, we advise against increasing this amount of time except in cases where loads take a
significant amount of time and the increased delay is unlikely to be noticed.</p>
