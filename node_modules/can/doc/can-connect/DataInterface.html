...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/data_interface.md
	@typedef can-connect/DataInterface
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - DataInterface</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>DataInterface</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/data_interface.md">Edit on GitHub</a>
				</li>
    ...
    <p>The most common <strong>raw</strong> data methods.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>DataInterface</code>
  </h2>
  <p>The <code>DataInterface</code> methods are the methods most used most commonly
by <code>can-connect</code> behaviors to get or mutate information in some form of
persisted storage.  The <code>DataInterface</code> methods only operate on <strong>raw</strong>
data comprised of plain JavaScript Objects, Arrays and primitive types.
This is in contrast to the <a href="InstanceInterface.html" title="The methods used to create, retrieve, update and destroy typed instances with a connection.">InstanceInterface</a> methods that
operate on typed data.</p>
<p>Those methods are:</p>
<ul>
<li><a href="connection.clear.html" title="Deletes all records on a connection.">clear</a> - Remove all records.</li>
<li><a href="connection.createData.html" title="Creates a new record in the connection.">createData</a> - Create a new record.</li>
<li><a href="connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> - Destroy a record.</li>
<li><a href="connection.getData.html" title="Retrieves a record.">getData</a> - Get a single record.</li>
<li><a href="connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> - Get multiple records.</li>
<li><a href="connection.getSets.html" title="Gets the sets that are available in the connection.">getSets</a> - Get the <a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a>s available within the persisted storage.</li>
<li><a href="connection.updateData.html" title="Updates a record in the collection.">updateData</a> - Update a single record.</li>
<li><a href="connection.updateListData.html" title="Updates records for a particular set in the connection.">updateListData</a> - Update multiple records.</li>
</ul>
<p>Behaviors either implement these methods or overwrite these methods to perform some
extra functionality.</p>
<p>For example, <a href="data/url/url.html" title="">data/url</a> implements these behaviors to
make an Ajax request like:</p>
...
<p>The <a href="data/parse/parse.html" title="Extract response data into a format needed for other extensions.">can-connect/data/parse/parse</a> behavior overwrites the <code>baseConnection</code>’s methods to
perform cleanup on the response data:</p>
<pre><code class="language-js">connect.behavior(&quot;data/parse&quot;, function(baseConnection) {
    return {
        getListData: function(set){
            var self = this;
