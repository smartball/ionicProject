...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/getListData.md
	@typedef can-connect/connection.getListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.getListData.html">getListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/getListData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Retrieves list of records for the given set.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>function(<a href="../can-set/Set.html" title="An object that represents a set of data.">set</a>)</code>
  </h2>
  <p>Returns a promise that resolves to a <a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> for a particular set.</p>
<pre><code class="language-js">connection.getListData({complete: true}).then(function(listData){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A object that represents the set of data needed to be loaded.  For example, <code>{complete: true}</code>
might represent the set of all completed records.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>&gt;}</code>: <p>A promise that resolves to the <a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a> format like:</p>
<pre><code class="language-js">{
  ...
  count: 1000
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/url/url.html" title="">data/url</a> make it easy to implement <code>getListData</code>, but it can be as simple as:</p>
<pre><code class="language-js">var connection = connect([],{
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/data_interface/getListData.md"},"description":"Retrieves list of records for the given set. \n","type":"typedef","title":"getListData","types":[{"type":"function","returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the [can-connect.listData] format like:\n\n```js\n{\n  data: [\n    {id: 1, name: \"take out the trash\"},\n    {id: 1, name: \"do the dishes\"}\n  ],\n  count: 1000\n}\n```\n"},"params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"A object that represents the set of data needed to be loaded.  For example, `{complete: true}`\nmight represent the set of all completed records.\n"}],"description":"\n\n  Returns a promise that resolves to a [can-connect.listData] for a particular set.  \n\n  ```js\n  connection.getListData({complete: true}).then(function(listData){\n\t  connection.hydrateList(listData);\n  });\n  ```\n"}],"name":"can-connect/connection.getListData","parent":"can-connect/DataInterface","_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"A object that represents the set of data needed to be loaded.  For example, `{complete: true}`\nmight represent the set of all completed records.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the [can-connect.listData] format like:\n\n```js\n{\n  data: [\n    {id: 1, name: \"take out the trash\"},\n    {id: 1, name: \"do the dishes\"}\n  ],\n  count: 1000\n}\n```\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
