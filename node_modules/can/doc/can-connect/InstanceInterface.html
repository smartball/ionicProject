...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/instance_interface/instance_interface.md
	@typedef can-connect/InstanceInterface
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - InstanceInterface</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>InstanceInterface</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/instance_interface/instance_interface.md">Edit on GitHub</a>
				</li>
    ...
    <p>The methods used to create, retrieve, update and destroy typed instances with a connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>InstanceInterface</code>
  </h2>
  <p>The <a href="constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> behavior is typically
used to implement the core instance interface methods:</p>
<ul>
<li><a href="connection.getList.html" title="Gets a can-connect.List of instances.">getList</a> - Get a list of instances.</li>
<li><a href="connection.get.html" title="">get</a> - Get a single instance.</li>
<li><a href="connection.save.html" title="Create or update an instance.">save</a> - Create or update an instance.</li>
<li><a href="connection.destroy.html" title="Destroy an instance.">destroy</a> - Destroy an instance.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/instance_interface/instance_interface.md"},"description":"The methods used to create, retrieve, update and destroy typed instances with a connection. \n","type":"typedef","title":"InstanceInterface","name":"can-connect/InstanceInterface","parent":"can-connect.types","signatures":[{"code":"InstanceInterface","description":"\n\nThe [can-connect/constructor/constructor] behavior is typically\nused to implement the core instance interface methods:\n\n - [can-connect/connection.getList] - Get a list of instances.\n - [can-connect/connection.get] - Get a single instance.\n - [can-connect/connection.save] - Create or update an instance.\n - [can-connect/connection.destroy] - Destroy an instance.\n","params":[]}],"pathToRoot":"../.."};
</script>
</article>
