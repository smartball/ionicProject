...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/getData.md
	@typedef can-connect/connection.getData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.getData.html">getData</a></li>
	...
	<div class="page-type">
		<h1>getData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/getData.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns a promise that resolves to the instance data for particular parameters.</p>
<p>The following shows how <a href="constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> calls <code>getData</code>
and what it does with the response:</p>
<pre><code class="language-js">connection.getData({id: 1}).then(function(instanceData){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>A object that represents the set of data needed to be loaded.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Object&gt;}</code>: <p>A promise that resolves to the properties of a record.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/url/url.html" title="">data/url</a> implement <code>getData</code>  but implementing it yourself can be as simple as:</p>
<pre><code class="language-js">var behavior = connect([],{
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/data_interface/getData.md"},"description":"Retrieves a record. \n","type":"typedef","title":"getData","types":[{"type":"function","returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the properties of a record.\n"},"params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"A object that represents the set of data needed to be loaded.\n"}],"description":"\n\n  Returns a promise that resolves to the instance data for particular parameters.\n\n  The following shows how [can-connect/constructor/constructor] calls `getData`\n  and what it does with the response:\n\n  ```js\n  connection.getData({id: 1}).then(function(instanceData){\n  \tconnection.hydrateInstance(instanceData);\n  });\n  ```\n"}],"name":"can-connect/connection.getData","parent":"can-connect/DataInterface","_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"A object that represents the set of data needed to be loaded.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[]}]}]}],"description":"A promise that resolves to the properties of a record.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
