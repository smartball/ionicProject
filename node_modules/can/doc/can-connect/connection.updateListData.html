...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/updateListData.md
	@typedef can-connect/connection.updateListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.updateListData.html">updateListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updateListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/updateListData.md">Edit on GitHub</a>
				</li>
    ...
    <p>Updates records for a particular set in the connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>function(<a href="../can-connect.listData.html" title="The data format used to create typed lists.">listData</a>, set)</code>
  </h2>
  <p>Returns a promise that resolves to the list data for a particular set.</p>
<pre><code class="language-js">connection.updateListData({
    data: [
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>A object that represents the set of data needed to be loaded.</p>
</li>
        
          <li><b>set</b> <code>{Object}</code>: <p>The set of data that is updating.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>&gt;}</code>: <p>A promise that resolves to the updated <a href="../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/data_interface/updateListData.md"},"description":"Updates records for a particular set in the connection. \n","type":"typedef","title":"updateListData","types":[{"type":"function","returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the updated [can-connect.listData].\n"},"params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"A object that represents the set of data needed to be loaded.\n"},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"set","description":"The set of data that is updating.\n"}],"description":"\n\n  Returns a promise that resolves to the list data for a particular set.\n\n  ```js\n  connection.updateListData({\n\t  data: [\n\t\t  {id: 1, name: \"dishes\", createdAt: 1477104548997}\n\t  ]\n  }, {}).then(function(listData){\n\t  listData //-> {\n\t  //\t  data: [\n\t  //\t\t  {id: 1, name: \"dishes\",\n\t  //\t\t   createdAt: 1477104548997, updatedAt: 1477104580000}\n\t  //\t  ]\n\t  //}\n  })\n  ```\n"}],"name":"can-connect/connection.updateListData","parent":"can-connect/DataInterface","_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"set","description":"The set of data that is updating.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.listData"}]}]}],"description":"A promise that resolves to the updated [can-connect.listData].\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
