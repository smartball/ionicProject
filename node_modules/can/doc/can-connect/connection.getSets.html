...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/data_interface/getSets.md
	@typedef can-connect/connection.getSets
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.getSets.html">getSets</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getSets</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/data_interface/getSets.md">Edit on GitHub</a>
				</li>
    ...
    <p>Gets the sets that are available in the connection.</p>
...
<div class="signature">
  ...
  <p>Returns a promise that resolves to a list of <a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a> objects contained in the
connection.  This is useful for querying a <a href="base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a>
if it will be able to satisfy a request.</p>
<p>An example response might look like:</p>
<pre><code class="language-js">connection.getSets().then(function(sets){
    sets //-&gt; [
    //   {complete: true},
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Array&lt;<a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a>&gt;&gt;}</code>: <p>A promise that resolves to an an array of sets.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/localstorage-cache/localstorage-cache.html" title="Saves raw data in localStorage.">localstorage-cache</a> implement
<code>.getSets</code> to provide the sets they contain.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/data_interface/getSets.md"},"description":"Gets the sets that are available in the connection. \n","type":"typedef","title":"getSets","types":[{"type":"function","returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-set/Set"}]}]}]}]}],"description":"A promise that resolves to an an array of sets.\n"},"params":[],"description":"\n\n  Returns a promise that resolves to a list of [can-set/Set] objects contained in the\n  connection.  This is useful for querying a [can-connect/base/base.cacheConnection]\n  if it will be able to satisfy a request.\n\n  An example response might look like:\n\n  ```js\n  connection.getSets().then(function(sets){\n\t  sets //-> [\n\t  //   {complete: true},\n\t  //   {userId: 5, start: 10, end: 20}\n\t  //]\n  })\n  ```\n"}],"name":"can-connect/connection.getSets","parent":"can-connect/DataInterface","_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-set/Set"}]}]}]}]}],"description":"A promise that resolves to an an array of sets.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
