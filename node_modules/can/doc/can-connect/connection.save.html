...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/instance_interface/save.md
	@function can-connect/connection.save
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
a map.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="connection.getList.html"
							title="Gets a can-connect.List of instances.">
							getList
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="connection.save.html"
							title="Create or update an instance.">
							save
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="InstanceInterface.html">InstanceInterface</a></li>
		<li> / </li>
	
	
	<li><a href="connection.save.html">save</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>save</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/instance_interface/save.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create or update an instance.</p>
...
<div class="signature">
  ...
  <p>Creates or updates an instance using the <code>connection</code> by calling
<a href="connection.createData.html" title="Creates a new record in the connection.">createData</a> or <a href="connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
...
<p>The choice of <a href="connection.createData.html" title="Creates a new record in the connection.">createData</a> or <a href="connection.updateData.html" title="Updates a record in the collection.">updateData</a> is made by the result of
<a href="constructor/constructor.isNew.html" title="Returns if the instance has not been loaded from or saved to the data source.">isNew</a>.</p>
<p>Note that <a href="can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds <code>save</code> to the <code>instance</code>
type's prototype.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>A typed instance.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p>Returns a promise that
resolve with created or updated instance if <a href="connection.createData.html" title="Creates a new record in the connection.">createData</a> or <a href="connection.updateData.html" title="Updates a record in the collection.">updateData</a> is resolved.  The promise is rejected if <a href="connection.createData.html" title="Creates a new record in the connection.">createData</a> or <a href="connection.updateData.html" title="Updates a record in the collection.">updateData</a> is rejected.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/instance_interface/save.md"},"description":"\nCreate or update an instance.\n","title":"save","name":"can-connect/connection.save","type":"function","parent":"can-connect/InstanceInterface","signatures":[{"code":"connection.save( instance )","description":"\n\nCreates or updates an instance using the `connection` by calling\n[can-connect/connection.createData] or [can-connect/connection.updateData].\n\n```js\n// create an instance\nvar instance = new Type();\n\n// create it with the connection\nconnection.save( instance ).then(function(instance){\n\n\t// change the instance\n\tinstance.prop = \"NEW VALUE\";\n\n\t// update it with the connection\n\tconnection.save( instance ).then(function(instance){\n\n\t});\n\n});\n```\n\nThe choice of [can-connect/connection.createData] or [can-connect/connection.updateData] is made by the result of\n[can-connect/constructor/constructor.isNew].\n\n\n\nNote that [can-connect/can/map/map] adds `save` to the `instance`\ntype's prototype.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"A typed instance.\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"Returns a promise that\nresolve with created or updated instance if [can-connect/connection.createData] or [can-connect/connection.updateData] is resolved.  The promise is rejected if [can-connect/connection.createData] or [can-connect/connection.updateData] is rejected.\n"}}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"A typed instance.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"Returns a promise that\nresolve with created or updated instance if [can-connect/connection.createData] or [can-connect/connection.updateData] is resolved.  The promise is rejected if [can-connect/connection.createData] or [can-connect/connection.updateData] is rejected.\n"},"pathToRoot":"../.."};
</script>
</article>
