...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/instance_interface/getList.md
	@function can-connect/connection.getList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.getList.html">getList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/instance_interface/getList.md">Edit on GitHub</a>
				</li>
    ...
    <p>Gets a <a href="../can-connect.List.html" title="A list type.">List</a> of instances.</p>
...
<div class="signature">
  ...
  <p>Gets a <a href="../can-connect.List.html" title="A list type.">List</a> of instances using the <code>connection</code> by calling
<a href="connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a>.</p>
<pre><code class="language-js">connection.getList({parentId: 5}).then(function(list){

});
</code></pre>
<p>Note that <a href="can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds <code>getList</code> to the <code>instance</code>'s
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>A set object that represents the list of data to load.</p>
</li>
...
resolve with a <code>List</code> if <a href="connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> is resolved.  The promise is rejected if <a href="connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> is rejected.</p>
</p>
  </div>
