...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/helpers/map-deep-merge.js
	@module can-connect/helpers/map-deep-merge
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - map-deep-merge</title>
...
<div class="breadcrumb">
	...
	<li><a href="map-deep-merge.html">./helpers/map-deep-merge</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>map-deep-merge</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/helpers/map-deep-merge.js#L12">Edit on GitHub</a>
				</li>
    ...
    <p>Perform a smart merge of deeply nested maps and lists.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>mapDeepMerge( instance, data )</code>
  </h2>
  <p>The <code>can-connect/helpers/map-deep-merge</code> module exports a function that
merges nested <a href="../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> or <a href="../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> instances.</p>
<pre><code>var mapDeepMerge = require('can-connect/helpers/map-deep-merge');
...
<p>To properly know how to merge <a href="../../can-define.html" title="Exports the define method that defines observable properties and their behavior on a prototype object.">can-define</a> instances of a <a href="../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>,
<code>mapDeepMerge</code> needs to know how to:</p>
<ul>
<li>uniquely identify the instances</li>
<li>create instances from raw data (hydration)</li>
</ul>
<p><code>mapDeepMerge</code> solves this by first identifying the <a href="../../can-define.types.TypeConstructor.html" title="Provides a constructor function to be used to convert any set value into an appropriate
value.">Type</a>
of the <a href="../../can-define/list/list.prototype.wildcardItems.html" title="Define default behavior for items in the list.">#</a> (index) property definition.</p>
<p>With the <code>Type</code> known of each item in the list, <code>mapDeepMerge</code> looks for for a <code>Type.algebra</code> to
specify the unique <a href="../../can-set.props.id.html" title="Defines the identify property.">id</a> of <code>Type</code> instances.  If <code>Type.algebra</code> does
not exist, it looks for an <code>id</code> and then <code>_id</code> property.</p>
<p>With the <code>Type</code> known of each item in the list, <code>mapDeepMerge</code> looks for a <code>Type.connection.hydrateInstance(props)</code>
method.  If one does not exist, <code>new Type(props)</code> is used instead.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>|can-define/map/list}</code>: <p>An instance to apply a merge to.</p>
</li>
        
          <li><b>data</b> <code>{Object|Array}</code>: <p>An object or array with the updated data.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>This method is often used by mixing in the <a href="../can/merge/merge.html" title="Minimally update nested data structures with the response from the server.">can/merge</a> behavior
into a connection.</p>
<p>It can be used directly to update a <a href="../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> instance or
<a href="../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> instance with nested data as follows:</p>
<pre><code class="language-js">var mapDeepMerge = require(&quot;can-connect/helpers/map-deep-merge&quot;);
...
<p>This will create the following changes:</p>
<pre><code class="language-js">// 1 - a property update
