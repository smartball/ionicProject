...
<!--####################################################################
	...
	@module can-connect/helpers/weak-reference-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - WeakReferenceMap</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>WeakReferenceMap</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/helpers/weak-reference-map.js#L3">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a map that only contains keys that are referenced.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new WeakReferenceMap()</code>
  </h2>
  <p>Creates a new weak reference map.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code>var WeakReferenceMap = require(&quot;can-connect/helpers/weak-reference-map&quot;);
...
<script type="text/javascript">
  window.docObject = {"type":"module","name":"can-connect/helpers/weak-reference-map","parent":"can-connect.modules","src":{"line":2,"codeLine":32,"path":"node_modules/can-connect/helpers/weak-reference-map.js"},"description":"\nProvides a map that only contains keys that are referenced.\n","title":"WeakReferenceMap","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"new WeakReferenceMap()","description":"\n\n  Creates a new weak reference map.\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
