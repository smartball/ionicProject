...
<!--####################################################################
	...
	@function can-connect/helpers/weak-reference-map.prototype.addReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addReference</title>
...
<div class="breadcrumb">
	...
	<li><a href="weak-reference-map.prototype.addReference.html">addReference</a></li>
	...
	<div class="page-type">
		<h1>addReference</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/helpers/weak-reference-map.js#L57">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>WeakReferenceMap.addReference(key, item)</code>
  </h2>
  <p>Adds a reference to item as key and increments the reference count. This should be called
when a value should be managed by something, typically the <a href="../constructor/store/store.html" title="Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
