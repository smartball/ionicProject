...
<!--####################################################################
	...
	@function can-connect/helpers/weak-reference-map.prototype.forEach
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - forEach</title>
...
<div class="breadcrumb">
	...
	<li><a href="weak-reference-map.prototype.forEach.html">forEach</a></li>
	...
	<div class="page-type">
		<h1>forEach</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/helpers/weak-reference-map.js#L121">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>weakReferenceMap.forEach(callback)</code>
  </h2>
  <p>Calls <code>callback</code> for every value in the store.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(item, key)}</code>: <p>A callback handler.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/helpers/weak-reference-map.prototype.forEach","parent":"can-connect/helpers/weak-reference-map.prototype","src":{"line":120,"codeLine":128,"path":"node_modules/can-connect/helpers/weak-reference-map.js"},"description":"","title":"forEach","signatures":[{"code":"weakReferenceMap.forEach(callback)","description":"\n\n  Calls `callback` for every value in the store.\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"item"},{"types":[{"type":"String"}],"name":"key"}]}],"name":"callback","description":"A callback handler.\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}],"name":"item"},{"types":[{"type":"String"}],"name":"key"}]}],"name":"callback","description":"A callback handler.\n "},"pathToRoot":"../../.."};
</script>
</article>
