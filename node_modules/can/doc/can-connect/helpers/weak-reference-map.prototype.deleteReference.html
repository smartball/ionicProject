...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/helpers/weak-reference-map.js
	@function can-connect/helpers/weak-reference-map.prototype.deleteReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - deleteReference</title>
...
a map.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="weak-reference-map.prototype.addReference.html"
							title="can-connect/helpers/weak-reference-map.prototype.addReference">
							addReference
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="weak-reference-map.prototype.deleteReference.html"
							title="can-connect/helpers/weak-reference-map.prototype.deleteReference">
							deleteReference
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="weak-reference-map.prototype.forEach.html"
							title="can-connect/helpers/weak-reference-map.prototype.forEach">
							forEach
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="weak-reference-map.prototype.get.html"
							title="can-connect/helpers/weak-reference-map.prototype.get">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="weak-reference-map.prototype.has.html"
							title="can-connect/helpers/weak-reference-map.prototype.has">
							has
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="weak-reference-map.html">./helpers/weak-reference-map</a></li>
		<li> / </li>
	
	
	<li><a href="weak-reference-map.prototype.deleteReference.html">deleteReference</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>deleteReference</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/helpers/weak-reference-map.js#L88">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>weakReferenceMap.deleteReference(key)</code>
  </h2>
  <p>Decrements the reference count for key and removes it if the reference count is <code>0</code>. This should be called
when a value should not be managed by something, typically the <a href="../constructor/store/store.html" title="Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key of the item in the store.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/helpers/weak-reference-map.prototype.deleteReference","parent":"can-connect/helpers/weak-reference-map.prototype","src":{"line":87,"codeLine":96,"path":"node_modules/can-connect/helpers/weak-reference-map.js"},"description":"","title":"deleteReference","signatures":[{"code":"weakReferenceMap.deleteReference(key)","description":"\n\n  Decrements the reference count for key and removes it if the reference count is `0`. This should be called\n  when a value should not be managed by something, typically the [can-connect/constructor/store/store].\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The key of the item in the store.\n "}]}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The key of the item in the store.\n "},"pathToRoot":"../../.."};
</script>
</article>
