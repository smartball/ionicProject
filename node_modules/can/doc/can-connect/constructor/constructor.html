...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/constructor/constructor.js
	@module can-connect/constructor/constructor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - constructor</title>
...
instances when instances are created outside of the can-connect connection.">
					...
					<li class="
           						...
           						">
						<a class="module"
							href="callbacks-once/callbacks-once.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor.instance.html"
							title="Behavior option provided to create a typed form of passed raw data.">
							instance
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor.list.html"
							title="Behavior option provided to create a typed list from a raw array.">
							list
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.destroy.html"
							title="Delete an instance from the connection data source">
							destroy
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.get.html"
							title="Retrieve a single instance from the connection data source.">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.getList.html"
							title="Retrieve a list of instances from the connection data source.">
							getList
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.save.html"
							title="Create or update an instance on the connection data source">
							save
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.createdInstance.html"
							title="A method run whenever a new instance has been saved to the data source. Updates the instance with response data.">
							createdInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.destroyedInstance.html"
							title="A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.">
							destroyedInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.updatedInstance.html"
							title="A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
data.">
							updatedInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.updatedList.html"
							title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.hydrateInstance.html"
							title="Produce a typed object containing the provided raw data.">
							hydrateInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.hydrateList.html"
							title="Produce a typed list from the provided raw list data.">
							hydrateList
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.serializeInstance.html"
							title="Generate the serialized form of a typed instance.">
							serializeInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor.serializeList.html"
							title="Generate the serialized form of a typed list.">
							serializeList
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor.cidStore.html"
							title="Temporarily hold references to new instances via their cid while they are undergoing creation.">
							cidStore
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>constructor</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L3">Edit on GitHub</a>
				</li>
    ...
    <p>Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>constructor( baseConnection )</code>
  </h2>
  <p>Adds an interface that allows the connection to operate on custom types. These fall into the categories:</p>
<ul>
<li><a href="constructor.html#CRUDMethods" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">CRUD Methods</a> - create, read, update and delete typed instances via the data source</li>
<li><a href="constructor.html#CRUDCallbacks" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">CRUD Callbacks</a> - activities run on typed instances following data source operations</li>
<li><a href="constructor.html#Hydrator" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">Hydrators</a> - conversion of raw data to typed data</li>
<li><a href="constructor.html#Serializers" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">Serializers</a> - conversion of typed data to raw data</li>
</ul>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>constructor</code> behavior added
on to it.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A <code>can-connect</code> connection containing the method implementations provided by <code>constructor</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>constructor</code> behavior allows you to instantiate the raw representation of the data source's data into a
custom typed representation with additional methods and behaviors.
An example might be loading data from a <code>&quot;/todos&quot;</code> service and being able to call <code>.timeLeft()</code>  on the todos that
you get back like:</p>
<pre><code>todoConnection.get({id: 6}).then(function(todo){
  todo.timeLeft() //-&gt; 60000
})
</code></pre>
<p>The following creates a <code>todoConnection</code> that does exactly that:</p>
<pre><code>// require connection plugins
...
<p>The <code>constructor</code> behavior is still useful even if you want to keep your data as untyped objects (which is the
default behavior when no <a href="constructor.instance.html" title="Behavior option provided to create a typed form of passed raw data."><code>instance</code></a> implementation is provided).  The
behavior provides an interface to the data held by the client. For example,
<a href="constructor.updatedInstance.html" title="A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
data.">updatedInstance</a> provides an extension point for logic that needs to be executed
after an instance held by the client finishes an update request. This is valuable whether that instance is typed or not.
Extensions like <a href="../real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a> or <a href="../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a>
require this interface for advanced behavior.</p>
<h2>Interface</h2>
<p><code>constructor</code> provides the following categories of methods to interact with typed data:</p>
<h3><span id="CRUDMethods">CRUD Methods</span></h3>
<p>Methods that create, read, update and delete (CRUD) typed representations of raw connection data:</p>
<ul>
<li><a href="constructor.get.html" title="Retrieve a single instance from the connection data source.">get</a> - retrieve a single typed instance from the data source</li>
<li><a href="constructor.getList.html" title="Retrieve a list of instances from the connection data source.">getList</a> - retrieve a typed list of instances from the data source</li>
<li><a href="constructor.save.html" title="Create or update an instance on the connection data source">save</a> - save a typed instance's data to the data source</li>
<li><a href="constructor.destroy.html" title="Delete an instance from the connection data source">destroy</a> - delete a typed instance's data from the data source</li>
</ul>
<h3><span id="CRUDCallbacks">CRUD Callbacks</span></h3>
<p>&quot;CRUD Methods&quot; call these methods with request response data and a related instance. Their implementation here
updates the related instance with that data:</p>
<ul>
<li><a href="constructor.createdInstance.html" title="A method run whenever a new instance has been saved to the data source. Updates the instance with response data.">createdInstance</a> - after <a href="constructor.save.html" title="Create or update an instance on the connection data source">saving</a> new instance to data source, update that instance with response data</li>
<li><a href="constructor.updatedInstance.html" title="A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
data.">updatedInstance</a> - after <a href="constructor.save.html" title="Create or update an instance on the connection data source">saving</a> existing instance to data source, update that instance with response data</li>
<li><a href="constructor.destroyedInstance.html" title="A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.">destroyedInstance</a> - after <a href="constructor.destroy.html" title="Delete an instance from the connection data source">deleting</a> instance from data source, update that instance with response data</li>
<li><a href="constructor.updatedList.html" title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">updatedList</a> - after new data is read from the data source, update an existing list with instances created from that data</li>
</ul>
<h3><span id="CRUDMethods">Hydrators</span></h3>
<p>These methods are used to create a typed instance or typed list given raw data objects:</p>
<ul>
<li><a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a> - create a typed instance given raw instance data</li>
<li><a href="constructor.hydrateList.html" title="Produce a typed list from the provided raw list data.">hydrateList</a> - create a typed list of typed instances given given raw list data</li>
</ul>
<h3><span id="Serializers">Serializers</span></h3>
<p>These methods convert a typed instance or typed list into a raw object:</p>
<ul>
<li><a href="constructor.serializeInstance.html" title="Generate the serialized form of a typed instance.">serializeInstance</a> - return raw data representing the state of the typed instance argument</li>
<li><a href="constructor.serializeList.html" title="Generate the serialized form of a typed list.">serializeList</a> - return raw data representing the state of the typed list argument</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/constructor/constructor","type":"module","parent":"can-connect.behaviors","src":{"line":2,"codeLine":116,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nAdds an interface to interact with custom types via the connection instead of plain Objects and Arrays.\n","title":"constructor","types":[{"type":"connect.Behavior"}],"signatures":[{"code":"constructor( baseConnection )","description":"\n\nAdds an interface that allows the connection to operate on custom types. These fall into the categories:\n- [can-connect/constructor/constructor#CRUDMethods CRUD Methods] - create, read, update and delete typed instances via the data source\n- [can-connect/constructor/constructor#CRUDCallbacks CRUD Callbacks] - activities run on typed instances following data source operations\n- [can-connect/constructor/constructor#Hydrator Hydrators] - conversion of raw data to typed data\n- [can-connect/constructor/constructor#Serializers Serializers] - conversion of typed data to raw data\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `constructor` behavior added\non to it.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A `can-connect` connection containing the method implementations provided by `constructor`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `constructor` behavior added\non to it.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A `can-connect` connection containing the method implementations provided by `constructor`.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
