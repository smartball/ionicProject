...
<!--####################################################################
	...
	@property can-connect/constructor/constructor.instance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - instance</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.instance.html">instance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>instance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L674">Edit on GitHub</a>
				</li>
    ...
    <p>Behavior option provided to create a typed form of passed raw data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.instance( props )</code>
  </h2>
  <p>Creates a typed instance for the passed raw data object. This method is passed as an option to the connection.
Called by <a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>a raw object containing the properties from the data source</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the typed instance created from the passed <code>props</code> object</p>
<h3>Usage</h3>
<p>The following example makes the connection produce <code>Todo</code> typed objects including a <code>complete</code> method:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":673,"codeLine":725,"path":"node_modules/can-connect/constructor/constructor.js"},"type":"property","description":"\nBehavior option provided to create a typed form of passed raw data.\n","title":"instance","name":"can-connect/constructor/constructor.instance","parent":"can-connect/constructor/constructor.options","signatures":[{"code":"connection.instance( props )","description":"\n\nCreates a typed instance for the passed raw data object. This method is passed as an option to the connection.\nCalled by [can-connect/constructor/constructor.hydrateInstance].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"a raw object containing the properties from the data source"}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"the typed instance created from the passed `props` object\n\n### Usage\n\nThe following example makes the connection produce `Todo` typed objects including a `complete` method:\n\n```\nvar constructor = require(\"can-connect/constructor/\");\nvar dataUrl = require(\"can-connect/data/url/\");\n\n// define type constructor\nvar Todo = function(rawData){\n  // add raw data to new instance\n  Object.assign(this, rawData);\n};\n\n// add methods to custom type\nTodo.prototype.complete = function(){\n  this.completed = true;\n}\n\n// create connection\nvar todosConnection = connect([constructor, dataUrl], {\n  url: \"/todos\",\n  instance: function(rawData) {\n    return new Todo(rawData);\n  }\n});\n\n// use connection to get typed instance & use custom method\ntodosConnection.get({id: 5}).then(function(todo){\n  todo.completed; // false\n  todo.complete();\n  todo.completed; // true\n});\n```\n\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"a raw object containing the properties from the data source"},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"the typed instance created from the passed `props` object\n\n### Usage\n\nThe following example makes the connection produce `Todo` typed objects including a `complete` method:\n\n```\nvar constructor = require(\"can-connect/constructor/\");\nvar dataUrl = require(\"can-connect/data/url/\");\n\n// define type constructor\nvar Todo = function(rawData){\n  // add raw data to new instance\n  Object.assign(this, rawData);\n};\n\n// add methods to custom type\nTodo.prototype.complete = function(){\n  this.completed = true;\n}\n\n// create connection\nvar todosConnection = connect([constructor, dataUrl], {\n  url: \"/todos\",\n  instance: function(rawData) {\n    return new Todo(rawData);\n  }\n});\n\n// use connection to get typed instance & use custom method\ntodosConnection.get({id: 5}).then(function(todo){\n  todo.completed; // false\n  todo.complete();\n  todo.completed; // true\n});\n```\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
