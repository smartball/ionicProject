...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.hydrateInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="constructor.hydrateInstance.html">hydrateInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L259">Edit on GitHub</a>
				</li>
    ...
    <p>Produce a typed object containing the provided raw data.</p>
...
<div class="signature">
  ...
  <p>If <a href="constructor.instance.html" title="Behavior option provided to create a typed form of passed raw data.">instance</a> has been passed as an option, or defined by another behavior,
pass <code>props</code> to it and return the value. Otherwise, return a clone of <code>props</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the raw instance data returned by the data source, often via <a href="../connection.getData.html" title="Retrieves a record.">getData</a></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>a typed instance containing the data from <code>props</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.hydrateInstance","parent":"can-connect/constructor/constructor.hydrators","src":{"line":258,"codeLine":272,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nProduce a typed object containing the provided raw data.\n","title":"hydrateInstance","signatures":[{"code":"connection.hydrateInstance(props)","description":"\n\nIf [can-connect/constructor/constructor.instance] has been passed as an option, or defined by another behavior,\npass `props` to it and return the value. Otherwise, return a clone of `props`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw instance data returned by the data source, often via [can-connect/connection.getData]"}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"a typed instance containing the data from `props`\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw instance data returned by the data source, often via [can-connect/connection.getData]"},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"a typed instance containing the data from `props`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
