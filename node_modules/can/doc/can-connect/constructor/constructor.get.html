...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="constructor.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L143">Edit on GitHub</a>
				</li>
    ...
    <p>Retrieve a single instance from the connection data source.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.get(params)</code>
  </h2>
  <p>Retrieves instance data from <a href="../connection.getData.html" title="Retrieves a record.">getData</a>, runs the resulting data through
<a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a>, creating a typed instance with the retrieved data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>data specifying the instance to retrieve.  Normally, this is something like like:
<code>{id: 5}</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p><code>Promise</code> resolving to the instance returned by
<a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a>.</p>
<h3>Usage</h3>
<p>Call <code>.get()</code> with the parameters that identify the instance you want to load.  <code>.get()</code> will return a promise
that resolves to that instance:</p>
<pre><code>todoConnection.get({id: 6}).then(function(todo){
  todo.id; // 6
  todo.name; // 'Take out the garbage'
});
</code></pre>
<p><code>.get()</code> above will call <a href="../connection.getData.html" title="Retrieves a record."><code>getData</code></a> on the <a href="../data/url/url.html" title="">data/url</a>
behavior, which will make an HTTP GET request to <code>/todos/6</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.get","parent":"can-connect/constructor/constructor.crud","src":{"line":142,"codeLine":173,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nRetrieve a single instance from the connection data source.\n","title":"get","signatures":[{"code":"connection.get(params)","description":"\n\nRetrieves instance data from [can-connect/connection.getData], runs the resulting data through\n[can-connect/constructor/constructor.hydrateInstance], creating a typed instance with the retrieved data.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"data specifying the instance to retrieve.  Normally, this is something like like:\n`{id: 5}`.\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` resolving to the instance returned by\n[can-connect/constructor/constructor.hydrateInstance].\n\n### Usage\n\nCall `.get()` with the parameters that identify the instance you want to load.  `.get()` will return a promise\nthat resolves to that instance:\n```\ntodoConnection.get({id: 6}).then(function(todo){\n  todo.id; // 6\n  todo.name; // 'Take out the garbage'\n});\n```\n\n`.get()` above will call [can-connect/connection.getData `getData`] on the [can-connect/data/url/url]\nbehavior, which will make an HTTP GET request to `/todos/6`.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"data specifying the instance to retrieve.  Normally, this is something like like:\n`{id: 5}`.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` resolving to the instance returned by\n[can-connect/constructor/constructor.hydrateInstance].\n\n### Usage\n\nCall `.get()` with the parameters that identify the instance you want to load.  `.get()` will return a promise\nthat resolves to that instance:\n```\ntodoConnection.get({id: 6}).then(function(todo){\n  todo.id; // 6\n  todo.name; // 'Take out the garbage'\n});\n```\n\n`.get()` above will call [can-connect/connection.getData `getData`] on the [can-connect/data/url/url]\nbehavior, which will make an HTTP GET request to `/todos/6`.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
