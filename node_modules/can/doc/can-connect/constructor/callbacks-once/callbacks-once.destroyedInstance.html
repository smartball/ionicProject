...
<!--####################################################################
	...
	@function can-connect/constructor/callbacks-once/callbacks-once.destroyedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-once.destroyedInstance.html">destroyedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyedInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/callbacks-once/callbacks-once.js#L54">Edit on GitHub</a>
				</li>
    ...
    <p><code>destroyedInstance</code> callback handler that prevents sequential calls with the same arguments.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>destroyedInstance(instance, data)</code>
  </h2>
  <p>Called with the instance created by <a href="../constructor.destroy.html" title="Delete an instance from the connection data source"><code>connection.destroy</code></a> and the response data of the
underlying request. Prevents sequential calls to the underlying <code>destroyedInstance</code> handlers with the same arguments.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b>: <p>the instance created by <code>connection.destroy</code></p>
</li>
        
          <li><b>data</b>: <p>the response data returned during <code>connection.destroy</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":53,"codeLine":66,"path":"node_modules/can-connect/constructor/callbacks-once/callbacks-once.js"},"type":"function","description":"\n`destroyedInstance` callback handler that prevents sequential calls with the same arguments.\n","title":"destroyedInstance","name":"can-connect/constructor/callbacks-once/callbacks-once.destroyedInstance","parent":"can-connect/constructor/callbacks-once/callbacks-once","signatures":[{"code":"destroyedInstance(instance, data)","description":"\nCalled with the instance created by [can-connect/constructor/constructor.destroy `connection.destroy`] and the response data of the\nunderlying request. Prevents sequential calls to the underlying `destroyedInstance` handlers with the same arguments.\n","params":[{"name":"instance","description":"the instance created by `connection.destroy`"},{"name":"data","description":"the response data returned during `connection.destroy`\n "}]}],"_curParam":{"name":"data","description":"the response data returned during `connection.destroy`\n "},"pathToRoot":"../../../.."};
</script>
</article>
