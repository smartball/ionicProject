...
<!--####################################################################
	...
	@function can-connect/constructor/callbacks-once/callbacks-once.updatedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-once.updatedInstance.html">updatedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/callbacks-once/callbacks-once.js#L40">Edit on GitHub</a>
				</li>
    ...
    <p><code>updatedInstance</code> callback handler that prevents sequential calls with the same arguments.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>updatedInstance(instance, data)</code>
  </h2>
  <p>Called with the instance updated by [can-connect/constructor/constructor.save<code>connection.save</code>] and the response data of the
underlying request. Prevents sequential calls to the underlying <code>updatedInstance</code> handlers with the same arguments.</p>
