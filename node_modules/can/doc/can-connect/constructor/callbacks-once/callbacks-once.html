...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/constructor/callbacks-once/callbacks-once.js
	@module can-connect/constructor/callbacks-once/callbacks-once
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - constructor/callbacks-once</title>
...
instances when instances are created outside of the can-connect connection.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.createdInstance.html"
							title="createdInstance callback handler that prevents sequential calls with the same arguments.">
							createdInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.destroyedInstance.html"
							title="destroyedInstance callback handler that prevents sequential calls with the same arguments.">
							destroyedInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.updatedInstance.html"
							title="updatedInstance callback handler that prevents sequential calls with the same arguments.">
							updatedInstance
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-once.html">./constructor/callbacks-once/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>constructor/callbacks-once</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/callbacks-once/callbacks-once.js">Edit on GitHub</a>
				</li>
    ...
    <p>Prevents duplicate calls to the instance callback methods.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>callbacksOnce( baseConnection )</code>
  </h2>
  <p>Prevents duplicate calls to the instance callback methods by tracking the last data the methods were called with.
If called with the same data again, it does not call the base connection's instance callback.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>callbacks-once</code> behavior added
on to it. Should already contain the behaviors that provide the Instance Callbacks
(e.g <a href="../constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a>). If the <code>connect</code> helper is used to build the connection, the
behaviors will automatically be ordered as required.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A <code>can-connect</code> connection containing the methods provided by <code>callbacks-once</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/constructor/callbacks-once/callbacks-once","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":19,"path":"node_modules/can-connect/constructor/callbacks-once/callbacks-once.js"},"description":"\nPrevents duplicate calls to the instance callback methods.\n","title":"constructor/callbacks-once","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"callbacksOnce( baseConnection )","description":"\n\n  Prevents duplicate calls to the instance callback methods by tracking the last data the methods were called with.\n  If called with the same data again, it does not call the base connection's instance callback.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `callbacks-once` behavior added\non to it. Should already contain the behaviors that provide the Instance Callbacks\n(e.g [can-connect/constructor/constructor]). If the `connect` helper is used to build the connection, the\nbehaviors will automatically be ordered as required.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A `can-connect` connection containing the methods provided by `callbacks-once`.\n\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `callbacks-once` behavior added\non to it. Should already contain the behaviors that provide the Instance Callbacks\n(e.g [can-connect/constructor/constructor]). If the `connect` helper is used to build the connection, the\nbehaviors will automatically be ordered as required.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A `can-connect` connection containing the methods provided by `callbacks-once`.\n\n"},"pathToRoot":"../../../.."};
</script>
</article>
