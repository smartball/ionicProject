...
<!--####################################################################
	...
	@function can-connect/constructor/callbacks-once/callbacks-once.createdInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="callbacks-once.createdInstance.html">createdInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/callbacks-once/callbacks-once.js#L26">Edit on GitHub</a>
				</li>
    ...
    <p><code>createdInstance</code> callback handler that prevents sequential calls with the same arguments.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>createdInstance(instance, data)</code>
  </h2>
  <p>Called with the instance created by <a href="../constructor.save.html" title="Create or update an instance on the connection data source"><code>connection.save</code></a> and the response data of the
underlying request. Prevents sequential calls to the underlying <code>createdInstance</code> handlers with the same arguments.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b>: <p>the instance created by <code>connection.save</code></p>
</li>
        
          <li><b>data</b>: <p>the response data returned during <code>connection.save</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":25,"codeLine":38,"path":"node_modules/can-connect/constructor/callbacks-once/callbacks-once.js"},"type":"function","description":"\n`createdInstance` callback handler that prevents sequential calls with the same arguments.\n","title":"createdInstance","name":"can-connect/constructor/callbacks-once/callbacks-once.createdInstance","parent":"can-connect/constructor/callbacks-once/callbacks-once","signatures":[{"code":"createdInstance(instance, data)","description":"\nCalled with the instance created by [can-connect/constructor/constructor.save `connection.save`] and the response data of the\nunderlying request. Prevents sequential calls to the underlying `createdInstance` handlers with the same arguments.\n","params":[{"name":"instance","description":"the instance created by `connection.save`"},{"name":"data","description":"the response data returned during `connection.save`\n "}]}],"_curParam":{"name":"data","description":"the response data returned during `connection.save`\n "},"pathToRoot":"../../../.."};
</script>
</article>
