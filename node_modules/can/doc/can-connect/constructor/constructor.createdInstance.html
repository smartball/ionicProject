...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.createdInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="constructor.createdInstance.html">createdInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L470">Edit on GitHub</a>
				</li>
    ...
    <p>A method run whenever a new instance has been saved to the data source. Updates the instance with response data.</p>
...
<div class="signature">
  ...
  <p><code>createdInstance</code> is run whenever a new instance is saved to the data source. This implementation updates the
instance with the data returned by <a href="../connection.createData.html" title="Creates a new record in the connection.">createData</a> which made the request to save the raw
instance data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the data returned from <a href="../connection.createData.html" title="Creates a new record in the connection.">createData</a> that will update the properties of <code>instance</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.createdInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":469,"codeLine":484,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nA method run whenever a new instance has been saved to the data source. Updates the instance with response data.\n","title":"createdInstance","signatures":[{"code":"connection.createdInstance( instance, props )","description":"\n\n`createdInstance` is run whenever a new instance is saved to the data source. This implementation updates the\ninstance with the data returned by [can-connect/connection.createData] which made the request to save the raw\ninstance data.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance that was created"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.createData] that will update the properties of `instance`\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.createData] that will update the properties of `instance`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
