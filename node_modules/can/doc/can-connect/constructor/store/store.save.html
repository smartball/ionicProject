...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.save
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="store.save.html">save</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>save</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L626">Edit on GitHub</a>
				</li>
    ...
    <p>Extends the underlying <a href="../../connection.save.html" title="Create or update an instance.">save</a> so any <a href="store.hydrateInstance.html" title="Returns an instance given raw data, returning it from the store.instanceStore if
...
returning different instances.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{Object}</code>: <p>a typed instance being saved</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p><code>Promise</code> returned by the underlying behavior's <a href="../../connection.save.html" title="Create or update an instance.">save</a></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.save","parent":"can-connect/constructor/store/store.crud","src":{"line":625,"codeLine":641,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nExtends the underlying [can-connect/connection.save] so any [can-connect/constructor/store/store.hydrateInstance instances hydrated]\nduring this request are kept in the store until all the concurrent requests complete.\n","title":"save","signatures":[{"code":"connection.save( instance )","description":"\n\nIncrements an internal request counter so instances hydrated during this request will be stored, and then\ndecrements the counter after the request is complete. This prevents concurrent requests for the same data from\nreturning different instances.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instance","description":"a typed instance being saved"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.save]\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instance","description":"a typed instance being saved"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.save]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
