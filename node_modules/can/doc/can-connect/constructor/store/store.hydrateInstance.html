...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.hydrateInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - hydrateInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.hydrateInstance.html">hydrateInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L482">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an instance given raw data, returning it from the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> if
available.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.hydrateInstance(props)</code>
  </h2>
  <p>Overwrites the base <code>hydrateInstance</code> so that if a matching instance is in the
<a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>, that instance will be
...
data.">updated</a> with <code>props</code> and returned.  If there isn't a
matching instance, the base <code>hydrateInstance</code> will be called.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the raw data used to create an instance</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>a typed instance either created or updated with the data from <code>props</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.hydrateInstance","parent":"can-connect/constructor/store/store.hydrators","src":{"line":481,"codeLine":497,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nReturns an instance given raw data, returning it from the [can-connect/constructor/store/store.instanceStore] if\navailable.\n","title":"hydrateInstance","signatures":[{"code":"connection.hydrateInstance(props)","description":"\nOverwrites the base `hydrateInstance` so that if a matching instance is in the\n[can-connect/constructor/store/store.instanceStore], that instance will be\n[can-connect/constructor/constructor.updatedInstance updated] with `props` and returned.  If there isn't a\nmatching instance, the base `hydrateInstance` will be called.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw data used to create an instance"}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"a typed instance either created or updated with the data from `props`.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw data used to create an instance"},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"a typed instance either created or updated with the data from `props`.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
