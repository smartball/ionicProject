...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.addInstanceReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addInstanceReference</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.addInstanceReference.html">addInstanceReference</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>addInstanceReference</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L181">Edit on GitHub</a>
				</li>
    ...
    <p>Add a reference to the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> so an instance can be easily looked up.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.addInstanceReference( instance )</code>
  </h2>
  <p>Adds a reference to an instance by <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> to the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>.
Keeps a count of the number of references, removing the instance from the store when the count reaches 0.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance to add</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> contains a mapping of instances keyed by their
<a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>. The <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> is used to prevent creating
the same instance multiple times, and for finding active instance for a given id.  Instances need to be added to
this store for this to work.  To do this, call <code>addInstanceReference</code>:</p>
...
<p>Now, if you were to retrieve the same data sometime later, it would be the same instance:</p>
<pre><code>todoConnection.get({id: 5}).then(function( todo ){
  todo === originalTodo // true
});
</code></pre>
<p>The <code>.getData</code> response data (underlying the call to <code>todoConnection.get</code>) is passed, along with the existing todo
instance (<code>originalTodo</code>) to <a href="../constructor.updatedInstance.html" title="A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
data.">updatedInstance</a>. That updates the shared
instance with the newly retrieved data.</p>
<p>All the referenced instances are held in memory.  Use
...
collected.">deleteInstanceReference</a> to remove them.</p>
<p>Typically, <code>addInstanceReference</code> is called when something expresses interest in the instance, such
as an event binding, and <code>deleteInstanceReference</code> is called when the interest is removed.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.addInstanceReference","parent":"can-connect/constructor/store/store.stores","src":{"line":180,"codeLine":238,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nAdd a reference to the [can-connect/constructor/store/store.instanceStore] so an instance can be easily looked up.\n","title":"addInstanceReference","signatures":[{"code":"connection.addInstanceReference( instance )","description":"\nAdds a reference to an instance by [can-connect/base/base.id] to the [can-connect/constructor/store/store.instanceStore].\nKeeps a count of the number of references, removing the instance from the store when the count reaches 0.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to add\n"}]}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to add\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
