...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.hydratedList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - hydratedList</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.hydratedList.html">hydratedList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydratedList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L511">Edit on GitHub</a>
				</li>
    ...
    <p>Keeps new lists in the <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> for the lifetime of any concurrent
requests.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>hydratedList(list)</code>
  </h2>
  <p>Adds a reference for new lists for the lifetime of any concurrent requests. Called when a new list is
created during <a href="store.hydrateList.html" title="Returns a list given raw data, returning it from the store.listStore if
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>the newly hydrated list</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.hydratedList","parent":"can-connect/constructor/store/store.hydrators","src":{"line":510,"codeLine":524,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nKeeps new lists in the [can-connect/constructor/store/store.listStore] for the lifetime of any concurrent\nrequests.\n","title":"hydratedList","signatures":[{"code":"hydratedList(list)","description":"\nAdds a reference for new lists for the lifetime of any concurrent requests. Called when a new list is\ncreated during [can-connect/constructor/store/store.hydrateList hydration]. This prevents concurrent requests\nfor the same data from returning different instances.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"the newly hydrated list\n\t "}]}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"the newly hydrated list\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
