...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.callbacks.createdInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - createdInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.callbacks.createdInstance.html">createdInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L250">Edit on GitHub</a>
				</li>
    ...
    <p>Calls <code>createdInstance</code> on the underlying behavior and moves the new instance from the <code>newInstanceStore</code> to
<code>instanceStore</code> if needed.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.createdInstance( instance, props )</code>
  </h2>
  <p>Calls the base behavior. Then calls <a href="store.stores.moveCreatedInstanceToInstanceStore.html" title="Moves recently created instances into the store.instanceStore.">moveCreatedInstanceToInstanceStore</a>
to move any pre-creation instance references to the standard instance reference store.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance that was created</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>the data returned from <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.callbacks.createdInstance","parent":"can-connect/constructor/store/store.callbacks","src":{"line":249,"codeLine":263,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nCalls `createdInstance` on the underlying behavior and moves the new instance from the `newInstanceStore` to\n`instanceStore` if needed.\n","title":"createdInstance","signatures":[{"code":"connection.createdInstance( instance, props )","description":"\nCalls the base behavior. Then calls [can-connect/constructor/store/store.stores.moveCreatedInstanceToInstanceStore]\nto move any pre-creation instance references to the standard instance reference store.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance that was created"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.createData]\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.createData]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
