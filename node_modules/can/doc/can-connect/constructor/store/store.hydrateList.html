...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.hydrateList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="store.hydrateList.html">hydrateList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L537">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a list given raw data, returning it from the <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> if
available.</p>
...
<div class="signature">
  ...
  <p>Overwrites the base <code>hydrateList</code> so that if a matching list is in the
<a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a>, that list will be
<a href="../constructor.updatedList.html" title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">updated</a> with <code>listData</code> and returned.
If there isn't a matching list, the base <code>hydrateList</code> will be called.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>raw list data to hydrate into a list type</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the parameters that represent the set of data in <code>listData</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{List}</code>: <p>a typed list from either created or updated with the data from <code>listData</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.hydrateList","parent":"can-connect/constructor/store/store.hydrators","src":{"line":536,"codeLine":554,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nReturns a list given raw data, returning it from the [can-connect/constructor/store/store.listStore] if\navailable.\n","title":"hydrateList","signatures":[{"code":"connection.hydrateList( listData, set )","description":"\n\n  Overwrites the base `hydrateList` so that if a matching list is in the\n  [can-connect/constructor/store/store.listStore], that list will be\n  [can-connect/constructor/constructor.updatedList updated] with `listData` and returned.\n  If there isn't a matching list, the base `hydrateList` will be called.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"raw list data to hydrate into a list type"},{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters that represent the set of data in `listData`"}],"returns":{"types":[{"type":"List"}],"description":"a typed list from either created or updated with the data from `listData`\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the parameters that represent the set of data in `listData`"},"_curReturn":{"types":[{"type":"List"}],"description":"a typed list from either created or updated with the data from `listData`\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
