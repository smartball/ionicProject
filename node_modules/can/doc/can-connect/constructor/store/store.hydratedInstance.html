...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.hydratedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - hydratedInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.hydratedInstance.html">hydratedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydratedInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L456">Edit on GitHub</a>
				</li>
    ...
    <p>Keeps new instances in the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> for the lifetime of any
...
<div class="signature">
  <h2 class="signature-title">
    <code>hydratedInstance(instance)</code>
  </h2>
  <p>Adds a reference for new instances for the lifetime of any concurrent requests. Called when a new instance is
created during <a href="store.hydrateInstance.html" title="Returns an instance given raw data, returning it from the store.instanceStore if
available.">hydration</a>. This prevents concurrent requests
for the same data from returning different instances.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the newly hydrated instance</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":455,"codeLine":469,"path":"node_modules/can-connect/constructor/store/store.js"},"type":"function","description":"\nKeeps new instances in the [can-connect/constructor/store/store.instanceStore] for the lifetime of any\nconcurrent requests.\n","title":"hydratedInstance","name":"can-connect/constructor/store/store.hydratedInstance","parent":"can-connect/constructor/store/store.hydrators","signatures":[{"code":"hydratedInstance(instance)","description":"\nAdds a reference for new instances for the lifetime of any concurrent requests. Called when a new instance is\ncreated during [can-connect/constructor/store/store.hydrateInstance hydration]. This prevents concurrent requests\nfor the same data from returning different instances.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the newly hydrated instance\n\t "}]}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the newly hydrated instance\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
