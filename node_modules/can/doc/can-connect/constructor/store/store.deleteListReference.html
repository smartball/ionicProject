...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.deleteListReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - deleteListReference</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.deleteListReference.html">deleteListReference</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>deleteListReference</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L421">Edit on GitHub</a>
				</li>
    ...
    <p>Removes a reference from the <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> so a list can can be garbage
collected.</p>
...
<div class="signature">
  ...
  <p>Decrements the number of references to a list in the <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a>.
Removes the list if there are no longer any references.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the list to remove</p>
<h3>Usage</h3>
<p><code>deleteListReference</code> is called to remove references to instances in the
<a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> so that lists maybe garbage collected.  It's usually called when
the application or some part of the application no longer is interested in a list.</p>
<p><a href="store.addListReference.html" title="Add a reference to the store.listStore so a list can be easily looked up.">addListReference</a> has an example of adding a list to the store.  The
following continues that example to remove the <code>dueToday</code> list from the store:</p>
<pre><code>todoConnection.deleteListReference(dueToday);
</code></pre>
