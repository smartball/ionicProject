...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="store.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L598">Edit on GitHub</a>
				</li>
    ...
    <p>Extends the underlying <a href="../../connection.get.html" title="">get</a> so any <a href="store.hydrateInstance.html" title="Returns an instance given raw data, returning it from the store.instanceStore if
...
returning different instances.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>params used to specify which instance to retrieve.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p><code>Promise</code> returned by the underlying behavior's <a href="../../connection.get.html" title="">get</a></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.get","parent":"can-connect/constructor/store/store.crud","src":{"line":597,"codeLine":612,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nExtends the underlying [can-connect/connection.get] so any [can-connect/constructor/store/store.hydrateInstance instances hydrated]\nduring this request are kept in the store until all the concurrent requests complete.\n","title":"get","signatures":[{"code":"connection.get( params )","description":"\nIncrements an internal request counter so instances hydrated during this request will be stored, and then\ndecrements the counter after the request is complete. This prevents concurrent requests for the same data from\nreturning different instances.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"params used to specify which instance to retrieve."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.get]\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"params used to specify which instance to retrieve."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.get]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
