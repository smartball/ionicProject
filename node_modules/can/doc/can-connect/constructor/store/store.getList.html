...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.getList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="store.getList.html">getList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L569">Edit on GitHub</a>
				</li>
    ...
    <p>Extends the underlying <a href="../../connection.getList.html" title="Gets a can-connect.List of instances.">getList</a> so any <a href="store.hydrateInstance.html" title="Returns an instance given raw data, returning it from the store.instanceStore if
...
all the concurrent requests complete.</p>
...
<div class="signature">
  ...
  <p>Increments an internal request counter so instances hydrated during this request will be stored, and then
decrements the counter after the request is complete. This prevents concurrent requests for the same data from
returning different instances.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listSet</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>parameters specifying the list to retrieve</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p><code>Promise</code> returned by the underlying behavior's <a href="../../connection.getList.html" title="Gets a can-connect.List of instances.">getList</a></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/store/store.getList","parent":"can-connect/constructor/store/store.crud","src":{"line":568,"codeLine":584,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nExtends the underlying [can-connect/connection.getList] so any [can-connect/constructor/store/store.hydrateInstance instances hydrated]\nor [can-connect/constructor/store/store.hydrateList lists hydrated] during this request are kept in the store until\nall the concurrent requests complete.\n","title":"getList","signatures":[{"code":"connection.getList( set )","description":"\nIncrements an internal request counter so instances hydrated during this request will be stored, and then\ndecrements the counter after the request is complete. This prevents concurrent requests for the same data from\nreturning different instances.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"listSet","description":"parameters specifying the list to retrieve"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.getList]\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"listSet","description":"parameters specifying the list to retrieve"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` returned by the underlying behavior's [can-connect/connection.getList]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
