...
<!--####################################################################
	...
	@property can-connect/constructor/store/store.instanceStore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - instanceStore</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.instanceStore.html">instanceStore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>instanceStore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L123">Edit on GitHub</a>
				</li>
    ...
    <p>A mapping of instances keyed by their <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code><a href="../../helpers/weak-reference-map.html" title="Provides a map that only contains keys that are referenced.">WeakReferenceMap</a></code>
  </h2>
  <p>Stores instances by their <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>. Holds instances based on reference counts which
are incremented by <a href="store.addInstanceReference.html" title="Add a reference to the store.instanceStore so an instance can be easily looked up.">addInstanceReference</a> and decremented by
...
collected.">deleteInstanceReference</a>. Once a reference count is 0, the instance is no
longer held in the store. Once a reference count is greater than 0, the instance is added to the store.</p>
<pre><code class="language-js">connection.addInstanceReference(todo5);
