...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/constructor/store/store.js
	@module can-connect/constructor/store/store
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - constructor/store</title>
...
application.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.addInstanceReference.html"
							title="Add a reference to the store.instanceStore so an instance can be easily looked up.">
					...
					<li class="
           						...
           						">
						<a class="property"
							href="store.addListReference.html"
							title="Add a reference to the store.listStore so a list can be easily looked up.">
							addListReference
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.deleteInstanceReference.html"
							title="Remove a reference from the store.instanceStore so an instance can be garbage
collected.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.deleteListReference.html"
							title="Removes a reference from the store.listStore so a list can can be garbage
collected.">
							deleteListReference
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="store.instanceStore.html"
							title="A mapping of instances keyed by their base.id.">
							instanceStore
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="store.listStore.html"
							title="A mapping of lists keyed by their base.listSet.">
							listStore
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.stores.moveCreatedInstanceToInstanceStore.html"
							title="Moves recently created instances into the store.instanceStore.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.callbacks.createdInstance.html"
							title="Calls createdInstance on the underlying behavior and moves the new instance from the newInstanceStore to
instanceStore if needed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.destroy.html"
							title="Extends the underlying connection.destroy so any instances hydrated
during this request are kept in the store until all the concurrent requests complete.">
					...
					<li class="
						...
						<a class="function"
							href="store.get.html"
							title="Extends the underlying connection.get so any instances hydrated
during this request are kept in the store until all the concurrent requests complete.">
							get
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.getList.html"
							title="Extends the underlying connection.getList so any instances hydrated
or lists hydrated during this request are kept in the store until
all the concurrent requests complete.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.save.html"
							title="Extends the underlying connection.save so any instances hydrated
during this request are kept in the store until all the concurrent requests complete.">
							save
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.hydrateInstance.html"
							title="Returns an instance given raw data, returning it from the store.instanceStore if
available.">
							hydrateInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.hydrateList.html"
							title="Returns a list given raw data, returning it from the store.listStore if
available.">
							hydrateList
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.hydratedInstance.html"
							title="Keeps new instances in the store.instanceStore for the lifetime of any
concurrent requests.">
							hydratedInstance
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="store.hydratedList.html"
							title="Keeps new lists in the store.listStore for the lifetime of any concurrent
requests.">
							hydratedList
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="store.html">./constructor/store/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>constructor/store</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js">Edit on GitHub</a>
				</li>
    ...
    <p>Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
application.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>constructorStore( baseConnection )</code>
  </h2>
  <p>Overwrites <code>baseConnection</code> so it contains a store for instances and lists.  This behavior:</p>
<ul>
<li>extends the <a href="store.hydrateInstance.html" title="Returns an instance given raw data, returning it from the store.instanceStore if
available.">hydrateInstance</a> and
<a href="store.hydrateList.html" title="Returns a list given raw data, returning it from the store.listStore if
available.">hydrateList</a> methods to return instances or lists from the store, if available</li>
<li>overwrites &quot;CRUD&quot; methods to make sure that while requests are pending, new lists and instances have references
kept in the store. This prevents duplicated instances from being created during concurrent requests.</li>
<li>provides methods to add and remove items in the store by counting references</li>
</ul>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>constructor/store</code> behavior added
on to it. Should already contain a behavior that provides the InstanceInteface
(e.g <a href="../constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a>). If the <code>connect</code> helper is used to build the connection, the behaviors
will automatically be ordered as required.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a <code>can-connect</code> connection containing the method implementations provided by <code>constructor/store</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>constructor-store</code> behavior is used to:</p>
<ul>
<li>provide a store of instances and lists in use by the client</li>
<li>prevent multiple instances from being generated for the same <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> or multiple
lists for the same <a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a>.</li>
</ul>
<p>The store provides access to an instance by its <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> or a list by its
<a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a>. This is used by other behaviors to lookup instances that should have changes applied.
Two examples, when there is a new instance that should be added to a list (<a href="../../real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a>) or
when newer data is available for a cached instance that is used in the page
(<a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a>).</p>
<p>Below you can see how <code>constructor-store</code>'s behavior be used to prevent multiple instances from being generated. This
example allows you to create multiple instances of a <code>todoEditor</code> that loads and edits a todo instance:</p>
<div class='demo_wrapper' data-demo-src='demos/can-connect/constructor-store.html'></div>
<p>You can see in this example that you can edit one todo and the other todos update.  This is because each <code>todoEditor</code>
is acting on same instance in memory. When it updates the todo's name here:</p>
<pre><code>var updateData = function(newName) {
  todo.name = newName; // update name on todo instance
  ...
};
</code></pre>
<p>The other widgets update because they are bound to the same instance:</p>
<pre><code>todo.on(&quot;name&quot;, updateElement); // when todo name changes update input element
todosConnection.addInstanceReference(todo); // previous line is a new usage of todo, so increase reference count
</code></pre>
<p>Each <code>todoEditor</code> receives the same instance because it was added to the
<a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">connnection.instanceStore</a> by
<a href="store.addInstanceReference.html" title="Add a reference to the store.instanceStore so an instance can be easily looked up.">addInstanceReference</a>. During all instance retrievals, a connection using the
<code>constructor/store</code> behavior checks the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> for an instance with a
matching <code>id</code> and return that if it exists. This example always requests <code>id: 5</code>, so all the <code>todoEditor</code>s use the
same instance held in the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>.</p>
<p>This widget cleans itself up when it is removed by removing the listener on the <code>todo</code> instance and
<a href="store.deleteInstanceReference.html" title="Remove a reference from the store.instanceStore so an instance can be garbage
collected.">reducing the instance reference count</a>:</p>
<pre><code>todo.off(&quot;name&quot;, updateElement); // stop listening to todo name change
todosConnection.deleteInstanceReference(todo); // previous line removed a usage of todo, so reduce reference count
</code></pre>
<p>This is done to prevent a memory leak produced by keeping instances in the <code>instanceStore</code> when they are no longer
needed by the application.</p>
<p><strong>Note:</strong> a hazard of sharing the same instance is that if new instance data is loaded from the server during
...
data.">updatedInstance</a> which updates the shared instance properties with the new
server data.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/constructor/store/store","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":89,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nAdds support for keeping references to active lists and instances. Prevents different copies of an instance from\nbeing used by the application at once. Allows other behaviors to look up instances currently active in the\napplication.\n","title":"constructor/store","types":[{"type":"connect.Behavior"}],"signatures":[{"code":"constructorStore( baseConnection )","description":"\n\nOverwrites `baseConnection` so it contains a store for instances and lists.  This behavior:\n- extends the [can-connect/constructor/store/store.hydrateInstance] and\n[can-connect/constructor/store/store.hydrateList] methods to return instances or lists from the store, if available\n- overwrites \"CRUD\" methods to make sure that while requests are pending, new lists and instances have references\nkept in the store. This prevents duplicated instances from being created during concurrent requests.\n- provides methods to add and remove items in the store by counting references\n","params":[{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `constructor/store` behavior added\non to it. Should already contain a behavior that provides the InstanceInteface\n(e.g [can-connect/constructor/constructor]). If the `connect` helper is used to build the connection, the behaviors\nwill automatically be ordered as required.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `constructor/store`.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"baseConnection","description":"`can-connect` connection object that is having the `constructor/store` behavior added\non to it. Should already contain a behavior that provides the InstanceInteface\n(e.g [can-connect/constructor/constructor]). If the `connect` helper is used to build the connection, the behaviors\nwill automatically be ordered as required.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a `can-connect` connection containing the method implementations provided by `constructor/store`.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
