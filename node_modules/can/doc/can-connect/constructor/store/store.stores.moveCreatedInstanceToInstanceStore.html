...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.stores.moveCreatedInstanceToInstanceStore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - moveCreatedInstanceToInstanceStore</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.stores.moveCreatedInstanceToInstanceStore.html">moveCreatedInstanceToInstanceStore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>moveCreatedInstanceToInstanceStore</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L271">Edit on GitHub</a>
				</li>
    ...
    <p>Moves recently created instances into the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>moveCreatedInstanceToInstanceStore( instance )</code>
  </h2>
  <p>Checks if an instance has an <code>id</code> and is in the <code>newInstanceStore</code>. If so, it adds it into the
<a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> and removes it from the <code>newInstanceStore</code>.</p>
<p>A new instances may have been added to the <code>newInstanceStore</code> if <a href="store.addInstanceReference.html" title="Add a reference to the store.instanceStore so an instance can be easily looked up.">addInstanceReference</a>
is called on is before the instance has been saved. This is done so we can keep track of references for unsaved
instances and update the references to be keyed by <code>id</code> when one is available. Without this a request for a
currently referenced instance that was just saved for the first time will erroneously result in a new instance.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>an instance.  If it was &quot;referenced&quot; (bound to) prior to
being created, this will check for that condition and move this instance into the
<a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>.</p>
</li>
