...
<!--####################################################################
	...
	@property can-connect/constructor/store/store.listStore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - listStore</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.listStore.html">listStore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>listStore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L145">Edit on GitHub</a>
				</li>
    ...
    <p>A mapping of lists keyed by their <a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a>.</p>
...
<div class="signature">
  ...
  <p>Stores lists by their <a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a>. Hold lists based on reference counts which are incremented
by <a href="store.addListReference.html" title="Add a reference to the store.listStore so a list can be easily looked up.">addListReference</a> and decremented by
<a href="store.deleteListReference.html" title="Removes a reference from the store.listStore so a list can can be garbage
collected.">deleteListReference</a>. Once a reference count is 0, the list is no
longer held in the store. Once a reference count is greater than 0, the list is added to the store.</p>
<pre><code class="language-js">connection.addInstanceReference(allTodos, {});
