...
<!--####################################################################
	...
	@property can-connect/constructor/store/store.addListReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - addListReference</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.addListReference.html">addListReference</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>addListReference</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L354">Edit on GitHub</a>
				</li>
    ...
    <p>Add a reference to the <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> so a list can be easily looked up.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.addListReference( list[, set] )</code>
  </h2>
  <p>Adds a reference to a list by <code>set</code> (or by <a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a>) to the
<a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a>.  Keeps a count of the number of references, removing the list
from the store when the count reaches 0.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>the list to add</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the set this list represents if it can't be identified with <a href="../../base/base.listSet.html" title="Uniquely identify the set of data a list contains.">listSet</a></p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> contains a mapping of lists keyed by their <code>set</code>. The
<a href="store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a> is used to prevent creating the same list multiple times and for
identifying a list for a given set. Lists need to be added to this store for this to work.  To do this, call
<code>addListReference</code>:</p>
<pre><code>// A basic connection:
...
<p>Now, if you were to retrieve the same set of data sometime later, it would be the same list instance:</p>
<pre><code>todoConnection.get({due: &quot;today&quot;}).then(function( todos ){
  todos === dueToday //-&gt; true
});
</code></pre>
<p>The <code>.getListData</code>  response data (underlying the call to <code>todoConnection.getList</code>) is passed, along with the
existing list (<code>dueToday</code>) to <a href="../constructor.updatedList.html" title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">updatedList</a>. That updates the shared list
instance with the newly retrieved data.</p>
<p>All the referenced lists stay in memory.  Use <a href="store.deleteListReference.html" title="Removes a reference from the store.listStore so a list can can be garbage
collected.">deleteListReference</a>
to remove them.</p>
<p>Typically, <code>addListReference</code> is called when something expresses interest in the list, such
as an event binding, and <code>deleteListReference</code> is called when interest is removed.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"property","name":"can-connect/constructor/store/store.addListReference","parent":"can-connect/constructor/store/store.stores","src":{"line":353,"codeLine":414,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nAdd a reference to the [can-connect/constructor/store/store.listStore] so a list can be easily looked up.\n","types":[{"type":"WeakReferenceMap"}],"title":"addListReference","signatures":[{"code":"connection.addListReference( list[, set] )","description":"\nAdds a reference to a list by `set` (or by [can-connect/base/base.listSet]) to the\n[can-connect/constructor/store/store.listStore].  Keeps a count of the number of references, removing the list\nfrom the store when the count reaches 0.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"the list to add"},{"types":[{"type":"can-set/Set"}],"optional":true,"name":"set","description":"the set this list represents if it can't be identified with [can-connect/base/base.listSet]\n"}]}],"_curParam":{"types":[{"type":"can-set/Set"}],"optional":true,"name":"set","description":"the set this list represents if it can't be identified with [can-connect/base/base.listSet]\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
