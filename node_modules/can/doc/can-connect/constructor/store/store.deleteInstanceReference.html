...
<!--####################################################################
	...
	@function can-connect/constructor/store/store.deleteInstanceReference
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - deleteInstanceReference</title>
...
<div class="breadcrumb">
	...
	<li><a href="store.deleteInstanceReference.html">deleteInstanceReference</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>deleteInstanceReference</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L315">Edit on GitHub</a>
				</li>
    ...
    <p>Remove a reference from the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> so an instance can be garbage
collected.</p>
...
<div class="signature">
  ...
  <p>Decrements the number of references to an instance in the <a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>.
Removes the instance if there are no longer any references.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance to remove</p>
<h3>Usage</h3>
<p><code>deleteInstanceReference</code> is called to remove references to instances in the
<a href="store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> so that instances maybe garbage collected.  It's usually
called when the application or some part of the application no longer is interested in an instance.</p>
<p><a href="store.addInstanceReference.html" title="Add a reference to the store.instanceStore so an instance can be easily looked up.">addInstanceReference</a> has an example of adding an instance to the store.
The following continues that example to remove the <code>originalTodo</code> instance from the store:</p>
<pre><code>todoConnection.deleteInstanceReference(originalTodo);
</code></pre>
<p>Also see the <a href="store.html#Use" title="Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
application.">usage example on the index page</a> for a more complete
example of the lifecycle of a reference.</p>
</li>
