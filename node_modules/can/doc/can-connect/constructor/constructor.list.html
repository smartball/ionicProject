...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/constructor/constructor.list
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - list</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.list.html">list</a></li>
  ...
  <section class="title">
    ...
    <p>Behavior option provided to create a typed list from a raw array.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.list( listData, set )</code>
  </h2>
  <p>Takes a <code>listData</code> argument with a <code>data</code> property, that is an array of typed instances, each produced by
<a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a>, and returns a new typed list containing those typed
instances.
This method is passed as an option to the connection.
Called by <a href="constructor.hydrateList.html" title="Produce a typed list from the provided raw list data.">hydrateList</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>an object with a <code>data</code> property, which is an array of instances.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the set description of this list</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>a typed list type containing the typed instances</p>
<h3>Usage</h3>
<p>The following example makes the connection produce <code>MyList</code> typed lists including a <code>completed</code> method:</p>
<pre><code>var constructor = require(&quot;can-connect/constructor/&quot;);
...
<p><strong>Note:</strong> we added the <a href="../base/base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> property (<code>__listSet</code> by default) on the list. This is
expected by other behaviors.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"description":"\nBehavior option provided to create a typed list from a raw array.\n","title":"list","name":"can-connect/constructor/constructor.list","type":"property","parent":"can-connect/constructor/constructor.options","signatures":[{"code":"connection.list( listData, set )","description":"\n\nTakes a `listData` argument with a `data` property, that is an array of typed instances, each produced by\n[can-connect/constructor/constructor.hydrateInstance], and returns a new typed list containing those typed\ninstances.\nThis method is passed as an option to the connection.\nCalled by [can-connect/constructor/constructor.hydrateList].\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"an object with a `data` property, which is an array of instances."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set description of this list"}],"returns":{"types":[{"type":"can-connect.List"}],"description":"a typed list type containing the typed instances\n\n### Usage\n\nThe following example makes the connection produce `MyList` typed lists including a `completed` method:\n\n```\nvar constructor = require(\"can-connect/constructor/\");\nvar dataUrl = require(\"can-connect/data/url/\");\n\n// define custom list type constructor\nvar MyList = function(items) {\n this.push.apply(this, items);\n}\n// inherit Array functionality\nMyList.prototype = Object.create(Array.prototype);\n// add custom methods to new list type\nMyList.prototype.completed = function(){\n return this.filter(function(){ return this.completed });\n};\n\n// create connection\nvar todosConnection = connect([constructor, dataUrl], {\n  url: \"/todos\",\n  list: function(listData, set){\n    // create custom list instance\n    var collection = new MyList(listData.data);\n    // add set info for use by other behaviors\n    collection.__listSet = set;\n    return collection;\n  }\n});\n\n// use connection to get typed list & use custom method\ntodosConnection.getList({}).then(function(todoList){\n  console.log(\"There are\", todoList.completed().length, \"completed todos\");\n});\n```\n\n**Note:** we added the [can-connect/base/base.listSetProp] property (`__listSet` by default) on the list. This is\nexpected by other behaviors.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set description of this list"},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"a typed list type containing the typed instances\n\n### Usage\n\nThe following example makes the connection produce `MyList` typed lists including a `completed` method:\n\n```\nvar constructor = require(\"can-connect/constructor/\");\nvar dataUrl = require(\"can-connect/data/url/\");\n\n// define custom list type constructor\nvar MyList = function(items) {\n this.push.apply(this, items);\n}\n// inherit Array functionality\nMyList.prototype = Object.create(Array.prototype);\n// add custom methods to new list type\nMyList.prototype.completed = function(){\n return this.filter(function(){ return this.completed });\n};\n\n// create connection\nvar todosConnection = connect([constructor, dataUrl], {\n  url: \"/todos\",\n  list: function(listData, set){\n    // create custom list instance\n    var collection = new MyList(listData.data);\n    // add set info for use by other behaviors\n    collection.__listSet = set;\n    return collection;\n  }\n});\n\n// use connection to get typed list & use custom method\ntodosConnection.getList({}).then(function(todoList){\n  console.log(\"There are\", todoList.completed().length, \"completed todos\");\n});\n```\n\n**Note:** we added the [can-connect/base/base.listSetProp] property (`__listSet` by default) on the list. This is\nexpected by other behaviors.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
