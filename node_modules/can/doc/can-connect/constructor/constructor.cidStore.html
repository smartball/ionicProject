...
<!--####################################################################
	...
	@property can-connect/constructor/constructor.cidStore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - cidStore</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.cidStore.html">cidStore</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>cidStore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L129">Edit on GitHub</a>
				</li>
    ...
    <p>Temporarily hold references to new instances via their <a href="../../can-util/js/cid/cid.html" title="Deprecated. Use can-cid instead.">cid</a> while they are undergoing creation.</p>
...
<div class="signature">
  ...
  <p>Temporarily holds references to instances by
<a href="../../can-util/js/cid/cid.html" title="Deprecated. Use can-cid instead.">cid</a> when they are in the process of being created and don't yet have an <code>id</code>s. This is typically
accessed in <code>createdData</code> handlers (e.g <a href="../real-time/real-time.createdData.html" title="Called whenever instance data is created.">real-time.createdData</a>) that
need to lookup the instance that was being created during a particular request.</p>
