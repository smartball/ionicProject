...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.updatedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - updatedInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.updatedInstance.html">updatedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L489">Edit on GitHub</a>
				</li>
    ...
    <p>A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updatedInstance( instance, props )</code>
  </h2>
  <p><code>updatedInstance</code> is run whenever an existing instance is saved to the data source. This implementation overwrites
the instance with the data returned bu [can-connect/connection.updatedData] which made the request to save the
modified instance data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance that was updated</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>the data from <a href="../connection.updateData.html" title="Updates a record in the collection.">updateData</a> that will overwrite the properties of <code>instance</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.updatedInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":488,"codeLine":504,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nA method run whenever an existing instance has been saved to the data source. Overwrites the instance with response\ndata.\n","title":"updatedInstance","signatures":[{"code":"connection.updatedInstance( instance, props )","description":"\n\n`updatedInstance` is run whenever an existing instance is saved to the data source. This implementation overwrites\nthe instance with the data returned bu [can-connect/connection.updatedData] which made the request to save the\nmodified instance data.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance that was updated"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data from [can-connect/connection.updateData] that will overwrite the properties of `instance`\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data from [can-connect/connection.updateData] that will overwrite the properties of `instance`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
