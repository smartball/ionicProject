...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.serializeInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - serializeInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.serializeInstance.html">serializeInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serializeInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L559">Edit on GitHub</a>
				</li>
    ...
    <p>Generate the serialized form of a typed instance.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.serializeInstance( instance )</code>
  </h2>
  <p>Generate a raw object representation of a typed instance. This default implementation simply clones the
<code>instance</code> object, copying all the properties of the object (excluding properties of it's prototypes) to a new
object. This is equivalent to <code>Object.assign({}, instance)</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance to serialize</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a serialized representation of the instance</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.serializeInstance","parent":"can-connect/constructor/constructor.serializers","src":{"line":558,"codeLine":573,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"Generate the serialized form of a typed instance. \n","title":"serializeInstance","signatures":[{"code":"connection.serializeInstance( instance )","description":"\n\n  Generate a raw object representation of a typed instance. This default implementation simply clones the\n  `instance` object, copying all the properties of the object (excluding properties of it's prototypes) to a new\n  object. This is equivalent to `Object.assign({}, instance)`.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to serialize"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"a serialized representation of the instance\n\t "}}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to serialize"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"a serialized representation of the instance\n\t "},"pathToRoot":"../../.."};
</script>
</article>
