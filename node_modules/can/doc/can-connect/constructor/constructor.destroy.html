...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.destroy
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - destroy</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.destroy.html">destroy</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroy</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L406">Edit on GitHub</a>
				</li>
    ...
    <p>Delete an instance from the connection data source</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.destroy( instance )</code>
  </h2>
  <p>To destroy an instance, it's <a href="constructor.serializeInstance.html" title="Generate the serialized form of a typed instance.">serialized data</a> is passed
to <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>. If <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>'s promise resolves to anything
other than <code>undefined</code>, <a href="constructor.destroyedInstance.html" title="A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.">destroyedInstance</a> is called.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance being deleted from the data source</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;}</code>: <p><code>Promise</code> resolving to the same instance that was passed to <code>destroy</code></p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use <code>destroy</code>, create a connection, retrieve an instance, and then call <code>.destroy()</code> with it.</p>
...
<p><code>.destroy()</code> above will call <a href="../connection.destroyData.html" title="Destroys a record in the collection."><code>destroyData</code></a> on the <a href="../data/url/url.html" title="">data/url</a>
behavior, which will make an HTTP DELETE request to <code>/todos/5</code> with the serialized <code>todo</code> data.  The server
response data may look something like:</p>
<pre><code>{
  deleted: true
}
</code></pre>
<p>That response data will be passed to <a href="constructor.destroyedInstance.html" title="A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.">destroyedInstance</a>, which by default
adds those properties to <code>todo</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":405,"codeLine":454,"path":"node_modules/can-connect/constructor/constructor.js"},"type":"function","description":"Delete an instance from the connection data source \n","title":"destroy","name":"can-connect/constructor/constructor.destroy","parent":"can-connect/constructor/constructor.crud","signatures":[{"code":"connection.destroy( instance )","description":"\n\n  To destroy an instance, it's [can-connect/constructor/constructor.serializeInstance serialized data] is passed\n  to [can-connect/connection.destroyData]. If [can-connect/connection.destroyData]'s promise resolves to anything\n  other than `undefined`, [can-connect/constructor/constructor.destroyedInstance] is called.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance being deleted from the data source\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` resolving to the same instance that was passed to `destroy`\n"}}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance being deleted from the data source\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect/Instance"}]}]}],"description":"`Promise` resolving to the same instance that was passed to `destroy`\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
