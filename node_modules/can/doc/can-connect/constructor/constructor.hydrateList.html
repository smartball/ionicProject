...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.hydrateList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - hydrateList</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.hydrateList.html">hydrateList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L221">Edit on GitHub</a>
				</li>
    ...
    <p>Produce a typed list from the provided raw list data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.hydrateList(listData, set)</code>
  </h2>
  <p>Call <a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a> for each item in the raw list data, and then call
<a href="constructor.list.html" title="Behavior option provided to create a typed list from a raw array.">list</a> with an array of the typed instances returned from
<a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrateInstance</a> .  If <a href="constructor.list.html" title="Behavior option provided to create a typed list from a raw array.">list</a> is not
provided as an argument or implemented by another behavior, a normal array is created.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>the raw list data returned by the data source, often via <a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a></p>
</li>
        
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>description of the set of data <code>listData</code> represents</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>a typed list containing typed instances generated from <code>listData</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.hydrateList","parent":"can-connect/constructor/constructor.hydrators","src":{"line":220,"codeLine":238,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nProduce a typed list from the provided raw list data.\n","title":"hydrateList","signatures":[{"code":"connection.hydrateList(listData, set)","description":"\n\n  Call [can-connect/constructor/constructor.hydrateInstance] for each item in the raw list data, and then call\n  [can-connect/constructor/constructor.list] with an array of the typed instances returned from\n  [can-connect/constructor/constructor.hydrateInstance] .  If [can-connect/constructor/constructor.list] is not\n  provided as an argument or implemented by another behavior, a normal array is created.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"the raw list data returned by the data source, often via [can-connect/connection.getListData]"},{"types":[{"type":"can-set/Set"}],"name":"set","description":"description of the set of data `listData` represents\n"}],"returns":{"types":[{"type":"can-connect.List"}],"description":"a typed list containing typed instances generated from `listData`\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"description of the set of data `listData` represents\n"},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"a typed list containing typed instances generated from `listData`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
