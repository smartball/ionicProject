...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.serializeList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - serializeList</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.serializeList.html">serializeList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serializeList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L578">Edit on GitHub</a>
				</li>
    ...
    <p>Generate the serialized form of a typed list.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.serializeList( list )</code>
  </h2>
  <p>Generate a raw array representation of a typed list. This default implementation simply returns a plain <code>Array</code>
containing the result of calling <a href="constructor.serializeInstance.html" title="Generate the serialized form of a typed instance.">serializeInstance</a> on each item in the
typed list.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>The instance to serialize.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object|Array}</code>: <p>A serialized representation of the list.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.serializeList","parent":"can-connect/constructor/constructor.serializers","src":{"line":577,"codeLine":592,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"Generate the serialized form of a typed list. \n","title":"serializeList","signatures":[{"code":"connection.serializeList( list )","description":"\n\n  Generate a raw array representation of a typed list. This default implementation simply returns a plain `Array`\n  containing the result of calling [can-connect/constructor/constructor.serializeInstance] on each item in the\n  typed list.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"The instance to serialize."}],"returns":{"types":[{"type":"Object"},{"type":"Array","options":[]}],"description":"A serialized representation of the list.\n\t "}}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"The instance to serialize."},"_curReturn":{"types":[{"type":"Object"},{"type":"Array","options":[]}],"description":"A serialized representation of the list.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
