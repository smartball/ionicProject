...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.getList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getList</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.getList.html">getList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L181">Edit on GitHub</a>
				</li>
    ...
    <p>Retrieve a list of instances from the connection data source.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.getList(set)</code>
  </h2>
  <p>Retrieves list data from <a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> and runs the resulting data through
<a href="constructor.hydrateList.html" title="Produce a typed list from the provided raw list data.">hydrateList</a>, creating a typed list of typed instances from  the retrieved
data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>data specifying the range of instances to retrieve. This might look something like:
<code>{start: 0, end: 50, due: 'today'}</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../../can-connect.List.html" title="A list type.">List</a>&lt;<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>&gt;&gt;}</code>: <p><code>Promise</code> resolving to the typed list returned by
<a href="constructor.hydrateList.html" title="Produce a typed list from the provided raw list data.">hydrateList</a>.</p>
<h3>Usage</h3>
<p>Call <code>getList</code> with the parameters that specify the set of data you want to load.  <code>.getList()</code> will return
a promise that resolves to a <a href="../../can-connect.List.html" title="A list type.">List</a> created from that set.</p>
<pre><code>todoConnection.getList({due: 'today'}).then(function(todos){
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.getList","parent":"can-connect/constructor/constructor.crud","src":{"line":180,"codeLine":211,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nRetrieve a list of instances from the connection data source.\n","title":"getList","signatures":[{"code":"connection.getList(set)","description":"\n\nRetrieves list data from [can-connect/connection.getListData] and runs the resulting data through\n[can-connect/constructor/constructor.hydrateList], creating a typed list of typed instances from  the retrieved\ndata.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"data specifying the range of instances to retrieve. This might look something like:\n```{start: 0, end: 50, due: 'today'}```\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.List","template":[{"types":[{"type":"can-connect/Instance"}]}]}]}]}],"description":"`Promise` resolving to the typed list returned by\n[can-connect/constructor/constructor.hydrateList].\n\n### Usage\n\nCall `getList` with the parameters that specify the set of data you want to load.  `.getList()` will return\na promise that resolves to a [can-connect.List] created from that set.\n\n```\ntodoConnection.getList({due: 'today'}).then(function(todos){\n  todos[0].name; // 'Take out the garbage'\n  todos[0].due > startOfDay && todos[0].due < endOfDay; // true\n})\n```\n\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"data specifying the range of instances to retrieve. This might look something like:\n```{start: 0, end: 50, due: 'today'}```\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.List","template":[{"types":[{"type":"can-connect/Instance"}]}]}]}]}],"description":"`Promise` resolving to the typed list returned by\n[can-connect/constructor/constructor.hydrateList].\n\n### Usage\n\nCall `getList` with the parameters that specify the set of data you want to load.  `.getList()` will return\na promise that resolves to a [can-connect.List] created from that set.\n\n```\ntodoConnection.getList({due: 'today'}).then(function(todos){\n  todos[0].name; // 'Take out the garbage'\n  todos[0].due > startOfDay && todos[0].due < endOfDay; // true\n})\n```\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
