...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.updatedList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - updatedList</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.updatedList.html">updatedList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L509">Edit on GitHub</a>
				</li>
    ...
    <p>A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updatedList( list, listData, set )</code>
  </h2>
  <p><a href="constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">Hydrates instances</a> from <code>listData</code>'s data and attempts to
merge them into <code>list</code>.  The merge is able to identify simple insertions and removals of elements instead of
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>an existing list</p>
</li>
        
          <li><b>listData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>raw data that should be included as part of <code>list</code> after conversion to typed instances</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>description of the set of data <code>list</code> represents</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.updatedList","parent":"can-connect/constructor/constructor.callbacks","src":{"line":508,"codeLine":525,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nA method run whenever new data for an existing list is retrieved from the data source. Updates the list to\ninclude the new data.\n","title":"updatedList","signatures":[{"code":"connection.updatedList( list, listData, set )","description":"\n\n[can-connect/constructor/constructor.hydrateInstance Hydrates instances] from `listData`'s data and attempts to\nmerge them into `list`.  The merge is able to identify simple insertions and removals of elements instead of\nreplacing the entire list.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"list","description":"an existing list"},{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"raw data that should be included as part of `list` after conversion to typed instances"},{"types":[{"type":"can-set/Set"}],"name":"set","description":"description of the set of data `list` represents\n\t "}]}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"description of the set of data `list` represents\n\t "},"pathToRoot":"../../.."};
</script>
</article>
