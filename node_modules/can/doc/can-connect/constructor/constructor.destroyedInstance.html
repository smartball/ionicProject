...
<!--####################################################################
	...
	@function can-connect/constructor/constructor.destroyedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - destroyedInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="constructor.destroyedInstance.html">destroyedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyedInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L539">Edit on GitHub</a>
				</li>
    ...
    <p>A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.destroyedInstance( instance, props )</code>
  </h2>
  <p><code>destroyedInstance</code> is run whenever an existing instance is deleted from the data source. This implementation
overwrites the instance with the data returned by <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> which made the request to
delete the raw instance data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance that was deleted</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>the data returned from <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> that will overwrite the
properties of <code>instance</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/constructor/constructor.destroyedInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":538,"codeLine":554,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nA method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.\n","title":"destroyedInstance","signatures":[{"code":"connection.destroyedInstance( instance, props )","description":"\n\n`destroyedInstance` is run whenever an existing instance is deleted from the data source. This implementation\noverwrites the instance with the data returned by [can-connect/connection.destroyData] which made the request to\ndelete the raw instance data.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance that was deleted"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.destroyData] that will overwrite the\nproperties of `instance`\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data returned from [can-connect/connection.destroyData] that will overwrite the\nproperties of `instance`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
