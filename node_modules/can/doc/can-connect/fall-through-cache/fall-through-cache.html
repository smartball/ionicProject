...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/fall-through-cache/fall-through-cache.js
	@module can-connect/fall-through-cache/fall-through-cache
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - fall-through-cache</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>fall-through-cache</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/fall-through-cache/fall-through-cache.js">Edit on GitHub</a>
				</li>
    ...
    <p>A fall through cache that checks another <code>cacheConnection</code>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>fallThroughCache( baseConnection )</code>
  </h2>
  <p>Implements a <code>getData</code> and <code>getListData</code> that
check their <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> for data and then
in the background update the instance or list with data
retrieved using the base connection.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use the <code>fall-through-cache</code>, create a connection with a
<a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> and a behavior that implements
<a href="../connection.getData.html" title="Retrieves a record.">getData</a> and <a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a>.</p>
<pre><code>var cache = connect([
...
<p>Then, make requests.  If the cache has the data,
it will be returned immediately, and then the item or list updated later
with the response from the base connection:</p>
<pre><code>todoConnection.getList({due: &quot;today&quot;}).then(function(todos){

})
</code></pre>
<h2>Demo</h2>
<p>The following shows the <code>fall-through-cache</code> behavior.</p>
...
display the results in the page:</p>
<pre><code>todoConnection.getList({completed: true});
todoConnection.getList({completed: false});
</code></pre>
<p>If you click back and forth between &quot;Completed&quot; and &quot;Incomplete&quot; multiple times
you'll notice that the old data is displayed immediately and then
updated after about a second.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/fall-through-cache/fall-through-cache","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":71,"path":"node_modules/can-connect/fall-through-cache/fall-through-cache.js"},"description":"\nA fall through cache that checks another `cacheConnection`.\n","title":"fall-through-cache","signatures":[{"code":"fallThroughCache( baseConnection )","description":"\n\n  Implements a `getData` and `getListData` that\n  check their [can-connect/base/base.cacheConnection] for data and then\n  in the background update the instance or list with data\n  retrieved using the base connection.\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
