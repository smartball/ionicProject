	...
	<div class="page-type">
		<h1>getListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/fall-through-cache/fall-through-cache.js#L117">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Checks the <a href="../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a> for <code>set</code>'s data.</p>
