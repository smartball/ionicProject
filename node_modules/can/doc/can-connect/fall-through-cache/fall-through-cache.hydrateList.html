...
<!--####################################################################
	...
	@function can-connect/fall-through-cache/fall-through-cache.hydrateList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="fall-through-cache.hydrateList.html">hydrateList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/fall-through-cache/fall-through-cache.js#L79">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a List instance given raw data.</p>
...
<div class="signature">
  ...
  <p>Calls the base <code>hydrateList</code> to create a List for <code>listData</code>.</p>
<p>Then, Looks for registered hydrateList callbacks for a given <code>set</code> and
calls them.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: </p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/fall-through-cache/fall-through-cache.hydrateList","parent":"can-connect/fall-through-cache/fall-through-cache.hydrators","src":{"line":78,"codeLine":95,"path":"node_modules/can-connect/fall-through-cache/fall-through-cache.js"},"description":"\nReturns a List instance given raw data.\n","title":"hydrateList","signatures":[{"code":"connection.hydrateList(listData, set)","description":"\n\n  Calls the base `hydrateList` to create a List for `listData`.\n\n  Then, Looks for registered hydrateList callbacks for a given `set` and\n  calls them.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":""},{"types":[{"type":"can-set/Set"}],"name":"set","description":""}],"returns":{"types":[{"type":"can-connect.List"}],"description":"\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":""},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"\n\t "},"pathToRoot":"../../.."};
</script>
</article>
