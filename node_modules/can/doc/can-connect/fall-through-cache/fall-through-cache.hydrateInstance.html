...
<!--####################################################################
	...
	@function can-connect/fall-through-cache/fall-through-cache.hydrateInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="fall-through-cache.hydrateInstance.html">hydrateInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hydrateInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/fall-through-cache/fall-through-cache.js#L185">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an instance given raw data.</p>
...
<div class="signature">
  ...
  <p>Calls the base <code>hydrateInstance</code> to create an Instance for <code>props</code>.</p>
<p>Then, Looks for registered hydrateInstance callbacks for a given <a href="../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> and
calls them.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: </p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/fall-through-cache/fall-through-cache.hydrateInstance","parent":"can-connect/fall-through-cache/fall-through-cache.hydrators","src":{"line":184,"codeLine":200,"path":"node_modules/can-connect/fall-through-cache/fall-through-cache.js"},"description":"\nReturns an instance given raw data.\n","title":"hydrateInstance","signatures":[{"code":"connection.hydrateInstance(props)","description":"\n\n  Calls the base `hydrateInstance` to create an Instance for `props`.\n\n  Then, Looks for registered hydrateInstance callbacks for a given [can-connect/base/base.id] and\n  calls them.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":""}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":""},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"\n\t "},"pathToRoot":"../../.."};
</script>
</article>
