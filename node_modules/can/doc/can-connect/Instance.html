...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/types/instance.md
	@typedef can-connect/Instance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>Instance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/types/instance.md">Edit on GitHub</a>
				</li>
    ...
    <p>An instance of some JavaScript type.</p>
...
<div class="signature">
  ...
  <p><code>can-connect</code> is primarily used to connect some form of <strong>typed data</strong> to
a service layer.  For example, the typed data might be a <code>Todo</code> with methods
like <code>todo.complete()</code> and the service layer might be a RESTful URL like
<code>https://myapp.com/todos</code>.</p>
<p><strong>Typed data</strong>, with methods, validation, type coercion, and other logic is
very useful to a client side developer.  However, a service layer
doesn't provide this functionality, instead it just provides raw data.</p>
<p><code>can-connect</code> is used to bridge the gap between <strong>typed data</strong> and the
raw data provided by the server.</p>
<p>An <code>Instance</code> represents some form of typed data. For example,
an <code>Instance</code> might represent an instance of the <code>Todo</code> type in the example above.</p>
<p>The <a href="constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> behavior is primarily responsible for
providing methods that go <a href="constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">back</a> and
<a href="constructor/constructor.serializeInstance.html" title="Generate the serialized form of a typed instance.">forth</a> between
instances and raw data.  Other behaviors like <a href="can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a>
extend this functionality.</p>
