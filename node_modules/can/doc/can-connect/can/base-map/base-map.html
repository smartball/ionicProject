...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/can/base-map/base-map.md
	@module can-connect/can/base-map/base-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/can/base-map/base-map</title>
...
<div class="breadcrumb">
	...
	<li><a href="base-map.html">./can/base-map/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/can/base-map/base-map</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/base-map/base-map.md">Edit on GitHub</a>
				</li>
...
<a href="../../constructor/callbacks-once/callbacks-once.html" title="Prevents duplicate calls to the instance callback methods.">constructor/callbacks-once</a>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>can-connect/can/base-map</code> module exports a helper function that creates a connection
with the &quot;standard&quot; behaviors in can-connect and hooks it up to a
<a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> and <a href="../../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>.</p>
...
<p>Next, call <code>baseMap</code> with all of the options needed by the behaviors that <code>baseMap</code> adds:</p>
<pre><code>var todoConnection = baseMap({
  Map: Todo,
  List: TodoList,
  url: &quot;/services/todos&quot;,
  name: &quot;todo&quot;
...
<p>As, <a href="../map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds CRUD methods to the <code>Map</code> option, you can use those to create,
