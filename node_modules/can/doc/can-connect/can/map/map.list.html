...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/can/map/map.js
	@function can-connect/can/map/map.list
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.list.html">list</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>list</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L211">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a <a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a> instance given raw data.</p>
...
<div class="signature">
  ...
  <p>Creates an instance of <a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a> if available, otherwise creates
<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>.List if available, and then finally defaulting to <a href="../../../can-types.DefaultList.html" title="">DefaultList</a>.</p>
<p>This will add properties on the raw <code>listData</code> array to the created list instance. e.g:</p>
<pre><code class="language-js">var listData = [{id: 1, name:&quot;do dishes&quot;}, ...];
...
todoList.loadedFrom; // &quot;shard 5&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>the raw list data.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the set the data belongs to.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>a <a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a> instance containing instances of
<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> built from the list items in <code>listData</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.list","parent":"can-connect/can/map/map.hydrators","src":{"line":210,"codeLine":235,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCreates a [can-connect/can/map/map._List] instance given raw data.\n","title":"list","signatures":[{"code":"connection.list(listData, set)","description":"\n\n  Creates an instance of [can-connect/can/map/map._List] if available, otherwise creates\n  [can-connect/can/map/map._Map].List if available, and then finally defaulting to [can-types.DefaultList].\n\n  This will add properties on the raw `listData` array to the created list instance. e.g:\n  ```js\n  var listData = [{id: 1, name:\"do dishes\"}, ...];\n  listData.loadedFrom; // \"shard 5\"\n\n  var todoList = todoConnection.list(listData, {});\n  todoList.loadedFrom; // \"shard 5\"\n  ```\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"the raw list data."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set the data belongs to."}],"returns":{"types":[{"type":"can-connect.List"}],"description":"a [can-connect/can/map/map._List] instance containing instances of\n[can-connect/can/map/map._Map] built from the list items in `listData`.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set the data belongs to."},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"a [can-connect/can/map/map._List] instance containing instances of\n[can-connect/can/map/map._Map] built from the list items in `listData`.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
