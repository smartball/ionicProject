...
<!--####################################################################
	...
	@function can-connect/can/map/map.prototype.isDestroying
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isDestroying</title>
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.isDestroying.html">isDestroying</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isDestroying</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L619">Edit on GitHub</a>
				</li>
    ...
    <p>Returns if the instance is currently being destroyed.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>instance.isDestroying()</code>
  </h2>
  <p>Observes if a promise returned by <a href="../../connection.destroy.html" title="Destroy an instance."><code>connection.destroy</code></a> is in progress for this
instance.  This is often used in a template like:</p>
<pre><code>&lt;button ($click)=&quot;todo.destroy()&quot;
...
&lt;/button&gt;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <a href="../../connection.destroy.html" title="Destroy an instance."><code>connection.destroy</code></a> has been called for this
instance but the returned promise has not resolved.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":618,"codeLine":639,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the instance is currently being destroyed.\n","title":"isDestroying","name":"can-connect/can/map/map.prototype.isDestroying","parent":"can-connect/can/map/map.map","signatures":[{"code":"instance.isDestroying()","description":"\n\nObserves if a promise returned by [can-connect/connection.destroy `connection.destroy`] is in progress for this\ninstance.  This is often used in a template like:\n\n```\n<button ($click)=\"todo.destroy()\"\n   {{#todo.isDestroying}}disabled{{/todo.isDestroying}}>\n  Delete\n</button>\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/connection.destroy `connection.destroy`] has been called for this\ninstance but the returned promise has not resolved.\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/connection.destroy `connection.destroy`] has been called for this\ninstance but the returned promise has not resolved.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
