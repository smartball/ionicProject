...
<!--####################################################################
	...
	@function can-connect/can/map/map.prototype.destroy
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.destroy.html">destroy</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroy</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L694">Edit on GitHub</a>
				</li>
    ...
    <p>Delete an instance from the service via the connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>instance.destroy(success, error)</code>
  </h2>
  <p>Calls <a href="../../connection.destroy.html" title="Destroy an instance.">destroy</a> for the <code>instance</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>success</b> <code>{function}</code>: <p>a function that is called if the <a href="../../connection.destroy.html" title="Destroy an instance.">destroy</a> call is successful.</p>
</li>
        
          <li><b>error</b> <code>{function}</code>: <p>a function that is called if the <a href="../../connection.destroy.html" title="Destroy an instance.">destroy</a> call is rejected.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Instance&gt;}</code>: <p>a promise that resolves to the instance if successful</p>
<h3>Usage</h3>
<pre><code>// import connection plugins
...
<script type="text/javascript">
  window.docObject = {"src":{"line":693,"codeLine":736,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nDelete an instance from the service via the connection.\n","title":"destroy","name":"can-connect/can/map/map.prototype.destroy","parent":"can-connect/can/map/map.map","signatures":[{"code":"instance.destroy(success, error)","description":"\n\nCalls [can-connect/connection.destroy] for the `instance`.\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"success","description":"a function that is called if the [can-connect/connection.destroy] call is successful."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"error","description":"a function that is called if the [can-connect/connection.destroy] call is rejected."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"a promise that resolves to the instance if successful\n\n### Usage\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// read instance\nTodo.get({id: 5}).then(function(todo){\n  if (todo.complete) {\n    // delete instance\n    todo.destroy();\n  }\n});\n```\n\t "}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"error","description":"a function that is called if the [can-connect/connection.destroy] call is rejected."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"a promise that resolves to the instance if successful\n\n### Usage\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// read instance\nTodo.get({id: 5}).then(function(todo){\n  if (todo.complete) {\n    // delete instance\n    todo.destroy();\n  }\n});\n```\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
