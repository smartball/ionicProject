...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/can/map/map.md
	@module can-connect/can/map/map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
instances when instances are created outside of the can-connect connection.">
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							href="map.get.html"
							title="Method added to the configured map._Map type. Retrieves an instance of the
map._Map type via the connection.">
							get
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">
							getList
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns the properties of an instance that should be sent to the data source when saving. Done by calling
instance.serialize().">
							serializeInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns the properties of a list that should be sent to the data source when saving. Done by calling
list.serialize().">
							serializeList
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Implements the constructor.createdInstance callback so it dispatches an event and
updates the instance.">
					...
					<li class="
						...
						<a class="function"
							...
							title="Implements the constructor.destroyedInstance callback so it dispatches an event and
updates the instance.">
							destroyedInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Implements the constructor.updatedInstance callback so it dispatches an event and
updates the instance.">
							updatedInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Implements the constructor.updatedList callback so it updates the list and it&#x27;s items
during a single batched event.">
							updatedList
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="map.html">./can/map/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can/map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.md">Edit on GitHub</a>
				</li>
    ...
    <p>Integrate a <code>can-connect</code> connection with a <a href="../../../can-define/map/map.html" title="Create observable objects.">DefineMap</a> type.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canMap( baseConnection )</code>
  </h2>
  <p>Extends the functionality of the <a href="../../constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> behavior so it integrates tightly
with <a href="../../../can-define/map/map.html" title="Create observable objects.">DefineMap</a> and <a href="../../../can-define/list/list.html" title="Create observable lists.">DefineList</a> types:</p>
<ul>
<li>adds methods to <a href="map.get.html" title="Method added to the configured map._Map type. Retrieves an instance of the
map._Map type via the connection.">read</a>, <a href="map.prototype.destroy.html" title="Delete an instance from the service via the connection.">destroy</a>,
<a href="map.prototype.save.html" title="Save the instance's data to the service via the connection.">create and update</a> instances (via the connection) to the
<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type</li>
<li>adds observable values to instances indicating if they are being <a href="map.prototype.isSaving.html" title="Returns if the instance is currently being saved.">saved</a>,
<a href="map.prototype.isDestroying.html" title="Returns if the instance is currently being destroyed.">deleted</a> or have
<a href="map.prototype.isNew.html" title="Returns if the instance has not been loaded from or saved to the data source.">not yet been saved</a></li>
<li>updates instances with the data from the response bodies of create, update and delete requests</li>
<li>triggers events on the <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type and instances when instances are created, destroyed or updated</li>
</ul>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{Object}</code>: <p><code>can-connect</code> connection object that is having the <code>can/map</code> behavior added on to it. Expects
the <a href="../../constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a> behavior to already be added to this base connection. If the <code>connect</code> helper
is used to build the connection, the behaviors will automatically be ordered as required.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>a <code>can-connect</code> connection containing the methods provided by <code>can/map</code>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>can/map</code> behavior links a connection to a <a href="../../../can-define/map/map.html" title="Create observable objects.">DefineMap</a> and <a href="../../../can-define/list/list.html" title="Create observable lists.">DefineList</a> type.
The connection will create those types of instances from the data it receives. It also adds convenient methods and
observable values to the <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> that offer connection functionality (e.g
<a href="map.prototype.save.html" title="Save the instance's data to the service via the connection."><code>instance.save</code></a>) and the status of the instance (e.g
<a href="map.prototype.isSaving.html" title="Returns if the instance is currently being saved."><code>instance.isSaving</code></a>).</p>
<p>To use the <code>can/map</code> behavior, first create a Map and List constructor function:</p>
...
<p>Next, pass the Map and List constructor functions to <code>connect</code> as options. The following creates connects the <code>Todo</code>
and <code>TodoList</code> types to a RESTful data service via the connection:</p>
...
<p>The connection itself can be used to create, read, update &amp; delete <code>Todo</code> and <code>TodoList</code>s:</p>
...
<p>... or instead of how it's done above, because <code>can/map</code> adds methods to the <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type, you
can use <code>Todo</code> to retrieve <code>Todo</code> and <code>TodoList</code>s:</p>
<pre><code class="language-js">Todo.getList({}).then(function(todos){ ... });
Todo.get({}).then(function(todo){ ... });
</code></pre>
<p>You can also create, update, and <a href="map.prototype.destroy.html" title="Delete an instance from the service via the connection.">destroy</a> <code>Todo</code> instances. Notice that
<a href="map.prototype.save.html" title="Save the instance's data to the service via the connection.">save</a> is used to create and update:</p>
<pre><code class="language-js">// create an instance
...
<p>There's also methods that let you know if an instance is in the process of being
<a href="map.prototype.isSaving.html" title="Returns if the instance is currently being saved.">saved</a> or <a href="map.prototype.isDestroying.html" title="Returns if the instance is currently being destroyed.">destroyed</a>:</p>
<pre><code class="language-js">var savePromise = new Todo({name: &quot;dishes&quot;}).save();
todo.isSaving() //-&gt; true
