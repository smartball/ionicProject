...
<!--####################################################################
	...
	@function can-connect/can/map/map.prototype.isNew
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.isNew.html">isNew</a></li>
	...
	<div class="page-type">
		<h1>isNew</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L576">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":575,"codeLine":584,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the instance has not been loaded from or saved to the data source.\n","title":"isNew","name":"can-connect/can/map/map.prototype.isNew","parent":"can-connect/can/map/map.map","signatures":[{"code":"instance.isNew()","description":"","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/base/base.id] is `null` or `undefined`\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/base/base.id] is `null` or `undefined`\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
