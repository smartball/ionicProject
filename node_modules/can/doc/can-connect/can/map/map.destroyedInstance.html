...
<!--####################################################################
	...
	@function can-connect/can/map/map.destroyedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.destroyedInstance.html">destroyedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyedInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L330">Edit on GitHub</a>
				</li>
    ...
    <p>Implements the <a href="../../constructor/constructor.destroyedInstance.html" title="A method run whenever an instance has been deleted from the data source. Overwrites the instance with response data.">destroyedInstance</a> callback so it dispatches an event and
...
<div class="signature">
  ...
  <p>Updates the instance with <code>props</code> and dispatches a &quot;destroyed&quot; event on the instance and the instances's
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the data in the response from <a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":329,"codeLine":344,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nImplements the [can-connect/constructor/constructor.destroyedInstance] callback so it dispatches an event and\nupdates the instance.\n","title":"destroyedInstance","name":"can-connect/can/map/map.destroyedInstance","parent":"can-connect/can/map/map.instance-callbacks","signatures":[{"code":"connection.destroyedInstance(instance, props)","description":"\n\n  Updates the instance with `props` and dispatches a \"destroyed\" event on the instance and the instances's\n  constructor function ([can-connect/can/map/map._Map]).\n","params":[{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"a [can-connect/can/map/map._Map] instance"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.destroyData]\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.destroyData]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
