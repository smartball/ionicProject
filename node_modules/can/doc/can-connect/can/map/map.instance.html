...
<!--####################################################################
	...
	@function can-connect/can/map/map.instance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.instance.html">instance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>instance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L192">Edit on GitHub</a>
				</li>
    ...
    <p>Creates a <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> instance given raw data.</p>
...
<div class="signature">
  ...
  <p>Create an instance of <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> if available, otherwise creates an instance of
<a href="../../../can-types.DefaultMap.html" title="">DefaultMap</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the raw instance data.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>}</code>: <p>a <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> instance containing the <code>props</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.instance","parent":"can-connect/can/map/map.hydrators","src":{"line":191,"codeLine":205,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCreates a [can-connect/can/map/map._Map] instance given raw data.\n","title":"instance","signatures":[{"code":"connection.instance(props)","description":"\n\n  Create an instance of [can-connect/can/map/map._Map] if available, otherwise creates an instance of\n  [can-types.DefaultMap].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw instance data."}],"returns":{"types":[{"type":"can-connect/can/map/map._Map"}],"description":"a [can-connect/can/map/map._Map] instance containing the `props`.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the raw instance data."},"_curReturn":{"types":[{"type":"can-connect/can/map/map._Map"}],"description":"a [can-connect/can/map/map._Map] instance containing the `props`.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
