...
<!--####################################################################
	...
	@function can-connect/can/map/map.updatedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.updatedInstance.html">updatedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L314">Edit on GitHub</a>
				</li>
    ...
    <p>Implements the <a href="../../constructor/constructor.updatedInstance.html" title="A method run whenever an existing instance has been saved to the data source. Overwrites the instance with response
...
<div class="signature">
  ...
  <p>Updates the instance with <code>props</code> and dispatches an &quot;updated&quot; event on the instance and the instances's
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>the data in the response from <a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":313,"codeLine":328,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nImplements the [can-connect/constructor/constructor.updatedInstance] callback so it dispatches an event and\nupdates the instance.\n","title":"updatedInstance","name":"can-connect/can/map/map.updatedInstance","parent":"can-connect/can/map/map.instance-callbacks","signatures":[{"code":"connection.updatedInstance(instance, props)","description":"\n\n  Updates the instance with `props` and dispatches an \"updated\" event on the instance and the instances's\n  constructor function ([can-connect/can/map/map._Map]).\n","params":[{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"a [can-connect/can/map/map._Map] instance"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.updateData]\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.updateData]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
