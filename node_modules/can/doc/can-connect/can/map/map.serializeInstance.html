...
<!--####################################################################
	...
	@function can-connect/can/map/map.serializeInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.serializeInstance.html">serializeInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serializeInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L80">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the properties of an instance that should be sent to the data source when saving. Done by calling
<a href="../../../can-define/map/map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children."><code>instance.serialize()</code></a>.</p>
...
<div class="signature">
  ...
  <p>Simply calls <a href="../../../can-define/map/map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children.">serialize</a> on the <code>instance</code> argument.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>}</code>: <p>the instance to serialize</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the result of calling <a href="../../../can-define/map/map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children."><code>instance.serialize()</code></a></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.serializeInstance","parent":"can-connect/can/map/map.serializers","src":{"line":79,"codeLine":92,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nReturns the properties of an instance that should be sent to the data source when saving. Done by calling\n[can-define/map/map.prototype.serialize `instance.serialize()`].\n","title":"serializeInstance","signatures":[{"code":"connection.serializeInstance(instance)","description":"\nSimply calls [can-define/map/map.prototype.serialize] on the `instance` argument.\n","params":[{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"the instance to serialize"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the result of calling [can-define/map/map.prototype.serialize `instance.serialize()`]\n\t "}}],"_curParam":{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"the instance to serialize"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the result of calling [can-define/map/map.prototype.serialize `instance.serialize()`]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
