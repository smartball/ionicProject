...
<!--####################################################################
	...
	@function can-connect/can/map/map.findOne
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - findOne</title>
...
<div class="breadcrumb">
	...
	<li><a href="map.findOne.html">findOne</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>findOne</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L525">Edit on GitHub</a>
				</li>
    ...
    <p>Alias of <a href="map.get.html" title="Method added to the configured map._Map type. Retrieves an instance of the
map._Map type via the connection.">get</a>. You should use <code>.get()</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.findOne","params":[{"name":"base","types":[{"type":"*"}]},{"name":"connection","types":[{"type":"*"}]}],"parent":"can-connect/can/map/map.map-static","src":{"line":524,"codeLine":531,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nAlias of [can-connect/can/map/map.get]. You should use `.get()`.\n","title":"findOne","hide":true,"pathToRoot":"../../../.."};
</script>
</article>
