...
<!--####################################################################
	...
	@function can-connect/can/map/map.createdInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.createdInstance.html">createdInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L295">Edit on GitHub</a>
				</li>
    ...
    <p>Implements the <a href="../../constructor/constructor.createdInstance.html" title="A method run whenever a new instance has been saved to the data source. Updates the instance with response data.">createdInstance</a> callback so it dispatches an event and
updates the instance.</p>
...
<div class="signature">
  ...
  <p>Updates the instance with <code>props</code> and dispatches a &quot;created&quot; event on the instance and the instances's
constructor function (<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>).</p>
<p>Calls <a href="../../constructor/store/store.stores.moveCreatedInstanceToInstanceStore.html" title="Moves recently created instances into the store.instanceStore.">moveCreatedInstanceToInstanceStore</a> to ensure new instances
are moved into the <a href="../../constructor/store/store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a> after being saved.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>}</code>: <p>a <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> instance</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>the data in the response from <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":294,"codeLine":312,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nImplements the [can-connect/constructor/constructor.createdInstance] callback so it dispatches an event and\nupdates the instance.\n","title":"createdInstance","name":"can-connect/can/map/map.createdInstance","parent":"can-connect/can/map/map.instance-callbacks","signatures":[{"code":"connection.createdInstance(instance, props)","description":"\n\n  Updates the instance with `props` and dispatches a \"created\" event on the instance and the instances's\n  constructor function ([can-connect/can/map/map._Map]).\n\n  Calls [can-connect/constructor/store/store.stores.moveCreatedInstanceToInstanceStore] to ensure new instances\n  are moved into the [can-connect/constructor/store/store.instanceStore] after being saved.\n","params":[{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"a [can-connect/can/map/map._Map] instance"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.createData]\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"the data in the response from [can-connect/connection.createData]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
