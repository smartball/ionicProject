...
<!--####################################################################
	...
	@function can-connect/can/map/map.prototype.save
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.save.html">save</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>save</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L647">Edit on GitHub</a>
				</li>
    ...
    <p>Save the instance's data to the service via the connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>instance.save(success, error)</code>
  </h2>
  <p>Calls <a href="../../connection.save.html" title="Create or update an instance.">save</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>success</b> <code>{function}</code>: <p>A function that is called if the save is successful.</p>
</li>
        
          <li><b>error</b> <code>{function}</code>: <p>A function that is called if the save is rejected.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":646,"codeLine":684,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nSave the instance's data to the service via the connection.\n","title":"save","name":"can-connect/can/map/map.prototype.save","parent":"can-connect/can/map/map.map","signatures":[{"code":"instance.save(success, error)","description":"\n\n  Calls [can-connect/connection.save].\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"success","description":"A function that is called if the save is successful."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"error","description":"A function that is called if the save is rejected."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise that resolves to the instance if successful.\n\n### Usage\n\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\nid: \"number\",\ncomplete: \"boolean\",\nname: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl], {\nMap: Todo,\nurl: \"/todos\"\n})\n\nnew Todo({name: \"dishes\"}).save();\n```\n\t "}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"error","description":"A function that is called if the save is rejected."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise that resolves to the instance if successful.\n\n### Usage\n\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\nid: \"number\",\ncomplete: \"boolean\",\nname: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl], {\nMap: Todo,\nurl: \"/todos\"\n})\n\nnew Todo({name: \"dishes\"}).save();\n```\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
