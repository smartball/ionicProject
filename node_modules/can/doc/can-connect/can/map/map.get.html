...
<!--####################################################################
	...
	@function can-connect/can/map/map.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.get.html">get</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L481">Edit on GitHub</a>
				</li>
    ...
    <p>Method added to the configured <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type. Retrieves an instance of the
<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type via the connection.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>identifying parameters of the instance to retrieve</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Map&gt;}</code>: <p><code>Promise</code> returning the <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> instance being retrieved</p>
<h3>Usage</h3>
<pre><code class="language-js">// import connection plugins
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.get","parent":"can-connect/can/map/map.map-static","src":{"line":480,"codeLine":518,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nMethod added to the configured [can-connect/can/map/map._Map] type. Retrieves an instance of the\n[can-connect/can/map/map._Map] type via the connection.\n","title":"get","signatures":[{"code":"Map.get(params)","description":"","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"identifying parameters of the instance to retrieve"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Map"}]}]}],"description":"`Promise` returning the [can-connect/can/map/map._Map] instance being retrieved\n\n### Usage\n\n```js\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection type\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// retrieve instance\nTodo.get({id: 5}).then(function(todo){\n  ...\n});\n```\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"identifying parameters of the instance to retrieve"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Map"}]}]}],"description":"`Promise` returning the [can-connect/can/map/map._Map] instance being retrieved\n\n### Usage\n\n```js\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection type\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// retrieve instance\nTodo.get({id: 5}).then(function(todo){\n  ...\n});\n```\n "},"pathToRoot":"../../../.."};
</script>
</article>
