...
<!--####################################################################
	...
	@function can-connect/can/map/map.getList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.getList.html">getList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L420">Edit on GitHub</a>
				</li>
    ...
    <p>Method added to the configured <a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type. Retrieves a <a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a> of
<a href="map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> instances via the connection.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>set definition of the list being retrieved</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Map&gt;}</code>: <p><code>Promise</code> returning the <a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a> of instances being retrieved</p>
<h3>Usage</h3>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.getList","parent":"can-connect/can/map/map.map-static","src":{"line":419,"codeLine":463,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nMethod added to the configured [can-connect/can/map/map._Map] type. Retrieves a [can-connect/can/map/map._List] of\n[can-connect/can/map/map._Map] instances via the connection.\n","title":"getList","signatures":[{"code":"Map.getList(set)","description":"","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"set definition of the list being retrieved"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Map"}]}]}],"description":"`Promise` returning the [can-connect/can/map/map._List] of instances being retrieved\n\n### Usage\n\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\nTodo.List = DefineList.extend({\n  completed: function() {\n    return this.filter(function(item) { return item.completed; });\n  }\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// retrieve instances\nTodo.getList({due: \"today\"}).then(function(todos){\n  ...\n});\n```\n "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"set definition of the list being retrieved"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Map"}]}]}],"description":"`Promise` returning the [can-connect/can/map/map._List] of instances being retrieved\n\n### Usage\n\n```\n// import connection plugins\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\n// define connection types\nvar Todo = DefineMap.extend({\n  id: \"number\",\n  complete: \"boolean\",\n  name: \"string\"\n});\n\nTodo.List = DefineList.extend({\n  completed: function() {\n    return this.filter(function(item) { return item.completed; });\n  }\n});\n\n// create connection\nconnect([canMap, constructor, dataUrl],{\n  Map: Todo,\n  url: \"/todos\"\n})\n\n// retrieve instances\nTodo.getList({due: \"today\"}).then(function(todos){\n  ...\n});\n```\n "},"pathToRoot":"../../../.."};
</script>
</article>
