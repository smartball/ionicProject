...
<!--####################################################################
	...
	@function can-connect/can/map/map.id
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>id</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L42">Edit on GitHub</a>
				</li>
    ...
    <p>Returns an observable identifier value for an instance.</p>
...
<div class="signature">
  ...
  <p>Reads the instance's id (in the same manner as <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data."><code>base.id()</code></a>) but as an observable value.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>the instance to get an identifier of</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>an identifier value</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.id","parent":"can-connect/can/map/map.identifiers","src":{"line":41,"codeLine":54,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nReturns an observable identifier value for an instance.\n","title":"id","signatures":[{"code":"connection.id(instance)","description":"\n\nReads the instance's id (in the same manner as [can-connect/base/base.id `base.id()`]) but as an observable value.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to get an identifier of"}],"returns":{"types":[{"type":"*"}],"description":"an identifier value\n\t "}}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"the instance to get an identifier of"},"_curReturn":{"types":[{"type":"*"}],"description":"an identifier value\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
