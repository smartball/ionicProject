...
<!--####################################################################
	...
	@function can-connect/can/map/map.updatedList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.updatedList.html">updatedList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L249">Edit on GitHub</a>
				</li>
    ...
    <p>Implements the <a href="../../constructor/constructor.updatedList.html" title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">updatedList</a> callback so it updates the list and it's items
during a single <a href="../../../can-event/batch/batch.html" title="Adds task batching abilities to event dispatching.">batched event</a>.</p>
...
<div class="signature">
  ...
  <p>Updates the list and the items within it during a single <a href="../../../can-event/batch/batch.html" title="Adds task batching abilities to event dispatching.">batched event</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>the list to be updated.</p>
</li>
        
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>raw list data.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the set of the list being updated.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.updatedList","parent":"can-connect/can/map/map.instance-callbacks","src":{"line":248,"codeLine":263,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nImplements the [can-connect/constructor/constructor.updatedList] callback so it updates the list and it's items\nduring a single [can-event/batch/batch batched event].\n","title":"updatedList","signatures":[{"code":"connection.updatedList(list, listData, set)","description":"\n\n  Updates the list and the items within it during a single [can-event/batch/batch batched event].\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"the list to be updated."},{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"raw list data."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set of the list being updated.\n\t "}]}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"the set of the list being updated.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
