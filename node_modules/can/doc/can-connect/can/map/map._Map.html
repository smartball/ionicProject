...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: unknown
	@property can-connect/can/map/map._Map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map._Map.html">Map</a></li>
  ...
  <section class="title">
    ...
    <p>Specify the type of the <code><a href="../../../can-define/map/map.html" title="Create observable objects.">DefineMap</a></code> that should be instantiated by the connection.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.Map</code>
  </h2>
  <p>Defaults to <a href="../../../can-types.DefaultMap.html" title="">DefaultMap</a> if this option is not specified.</p>
...
<script type="text/javascript">
  window.docObject = {"description":"\nSpecify the type of the `[can-define/map/map DefineMap]` that should be instantiated by the connection.\n","types":[{"type":"connection.Map","description":"Defaults to [can-types.DefaultMap] if this option is not specified.\n\n**Usage:**\n\n```js\nvar DefineMap = require(\"can-define/map/map\");\nvar canMap = require(\"can-connect/can/map/map\");\nvar constructor = require(\"can-connect/constructor/constructor\");\nvar dataUrl = require(\"can-connect/data/url/url\");\n\nvar Todo = DefineMap.extend({\n  completed: \"boolean\",\n  complete: function(){\n    this.completed = true\n  }\n});\n\nvar todoConnection = connect([dataUrl, constructor, canMap], {\n  Map: Todo,\n  url: \"/todos\"\n});\n\ntodoConnect.get({id:1}).then(function(item) {\n  item instanceof Todo // true\n});\n```\n\t "}],"title":"Map","name":"can-connect/can/map/map._Map","type":"property","parent":"can-connect/can/map/map.options","pathToRoot":"../../../.."};
</script>
</article>
