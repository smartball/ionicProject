...
<!--####################################################################
	...
	@function can-connect/can/map/map.prototype.isSaving
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isSaving</title>
...
<div class="breadcrumb">
	...
	<li><a href="map.prototype.isSaving.html">isSaving</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isSaving</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L591">Edit on GitHub</a>
				</li>
    ...
    <p>Returns if the instance is currently being saved.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>instance.isSaving()</code>
  </h2>
  <p>Observes if a promise returned by <a href="../../connection.save.html" title="Create or update an instance."><code>connection.save</code></a> is in progress for this
instance.  This is often used in a template like:</p>
<pre><code>&lt;button ($click)=&quot;todo.save()&quot;
...
&lt;/button&gt;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <a href="../../connection.save.html" title="Create or update an instance."><code>connection.save</code></a> has been called for this
instance but the returned promise has not yet resolved.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":590,"codeLine":611,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the instance is currently being saved.\n","title":"isSaving","name":"can-connect/can/map/map.prototype.isSaving","parent":"can-connect/can/map/map.map","signatures":[{"code":"instance.isSaving()","description":"\n\nObserves if a promise returned by [can-connect/connection.save `connection.save`] is in progress for this\ninstance.  This is often used in a template like:\n\n```\n<button ($click)=\"todo.save()\"\n   {{#todo.isSaving}}disabled{{/todo.isSaving}}>\n  Save Changes\n</button>\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/connection.save `connection.save`] has been called for this\ninstance but the returned promise has not yet resolved.\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if [can-connect/connection.save `connection.save`] has been called for this\ninstance but the returned promise has not yet resolved.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
