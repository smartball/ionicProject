...
<!--####################################################################
	...
	@function can-connect/can/map/map.findAll
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - findAll</title>
...
<div class="breadcrumb">
	...
	<li><a href="map.findAll.html">findAll</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>findAll</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L469">Edit on GitHub</a>
				</li>
    ...
    <p>Alias of <a href="map.getList.html" title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">getList</a>. You should use <code>.getList()</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.findAll","params":[{"name":"base","types":[{"type":"*"}]},{"name":"connection","types":[{"type":"*"}]}],"parent":"can-connect/can/map/map.map-static","src":{"line":468,"codeLine":475,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nAlias of [can-connect/can/map/map.getList]. You should use `.getList()`.\n","title":"findAll","hide":true,"pathToRoot":"../../../.."};
</script>
</article>
