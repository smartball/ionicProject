...
<!--####################################################################
	...
	@function can-connect/can/map/map.callbackInstanceEvents
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - callbackInstanceEvents</title>
...
<div class="breadcrumb">
	...
	<li><a href="map.callbackInstanceEvents.html">callbackInstanceEvents</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>callbackInstanceEvents</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L373">Edit on GitHub</a>
				</li>
    ...
    <p>Utility function to dispatch events for instance callbacks, e.g. <a href="map.updatedInstance.html" title="Implements the constructor.updatedInstance callback so it dispatches an event and
updates the instance.">updatedInstance</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.callbackInstanceEvents(cbName, instance)</code>
  </h2>
  <p>Used to dispatch events as part of instance callbacks implementations. This method could be useful in other
behaviors that implement instance callbacks. E.g. a behavior overriding the
<a href="map.updatedInstance.html" title="Implements the constructor.updatedInstance callback so it dispatches an event and
updates the instance."><code>updatedInstance</code></a> callback:</p>
<pre><code>connect([canMap, {
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>eventName</b> <code>{String}</code>: <p>name of the the event to be triggered</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.callbackInstanceEvents","parent":"can-connect/can/map/map.static","src":{"line":372,"codeLine":396,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nUtility function to dispatch events for instance callbacks, e.g. [can-connect/can/map/map.updatedInstance].\n","title":"callbackInstanceEvents","signatures":[{"code":"connection.callbackInstanceEvents(cbName, instance)","description":"\n\n  Used to dispatch events as part of instance callbacks implementations. This method could be useful in other\n  behaviors that implement instance callbacks. E.g. a behavior overriding the\n  [can-connect/can/map/map.updatedInstance `updatedInstance`] callback:\n\n  ```\n  connect([canMap, {\n      updatedInstance: function(instance, props) {\n          instance = smartMerge(instance, props);\n          canMapBehavior.callbackInstanceEvents(\"updated\", instance);\n      }\n  }], {})\n  ```\n","params":[{"types":[{"type":"String"}],"name":"eventName","description":"name of the the event to be triggered"},{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"a [can-connect/can/map/map._Map] instance.\n"}]}],"_curParam":{"types":[{"type":"can-connect/can/map/map._Map"}],"name":"instance","description":"a [can-connect/can/map/map._Map] instance.\n"},"pathToRoot":"../../../.."};
</script>
</article>
