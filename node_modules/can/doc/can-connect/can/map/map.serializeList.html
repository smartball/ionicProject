...
<!--####################################################################
	...
	@function can-connect/can/map/map.serializeList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="map.serializeList.html">serializeList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serializeList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L96">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the properties of a list that should be sent to the data source when saving. Done by calling
<a href="../../../can-define/list/list.prototype.serialize.html" title="Returns the a serialized version of this list."><code>list.serialize()</code></a>.</p>
...
<div class="signature">
  ...
  <p>Simply calls <a href="../../../can-define/list/list.prototype.serialize.html" title="Returns the a serialized version of this list.">serialize</a> on the <code>list</code> argument.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="map._List.html" title="Specify the type of the DefineList that should be instantiated by the connection.">List</a>}</code>: <p>the list to serialize</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the result of calling <a href="../../../can-define/list/list.prototype.serialize.html" title="Returns the a serialized version of this list."><code>list.serialize()</code></a></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.serializeList","parent":"can-connect/can/map/map.serializers","src":{"line":95,"codeLine":108,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nReturns the properties of a list that should be sent to the data source when saving. Done by calling\n[can-define/list/list.prototype.serialize `list.serialize()`].\n","title":"serializeList","signatures":[{"code":"connection.serializeList(list)","description":"\nSimply calls [can-define/list/list.prototype.serialize] on the `list` argument.\n","params":[{"types":[{"type":"can-connect/can/map/map._List"}],"name":"list","description":"the list to serialize"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the result of calling [can-define/list/list.prototype.serialize `list.serialize()`]\n\t "}}],"_curParam":{"types":[{"type":"can-connect/can/map/map._List"}],"name":"list","description":"the list to serialize"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the result of calling [can-define/list/list.prototype.serialize `list.serialize()`]\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
