...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/can/merge/merge.js
	@function can-connect/can/merge/merge.destroyedInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="merge.destroyedInstance.html">destroyedInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyedInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/merge/merge.js#L31">Edit on GitHub</a>
				</li>
    ...
    <p>Makes minimal updates to an instance's properties and its nested properties using <a href="../../helpers/map-deep-merge.html" title="Perform a smart merge of deeply nested maps and lists.">map-deep-merge</a>.</p>
...
<div class="signature">
  ...
  <p>Calls <a href="../../helpers/map-deep-merge.html" title="Perform a smart merge of deeply nested maps and lists.">map-deep-merge</a> and triggers the <code>'destroyed'</code> event on the instance and it's type
within a <a href="../../../can-event/batch/batch.html" title="Adds task batching abilities to event dispatching.">batch</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The instance that was just destroyed whose
properties will be updated.</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>The new data the instance and children of the
instance should be updated to look like.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/merge/merge.destroyedInstance","parent":"can-connect/can/merge/merge.instance-callbacks","src":{"line":30,"codeLine":47,"path":"node_modules/can-connect/can/merge/merge.js"},"description":"Makes minimal updates to an instance's properties and its nested properties using [can-connect/helpers/map-deep-merge].\n\n","title":"destroyedInstance","signatures":[{"code":"connection.destroyedInstance(instance, props)","description":"\n\n  Calls [can-connect/helpers/map-deep-merge] and triggers the `'destroyed'` event on the instance and it's type\n  within a [can-event/batch/batch batch].\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"The instance that was just destroyed whose\nproperties will be updated."},{"types":[{"type":"Object","options":[]}],"name":"props","description":"The new data the instance and children of the\ninstance should be updated to look like.\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The new data the instance and children of the\ninstance should be updated to look like.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
