...
<!--####################################################################
	...
	@function can-connect/can/merge/merge.updatedList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="merge.updatedList.html">updatedList</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/merge/merge.js#L77">Edit on GitHub</a>
				</li>
    ...
    <p>Makes minimal updates to an list's items and those items' nested properties using <a href="../../helpers/map-deep-merge.html" title="Perform a smart merge of deeply nested maps and lists.">map-deep-merge</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updatedList(list, listData)</code>
  </h2>
  <p>Calls <a href="../../helpers/map-deep-merge.html" title="Perform a smart merge of deeply nested maps and lists.">map-deep-merge</a> on the list within a <a href="../../../can-event/batch/batch.html" title="Adds task batching abilities to event dispatching.">batch</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>the list that will be updated.</p>
</li>
        
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>the new data the list and items in the
list should be updated to look like.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/merge/merge.updatedList","parent":"can-connect/can/merge/merge.instance-callbacks","src":{"line":76,"codeLine":91,"path":"node_modules/can-connect/can/merge/merge.js"},"description":"Makes minimal updates to an list's items and those items' nested properties using [can-connect/helpers/map-deep-merge].\n\n","title":"updatedList","signatures":[{"code":"connection.updatedList(list, listData)","description":"\n\n  Calls [can-connect/helpers/map-deep-merge] on the list within a [can-event/batch/batch batch].\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"the list that will be updated."},{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"the new data the list and items in the\nlist should be updated to look like.\n\t "}]}],"_curParam":{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"the new data the list and items in the\nlist should be updated to look like.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
