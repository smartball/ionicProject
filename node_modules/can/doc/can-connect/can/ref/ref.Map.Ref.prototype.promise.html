...
<!--####################################################################
	...
	@property can-connect/can/ref/ref.Map.Ref.prototype.promise
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - promise</title>
...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.promise.html">promise</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>promise</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L247">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a resolved promise if the referenced instance is already available, if not, returns a new promise
to retrieve the instance by the id.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>Promise resolving the instance referenced</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.promise","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":246,"codeLine":257,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nReturns a resolved promise if the referenced instance is already available, if not, returns a new promise\nto retrieve the instance by the id.\n","types":[{"type":"Promise"}],"title":"promise","hide":true,"signatures":[{"code":"ref.promise","description":"","params":[],"returns":{"types":[{"type":"Promise"}],"description":"Promise resolving the instance referenced\n\t "}}],"_curReturn":{"types":[{"type":"Promise"}],"description":"Promise resolving the instance referenced\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
