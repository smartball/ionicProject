...
<!--####################################################################
	...
	@property can-connect/can/ref/ref.Map.Ref
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Map.Ref</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>Map.Ref</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L165">Edit on GitHub</a>
				</li>
    ...
    <p>A reference type with <code>instanceRef.value</code> primed to return an existing instance of the
<a href="../map/map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a> type, if available, or lazy load an instance upon accessing <code>instanceRef.value</code>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new Map.Ref(id, value)</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>id</b> <code>{string}</code>: <p>string representing the record id</p>
</li>
        
          <li><b>value</b> <code>{Object}</code>: <p>properties to be loaded / hydrated</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Map.Ref}</code>: <p>instance reference object for the id</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"property","name":"can-connect/can/ref/ref.Map.Ref","parent":"can-connect/can/ref/ref.hydrators","src":{"line":164,"codeLine":178,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nA reference type with `instanceRef.value` primed to return an existing instance of the\n[can-connect/can/map/map._Map] type, if available, or lazy load an instance upon accessing `instanceRef.value`.\n","types":[{"type":"constructor"}],"title":"Map.Ref","signatures":[{"code":"new Map.Ref(id, value)","description":"","params":[{"types":[{"type":"string"}],"name":"id","description":"string representing the record id"},{"types":[{"type":"Object","options":[]}],"name":"value","description":"properties to be loaded / hydrated"}],"returns":{"types":[{"type":"Map.Ref"}],"description":"instance reference object for the id\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"value","description":"properties to be loaded / hydrated"},"_curReturn":{"types":[{"type":"Map.Ref"}],"description":"instance reference object for the id\n "},"pathToRoot":"../../../.."};
</script>
</article>
