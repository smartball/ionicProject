...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.isRejected.html">isRejected</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isRejected</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L352">Edit on GitHub</a>
				</li>
    ...
    <p>Observable property typically for use in templates to indicate to the user if lazy loading has failed.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{boolean}</code>: <p><code>true</code> if the lazy loading promise was rejected.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isRejected","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":351,"codeLine":360,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nObservable property typically for use in templates to indicate to the user if lazy loading has failed.\n","title":"isRejected","signatures":[{"code":"ref.isRejected","description":"","params":[],"returns":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise was rejected.\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise was rejected.\n "},"pathToRoot":"../../../.."};
</script>
</article>
