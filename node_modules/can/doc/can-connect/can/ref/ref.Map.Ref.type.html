...
<!--####################################################################
	...
	@function can-connect/can/ref/ref.Map.Ref.type
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
map._Map type, if available, or lazy load an instance upon accessing instanceRef.value.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="ref.Map.Ref.type.html"
							title="Returns a new instance of Map.Ref.">
							type
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="ref.Map.Ref.prototype.isPending.html"
							title="Observable property typically for use in templates to indicate to the user if lazy loading is ongoing.">
							isPending
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="ref.Map.Ref.prototype.isRejected.html"
							title="Observable property typically for use in templates to indicate to the user if lazy loading has failed.">
							isRejected
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="ref.Map.Ref.prototype.isResolved.html"
							title="Observable property typically for use in templates to indicate to the user if lazy loading has succeeded.">
							isResolved
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="ref.Map.Ref.prototype.reason.html"
							title="Returns the failure message from the lazy loading promise. Returns undefined if the referenced instance is
available or loading is ongoing.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="ref.Map.Ref.prototype.serialize.html"
							title="Return the id of the referenced instance when serializing. Prevents the referenced instance from
being entirely serialized when serializing the referencing instance.">
					...
					<li class="
           						...
           						">
						<a class="property"
							href="ref.Map.Ref.prototype.value.html"
							title="Returns the actual instance the reference points to. Returns undefined if the instance is still being loaded.
...
<div class="breadcrumb">
		...
		<li><a href="ref.Map.Ref.html">Map.Ref</a></li>
		<li> / </li>
	
	
	<li><a href="ref.Map.Ref.type.html">type</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>type</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L226">Edit on GitHub</a>
				</li>
    ...
    <p>Returns a new instance of <code>Map.Ref</code>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>Map.Ref.type(reference)</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>reference</b> <code>{Object|String|Number}</code>: <p>either data or an id for an instance of <a href="../map/map._Map.html" title="Specify the type of the DefineMap that should be instantiated by the connection.">Map</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="ref.Map.Ref.html" title="A reference type with instanceRef.value primed to return an existing instance of the
map._Map type, if available, or lazy load an instance upon accessing instanceRef.value.">Map.Ref</a>}</code>: <p>reference instance for the passed data or identifier.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.type","parent":"can-connect/can/ref/ref.Map.Ref.static","src":{"line":225,"codeLine":236,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nReturns a new instance of `Map.Ref`.\n","title":"type","signatures":[{"code":"Map.Ref.type(reference)","description":"\n","params":[{"types":[{"type":"Object"},{"type":"String"},{"type":"Number"}],"name":"reference","description":"either data or an id for an instance of [can-connect/can/map/map._Map]."}],"returns":{"types":[{"type":"can-connect/can/ref/ref.Map.Ref"}],"description":"reference instance for the passed data or identifier.\n "}}],"_curParam":{"types":[{"type":"Object"},{"type":"String"},{"type":"Number"}],"name":"reference","description":"either data or an id for an instance of [can-connect/can/map/map._Map]."},"_curReturn":{"types":[{"type":"can-connect/can/ref/ref.Map.Ref"}],"description":"reference instance for the passed data or identifier.\n "},"pathToRoot":"../../../.."};
</script>
</article>
