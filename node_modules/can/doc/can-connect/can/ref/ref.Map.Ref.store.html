...
<!--####################################################################
	...
	@property can-connect/can/ref/ref.Map.Ref.store
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - store</title>
...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.store.html">store</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>store</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L218">Edit on GitHub</a>
				</li>
    ...
    <p>A WeakReferenceMap that contains instances being created by their <code>._cid</code> property.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.store","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.static","src":{"line":217,"codeLine":223,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"A WeakReferenceMap that contains instances being created by their `._cid` property.\n","types":[{"type":"can-connect/helpers/weak-reference-map"}],"title":"store","hide":true,"pathToRoot":"../../../.."};
</script>
</article>
