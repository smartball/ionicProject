...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.isResolved.html">isResolved</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isResolved</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L340">Edit on GitHub</a>
				</li>
    ...
    <p>Observable property typically for use in templates to indicate to the user if lazy loading has succeeded.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{boolean}</code>: <p><code>true</code> if the lazy loading promise was resolved.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isResolved","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":339,"codeLine":348,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nObservable property typically for use in templates to indicate to the user if lazy loading has succeeded.\n","title":"isResolved","signatures":[{"code":"ref.isResolved","description":"","params":[],"returns":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise was resolved.\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise was resolved.\n "},"pathToRoot":"../../../.."};
</script>
</article>
