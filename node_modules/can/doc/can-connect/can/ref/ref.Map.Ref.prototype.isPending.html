...
<!--####################################################################
	...
	@function can-connect/can/ref/ref.Map.Ref.prototype.isPending
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isPending</title>
...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.isPending.html">isPending</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isPending</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L365">Edit on GitHub</a>
				</li>
    ...
    <p>Observable property typically for use in templates to indicate to the user if lazy loading is ongoing.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{boolean}</code>: <p><code>true</code> if the lazy loading promise state is not resolved or rejected.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isPending","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":364,"codeLine":373,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nObservable property typically for use in templates to indicate to the user if lazy loading is ongoing.\n","title":"isPending","signatures":[{"code":"ref.isPending","description":"","params":[],"returns":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise state is not resolved or rejected.\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"`true` if the lazy loading promise state is not resolved or rejected.\n "},"pathToRoot":"../../../.."};
</script>
</article>
