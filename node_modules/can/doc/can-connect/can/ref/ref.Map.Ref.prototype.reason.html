...
<!--####################################################################
	...
	@property can-connect/can/ref/ref.Map.Ref.prototype.reason
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - reason</title>
...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.reason.html">reason</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>reason</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L306">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the failure message from the lazy loading promise. Returns <code>undefined</code> if the referenced instance is
available or loading is ongoing.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>error message if the promise is rejected</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.reason","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":305,"codeLine":315,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nReturns the failure message from the lazy loading promise. Returns `undefined` if the referenced instance is\navailable or loading is ongoing.\n","types":[{"type":"*"}],"title":"reason","signatures":[{"code":"ref.reason","description":"","params":[],"returns":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "}}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
