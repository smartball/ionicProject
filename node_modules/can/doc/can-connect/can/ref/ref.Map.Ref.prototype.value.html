...
<!--####################################################################
	...
	@property can-connect/can/ref/ref.Map.Ref.prototype.value
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="ref.Map.Ref.prototype.value.html">value</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>value</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L284">Edit on GitHub</a>
				</li>
    ...
    <p>Returns the actual instance the reference points to. Returns <code>undefined</code> if the instance is still being loaded.
Accessing this property will start lazy loading if the instance isn't already available.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{object}</code>: <p>actual instance referenced or <code>undefined</code> if lazy loading ongoing</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.value","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":283,"codeLine":293,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\nReturns the actual instance the reference points to. Returns `undefined` if the instance is still being loaded.\nAccessing this property will start lazy loading if the instance isn't already available.\n","types":[{"type":"*"}],"title":"value","signatures":[{"code":"ref.value","description":"","params":[],"returns":{"types":[{"type":"object"}],"description":"actual instance referenced or `undefined` if lazy loading ongoing\n\t "}}],"_curReturn":{"types":[{"type":"object"}],"description":"actual instance referenced or `undefined` if lazy loading ongoing\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
