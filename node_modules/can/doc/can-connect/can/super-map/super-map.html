...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/can/super-map/super-map.md
	@module can-connect/can/super-map/super-map
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/can/super-map/super-map</title>
...
<div class="breadcrumb">
	...
	<li><a href="super-map.html">./can/super-map/</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/can/super-map/super-map</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/super-map/super-map.md">Edit on GitHub</a>
				</li>
    ...
    <p>Create connection with many of the best behaviors in can-connect and hook it up to
a <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>superMap(options)</code>
  </h2>
  <p>Creates a connection with the following behaviors: <a href="../../constructor/constructor.html" title="Adds an interface to interact with custom types via the connection instead of plain Objects and Arrays.">constructor</a>,
<a href="../map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a>,
<a href="../../constructor/store/store.html" title="Adds support for keeping references to active lists and instances. Prevents different copies of an instance from
being used by the application at once. Allows other behaviors to look up instances currently active in the
application.">constructor/store</a>,
<a href="../../data/callbacks/callbacks.html" title="Extend DataInterface methods to call callbacks with the raw response data.">data/callbacks</a>,
<a href="../../data/callbacks-cache/callbacks-cache.html" title="Implements the data interface callbacks to call the base.cacheConnection
DataInterface. These calls keep the base.cacheConnection contents
up to date.">data/callbacks-cache</a>,
<a href="../../data/combine-requests/combine-requests.html" title="Combines multiple incoming lists requests into a single list request when possible.">combine-requests</a>,
<a href="../../data/parse/parse.html" title="Extract response data into a format needed for other extensions.">can-connect/data/parse/parse</a>,
<a href="../../data/url/url.html" title="">data/url</a>,
<a href="../../real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a>,
<a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a>,
<a href="../../constructor/callbacks-once/callbacks-once.html" title="Prevents duplicate calls to the instance callback methods.">constructor/callbacks-once</a>.</p>
<p>And creates a <a href="../../data/localstorage-cache/localstorage-cache.html" title="Saves raw data in localStorage.">localstorage-cache</a> to use as a <a href="../../base/base.cacheConnection.html" title="An underlying can-connect connection used when fetching data from a cache.">cacheConnection</a>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>can-connect/can/super-map</code> module exports a helper function that creates a connection
with the &quot;advanced&quot; behaviors in can-connect and hooks it up to a <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>
and <a href="../../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>.</p>
<p>If you are using CanJS, this is an easy way to create a connection that can be useful and
fast in most circumstances.</p>
<p>To use it, first define a Map and List constructor function:</p>
...
<p>Next, call <code>superMap</code> with all of the options needed by the behaviors that <code>superMap</code> adds:</p>
...
<p><a href="../map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds CRUD methods to the <code>Map</code> option, you can use those to create,
read, update and destroy todos:</p>
<pre><code>Todo.getList({}).then(function(todos){ ... });
