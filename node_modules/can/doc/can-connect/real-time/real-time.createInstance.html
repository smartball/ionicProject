...
<!--####################################################################
	...
	@function can-connect/real-time/real-time.createInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - createInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="real-time.createInstance.html">createInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/real-time/real-time.js#L145">Edit on GitHub</a>
				</li>
    ...
    <p>Programatically indicate a new instance has been created.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.createInstance(props)</code>
  </h2>
  <p>If there is no instance in the <a href="../constructor/store/store.instanceStore.html" title="A mapping of instances keyed by their base.id.">instanceStore</a>
for <code>props</code>'s <a href="../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>, an instance is <a href="../constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrated</a>,
added to the store, and then <a href="real-time.createdData.html" title="Called whenever instance data is created.">createdData</a> is called with
<code>props</code> and the hydrated instance's serialized data. <a href="real-time.createdData.html" title="Called whenever instance data is created.">createdData</a>
will add this instance to any lists the instance belongs to.</p>
<p>If this instance has already been created, calls
<a href="real-time.updateInstance.html" title="Programatically indicate a new instance has been updated.">updateInstance</a> with <code>props</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: </li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Instance&gt;}</code>: </p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>With a <code>real-time</code> connection, call <code>createInstance</code> when an instance is created that
the connection itself did not make.  For instance, the following might listen to
<a href="http://socket.io/">socket.io</a> for when a <code>todo</code> is created and update the connection
accordingly:</p>
<pre><code>socket.on('todo created', function(todo){
