...
<!--####################################################################
	...
	@function can-connect/real-time/real-time.destroyedData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="real-time.destroyedData.html">destroyedData</a></li>
	...
	<div class="page-type">
		<h1>destroyedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/real-time/real-time.js#L304">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.destroyedData(props, params)</code>
  </h2>
  <p>Gets the instance for this request.  Then tests if the instance
is in any list in the <a href="../constructor/store/store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a>.  If
it is, removes the instance from the list.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>The parameters used to destroy the data.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/real-time/real-time.destroyedData","parent":"can-connect/real-time/real-time.callbacks","src":{"line":303,"codeLine":316,"path":"node_modules/can-connect/real-time/real-time.js"},"description":"\n","title":"destroyedData","signatures":[{"code":"connection.destroyedData(props, params)","description":"\n\nGets the instance for this request.  Then tests if the instance\nis in any list in the [can-connect/constructor/store/store.listStore].  If\nit is, removes the instance from the list.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The properties of the destroyed instance."},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"params","description":"The parameters used to destroy the data.\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"params","description":"The parameters used to destroy the data.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
