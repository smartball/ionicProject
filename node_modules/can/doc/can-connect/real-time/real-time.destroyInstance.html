...
<!--####################################################################
	...
	@function can-connect/real-time/real-time.destroyInstance
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - destroyInstance</title>
...
<div class="breadcrumb">
	...
	<li><a href="real-time.destroyInstance.html">destroyInstance</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroyInstance</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/real-time/real-time.js#L329">Edit on GitHub</a>
				</li>
    ...
    <p>Programatically indicate a new instance has been destroyed.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.destroyInstance(props)</code>
  </h2>
  <p>Gets or creates an instance from <code>props</code> and uses
it to call <a href="real-time.destroyedData.html" title="">destroyedData</a>
correctly.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>The properties of the destroyed instance.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Instance&gt;}</code>: <p>A promise with the destroyed instance.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/real-time/real-time.destroyInstance","parent":"can-connect/real-time/real-time.methods","src":{"line":328,"codeLine":343,"path":"node_modules/can-connect/real-time/real-time.js"},"description":"\nProgramatically indicate a new instance has been destroyed.\n","title":"destroyInstance","signatures":[{"code":"connection.destroyInstance(props)","description":"\n\n  Gets or creates an instance from `props` and uses\n  it to call [can-connect/real-time/real-time.destroyedData]\n  correctly.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The properties of the destroyed instance."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise with the destroyed instance.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The properties of the destroyed instance."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise with the destroyed instance.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
