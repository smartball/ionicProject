...
<!--####################################################################
	...
	@function can-connect/real-time/real-time.createdData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="real-time.createdData.html">createdData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>createdData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/real-time/real-time.js#L213">Edit on GitHub</a>
				</li>
    ...
    <p>Called whenever instance data is created.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.createdData(props, params, [cid])</code>
  </h2>
  <p>Updates lists with the created instance.</p>
<p>Gets the instance created for this request. Then, updates the instance with
the response data <code>props</code>.</p>
<p>Next, it goes through every list in the <a href="../constructor/store/store.listStore.html" title="A mapping of lists keyed by their base.listSet.">listStore</a>,
test if the instance's data belongs in that list.  If it does,
adds the instance's data to the serialized list data and
<a href="../constructor/constructor.updatedList.html" title="A method run whenever new data for an existing list is retrieved from the data source. Updates the list to
include the new data.">updates the list</a>.</p>
