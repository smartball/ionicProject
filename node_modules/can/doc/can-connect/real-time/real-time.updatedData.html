...
<!--####################################################################
	...
	@function can-connect/real-time/real-time.updatedData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="real-time.updatedData.html">updatedData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>updatedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/real-time/real-time.js#L246">Edit on GitHub</a>
				</li>
    ...
    <p>Called whenever instance data is updated.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.updatedData(props, params)</code>
  </h2>
  <p>Gets the instance that is updated, updates
it with <code>props</code> and the adds or removes it to
lists it belongs in.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{undefined}</code>: <p>Returns <code>undefined</code> to prevent <code>.save</code> from calling <code>updatedInstance</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":245,"codeLine":259,"path":"node_modules/can-connect/real-time/real-time.js"},"type":"function","description":"\nCalled whenever instance data is updated.\n","title":"updatedData","name":"can-connect/real-time/real-time.updatedData","parent":"can-connect/real-time/real-time.callbacks","signatures":[{"code":"connection.updatedData(props, params)","description":"\n\n  Gets the instance that is updated, updates\n  it with `props` and the adds or removes it to\n  lists it belongs in.\n","params":[],"returns":{"types":[{"type":"undefined"}],"description":"Returns `undefined` to prevent `.save` from calling `updatedInstance`.\n\t "}}],"_curReturn":{"types":[{"type":"undefined"}],"description":"Returns `undefined` to prevent `.save` from calling `updatedInstance`.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
