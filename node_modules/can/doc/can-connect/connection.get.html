...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/instance_interface/get.md
	@function can-connect/connection.get
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.get.html">get</a></li>
	...
	<div class="page-type">
		<h1>get</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/instance_interface/get.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Get a single <a href="Instance.html" title="An instance of some JavaScript type.">Instance</a> using the <code>connection</code> by calling
<a href="connection.getData.html" title="Retrieves a record.">getData</a>.</p>
<pre><code class="language-js">connection.get({id: 5}).then(function(instance){

});
</code></pre>
<p>Note that <a href="can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds <code>get</code> to the <code>instance</code>'s
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>An object that specifies an instance to retrieve.  Typically, the object contains the <code>id</code> property and the <code>id</code> value of the
instance that should be retrieved like <code>{_id: &quot;saq232la8kjsa&quot;}</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;<a href="../can-connect.List.html" title="A list type.">List</a>&gt;}</code>: <p>Returns a promise that
resolve with a <code>List</code> if <a href="connection.getData.html" title="Retrieves a record.">getData</a> is resolved.  The promise is rejected if <a href="connection.getData.html" title="Retrieves a record.">getData</a> is rejected.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Gets a <a href="Instance.html" title="An instance of some JavaScript type.">Instance</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/docs/instance_interface/get.md"},"description":"\n","title":"get","name":"can-connect/connection.get","type":"function","parent":"can-connect/InstanceInterface","signatures":[{"code":"connection.get( params )","description":"\n\nGet a single [can-connect/Instance] using the `connection` by calling\n[can-connect/connection.getData].\n\n```js\nconnection.get({id: 5}).then(function(instance){\n\n});\n```\n\nNote that [can-connect/can/map/map] adds `get` to the `instance`'s\nconstructor function.\n\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"An object that specifies an instance to retrieve.  Typically, the object contains the `id` property and the `id` value of the\ninstance that should be retrieved like `{_id: \"saq232la8kjsa\"}`.\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.List"}]}]}],"description":"Returns a promise that\nresolve with a `List` if [can-connect/connection.getData] is resolved.  The promise is rejected if [can-connect/connection.getData] is rejected.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"An object that specifies an instance to retrieve.  Typically, the object contains the `id` property and the `id` value of the\ninstance that should be retrieved like `{_id: \"saq232la8kjsa\"}`.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"can-connect.List"}]}]}],"description":"Returns a promise that\nresolve with a `List` if [can-connect/connection.getData] is resolved.  The promise is rejected if [can-connect/connection.getData] is rejected.\n"},"pathToRoot":"../.."};
</script>
</article>
