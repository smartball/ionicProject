...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/instance_interface/destroy.md
	@function can-connect/connection.destroy
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="connection.destroy.html">destroy</a></li>
	...
	<div class="page-type">
		<h1>destroy</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/instance_interface/destroy.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Destroys an instance using the <code>connection</code> by calling
<a href="connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>.</p>
<pre><code class="language-js">// get an instance
...
<p>Note that <a href="can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">can/map</a> adds <code>destroy</code> to the <code>instance</code>
type's prototype.</p>
...
resolve with destroyed instance if <a href="connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> is resolved.  The promise is rejected if <a href="connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a> is rejected.</p>
</p>
  </div>
