...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/docs/ValueConstructor.md
	@function can-define.types.ValueConstructor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define.types.ValueConstructor.html">Value</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Value</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/docs/ValueConstructor.md">Edit on GitHub</a>
				</li>
    ...
    <p>Provides a constructor function to be used to provide a default value for a property.</p>
...
<div class="signature">
  ...
  <p>A constructor function can be provided that is called to create a default value used for this property.
This constructor will be invoked with <code>new</code> for each created instance. The default
value is created on demand when the property is read for the first time.</p>
<p>Specify <code>Value</code> like:</p>
