...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map/docs/prototype.removeAttr.md
	@function can-map.prototype.removeAttr
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - removeAttr</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-map.prototype.removeAttr.html">removeAttr</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>removeAttr</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map/edit/master/docs/prototype.removeAttr.md">Edit on GitHub</a>
				</li>
    ...
    <p>Remove a property from a Map.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>attrName</b> <code>{String}</code>: <p>the name of the property to remove</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>the value of the property that was removed</p>
</p>
  </div>
    ...
    <section class="body">
    <p><code>removeAttr</code> removes a property by name from a Map.</p>
<pre><code>var people = new Map({a: 'Alice', b: 'Bob', e: 'Eve'});
...
under <code><a href="can-map.prototype.attr.html" title="Get or set properties on a Map.">attr</a></code>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map/docs/prototype.removeAttr.md"},"description":"Remove a property from a Map. \n","title":"removeAttr","name":"can-map.prototype.removeAttr","type":"function","parent":"can-map.prototype","order":6,"signatures":[{"code":"map.removeAttr(attrName)","description":"","params":[{"types":[{"type":"String"}],"name":"attrName","description":"the name of the property to remove"}],"returns":{"types":[{"type":"*"}],"description":"the value of the property that was removed\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"attrName","description":"the name of the property to remove"},"_curReturn":{"types":[{"type":"*"}],"description":"the value of the property that was removed\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
