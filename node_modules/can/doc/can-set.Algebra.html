...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/docs/can-set.algebra.md
	@function can-set.Algebra
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Algebra</title>
  ...
  lastName: function(aValue, bValue){
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.count.html"
							title="">
							count
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.difference.html"
							title="">
							difference
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.equal.html"
							title="">
							equal
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.getSubset.html"
							title="">
							getSubset
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.getUnion.html"
							title="">
							getUnion
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.has.html"
							title="">
							has
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.id.html"
							title="">
							id
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.index.html"
							title="">
							index
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.intersection.html"
							title="">
							intersection
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.properSubset.html"
							title="">
							properSubset
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.subset.html"
							title="">
							subset
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Algebra.prototype.union.html"
							title="">
							union
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-set.Translate.html"
							title="can-set.Translate">
							Translate
						</a>
...
<div class="breadcrumb">
		...
		<li><a href="can-set.html">can-set</a></li>
		<li> / </li>
	
	
	<li><a href="can-set.Algebra.html">Algebra</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Algebra</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/docs/can-set.algebra.md">Edit on GitHub</a>
				</li>
    ...
    <p>Perform set logic with an awareness of how certain properties represent a set.</p>
...
<div class="signature">
  ...
  <p>An <code>algebra</code> instance can perform a variety of set logic methods
using the <code>compares</code> configuration.</p>
<p>A default <code>algebra</code> instance can be created like:</p>
<pre><code class="language-js">var set = require(&quot;can-set&quot;);
var defaultAlgebra = new set.Algebra();
</code></pre>
<p>This treats every property as a filter in a <code>where</code> clause.  For example:</p>
<pre><code class="language-js">// `{id: 2, ownerId: 5}` belongs to ``.getList({ownerId: 5})`
...
<p><a href="can-set.compares.html" title="An object of property names and prop functions.
{
// return `true` if the values should be considered the same:
lastName: function(aValue, bValue){
return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
}
}">Compares</a> configurations can be passed to
add better property behavior awareness:</p>
<pre><code class="language-js">var set = require(&quot;can-set&quot;);
...
<p><a href="can-set.props.html" title="Contains a collection of prop generating functions.
The following functions create compares objects that can be mixed together to create a set Algebra.
var set = require(&quot;can-set&quot;);
var algebra = new set.Algebra(
{
...
set.props.boolean(&quot;completed&quot;),
set.props.rangeInclusive(&quot;start&quot;,&quot;end&quot;)
);">props</a> has helper functions that make common <a href="can-set.compares.html" title="An object of property names and prop functions.
{
// return `true` if the values should be considered the same:
lastName: function(aValue, bValue){
return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>compares</b> <code>{<a href="can-set.compares.html" title="An object of property names and prop functions.
{
  // return `true` if the values should be considered the same:
  lastName: function(aValue, bValue){
    return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
  }
}">Compares</a>}</code>: <p>Each argument is a compares. These
are returned by the functions on <a href="can-set.props.html" title="Contains a collection of prop generating functions.
The following functions create compares objects that can be mixed together to create a set Algebra.
var set = require(&quot;can-set&quot;);
var algebra = new set.Algebra(
{
...
manually.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a>(<a href="can-set.compares.html" title="An object of property names and prop functions.
{
  // return `true` if the values should be considered the same:
  lastName: function(aValue, bValue){
    return (&quot;&quot;+aValue).toLowerCase() === (&quot;&quot;+bValue).toLowerCase();
  }
}">compares</a>)}</code>: <p>Returns an instance of an algebra.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-set/docs/can-set.algebra.md"},"description":"Perform set logic with an awareness of how certain properties represent a set.\n\n\n","title":"Algebra","name":"can-set.Algebra","type":"function","parent":"can-set.properties","signatures":[{"code":"new set.Algebra(compares...)","description":"\n\nAn `algebra` instance can perform a variety of set logic methods\nusing the `compares` configuration.\n\nA default `algebra` instance can be created like:\n\n```js\nvar set = require(\"can-set\");\nvar defaultAlgebra = new set.Algebra();\n```\n\nThis treats every property as a filter in a `where` clause.  For example:\n\n```js\n// `{id: 2, ownerId: 5}` belongs to ``.getList({ownerId: 5})`\ndefaultAlgebra.has({ownerId: 5}, {id: 2, ownerId: 5}) //-> true\n\ndefaultAlgebra.getSubset({ownerId: 5}, {},\n    [\n        {id: 1, ownerId: 2},\n        {id: 2, ownerId: 5},\n        {id: 3, ownerId: 12}\n    ]) //-> [{id: 2, ownerId: 5}]\n```\n\n[can-set.compares] configurations can be passed to\nadd better property behavior awareness:\n\n\n```js\nvar set = require(\"can-set\");\nvar todoAlgebra = new set.Algebra(\n  set.props.boolean(\"completed\"),\n  set.props.id(\"_id\"),\n  set.props.offsetLimit(\"offset\",\"limit\")\n);\n\ndefaultAlgebra.getSubset({limit: 2, offset: 1}, {},\n    [\n        {id: 1, ownerId: 2},\n        {id: 2, ownerId: 5},\n        {id: 3, ownerId: 12}\n    ]) //-> [{id: 2, ownerId: 5},{id: 3, ownerId: 12}]\n```\n\n[can-set.props] has helper functions that make common [can-set.compares]\nconfigurations.\n","params":[{"types":[{"type":"can-set.compares"}],"name":"compares","description":"Each argument is a compares. These\nare returned by the functions on [can-set.props] or can be created\nmanually.\n"}],"returns":{"types":[{"type":"can-set.Algebra"}],"description":"Returns an instance of an algebra.\n"}}],"_curParam":{"types":[{"type":"can-set.compares"}],"name":"compares","description":"Each argument is a compares. These\nare returned by the functions on [can-set.props] or can be created\nmanually.\n"},"_curReturn":{"types":[{"type":"can-set.Algebra"}],"description":"Returns an instance of an algebra.\n"},"pathToRoot":".."};
</script>
</article>
