...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-callbacks/docs/attr.md
	@function can-view-callbacks.attr
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-view-callbacks.attr.html">attr</a></li>
	...
	<div class="page-type">
		<h1>attr</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-callbacks/edit/master/docs/attr.md">Edit on GitHub</a>
				</li>
...
in a template.</p>
<p>Handlers must be registered before templates using them are parsed.</p>
<pre><code class="language-js">var canViewCallbacks = require(&quot;can-view-callbacks&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>attributeName</b> <code>{String|RegExp}</code>: <p>A lower-case attribute name or regular expression
that matches attribute names. Examples: <code>&quot;my-fill&quot;</code> or <code>/my-\w/</code>.</p>
</li>
        
          <li><b>attrHandler</b> <code>{function(el, <a href="can-view-callbacks.attrData.html" title="The data provided to can-view-callbacks.attr.">attrData</a>)}</code>: <p>A function that adds custom behavior to <code>el</code>. Note that <code>el</code> might not be in the DOM
when the callback is called.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>canViewCallbacks.attr</code> is used to add custom behavior to elements that contain a
specified html attribute. Typically it is used to mixin behavior (whereas
<a href="can-view-callbacks.tag.html" title="">tag</a> is used to define behavior).</p>
...
<p>The <a href="can-util/dom/events/attributes/attributes.html" title="Adds a listenable &quot;attributes&quot; event to DOM nodes, which fires when
the node's attributes change.">attributes</a> event can be used to listen to when
the toolip attribute changes its value like:</p>
<pre><code class="language-js">canViewCallbacks.attr(&quot;tooltip&quot;, function( el, attrData ) {
...
data from the element's <a href="can.view.Scope.html" title="undefined">scope</a>. For example,
...
<p>These values can be read from <a href="can-view-callbacks.attrData.html" title="The data provided to can-view-callbacks.attr.">attrData</a>'s scope like:</p>
...
using <a href="can-view-scope.prototype.compute.html" title="">compute</a> to get a get/set compute that is
...
<pre><code>canViewCallbacks.attr(&quot;toggle&quot;, function(el, attrData){
...
<pre><code>canViewCallbacks.attr(&quot;fade-in-when&quot;, function( el, attrData ) {
...
unbind the event handler when the element is <a href="can-util/dom/events/removed/removed.html" title="This event fires when the bound element is detached or destroyed.">removed</a> from the page:</p>
<pre><code class="language-js">domEvents.addEventListener.call(el,&quot;removed&quot;, function(){
    fadeInCompute.off(handler);
});
</code></pre>
<div class='demo_wrapper' data-demo-src='demos/can-view-callbacks/fade_in_when.html'></div>
<h2>When to call</h2>
<p><code>canViewCallbacks.attr</code> must be called before a template is processed. When <a href="http://canjs.com/docs/can.view.html#sig_can_view_idOrUrl_">using <code>can.view</code> to create a renderer function</a>, <code>canViewCallbacks.attr</code> must be called before the template is loaded, not simply before it is rendered.</p>
<pre><code>    //Call canViewCallbacks.attr first
