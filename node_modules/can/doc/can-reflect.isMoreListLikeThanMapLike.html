...
<!--####################################################################
	...
	@function can-reflect.isMoreListLikeThanMapLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isMoreListLikeThanMapLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isMoreListLikeThanMapLike.html">isMoreListLikeThanMapLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isMoreListLikeThanMapLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L427">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value should be treated as a list instead of a map.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isMoreListLikeThanMapLike(obj)</code>
  </h2>
  <p>Return  <code>true</code> if <code>obj</code> is an Array, declares itself to be more ListLike with
<code>@@can.isMoreListLikeThanMapLike</code>, or self-reports as ListLike but not as MapLike; <code>false</code> otherwise.</p>
<pre><code>canReflect.isMoreListLikeThanMapLike([]); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to test for ListLike against MapLike traits.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isMoreListLikeThanMapLike","parent":"can-reflect/type","src":{"line":426,"codeLine":449,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value should be treated as a list instead of a map. \n","title":"isMoreListLikeThanMapLike","signatures":[{"code":"isMoreListLikeThanMapLike(obj)","description":"\n\nReturn  `true` if `obj` is an Array, declares itself to be more ListLike with\n`@@can.isMoreListLikeThanMapLike`, or self-reports as ListLike but not as MapLike; `false` otherwise.\n\n```\ncanReflect.isMoreListLikeThanMapLike([]); // -> true\ncanReflect.isMoreListLikeThanMapLike(null); // -> undefined\ncanReflect.isMoreListLikeThanMapLike({}); // -> false\ncanReflect.isMoreListLikeThanMapLike(new DefineList()); // -> true\ncanReflect.isMoreListLikeThanMapLike(new DefineMap()); // -> false\ncanReflect.isMoreListLikeThanMapLike(function() {}); // -> false\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test for ListLike against MapLike traits."}],"returns":{"types":[{"type":"Boolean"}],"description":"\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test for ListLike against MapLike traits."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n "},"pathToRoot":".."};
</script>
</article>
