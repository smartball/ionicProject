...
<!--####################################################################
	...
	@function can-reflect.isIteratorLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isIteratorLike</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-reflect.isIteratorLike.html">isIteratorLike</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>isIteratorLike</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/type/type.js#L466">Edit on GitHub</a>
				</li>
    ...
    <p>Test if a value looks like an iterator.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isIteratorLike(obj)</code>
  </h2>
  <p>Return <code>true</code> if <code>obj</code> has a key <code>&quot;next&quot;</code> pointing to a zero-argument function; <code>false</code> otherwise</p>
<pre><code>canReflect.isIteratorLike([][Symbol.iterator]()); // -&gt; true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to test for Iterator traits</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect.isIteratorLike","parent":"can-reflect/type","src":{"line":465,"codeLine":485,"path":"node_modules/can-reflect/reflections/type/type.js"},"description":"Test if a value looks like an iterator. ","title":"isIteratorLike","signatures":[{"code":"isIteratorLike(obj)","description":"\n\nReturn `true` if `obj` has a key `\"next\"` pointing to a zero-argument function; `false` otherwise\n\n```\ncanReflect.isIteratorLike([][Symbol.iterator]()); // -> true\ncanReflect.isIteratorLike(new DefineList()[canSymbol.iterator]()); // -> true\ncanReflect.isIteratorLike(new DefineMap()[canSymbol.iterator]()); // -> true\ncanReflect.isIteratorLike(null); // -> false\ncanReflect.isIteratorLike({ next: function() {} }); // -> true\ncanReflect.isIteratorLike({ next: function(foo) {} }); // -> false (iterator nexts do not take arguments)\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test for Iterator traits"}],"returns":{"types":[{"type":"Boolean"}],"description":"\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to test for Iterator traits"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n "},"pathToRoot":".."};
</script>
</article>
