...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-signalr/docs/can-connect-signalr.md
	@module can-connect-signalr
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-signalr</title>
...
SignalR server.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect-signalr.signalR.html"
							title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">
							signalR
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr.init.html"
							title="Establishes a connection to the SignalR hub, sets up proxy methods and RPC listeners.
...
The init method is called automatically.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr/createData.html"
							title="Creates an instance on the server.  This is invoked on a new instance by calling save.">
							createData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr/destroyData.html"
							title="Destroys an instance on the server.  This is invoked on an instance by calling destroy.">
							destroyData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr/getData.html"
							title="Gets an instance from the server. This is invoked on a constructor function by calling getData.">
							getData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr/getListData.html"
							title="Gets an list of data from the server. This is invoked on a constructor function by calling getListData.">
							getListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="can-connect-signalr/updateData.html"
							title="Updates an instance on the server.  This is invoked on an existing instance by calling save.">
							updateData
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-signalr.html">can-connect-signalr</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-signalr</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-signalr">
						<img src="https://img.shields.io/badge/npm%20package-0.2.2-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-connect-signalr" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-signalr/edit/master/docs/can-connect-signalr.md">Edit on GitHub</a>
				</li>
    ...
    <p>Connect to a <a href="https://docs.microsoft.com/en-us/aspnet/signalr/overview/guide-to-the-api/hubs-api-guide-server">Hub</a> on a
<a href="https://docs.microsoft.com/en-us/aspnet/signalr/">SignalR</a> server.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connectSignalR( baseBehavior )</code>
  </h2>
  <p>Encapsulates connecting to a <code>SignalR</code> hub, by:</p>
<ul>
<li><p>implementing the: <a href="can-connect-signalr/createData.html" title="Creates an instance on the server.  This is invoked on a new instance by calling save.">createData</a>,  <a href="can-connect-signalr/updateData.html" title="Updates an instance on the server.  This is invoked on an existing instance by calling save.">updateData</a>, <a href="can-connect-signalr/getData.html" title="Gets an instance from the server. This is invoked on a constructor function by calling getData.">getData</a>, <a href="can-connect-signalr/getListData.html" title="Gets an list of data from the server. This is invoked on a constructor function by calling getListData.">getListData</a>, and <a href="can-connect-signalr/destroyData.html" title="Destroys an instance on the server.  This is invoked on an instance by calling destroy.">destroyData</a> <a href="can-connect/DataInterface.html" title="The most common raw data methods.">DataInterface</a> methods to make RPC calls to the server.</p></li>
<li><p>listening for the following messages pushed from the server to the browser:</p>
<ul>
<li><a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a><code>.createdName</code>,</li>
<li><a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a><code>.updatedName</code>,</li>
<li><a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a><code>.destroyedName</code></li>
</ul>
<p>and calling: <a href="can-connect/real-time/real-time.createInstance.html" title="Programatically indicate a new instance has been created.">createInstance</a>, <a href="can-connect/real-time/real-time.updateInstance.html" title="Programatically indicate a new instance has been updated.">updateInstance</a>, or <a href="can-connect/real-time/real-time.destroyInstance.html" title="Programatically indicate a new instance has been destroyed.">destroyInstance</a>.</p></li>
</ul>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-connect-signalr</code> is a <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> behavior that makes a connection that can communicate with a
<a href="https://docs.microsoft.com/en-us/aspnet/signalr/overview/guide-to-the-api/hubs-api-guide-server">Hub</a> on a
<a href="https://docs.microsoft.com/en-us/aspnet/signalr/">SignalR</a> server.</p>
<p>The following walks through an example setup that allows a <code>Message</code>
...
server.</p>
<p>Specifically, we will detail the:</p>
<ul>
<li><code>can-connect</code> Client setup</li>
<li>Hub Interface Requirements</li>
</ul>
<h3><code>can-connect</code> Client setup</h3>
<p>Below is a complete example of connecting a <code>DefineMap</code> model type to
a SignalR hub:</p>
...
<p>This example creates a <code>Message</code> <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> type and
<code>Message.List</code> <a href="can-define/list/list.html" title="Create observable lists.">can-define/list/list</a> type and connects them
to <code>MessageHub</code> at <code>http://test.com</code>.</p>
<p>This sets up <code>Message</code> so it can retrieve, create, update and delete <code>Message</code>s as follows:</p>
<style>
.table {
 width: 100%;
...
<table class="table">
  ...
  body: "Hello World!"
       ...
       <td>
          This calls <code>MessageHub</code>'s <code>public MessageModel messageHubCreate( MessageModel message )</code> method with the <a href="can-define.types.serialize.html" title="Defines custom serialization behavior for a property.">serialized</a> properties of the client message.  <code>MessageHubCreate</code> is expected to persist the message, add a unique
            <a href="can-connect/base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> property and value, and return the <code>Message</code>'s new data. It should also notify clients that a message was created.
       </td>
    </tr>
    <tr>
       <td>
...
<h3>Hub Server Setup</h3>
<p>The following code outlines a <code>MessageHub</code> that would work with with
the above client setup:</p>
<pre><code class="language-c-sharp">public class MessageHub : Hub
    {
...
<h2>Configuration</h2>
<p>The name of the Hub is specified by <a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a><code>.name</code>.
This is used to create default method and event names.</p>
<p>For example, if the <a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a><code>.name</code> is <code>&quot;TaskHub&quot;</code>, it
will make RPC calls for the following methods (<a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a> configuration name in parenthesis):</p>
<ul>
<li><code>taskHubGetData</code> (<code>signalR.getListName</code>)</li>
<li><code>taskHubGetListData</code> (<code>signalR.getListName</code>)</li>
<li><code>taskHubCreateData</code> (<code>signalR.createName</code>)</li>
<li><code>taskHubUpdateData</code> (<code>signalR.updateName</code>)</li>
<li><code>taskHubDestroyData</code> (<code>signalR.destroyName</code>)</li>
</ul>
<p>It will listen to the following events (<a href="can-connect-signalr.signalR.html" title="The options object passed to the can-connect factory function that generates the  can-connect-signalr connection.">signalR</a> configuration name in parenthesis):</p>
<ul>
<li><code>taskHubCreatedData</code> (<code>signalR.createdData</code>)</li>
<li><code>taskHubUpdatedData</code> (<code>signalR.updatedData</code>)</li>
<li><code>taskHubDestroyedData</code> (<code>signalR.destroyedData</code>)</li>
</ul>
<p>For example, you can overwrite these defaults like:</p>
<pre><code>connect(behaviors,{
    Map: Task,
    signalR: {
        url: &quot;/hubs&quot;,
        name: &quot;TaskHub&quot;,
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/can-connect-signalr.md"},"description":"Connect to a [Hub](https://docs.microsoft.com/en-us/aspnet/signalr/overview/guide-to-the-api/hubs-api-guide-server) on a\n[SignalR](https://docs.microsoft.com/en-us/aspnet/signalr/) server.\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect-signalr","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-connect-signalr/issues"},"bundleDependencies":false,"dependencies":{"can-connect":"^1.5.0","jquery":"2.x - 3.x","ms-signalr-client":"^2.2.5"},"deprecated":false,"description":"can-connect-signalr is a set of behaviors for integrating can-connect with Microsoft's signalR","devDependencies":{"can-define":"^1.2.0","jshint":"^2.9.1","steal":"^1.5.2","steal-qunit":"^1.0.1","steal-tools":"^1.0.0","testee":"^0.5.0"},"homepage":"https://github.com/canjs/can-connect-signalr#readme","keywords":[],"license":"MIT","main":"can-connect-signalr","name":"can-connect-signalr","repository":{"type":"git","url":"git+https://github.com/canjs/can-connect-signalr.git"},"scripts":{"develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"system":{"transpiler":"babel"},"version":"0.2.2"},"signatures":[{"code":"connectSignalR( baseBehavior )","description":"\n\nEncapsulates connecting to a `SignalR` hub, by:\n\n- implementing the: [can-connect-signalr/createData],  [can-connect-signalr/updateData], [can-connect-signalr/getData], [can-connect-signalr/getListData], and [can-connect-signalr/destroyData] [can-connect/DataInterface] methods to make RPC calls to the server.\n- listening for the following messages pushed from the server to the browser:\n  - [can-connect-signalr.signalR]`.createdName`,\n  - [can-connect-signalr.signalR]`.updatedName`,\n  - [can-connect-signalr.signalR]`.destroyedName`\n\n  and calling: [can-connect/real-time/real-time.createInstance], [can-connect/real-time/real-time.updateInstance], or [can-connect/real-time/real-time.destroyInstance].\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
