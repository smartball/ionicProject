...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/helpers/eq.md
	@function can-stache.helpers.eq
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - {{#eq(expressions)}}</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.helpers.eq.html">{{#eq(expressions)}}</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>{{#eq(expressions)}}</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/helpers/eq.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>{{#eq([EXPRESSION...])}}FN{{else}}INVERSE{{/eq}}</code>
  </h2>
  <p>Render FN if two values are equal, otherwise render INVERSE.</p>
<p><code>eq</code> is an alias for <a href="can-stache.helpers.is.html" title="Render something if two values are equal.">the <code>is</code> helper</a>.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/helpers/eq.md"},"description":"\n","title":"{{#eq(expressions)}}","name":"can-stache.helpers.eq","type":"function","parent":"can-stache.htags","order":12,"signatures":[{"code":"{{#eq([EXPRESSION...])}}FN{{else}}INVERSE{{/eq}}","description":"\n\nRender FN if two values are equal, otherwise render INVERSE.\n\n`eq` is an alias for [can-stache.helpers.is the `is` helper].\n\n\n","params":[]}],"pathToRoot":".."};
</script>
</article>
