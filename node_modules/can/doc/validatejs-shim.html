...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-validate-legacy/docs/validatejs-shim.md
	@module validatejs-shim
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ValidateJS Shim</title>
...
itself with can.validate and passes the methods object.">
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="module"
							href="validatejs-shim.html"
							title="This shim requires ValidateJS in the consuming app&#x27;s package.json. It processes
...
<div class="breadcrumb">
		...
		<li><a href="can-validate-legacy.shims.html">Shims</a></li>
		<li> / </li>
	
	
	<li><a href="validatejs-shim.html">validatejs-shim</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ValidateJS Shim</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-validate-legacy/edit/master/docs/validatejs-shim.md">Edit on GitHub</a>
				</li>
    ...
    <p>This shim requires ValidateJS in the consuming app's package.json. It processes
the passed in options so they can be properly used by the ValidateJS libarary.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>validate(MAP_OF_VALUES, MAP_OF_CONSTRAINTS)</code>
  </h2>
  <pre><code class="language-javascript">var errors = validate.validate(user, constraints);
</code></pre>
<p>Validate is a can.Construct that is set to can.validate. It is possible to create
an instance for the purpose of storing errors in the instance. It is recommended
to use can.Map, can.Map.define, and can.Map.validate instead.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>once(VALUE, CONSTRAINTS, VALUE_NAME)</code>
  </h2>
...
<div class="signature">
  <h2 class="signature-title">
    <code>isValid(VALUE, CONSTRAINTS, VALUE_NAME)</code>
  </h2>
  <pre><code class="language-javascript">var errors = validate.once(user.firstName, constraints.firstName, 'firstName');
</code></pre>
...
<p>Import ValidateJS, validate plugin and this shim to immediately use the
ValidateJS in a CanJS project plugin.</p>
<pre><code class="language-js">import &quot;validatejs&quot;;
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-validate-legacy/docs/validatejs-shim.md"},"description":" This shim requires ValidateJS in the consuming app's package.json. It processes\nthe passed in options so they can be properly used by the ValidateJS libarary.\n","type":"module","title":"ValidateJS Shim","types":[{"type":"Object","options":[]}],"name":"validatejs-shim","parent":"can-validate-legacy.shims","comment":" ","signatures":[{"code":"validate(MAP_OF_VALUES, MAP_OF_CONSTRAINTS)","description":"\n\n```javascript\nvar errors = validate.validate(user, constraints);\n```\n\nValidate is a can.Construct that is set to can.validate. It is possible to create\nan instance for the purpose of storing errors in the instance. It is recommended\nto use can.Map, can.Map.define, and can.Map.validate instead.\n","params":[]},{"code":"once(VALUE, CONSTRAINTS, VALUE_NAME)","description":"\n\n```javascript\nvar errors = validate.once(user.firstName, constraints.firstName, 'firstName');\n```","params":[]},{"code":"isValid(VALUE, CONSTRAINTS, VALUE_NAME)","description":"\n\n```javascript\nvar errors = validate.once(user.firstName, constraints.firstName, 'firstName');\n```\n","params":[]}],"pathToRoot":".."};
</script>
</article>
