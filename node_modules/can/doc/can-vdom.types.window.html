...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-vdom/docs/window.md
	@typedef can-vdom.types.window
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - window</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-vdom.types.window.html">window</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>window</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-vdom/edit/master/docs/window.md">Edit on GitHub</a>
				</li>
    ...
    <p>An object representing a fake <code>window</code> object.</p>
...
<div class="signature">
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>document</b> <code>{can-simple-dom/document/document}</code>:
        <p>A browser document</p>

      </li>
    
      <li>
        <b>window</b> <code>{Object}</code>:
        <p>The window itself.</p>

      </li>
    
      <li>
        <b>self</b> <code>{Object}</code>:
        <p>The <code>self</code> object is an alias for <code>window</code>.</p>

      </li>
    
      <li>
        <b>addEventListener</b> <code>{function}</code>:
        <p>A stub for <code>window.addEventListener</code>, does not actually set up events unless overridden some place else.</p>

      </li>
    
      <li>
        <b>removeEventListener</b> <code>{function}</code>:
        <p>A stub for <code>window.removeEventListener</code>.</p>

      </li>
    
      <li>
        <b>navigator</b> <code>{Object}</code>:
        
      </li>
    
      <li>
        <b>location</b> <code>{Object}</code>:
        
      </li>
    
      <li>
        <b>history</b> <code>{Object}</code>:
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-vdom/docs/window.md"},"description":"\nAn object representing a fake `window` object.\n","type":"typedef","title":"window","types":[{"type":"Object","options":[{"name":"document","description":"A browser document\n","types":[{"type":"can-simple-dom/document/document"}]},{"name":"window","description":"The window itself.\n","types":[{"type":"Object","options":[]}]},{"name":"self","description":"The `self` object is an alias for `window`.\n","types":[{"type":"Object","options":[]}]},{"name":"addEventListener","description":"A stub for `window.addEventListener`, does not actually set up events unless overridden some place else.\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"removeEventListener","description":"A stub for `window.removeEventListener`.\n","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}]},{"name":"navigator","description":"\n","types":[{"type":"Object","options":[]}]},{"name":"location","description":"\n","types":[{"type":"Object","options":[]}]},{"name":"history","description":"\n","types":[{"type":"Object","options":[]}]}]}],"name":"can-vdom.types.window","parent":"can-vdom.types","pathToRoot":".."};
</script>
</article>
