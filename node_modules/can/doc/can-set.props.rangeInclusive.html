...
<!--####################################################################
	...
	@function can-set.props.rangeInclusive
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - rangeInclusive</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.props.rangeInclusive.html">rangeInclusive</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>rangeInclusive</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/src/props.js#L440">Edit on GitHub</a>
				</li>
    ...
    <p>Supports ranged properties.</p>
...
[0,20] loads 21 items.</p>
<pre><code>set.props.rangeInclusive(&quot;start&quot;,&quot;end&quot;)
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>startIndexProperty</b> <code>{String}</code>: <p>The starting property name</p>
</li>
        
          <li><b>endIndexProperty</b> <code>{String}</code>: <p>The ending property name</p>
</li>
...
}">Compares</a>}</code>: <p>Returns a prop</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-set.props.rangeInclusive","parent":"can-set.props","src":{"line":439,"codeLine":459,"path":"node_modules/can-set/src/props.js"},"description":"Supports ranged properties. \n","title":"rangeInclusive","signatures":[{"code":"set.props.rangeInclusive(startIndexProperty, endIndexProperty)","description":"\n\nMakes a prop for two ranged properties that specify a range of items\nthat includes both the startIndex and endIndex.  For example, a range of\n[0,20] loads 21 items.\n\n```\nset.props.rangeInclusive(\"start\",\"end\")\n```\n","params":[{"types":[{"type":"String"}],"name":"startIndexProperty","description":"The starting property name"},{"types":[{"type":"String"}],"name":"endIndexProperty","description":"The ending property name"}],"returns":{"types":[{"type":"can-set.compares"}],"description":"Returns a prop\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"endIndexProperty","description":"The ending property name"},"_curReturn":{"types":[{"type":"can-set.compares"}],"description":"Returns a prop\n"},"pathToRoot":".."};
</script>
</article>
