...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define/docs/types.set.md
	@function can-define.types.set
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-define.types.set.html">set</a></li>
	...
	<div class="page-type">
		<h1>set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/docs/types.set.md">Edit on GitHub</a>
				</li>
