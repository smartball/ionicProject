...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-canjs/can-legacy.md
	@page can-legacy
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Legacy</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>Legacy</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/canjs/edit/master/docs/can-canjs/can-legacy.md">Edit on GitHub</a>
				</li>
    ...
    <p>Former libraries that we still accept patches for, but are not under active development.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-canjs/can-legacy.md"},"description":"Former libraries that we still accept patches for, but are not under active development.\n\n","name":"can-legacy","title":"Legacy","type":"page","parent":"api","order":3,"comment":" ","pathToRoot":".."};
</script>
</article>
