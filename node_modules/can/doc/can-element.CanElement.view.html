...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-element/docs/can-element.CanElement.view.md
	@typedef can-element.CanElement.view
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - CanElement.view</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-element.CanElement.view.html">CanElement.view</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>CanElement.view</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-element/edit/master/docs/can-element.CanElement.view.md">Edit on GitHub</a>
				</li>
    ...
    <p>A static getter that returns the renderer function used to render the element's shadow DOM.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-element/docs/can-element.CanElement.view.md"},"description":"\nA static getter that returns the renderer function used to render the element's shadow DOM.\n","type":"typedef","title":"CanElement.view","types":[{"type":"Object","options":[]}],"name":"can-element.CanElement.view","parent":"can-element.CanElement","pathToRoot":".."};
</script>
</article>
