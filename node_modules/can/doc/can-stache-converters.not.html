...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/not.md
	@function can-stache-converters.not
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - not</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.not.html">not</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>not</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/not.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that two-way binds the negation of a value.</p>
...
<div class="signature">
  ...
  <p>When the getter is called, gets the value of the compute and returns the negation.</p>
<p>When the setter is called, sets the compute’s value to the negation of the new value derived from the element.</p>
<p><em>Note</em> that <code>not</code> needs a compute so that it can update the scope’s value when the setter is called.</p>
<pre><code class="language-handlebars">&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;not(~val)&quot; /&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A value stored in a <a href="can-compute.html" title="Create an observable value.">can-compute</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be two-way bound by <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> as a getter/setter on the element.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Use this converter to two-way bind to the negation of some value. For example:</p>
<pre><code class="language-handlebars">&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;not(~val)&quot; /&gt;
</code></pre>
