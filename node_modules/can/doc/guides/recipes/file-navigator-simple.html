...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-guides/commitment/recipes/file-navigator/file-navigator-simple.md
	...
	<div class="page-type">
		<h1>File Navigator Guide (Simple)</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/canjs/edit/master/docs/can-guides/commitment/recipes/file-navigator/file-navigator-simple.md">Edit on GitHub</a>
				</li>
...
<p><a class="jsbin-embed" href="https://jsbin.com/hisupin/4/embed?js,output">
Finished version of the CanJS File Navigator Guide (Simple) on jsbin.com
</a>
<a href="https://jsfiddle.net/donejs/Lus3f8kL/">Open in JSFiddle</a></p>
...
<p><a class="jsbin-embed" href="https://jsbin.com/diqeyoj/16/embed?html,css,output">
Starter version of the CanJS File Navigator Guide (Simple) on jsbin.com
</a>
<a href="https://jsfiddle.net/donejs/5vmsnx89/">Open in JSFiddle</a></p>
...
<h3>The problem</h3>
<p>Let’s render <code>rootEntityData</code> in the page with its immediate children.</p>
...
and keep it updated.  Templates can be authored in <code>&lt;script&gt;</code> tags like:</p>
...
<p><span line-highlight='2-13'></span>
...
<p><span line-highlight='1-5'></span></p>
<h2>Render all the files and folders</h2>
<h3>The Problem</h3>
<p>Now let’s render all of the files and folders!  This means we want to render the files and folders recursively.  Every time we
...
<p><span line-highlight='1-14,19'></span></p>
<h3>Test it</h3>
<p>Run the following the <strong>Console</strong> tab:</p>
...
<p><span line-highlight='2,3,15'></span></p>
<h2>Result</h2>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-guides/commitment/recipes/file-navigator/file-navigator-simple.md"},"description":"This guide walks you through building a simple file navigation widget.  It takes about 25 minutes to complete.  It was written with\nCanJS 3.10. Check out the [guides/recipes/file-navigator-advanced]\nfor an example that makes AJAX requests for its data and uses [can-component].\n\n\n","name":"guides/recipes/file-navigator-simple","title":"File Navigator Guide (Simple)","type":"page","parent":"guides/recipes","comment":" ","pathToRoot":"../../.."};
</script>
</article>
