...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-guides/commitment/recipes/weather-report/weather-report-advanced.md
...
<p><a class="jsbin-embed" href="https://jsbin.com/jipevu/3/embed?html,js,output">JS Bin on jsbin.com</a></p>
<p><strong>Start this tutorial by cloning the following JS Bin</strong>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/qowacac/3/embed?html,js,output">JS Bin on jsbin.com</a></p>
...
<p><span line-highlight='3-21,24-40,only'></span>
Update the <strong>HTML</strong> tab:</p>
...
<p><span line-highlight='61-63,only'></span>
Update the <strong>HTML</strong> tab:</p>
<pre><code class="language-html">Latitude: {{geoLocation.coords.latitude}},
Longitude: {{geoLocation.coords.longitude}},
Error: {{geoLocationError.message}}
...
<p><span line-highlight='64-66,only'></span>
Update the <strong>HTML</strong> tab:</p>
<pre><code class="language-html">Latitude: {{geoLocation.coords.latitude}},
Longitude: {{geoLocation.coords.longitude}},
Error: {{geoLocationError.message}}
