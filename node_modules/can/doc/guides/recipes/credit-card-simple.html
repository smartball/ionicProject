...
<p><a class="jsbin-embed" href="https://jsbin.com/konemoc/1/embed?output">JS Bin on jsbin.com</a></p>
...
<p><a class="jsbin-embed" href="https://jsbin.com/gafibor/3/embed?output">JS Bin on jsbin.com</a></p>
...
<h3>What you need to know</h3>
<ul>
<li><p>Use <a href="../../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">value:bind</a> to setup a two-way binding<br />
in <code>can-stache</code>.  For example, the following keeps <code>email</code> on the ViewModel and the input's <code>value</code> in sync:</p>
