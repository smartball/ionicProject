...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-guides/commitment/recipes/weather-report/weather-report.md
...
<p><a class="jsbin-embed" href="https://jsbin.com/vujugel/3/embed?html,js,output">JS Bin on jsbin.com</a></p>
...
<h2>Setup</h2>
<h3>The problem</h3>
<p>Get the basic setup for a CanJS app (in a JS Bin) setup by:</p>
<ol>
...
<h3>The solution</h3>
<p>Update the <strong>HTML</strong> tab to wrap the template in a <code>script</code> tag:</p>
...
<pre><code class="language-html">&lt;input value:to=&quot;property&quot;/&gt;
</code></pre></li>
...
<h3>The solution</h3>
<p>Update the <strong>JavaScript</strong> tab to define a <code>location</code> property as a string.</p>
<pre><code class="language-js">var WeatherViewModel = can.DefineMap.extend({
  location: &quot;string&quot;
});
...
Update the template in the <strong>HTML</strong> tab to:</p>
<ol>
...
<h3>The solution</h3>
<p>Update the <strong>JavaScript</strong> tab to set the <code>place</code> property to null when the <code>location</code> changes.</p>
<pre><code class="language-js">var yqlURL = &quot;//query.yahooapis.com/v1/public/yql?&quot;;
...
<h3>The solution</h3>
<p>Update the template in the <strong>HTML</strong> tab to use a <code>showPlacePicker</code> property to determine if we should show the <code>place</code> picker list.</p>
<pre><code class="language-html">&lt;script id=&quot;app-template&quot; type=&quot;text/stache&quot;&gt;
  &lt;div class=&quot;weather-widget&quot;&gt;
    &lt;div class=&quot;location-entry&quot;&gt;
      &lt;label for=&quot;location&quot;&gt;Enter Your location:&lt;/label&gt;
...
<p><a class="jsbin-embed" href="https://jsbin.com/vujugel/3/embed?js,output">JS Bin on jsbin.com</a></p>
