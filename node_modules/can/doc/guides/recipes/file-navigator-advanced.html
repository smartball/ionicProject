...
<p><a class="jsbin-embed" href="https://jsbin.com/nadebud/2/embed?js,output">
Finished version of the CanJS File Navigator Guide (Advanced) on jsbin.com
</a>
<a href="https://jsfiddle.net/donejs/evb4mkps/">Open in JSFiddle</a></p>
<blockquote>
<p>Note: If you don’t see any files show up, run the JS Bin again. This
JS Bin uses randomly generated files, so it’s possible nothing shows up.</p>
</blockquote>
<p><strong>Start this tutorial by cloning the following JS Bin</strong>:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/waxiyel/8/embed?html,css,output">
Starter version of the CanJS File Navigator Guide (Advanced) on jsbin.com
</a>
<a href="https://jsfiddle.net/donejs/wvb97vng/">Open in JSFiddle</a></p>
...
<p>Watch a video of us building this recipe here:</p>
...
<li><p><a href="../../can-fixture.store.html" title="">store</a> can be used to automatically filter records using the query string:</p>
...
<h3>Solution</h3>
<p>First, let’s make a function that generates an array of <code>entities</code> that will be
stored on our fake server. Update the <strong>JavaScript</strong> tab to:</p>
...
<p>Next, let’s make those entities, create a <code>store</code> to house them, and trap AJAX
requests to use that <code>store</code>:</p>
<pre><code class="language-js">// Stores the next entity id to use.
var entityId = 1;
...
<p><span line-highlight='43-53,only'></span></p>
...
<p><span line-highlight='55-61,only'></span></p>
...
<p><span line-highlight='63-66,only'></span></p>
...
<p><span line-highlight='68-80,only'></span></p>
...
<p><span line-highlight='3-17'></span>
The following adds an <code>entitiesPromise</code> to data passed to the template.  <code>entitiesPromise</code>
...
<p><span line-highlight='77,only'></span></p>
...
its children. <code>ViewModels</code> are constructor functions created with <a href="../../can-define/map/map.html" title="Create observable objects.">can.DefineMap</a>.</p></li>
...
<p><span line-highlight='75-91,94,only'></span>
...
<p><span line-highlight='2-3,19'></span></p>
...
<li><p>You can pass data to a component’s <code>ViewModel</code> with <a href="../../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">{data-bindings}</a> like:</p>
<pre><code class="language-html">&lt;my-component message:from=&quot;'Hi There'&quot; /&gt;
</code></pre>
<p>This sets <code>message</code> on the ViewModel to <code>'Hi There'</code>.  You can also send data within stache like:</p>
<pre><code class="language-html">&lt;my-component message:from=&quot;greeting&quot; /&gt;
</code></pre>
...
<p><span line-highlight='2,18'></span>
The following:</p>
<ol>
...
<p><span line-highlight='88-92,95,only'></span></p>
<h2>Result</h2>
<p>When complete, you should have a working file-navigation widget
like the following JS Bin:</p>
<p><a class="jsbin-embed" href="https://jsbin.com/nadebud/2/embed?js,output">
Finished version of the CanJS File Navigator Guide (Advanced) on jsbin.com
</a>
<a href="https://jsfiddle.net/donejs/evb4mkps/">Open in JSFiddle</a></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-guides/commitment/recipes/file-navigator/file-navigator-advanced.md"},"description":"This guide walks you through building a file navigation widget.  It takes about 45 minutes to complete.  It was written with\nCanJS 3.10. Check out the [guides/recipes/file-navigator-simple]\nfor an easier example that produces similar functionality.\n\n\n","name":"guides/recipes/file-navigator-advanced","title":"File Navigator Guide (Advanced)","type":"page","parent":"guides/recipes","comment":" ","pathToRoot":"../../.."};
</script>
</article>
