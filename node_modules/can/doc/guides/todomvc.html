...
<p><a class="jsbin-embed" href="https://jsbin.com/sasuje/11/embed?html,output">JS Bin on jsbin.com</a></p>
<p>The JS Bin starts
...
<p>The JS Bin also loads <a href="https://unpkg.com/can@3/dist/global/can.all.js">can.all.js</a>, which is a script that includes all of CanJS core, ecosystem, legacy and infrastructure libraries under a
...
should import things directly with a module loader like <a href="https://stealjs.com">StealJS</a>,
...
<p>Update the <strong>HTML</strong> tab to have a <code>&lt;script&gt;</code> tag around the html content.</p>
...
Update the <strong>HTML</strong> tab to:</p>
<ul>
...
<li>Use <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope."><code>checked:bind</code></a> to two-way bind the checkbox’s <code>checked</code> property to its todo’s <code>complete</code> property.</li>
...
on the server.</li>
<li>Use <a href="../can-connect/can/map/map.getList.html" title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">getList</a> to load a list of all todos on the server. The result
...
a map.">can-connect/can/super-map/super-map</a> adds the <a href="../can-connect/fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> behavior.  The
<a href="../can-connect/fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> behavior stores loaded data in
...
<li>A <code>createTodo</code> method that <a href="../can-connect/can/map/map.prototype.save.html" title="Save the instance's data to the service via the connection.">save</a>s the <code>Todo</code> instance
...
<ul>
<li>Updates the <code>todo</code>’s <code>name</code> with the <code>&lt;input&gt;</code>’s <code>value</code> using <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope."><code>value:bind</code></a>.</li>
<li>Calls <code>createTodo</code> when the <code>enter</code> key is pressed using <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels."><code>on:enter</code></a>.</li>
</ul></li>
...
on set logic.">real-time</a> behavior.  The
<a href="../can-connect/real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">real-time</a> behavior automatically inserts newly created items into
...
using <a href="../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element."><code>{todos}</code></a>.</li>
</ul>
<pre><code class="language-html">&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<li>An <code>updateName</code> method that updates the editing todo and <a href="../can-connect/can/map/map.prototype.save.html" title="Save the instance's data to the service via the connection.">saves</a> it to the server.</li>
</ul></li>
</ul>
<pre><code class="language-js">var todoAlgebra = new can.set.Algebra(
  can.set.props.boolean(&quot;complete&quot;),
...
<li>When the checkbox changes, update the todo on the server with <a href="../can-connect/can/map/map.prototype.save.html" title="Save the instance's data to the service via the connection.">save</a>,</li>
...
<ul>
<li>Two-way bind its value to the current todo’s <code>name</code> using <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope."><code>value:bind</code></a>.</li>
...
<code>appVM</code> will be set to <code>filter</code> with <a href="../can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a>.</li>
...
This is because the <a href="../can-connect/fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">fall-through-cache</a> is able to make use
...
<li>An <code>updateCompleteTo</code> method that updates every todo’s <code>complete</code> property to the specified value and updates the compute on the server with <a href="../can-connect/can/map/map.prototype.save.html" title="Save the instance's data to the service via the connection.">save</a>.</li>
...
<p><a class="jsbin-embed" href="https://jsbin.com/tibana/2/embed?html,js,output">JS Bin on jsbin.com</a></p>
