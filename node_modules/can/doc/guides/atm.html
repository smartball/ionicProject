...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: docs/can-guides/experiment/atm/atm.md
	@page guides/atm
######################################################################## -->
<html lang="en">
<head>
...
<p><a class="jsbin-embed" href="https://jsbin.com/daroce/2/embed?js,output">JS Bin on jsbin.com</a></p>
...
<p><a class="jsbin-embed" href="https://jsbin.com/meziyu/3/edit?html,js,output">JS Bin on jsbin.com</a></p>
<p>The JS Bin is designed to run both the application and its tests in the <code>OUTPUT</code>
tab.  To set this up, the <strong>HTML</strong> tab:</p>
<ul>
...
<li><p>Loads <a href="https://unpkg.com/can@3/dist/global/can.all.js">can.all.js</a>, which
...
<p>An <code>Account</code> will have an <code>id</code>, <code>name</code>, and <code>balance</code>.  We’ll use <a href="../can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> to add a
<a href="../can-connect/can/map/map.getList.html" title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">getList</a> method that retrieves an account given a <code>card</code>.</p>
