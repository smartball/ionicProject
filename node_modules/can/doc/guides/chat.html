...
<p><a class="jsbin-embed" href="https://jsbin.com/weganur/1/edit?html,output">JS Bin on jsbin.com</a></p>
<p>The JS Bin loads <a href="https://getbootstrap.com/" title="Bootstrap">Bootstrap</a> for its styles and <a href="https://socket.io/" title="socket.io">socket.io</a> for a socket
...
<p>The JS Bin also loads <a href="https://unpkg.com/can@3/dist/global/can.js">can.js</a>, which is a script that includes all of CanJS core under a
...
<p>In your JS Bin, update the <strong>HTML</strong> tab to:</p>
<ul>
...
<li>branching with <a href="../can-stache.helpers.if.html" title="can-stache.helpers.if">{{#if(expression)}}</a> or <a href="../can-stache.helpers.is.html" title="Render something if two values are equal.">{{#eq(expressions)}}</a></li>
</ul>
<blockquote>
...
<blockquote>
<p><strong>Key take-away:</strong>  <a href="../can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a> two-way binds changes in the browser’s url to
...
like <a href="../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel or element.">toChild:from</a> and <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a> to pass data
...
that represents the loading of all messages using <a href="../can-connect/can/map/map.getList.html" title="Method added to the configured map._Map type. Retrieves a map._List of
map._Map instances via the connection.">getList</a>.</li>
</ul>
<pre><code class="language-js">var Message = can.DefineMap.extend({
    id: &quot;number&quot;,
    name: &quot;string&quot;,
...
a map.">super-map module</a> adds <a href="../can-connect/can/map/map.html" title="Integrate a can-connect connection with a DefineMap type.">methods</a> to the <code>Message</code> type that let you:</p>
<ul>
...
<a href="../can-connect/can/map/map.prototype.isNew.html" title="Returns if the instance has not been loaded from or saved to the data source.">isNew</a>,
...
<li>When the form is submitted, call <code>send</code> on the <code>ChatMessagesVM</code> with <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">on:event</a>.</li>
<li>Connect the first <code>&lt;input&gt;</code>’s <code>value</code> to the <code>ChatMessagesVM</code>’s <code>name</code> property with <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a>.</li>
<li>Connect the second <code>&lt;input&gt;</code>’s <code>value</code> to the <code>ChatMessagesVM</code>’s <code>body</code> property with <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">twoWay:bind</a>.</li>
</ul>
<pre><code class="language-html">&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p><a class="jsbin-embed" href="https://jsbin.com/yexezu/5/embed?html,js,output">JS Bin on jsbin.com</a></p>
