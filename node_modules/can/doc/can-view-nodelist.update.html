...
<!--####################################################################
	...
	@function can-view-nodelist.update
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-view-nodelist.update.html">update</a></li>
	...
	<div class="page-type">
		<h1>update</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-nodelist/edit/master/can-view-nodelist.js#L125">Edit on GitHub</a>
				</li>
...
references to other collections.">NodeList</a>}</code>: <p>The list to update with the new nodes.</p>
</li>
        
          <li><b>newNodes</b> <code>{<a href="can-view-nodelist/types/NodeList.html" title="A collection of nodes being managed by a part of a live-bound template and
references to other collections.">NodeList</a>}</code>: <p>The new nodes to update with.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array&lt;Node&gt;}</code>: <p>The nodes that were removed from <code>nodeList</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-view-nodelist.update","parent":"can-view-nodelist/methods","src":{"line":124,"codeLine":137,"path":"node_modules/can-view-nodelist/can-view-nodelist.js"},"description":"\n","title":"update","signatures":[{"code":"nodeLists.update(nodeList, newNodes)","description":"\n\nUpdates a nodeList with new items, i.e. when values for the template have changed.\n","params":[{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"nodeList","description":"The list to update with the new nodes."},{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"newNodes","description":"The new nodes to update with.\n"}],"returns":{"types":[{"type":"Array","template":[{"types":[{"type":"Node"}]}]}],"description":"The nodes that were removed from `nodeList`.\n"}}],"_curParam":{"types":[{"type":"can-view-nodelist/types/NodeList"}],"name":"newNodes","description":"The new nodes to update with.\n"},"_curReturn":{"types":[{"type":"Array","template":[{"types":[{"type":"Node"}]}]}],"description":"The nodes that were removed from `nodeList`.\n"},"pathToRoot":".."};
</script>
</article>
