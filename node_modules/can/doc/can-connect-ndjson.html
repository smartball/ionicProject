...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect-ndjson/docs/can-connect-ndjson.md
	@module can-connect-ndjson
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect-ndjson</title>
...
all items were removed.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect-ndjson.ndjson.html"
							title="Specify the URL of an NDJSON service endpoint. If not specified or not supported in the browser, it falls back to the url endpoint.">
							ndjson
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect-ndjson/DefineList.prototype.isStreaming.html"
							title="Set to true on the list if underlying stream is streaming and false when the stream is completed.">
							isStreaming
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="can-connect-ndjson/DefineList.prototype.streamError.html"
							title="Set on the list if the underlying stream has an error.">
							streamError
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect-ndjson.html">can-connect-ndjson</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect-ndjson</h1>
			<ul class="title-social">
				
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-ndjson">
						<img src="https://img.shields.io/badge/npm%20package-0.1.1-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-connect-ndjson" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect-ndjson/edit/master/docs/can-connect-ndjson.md">Edit on GitHub</a>
				</li>
    ...
    <p>Get a list of data from an NDJSON service endpoint.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>ndjsonStream( baseConnection )</code>
  </h2>
  <p>Overwrites the <a href="can-connect/connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> and
[can-connect/constructor.hydrateList] methods on the <a href="can-connect.html" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">can-connect</a> base connection to enable <a href="http://www.ndjson.org/">NDJSON</a> streaming using
<a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API"><code>Fetch</code></a> with
<a href="https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream"><code>ReadableStream</code></a>s. Falls back to default <code>baseConnection</code> in browsers that do not support <code>Fetch</code> and <code>ReadableStream</code>.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>In this example, we will connect a <a href="can-define/map/map.html" title="Create observable objects."><code>DefineMap</code></a> model to an
NDJSON stream service. If you prefer to use a non-CanJS type, skip step 1 and
<a href="can-connect.html#Otheruse" title="can-connect provides persisted data middleware. Assemble powerful model layers for any JavaScript  project from fully modularized behaviors (i.e plugins).">modify the behaviors</a> in step 2 (can/map in particular)
to suit your data structure.</p>
<p>Follow these steps to get started:</p>
<h4>1. Define a model.</h4>
<pre><code class="language-js">const DefineList = require(&quot;can-define/list/list&quot;);
...
<h4>2. Include the required behaviors.</h4>
<p>These four behaviors are the minumum required behaviors if you choose to use
<a href="can-define/map/map.html" title="Create observable objects."><code>DefineMap</code></a>s and <a href="can-define/list/list.html" title="Create observable lists."><code>DefineList</code></a>s for
the model layer. <code>can-connect</code> is flexible and can be used with any array-like
type.</p>
...
<h4>3.Create <code>can-connect</code> connection.</h4>
<p>Link <code>can-connect</code> to the model by attaching a connection object. The connection
object is created by calling <code>connect</code> with the behaviors and options. You may
need to pass an NDJSON-specific endpoint option if the backend serves NDJSON
from a different URL.</p>
<pre><code class="language-js">const connect = require(&quot;can-connect&quot;);
...
<h4>4. Use the <code>can-connect</code> methods on the model.</h4>
<p><code>getList</code> now uses a <a href="https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream"><code>ReadableStream</code></a>
response behind the scenes. NDJSON lines read from the stream will be pushed
into the list instance as JavaScript objects.</p>
<pre><code class="language-js">let todoListPromise = Todo.getList({});
</code></pre>
<p>The <code>todoListPromise</code> will return the list as soon as the streaming response
...
created from each line and added to the list, one at a time.</p>
<p>If using the raw data below, each <code>Todo</code> instance in the list will contain the
properties from a line, eg. <code>{&quot;name&quot;:&quot;first&quot;, &quot;id&quot;: 1}</code></p>
<pre><code class="language-js">//NDJSON raw data example
{&quot;name&quot;:&quot;first&quot;, &quot;id&quot;: 1}\n
{&quot;name&quot;:&quot;second&quot;, &quot;id&quot;: 2}\n
{&quot;name&quot;:&quot;third&quot;, &quot;id&quot;: 3}\n
{&quot;name&quot;:&quot;fourth&quot;, &quot;id&quot;: 4}\n
</code></pre>
<h4>5. Use the model with a template.</h4>
<p>Use <code>can-stache</code> or your favorite live-binding template language to attach your
data to the DOM.</p>
<pre><code class="language-js">const stache = require(&quot;can-stache&quot;);
...
<p>Though the list is initially empty, the template will update with new <code>li</code> elements
each time the list is updated with a newly streamed line.</p>
<h4>All together</h4>
<p>We use our <code>ndjsonStream</code> behavior to enable our model to work seamlessly with
a stream of NDJSON, which it will parse into an array of JS objects.</p>
<p><strong>Note:</strong></p>
<ul>
<li>you must pass the <code>ndjsonStream</code> behavior</li>
<li>if no <code>ndjson</code> option is passed, the endpoint accessed by <code>getListData</code>
will default to the <code>url</code>.</li>
</ul>
<pre><code class="language-js">const connect = require(&quot;can-connect&quot;);
...
<h2>Fallback for browsers without <code>fetch</code> and <code>stream</code> support</h2>
<p>In browsers that don't support <code>fetch</code> and <code>streams</code>, this module will fall back to the <code>baseConnection</code> configuration. The <code>baseConnection</code> and will do a <code>GET</code> request to the <code>url</code> endpoint and expects to receive JSON data.</p>
<p>Note: the stream state properties such as <code>streamError</code> or <code>isStreaming</code> are not available when falling back.</p>
<p>Try out <a href="https://github.com/canjs/can-connect-ndjson">the demo</a> to see how to works.</p>
<h2>Using <code>fetch</code> with NDJSON and <code>ReadableStreams</code></h2>
<p>Learn more about using the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API"><code>fetch API</code></a>
with NDJSON and <code>ReadableStreams</code> <a href="">here</a>.</p>
<h2>Parsing a stream of NDJSON to a stream of JS Objects</h2>
<p>Learn about how we parse the NDJSON stream into a ReadableStream of JS objects using <a href="can-ndjson-stream.html" title="Parses an NDJSON stream into a stream of JavaScript objects."><code>can-ndjson-stream</code></a>.</p>
<h2>Creating an NDJSON service using Express</h2>
<p>Checkout <a href="">this tutorial</a> or the <a href="can-ndjson-stream.html#CreatinganNDJSONstreamservicewithNodeJS_" title="Parses an NDJSON stream into a stream of JavaScript objects."><code>can-ndjson-stream</code></a>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-ndjson/docs/can-connect-ndjson.md"},"description":"Get a list of data from an NDJSON service endpoint. \n","type":"module","title":"","types":[{"type":"connect.Behavior"}],"name":"can-connect-ndjson","parent":"can-ecosystem","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-connect-ndjson/issues"},"bundleDependencies":false,"dependencies":{"can-connect":"^1.3.6","can-define":"^1.0.16","can-namespace":"^1.0.0","can-ndjson-stream":"^0.1.0","can-reflect":"^1.2.2","can-util":"^3.3.0","mocha":"^3.4.2","natives":"^1.1.0","request":"^2.81.0"},"deprecated":false,"description":"[![Greenkeeper badge](https://badges.greenkeeper.io/canjs/can-connect-ndjson.svg)](https://greenkeeper.io/)","devDependencies":{"can-stache":"^3.0.19","http-server":"^0.10.0","jshint":"^2.9.5","saucelabs":"^1.4.0","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","test-saucelabs":"0.0.1","testee":"^0.3.2"},"homepage":"https://github.com/canjs/can-connect-ndjson#readme","keywords":[],"licenses":[{"type":"MIT","url":"http://opensource.org/licenses/mit-license.php"}],"main":"can-connect-ndjson","name":"can-connect-ndjson","repository":{"type":"git","url":"git://github.com/canjs/can-connect-ndjson.git"},"scripts":{"build":"node build.js","ci":"npm run build && npm run test && node ./test/test-sauce-labs.js","develop":"done-serve --static --develop --port 8080","http-server":"http-server -p 3000 --silent","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"npm run jshint && node test/test.js","testee":"testee ./test/test.html --browsers chrome","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-connect-ndjson","configDependencies":["live-reload"],"npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"0.1.1"},"signatures":[{"code":"ndjsonStream( baseConnection )","description":"\n\nOverwrites the [can-connect/connection.getListData] and\n[can-connect/constructor.hydrateList] methods on the [can-connect] base connection to enable [NDJSON](http://www.ndjson.org/) streaming using\n[`Fetch`](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) with\n[`ReadableStream`](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)s. Falls back to default `baseConnection` in browsers that do not support `Fetch` and `ReadableStream`.\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
