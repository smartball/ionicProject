...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/types/listData.md
	@typedef can-connect.listData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - ListData</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-connect.listData.html">ListData</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>ListData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/types/listData.md">Edit on GitHub</a>
				</li>
    ...
    <p>The data format used to create typed lists.</p>
...
<div class="signature">
  ...
  <p>A plain JavaScript object used to <a href="can-connect/constructor/constructor.hydrateList.html" title="Produce a typed list from the provided raw list data.">hydrate</a>
a typed list.  This is the data format resolved by <a href="can-connect/connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a>.</p>
<p>A <code>ListData</code> object should look like:</p>
...
<p>The object must have a <code>data</code> property that is an <code>Array</code> of
instance data used to <a href="can-connect/constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrate</a> typed instances.</p>
<p>The ListData object can have other meta information related to the data
that has been loaded.  For example, <code>count</code> might be the total
number of items the server has:</p>
<pre><code>{
  data: [
    {id: 1, name: &quot;take out the trash&quot;},
    {id: 1, name: &quot;do the dishes&quot;}
...
<p>The <a href="can-connect/data/parse/parse.html" title="Extract response data into a format needed for other extensions.">can-connect/data/parse/parse</a> behavior can be used to convert request responses to the <code>ListData</code> format.</p>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        <b>data</b> <code>{Array&lt;Object&gt;}</code>:
        <p>The ListData object must have a <code>data</code> property that is an array of objects.  Each
object is used to <a href="can-connect/constructor/constructor.hydrateInstance.html" title="Produce a typed object containing the provided raw data.">hydrate</a> typed instances.</p>
