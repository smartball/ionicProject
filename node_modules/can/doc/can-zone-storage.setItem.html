...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-zone-storage/docs/can-zone-storage.methods.setItem.md
	@function can-zone-storage.setItem
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - can-zone-storage.setItem</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-zone-storage.setItem.html">can-zone-storage.setItem</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-zone-storage.setItem</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-zone-storage/edit/master/docs/can-zone-storage.methods.setItem.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Stores keyed data in the current data store.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>The key name under which the data will be stored.</p>
</li>
        
          <li><b>value</b> <code>{Any}</code>: <p>The data to be stored.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-zone-storage/docs/can-zone-storage.methods.setItem.md"},"description":"\n","title":"","name":"can-zone-storage.setItem","type":"function","parent":"can-zone-storage.methods","signatures":[{"code":"setItem(key, value)","description":"\n\nStores keyed data in the current data store.\n\n```js\nvar zoneStorage = require(\"can-zone-storage\");\n\nvar value = 'Store me';\n\nzoneStorage.setItem('key-name', value);\n```\n","params":[{"types":[{"type":"String"}],"name":"key","description":"The key name under which the data will be stored."},{"types":[{"type":"Any"}],"name":"value","description":"The data to be stored."}]}],"_curParam":{"types":[{"type":"Any"}],"name":"value","description":"The data to be stored."},"pathToRoot":".."};
</script>
</article>
