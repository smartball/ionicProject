...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-control/docs/control.extend.md
...
<div class="breadcrumb">
	...
	<li><a href="can-control.extend.html">extend</a></li>
	...
	<div class="page-type">
		<h1>extend</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-control/edit/master/docs/control.extend.md">Edit on GitHub</a>
				</li>
...
as event handlers.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{constructor(element, options) => <a href="can-construct.html" title="Provides a way to easily use the power of prototypal inheritance
without worrying about hooking up all the particulars yourself. Use
can-construct.extend to create an inheritable
constructor function of your own.">can-construct</a>}</code>: <p>A control constructor function that has been
extended with the provided <code>staticProperties</code> and <code>instanceProperties</code>.</p>
    ...
    <section class="body">
    <h2>Examples</h2>
<pre><code>// Control that writes &quot;hello world&quot;
