...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-map-define/docs/serialize.md
	@function can-map-define.serialize
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-map-define.serialize.html">serialize</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>serialize</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-map-define/edit/master/docs/serialize.md">Edit on GitHub</a>
				</li>
    ...
    <p>Called when an attribute is removed.</p>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>value</b> <code>{*}</code>: <p>The current value of the attribute.</p>
</li>
        
          <li><b>attr</b> <code>{String}</code>: <p>The name of the attribute being serialized.</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p><a href="can-map.prototype.serialize.html" title="Serialize this object to something that can be passed to JSON.stringify.">serialize</a> is useful for serializing a Map instance into
a more JSON-friendly form.  This can be used for many reasons, including saving a
[can-model Model] instance on the server or serializing <a href="can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">route</a>'s internal
Map for display in the hash or pushstate URL.</p>
<p>The serialize property allows an opportunity to define how
each attribute will behave when the map is serialized.  This can be useful for:</p>
<ul>
...
the comma separated ID values of the location property on this map:</p>
<pre><code>define: {
  locationIds: {
    serialize: function(){
      var ids = [];
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-define/docs/serialize.md"},"description":"\nCalled when an attribute is removed.\n","title":"serialize","name":"can-map-define.serialize","type":"function","parent":"can-map-define","signatures":[{"code":"serialize( currentValue )","description":"\n","params":[{"types":[{"type":"*"}],"name":"value","description":"The current value of the attribute. \n"},{"types":[{"type":"String"}],"name":"attr","description":"The name of the attribute being serialized.\n"}],"returns":{"types":[{"type":"*"},{"type":"undefined"}],"description":"If `undefined` is returned, the value is not serialized.\n"},"context":{"types":[{"type":"Map"}],"description":"The map instance being serialized.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"attr","description":"The name of the attribute being serialized.\n"},"_curReturn":{"types":[{"type":"*"},{"type":"undefined"}],"description":"If `undefined` is returned, the value is not serialized.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
