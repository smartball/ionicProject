...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-compute/docs/async.md
	@function can-compute.async
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - async</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-compute.async.html">async</a></li>
	...
	<div class="page-type">
		<h1>async</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-compute/edit/master/docs/async.md">Edit on GitHub</a>
				</li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>The</b> <code>{*}</code>: <p>initial value of the compute.</p>
</li>
        
          <li><b>computed</b> <code>{<a href="can-compute.asyncComputer.html" title="A function that determines a value for an async compute.">asyncComputer</a>(lastSetValue, setVal)}</code>: <p>A function
that returns the current value of the compute and can optionally later call
its <code>setValue</code> callback to update the value.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>(newVal)}</code>: <p>Returns a compute, but a compute that will
possibly not have the correct value unless it is bound to.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The following compute is a live list of todos for a given
userId. <code>todos</code> value would alternate between <code>null</code> and a Todo.List as <code>userId</code> changes.</p>
<pre><code>var userId = compute(5)
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-compute/docs/async.md"},"description":"\nCreate a compute that can set its value after the computed function has been called.\n","title":"async","name":"can-compute.async","type":"function","parent":"can-compute","release":"2.1","hide":true,"signatures":[{"code":"compute.async(initialValue, computed(currentValue, setValue(newValue) )","description":"\n","params":[{"types":[{"type":"*"}],"name":"The","description":"initial value of the compute.\n"},{"types":[{"type":"can-compute.asyncComputer"}],"name":"computed","description":"A function \nthat returns the current value of the compute and can optionally later call \nits `setValue` callback to update the value.\n"}],"returns":{"types":[{"type":"can-compute.computed"}],"description":"Returns a compute, but a compute that will \npossibly not have the correct value unless it is bound to.\n"}}],"_curParam":{"types":[{"type":"can-compute.asyncComputer"}],"name":"computed","description":"A function \nthat returns the current value of the compute and can optionally later call \nits `setValue` callback to update the value.\n"},"_curReturn":{"types":[{"type":"can-compute.computed"}],"description":"Returns a compute, but a compute that will \npossibly not have the correct value unless it is bound to.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
