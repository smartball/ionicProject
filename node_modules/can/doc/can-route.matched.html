...
<!--####################################################################
	...
	@function can-route.matched
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - matched</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-route.matched.html">matched</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>matched</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L854">Edit on GitHub</a>
				</li>
    ...
    <p>A compute representing the currently matched route.</p>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>The currently matched route.</p>
</p>
  </div>
    ...
    <section class="body">
    <p>Use <code>route.matched()</code> to find the currently matched route.</p>
<pre><code class="language-js">route(&quot;{type}&quot;, { type: &quot;foo&quot; });
route(&quot;{type}/{subtype}&quot;);
...
<script type="text/javascript">
  window.docObject = {"name":"can-route.matched","type":"function","parent":"can-route.static","src":{"line":853,"codeLine":874,"path":"node_modules/can-route/can-route.js"},"description":"A compute representing the currently matched route. ","title":"matched","signatures":[{"code":"route.matched()","description":"","params":[],"returns":{"types":[{"type":"String"}],"description":"The currently matched route.\n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"The currently matched route.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
