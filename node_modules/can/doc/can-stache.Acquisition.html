...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/acquisition.md
	@page can-stache.Acquisition
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Template Acquisition</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.Acquisition.html">Template Acquisition</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Template Acquisition</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/acquisition.md">Edit on GitHub</a>
				</li>
...
a module loader, or script tags in the markup.</p>
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <h2>Raw Text</h2>
<p>Raw text can be templated by passing the text containing your template.  For example:</p>
<pre><code>var text = &quot;My body lies over the {{.}}&quot;,
...
<p>For <a href="http://stealjs.com" title="StealJS">StealJS</a>, use <a href="steal-stache.html" title="A StealJS extension that allows stache templates as dependencies.">steal-stache</a> to import stache templates directly.</p>
<h2>Script Tags</h2>
<p>You can embed a <code>&lt;script&gt;</code> tag and use its text as a stache template like:</p>
<pre><code class="language-html">&lt;script type='text/stache' id='my-template'&gt;
  &lt;h1&gt;{{message}}&lt;/h1&gt;
&lt;/script&gt;
</code></pre>
<p>Load this template like:</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/acquisition.md"},"description":"\nThere are number of ways to acquire templates such as: raw text,\na module loader, or script tags in the markup.\n","name":"can-stache.Acquisition","title":"Template Acquisition","type":"page","parent":"can-stache.pages","order":3,"pathToRoot":".."};
</script>
</article>
