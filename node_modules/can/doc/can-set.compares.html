...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-set/docs/can-set.compares.md
	@typedef can-set.compares
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - Compares</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-set.compares.html">Compares</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Compares</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-set/edit/master/docs/can-set.compares.md">Edit on GitHub</a>
				</li>
    ...
    <p>An object of property names and <code>prop</code> functions.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>Object&lt;String,<a href="can-set.prop.html" title="">Prop</a>()&gt;</code>
  </h2>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-set/docs/can-set.compares.md"},"description":"An object of property names and `prop` functions. \n```js\n{\n  // return `true` if the values should be considered the same:\n  lastName: function(aValue, bValue){\n    return (\"\"+aValue).toLowerCase() === (\"\"+bValue).toLowerCase();\n  }\n}\n```\n\n\n","type":"typedef","title":"Compares","types":[{"type":"Object","template":[{"types":[{"type":"String"}]},{"types":[{"type":"can-set.prop"}]}]}],"name":"can-set.compares","parent":"can-set.types","pathToRoot":".."};
</script>
</article>
