...
<!--####################################################################
	...
	@function can-reflect/observe.onValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onValue.html">onValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L240">Edit on GitHub</a>
				</li>
    ...
    <p>Register an event handler on an observable ValueLike object, based on a change in its value</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onValue(handler)</code>
  </h2>
  <p>Register an event handler on the Value-like object <code>obj</code> to trigger when its value changes.
<code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onValue.html" title="Defines how observables can listen to the object's value changing.">@@can.onValue</a> to be compatible with
can-reflect.onKeyValue.  The function passed as <code>handler</code> will receive the new value of <code>obj</code>
as the first argument, and the previous value of <code>obj</code> as the second argument.</p>
<pre><code>var obj = canCompute(&quot;foo&quot;);
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{*}</code>: <p>any object implementing @@can.onValue</p>
</li>
        
          <li><b>handler</b> <code>{function(*, *)}</code>: <p>a callback function that receives the new and old values</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.onValue","type":"function","parent":"can-reflect/observe","src":{"line":239,"codeLine":263,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Register an event handler on an observable ValueLike object, based on a change in its value \n","title":"onValue","signatures":[{"code":"onValue(handler)","description":"\n\nRegister an event handler on the Value-like object `obj` to trigger when its value changes.\n`obj` *must* implement [can-symbol/symbols/onValue @@can.onValue] to be compatible with\ncan-reflect.onKeyValue.  The function passed as `handler` will receive the new value of `obj`\nas the first argument, and the previous value of `obj` as the second argument.\n\n```\nvar obj = canCompute(\"foo\");\ncanReflect.onValue(obj, function(newVal, oldVal) {\n\tconsole.log(\"compute is now\", newVal, \", was\", oldVal);\n});\n\nobj(\"bar\");  // -> logs \"compute is now bar , was foo\"\n```\n","params":[{"types":[{"type":"*"}],"name":"obj","description":"any object implementing @@can.onValue"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"*"}]}]}],"name":"handler","description":"a callback function that receives the new and old values\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"*"}]}]}],"name":"handler","description":"a callback function that receives the new and old values\n "},"pathToRoot":"../.."};
</script>
</article>
