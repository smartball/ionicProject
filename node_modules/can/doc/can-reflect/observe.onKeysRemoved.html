...
<!--####################################################################
	...
	@function can-reflect/observe.onKeysRemoved
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onKeysRemoved</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onKeysRemoved.html">onKeysRemoved</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onKeysRemoved</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L135">Edit on GitHub</a>
				</li>
    ...
    <p>Register an event handler on a MapLike object, triggered on keys being deleted.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onKeysRemoved(obj, handler)</code>
  </h2>
  <p>Register an event handler on the Map-like object <code>obj</code> to trigger when a key or keys are removed from
<code>obj</code>'s keyset. <code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onKeysRemoved.html" title="Define a function used to listen to when the object's key set has keys removed through deletion.">@@can.onKeysRemoved</a> to be
compatible with can-reflect.onKeysAdded.  The function passed as <code>handler</code> will receive an Array of
Strings as its one argument.</p>
<pre><code>var obj = new CanMap({ foo: &quot;bar&quot; });
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(Array)}</code>: <p>the callback function to receive the array of removed keys</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.onKeysRemoved","type":"function","parent":"can-reflect/observe","src":{"line":134,"codeLine":158,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Register an event handler on a MapLike object, triggered on keys being deleted. \n","title":"onKeysRemoved","signatures":[{"code":"onKeysRemoved(obj, handler)","description":"\n\nRegister an event handler on the Map-like object `obj` to trigger when a key or keys are removed from\n`obj`'s keyset. `obj` *must* implement [can-symbol/symbols/onKeysRemoved @@can.onKeysRemoved] to be\ncompatible with can-reflect.onKeysAdded.  The function passed as `handler` will receive an Array of\nStrings as its one argument.\n\n```\nvar obj = new CanMap({ foo: \"bar\" });\ncanReflect.onKeys(obj, function(diffs) {\n\tconsole.log(JSON.stringify(diffs));\n});\n\nfoo.removeAttr(\"foo\");  // -> logs '[\"foo\"]'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"an observable MapLike that can listen to changes in named properties."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the array of removed keys\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the array of removed keys\n "},"pathToRoot":"../.."};
</script>
</article>
