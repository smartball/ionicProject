...
<!--####################################################################
	...
	@function can-reflect/observe.onKeysAdded
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onKeysAdded</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onKeysAdded.html">onKeysAdded</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onKeysAdded</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L109">Edit on GitHub</a>
				</li>
    ...
    <p>Register an event handler on a MapLike object, triggered on new keys being added.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onKeysAdded(obj, handler)</code>
  </h2>
  <p>Register an event handler on the Map-like object <code>obj</code> to trigger when a new key or keys are set on
<code>obj</code>. <code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onKeysAdded.html" title="Define a function used to listen to when the object's key set has new additions.">@@can.onKeysAdded</a> to be compatible with
can-reflect.onKeysAdded.  The function passed as <code>handler</code> will receive an Array of Strings as its one
argument.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(Array)}</code>: <p>the callback function to receive the array of added keys</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.onKeysAdded","type":"function","parent":"can-reflect/observe","src":{"line":108,"codeLine":132,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Register an event handler on a MapLike object, triggered on new keys being added. \n","title":"onKeysAdded","signatures":[{"code":"onKeysAdded(obj, handler)","description":"\n\nRegister an event handler on the Map-like object `obj` to trigger when a new key or keys are set on\n`obj`. `obj` *must* implement [can-symbol/symbols/onKeysAdded @@can.onKeysAdded] to be compatible with\ncan-reflect.onKeysAdded.  The function passed as `handler` will receive an Array of Strings as its one\nargument.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\ncanReflect.onKeysAded(obj, function(newKeys) {\n\tconsole.log(newKeys);\n});\n\nfoo.set(\"baz\", \"quux\");  // -> logs '[\"baz\"]'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"an observable MapLike that can listen to changes in named properties."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the array of added keys\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the array of added keys\n "},"pathToRoot":"../.."};
</script>
</article>
