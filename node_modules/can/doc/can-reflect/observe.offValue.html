...
<!--####################################################################
	...
	@function can-reflect/observe.offValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - offEvent</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.offValue.html">offEvent</a></li>
	...
	<div class="page-type">
		<h1>offEvent</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L403">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>offKeyValue(obj, eventName, callback)</code>
  </h2>
  <p>Unregister an event handler from the object <code>obj</code> that had previously been registered with
<a href="observe.onEvent.html" title="Register a named event handler on an observable object">onEvent</a>. The function passed as <code>callback</code> will no longer be called
when the event named <code>eventName</code> is dispatched on <code>obj</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to unbind an event handler from</p>
</li>
        
          <li><b>eventName</b> <code>{String}</code>: <p>the name of the event to unbind the handler from</p>
</li>
        
          <li><b>callback</b> <code>{function(*)}</code>: <p>the handler function to unbind from the event</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.offValue","type":"function","parent":"can-reflect/observe","src":{"line":402,"codeLine":429,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Unregister an event handler on a MapLike object, based on a key change \n","title":"offEvent","signatures":[{"code":"offKeyValue(obj, eventName, callback)","description":"\n\nUnregister an event handler from the object `obj` that had previously been registered with\n[can-reflect/observe.onEvent onEvent]. The function passed as `callback` will no longer be called\nwhen the event named `eventName` is dispatched on `obj`.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\nvar handler = function(ev, newVal, oldVal) {\n\tconsole.log(\"foo is now\", newVal, \", was\", oldVal);\n};\n\ncanReflect.onEvent(obj, \"foo\", handler);\ncanReflect.offKeyValue(obj, \"foo\", handler);\n\ncanEvent.dispatch.call(obj, \"foo\", [\"baz\", \"quux\"]);  // -> nothing is logged\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to unbind an event handler from"},{"types":[{"type":"String"}],"name":"eventName","description":"the name of the event to unbind the handler from"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"callback","description":"the handler function to unbind from the event\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"callback","description":"the handler function to unbind from the event\n "},"pathToRoot":"../.."};
</script>
</article>
