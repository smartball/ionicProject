...
<!--####################################################################
	...
	@function can-reflect/getPriority
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getPriority</title>
...
<div class="breadcrumb">
	...
	<li><a href="getPriority.html">getPriority</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getPriority</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L510">Edit on GitHub</a>
				</li>
    ...
    <p>Read the priority for an observable that derives its value.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getPriority(obj)</code>
  </h2>
  <p>Calls an underlying <code>@can.getPriority</code> symbol on <code>obj</code> if it exists
and returns its value. Read <a href="setPriority.html" title="Provide a priority for when an observable that derives its value should be re-evaluated.">setPriority</a> for more information.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>An observable.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Undefined|Number}</code>: <p>Returns the priority number if
available, undefined if this object does not support the <code>can.getPriority</code>
symbol.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/getPriority","parent":"can-reflect/observe","src":{"line":509,"codeLine":530,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Read the priority for an observable that derives its value.\n\n","title":"getPriority","signatures":[{"code":"getPriority(obj)","description":"\n\nCalls an underlying `@can.getPriority` symbol on `obj` if it exists\nand returns its value. Read [can-reflect/setPriority] for more information.\n\n\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An observable."}],"returns":{"types":[{"type":"Undefined"},{"type":"Number"}],"description":"Returns the priority number if\navailable, undefined if this object does not support the `can.getPriority`\nsymbol.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"An observable."},"_curReturn":{"types":[{"type":"Undefined"},{"type":"Number"}],"description":"Returns the priority number if\navailable, undefined if this object does not support the `can.getPriority`\nsymbol.\n"},"comment":" ","pathToRoot":"../.."};
</script>
</article>
