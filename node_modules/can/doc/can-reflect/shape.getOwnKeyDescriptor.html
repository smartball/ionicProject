...
<!--####################################################################
	...
	@function can-reflect/shape.getOwnKeyDescriptor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getOwnKeyDescriptor</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.getOwnKeyDescriptor.html">getOwnKeyDescriptor</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getOwnKeyDescriptor</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L541">Edit on GitHub</a>
				</li>
    ...
    <p>Return a property descriptor for a named property on an object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getOwnKeyDescriptor(obj, key)</code>
  </h2>
  <p>Return the key descriptor for the property key <code>key</code> on the Map-like object <code>obj</code>. A key descriptor
is specified in ECMAScript 5 and contains keys for the property's <code>configurable</code> and <code>enumerable</code> states,
as well as either <code>value</code> and <code>writable</code> for value properties, or <code>get</code> and <code>set</code> for getter/setter properties.</p>
<p>The default behavior can be overridden by implementing <a href="../can-symbol/symbols/getOwnKeyDescriptor.html" title="Describe the attributes of an object's keyed property.">@@can.getOwnKeyDescriptor</a>
on <code>obj</code>; otherwise the default is to call <code>Object.getOwnKeyDescriptor()</code>.</p>
...
getOwnKeyDescriptor(foo, &quot;bar&quot;); // -&gt; {configurable: true, writable: true, enumerable: true, value: &quot;baz&quot;}
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>Any object with named properties</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>The property name to look up on <code>obj</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>A key descriptor object</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.getOwnKeyDescriptor","parent":"can-reflect/shape","src":{"line":540,"codeLine":564,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Return a property descriptor for a named property on an object. \n","title":"getOwnKeyDescriptor","signatures":[{"code":"getOwnKeyDescriptor(obj, key)","description":"\n\nReturn the key descriptor for the property key `key` on the Map-like object `obj`. A key descriptor\nis specified in ECMAScript 5 and contains keys for the property's `configurable` and `enumerable` states,\nas well as either `value` and `writable` for value properties, or `get` and `set` for getter/setter properties.\n\nThe default behavior can be overridden by implementing [can-symbol/symbols/getOwnKeyDescriptor @@can.getOwnKeyDescriptor]\non `obj`; otherwise the default is to call `Object.getOwnKeyDescriptor()`.\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\n\ngetOwnKeyDescriptor(foo, \"bar\"); // -> {configurable: true, writable: true, enumerable: true, value: \"baz\"}\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any object with named properties"},{"types":[{"type":"String"}],"name":"key","description":"The property name to look up on `obj`"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"A key descriptor object\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The property name to look up on `obj`"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"A key descriptor object\n "},"pathToRoot":"../.."};
</script>
</article>
