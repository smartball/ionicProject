...
<!--####################################################################
	...
	@function can-reflect/observe.offKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - offKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.offKeyValue.html">offKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>offKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L54">Edit on GitHub</a>
				</li>
    ...
    <p>Unregister an event handler on a MapLike object, based on a key change</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>offKeyValue(obj, key, handler)</code>
  </h2>
  <p>Unregister a handler from the Map-like object <code>obj</code> that had previously been registered with
<a href="observe.onKeyValue.html" title="Register an event handler on a MapLike object, based on a key change">onKeyValue</a>. The function passed as <code>handler</code> will no longer be called
when the value of <code>key</code> on <code>obj</code> changes.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{String}</code>: <p>the key to stop listening to</p>
</li>
        
          <li><b>handler</b> <code>{function(*)}</code>: <p>the callback function that should be removed from the event handlers for <code>key</code></p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.offKeyValue","type":"function","parent":"can-reflect/observe","src":{"line":53,"codeLine":80,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Unregister an event handler on a MapLike object, based on a key change \n","title":"offKeyValue","signatures":[{"code":"offKeyValue(obj, key, handler)","description":"\n\nUnregister a handler from the Map-like object `obj` that had previously been registered with\n[can-reflect/observe.onKeyValue onKeyValue]. The function passed as `handler` will no longer be called\nwhen the value of `key` on `obj` changes.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\nvar handler = function(newVal, oldVal) {\n\tconsole.log(\"foo is now\", newVal, \", was\", oldVal);\n};\n\ncanReflect.onKeyValue(obj, \"foo\", handler);\ncanReflect.offKeyValue(obj, \"foo\", handler);\n\nobj.foo = \"baz\";  // -> nothing is logged\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"an observable MapLike that can listen to changes in named properties."},{"types":[{"type":"String"}],"name":"key","description":"the key to stop listening to"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"handler","description":"the callback function that should be removed from the event handlers for `key`\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"handler","description":"the callback function that should be removed from the event handlers for `key`\n "},"pathToRoot":"../.."};
</script>
</article>
