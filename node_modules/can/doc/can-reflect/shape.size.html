...
<!--####################################################################
	...
	@function can-reflect/shape.size
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - size</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.size.html">size</a></li>
	...
	<div class="page-type">
		<h1>size</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L895">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>.size(target)</code>
  </h2>
  <p>Returns the number of items contained in <code>target</code>. Target can
provide the size using the <a href="../can-symbol/symbols/size.html" title="Return the number of items in the collection.">can.size</a> symbol.</p>
<p>If the <code>target</code> has a numeric <code>length</code> property that is greater than or equal to 0, that
<code>length</code> will be returned.</p>
<pre><code class="language-js">canReflect.size([1,2,3]) //-&gt; 3
</code></pre>
<p>If the <code>target</code> is <a href="../can-reflect.isListLike.html" title="Test if a value looks like a constructor function.">isListLike</a>, the values of the list will be counted.</p>
<p>If the <code>target</code> is a plain JS object, the number of enumerable properties will be returned.</p>
<pre><code class="language-js">canReflect.size({foo:&quot;bar&quot;}) //-&gt; 1
</code></pre>
<p>If the <code>target</code> is anything else, <code>undefined</code> is returned.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{Object}</code>: <p>The container object.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Number}</code>: <p>The number of values in the target.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.size","parent":"can-reflect/shape","src":{"line":894,"codeLine":924,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Return the number of items in the collection. \n","title":"size","signatures":[{"code":".size(target)","description":"\n\nReturns the number of items contained in `target`. Target can\nprovide the size using the [can-symbol/symbols/size] symbol.\n\nIf the `target` has a numeric `length` property that is greater than or equal to 0, that\n`length` will be returned.\n\n```js\ncanReflect.size([1,2,3]) //-> 3\n```\n\nIf the `target` is [can-reflect.isListLike], the values of the list will be counted.\n\nIf the `target` is a plain JS object, the number of enumerable properties will be returned.\n\n```js\ncanReflect.size({foo:\"bar\"}) //-> 1\n```\n\nIf the `target` is anything else, `undefined` is returned.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"target","description":"The container object."}],"returns":{"types":[{"type":"Number"}],"description":"The number of values in the target.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"target","description":"The container object."},"_curReturn":{"types":[{"type":"Number"}],"description":"The number of values in the target.\n "},"pathToRoot":"../.."};
</script>
</article>
