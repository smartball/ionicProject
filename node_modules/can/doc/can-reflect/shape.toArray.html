...
<!--####################################################################
	...
	@function can-reflect/shape.toArray
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - toArray</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.toArray.html">toArray</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>toArray</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L328">Edit on GitHub</a>
				</li>
    ...
    <p>convert the values of any MapLike or ListLike into an array</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>toArray(obj)</code>
  </h2>
  <p>Convert the values of any Map-like or List-like into a JavaScript Array.  If a Map-like,
key data is discarded and only value data is preserved.</p>
<pre><code>var foo = new DefineList([&quot;bar&quot;, &quot;baz&quot;]);
var quux = new DefineMap({ thud: &quot;jeek&quot; });
</code></pre>
<p>canReflect.toArray(foo); // -&gt; [&quot;bar&quot;, &quot;baz&quot;]
canReflect.toArray(quux): // -&gt; [&quot;jeek&quot;]</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>Any object, whether MapLike or ListLike</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>an array of the values of <code>obj</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.toArray","parent":"can-reflect/shape","src":{"line":327,"codeLine":348,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"convert the values of any MapLike or ListLike into an array \n","title":"toArray","signatures":[{"code":"toArray(obj)","description":"\n\nConvert the values of any Map-like or List-like into a JavaScript Array.  If a Map-like,\nkey data is discarded and only value data is preserved.\n\n```\nvar foo = new DefineList([\"bar\", \"baz\"]);\nvar quux = new DefineMap({ thud: \"jeek\" });\n```\n\ncanReflect.toArray(foo); // -> [\"bar\", \"baz\"]\ncanReflect.toArray(quux): // -> [\"jeek\"]\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any object, whether MapLike or ListLike"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"an array of the values of `obj`\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any object, whether MapLike or ListLike"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"an array of the values of `obj`\n "},"pathToRoot":"../.."};
</script>
</article>
