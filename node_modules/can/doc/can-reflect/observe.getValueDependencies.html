...
<!--####################################################################
	...
	@function can-reflect/observe.getValueDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getValueDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.getValueDependencies.html">getValueDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getValueDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L293">Edit on GitHub</a>
				</li>
    ...
    <p>Return all the events that bind to the value of an observable, Value-like object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getValueDependencies(obj)</code>
  </h2>
  <p>Return the observable objects that provide input values to generate the computed value of the
Value-like object <code>obj</code>.  If <code>obj</code> does not have dependencies, returns <code>undefined</code>.
...
<p><code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/getValueDependencies.html" title="A symbol placed on a constructor to reference a function that returns the other events that will trigger a value change event on the object.">@@can.getValueDependencies</a> to work with
<code>canReflect.getValueDependencies</code>.</p>
...
way to observe those reads called within a given function.&quot;&gt;can-observation&lt;/a&gt;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to check for value dependencies</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the observable objects that <code>obj</code>'s value depends on</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.getValueDependencies","type":"function","parent":"can-reflect/observe","src":{"line":292,"codeLine":323,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Return all the events that bind to the value of an observable, Value-like object \n","title":"getValueDependencies","signatures":[{"code":"getValueDependencies(obj)","description":"\n\nReturn the observable objects that provide input values to generate the computed value of the\nValue-like object `obj`.  If `obj` does not have dependencies, returns `undefined`.\nOtherwise returns an object with up to two keys: `keyDependencies` is a [can-util/js/cid-map/cid-map CIDMap] that\nmaps each Map-like object providing keyed values to an Array of the relevant keys; `valueDependencies` is a\n[can-util/js/cid-set/cid-set CIDSet] that contains all Value-like dependencies providing their own values.\n\n`obj` *must* implement [can-symbol/symbols/getValueDependencies @@can.getValueDependencies] to work with\n`canReflect.getValueDependencies`.\n\n\n```\nvar foo = new DefineMap({ \"bar\": \"baz\" })\nvar obj = canCompute(function() {\n\t return foo.bar;\n});\n\ncanReflect.getValueDependencies(obj);  // -> { valueDependencies: CIDSet } because `obj` is internally backed by\na [can-observation]\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for value dependencies"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the observable objects that `obj`'s value depends on\n\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for value dependencies"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the observable objects that `obj`'s value depends on\n\n "},"pathToRoot":"../.."};
</script>
</article>
