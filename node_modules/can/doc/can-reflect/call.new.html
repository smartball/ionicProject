...
<!--####################################################################
	...
	@function can-reflect/call.new
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - new</title>
...
<div class="breadcrumb">
	...
	<li><a href="call.new.html">new</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>new</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/call/call.js#L72">Edit on GitHub</a>
				</li>
    ...
    <p>Construct a new instance of a callable constructor</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>new(func, ...rest)</code>
  </h2>
  <p>Call the callable <code>func</code> as if it were a function, bound to a new instance of <code>func</code>, and with any additional
parameters occurring after <code>func</code> set to the positional parameters.</p>
<p>Note that <code>func</code> <em>must</em> either implement <a href="../can-symbol/symbols/new.html" title="Create a new instance of a constructor function or prototype object.">@@can.new</a>,
or have a callable <code>apply</code> property <em>and</em> a prototype to work with <code>canReflect.new</code></p>
<pre><code>canReflect.new(DefineList, [&quot;foo&quot;]); // -&gt; [&quot;foo&quot;]&lt;DefineList&gt;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>func</b> <code>{function(...)}</code>: <p>a constructor</p>
</li>
        
          <li><b>rest</b> <code>{*}</code>: <p>arguments to be passed to the constructor</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>if <code>func</code> returns an Object, that returned Object; otherwise a new instance of <code>func</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/call.new","parent":"can-reflect/call","src":{"line":71,"codeLine":92,"path":"node_modules/can-reflect/reflections/call/call.js"},"description":"Construct a new instance of a callable constructor \n","title":"new","signatures":[{"code":"new(func, ...rest)","description":"\n\nCall the callable `func` as if it were a function, bound to a new instance of `func`, and with any additional\nparameters occurring after `func` set to the positional parameters.\n\nNote that `func` *must* either implement [can-symbol/symbols/new @@can.new],\nor have a callable `apply` property *and* a prototype to work with `canReflect.new`\n\n```\ncanReflect.new(DefineList, [\"foo\"]); // -> [\"foo\"]<DefineList>\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"variable":true}]}],"name":"func","description":"a constructor"},{"types":[{"type":"*"}],"name":"rest","description":"arguments to be passed to the constructor"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"if `func` returns an Object, that returned Object; otherwise a new instance of `func`\n "}}],"_curParam":{"types":[{"type":"*"}],"name":"rest","description":"arguments to be passed to the constructor"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"if `func` returns an Object, that returned Object; otherwise a new instance of `func`\n "},"pathToRoot":"../.."};
</script>
</article>
