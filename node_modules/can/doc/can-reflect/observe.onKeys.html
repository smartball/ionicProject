...
<!--####################################################################
	...
	@function can-reflect/observe.onKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onKeys.html">onKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onKeys</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L83">Edit on GitHub</a>
				</li>
    ...
    <p>Register an event handler on a MapLike object, triggered on the key set changing</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onKeys(obj, handler)</code>
  </h2>
  <p>Register an event handler on the Map-like object <code>obj</code> to trigger when <code>obj</code>'s keyset changes.
<code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onKeys.html" title="Define a function used to listen to when the object's key set changes.">@@can.onKeys</a> to be compatible with
can-reflect.onKeys.  The function passed as <code>handler</code> will receive an Array of object diffs (see
<a href="../can-util/js/diff-object/diff-object.html" title="can-util/js/diff-object/diff-object">diffObject</a> for the format) as its one argument.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>handler</b> <code>{function(Array)}</code>: <p>the callback function to receive the diffs in the key set</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":82,"codeLine":106,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"type":"function","description":"Register an event handler on a MapLike object, triggered on the key set changing \n","title":"onKeys","name":"can-reflect/observe.onKeys","parent":"can-reflect/observe","signatures":[{"code":"onKeys(obj, handler)","description":"\n\nRegister an event handler on the Map-like object `obj` to trigger when `obj`'s keyset changes.\n`obj` *must* implement [can-symbol/symbols/onKeys @@can.onKeys] to be compatible with\ncan-reflect.onKeys.  The function passed as `handler` will receive an Array of object diffs (see\n[can-util/js/diff-object/diff-object diffObject] for the format) as its one argument.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\ncanReflect.onKeys(obj, function(diffs) {\n\tconsole.log(diffs);\n});\n\nobj.set(\"baz\", \"quux\");  // -> logs '[{\"property\": \"baz\", \"type\": \"add\", \"value\": \"quux\"}]'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"an observable MapLike that can listen to changes in named properties."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the diffs in the key set\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Array","options":[]}]}]}],"name":"handler","description":"the callback function to receive the diffs in the key set\n "},"pathToRoot":"../.."};
</script>
</article>
