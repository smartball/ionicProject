...
<!--####################################################################
	...
	@function can-reflect/shape.assignDeep
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - assignDeep</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.assignDeep.html">assignDeep</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>assignDeep</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L665">Edit on GitHub</a>
				</li>
    ...
    <p>Assign one objects values to another, and performs the same action for all child values.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>.assignDeep(target, source)</code>
  </h2>
  <p>Copies the values (and properties if map-like) from <code>source</code> onto <code>target</code> and repeates for all child
values.</p>
<p>For map-like objects, every enumerable property on <code>target</code> is copied:</p>
<pre><code class="language-js">var target = {name: {first: &quot;Justin&quot;}};
var source = {name: {last: &quot;Meyer&quot;}};
var restult = canReflect.assignDeep(target, source);
target //-&gt;  {name: {first: &quot;Justin&quot;, last: &quot;Meyer&quot;}}
</code></pre>
<p>An object can control the behavior of <code>assignDeep</code> using the <a href="../can-symbol/symbols/assignDeep.html" title="Defines how to copy values onto an object.">can.assignDeep</a> symbol.</p>
