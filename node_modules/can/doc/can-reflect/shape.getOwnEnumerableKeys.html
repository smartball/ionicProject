...
<!--####################################################################
	...
	@function can-reflect/shape.getOwnEnumerableKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getOwnEnumerableKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.getOwnEnumerableKeys.html">getOwnEnumerableKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getOwnEnumerableKeys</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L440">Edit on GitHub</a>
				</li>
    ...
    <p>Return the list of keys which can be iterated over on an object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getOwnEnumerableKeys(obj)</code>
  </h2>
  <p>Return all keys on <code>obj</code> which have been defined as enumerable, either from explicitly setting
<code>enumerable</code> on the property descriptor, or by using <code>=</code> to set the value of the property without
a key descriptor, but excluding properties that only exist on <code>obj</code>'s prototype chaing.  The
default behavior can be overridden by implementing
<a href="../can-symbol/symbols/getOwnEnumerableKeys.html" title="List the enumerable keys (as defined by its property descriptor) an object has, but not those from its prototype chain.">@@can.getOwnEnumerableKeys</a> on <code>obj</code>.  By default,
<code>canReflect.getOwnEnumerableKeys</code> will use <a href="../can-symbol/symbols/getOwnKeys.html" title="List which keys an object has of its own (not other objects on the prototype chain).">@@can.getOwnKeys</a> to
retrieve the set of keys and <a href="../can-symbol/symbols/getOwnKeyDescriptor.html" title="Describe the attributes of an object's keyed property.">@@can.getOwnKeyDescriptor</a>
to filter for those which are enumerable.  If either symbol is absent from <code>obj</code>, <code>Object.keys</code>
is used.</p>
<pre><code>var foo = new DefineMap({ bar: &quot;baz&quot;, [canSymbol.for(&quot;quux&quot;)]: &quot;thud&quot; });
...
canReflect.getOwnEnumerableKeys(foo); // -&gt; [&quot;bar&quot;, &quot;jeek&quot;]
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>Any Map-like object</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>the Array of all enumerable keys from the object, either using
<a href="../can-symbol/symbols/getOwnEnumerableKeys.html" title="List the enumerable keys (as defined by its property descriptor) an object has, but not those from its prototype chain."><code>@@can.getOwnEnumerableKeys</code></a> from <code>obj</code>, or filtering
<code>obj</code>'s own keys for those which are enumerable.</p>
</p>
  </div>
