...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-reflect/reflections/call/call.js
	@function can-reflect/call.call
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - call</title>
...
<div class="breadcrumb">
	...
	<li><a href="call.call.html">call</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>call</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/call/call.js#L5">Edit on GitHub</a>
				</li>
    ...
    <p>Call a callable, with a context object and parameters</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>call(func, context, ...rest)</code>
  </h2>
  <p>Call the callable <code>func</code> as if it were a function, bound to <code>context</code> and with any additional parameters
occurring after <code>context</code> set to the positional parameters.</p>
<p>Note that <code>func</code> <em>must</em> either be natively callable, implement <a href="../can-symbol/symbols/apply.html" title="How to apply a List-like as the arguments to a call of the function.">@@can.apply</a>,
or have a callable <code>apply</code> property to work with <code>canReflect.call</code></p>
<pre><code>var compute = canCompute(&quot;foo&quot;);
...
canReflect.call(compute, null); // -&gt; &quot;bar&quot;
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>func</b> <code>{function(...)}</code>: <p>the function to call with the supplied arguments</p>
</li>
        
          <li><b>context</b> <code>{Object}</code>: <p>the context object to set as <code>this</code> on the function call</p>
</li>
        
          <li><b>rest</b> <code>{*}</code>: <p>any arguments after <code>context</code> will be passed to the function call</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>return types and values are determined by the call to <code>func</code></p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/call.call","parent":"can-reflect/call","src":{"line":4,"codeLine":29,"path":"node_modules/can-reflect/reflections/call/call.js"},"description":"Call a callable, with a context object and parameters \n","title":"call","signatures":[{"code":"call(func, context, ...rest)","description":"\n\nCall the callable `func` as if it were a function, bound to `context` and with any additional parameters\noccurring after `context` set to the positional parameters.\n\nNote that `func` *must* either be natively callable, implement [can-symbol/symbols/apply @@can.apply],\nor have a callable `apply` property to work with `canReflect.call`\n\n```\nvar compute = canCompute(\"foo\");\n\ncanReflect.call(compute, null, \"bar\");\ncanReflect.call(compute, null); // -> \"bar\"\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"variable":true}]}],"name":"func","description":"the function to call with the supplied arguments"},{"types":[{"type":"Object","options":[]}],"name":"context","description":"the context object to set as `this` on the function call"},{"types":[{"type":"*"}],"name":"rest","description":"any arguments after `context` will be passed to the function call"}],"returns":{"types":[{"type":"*"}],"description":"return types and values are determined by the call to `func`\n "}}],"_curParam":{"types":[{"type":"*"}],"name":"rest","description":"any arguments after `context` will be passed to the function call"},"_curReturn":{"types":[{"type":"*"}],"description":"return types and values are determined by the call to `func`\n "},"pathToRoot":"../.."};
</script>
</article>
