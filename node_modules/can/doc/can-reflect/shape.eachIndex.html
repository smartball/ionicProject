...
<!--####################################################################
	...
	@function can-reflect/shape.eachIndex
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - eachIndex</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.eachIndex.html">eachIndex</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>eachIndex</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L258">Edit on GitHub</a>
				</li>
    ...
    <p>Iterate a ListLike calling <code>callback</code> on each numerically indexed element</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>eachIndex(list, callback, context)</code>
  </h2>
  <p>For each numeric index from 0 to <code>list.length - 1</code>, call <code>callback</code>, passing the current
property value, the current index, and <code>list</code>, and optionally setting <code>this</code> as <code>context</code>
if specified (otherwise use the current property value).</p>
<pre><code>var foo = new DefineList([ &quot;bar&quot;, &quot;baz&quot; ]);
...
canReflect.eachIndex(foo, console.log, console); // -&gt; logs 'bar 0 {foo}'; logs 'baz 1 {foo}'
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{ListLike}</code>: <p>The list to iterate over</p>
</li>
        
          <li><b>callback</b> <code>{function(*, Number)}</code>: <p>a function that receives each item</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{ListLike}</code>: <p>the original list</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.eachIndex","parent":"can-reflect/shape","src":{"line":257,"codeLine":279,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Iterate a ListLike calling `callback` on each numerically indexed element \n","title":"eachIndex","signatures":[{"code":"eachIndex(list, callback, context)","description":"\n\nFor each numeric index from 0 to `list.length - 1`, call `callback`, passing the current\nproperty value, the current index, and `list`, and optionally setting `this` as `context`\nif specified (otherwise use the current property value).\n\n```\nvar foo = new DefineList([ \"bar\", \"baz\" ]);\n\ncanReflect.eachIndex(foo, console.log, console); // -> logs 'bar 0 {foo}'; logs 'baz 1 {foo}'\n```\n","params":[{"types":[{"type":"ListLike"}],"name":"list","description":"The list to iterate over"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"Number"}]}]}],"name":"callback","description":"a function that receives each item"},{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling the callback"}],"returns":{"types":[{"type":"ListLike"}],"description":"the original list\n "}}],"_curParam":{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling the callback"},"_curReturn":{"types":[{"type":"ListLike"}],"description":"the original list\n "},"pathToRoot":"../.."};
</script>
</article>
