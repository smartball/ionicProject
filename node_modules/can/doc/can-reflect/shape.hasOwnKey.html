...
<!--####################################################################
	...
	@function can-reflect/shape.hasOwnKey
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - hasOwnKey</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.hasOwnKey.html">hasOwnKey</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>hasOwnKey</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L395">Edit on GitHub</a>
				</li>
    ...
    <p>Determine whether an object contains a key on itself, not only on its prototype chain</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>hasOwnKey(obj, key)</code>
  </h2>
  <p>Return <code>true</code> if an object's own properties include the property key <code>key</code>, <code>false</code> otherwise.
An object may implement <a href="../can-symbol/symbols/hasOwnKey.html" title="Define a function to determine key membership of an object">@@can.hasOWnKey</a> to override default behavior.
By default, <code>canReflect.hasOwnKey</code> will first look for
[can-symbol/symbols/getOwnKey @@can.getOwnKey] on <code>obj</code>. If present, it will call <code>@@can.getOwnKey</code> and
test <code>key</code> against the returned Array of keys.  If absent, <code>Object.prototype.hasOwnKey()</code> is used.</p>
...
foo.each // -&gt; function each() {...}
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>Any MapLike object</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>The key to look up on <code>obj</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <code>obj</code>'s key set contains <code>key</code>, <code>false</code> otherwise</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.hasOwnKey","parent":"can-reflect/shape","src":{"line":394,"codeLine":419,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Determine whether an object contains a key on itself, not only on its prototype chain \n","title":"hasOwnKey","signatures":[{"code":"hasOwnKey(obj, key)","description":"\n\nReturn `true` if an object's own properties include the property key `key`, `false` otherwise.\nAn object may implement [can-symbol/symbols/hasOwnKey @@can.hasOWnKey] to override default behavior.\nBy default, `canReflect.hasOwnKey` will first look for\n[can-symbol/symbols/getOwnKey @@can.getOwnKey] on `obj`. If present, it will call `@@can.getOwnKey` and\ntest `key` against the returned Array of keys.  If absent, `Object.prototype.hasOwnKey()` is used.\n\n```\nvar foo = new DefineMap({ \"bar\": \"baz\" });\n\ncanReflect.hasOwnKey(foo, \"bar\"); // -> true\ncanReflect.hasOwnKey(foo, \"each\"); // -> false\nfoo.each // -> function each() {...}\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any MapLike object"},{"types":[{"type":"String"}],"name":"key","description":"The key to look up on `obj`"}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if `obj`'s key set contains `key`, `false` otherwise\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"The key to look up on `obj`"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if `obj`'s key set contains `key`, `false` otherwise\n "},"pathToRoot":"../.."};
</script>
</article>
