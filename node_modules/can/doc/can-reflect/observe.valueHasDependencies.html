...
<!--####################################################################
	...
	@function can-reflect/observe.valueHasDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - valueHasDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.valueHasDependencies.html">valueHasDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>valueHasDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L326">Edit on GitHub</a>
				</li>
    ...
    <p>Determine whether the value of an observable object is bound to other events</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>valueHasDependencies(obj)</code>
  </h2>
  <p>Returns <code>true</code> if the computed value of the Value-like object <code>obj</code> derives from other values.
Returns <code>false</code> if <code>obj</code> is computed but does not have dependencies on other objects. If <code>obj</code> is not
a computed value, returns <code>undefined</code>.</p>
<p><code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/valueHasDependencies.html" title="Define a function that checks if there are any other observable objects that affect the value of the object.">@@can.valueHasDependencies</a> to work with
<code>canReflect.valueHasDependencies</code>.</p>
<pre><code>var foo = canCompute( &quot;bar&quot; );
...
canReflect.valueHasDependencies(foo);  // -&gt; undefined
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to check for dependencies</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if there are other dependencies that may update the object's value; <code>false</code> otherwise</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.valueHasDependencies","type":"function","parent":"can-reflect/observe","src":{"line":325,"codeLine":361,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Determine whether the value of an observable object is bound to other events \n","title":"valueHasDependencies","signatures":[{"code":"valueHasDependencies(obj)","description":"\n\nReturns `true` if the computed value of the Value-like object `obj` derives from other values.\nReturns `false` if `obj` is computed but does not have dependencies on other objects. If `obj` is not\na computed value, returns `undefined`.\n\n`obj` *must* implement [can-symbol/symbols/valueHasDependencies @@can.valueHasDependencies] to work with\n`canReflect.valueHasDependencies`.\n\n```\nvar foo = canCompute( \"bar\" );\nvar baz = canCompute(function() {\n\t return foo();\n});\nvar quux = \"thud\";\nvar jeek = canCompute(function(plonk) {\n\t if(argument.length) {\n\t \t  quux = plonk;\n\t }\n\t return quux;\n});\n\ncanReflect.valueHasDependencies(baz);  // -> true\ncanReflect.valueHasDependencies(jeek);  // -> false\ncanReflect.valueHasDependencies(foo);  // -> undefined\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for dependencies"}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if there are other dependencies that may update the object's value; `false` otherwise\n\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for dependencies"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if there are other dependencies that may update the object's value; `false` otherwise\n\n "},"pathToRoot":"../.."};
</script>
</article>
