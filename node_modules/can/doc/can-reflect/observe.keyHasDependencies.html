...
<!--####################################################################
	...
	@function can-reflect/observe.keyHasDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - keyHasDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.keyHasDependencies.html">keyHasDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>keyHasDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L197">Edit on GitHub</a>
				</li>
    ...
    <p>Determine whether the value for a named property on an object is bound to other events</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>keyHasDependencies(obj, key)</code>
  </h2>
  <p>Returns <code>true</code> if the computed value of the property <code>key</code> on Map-like object <code>obj</code> derives from other values.
Returns <code>false</code> if <code>key</code> is computed on <code>obj</code> but does not have dependencies on other objects. If <code>key</code> is not
a computed value on <code>obj</code>, returns <code>undefined</code>.</p>
<p><code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/keyHasDependencies.html" title="Check if there are any other objects that affect the value of a named property.">@@can.keyHasDependencies</a> to work with
<code>canReflect.keyHasDependencies</code>.</p>
...
canReflect.keyHasDependencies(foo, &quot;bar&quot;);  // -&gt; undefined
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if there are other objects that may update the keyed value; <code>false</code> otherwise</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.keyHasDependencies","type":"function","parent":"can-reflect/observe","src":{"line":196,"codeLine":235,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Determine whether the value for a named property on an object is bound to other events \n","title":"keyHasDependencies","signatures":[{"code":"keyHasDependencies(obj, key)","description":"\n\nReturns `true` if the computed value of the property `key` on Map-like object `obj` derives from other values.\nReturns `false` if `key` is computed on `obj` but does not have dependencies on other objects. If `key` is not\na computed value on `obj`, returns `undefined`.\n\n`obj` *must* implement [can-symbol/symbols/keyHasDependencies @@can.keyHasDependencies] to work with\n`canReflect.keyHasDependencies`.\n\n```\nvar foo = new DefineMap({ \"bar\": \"baz\" })\nvar obj = new (DefineMap.extend({\n\t baz: {\n\t   get: function() {\n\t     return foo.bar;\n\t   }\n\t },\n\t quux: {\n\t \t get: function() {\n\t \t   return \"thud\";\n\t \t }\n\t }\n}))();\n\ncanReflect.keyHasDependencies(obj, \"baz\");  // -> true\ncanReflect.keyHasDependencies(obj, \"quux\");  // -> false\ncanReflect.keyHasDependencies(foo, \"bar\");  // -> undefined\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for key dependencies"},{"types":[{"type":"String"}],"name":"key","description":"the key on the object to check"}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if there are other objects that may update the keyed value; `false` otherwise\n\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key on the object to check"},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if there are other objects that may update the keyed value; `false` otherwise\n\n "},"pathToRoot":"../.."};
</script>
</article>
