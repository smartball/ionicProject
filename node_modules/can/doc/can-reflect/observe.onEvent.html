...
<!--####################################################################
	...
	@function can-reflect/observe.onEvent
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onEvent</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onEvent.html">onEvent</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onEvent</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L367">Edit on GitHub</a>
				</li>
    ...
    <p>Register a named event handler on an observable object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onEvent(obj, eventName, callback)</code>
  </h2>
  <p>Register an event handler on the object <code>obj</code> to trigger when the event <code>eventName</code> is dispatched.
<code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onKeyValue.html" title="Defines how observable values can be listened to on a type.">@@can.onEvent</a> or <code>.addEventListener()</code> to be compatible
with can-reflect.onKeyValue.  The function passed as <code>callback</code> will receive the event descriptor as the first
argument, and any data passed to the event dispatch as subsequent arguments.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to bind a new event handler to</p>
</li>
        
          <li><b>eventName</b> <code>{String}</code>: <p>the name of the event to bind the handler to</p>
</li>
        
          <li><b>callback</b> <code>{function(*)}</code>: <p>the handler function to bind to the event</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/observe.onEvent","parent":"can-reflect/observe","src":{"line":366,"codeLine":392,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Register a named event handler on an observable object \n","title":"onEvent","signatures":[{"code":"onEvent(obj, eventName, callback)","description":"\n\n\nRegister an event handler on the object `obj` to trigger when the event `eventName` is dispatched.\n`obj` *must* implement [can-symbol/symbols/onKeyValue @@can.onEvent] or `.addEventListener()` to be compatible\nwith can-reflect.onKeyValue.  The function passed as `callback` will receive the event descriptor as the first\nargument, and any data passed to the event dispatch as subsequent arguments.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\ncanReflect.onEvent(obj, \"foo\", function(ev, newVal, oldVal) {\n\tconsole.log(\"foo is now\", newVal, \", was\", oldVal);\n});\n\ncanEvent.dispatch.call(obj, \"foo\", [\"baz\", \"quux\"]);  // -> logs \"foo is now baz , was quux\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to bind a new event handler to"},{"types":[{"type":"String"}],"name":"eventName","description":"the name of the event to bind the handler to"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"callback","description":"the handler function to bind to the event\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]}]}],"name":"callback","description":"the handler function to bind to the event\n "},"pathToRoot":"../.."};
</script>
</article>
