...
<!--####################################################################
	...
	@function can-reflect/shape.assign
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - assign</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.assign.html">assign</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>assign</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L595">Edit on GitHub</a>
				</li>
    ...
    <p>Assign one objects values to another</p>
...
<div class="signature">
  ...
  <p>Copies the values (and properties if map-like) from <code>source</code> onto <code>target</code>.</p>
...
<p>For Arrays, enumerated values are copied over, but the length of the array will not be
trunkated.  Use [can-reflect.update] for trunkating.</p>
