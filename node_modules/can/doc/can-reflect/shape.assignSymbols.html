...
<!--####################################################################
	...
	@function can-reflect/shape.assignSymbols
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - assignSymbols</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.assignSymbols.html">assignSymbols</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>assignSymbols</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L855">Edit on GitHub</a>
				</li>
    ...
    <p>Assign well known symbols and values to an object.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>.assignSymbols(target, source)</code>
  </h2>
  <p>Converts each property name on the <code>source</code> object to a <a href="../can-symbol.for.html" title="Get a symbol based on a known string identifier, or create it if it doesn't exist.">well known symbol</a>
and uses that symbol to set the corresponding value on target.</p>
<p>This is used to easily set symbols correctly even when symbol isn't natively supported.</p>
<pre><code class="language-js">canReflect.assignSymbols(Map.prototype, {
  &quot;can.getKeyValue&quot;: Map.prototype.get
})
</code></pre>
<p>If a <code>source</code> property name matches a symbol on <code>Symbol</code> (like <code>iterator</code> on <code>Symbol.iterator</code>),
that symbol will be used:</p>
<pre><code class="language-js">canReflect.assignSymbols(ArrayLike.prototype, {
  &quot;iterator&quot;: function() { ... }
})
ArrayLike.prototype[Symbol.iterator] = function(){ ... }
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{Object}</code>: <p>The value that will be updated with <code>source</code>'s symbols and values.</p>
</li>
        
          <li><b>source</b> <code>{Object&lt;name,value&gt;}</code>: <p>A source of symbol names and values to copy to <code>target</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The target.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.assignSymbols","parent":"can-reflect/shape","src":{"line":854,"codeLine":886,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Assign well known symbols and values to an object. \n","title":"assignSymbols","signatures":[{"code":".assignSymbols(target, source)","description":"\n\nConverts each property name on the `source` object to a [can-symbol.for well known symbol]\nand uses that symbol to set the corresponding value on target.\n\nThis is used to easily set symbols correctly even when symbol isn't natively supported.\n\n```js\ncanReflect.assignSymbols(Map.prototype, {\n  \"can.getKeyValue\": Map.prototype.get\n})\n```\n\nIf a `source` property name matches a symbol on `Symbol` (like `iterator` on `Symbol.iterator`),\nthat symbol will be used:\n\n```js\ncanReflect.assignSymbols(ArrayLike.prototype, {\n  \"iterator\": function() { ... }\n})\nArrayLike.prototype[Symbol.iterator] = function(){ ... }\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"target","description":"The value that will be updated with `source`'s symbols and values."},{"types":[{"type":"Object","template":[{"types":[{"type":"name"}]},{"types":[{"type":"value"}]}]}],"name":"source","description":"A source of symbol names and values to copy to `target`."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The target.\n "}}],"_curParam":{"types":[{"type":"Object","template":[{"types":[{"type":"name"}]},{"types":[{"type":"value"}]}]}],"name":"source","description":"A source of symbol names and values to copy to `target`."},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The target.\n "},"pathToRoot":"../.."};
</script>
</article>
