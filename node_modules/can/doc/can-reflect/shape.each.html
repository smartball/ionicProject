...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-reflect/reflections/shape/shape.js
	@function can-reflect/shape.each
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - each</title>
...
way to observe those reads called within a given function.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="shape.getOwnEnumerableKeys.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="shape.getOwnKeyDescriptor.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="observe.getKeyDependencies.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="observe.getValueDependencies.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="observe.keyHasDependencies.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="observe.onKeysRemoved.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="observe.valueHasDependencies.html"
...
<div class="breadcrumb">
		...
		<li><a href="../can-reflect.html">can-reflect</a></li>
		<li> / </li>
	
	
	<li><a href="shape.each.html">each</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>each</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L221">Edit on GitHub</a>
				</li>
    ...
    <p>Iterate a List-like or Map-like, calling <code>callback</code> on each keyed or indexed property</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>each(obj, callback, context)</code>
  </h2>
  <p>If <code>obj</code> is a List-like or an Iterator-like, <code>each</code> functions as <a href="shape.eachIndex.html" title="Iterate a ListLike calling callback on each numerically indexed element">eachIndex</a>,
iterating over numeric indexes from 0 to <code>obj.length - 1</code> and calling <code>callback</code> with each property and
index, optionally with <code>context</code> as <code>this</code> (defaulting to <code>obj</code>).  If not, <code>each</code> functions as
<a href="shape.eachKey.html" title="Iterate over a MapLike, calling callback on each enumerable property">eachKey</a>,
iterating over every key on <code>obj</code> and calling <code>callback</code> on each one.</p>
<pre><code>var foo = new DefineMap({ bar: &quot;baz&quot; });
...
canReflect.each(quux, console.log, console); // -&gt; logs 'thud 0 {quux}'; logs 'jeek 1 {quux}'
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>The object to iterate over</p>
</li>
        
          <li><b>callback</b> <code>{function(*, ValueLike)}</code>: <p>a function that receives each item in the ListLike or MapLike</p>
</li>
        
          <li><b>context</b> <code>{[}</code>: <p>an optional <code>this</code> context for calling the callback</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>the result of calling <a href="shape.eachIndex.html" title="Iterate a ListLike calling callback on each numerically indexed element"><code>eachIndex</code></a> if <code>obj</code> is a ListLike,
or <a href="shape.eachKey.html" title="Iterate over a MapLike, calling callback on each enumerable property"><code>eachKey</code></a> if a MapLike.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.each","parent":"can-reflect/shape","src":{"line":220,"codeLine":247,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Iterate a List-like or Map-like, calling `callback` on each keyed or indexed property \n","title":"each","signatures":[{"code":"each(obj, callback, context)","description":"\n\nIf `obj` is a List-like or an Iterator-like, `each` functions as [can-reflect/shape.eachIndex eachIndex],\niterating over numeric indexes from 0 to `obj.length - 1` and calling `callback` with each property and\nindex, optionally with `context` as `this` (defaulting to `obj`).  If not, `each` functions as\n[can-reflect/shape.eachKey eachKey],\niterating over every key on `obj` and calling `callback` on each one.\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\nvar quux = new DefineList([ \"thud\", \"jeek\" ]);\n\ncanReflect.each(foo, console.log, console); // -> logs 'baz bar {foo}'\ncanReflect.each(quux, console.log, console); // -> logs 'thud 0 {quux}'; logs 'jeek 1 {quux}'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"The object to iterate over"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"ValueLike"}]}]}],"name":"callback","description":"a function that receives each item in the ListLike or MapLike"},{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling the callback"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"the result of calling [can-reflect/shape.eachIndex `eachIndex`] if `obj` is a ListLike,\nor [can-reflect/shape.eachKey `eachKey`] if a MapLike.\n "}}],"_curParam":{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling the callback"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"the result of calling [can-reflect/shape.eachIndex `eachIndex`] if `obj` is a ListLike,\nor [can-reflect/shape.eachKey `eachKey`] if a MapLike.\n "},"pathToRoot":"../.."};
</script>
</article>
