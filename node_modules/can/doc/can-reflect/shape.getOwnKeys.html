...
<!--####################################################################
	...
	@function can-reflect/shape.getOwnKeys
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getOwnKeys</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.getOwnKeys.html">getOwnKeys</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getOwnKeys</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L508">Edit on GitHub</a>
				</li>
    ...
    <p>Return the list of keys on an object, whether or not they can be iterated over</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getOwnKeys(obj)</code>
  </h2>
  <p>Return the Array of all String (not Symbol) keys from <code>obj</code>, whether they are enumerable or not.  If
<a href="../can-symbol/symbols/getOwnKeys.html" title="List which keys an object has of its own (not other objects on the prototype chain).">@@can.getOwnKeys</a> exists on <code>obj</code>, it is called to return
the keys; otherwise, <code>Object.getOwnPropertyNames()</code> is used.</p>
...
canReflect.getOwnKeys(foo); // -&gt; [&quot;bar&quot;, &quot;jeek&quot;]
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>the Array of all String keys from the object.</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.getOwnKeys","parent":"can-reflect/shape","src":{"line":507,"codeLine":531,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Return the list of keys on an object, whether or not they can be iterated over \n","title":"getOwnKeys","signatures":[{"code":"getOwnKeys(obj)","description":"\n\nReturn the Array of all String (not Symbol) keys from `obj`, whether they are enumerable or not.  If\n[can-symbol/symbols/getOwnKeys @@can.getOwnKeys] exists on `obj`, it is called to return\nthe keys; otherwise, `Object.getOwnPropertyNames()` is used.\n\n```\nvar foo = new DefineMap({ bar: \"baz\", [canSymbol.for(\"quux\")]: \"thud\" });\nObject.defineProperty(foo, \"jeek\", {\n  enumerable: false,\n  value: \"plonk\"\n});\n\ncanReflect.getOwnKeys(foo); // -> [\"bar\", \"jeek\"]\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any MapLike object"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"the Array of all String keys from the object.\n "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"obj","description":"Any MapLike object"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"the Array of all String keys from the object.\n "},"pathToRoot":"../.."};
</script>
</article>
