...
<!--####################################################################
	...
	@function can-reflect/shape.eachKey
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - eachKey</title>
...
<div class="breadcrumb">
	...
	<li><a href="shape.eachKey.html">eachKey</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>eachKey</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L356">Edit on GitHub</a>
				</li>
    ...
    <p>Iterate over a MapLike, calling <code>callback</code> on each enumerable property</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>eachKey(obj, callback, context)</code>
  </h2>
  <p>Iterate all own enumerable properties on Map-like <code>obj</code>
(using [can-reflect/shape/getOwnEnumerableKeys canReflect.getOwnEnumerableKeys]), and call
<code>callback</code> with the property value, the property key, and <code>obj</code>, and optionally setting
<code>this</code> on the callback as <code>context</code> if provided, <code>obj</code> otherwise.</p>
...
canReflect.eachKey(foo, console.log, console); // logs 'baz bar {foo}'
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>callback</b> <code>{function(*, String)}</code>: <p>The callback to call on each enumerable property value</p>
</li>
        
          <li><b>context</b> <code>{[}</code>: <p>an optional <code>this</code> context for calling <code>callback</code></p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array}</code>: <p>the enumerable keys of <code>obj</code> as an Array</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/shape.eachKey","parent":"can-reflect/shape","src":{"line":355,"codeLine":378,"path":"node_modules/can-reflect/reflections/shape/shape.js"},"description":"Iterate over a MapLike, calling `callback` on each enumerable property \n","title":"eachKey","signatures":[{"code":"eachKey(obj, callback, context)","description":"\n\nIterate all own enumerable properties on Map-like `obj`\n(using [can-reflect/shape/getOwnEnumerableKeys canReflect.getOwnEnumerableKeys]), and call\n`callback` with the property value, the property key, and `obj`, and optionally setting\n`this` on the callback as `context` if provided, `obj` otherwise.\n\n```\nvar foo = new DefineMap({ bar: \"baz\" });\n\ncanReflect.eachKey(foo, console.log, console); // logs 'baz bar {foo}'\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"The object to iterate over"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"String"}]}]}],"name":"callback","description":"The callback to call on each enumerable property value"},{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling `callback`"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"the enumerable keys of `obj` as an Array\n "}}],"_curParam":{"types":[{"type":"["}],"name":"context","description":"an optional `this` context for calling `callback`"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"the enumerable keys of `obj` as an Array\n "},"pathToRoot":"../.."};
</script>
</article>
