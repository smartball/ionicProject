...
<!--####################################################################
	...
	@function can-reflect/observe.getKeyDependencies
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - getKeyDependencies</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.getKeyDependencies.html">getKeyDependencies</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>getKeyDependencies</h1>
			<ul class="title-social">
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L161">Edit on GitHub</a>
				</li>
    ...
    <p>Return the observable objects that compute to the value of a named property on an object</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>getKeyDependencies(obj, key)</code>
  </h2>
  <p>Return the observable objects that provide input values to generate the computed value of the
property <code>key</code> on Map-like object <code>obj</code>.  If <code>key</code> does not have dependencies on <code>obj</code>, returns <code>undefined</code>.
Otherwise returns an object with up to two keys: <code>keyDependencies</code> is a <a href="../can-util/js/cid-map/cid-map.html" title="Deprecated. Use map instead.">CIDMap</a> that
maps each Map-like object providing keyed values to an Array of the relevant keys; <code>valueDependencies</code> is a
<a href="../can-util/js/cid-set/cid-set.html" title="Deprecated. Use set instead.">CIDSet</a> that contains all Value-like dependencies providing their own values.</p>
<p><code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/getKeyDependencies.html" title="A symbol placed on a constructor to reference a function that returns the other events that will trigger an event for the key on the object.">@@can.getKeyDependencies</a> to work with
<code>canReflect.getKeyDependencies</code>.</p>
...
canReflect.getKeyDependencies(obj, &quot;baz&quot;);  // -&gt; { valueDependencies: CIDSet }
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>the object to check for key dependencies</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>the key on the object to check</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>the observable values that this keyed value depends on</p>
</p>
  </div>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.getKeyDependencies","type":"function","parent":"can-reflect/observe","src":{"line":160,"codeLine":194,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Return the observable objects that compute to the value of a named property on an object \n","title":"getKeyDependencies","signatures":[{"code":"getKeyDependencies(obj, key)","description":"\n\nReturn the observable objects that provide input values to generate the computed value of the\nproperty `key` on Map-like object `obj`.  If `key` does not have dependencies on `obj`, returns `undefined`.\nOtherwise returns an object with up to two keys: `keyDependencies` is a [can-util/js/cid-map/cid-map CIDMap] that\nmaps each Map-like object providing keyed values to an Array of the relevant keys; `valueDependencies` is a\n[can-util/js/cid-set/cid-set CIDSet] that contains all Value-like dependencies providing their own values.\n\n`obj` *must* implement [can-symbol/symbols/getKeyDependencies @@can.getKeyDependencies] to work with\n`canReflect.getKeyDependencies`.\n\n\n```\nvar foo = new DefineMap({ \"bar\": \"baz\" })\nvar obj = new (DefineMap.extend({\n\t baz: {\n\t   get: function() {\n\t     return foo.bar;\n\t   }\n\t }\n}))();\n\ncanReflect.getKeyDependencies(obj, \"baz\");  // -> { valueDependencies: CIDSet }\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"the object to check for key dependencies"},{"types":[{"type":"String"}],"name":"key","description":"the key on the object to check"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"the observable values that this keyed value depends on\n "}}],"_curParam":{"types":[{"type":"String"}],"name":"key","description":"the key on the object to check"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"the observable values that this keyed value depends on\n "},"pathToRoot":"../.."};
</script>
</article>
