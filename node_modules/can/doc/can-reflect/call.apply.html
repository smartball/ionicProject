...
<!--####################################################################
	...
	@function can-reflect/call.apply
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - apply</title>
...
<div class="breadcrumb">
	...
	<li><a href="call.apply.html">apply</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>apply</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/call/call.js#L39">Edit on GitHub</a>
				</li>
    ...
    <p>Call a callable, with a context object and a list of parameters</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>apply(func, context, args)</code>
  </h2>
...
contained in the Array-like <code>args</code></p>
...
or have a callable <code>apply</code> property to work with <code>canReflect.apply</code></p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>func</b> <code>{function(...)}</code>: <p>the function to call</p>
</li>
        
          <li><b>context</b> <code>{Object}</code>: <p>the context object to set as <code>this</code> on the function call</p>
</li>
        
          <li><b>args</b> <code>{*}</code>: <p>arguments to be passed to the function call</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-reflect/call.apply","parent":"can-reflect/call","src":{"line":38,"codeLine":63,"path":"node_modules/can-reflect/reflections/call/call.js"},"description":"Call a callable, with a context object and a list of parameters \n","title":"apply","signatures":[{"code":"apply(func, context, args)","description":"\n\nCall the callable `func` as if it were a function, bound to `context` and with any additional parameters\ncontained in the Array-like `args`\n\nNote that `func` *must* either be natively callable, implement [can-symbol/symbols/apply @@can.apply],\nor have a callable `apply` property to work with `canReflect.apply`\n\n```\nvar compute = canCompute(\"foo\");\n\ncanReflect.apply(compute, null, [\"bar\"]);\ncanReflect.apply(compute, null, []); // -> \"bar\"\n```\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"variable":true}]}],"name":"func","description":"the function to call"},{"types":[{"type":"Object","options":[]}],"name":"context","description":"the context object to set as `this` on the function call"},{"types":[{"type":"*"}],"name":"args","description":"arguments to be passed to the function call"}],"returns":{"types":[{"type":"*"}],"description":"return types and values are determined by the call to `func`\n "}}],"_curParam":{"types":[{"type":"*"}],"name":"args","description":"arguments to be passed to the function call"},"_curReturn":{"types":[{"type":"*"}],"description":"return types and values are determined by the call to `func`\n "},"pathToRoot":"../.."};
</script>
</article>
