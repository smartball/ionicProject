...
<!--####################################################################
	...
	@function can-reflect/observe.onKeyValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - onKeyValue</title>
...
<div class="breadcrumb">
	...
	<li><a href="observe.onKeyValue.html">onKeyValue</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>onKeyValue</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L28">Edit on GitHub</a>
				</li>
    ...
    <p>Register an event handler on a MapLike object, based on a key change</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>onKeyValue(obj, key, handler)</code>
  </h2>
  <p>Register a handler on the Map-like object <code>obj</code> to trigger when the property key <code>key</code> changes.
<code>obj</code> <em>must</em> implement <a href="../can-symbol/symbols/onKeyValue.html" title="Defines how observable values can be listened to on a type.">@@can.onKeyValue</a> to be compatible with
can-reflect.onKeyValue.  The function passed as <code>handler</code> will receive the new value of the property
as the first argument, and the previous value of the property as the second argument.</p>
<pre><code>var obj = new DefineMap({ foo: &quot;bar&quot; });
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>obj</b> <code>{Object}</code>: <p>an observable MapLike that can listen to changes in named properties.</p>
</li>
        
          <li><b>key</b> <code>{String}</code>: <p>the key to listen to</p>
</li>
        
          <li><b>handler</b> <code>{function(*, *)}</code>: <p>a callback function that recieves the new value</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-reflect/observe.onKeyValue","type":"function","parent":"can-reflect/observe","src":{"line":27,"codeLine":52,"path":"node_modules/can-reflect/reflections/observe/observe.js"},"description":"Register an event handler on a MapLike object, based on a key change \n","title":"onKeyValue","signatures":[{"code":"onKeyValue(obj, key, handler)","description":"\n\nRegister a handler on the Map-like object `obj` to trigger when the property key `key` changes.\n`obj` *must* implement [can-symbol/symbols/onKeyValue @@can.onKeyValue] to be compatible with\ncan-reflect.onKeyValue.  The function passed as `handler` will receive the new value of the property\nas the first argument, and the previous value of the property as the second argument.\n\n```\nvar obj = new DefineMap({ foo: \"bar\" });\ncanReflect.onKeyValue(obj, \"foo\", function(newVal, oldVal) {\n\tconsole.log(\"foo is now\", newVal, \", was\", oldVal);\n});\n\nobj.foo = \"baz\";  // -> logs \"foo is now baz , was bar\"\n```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"obj","description":"an observable MapLike that can listen to changes in named properties."},{"types":[{"type":"String"}],"name":"key","description":"the key to listen to"},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"*"}]}]}],"name":"handler","description":"a callback function that recieves the new value\n "}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"*"}]},{"types":[{"type":"*"}]}]}],"name":"handler","description":"a callback function that recieves the new value\n "},"pathToRoot":"../.."};
</script>
</article>
