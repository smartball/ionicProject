...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-ejs/doc/can-ejs.md
	@module can-ejs
######################################################################## -->
<html lang="en">
<head>
			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-ejs">
						<img src="https://img.shields.io/badge/npm%20package-3.1.6-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-ejs" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-ejs/edit/master/doc/can-ejs.md">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-ejs/doc/can-ejs.md"},"description":"EJS provides __live__ ERB-style client-side templates. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-ejs","parent":"can-legacy","package":{"author":{"name":"Bitovi","email":"justin@bitovi.com","url":"http://bitovi.com"},"bundleDependencies":false,"dependencies":{"can-compute":"^3.3.0","can-legacy-view-helpers":"^0.6.0","can-namespace":"^1.0.0","can-observation":"^3.3.0","can-reflect":"^1.1.0","can-stache-key":"0.1.0","can-util":"^3.9.0"},"deprecated":false,"description":"legacy EJS layer for canjs","devDependencies":{"can-list":"^3.1.0","can-map":"^3.1.0","jshint":"^2.9.1","steal":"^1.5.13","steal-qunit":"^1.0.1","steal-tools":"^1.8.4","testee":"^0.7.0"},"homepage":"https://canjs.com/2.3/docs/can.ejs.html","keywords":["CanJS","MVVM"],"main":"can-ejs","name":"can-ejs","scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","jshint":"jshint can-ejs.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version pre && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-ejs","ext":{"ejs":"can-ejs/steal-ejs.js"},"plugins":["can-ejs"],"configDependencies":["live-reload"],"npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.6"},"deprecated":[{"version":"2.1","description":"EJS is incompatible with [can-component] and should\nbe avoided for new projects. Projects using EJS should consider\nswitching to [can-stache].\n"}],"signatures":[{"code":"ejs( template )","description":"\n\nReturns `template` compiled to a renderer function.\n\n```js\nvar ejs = require(\"can-ejs\");\nvar renderer = ejs(\"<h1><%= message %></h1>\");\nvar frag = renderer({message: \"Hello World\"});\nfrag //-> <h1>Hello World</h1>\n\ndocument.body.appendChild(frag);\n```\n","params":[{"types":[{"type":"String"}],"name":"template","description":"The content of the mustache template.\n"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Any"}]}]}],"description":"A function that renders the ejs template into\na live documentFragment given data.\n"}},{"code":"new ejs(options)","description":"\n\nCreates an EmbeddedJS template instance.  This form can be used\nto render a string.\n\n```js\nvar ejs = require(\"can-ejs\");\nvar ejsInstance = new ejs({\n\ttext: \"<h1><%= message %></h1>\"\n});\nvar string = ejsInstance.render({message: \"Hello World\"});\nstring //-> \"<h1>Hello World</h1>\"\n```\n","params":[]}],"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Any"}]}]}],"description":"A function that renders the ejs template into\na live documentFragment given data.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
