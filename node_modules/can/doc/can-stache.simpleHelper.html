...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache/docs/simplehelper.md
	@typedef can-stache.simpleHelper
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - simpleHelper</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.simpleHelper.html">simpleHelper</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>simpleHelper</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache/edit/master/docs/simplehelper.md">Edit on GitHub</a>
				</li>
    ...
    <p>A helper function passed to <a href="can-stache.registerSimpleHelper.html" title="Register a helper that gets passed values.">registerSimpleHelper</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>arg</b> <code>{*}</code>: <p>Arguments passed from the tag. After the helper
...
<pre><code>stache.registerSimpleHelper('madLib',
...
<p>Unlike <a href="can-stache.helper.html" title="A helper function passed to can-stache.registerHelper.
Given the arguments, returns the content that should be shown in the DOM
or a function that will be called on the DOM element the helper was
called on.">helper</a> simple helpers will always pass the actual
value (instead of a compute).</p>
</li>
...
<li>a <code>hash</code> object of the maps passed to the helper</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String|function(HTMLElement)}</code>: <p>The content to be inserted into
the template.</p>
</p>
  </div>
...
be used to create mustache tags that have rich behavior.</p>
...
<pre><code>stache.registerSimpleHelper(&quot;sortable&quot;,function(){
  return function(el){
    $(el).slider();
  }
});
...
<p>The returned function is called with a temporary element. The
following helper would be called with a temporary <code>&lt;li&gt;</code> element:</p>
<pre><code>stache.registerSimpleHelper(&quot;items&quot;,function(){
  return function(li){

  }
});
</code></pre>
<p>The temporary element depends on the parent element. The default temporary element
is a <code>&lt;span&gt;</code> element.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/simplehelper.md"},"description":"A helper function passed to [can-stache.registerSimpleHelper]. \n","type":"typedef","title":"simpleHelper","types":[{"type":"function","returns":{"types":[{"type":"String"},{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"HTMLElement"}]}]}],"description":"The content to be inserted into\nthe template.\n"},"params":[{"types":[{"type":"*"}],"optional":true,"variable":true,"name":"arg","description":"Arguments passed from the tag. After the helper\nname, any space separated [can-stache.key keys], numbers or\nstrings are passed as arguments.\n\nThe following template:\n\n    <p>{{madLib \"Lebron James\" verb 4}}</p>\n\nRendered with\n\n    {verb: \"swept\"}\n\nWill call a `madLib` helper with the following arguements.\n\n    stache.registerSimpleHelper('madLib',\n      function(subject, verb, number){\n        // subject -> \"Lebron James\"\n        // verb -> \"swept\"\n        // number -> 4\n    });\n\nUnlike [can-stache.helper] simple helpers will always pass the actual\nvalue (instead of a compute).\n"},{"types":[{"type":"can-stache.helperOptions"}],"name":"options","description":"An options object\nthat gets populated with optional:\n\n- `fn` and `inverse` section rendering functions\n- a `hash` object of the maps passed to the helper\n"}],"context":{"types":[{"type":"can-stache.context"}],"description":"The context the helper was\ncalled within.\n"}}],"name":"can-stache.simpleHelper","parent":"can-stache.types","_curParam":{"types":[{"type":"can-stache.helperOptions"}],"name":"options","description":"An options object\nthat gets populated with optional:\n\n- `fn` and `inverse` section rendering functions\n- a `hash` object of the maps passed to the helper\n"},"_curReturn":{"types":[{"type":"String"},{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"HTMLElement"}]}]}],"description":"The content to be inserted into\nthe template.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
