...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stache-converters/docs/either-or.md
	@function can-stache-converters.either-or
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - either-or</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.either-or.html">either-or</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>either-or</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stache-converters/edit/master/docs/either-or.md">Edit on GitHub</a>
				</li>
    ...
    <p>A <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> that two-way binds to a checkbox two values provided as arguments. This converter is useful when you have a binary decision between two fixed values.</p>
...
<div class="signature">
  ...
  <p>When the getter is called, gets the value of the <strong>chosen</strong> compute and if it is equal to <strong>a</strong>, returns true, otherwise it returns false.</p>
<p>When the setter is called, if the new value is truthy, sets the <strong>chosen</strong> <a href="can-compute.html" title="Create an observable value.">can-compute</a> to <strong>a</strong>’s value, otherwise sets it to <strong>b</strong>’s value.</p>
<pre><code class="language-handlebars">&lt;span&gt;Favorite superhero:&lt;/span&gt;
&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;either-or(~chosen, 'Batman', 'Superman')&quot;&gt; Batman?
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>chosen</b> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute where the chosen value (between <code>a</code> and <code>b</code> is stored). When the setter is called, this compute’s value will be updated.</p>
</li>
        
          <li><b>a</b> <code>{*}</code>: <p>The <code>true</code> value. If the checkbox is checked, then <strong>a</strong>’s value will be stored in the <strong>chosen</strong> compute.</p>
</li>
        
          <li><b>b</b> <code>{*}</code>: <p>The <code>false</code> value. If the checkbox is unchecked, then <strong>b</strong>’s value will be stored in the <strong>chosen</strong> compute.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be used by <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> as a getter/setter bound to the element or a component's viewModel.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><strong>either-or</strong> is made to be used with <code>&lt;input type=checkbox&gt;</code> elements when there is a binary decision that can be made (so that multiple radio buttons are not needed).</p>
<p>You pass 3 arguments to this <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a>. The first argument is a compute that represents the chosen value. The second argument is the default, truthy, value. And the third argument is the falsey value.</p>
<pre><code class="language-handlebars">&lt;p&gt;
    &lt;input type=&quot;checkbox&quot;
...
<pre><code class="language-js">var template = stache.from(&quot;demo-template&quot;);
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-converters/docs/either-or.md"},"description":"A [can-stache.registerConverter converter] that two-way binds to a checkbox two values provided as arguments. This converter is useful when you have a binary decision between two fixed values. \n","title":"either-or","name":"can-stache-converters.either-or","type":"function","parent":"can-stache-converters.converters","signatures":[{"code":"either-or(~chosen, a, b)","description":"\n\nWhen the getter is called, gets the value of the **chosen** compute and if it is equal to **a**, returns true, otherwise it returns false.\n\nWhen the setter is called, if the new value is truthy, sets the **chosen** [can-compute] to **a**’s value, otherwise sets it to **b**’s value.\n\n```handlebars\n<span>Favorite superhero:</span>\n<input type=\"checkbox\" {($checked)}=\"either-or(~chosen, 'Batman', 'Superman')\"> Batman?\n```\n","params":[{"types":[{"type":"can-compute"}],"name":"chosen","description":"A compute where the chosen value (between `a` and `b` is stored). When the setter is called, this compute’s value will be updated.\n"},{"types":[{"type":"*"}],"name":"a","description":"The `true` value. If the checkbox is checked, then **a**’s value will be stored in the **chosen** compute.\n"},{"types":[{"type":"*"}],"name":"b","description":"The `false` value. If the checkbox is unchecked, then **b**’s value will be stored in the **chosen** compute.\n"}],"returns":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter bound to the element or a component's viewModel.\n"}}],"_curParam":{"types":[{"type":"*"}],"name":"b","description":"The `false` value. If the checkbox is unchecked, then **b**’s value will be stored in the **chosen** compute.\n"},"_curReturn":{"types":[{"type":"can-compute"}],"description":"A compute that will be used by [can-stache-bindings] as a getter/setter bound to the element or a component's viewModel.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
