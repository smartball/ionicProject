...
<!--####################################################################
	...
	@function can-dom-events.dispatch
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-dom-events.dispatch.html">dispatch</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>dispatch</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-dom-events/edit/master/can-dom-events.js#L96">Edit on GitHub</a>
				</li>
    ...
    <p>Create and dispatch a configured event on the target.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dispatch( target, eventData [, bubbles ][, cancelable ] )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>target</b> <code>{DomEventTarget}</code>: <p>The object to which to add the listener.</p>
</li>
        
          <li><b>eventData</b> <code>{Object|String}</code>: <p>The data to be assigned to the event. If it is a string, that will be the event type.</p>
</li>
        
          <li><b>bubbles</b> <code>{Boolean}</code>: <p>Whether the event should bubble; defaults to true.</p>
</li>
        
          <li><b>cancelable</b> <code>{Boolean}</code>: <p>Whether the event can be cancelled; defaults to false.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p>notCancelled Whether the event dispatched without being cancelled.</p>
</p>
  </div>
