...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-define-validate-validatejs/docs/errors.md
	@function can-define-validate-validatejs.errors
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - errors</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define-validate-validatejs.errors.html">errors</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>errors</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define-validate-validatejs/edit/master/docs/errors.md">Edit on GitHub</a>
				</li>
    ...
    <p>The <code>errors</code> method retrieves errors from validator.</p>
...
<div class="signature">
  ...
  <p>Returns all errors for the current map instance.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.errors(...propName)</code>
  </h2>
  <p>Returns errors for the specified keys from current map instance.</p>
<pre><code class="language-js">var Person = new DefineMap({
    name: {
        validate: {
            presence: true
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>propName</b> <code>{Array&lt;string&gt;}</code>: <p>The property key to retrieve errors for.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-validate-validatejs/docs/errors.md"},"description":"\nThe `errors` method retrieves errors from validator.\n","title":"errors","name":"can-define-validate-validatejs.errors","type":"function","parent":"can-define-validate-validatejs.defineMap","signatures":[{"code":"errors()","description":"\n\n  Returns all errors for the current map instance.\n\n  ```js\n  var Person = new DefineMap({\n      name: {\n          validate: {\n              presence: true\n          }\n      }\n  });\n  var person = new Person();\n  person.errors();\n  //-> [{message: \"is required\", related: \"name\"}]\n  ```\n","params":[],"returns":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if map is valid.\nOtherwise, will return an array of [can-validate/types/errors].\n"}},{"code":"map.errors(...propName)","description":"\n\n  Returns errors for the specified keys from current map instance.\n\n  ```js\n  var Person = new DefineMap({\n      name: {\n          validate: {\n              presence: true\n          }\n      }\n      age: {\n          validate: {\n              presence: true,\n              numericality: true\n          }\n      }\n  });\n  var person = new Person();\n  person.errors('name');\n  //-> [{message: \"is required\", related: \"name\"}]\n  ```\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"string"}]}]}],"optional":true,"name":"propName","description":"The property key to retrieve errors for.\n"}],"returns":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if map is valid.\nOtherwise, will return an array of [can-validate/types/errors].\n"}}],"_curReturn":{"types":[{"type":"can-validate.errors"}],"description":"Will return `undefined` if map is valid.\nOtherwise, will return an array of [can-validate/types/errors].\n"},"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"string"}]}]}],"optional":true,"name":"propName","description":"The property key to retrieve errors for.\n"},"pathToRoot":".."};
</script>
</article>
