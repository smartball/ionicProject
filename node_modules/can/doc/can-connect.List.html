...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-connect/docs/types/list.md
	@typedef can-connect.List
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-connect.List.html">List</a></li>
	...
	<div class="page-type">
		<h1>List</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/docs/types/list.md">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>The <code>List</code> type is a JavaScript type, typically
a constructor function, that is used to contain a list of typed <a href="can-connect/Instance.html" title="An instance of some JavaScript type.">instances</a>.  <code>List</code> types usually are
<code>Array</code>-like.  An instance of type <code>List</code> is what's returned by
[can-connect/constructor.hydrateList] to convert raw data into
what's returned by <a href="can-connect/connection.getList.html" title="Gets a can-connect.List of instances.">getList</a>.</p>
<pre><code class="language-js">var list = connection.hydrateList({
  data: [{id: 1, name: &quot;raw data&quot;}]
});

list //-&gt; an instance of List
</code></pre>
<p>The <code>List</code> type often has special methods used to interact with
the collection of <a href="can-connect/Instance.html" title="An instance of some JavaScript type.">Instance</a> instances.</p>
<pre><code class="language-js">var list = connection.hydrateList({
  data: [{id: 1, name: &quot;raw data&quot;}]
});
...
<p>The <a href="can-connect/constructor/constructor.list.html" title="Behavior option provided to create a typed list from a raw array.">list</a> option is used
to convert an Array of instances into the final <code>List</code> type.</p>
