...
<!--####################################################################
	...
	@function can-fixture-socket.Server.prototype.restore
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - restore</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-fixture-socket.Server.prototype.restore.html">restore</a></li>
	...
	<div class="page-type">
		<h1>restore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-fixture-socket/edit/master/src/index.js#L124">Edit on GitHub</a>
				</li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>server.restore()</code>
  </h2>
  <p>Restores <code>io.Manager.prototype</code> and clears <code>io.managers</code> cache.</p>
<pre><code>server.restore();
</code></pre>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-fixture-socket.Server.prototype.restore","parent":"can-fixture-socket.Server.prototype","src":{"line":123,"codeLine":135,"path":"node_modules/can-fixture-socket/src/index.js"},"description":"\n","title":"restore","signatures":[{"code":"server.restore()","description":"\n\nRestores `io.Manager.prototype` and clears `io.managers` cache.\n\n```\nserver.restore();\n```\n","params":[]}],"pathToRoot":".."};
</script>
</article>
