...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-stream-kefir/docs/toCompute.md
	@function can-stream-kefir.toCompute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stream-kefir.toCompute.html">toCompute</a></li>
	...
	<div class="page-type">
		<h1>toCompute</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-stream-kefir/edit/master/docs/toCompute.md">Edit on GitHub</a>
				</li>
...
function.  This function takes the stream of set values, and typically other streams and manipulates them into the final returned output stream.  The output stream's values are used as the value of the returned <a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>.</p>
...
returnedCompute(2);
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.computed.html" title="A derived value from other computes and observable maps.">compute</a>(newVal)}</code>: <p>A compute that when read will return the value of the stream returned by <code>setStream</code>.  When the compute is written to, it will update <code>setStream</code>.</p>
</p>
  </div>
