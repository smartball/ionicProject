...
<!--####################################################################
	...
	INSTEAD CHANGE:
	source: node_modules/can-view-scope/docs/prototype.peek.md
	@function can-view-scope.prototype.peek
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - peek</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-view-scope.prototype.peek.html">peek</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>peek</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-view-scope/edit/master/docs/prototype.peek.md">Edit on GitHub</a>
				</li>
    ...
    <p>Read a value from the scope without being observable.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>scope.peek(key [, options])</code>
  </h2>
  <p>Works just like <a href="can-view-scope.prototype.get.html" title="">get</a>, but prevents any calls to <a href="can-observation.add.html" title="Signals that an object's property is being observed, so that any functions
that are recording observations will see that this object is a dependency.">add</a>.</p>
<p>Walks up the scope to find a value at <code>key</code>.  Stops at the first context where <code>key</code> has
a value.</p>
<pre><code class="language-js">scope.peek(&quot;first.name&quot;);
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>key</b> <code>{<a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a>}</code>: <p>A dot seperated path.  Use <code>&quot;.&quot;</code> if you have a
property name that includes a dot.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{*}</code>: <p>The found value or undefined if no value is found.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>scope.peek(key)</code> looks up a value in the current scope's
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-scope/docs/prototype.peek.md"},"description":"\nRead a value from the scope without being observable.\n","title":"peek","name":"can-view-scope.prototype.peek","type":"function","parent":"can-view-scope.prototype","signatures":[{"code":"scope.peek(key [, options])","description":"\n\nWorks just like [can-view-scope.prototype.get], but prevents any calls to [can-observation.add].\n\n\nWalks up the scope to find a value at `key`.  Stops at the first context where `key` has\na value.\n\n```js\nscope.peek(\"first.name\");\n```\n","params":[{"types":[{"type":"can-stache.key"}],"name":"key","description":"A dot seperated path.  Use `\".\"` if you have a\nproperty name that includes a dot.\n"}],"returns":{"types":[{"type":"*"}],"description":"The found value or undefined if no value is found.\n"}}],"_curParam":{"types":[{"type":"can-stache.key"}],"name":"key","description":"A dot seperated path.  Use `\".\"` if you have a\nproperty name that includes a dot.\n"},"_curReturn":{"types":[{"type":"*"}],"description":"The found value or undefined if no value is found.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
